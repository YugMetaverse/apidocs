[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AIPerceptionStimuliSourceComponent

# Class: AIPerceptionStimuliSourceComponent

[ue/ue](../modules/ue_ue.md).AIPerceptionStimuliSourceComponent
...
- [constructor](ue_ue.AIPerceptionStimuliSourceComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.AIPerceptionStimuliSourceComponent.md#assetuserdata)
- [ComponentTags](ue_ue.AIPerceptionStimuliSourceComponent.md#componenttags)
- [CreationMethod](ue_ue.AIPerceptionStimuliSourceComponent.md#creationmethod)
- [OnComponentActivated](ue_ue.AIPerceptionStimuliSourceComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.AIPerceptionStimuliSourceComponent.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.AIPerceptionStimuliSourceComponent.md#primarycomponenttick)
- [RegisterAsSourceForSenses](ue_ue.AIPerceptionStimuliSourceComponent.md#registerassourceforsenses)
- [UCSModifiedProperties](ue_ue.AIPerceptionStimuliSourceComponent.md#ucsmodifiedproperties)
- [\_\_tid\_AIPerceptionStimuliSourceComponent\_\_](ue_ue.AIPerceptionStimuliSourceComponent.md#__tid_aiperceptionstimulisourcecomponent__)
- [\_\_tid\_ActorComponent\_\_](ue_ue.AIPerceptionStimuliSourceComponent.md#__tid_actorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.AIPerceptionStimuliSourceComponent.md#__tid_object__)
- [bAutoActivate](ue_ue.AIPerceptionStimuliSourceComponent.md#bautoactivate)
- [bAutoRegisterAsSource](ue_ue.AIPerceptionStimuliSourceComponent.md#bautoregisterassource)
- [bCanEverAffectNavigation](ue_ue.AIPerceptionStimuliSourceComponent.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.AIPerceptionStimuliSourceComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.AIPerceptionStimuliSourceComponent.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.AIPerceptionStimuliSourceComponent.md#binstancecomponent)
- [bIsActive](ue_ue.AIPerceptionStimuliSourceComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.AIPerceptionStimuliSourceComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.AIPerceptionStimuliSourceComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.AIPerceptionStimuliSourceComponent.md#bnetaddressable)
- [bReplicates](ue_ue.AIPerceptionStimuliSourceComponent.md#breplicates)

### Methods

- [Activate](ue_ue.AIPerceptionStimuliSourceComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.AIPerceptionStimuliSourceComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.AIPerceptionStimuliSourceComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.AIPerceptionStimuliSourceComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.AIPerceptionStimuliSourceComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.AIPerceptionStimuliSourceComponent.md#deactivate)
- [ExecuteUbergraph](ue_ue.AIPerceptionStimuliSourceComponent.md#executeubergraph)
- [GetClass](ue_ue.AIPerceptionStimuliSourceComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.AIPerceptionStimuliSourceComponent.md#getcomponenttickinterval)
- [GetName](ue_ue.AIPerceptionStimuliSourceComponent.md#getname)
- [GetOuter](ue_ue.AIPerceptionStimuliSourceComponent.md#getouter)
- [GetOwner](ue_ue.AIPerceptionStimuliSourceComponent.md#getowner)
- [GetWorld](ue_ue.AIPerceptionStimuliSourceComponent.md#getworld)
- [IsActive](ue_ue.AIPerceptionStimuliSourceComponent.md#isactive)
- [IsBeingDestroyed](ue_ue.AIPerceptionStimuliSourceComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.AIPerceptionStimuliSourceComponent.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.AIPerceptionStimuliSourceComponent.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.AIPerceptionStimuliSourceComponent.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.AIPerceptionStimuliSourceComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.AIPerceptionStimuliSourceComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.AIPerceptionStimuliSourceComponent.md#receivetick)
- [RegisterComponent](ue_ue.AIPerceptionStimuliSourceComponent.md#registercomponent)
- [RegisterForSense](ue_ue.AIPerceptionStimuliSourceComponent.md#registerforsense)
- [RegisterWithPerceptionSystem](ue_ue.AIPerceptionStimuliSourceComponent.md#registerwithperceptionsystem)
- [RemoveTickPrerequisiteActor](ue_ue.AIPerceptionStimuliSourceComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.AIPerceptionStimuliSourceComponent.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.AIPerceptionStimuliSourceComponent.md#setactive)
- [SetAutoActivate](ue_ue.AIPerceptionStimuliSourceComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.AIPerceptionStimuliSourceComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.AIPerceptionStimuliSourceComponent.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.AIPerceptionStimuliSourceComponent.md#setisreplicated)
- [SetTickGroup](ue_ue.AIPerceptionStimuliSourceComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.AIPerceptionStimuliSourceComponent.md#settickablewhenpaused)
- [ToggleActive](ue_ue.AIPerceptionStimuliSourceComponent.md#toggleactive)
- [UnregisterFromPerceptionSystem](ue_ue.AIPerceptionStimuliSourceComponent.md#unregisterfromperceptionsystem)
- [UnregisterFromSense](ue_ue.AIPerceptionStimuliSourceComponent.md#unregisterfromsense)
- [Find](ue_ue.AIPerceptionStimuliSourceComponent.md#find)
- [Load](ue_ue.AIPerceptionStimuliSourceComponent.md#load)
- [StaticClass](ue_ue.AIPerceptionStimuliSourceComponent.md#staticclass)

## Constructors

### constructor

• **new AIPerceptionStimuliSourceComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:15399](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15399)
...
• **RegisterAsSourceForSenses**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Class`](ue_ue.Class.md)\>

#### Defined in

[ue/ue.d.ts:15401](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15401)
...
### \_\_tid\_AIPerceptionStimuliSourceComponent\_\_

• **\_\_tid\_AIPerceptionStimuliSourceComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:15410](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15410)
...
[ue/ue.d.ts:15400](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15400)
...
▸ **RegisterForSense**(`SenseClass`): `void`
...
[ue/ue.d.ts:15402](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15402)
...
[ue/ue.d.ts:15403](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15403)
...
[ue/ue.d.ts:15404](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15404)

___

### UnregisterFromSense

▸ **UnregisterFromSense**(`SenseClass`): `void`
...
[ue/ue.d.ts:15405](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15405)

___

### Find

▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AIPerceptionStimuliSourceComponent`](ue_ue.AIPerceptionStimuliSourceComponent.md)
...
[ue/ue.d.ts:15407](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15407)

___

### Load

▸ `Static` **Load**(`InName`): [`AIPerceptionStimuliSourceComponent`](ue_ue.AIPerceptionStimuliSourceComponent.md)
...
[ue/ue.d.ts:15408](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15408)
...
[ue/ue.d.ts:15406](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15406)
