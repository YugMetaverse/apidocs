[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryAtmosphericFog

# Class: ActorFactoryAtmosphericFog

[ue/ue](../modules/ue_ue.md).ActorFactoryAtmosphericFog
...
- [constructor](ue_ue.ActorFactoryAtmosphericFog.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryAtmosphericFog.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryAtmosphericFog.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryAtmosphericFog.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryAtmosphericFog.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryAtmosphericFog.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryAtmosphericFog\_\_](ue_ue.ActorFactoryAtmosphericFog.md#__tid_actorfactoryatmosphericfog__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryAtmosphericFog.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryAtmosphericFog.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryAtmosphericFog.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryAtmosphericFog.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryAtmosphericFog.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryAtmosphericFog.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryAtmosphericFog.md#getclass)
- [GetName](ue_ue.ActorFactoryAtmosphericFog.md#getname)
- [GetOuter](ue_ue.ActorFactoryAtmosphericFog.md#getouter)
- [GetWorld](ue_ue.ActorFactoryAtmosphericFog.md#getworld)
- [Find](ue_ue.ActorFactoryAtmosphericFog.md#find)
- [Load](ue_ue.ActorFactoryAtmosphericFog.md#load)
- [StaticClass](ue_ue.ActorFactoryAtmosphericFog.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryAtmosphericFog**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13542](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13542)
...
### \_\_tid\_ActorFactoryAtmosphericFog\_\_

• **\_\_tid\_ActorFactoryAtmosphericFog\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13547](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13547)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryAtmosphericFog`](ue_ue.ActorFactoryAtmosphericFog.md)
...
[ue/ue.d.ts:13544](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13544)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryAtmosphericFog`](ue_ue.ActorFactoryAtmosphericFog.md)
...
[ue/ue.d.ts:13545](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13545)
...
[ue/ue.d.ts:13543](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13543)
