[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryCameraActor

# Class: ActorFactoryCameraActor

[ue/ue](../modules/ue_ue.md).ActorFactoryCameraActor
...
- [constructor](ue_ue.ActorFactoryCameraActor.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryCameraActor.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryCameraActor.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryCameraActor.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryCameraActor.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryCameraActor.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryCameraActor\_\_](ue_ue.ActorFactoryCameraActor.md#__tid_actorfactorycameraactor__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryCameraActor.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryCameraActor.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryCameraActor.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryCameraActor.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryCameraActor.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryCameraActor.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryCameraActor.md#getclass)
- [GetName](ue_ue.ActorFactoryCameraActor.md#getname)
- [GetOuter](ue_ue.ActorFactoryCameraActor.md#getouter)
- [GetWorld](ue_ue.ActorFactoryCameraActor.md#getworld)
- [Find](ue_ue.ActorFactoryCameraActor.md#find)
- [Load](ue_ue.ActorFactoryCameraActor.md#load)
- [StaticClass](ue_ue.ActorFactoryCameraActor.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryCameraActor**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13605](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13605)
...
### \_\_tid\_ActorFactoryCameraActor\_\_

• **\_\_tid\_ActorFactoryCameraActor\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13610](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13610)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryCameraActor`](ue_ue.ActorFactoryCameraActor.md)
...
[ue/ue.d.ts:13607](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13607)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryCameraActor`](ue_ue.ActorFactoryCameraActor.md)
...
[ue/ue.d.ts:13608](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13608)
...
[ue/ue.d.ts:13606](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13606)
