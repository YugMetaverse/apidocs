[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryClass

# Class: ActorFactoryClass

[ue/ue](../modules/ue_ue.md).ActorFactoryClass
...
- [constructor](ue_ue.ActorFactoryClass.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryClass.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryClass.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryClass.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryClass.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryClass.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryClass\_\_](ue_ue.ActorFactoryClass.md#__tid_actorfactoryclass__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryClass.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryClass.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryClass.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryClass.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryClass.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryClass.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryClass.md#getclass)
- [GetName](ue_ue.ActorFactoryClass.md#getname)
- [GetOuter](ue_ue.ActorFactoryClass.md#getouter)
- [GetWorld](ue_ue.ActorFactoryClass.md#getworld)
- [Find](ue_ue.ActorFactoryClass.md#find)
- [Load](ue_ue.ActorFactoryClass.md#load)
- [StaticClass](ue_ue.ActorFactoryClass.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryClass**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13623](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13623)
...
### \_\_tid\_ActorFactoryClass\_\_

• **\_\_tid\_ActorFactoryClass\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13628](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13628)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryClass`](ue_ue.ActorFactoryClass.md)
...
[ue/ue.d.ts:13625](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13625)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryClass`](ue_ue.ActorFactoryClass.md)
...
[ue/ue.d.ts:13626](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13626)
...
[ue/ue.d.ts:13624](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13624)
