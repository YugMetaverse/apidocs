[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryDirectionalLight

# Class: ActorFactoryDirectionalLight

[ue/ue](../modules/ue_ue.md).ActorFactoryDirectionalLight
...
- [constructor](ue_ue.ActorFactoryDirectionalLight.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryDirectionalLight.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryDirectionalLight.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryDirectionalLight.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryDirectionalLight.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryDirectionalLight.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryDirectionalLight\_\_](ue_ue.ActorFactoryDirectionalLight.md#__tid_actorfactorydirectionallight__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryDirectionalLight.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryDirectionalLight.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryDirectionalLight.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryDirectionalLight.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryDirectionalLight.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryDirectionalLight.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryDirectionalLight.md#getclass)
- [GetName](ue_ue.ActorFactoryDirectionalLight.md#getname)
- [GetOuter](ue_ue.ActorFactoryDirectionalLight.md#getouter)
- [GetWorld](ue_ue.ActorFactoryDirectionalLight.md#getworld)
- [Find](ue_ue.ActorFactoryDirectionalLight.md#find)
- [Load](ue_ue.ActorFactoryDirectionalLight.md#load)
- [StaticClass](ue_ue.ActorFactoryDirectionalLight.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryDirectionalLight**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13650](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13650)
...
### \_\_tid\_ActorFactoryDirectionalLight\_\_

• **\_\_tid\_ActorFactoryDirectionalLight\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13655](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13655)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryDirectionalLight`](ue_ue.ActorFactoryDirectionalLight.md)
...
[ue/ue.d.ts:13652](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13652)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryDirectionalLight`](ue_ue.ActorFactoryDirectionalLight.md)
...
[ue/ue.d.ts:13653](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13653)
...
[ue/ue.d.ts:13651](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13651)
