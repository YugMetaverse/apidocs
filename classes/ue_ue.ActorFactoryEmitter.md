[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryEmitter

# Class: ActorFactoryEmitter

[ue/ue](../modules/ue_ue.md).ActorFactoryEmitter
...
- [constructor](ue_ue.ActorFactoryEmitter.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryEmitter.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryEmitter.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryEmitter.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryEmitter.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryEmitter.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryEmitter\_\_](ue_ue.ActorFactoryEmitter.md#__tid_actorfactoryemitter__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryEmitter.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryEmitter.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryEmitter.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryEmitter.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryEmitter.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryEmitter.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryEmitter.md#getclass)
- [GetName](ue_ue.ActorFactoryEmitter.md#getname)
- [GetOuter](ue_ue.ActorFactoryEmitter.md#getouter)
- [GetWorld](ue_ue.ActorFactoryEmitter.md#getworld)
- [Find](ue_ue.ActorFactoryEmitter.md#find)
- [Load](ue_ue.ActorFactoryEmitter.md#load)
- [StaticClass](ue_ue.ActorFactoryEmitter.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryEmitter**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13659](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13659)
...
### \_\_tid\_ActorFactoryEmitter\_\_

• **\_\_tid\_ActorFactoryEmitter\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13664](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13664)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryEmitter`](ue_ue.ActorFactoryEmitter.md)
...
[ue/ue.d.ts:13661](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13661)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryEmitter`](ue_ue.ActorFactoryEmitter.md)
...
[ue/ue.d.ts:13662](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13662)
...
[ue/ue.d.ts:13660](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13660)
