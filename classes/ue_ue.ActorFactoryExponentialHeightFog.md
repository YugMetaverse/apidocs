[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryExponentialHeightFog

# Class: ActorFactoryExponentialHeightFog

[ue/ue](../modules/ue_ue.md).ActorFactoryExponentialHeightFog
...
- [constructor](ue_ue.ActorFactoryExponentialHeightFog.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryExponentialHeightFog.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryExponentialHeightFog.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryExponentialHeightFog.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryExponentialHeightFog.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryExponentialHeightFog.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryExponentialHeightFog\_\_](ue_ue.ActorFactoryExponentialHeightFog.md#__tid_actorfactoryexponentialheightfog__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryExponentialHeightFog.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryExponentialHeightFog.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryExponentialHeightFog.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryExponentialHeightFog.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryExponentialHeightFog.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryExponentialHeightFog.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryExponentialHeightFog.md#getclass)
- [GetName](ue_ue.ActorFactoryExponentialHeightFog.md#getname)
- [GetOuter](ue_ue.ActorFactoryExponentialHeightFog.md#getouter)
- [GetWorld](ue_ue.ActorFactoryExponentialHeightFog.md#getworld)
- [Find](ue_ue.ActorFactoryExponentialHeightFog.md#find)
- [Load](ue_ue.ActorFactoryExponentialHeightFog.md#load)
- [StaticClass](ue_ue.ActorFactoryExponentialHeightFog.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryExponentialHeightFog**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13678](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13678)
...
### \_\_tid\_ActorFactoryExponentialHeightFog\_\_

• **\_\_tid\_ActorFactoryExponentialHeightFog\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13683](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13683)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryExponentialHeightFog`](ue_ue.ActorFactoryExponentialHeightFog.md)
...
[ue/ue.d.ts:13680](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13680)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryExponentialHeightFog`](ue_ue.ActorFactoryExponentialHeightFog.md)
...
[ue/ue.d.ts:13681](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13681)
...
[ue/ue.d.ts:13679](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13679)
