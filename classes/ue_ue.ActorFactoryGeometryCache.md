[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryGeometryCache

# Class: ActorFactoryGeometryCache

[ue/ue](../modules/ue_ue.md).ActorFactoryGeometryCache
...
- [constructor](ue_ue.ActorFactoryGeometryCache.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryGeometryCache.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryGeometryCache.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryGeometryCache.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryGeometryCache.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryGeometryCache.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryGeometryCache\_\_](ue_ue.ActorFactoryGeometryCache.md#__tid_actorfactorygeometrycache__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryGeometryCache.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryGeometryCache.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryGeometryCache.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryGeometryCache.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryGeometryCache.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryGeometryCache.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryGeometryCache.md#getclass)
- [GetName](ue_ue.ActorFactoryGeometryCache.md#getname)
- [GetOuter](ue_ue.ActorFactoryGeometryCache.md#getouter)
- [GetWorld](ue_ue.ActorFactoryGeometryCache.md#getworld)
- [Find](ue_ue.ActorFactoryGeometryCache.md#find)
- [Load](ue_ue.ActorFactoryGeometryCache.md#load)
- [StaticClass](ue_ue.ActorFactoryGeometryCache.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryGeometryCache**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13687](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13687)
...
### \_\_tid\_ActorFactoryGeometryCache\_\_

• **\_\_tid\_ActorFactoryGeometryCache\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13692](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13692)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryGeometryCache`](ue_ue.ActorFactoryGeometryCache.md)
...
[ue/ue.d.ts:13689](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13689)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryGeometryCache`](ue_ue.ActorFactoryGeometryCache.md)
...
[ue/ue.d.ts:13690](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13690)
...
[ue/ue.d.ts:13688](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13688)
