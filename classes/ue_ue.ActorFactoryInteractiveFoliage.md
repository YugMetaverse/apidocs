[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryInteractiveFoliage
...
• **new ActorFactoryInteractiveFoliage**(`Outer?`, `Name?`, `ObjectFlags?`)
