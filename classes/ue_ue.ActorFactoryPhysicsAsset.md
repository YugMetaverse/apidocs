[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryPhysicsAsset

# Class: ActorFactoryPhysicsAsset

[ue/ue](../modules/ue_ue.md).ActorFactoryPhysicsAsset
...
- [constructor](ue_ue.ActorFactoryPhysicsAsset.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryPhysicsAsset.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryPhysicsAsset.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryPhysicsAsset.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryPhysicsAsset.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryPhysicsAsset.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryPhysicsAsset\_\_](ue_ue.ActorFactoryPhysicsAsset.md#__tid_actorfactoryphysicsasset__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryPhysicsAsset.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryPhysicsAsset.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryPhysicsAsset.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryPhysicsAsset.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryPhysicsAsset.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryPhysicsAsset.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryPhysicsAsset.md#getclass)
- [GetName](ue_ue.ActorFactoryPhysicsAsset.md#getname)
- [GetOuter](ue_ue.ActorFactoryPhysicsAsset.md#getouter)
- [GetWorld](ue_ue.ActorFactoryPhysicsAsset.md#getworld)
- [Find](ue_ue.ActorFactoryPhysicsAsset.md#find)
- [Load](ue_ue.ActorFactoryPhysicsAsset.md#load)
- [StaticClass](ue_ue.ActorFactoryPhysicsAsset.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryPhysicsAsset**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13750](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13750)
...
### \_\_tid\_ActorFactoryPhysicsAsset\_\_

• **\_\_tid\_ActorFactoryPhysicsAsset\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13755](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13755)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryPhysicsAsset`](ue_ue.ActorFactoryPhysicsAsset.md)
...
[ue/ue.d.ts:13752](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13752)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryPhysicsAsset`](ue_ue.ActorFactoryPhysicsAsset.md)
...
[ue/ue.d.ts:13753](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13753)
...
[ue/ue.d.ts:13751](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13751)
