[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryPlaneReflectionCapture

# Class: ActorFactoryPlaneReflectionCapture

[ue/ue](../modules/ue_ue.md).ActorFactoryPlaneReflectionCapture
...
- [constructor](ue_ue.ActorFactoryPlaneReflectionCapture.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryPlaneReflectionCapture.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryPlaneReflectionCapture.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryPlaneReflectionCapture.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryPlaneReflectionCapture.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryPlaneReflectionCapture.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryPlaneReflectionCapture\_\_](ue_ue.ActorFactoryPlaneReflectionCapture.md#__tid_actorfactoryplanereflectioncapture__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryPlaneReflectionCapture.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryPlaneReflectionCapture.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryPlaneReflectionCapture.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryPlaneReflectionCapture.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryPlaneReflectionCapture.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryPlaneReflectionCapture.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryPlaneReflectionCapture.md#getclass)
- [GetName](ue_ue.ActorFactoryPlaneReflectionCapture.md#getname)
- [GetOuter](ue_ue.ActorFactoryPlaneReflectionCapture.md#getouter)
- [GetWorld](ue_ue.ActorFactoryPlaneReflectionCapture.md#getworld)
- [Find](ue_ue.ActorFactoryPlaneReflectionCapture.md#find)
- [Load](ue_ue.ActorFactoryPlaneReflectionCapture.md#load)
- [StaticClass](ue_ue.ActorFactoryPlaneReflectionCapture.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryPlaneReflectionCapture**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13768](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13768)
...
### \_\_tid\_ActorFactoryPlaneReflectionCapture\_\_

• **\_\_tid\_ActorFactoryPlaneReflectionCapture\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13773](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13773)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryPlaneReflectionCapture`](ue_ue.ActorFactoryPlaneReflectionCapture.md)
...
[ue/ue.d.ts:13770](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13770)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryPlaneReflectionCapture`](ue_ue.ActorFactoryPlaneReflectionCapture.md)
...
[ue/ue.d.ts:13771](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13771)
...
[ue/ue.d.ts:13769](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13769)
