[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryPlayerStart

# Class: ActorFactoryPlayerStart

[ue/ue](../modules/ue_ue.md).ActorFactoryPlayerStart
...
- [constructor](ue_ue.ActorFactoryPlayerStart.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryPlayerStart.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryPlayerStart.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryPlayerStart.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryPlayerStart.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryPlayerStart.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryPlayerStart\_\_](ue_ue.ActorFactoryPlayerStart.md#__tid_actorfactoryplayerstart__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryPlayerStart.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryPlayerStart.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryPlayerStart.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryPlayerStart.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryPlayerStart.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryPlayerStart.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryPlayerStart.md#getclass)
- [GetName](ue_ue.ActorFactoryPlayerStart.md#getname)
- [GetOuter](ue_ue.ActorFactoryPlayerStart.md#getouter)
- [GetWorld](ue_ue.ActorFactoryPlayerStart.md#getworld)
- [Find](ue_ue.ActorFactoryPlayerStart.md#find)
- [Load](ue_ue.ActorFactoryPlayerStart.md#load)
- [StaticClass](ue_ue.ActorFactoryPlayerStart.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryPlayerStart**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13777](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13777)
...
### \_\_tid\_ActorFactoryPlayerStart\_\_

• **\_\_tid\_ActorFactoryPlayerStart\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13782](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13782)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryPlayerStart`](ue_ue.ActorFactoryPlayerStart.md)
...
[ue/ue.d.ts:13779](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13779)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryPlayerStart`](ue_ue.ActorFactoryPlayerStart.md)
...
[ue/ue.d.ts:13780](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13780)
...
[ue/ue.d.ts:13778](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13778)
