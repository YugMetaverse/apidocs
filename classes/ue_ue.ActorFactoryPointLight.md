[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryPointLight

# Class: ActorFactoryPointLight

[ue/ue](../modules/ue_ue.md).ActorFactoryPointLight
...
- [constructor](ue_ue.ActorFactoryPointLight.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryPointLight.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryPointLight.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryPointLight.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryPointLight.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryPointLight.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryPointLight\_\_](ue_ue.ActorFactoryPointLight.md#__tid_actorfactorypointlight__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryPointLight.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryPointLight.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryPointLight.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryPointLight.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryPointLight.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryPointLight.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryPointLight.md#getclass)
- [GetName](ue_ue.ActorFactoryPointLight.md#getname)
- [GetOuter](ue_ue.ActorFactoryPointLight.md#getouter)
- [GetWorld](ue_ue.ActorFactoryPointLight.md#getworld)
- [Find](ue_ue.ActorFactoryPointLight.md#find)
- [Load](ue_ue.ActorFactoryPointLight.md#load)
- [StaticClass](ue_ue.ActorFactoryPointLight.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryPointLight**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13786](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13786)
...
### \_\_tid\_ActorFactoryPointLight\_\_

• **\_\_tid\_ActorFactoryPointLight\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13791](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13791)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryPointLight`](ue_ue.ActorFactoryPointLight.md)
...
[ue/ue.d.ts:13788](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13788)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryPointLight`](ue_ue.ActorFactoryPointLight.md)
...
[ue/ue.d.ts:13789](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13789)
...
[ue/ue.d.ts:13787](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13787)
