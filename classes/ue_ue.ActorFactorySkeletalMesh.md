[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactorySkeletalMesh

# Class: ActorFactorySkeletalMesh

[ue/ue](../modules/ue_ue.md).ActorFactorySkeletalMesh
...
- [constructor](ue_ue.ActorFactorySkeletalMesh.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactorySkeletalMesh.md#displayname)
- [MenuPriority](ue_ue.ActorFactorySkeletalMesh.md#menupriority)
- [NewActorClass](ue_ue.ActorFactorySkeletalMesh.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactorySkeletalMesh.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactorySkeletalMesh.md#spawnpositionoffset)
- [\_\_tid\_ActorFactorySkeletalMesh\_\_](ue_ue.ActorFactorySkeletalMesh.md#__tid_actorfactoryskeletalmesh__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactorySkeletalMesh.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactorySkeletalMesh.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactorySkeletalMesh.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactorySkeletalMesh.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactorySkeletalMesh.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactorySkeletalMesh.md#executeubergraph)
- [GetClass](ue_ue.ActorFactorySkeletalMesh.md#getclass)
- [GetName](ue_ue.ActorFactorySkeletalMesh.md#getname)
- [GetOuter](ue_ue.ActorFactorySkeletalMesh.md#getouter)
- [GetWorld](ue_ue.ActorFactorySkeletalMesh.md#getworld)
- [Find](ue_ue.ActorFactorySkeletalMesh.md#find)
- [Load](ue_ue.ActorFactorySkeletalMesh.md#load)
- [StaticClass](ue_ue.ActorFactorySkeletalMesh.md#staticclass)

## Constructors

### constructor

• **new ActorFactorySkeletalMesh**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13524](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13524)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactorySkeletalMesh`](ue_ue.ActorFactorySkeletalMesh.md)
...
[ue/ue.d.ts:13526](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13526)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactorySkeletalMesh`](ue_ue.ActorFactorySkeletalMesh.md)
...
[ue/ue.d.ts:13527](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13527)
...
[ue/ue.d.ts:13525](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13525)
