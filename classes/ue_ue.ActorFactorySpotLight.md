[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactorySpotLight

# Class: ActorFactorySpotLight

[ue/ue](../modules/ue_ue.md).ActorFactorySpotLight
...
- [constructor](ue_ue.ActorFactorySpotLight.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactorySpotLight.md#displayname)
- [MenuPriority](ue_ue.ActorFactorySpotLight.md#menupriority)
- [NewActorClass](ue_ue.ActorFactorySpotLight.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactorySpotLight.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactorySpotLight.md#spawnpositionoffset)
- [\_\_tid\_ActorFactorySpotLight\_\_](ue_ue.ActorFactorySpotLight.md#__tid_actorfactoryspotlight__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactorySpotLight.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactorySpotLight.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactorySpotLight.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactorySpotLight.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactorySpotLight.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactorySpotLight.md#executeubergraph)
- [GetClass](ue_ue.ActorFactorySpotLight.md#getclass)
- [GetName](ue_ue.ActorFactorySpotLight.md#getname)
- [GetOuter](ue_ue.ActorFactorySpotLight.md#getouter)
- [GetWorld](ue_ue.ActorFactorySpotLight.md#getworld)
- [Find](ue_ue.ActorFactorySpotLight.md#find)
- [Load](ue_ue.ActorFactorySpotLight.md#load)
- [StaticClass](ue_ue.ActorFactorySpotLight.md#staticclass)

## Constructors

### constructor

• **new ActorFactorySpotLight**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13858](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13858)
...
### \_\_tid\_ActorFactorySpotLight\_\_

• **\_\_tid\_ActorFactorySpotLight\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13863](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13863)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactorySpotLight`](ue_ue.ActorFactorySpotLight.md)
...
[ue/ue.d.ts:13860](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13860)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactorySpotLight`](ue_ue.ActorFactorySpotLight.md)
...
[ue/ue.d.ts:13861](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13861)
...
[ue/ue.d.ts:13859](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13859)
