[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryTextRender

# Class: ActorFactoryTextRender

[ue/ue](../modules/ue_ue.md).ActorFactoryTextRender
...
- [constructor](ue_ue.ActorFactoryTextRender.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryTextRender.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryTextRender.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryTextRender.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryTextRender.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryTextRender.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryTextRender\_\_](ue_ue.ActorFactoryTextRender.md#__tid_actorfactorytextrender__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryTextRender.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryTextRender.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryTextRender.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryTextRender.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryTextRender.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryTextRender.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryTextRender.md#getclass)
- [GetName](ue_ue.ActorFactoryTextRender.md#getname)
- [GetOuter](ue_ue.ActorFactoryTextRender.md#getouter)
- [GetWorld](ue_ue.ActorFactoryTextRender.md#getworld)
- [Find](ue_ue.ActorFactoryTextRender.md#find)
- [Load](ue_ue.ActorFactoryTextRender.md#load)
- [StaticClass](ue_ue.ActorFactoryTextRender.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryTextRender**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13876](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13876)
...
### \_\_tid\_ActorFactoryTextRender\_\_

• **\_\_tid\_ActorFactoryTextRender\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13881](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13881)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryTextRender`](ue_ue.ActorFactoryTextRender.md)
...
[ue/ue.d.ts:13878](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13878)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryTextRender`](ue_ue.ActorFactoryTextRender.md)
...
[ue/ue.d.ts:13879](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13879)
...
[ue/ue.d.ts:13877](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13877)
