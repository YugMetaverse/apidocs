[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryTriggerBox

# Class: ActorFactoryTriggerBox

[ue/ue](../modules/ue_ue.md).ActorFactoryTriggerBox
...
- [constructor](ue_ue.ActorFactoryTriggerBox.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryTriggerBox.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryTriggerBox.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryTriggerBox.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryTriggerBox.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryTriggerBox.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryTriggerBox\_\_](ue_ue.ActorFactoryTriggerBox.md#__tid_actorfactorytriggerbox__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryTriggerBox.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryTriggerBox.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryTriggerBox.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryTriggerBox.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryTriggerBox.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryTriggerBox.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryTriggerBox.md#getclass)
- [GetName](ue_ue.ActorFactoryTriggerBox.md#getname)
- [GetOuter](ue_ue.ActorFactoryTriggerBox.md#getouter)
- [GetWorld](ue_ue.ActorFactoryTriggerBox.md#getworld)
- [Find](ue_ue.ActorFactoryTriggerBox.md#find)
- [Load](ue_ue.ActorFactoryTriggerBox.md#load)
- [StaticClass](ue_ue.ActorFactoryTriggerBox.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryTriggerBox**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13885](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13885)
...
### \_\_tid\_ActorFactoryTriggerBox\_\_

• **\_\_tid\_ActorFactoryTriggerBox\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13890](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13890)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryTriggerBox`](ue_ue.ActorFactoryTriggerBox.md)
...
[ue/ue.d.ts:13887](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13887)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryTriggerBox`](ue_ue.ActorFactoryTriggerBox.md)
...
[ue/ue.d.ts:13888](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13888)
...
[ue/ue.d.ts:13886](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L13886)
