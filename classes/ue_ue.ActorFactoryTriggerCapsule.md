[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryTriggerCapsule

# Class: ActorFactoryTriggerCapsule

[ue/ue](../modules/ue_ue.md).ActorFactoryTriggerCapsule
...
- [constructor](ue_ue.ActorFactoryTriggerCapsule.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryTriggerCapsule.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryTriggerCapsule.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryTriggerCapsule.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryTriggerCapsule.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryTriggerCapsule.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryTriggerCapsule\_\_](ue_ue.ActorFactoryTriggerCapsule.md#__tid_actorfactorytriggercapsule__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryTriggerCapsule.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryTriggerCapsule.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryTriggerCapsule.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryTriggerCapsule.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryTriggerCapsule.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryTriggerCapsule.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryTriggerCapsule.md#getclass)
- [GetName](ue_ue.ActorFactoryTriggerCapsule.md#getname)
- [GetOuter](ue_ue.ActorFactoryTriggerCapsule.md#getouter)
- [GetWorld](ue_ue.ActorFactoryTriggerCapsule.md#getworld)
- [Find](ue_ue.ActorFactoryTriggerCapsule.md#find)
- [Load](ue_ue.ActorFactoryTriggerCapsule.md#load)
- [StaticClass](ue_ue.ActorFactoryTriggerCapsule.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryTriggerCapsule**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13894](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13894)
...
### \_\_tid\_ActorFactoryTriggerCapsule\_\_

• **\_\_tid\_ActorFactoryTriggerCapsule\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13899](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13899)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryTriggerCapsule`](ue_ue.ActorFactoryTriggerCapsule.md)
...
[ue/ue.d.ts:13896](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13896)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryTriggerCapsule`](ue_ue.ActorFactoryTriggerCapsule.md)
...
[ue/ue.d.ts:13897](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13897)
...
[ue/ue.d.ts:13895](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13895)
