[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ActorFactoryVectorFieldVolume

# Class: ActorFactoryVectorFieldVolume

[ue/ue](../modules/ue_ue.md).ActorFactoryVectorFieldVolume
...
- [constructor](ue_ue.ActorFactoryVectorFieldVolume.md#constructor)

### Properties

- [DisplayName](ue_ue.ActorFactoryVectorFieldVolume.md#displayname)
- [MenuPriority](ue_ue.ActorFactoryVectorFieldVolume.md#menupriority)
- [NewActorClass](ue_ue.ActorFactoryVectorFieldVolume.md#newactorclass)
- [NewActorClassName](ue_ue.ActorFactoryVectorFieldVolume.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.ActorFactoryVectorFieldVolume.md#spawnpositionoffset)
- [\_\_tid\_ActorFactoryVectorFieldVolume\_\_](ue_ue.ActorFactoryVectorFieldVolume.md#__tid_actorfactoryvectorfieldvolume__)
- [\_\_tid\_ActorFactory\_\_](ue_ue.ActorFactoryVectorFieldVolume.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ActorFactoryVectorFieldVolume.md#__tid_object__)
- [bShowInEditorQuickMenu](ue_ue.ActorFactoryVectorFieldVolume.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.ActorFactoryVectorFieldVolume.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.ActorFactoryVectorFieldVolume.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ActorFactoryVectorFieldVolume.md#executeubergraph)
- [GetClass](ue_ue.ActorFactoryVectorFieldVolume.md#getclass)
- [GetName](ue_ue.ActorFactoryVectorFieldVolume.md#getname)
- [GetOuter](ue_ue.ActorFactoryVectorFieldVolume.md#getouter)
- [GetWorld](ue_ue.ActorFactoryVectorFieldVolume.md#getworld)
- [Find](ue_ue.ActorFactoryVectorFieldVolume.md#find)
- [Load](ue_ue.ActorFactoryVectorFieldVolume.md#load)
- [StaticClass](ue_ue.ActorFactoryVectorFieldVolume.md#staticclass)

## Constructors

### constructor

• **new ActorFactoryVectorFieldVolume**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:13912](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13912)
...
### \_\_tid\_ActorFactoryVectorFieldVolume\_\_

• **\_\_tid\_ActorFactoryVectorFieldVolume\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:13917](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13917)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorFactoryVectorFieldVolume`](ue_ue.ActorFactoryVectorFieldVolume.md)
...
[ue/ue.d.ts:13914](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13914)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorFactoryVectorFieldVolume`](ue_ue.ActorFactoryVectorFieldVolume.md)
...
[ue/ue.d.ts:13915](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13915)
...
[ue/ue.d.ts:13913](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L13913)
