[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AlembicTestCommandlet

# Class: AlembicTestCommandlet

[ue/ue](../modules/ue_ue.md).AlembicTestCommandlet
...
- [constructor](ue_ue.AlembicTestCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.AlembicTestCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.AlembicTestCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.AlembicTestCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.AlembicTestCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.AlembicTestCommandlet.md#helpweblink)
- [IsClient](ue_ue.AlembicTestCommandlet.md#isclient)
- [IsEditor](ue_ue.AlembicTestCommandlet.md#iseditor)
- [IsServer](ue_ue.AlembicTestCommandlet.md#isserver)
- [LogToConsole](ue_ue.AlembicTestCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.AlembicTestCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.AlembicTestCommandlet.md#showprogress)
- [\_\_tid\_AlembicTestCommandlet\_\_](ue_ue.AlembicTestCommandlet.md#__tid_alembictestcommandlet__)
- [\_\_tid\_Commandlet\_\_](ue_ue.AlembicTestCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.AlembicTestCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.AlembicTestCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AlembicTestCommandlet.md#executeubergraph)
- [GetClass](ue_ue.AlembicTestCommandlet.md#getclass)
- [GetName](ue_ue.AlembicTestCommandlet.md#getname)
- [GetOuter](ue_ue.AlembicTestCommandlet.md#getouter)
- [GetWorld](ue_ue.AlembicTestCommandlet.md#getworld)
- [Find](ue_ue.AlembicTestCommandlet.md#find)
- [Load](ue_ue.AlembicTestCommandlet.md#load)
- [StaticClass](ue_ue.AlembicTestCommandlet.md#staticclass)

## Constructors

### constructor

• **new AlembicTestCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:16186](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16186)
...
### \_\_tid\_AlembicTestCommandlet\_\_

• **\_\_tid\_AlembicTestCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:16191](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16191)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AlembicTestCommandlet`](ue_ue.AlembicTestCommandlet.md)
...
[ue/ue.d.ts:16188](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16188)

___

### Load

▸ `Static` **Load**(`InName`): [`AlembicTestCommandlet`](ue_ue.AlembicTestCommandlet.md)
...
[ue/ue.d.ts:16189](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16189)
...
[ue/ue.d.ts:16187](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16187)
