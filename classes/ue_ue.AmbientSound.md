[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AmbientSound

# Class: AmbientSound

[ue/ue](../modules/ue_ue.md).AmbientSound
...
- [constructor](ue_ue.AmbientSound.md#constructor)

### Properties

- [ActorLabel](ue_ue.AmbientSound.md#actorlabel)
- [AttachmentReplication](ue_ue.AmbientSound.md#attachmentreplication)
- [AudioComponent](ue_ue.AmbientSound.md#audiocomponent)
- [AutoReceiveInput](ue_ue.AmbientSound.md#autoreceiveinput)
- [BlueprintCreatedComponents](ue_ue.AmbientSound.md#blueprintcreatedcomponents)
- [Children](ue_ue.AmbientSound.md#children)
- [ControllingMatineeActors](ue_ue.AmbientSound.md#controllingmatineeactors)
- [CustomTimeDilation](ue_ue.AmbientSound.md#customtimedilation)
- [DefaultUpdateOverlapsMethodDuringLevelStreaming](ue_ue.AmbientSound.md#defaultupdateoverlapsmethodduringlevelstreaming)
- [FolderPath](ue_ue.AmbientSound.md#folderpath)
- [GroupActor](ue_ue.AmbientSound.md#groupactor)
- [HiddenEditorViews](ue_ue.AmbientSound.md#hiddeneditorviews)
- [InitialLifeSpan](ue_ue.AmbientSound.md#initiallifespan)
- [InputComponent](ue_ue.AmbientSound.md#inputcomponent)
- [InputPriority](ue_ue.AmbientSound.md#inputpriority)
- [InstanceComponents](ue_ue.AmbientSound.md#instancecomponents)
- [Instigator](ue_ue.AmbientSound.md#instigator)
- [Layers](ue_ue.AmbientSound.md#layers)
- [MinNetUpdateFrequency](ue_ue.AmbientSound.md#minnetupdatefrequency)
- [NetCullDistanceSquared](ue_ue.AmbientSound.md#netculldistancesquared)
- [NetDormancy](ue_ue.AmbientSound.md#netdormancy)
- [NetDriverName](ue_ue.AmbientSound.md#netdrivername)
- [NetPriority](ue_ue.AmbientSound.md#netpriority)
- [NetTag](ue_ue.AmbientSound.md#nettag)
- [NetUpdateFrequency](ue_ue.AmbientSound.md#netupdatefrequency)
- [OnActorBeginOverlap](ue_ue.AmbientSound.md#onactorbeginoverlap)
- [OnActorEndOverlap](ue_ue.AmbientSound.md#onactorendoverlap)
- [OnActorHit](ue_ue.AmbientSound.md#onactorhit)
- [OnBeginCursorOver](ue_ue.AmbientSound.md#onbegincursorover)
- [OnClicked](ue_ue.AmbientSound.md#onclicked)
- [OnDestroyed](ue_ue.AmbientSound.md#ondestroyed)
- [OnEndCursorOver](ue_ue.AmbientSound.md#onendcursorover)
- [OnEndPlay](ue_ue.AmbientSound.md#onendplay)
- [OnInputTouchBegin](ue_ue.AmbientSound.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue.AmbientSound.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue.AmbientSound.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue.AmbientSound.md#oninputtouchleave)
- [OnReleased](ue_ue.AmbientSound.md#onreleased)
- [OnTakeAnyDamage](ue_ue.AmbientSound.md#ontakeanydamage)
- [OnTakePointDamage](ue_ue.AmbientSound.md#ontakepointdamage)
- [OnTakeRadialDamage](ue_ue.AmbientSound.md#ontakeradialdamage)
- [Owner](ue_ue.AmbientSound.md#owner)
- [ParentComponent](ue_ue.AmbientSound.md#parentcomponent)
- [ParentComponentActor](ue_ue.AmbientSound.md#parentcomponentactor)
- [PivotOffset](ue_ue.AmbientSound.md#pivotoffset)
- [PrimaryActorTick](ue_ue.AmbientSound.md#primaryactortick)
- [RemoteRole](ue_ue.AmbientSound.md#remoterole)
- [ReplicatedMovement](ue_ue.AmbientSound.md#replicatedmovement)
- [Role](ue_ue.AmbientSound.md#role)
- [RootComponent](ue_ue.AmbientSound.md#rootcomponent)
- [SpawnCollisionHandlingMethod](ue_ue.AmbientSound.md#spawncollisionhandlingmethod)
- [SpriteScale](ue_ue.AmbientSound.md#spritescale)
- [Tags](ue_ue.AmbientSound.md#tags)
- [UpdateOverlapsMethodDuringLevelStreaming](ue_ue.AmbientSound.md#updateoverlapsmethodduringlevelstreaming)
- [\_\_tid\_Actor\_\_](ue_ue.AmbientSound.md#__tid_actor__)
- [\_\_tid\_AmbientSound\_\_](ue_ue.AmbientSound.md#__tid_ambientsound__)
- [\_\_tid\_Object\_\_](ue_ue.AmbientSound.md#__tid_object__)
- [bActorEnableCollision](ue_ue.AmbientSound.md#bactorenablecollision)
- [bActorIsBeingDestroyed](ue_ue.AmbientSound.md#bactorisbeingdestroyed)
- [bActorLabelEditable](ue_ue.AmbientSound.md#bactorlabeleditable)
- [bActorSeamlessTraveled](ue_ue.AmbientSound.md#bactorseamlesstraveled)
- [bAllowReceiveTickEventOnDedicatedServer](ue_ue.AmbientSound.md#ballowreceivetickeventondedicatedserver)
- [bAllowTickBeforeBeginPlay](ue_ue.AmbientSound.md#ballowtickbeforebeginplay)
- [bAlwaysRelevant](ue_ue.AmbientSound.md#balwaysrelevant)
- [bAutoDestroyWhenFinished](ue_ue.AmbientSound.md#bautodestroywhenfinished)
- [bBlockInput](ue_ue.AmbientSound.md#bblockinput)
- [bCanBeDamaged](ue_ue.AmbientSound.md#bcanbedamaged)
- [bCanBeInCluster](ue_ue.AmbientSound.md#bcanbeincluster)
- [bCollideWhenPlacing](ue_ue.AmbientSound.md#bcollidewhenplacing)
- [bEditable](ue_ue.AmbientSound.md#beditable)
- [bEnableAutoLODGeneration](ue_ue.AmbientSound.md#benableautolodgeneration)
- [bExchangedRoles](ue_ue.AmbientSound.md#bexchangedroles)
- [bFindCameraComponentWhenViewTarget](ue_ue.AmbientSound.md#bfindcameracomponentwhenviewtarget)
- [bGenerateOverlapEventsDuringLevelStreaming](ue_ue.AmbientSound.md#bgenerateoverlapeventsduringlevelstreaming)
- [bHidden](ue_ue.AmbientSound.md#bhidden)
- [bHiddenEd](ue_ue.AmbientSound.md#bhiddened)
- [bHiddenEdLayer](ue_ue.AmbientSound.md#bhiddenedlayer)
- [bHiddenEdLevel](ue_ue.AmbientSound.md#bhiddenedlevel)
- [bHiddenEdTemporary](ue_ue.AmbientSound.md#bhiddenedtemporary)
- [bIgnoresOriginShifting](ue_ue.AmbientSound.md#bignoresoriginshifting)
- [bIsEditorOnlyActor](ue_ue.AmbientSound.md#biseditoronlyactor)
- [bIsEditorPreviewActor](ue_ue.AmbientSound.md#biseditorpreviewactor)
- [bListedInSceneOutliner](ue_ue.AmbientSound.md#blistedinsceneoutliner)
- [bLockLocation](ue_ue.AmbientSound.md#blocklocation)
- [bNetLoadOnClient](ue_ue.AmbientSound.md#bnetloadonclient)
- [bNetStartup](ue_ue.AmbientSound.md#bnetstartup)
- [bNetTemporary](ue_ue.AmbientSound.md#bnettemporary)
- [bNetUseOwnerRelevancy](ue_ue.AmbientSound.md#bnetuseownerrelevancy)
- [bOnlyRelevantToOwner](ue_ue.AmbientSound.md#bonlyrelevanttoowner)
- [bOptimizeBPComponentData](ue_ue.AmbientSound.md#boptimizebpcomponentdata)
- [bRelevantForLevelBounds](ue_ue.AmbientSound.md#brelevantforlevelbounds)
- [bRelevantForNetworkReplays](ue_ue.AmbientSound.md#brelevantfornetworkreplays)
- [bReplayRewindable](ue_ue.AmbientSound.md#breplayrewindable)
- [bReplicateMovement](ue_ue.AmbientSound.md#breplicatemovement)
- [bReplicates](ue_ue.AmbientSound.md#breplicates)
- [bTearOff](ue_ue.AmbientSound.md#btearoff)

### Methods

- [ActorHasTag](ue_ue.AmbientSound.md#actorhastag)
- [AddComponent](ue_ue.AmbientSound.md#addcomponent)
- [AddTickPrerequisiteActor](ue_ue.AmbientSound.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.AmbientSound.md#addtickprerequisitecomponent)
- [AdjustVolume](ue_ue.AmbientSound.md#adjustvolume)
- [CreateDefaultSubobject](ue_ue.AmbientSound.md#createdefaultsubobject)
- [DetachRootComponentFromParent](ue_ue.AmbientSound.md#detachrootcomponentfromparent)
- [DisableInput](ue_ue.AmbientSound.md#disableinput)
- [EnableInput](ue_ue.AmbientSound.md#enableinput)
- [ExecuteUbergraph](ue_ue.AmbientSound.md#executeubergraph)
- [FadeIn](ue_ue.AmbientSound.md#fadein)
- [FadeOut](ue_ue.AmbientSound.md#fadeout)
- [FlushNetDormancy](ue_ue.AmbientSound.md#flushnetdormancy)
- [ForceNetUpdate](ue_ue.AmbientSound.md#forcenetupdate)
- [GetActorBounds](ue_ue.AmbientSound.md#getactorbounds)
- [GetActorEnableCollision](ue_ue.AmbientSound.md#getactorenablecollision)
- [GetActorEyesViewPoint](ue_ue.AmbientSound.md#getactoreyesviewpoint)
- [GetActorForwardVector](ue_ue.AmbientSound.md#getactorforwardvector)
- [GetActorLabel](ue_ue.AmbientSound.md#getactorlabel)
- [GetActorRelativeScale3D](ue_ue.AmbientSound.md#getactorrelativescale3d)
- [GetActorRightVector](ue_ue.AmbientSound.md#getactorrightvector)
- [GetActorScale3D](ue_ue.AmbientSound.md#getactorscale3d)
- [GetActorTickInterval](ue_ue.AmbientSound.md#getactortickinterval)
- [GetActorTimeDilation](ue_ue.AmbientSound.md#getactortimedilation)
- [GetActorUpVector](ue_ue.AmbientSound.md#getactorupvector)
- [GetAllChildActors](ue_ue.AmbientSound.md#getallchildactors)
- [GetAttachParentActor](ue_ue.AmbientSound.md#getattachparentactor)
- [GetAttachParentSocketName](ue_ue.AmbientSound.md#getattachparentsocketname)
- [GetAttachedActors](ue_ue.AmbientSound.md#getattachedactors)
- [GetClass](ue_ue.AmbientSound.md#getclass)
- [GetComponentByClass](ue_ue.AmbientSound.md#getcomponentbyclass)
- [GetComponentsByInterface](ue_ue.AmbientSound.md#getcomponentsbyinterface)
- [GetComponentsByTag](ue_ue.AmbientSound.md#getcomponentsbytag)
- [GetDistanceTo](ue_ue.AmbientSound.md#getdistanceto)
- [GetDotProductTo](ue_ue.AmbientSound.md#getdotproductto)
- [GetFolderPath](ue_ue.AmbientSound.md#getfolderpath)
- [GetGameTimeSinceCreation](ue_ue.AmbientSound.md#getgametimesincecreation)
- [GetHorizontalDistanceTo](ue_ue.AmbientSound.md#gethorizontaldistanceto)
- [GetHorizontalDotProductTo](ue_ue.AmbientSound.md#gethorizontaldotproductto)
- [GetInputAxisKeyValue](ue_ue.AmbientSound.md#getinputaxiskeyvalue)
- [GetInputAxisValue](ue_ue.AmbientSound.md#getinputaxisvalue)
- [GetInputVectorAxisValue](ue_ue.AmbientSound.md#getinputvectoraxisvalue)
- [GetInstigator](ue_ue.AmbientSound.md#getinstigator)
- [GetInstigatorController](ue_ue.AmbientSound.md#getinstigatorcontroller)
- [GetLifeSpan](ue_ue.AmbientSound.md#getlifespan)
- [GetLocalRole](ue_ue.AmbientSound.md#getlocalrole)
- [GetName](ue_ue.AmbientSound.md#getname)
- [GetOuter](ue_ue.AmbientSound.md#getouter)
- [GetOverlappingActors](ue_ue.AmbientSound.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue.AmbientSound.md#getoverlappingcomponents)
- [GetOwner](ue_ue.AmbientSound.md#getowner)
- [GetParentActor](ue_ue.AmbientSound.md#getparentactor)
- [GetParentComponent](ue_ue.AmbientSound.md#getparentcomponent)
- [GetRemoteRole](ue_ue.AmbientSound.md#getremoterole)
- [GetSquaredDistanceTo](ue_ue.AmbientSound.md#getsquareddistanceto)
- [GetTickableWhenPaused](ue_ue.AmbientSound.md#gettickablewhenpaused)
- [GetTransform](ue_ue.AmbientSound.md#gettransform)
- [GetVelocity](ue_ue.AmbientSound.md#getvelocity)
- [GetVerticalDistanceTo](ue_ue.AmbientSound.md#getverticaldistanceto)
- [GetWorld](ue_ue.AmbientSound.md#getworld)
- [HasAuthority](ue_ue.AmbientSound.md#hasauthority)
- [IsActorBeingDestroyed](ue_ue.AmbientSound.md#isactorbeingdestroyed)
- [IsActorTickEnabled](ue_ue.AmbientSound.md#isactortickenabled)
- [IsChildActor](ue_ue.AmbientSound.md#ischildactor)
- [IsEditable](ue_ue.AmbientSound.md#iseditable)
- [IsHiddenEd](ue_ue.AmbientSound.md#ishiddened)
- [IsHiddenEdAtStartup](ue_ue.AmbientSound.md#ishiddenedatstartup)
- [IsOverlappingActor](ue_ue.AmbientSound.md#isoverlappingactor)
- [IsSelectable](ue_ue.AmbientSound.md#isselectable)
- [IsTemporarilyHiddenInEditor](ue_ue.AmbientSound.md#istemporarilyhiddenineditor)
- [K2\_AddActorLocalOffset](ue_ue.AmbientSound.md#k2_addactorlocaloffset)
- [K2\_AddActorLocalRotation](ue_ue.AmbientSound.md#k2_addactorlocalrotation)
- [K2\_AddActorLocalTransform](ue_ue.AmbientSound.md#k2_addactorlocaltransform)
- [K2\_AddActorWorldOffset](ue_ue.AmbientSound.md#k2_addactorworldoffset)
- [K2\_AddActorWorldRotation](ue_ue.AmbientSound.md#k2_addactorworldrotation)
- [K2\_AddActorWorldTransform](ue_ue.AmbientSound.md#k2_addactorworldtransform)
- [K2\_AttachRootComponentTo](ue_ue.AmbientSound.md#k2_attachrootcomponentto)
- [K2\_AttachRootComponentToActor](ue_ue.AmbientSound.md#k2_attachrootcomponenttoactor)
- [K2\_AttachToActor](ue_ue.AmbientSound.md#k2_attachtoactor)
- [K2\_AttachToComponent](ue_ue.AmbientSound.md#k2_attachtocomponent)
- [K2\_DestroyActor](ue_ue.AmbientSound.md#k2_destroyactor)
- [K2\_DestroyComponent](ue_ue.AmbientSound.md#k2_destroycomponent)
- [K2\_DetachFromActor](ue_ue.AmbientSound.md#k2_detachfromactor)
- [K2\_GetActorLocation](ue_ue.AmbientSound.md#k2_getactorlocation)
- [K2\_GetActorRotation](ue_ue.AmbientSound.md#k2_getactorrotation)
- [K2\_GetComponentsByClass](ue_ue.AmbientSound.md#k2_getcomponentsbyclass)
- [K2\_GetRootComponent](ue_ue.AmbientSound.md#k2_getrootcomponent)
- [K2\_OnBecomeViewTarget](ue_ue.AmbientSound.md#k2_onbecomeviewtarget)
- [K2\_OnEndViewTarget](ue_ue.AmbientSound.md#k2_onendviewtarget)
- [K2\_OnReset](ue_ue.AmbientSound.md#k2_onreset)
- [K2\_SetActorLocation](ue_ue.AmbientSound.md#k2_setactorlocation)
- [K2\_SetActorLocationAndRotation](ue_ue.AmbientSound.md#k2_setactorlocationandrotation)
- [K2\_SetActorRelativeLocation](ue_ue.AmbientSound.md#k2_setactorrelativelocation)
- [K2\_SetActorRelativeRotation](ue_ue.AmbientSound.md#k2_setactorrelativerotation)
- [K2\_SetActorRelativeTransform](ue_ue.AmbientSound.md#k2_setactorrelativetransform)
- [K2\_SetActorRotation](ue_ue.AmbientSound.md#k2_setactorrotation)
- [K2\_SetActorTransform](ue_ue.AmbientSound.md#k2_setactortransform)
- [K2\_TeleportTo](ue_ue.AmbientSound.md#k2_teleportto)
- [MakeMIDForMaterial](ue_ue.AmbientSound.md#makemidformaterial)
- [MakeNoise](ue_ue.AmbientSound.md#makenoise)
- [OnRep\_AttachmentReplication](ue_ue.AmbientSound.md#onrep_attachmentreplication)
- [OnRep\_Instigator](ue_ue.AmbientSound.md#onrep_instigator)
- [OnRep\_Owner](ue_ue.AmbientSound.md#onrep_owner)
- [OnRep\_ReplicateMovement](ue_ue.AmbientSound.md#onrep_replicatemovement)
- [OnRep\_ReplicatedMovement](ue_ue.AmbientSound.md#onrep_replicatedmovement)
- [Play](ue_ue.AmbientSound.md#play)
- [PrestreamTextures](ue_ue.AmbientSound.md#prestreamtextures)
- [ReceiveActorBeginCursorOver](ue_ue.AmbientSound.md#receiveactorbegincursorover)
- [ReceiveActorBeginOverlap](ue_ue.AmbientSound.md#receiveactorbeginoverlap)
- [ReceiveActorEndCursorOver](ue_ue.AmbientSound.md#receiveactorendcursorover)
- [ReceiveActorEndOverlap](ue_ue.AmbientSound.md#receiveactorendoverlap)
- [ReceiveActorOnClicked](ue_ue.AmbientSound.md#receiveactoronclicked)
- [ReceiveActorOnInputTouchBegin](ue_ue.AmbientSound.md#receiveactoroninputtouchbegin)
- [ReceiveActorOnInputTouchEnd](ue_ue.AmbientSound.md#receiveactoroninputtouchend)
- [ReceiveActorOnInputTouchEnter](ue_ue.AmbientSound.md#receiveactoroninputtouchenter)
- [ReceiveActorOnInputTouchLeave](ue_ue.AmbientSound.md#receiveactoroninputtouchleave)
- [ReceiveActorOnReleased](ue_ue.AmbientSound.md#receiveactoronreleased)
- [ReceiveAnyDamage](ue_ue.AmbientSound.md#receiveanydamage)
- [ReceiveBeginPlay](ue_ue.AmbientSound.md#receivebeginplay)
- [ReceiveDestroyed](ue_ue.AmbientSound.md#receivedestroyed)
- [ReceiveEndPlay](ue_ue.AmbientSound.md#receiveendplay)
- [ReceiveHit](ue_ue.AmbientSound.md#receivehit)
- [ReceivePointDamage](ue_ue.AmbientSound.md#receivepointdamage)
- [ReceiveRadialDamage](ue_ue.AmbientSound.md#receiveradialdamage)
- [ReceiveTick](ue_ue.AmbientSound.md#receivetick)
- [RemoveTickPrerequisiteActor](ue_ue.AmbientSound.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.AmbientSound.md#removetickprerequisitecomponent)
- [SetActorEnableCollision](ue_ue.AmbientSound.md#setactorenablecollision)
- [SetActorHiddenInGame](ue_ue.AmbientSound.md#setactorhiddeningame)
- [SetActorLabel](ue_ue.AmbientSound.md#setactorlabel)
- [SetActorRelativeScale3D](ue_ue.AmbientSound.md#setactorrelativescale3d)
- [SetActorScale3D](ue_ue.AmbientSound.md#setactorscale3d)
- [SetActorTickEnabled](ue_ue.AmbientSound.md#setactortickenabled)
- [SetActorTickInterval](ue_ue.AmbientSound.md#setactortickinterval)
- [SetFolderPath](ue_ue.AmbientSound.md#setfolderpath)
- [SetIsTemporarilyHiddenInEditor](ue_ue.AmbientSound.md#setistemporarilyhiddenineditor)
- [SetLifeSpan](ue_ue.AmbientSound.md#setlifespan)
- [SetNetDormancy](ue_ue.AmbientSound.md#setnetdormancy)
- [SetOwner](ue_ue.AmbientSound.md#setowner)
- [SetReplicateMovement](ue_ue.AmbientSound.md#setreplicatemovement)
- [SetReplicates](ue_ue.AmbientSound.md#setreplicates)
- [SetTickGroup](ue_ue.AmbientSound.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.AmbientSound.md#settickablewhenpaused)
- [SnapRootComponentTo](ue_ue.AmbientSound.md#snaprootcomponentto)
- [Stop](ue_ue.AmbientSound.md#stop)
- [TearOff](ue_ue.AmbientSound.md#tearoff)
- [UserConstructionScript](ue_ue.AmbientSound.md#userconstructionscript)
- [WasRecentlyRendered](ue_ue.AmbientSound.md#wasrecentlyrendered)
- [Find](ue_ue.AmbientSound.md#find)
- [Load](ue_ue.AmbientSound.md#load)
- [StaticClass](ue_ue.AmbientSound.md#staticclass)

## Constructors

### constructor

• **new AmbientSound**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:16338](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16338)
...
[ue/ue.d.ts:16339](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16339)
...
### \_\_tid\_AmbientSound\_\_

• **\_\_tid\_AmbientSound\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:16349](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16349)
...
▸ **AdjustVolume**(`AdjustVolumeDuration`, `AdjustVolumeLevel`): `void`
...
[ue/ue.d.ts:16340](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16340)
...
▸ **FadeIn**(`FadeInDuration`, `FadeVolumeLevel?`): `void`
...
[ue/ue.d.ts:16341](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16341)

___

### FadeOut

▸ **FadeOut**(`FadeOutDuration`, `FadeVolumeLevel`): `void`
...
[ue/ue.d.ts:16342](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16342)
...
[ue/ue.d.ts:16343](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16343)
...
[ue/ue.d.ts:16344](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16344)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AmbientSound`](ue_ue.AmbientSound.md)
...
[ue/ue.d.ts:16346](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16346)

___

### Load

▸ `Static` **Load**(`InName`): [`AmbientSound`](ue_ue.AmbientSound.md)
...
[ue/ue.d.ts:16347](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16347)
...
[ue/ue.d.ts:16345](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16345)
