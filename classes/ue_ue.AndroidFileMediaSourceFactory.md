[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AndroidFileMediaSourceFactory

# Class: AndroidFileMediaSourceFactory

[ue/ue](../modules/ue_ue.md).AndroidFileMediaSourceFactory
...
- [constructor](ue_ue.AndroidFileMediaSourceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.AndroidFileMediaSourceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.AndroidFileMediaSourceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.AndroidFileMediaSourceFactory.md#contextclass)
- [Formats](ue_ue.AndroidFileMediaSourceFactory.md#formats)
- [ImportPriority](ue_ue.AndroidFileMediaSourceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.AndroidFileMediaSourceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.AndroidFileMediaSourceFactory.md#supportedclass)
- [\_\_tid\_AndroidFileMediaSourceFactory\_\_](ue_ue.AndroidFileMediaSourceFactory.md#__tid_androidfilemediasourcefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.AndroidFileMediaSourceFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.AndroidFileMediaSourceFactory.md#__tid_object__)
- [bCreateNew](ue_ue.AndroidFileMediaSourceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.AndroidFileMediaSourceFactory.md#beditafternew)
- [bEditorImport](ue_ue.AndroidFileMediaSourceFactory.md#beditorimport)
- [bText](ue_ue.AndroidFileMediaSourceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.AndroidFileMediaSourceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AndroidFileMediaSourceFactory.md#executeubergraph)
- [GetClass](ue_ue.AndroidFileMediaSourceFactory.md#getclass)
- [GetName](ue_ue.AndroidFileMediaSourceFactory.md#getname)
- [GetOuter](ue_ue.AndroidFileMediaSourceFactory.md#getouter)
- [GetWorld](ue_ue.AndroidFileMediaSourceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.AndroidFileMediaSourceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.AndroidFileMediaSourceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.AndroidFileMediaSourceFactory.md#find)
- [Load](ue_ue.AndroidFileMediaSourceFactory.md#load)
- [StaticClass](ue_ue.AndroidFileMediaSourceFactory.md#staticclass)

## Constructors

### constructor

• **new AndroidFileMediaSourceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:16363](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16363)
...
### \_\_tid\_AndroidFileMediaSourceFactory\_\_

• **\_\_tid\_AndroidFileMediaSourceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:16368](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16368)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AndroidFileMediaSourceFactory`](ue_ue.AndroidFileMediaSourceFactory.md)
...
[ue/ue.d.ts:16365](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16365)

___

### Load

▸ `Static` **Load**(`InName`): [`AndroidFileMediaSourceFactory`](ue_ue.AndroidFileMediaSourceFactory.md)
...
[ue/ue.d.ts:16366](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16366)
...
[ue/ue.d.ts:16364](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L16364)
