[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimCompositeFactory

# Class: AnimCompositeFactory

[ue/ue](../modules/ue_ue.md).AnimCompositeFactory
...
- [constructor](ue_ue.AnimCompositeFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.AnimCompositeFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.AnimCompositeFactory.md#automatedimportdata)
- [ContextClass](ue_ue.AnimCompositeFactory.md#contextclass)
- [Formats](ue_ue.AnimCompositeFactory.md#formats)
- [ImportPriority](ue_ue.AnimCompositeFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.AnimCompositeFactory.md#overwriteyesornotoallstate)
- [PreviewSkeletalMesh](ue_ue.AnimCompositeFactory.md#previewskeletalmesh)
- [SourceAnimation](ue_ue.AnimCompositeFactory.md#sourceanimation)
- [SupportedClass](ue_ue.AnimCompositeFactory.md#supportedclass)
- [TargetSkeleton](ue_ue.AnimCompositeFactory.md#targetskeleton)
- [\_\_tid\_AnimCompositeFactory\_\_](ue_ue.AnimCompositeFactory.md#__tid_animcompositefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.AnimCompositeFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.AnimCompositeFactory.md#__tid_object__)
- [bCreateNew](ue_ue.AnimCompositeFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.AnimCompositeFactory.md#beditafternew)
- [bEditorImport](ue_ue.AnimCompositeFactory.md#beditorimport)
- [bText](ue_ue.AnimCompositeFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimCompositeFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimCompositeFactory.md#executeubergraph)
- [GetClass](ue_ue.AnimCompositeFactory.md#getclass)
- [GetName](ue_ue.AnimCompositeFactory.md#getname)
- [GetOuter](ue_ue.AnimCompositeFactory.md#getouter)
- [GetWorld](ue_ue.AnimCompositeFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.AnimCompositeFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.AnimCompositeFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.AnimCompositeFactory.md#find)
- [Load](ue_ue.AnimCompositeFactory.md#load)
- [StaticClass](ue_ue.AnimCompositeFactory.md#staticclass)

## Constructors

### constructor

• **new AnimCompositeFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:17363](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17363)
...
[ue/ue.d.ts:17366](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17366)
...
[ue/ue.d.ts:17365](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17365)
...
[ue/ue.d.ts:17364](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17364)

___

### \_\_tid\_AnimCompositeFactory\_\_

• **\_\_tid\_AnimCompositeFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:17371](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17371)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimCompositeFactory`](ue_ue.AnimCompositeFactory.md)
...
[ue/ue.d.ts:17368](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17368)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimCompositeFactory`](ue_ue.AnimCompositeFactory.md)
...
[ue/ue.d.ts:17369](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17369)
...
[ue/ue.d.ts:17367](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L17367)
