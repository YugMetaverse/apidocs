[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_ApplyAdditive

# Class: AnimGraphNode\_ApplyAdditive

[ue/ue](../modules/ue_ue.md).AnimGraphNode_ApplyAdditive
...
- [constructor](ue_ue.AnimGraphNode_ApplyAdditive.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_ApplyAdditive.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_ApplyAdditive.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_ApplyAdditive.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_ApplyAdditive.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_ApplyAdditive.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_ApplyAdditive.md#errortype)
- [Node](ue_ue.AnimGraphNode_ApplyAdditive.md#node)
- [NodeComment](ue_ue.AnimGraphNode_ApplyAdditive.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_ApplyAdditive.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_ApplyAdditive.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_ApplyAdditive.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_ApplyAdditive.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_ApplyAdditive.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_ApplyAdditive.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_ApplyAdditive.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_ApplyAdditive\_\_](ue_ue.AnimGraphNode_ApplyAdditive.md#__tid_animgraphnode_applyadditive__)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_ApplyAdditive.md#__tid_animgraphnode_base__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_ApplyAdditive.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_ApplyAdditive.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_ApplyAdditive.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_ApplyAdditive.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_ApplyAdditive.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_ApplyAdditive.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_ApplyAdditive.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_ApplyAdditive.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_ApplyAdditive.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_ApplyAdditive.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_ApplyAdditive.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_ApplyAdditive.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_ApplyAdditive.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_ApplyAdditive.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_ApplyAdditive.md#getclass)
- [GetName](ue_ue.AnimGraphNode_ApplyAdditive.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_ApplyAdditive.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_ApplyAdditive.md#getworld)
- [Find](ue_ue.AnimGraphNode_ApplyAdditive.md#find)
- [Load](ue_ue.AnimGraphNode_ApplyAdditive.md#load)
- [StaticClass](ue_ue.AnimGraphNode_ApplyAdditive.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_ApplyAdditive**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:17909](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17909)
...
• **Node**: [`AnimNode_ApplyAdditive`](ue_ue.AnimNode_ApplyAdditive.md)

#### Defined in

[ue/ue.d.ts:17910](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17910)
...
### \_\_tid\_AnimGraphNode\_ApplyAdditive\_\_

• **\_\_tid\_AnimGraphNode\_ApplyAdditive\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:17915](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17915)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_ApplyAdditive`](ue_ue.AnimGraphNode_ApplyAdditive.md)
...
[ue/ue.d.ts:17912](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17912)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_ApplyAdditive`](ue_ue.AnimGraphNode_ApplyAdditive.md)
...
[ue/ue.d.ts:17913](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17913)
...
[ue/ue.d.ts:17911](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17911)
