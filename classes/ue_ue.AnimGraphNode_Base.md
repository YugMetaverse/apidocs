[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_Base

# Class: AnimGraphNode\_Base

[ue/ue](../modules/ue_ue.md).AnimGraphNode_Base
...
- [`K2Node`](ue_ue.K2Node.md)
  ...
  ↳↳ [`AnimGraphNode_TransitionResult`](ue_ue.AnimGraphNode_TransitionResult.md)
  ...
  ↳↳ [`AnimGraphNode_ApplyAdditive`](ue_ue.AnimGraphNode_ApplyAdditive.md)

  ↳↳ [`AnimGraphNode_ApplyMeshSpaceAdditive`](ue_ue.AnimGraphNode_ApplyMeshSpaceAdditive.md)

  ↳↳ [`AnimGraphNode_BlendBoneByChannel`](ue_ue.AnimGraphNode_BlendBoneByChannel.md)

  ↳↳ [`AnimGraphNode_BlendListBase`](ue_ue.AnimGraphNode_BlendListBase.md)

  ↳↳ [`AnimGraphNode_ComponentToLocalSpace`](ue_ue.AnimGraphNode_ComponentToLocalSpace.md)

  ↳↳ [`AnimGraphNode_CopyPoseFromMesh`](ue_ue.AnimGraphNode_CopyPoseFromMesh.md)

  ↳↳ [`AnimGraphNode_CurveSource`](ue_ue.AnimGraphNode_CurveSource.md)
  ...
  ↳↳ [`AnimGraphNode_Inertialization`](ue_ue.AnimGraphNode_Inertialization.md)
  ...
  ↳↳ [`AnimGraphNode_MakeDynamicAdditive`](ue_ue.AnimGraphNode_MakeDynamicAdditive.md)

  ↳↳ [`AnimGraphNode_MeshRefPose`](ue_ue.AnimGraphNode_MeshRefPose.md)

  ↳↳ [`AnimGraphNode_ModifyCurve`](ue_ue.AnimGraphNode_ModifyCurve.md)

  ↳↳ [`AnimGraphNode_MultiWayBlend`](ue_ue.AnimGraphNode_MultiWayBlend.md)

  ↳↳ [`AnimGraphNode_PoseSnapshot`](ue_ue.AnimGraphNode_PoseSnapshot.md)

  ↳↳ [`AnimGraphNode_RandomPlayer`](ue_ue.AnimGraphNode_RandomPlayer.md)

  ↳↳ [`AnimGraphNode_Root`](ue_ue.AnimGraphNode_Root.md)

  ↳↳ [`AnimGraphNode_RotateRootBone`](ue_ue.AnimGraphNode_RotateRootBone.md)

  ↳↳ [`AnimGraphNode_SaveCachedPose`](ue_ue.AnimGraphNode_SaveCachedPose.md)

  ↳↳ [`AnimGraphNode_ScaleChainLength`](ue_ue.AnimGraphNode_ScaleChainLength.md)

  ↳↳ [`AnimGraphNode_Slot`](ue_ue.AnimGraphNode_Slot.md)

  ↳↳ [`AnimGraphNode_SteamVRInputAnimPose`](ue_ue.AnimGraphNode_SteamVRInputAnimPose.md)

  ↳↳ [`AnimGraphNode_SteamVRSetWristTransform`](ue_ue.AnimGraphNode_SteamVRSetWristTransform.md)

  ↳↳ [`AnimGraphNode_TransitionPoseEvaluator`](ue_ue.AnimGraphNode_TransitionPoseEvaluator.md)

  ↳↳ [`AnimGraphNode_TwoWayBlend`](ue_ue.AnimGraphNode_TwoWayBlend.md)
...
- [constructor](ue_ue.AnimGraphNode_Base.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_Base.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_Base.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_Base.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_Base.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_Base.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_Base.md#errortype)
- [NodeComment](ue_ue.AnimGraphNode_Base.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_Base.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_Base.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_Base.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_Base.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_Base.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_Base.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_Base.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_Base.md#__tid_animgraphnode_base__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_Base.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_Base.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_Base.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_Base.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_Base.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_Base.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_Base.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_Base.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_Base.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_Base.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_Base.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_Base.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_Base.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_Base.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_Base.md#getclass)
- [GetName](ue_ue.AnimGraphNode_Base.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_Base.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_Base.md#getworld)
- [Find](ue_ue.AnimGraphNode_Base.md#find)
- [Load](ue_ue.AnimGraphNode_Base.md#load)
- [StaticClass](ue_ue.AnimGraphNode_Base.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_Base**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:16777](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16777)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_Base`](ue_ue.AnimGraphNode_Base.md)
...
[ue/ue.d.ts:16781](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16781)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_Base`](ue_ue.AnimGraphNode_Base.md)
...
[ue/ue.d.ts:16782](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16782)
...
[ue/ue.d.ts:16780](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L16780)
