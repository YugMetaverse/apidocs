[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_CopyBone

# Class: AnimGraphNode\_CopyBone

[ue/ue](../modules/ue_ue.md).AnimGraphNode_CopyBone
...
- [constructor](ue_ue.AnimGraphNode_CopyBone.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_CopyBone.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_CopyBone.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_CopyBone.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_CopyBone.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_CopyBone.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_CopyBone.md#errortype)
- [Node](ue_ue.AnimGraphNode_CopyBone.md#node)
- [NodeComment](ue_ue.AnimGraphNode_CopyBone.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_CopyBone.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_CopyBone.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_CopyBone.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_CopyBone.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_CopyBone.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_CopyBone.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_CopyBone.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_CopyBone.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_CopyBone\_\_](ue_ue.AnimGraphNode_CopyBone.md#__tid_animgraphnode_copybone__)
- [\_\_tid\_AnimGraphNode\_SkeletalControlBase\_\_](ue_ue.AnimGraphNode_CopyBone.md#__tid_animgraphnode_skeletalcontrolbase__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_CopyBone.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_CopyBone.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_CopyBone.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_CopyBone.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_CopyBone.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_CopyBone.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_CopyBone.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_CopyBone.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_CopyBone.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_CopyBone.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_CopyBone.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_CopyBone.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_CopyBone.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_CopyBone.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_CopyBone.md#getclass)
- [GetName](ue_ue.AnimGraphNode_CopyBone.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_CopyBone.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_CopyBone.md#getworld)
- [Find](ue_ue.AnimGraphNode_CopyBone.md#find)
- [Load](ue_ue.AnimGraphNode_CopyBone.md#load)
- [StaticClass](ue_ue.AnimGraphNode_CopyBone.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_CopyBone**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:18353](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18353)
...
• **Node**: [`AnimNode_CopyBone`](ue_ue.AnimNode_CopyBone.md)

#### Defined in

[ue/ue.d.ts:18354](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18354)
...
### \_\_tid\_AnimGraphNode\_CopyBone\_\_

• **\_\_tid\_AnimGraphNode\_CopyBone\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:18359](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18359)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_CopyBone`](ue_ue.AnimGraphNode_CopyBone.md)
...
[ue/ue.d.ts:18356](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18356)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_CopyBone`](ue_ue.AnimGraphNode_CopyBone.md)
...
[ue/ue.d.ts:18357](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18357)
...
[ue/ue.d.ts:18355](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18355)
