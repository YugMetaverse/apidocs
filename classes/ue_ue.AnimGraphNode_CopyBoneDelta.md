[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_CopyBoneDelta

# Class: AnimGraphNode\_CopyBoneDelta

[ue/ue](../modules/ue_ue.md).AnimGraphNode_CopyBoneDelta
...
- [constructor](ue_ue.AnimGraphNode_CopyBoneDelta.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_CopyBoneDelta.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_CopyBoneDelta.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_CopyBoneDelta.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_CopyBoneDelta.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_CopyBoneDelta.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_CopyBoneDelta.md#errortype)
- [Node](ue_ue.AnimGraphNode_CopyBoneDelta.md#node)
- [NodeComment](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_CopyBoneDelta.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_CopyBoneDelta.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_CopyBoneDelta.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_CopyBoneDelta\_\_](ue_ue.AnimGraphNode_CopyBoneDelta.md#__tid_animgraphnode_copybonedelta__)
- [\_\_tid\_AnimGraphNode\_SkeletalControlBase\_\_](ue_ue.AnimGraphNode_CopyBoneDelta.md#__tid_animgraphnode_skeletalcontrolbase__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_CopyBoneDelta.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_CopyBoneDelta.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_CopyBoneDelta.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_CopyBoneDelta.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_CopyBoneDelta.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_CopyBoneDelta.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_CopyBoneDelta.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_CopyBoneDelta.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_CopyBoneDelta.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_CopyBoneDelta.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_CopyBoneDelta.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_CopyBoneDelta.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_CopyBoneDelta.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_CopyBoneDelta.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_CopyBoneDelta.md#getclass)
- [GetName](ue_ue.AnimGraphNode_CopyBoneDelta.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_CopyBoneDelta.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_CopyBoneDelta.md#getworld)
- [Find](ue_ue.AnimGraphNode_CopyBoneDelta.md#find)
- [Load](ue_ue.AnimGraphNode_CopyBoneDelta.md#load)
- [StaticClass](ue_ue.AnimGraphNode_CopyBoneDelta.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_CopyBoneDelta**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:18384](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18384)
...
• **Node**: [`AnimNode_CopyBoneDelta`](ue_ue.AnimNode_CopyBoneDelta.md)

#### Defined in

[ue/ue.d.ts:18385](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18385)
...
### \_\_tid\_AnimGraphNode\_CopyBoneDelta\_\_

• **\_\_tid\_AnimGraphNode\_CopyBoneDelta\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:18390](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18390)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_CopyBoneDelta`](ue_ue.AnimGraphNode_CopyBoneDelta.md)
...
[ue/ue.d.ts:18387](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18387)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_CopyBoneDelta`](ue_ue.AnimGraphNode_CopyBoneDelta.md)
...
[ue/ue.d.ts:18388](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18388)
...
[ue/ue.d.ts:18386](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18386)
