[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_CurveSource

# Class: AnimGraphNode\_CurveSource

[ue/ue](../modules/ue_ue.md).AnimGraphNode_CurveSource
...
- [constructor](ue_ue.AnimGraphNode_CurveSource.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_CurveSource.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_CurveSource.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_CurveSource.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_CurveSource.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_CurveSource.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_CurveSource.md#errortype)
- [Node](ue_ue.AnimGraphNode_CurveSource.md#node)
- [NodeComment](ue_ue.AnimGraphNode_CurveSource.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_CurveSource.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_CurveSource.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_CurveSource.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_CurveSource.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_CurveSource.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_CurveSource.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_CurveSource.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_CurveSource.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_CurveSource\_\_](ue_ue.AnimGraphNode_CurveSource.md#__tid_animgraphnode_curvesource__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_CurveSource.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_CurveSource.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_CurveSource.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_CurveSource.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_CurveSource.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_CurveSource.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_CurveSource.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_CurveSource.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_CurveSource.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_CurveSource.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_CurveSource.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_CurveSource.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_CurveSource.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_CurveSource.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_CurveSource.md#getclass)
- [GetName](ue_ue.AnimGraphNode_CurveSource.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_CurveSource.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_CurveSource.md#getworld)
- [Find](ue_ue.AnimGraphNode_CurveSource.md#find)
- [Load](ue_ue.AnimGraphNode_CurveSource.md#load)
- [StaticClass](ue_ue.AnimGraphNode_CurveSource.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_CurveSource**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:18458](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18458)
...
• **Node**: [`AnimNode_CurveSource`](ue_ue.AnimNode_CurveSource.md)

#### Defined in

[ue/ue.d.ts:18459](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18459)
...
### \_\_tid\_AnimGraphNode\_CurveSource\_\_

• **\_\_tid\_AnimGraphNode\_CurveSource\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:18464](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18464)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_CurveSource`](ue_ue.AnimGraphNode_CurveSource.md)
...
[ue/ue.d.ts:18461](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18461)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_CurveSource`](ue_ue.AnimGraphNode_CurveSource.md)
...
[ue/ue.d.ts:18462](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18462)
...
[ue/ue.d.ts:18460](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18460)
