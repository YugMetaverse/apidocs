[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_CustomProperty

# Class: AnimGraphNode\_CustomProperty

[ue/ue](../modules/ue_ue.md).AnimGraphNode_CustomProperty
...
- [constructor](ue_ue.AnimGraphNode_CustomProperty.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_CustomProperty.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_CustomProperty.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_CustomProperty.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_CustomProperty.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_CustomProperty.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_CustomProperty.md#errortype)
- [ExposedPropertyNames](ue_ue.AnimGraphNode_CustomProperty.md#exposedpropertynames)
- [KnownExposableProperties](ue_ue.AnimGraphNode_CustomProperty.md#knownexposableproperties)
- [NodeComment](ue_ue.AnimGraphNode_CustomProperty.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_CustomProperty.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_CustomProperty.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_CustomProperty.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_CustomProperty.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_CustomProperty.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_CustomProperty.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_CustomProperty.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_CustomProperty.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_CustomProperty\_\_](ue_ue.AnimGraphNode_CustomProperty.md#__tid_animgraphnode_customproperty__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_CustomProperty.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_CustomProperty.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_CustomProperty.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_CustomProperty.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_CustomProperty.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_CustomProperty.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_CustomProperty.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_CustomProperty.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_CustomProperty.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_CustomProperty.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_CustomProperty.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_CustomProperty.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_CustomProperty.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_CustomProperty.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_CustomProperty.md#getclass)
- [GetName](ue_ue.AnimGraphNode_CustomProperty.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_CustomProperty.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_CustomProperty.md#getworld)
- [Find](ue_ue.AnimGraphNode_CustomProperty.md#find)
- [Load](ue_ue.AnimGraphNode_CustomProperty.md#load)
- [StaticClass](ue_ue.AnimGraphNode_CustomProperty.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_CustomProperty**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:18468](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18468)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_CustomProperty`](ue_ue.AnimGraphNode_CustomProperty.md)
...
[ue/ue.d.ts:18472](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18472)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_CustomProperty`](ue_ue.AnimGraphNode_CustomProperty.md)
...
[ue/ue.d.ts:18473](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18473)
...
[ue/ue.d.ts:18471](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18471)
