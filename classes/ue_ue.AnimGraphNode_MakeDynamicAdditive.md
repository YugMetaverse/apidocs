[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_MakeDynamicAdditive

# Class: AnimGraphNode\_MakeDynamicAdditive

[ue/ue](../modules/ue_ue.md).AnimGraphNode_MakeDynamicAdditive
...
- [constructor](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#errortype)
- [Node](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#node)
- [NodeComment](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_MakeDynamicAdditive\_\_](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#__tid_animgraphnode_makedynamicadditive__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#getclass)
- [GetName](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#getworld)
- [Find](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#find)
- [Load](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#load)
- [StaticClass](ue_ue.AnimGraphNode_MakeDynamicAdditive.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_MakeDynamicAdditive**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:18935](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18935)
...
• **Node**: [`AnimNode_MakeDynamicAdditive`](ue_ue.AnimNode_MakeDynamicAdditive.md)

#### Defined in

[ue/ue.d.ts:18936](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18936)
...
### \_\_tid\_AnimGraphNode\_MakeDynamicAdditive\_\_

• **\_\_tid\_AnimGraphNode\_MakeDynamicAdditive\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:18941](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18941)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_MakeDynamicAdditive`](ue_ue.AnimGraphNode_MakeDynamicAdditive.md)
...
[ue/ue.d.ts:18938](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18938)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_MakeDynamicAdditive`](ue_ue.AnimGraphNode_MakeDynamicAdditive.md)
...
[ue/ue.d.ts:18939](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18939)
...
[ue/ue.d.ts:18937](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L18937)
