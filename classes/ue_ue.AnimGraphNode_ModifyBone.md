[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_ModifyBone

# Class: AnimGraphNode\_ModifyBone

[ue/ue](../modules/ue_ue.md).AnimGraphNode_ModifyBone
...
- [constructor](ue_ue.AnimGraphNode_ModifyBone.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_ModifyBone.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_ModifyBone.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_ModifyBone.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_ModifyBone.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_ModifyBone.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_ModifyBone.md#errortype)
- [Node](ue_ue.AnimGraphNode_ModifyBone.md#node)
- [NodeComment](ue_ue.AnimGraphNode_ModifyBone.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_ModifyBone.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_ModifyBone.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_ModifyBone.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_ModifyBone.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_ModifyBone.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_ModifyBone.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_ModifyBone.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_ModifyBone.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_ModifyBone\_\_](ue_ue.AnimGraphNode_ModifyBone.md#__tid_animgraphnode_modifybone__)
- [\_\_tid\_AnimGraphNode\_SkeletalControlBase\_\_](ue_ue.AnimGraphNode_ModifyBone.md#__tid_animgraphnode_skeletalcontrolbase__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_ModifyBone.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_ModifyBone.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_ModifyBone.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_ModifyBone.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_ModifyBone.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_ModifyBone.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_ModifyBone.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_ModifyBone.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_ModifyBone.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_ModifyBone.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_ModifyBone.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_ModifyBone.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_ModifyBone.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_ModifyBone.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_ModifyBone.md#getclass)
- [GetName](ue_ue.AnimGraphNode_ModifyBone.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_ModifyBone.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_ModifyBone.md#getworld)
- [Find](ue_ue.AnimGraphNode_ModifyBone.md#find)
- [Load](ue_ue.AnimGraphNode_ModifyBone.md#load)
- [StaticClass](ue_ue.AnimGraphNode_ModifyBone.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_ModifyBone**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:18987](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18987)
...
• **Node**: [`AnimNode_ModifyBone`](ue_ue.AnimNode_ModifyBone.md)

#### Defined in

[ue/ue.d.ts:18988](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18988)
...
### \_\_tid\_AnimGraphNode\_ModifyBone\_\_

• **\_\_tid\_AnimGraphNode\_ModifyBone\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:18993](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18993)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_ModifyBone`](ue_ue.AnimGraphNode_ModifyBone.md)
...
[ue/ue.d.ts:18990](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18990)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_ModifyBone`](ue_ue.AnimGraphNode_ModifyBone.md)
...
[ue/ue.d.ts:18991](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18991)
...
[ue/ue.d.ts:18989](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L18989)
