[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_ModifyCurve

# Class: AnimGraphNode\_ModifyCurve

[ue/ue](../modules/ue_ue.md).AnimGraphNode_ModifyCurve
...
- [constructor](ue_ue.AnimGraphNode_ModifyCurve.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_ModifyCurve.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_ModifyCurve.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_ModifyCurve.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_ModifyCurve.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_ModifyCurve.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_ModifyCurve.md#errortype)
- [Node](ue_ue.AnimGraphNode_ModifyCurve.md#node)
- [NodeComment](ue_ue.AnimGraphNode_ModifyCurve.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_ModifyCurve.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_ModifyCurve.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_ModifyCurve.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_ModifyCurve.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_ModifyCurve.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_ModifyCurve.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_ModifyCurve.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_ModifyCurve.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_ModifyCurve\_\_](ue_ue.AnimGraphNode_ModifyCurve.md#__tid_animgraphnode_modifycurve__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_ModifyCurve.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_ModifyCurve.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_ModifyCurve.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_ModifyCurve.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_ModifyCurve.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_ModifyCurve.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_ModifyCurve.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_ModifyCurve.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_ModifyCurve.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_ModifyCurve.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_ModifyCurve.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_ModifyCurve.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_ModifyCurve.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_ModifyCurve.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_ModifyCurve.md#getclass)
- [GetName](ue_ue.AnimGraphNode_ModifyCurve.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_ModifyCurve.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_ModifyCurve.md#getworld)
- [Find](ue_ue.AnimGraphNode_ModifyCurve.md#find)
- [Load](ue_ue.AnimGraphNode_ModifyCurve.md#load)
- [StaticClass](ue_ue.AnimGraphNode_ModifyCurve.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_ModifyCurve**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19014](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19014)
...
• **Node**: [`AnimNode_ModifyCurve`](ue_ue.AnimNode_ModifyCurve.md)

#### Defined in

[ue/ue.d.ts:19015](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19015)
...
### \_\_tid\_AnimGraphNode\_ModifyCurve\_\_

• **\_\_tid\_AnimGraphNode\_ModifyCurve\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19020](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19020)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_ModifyCurve`](ue_ue.AnimGraphNode_ModifyCurve.md)
...
[ue/ue.d.ts:19017](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19017)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_ModifyCurve`](ue_ue.AnimGraphNode_ModifyCurve.md)
...
[ue/ue.d.ts:19018](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19018)
...
[ue/ue.d.ts:19016](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19016)
