[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_PoseByName

# Class: AnimGraphNode\_PoseByName

[ue/ue](../modules/ue_ue.md).AnimGraphNode_PoseByName
...
- [constructor](ue_ue.AnimGraphNode_PoseByName.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_PoseByName.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_PoseByName.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_PoseByName.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_PoseByName.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_PoseByName.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_PoseByName.md#errortype)
- [Node](ue_ue.AnimGraphNode_PoseByName.md#node)
- [NodeComment](ue_ue.AnimGraphNode_PoseByName.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_PoseByName.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_PoseByName.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_PoseByName.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_PoseByName.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_PoseByName.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_PoseByName.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_PoseByName.md#showpinforproperties)
- [SyncGroup](ue_ue.AnimGraphNode_PoseByName.md#syncgroup)
- [\_\_tid\_AnimGraphNode\_AssetPlayerBase\_\_](ue_ue.AnimGraphNode_PoseByName.md#__tid_animgraphnode_assetplayerbase__)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_PoseByName.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_PoseByName\_\_](ue_ue.AnimGraphNode_PoseByName.md#__tid_animgraphnode_posebyname__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_PoseByName.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_PoseByName.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_PoseByName.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_PoseByName.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_PoseByName.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_PoseByName.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_PoseByName.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_PoseByName.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_PoseByName.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_PoseByName.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_PoseByName.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_PoseByName.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_PoseByName.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_PoseByName.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_PoseByName.md#getclass)
- [GetName](ue_ue.AnimGraphNode_PoseByName.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_PoseByName.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_PoseByName.md#getworld)
- [Find](ue_ue.AnimGraphNode_PoseByName.md#find)
- [Load](ue_ue.AnimGraphNode_PoseByName.md#load)
- [StaticClass](ue_ue.AnimGraphNode_PoseByName.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_PoseByName**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19135](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19135)
...
• **Node**: [`AnimNode_PoseByName`](ue_ue.AnimNode_PoseByName.md)

#### Defined in

[ue/ue.d.ts:19136](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19136)
...
### \_\_tid\_AnimGraphNode\_PoseByName\_\_

• **\_\_tid\_AnimGraphNode\_PoseByName\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19141](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19141)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_PoseByName`](ue_ue.AnimGraphNode_PoseByName.md)
...
[`AnimGraphNode_PoseByName`](ue_ue.AnimGraphNode_PoseByName.md)
...
[ue/ue.d.ts:19138](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19138)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_PoseByName`](ue_ue.AnimGraphNode_PoseByName.md)
...
[ue/ue.d.ts:19139](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19139)
...
[ue/ue.d.ts:19137](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19137)
