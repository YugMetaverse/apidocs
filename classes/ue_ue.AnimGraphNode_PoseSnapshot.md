[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_PoseSnapshot

# Class: AnimGraphNode\_PoseSnapshot

[ue/ue](../modules/ue_ue.md).AnimGraphNode_PoseSnapshot
...
- [constructor](ue_ue.AnimGraphNode_PoseSnapshot.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_PoseSnapshot.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_PoseSnapshot.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_PoseSnapshot.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_PoseSnapshot.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_PoseSnapshot.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_PoseSnapshot.md#errortype)
- [Node](ue_ue.AnimGraphNode_PoseSnapshot.md#node)
- [NodeComment](ue_ue.AnimGraphNode_PoseSnapshot.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_PoseSnapshot.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_PoseSnapshot.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_PoseSnapshot.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_PoseSnapshot.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_PoseSnapshot.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_PoseSnapshot.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_PoseSnapshot.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_PoseSnapshot.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_PoseSnapshot\_\_](ue_ue.AnimGraphNode_PoseSnapshot.md#__tid_animgraphnode_posesnapshot__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_PoseSnapshot.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_PoseSnapshot.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_PoseSnapshot.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_PoseSnapshot.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_PoseSnapshot.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_PoseSnapshot.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_PoseSnapshot.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_PoseSnapshot.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_PoseSnapshot.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_PoseSnapshot.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_PoseSnapshot.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_PoseSnapshot.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_PoseSnapshot.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_PoseSnapshot.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_PoseSnapshot.md#getclass)
- [GetName](ue_ue.AnimGraphNode_PoseSnapshot.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_PoseSnapshot.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_PoseSnapshot.md#getworld)
- [Find](ue_ue.AnimGraphNode_PoseSnapshot.md#find)
- [Load](ue_ue.AnimGraphNode_PoseSnapshot.md#load)
- [StaticClass](ue_ue.AnimGraphNode_PoseSnapshot.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_PoseSnapshot**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19259](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19259)
...
• **Node**: [`AnimNode_PoseSnapshot`](ue_ue.AnimNode_PoseSnapshot.md)

#### Defined in

[ue/ue.d.ts:19260](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19260)
...
### \_\_tid\_AnimGraphNode\_PoseSnapshot\_\_

• **\_\_tid\_AnimGraphNode\_PoseSnapshot\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19265](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19265)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_PoseSnapshot`](ue_ue.AnimGraphNode_PoseSnapshot.md)
...
[ue/ue.d.ts:19262](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19262)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_PoseSnapshot`](ue_ue.AnimGraphNode_PoseSnapshot.md)
...
[ue/ue.d.ts:19263](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19263)
...
[ue/ue.d.ts:19261](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19261)
