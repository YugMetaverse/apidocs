[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_RotateRootBone

# Class: AnimGraphNode\_RotateRootBone

[ue/ue](../modules/ue_ue.md).AnimGraphNode_RotateRootBone
...
- [constructor](ue_ue.AnimGraphNode_RotateRootBone.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_RotateRootBone.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_RotateRootBone.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_RotateRootBone.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_RotateRootBone.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_RotateRootBone.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_RotateRootBone.md#errortype)
- [Node](ue_ue.AnimGraphNode_RotateRootBone.md#node)
- [NodeComment](ue_ue.AnimGraphNode_RotateRootBone.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_RotateRootBone.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_RotateRootBone.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_RotateRootBone.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_RotateRootBone.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_RotateRootBone.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_RotateRootBone.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_RotateRootBone.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_RotateRootBone.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_RotateRootBone\_\_](ue_ue.AnimGraphNode_RotateRootBone.md#__tid_animgraphnode_rotaterootbone__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_RotateRootBone.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_RotateRootBone.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_RotateRootBone.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_RotateRootBone.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_RotateRootBone.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_RotateRootBone.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_RotateRootBone.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_RotateRootBone.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_RotateRootBone.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_RotateRootBone.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_RotateRootBone.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_RotateRootBone.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_RotateRootBone.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_RotateRootBone.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_RotateRootBone.md#getclass)
- [GetName](ue_ue.AnimGraphNode_RotateRootBone.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_RotateRootBone.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_RotateRootBone.md#getworld)
- [Find](ue_ue.AnimGraphNode_RotateRootBone.md#find)
- [Load](ue_ue.AnimGraphNode_RotateRootBone.md#load)
- [StaticClass](ue_ue.AnimGraphNode_RotateRootBone.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_RotateRootBone**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19434](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19434)
...
• **Node**: [`AnimNode_RotateRootBone`](ue_ue.AnimNode_RotateRootBone.md)

#### Defined in

[ue/ue.d.ts:19435](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19435)
...
### \_\_tid\_AnimGraphNode\_RotateRootBone\_\_

• **\_\_tid\_AnimGraphNode\_RotateRootBone\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19440](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19440)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_RotateRootBone`](ue_ue.AnimGraphNode_RotateRootBone.md)
...
[ue/ue.d.ts:19437](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19437)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_RotateRootBone`](ue_ue.AnimGraphNode_RotateRootBone.md)
...
[ue/ue.d.ts:19438](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19438)
...
[ue/ue.d.ts:19436](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19436)
