[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_SaveCachedPose

# Class: AnimGraphNode\_SaveCachedPose

[ue/ue](../modules/ue_ue.md).AnimGraphNode_SaveCachedPose
...
- [constructor](ue_ue.AnimGraphNode_SaveCachedPose.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_SaveCachedPose.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_SaveCachedPose.md#blueprintusage)
- [CacheName](ue_ue.AnimGraphNode_SaveCachedPose.md#cachename)
- [DeprecatedPins](ue_ue.AnimGraphNode_SaveCachedPose.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_SaveCachedPose.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_SaveCachedPose.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_SaveCachedPose.md#errortype)
- [Node](ue_ue.AnimGraphNode_SaveCachedPose.md#node)
- [NodeComment](ue_ue.AnimGraphNode_SaveCachedPose.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_SaveCachedPose.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_SaveCachedPose.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_SaveCachedPose.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_SaveCachedPose.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_SaveCachedPose.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_SaveCachedPose.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_SaveCachedPose.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_SaveCachedPose.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_SaveCachedPose\_\_](ue_ue.AnimGraphNode_SaveCachedPose.md#__tid_animgraphnode_savecachedpose__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_SaveCachedPose.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_SaveCachedPose.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_SaveCachedPose.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_SaveCachedPose.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_SaveCachedPose.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_SaveCachedPose.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_SaveCachedPose.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_SaveCachedPose.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_SaveCachedPose.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_SaveCachedPose.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_SaveCachedPose.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_SaveCachedPose.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_SaveCachedPose.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_SaveCachedPose.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_SaveCachedPose.md#getclass)
- [GetName](ue_ue.AnimGraphNode_SaveCachedPose.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_SaveCachedPose.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_SaveCachedPose.md#getworld)
- [Find](ue_ue.AnimGraphNode_SaveCachedPose.md#find)
- [Load](ue_ue.AnimGraphNode_SaveCachedPose.md#load)
- [StaticClass](ue_ue.AnimGraphNode_SaveCachedPose.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_SaveCachedPose**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19513](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19513)
...
[ue/ue.d.ts:19515](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19515)
...
• **Node**: [`AnimNode_SaveCachedPose`](ue_ue.AnimNode_SaveCachedPose.md)

#### Defined in

[ue/ue.d.ts:19514](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19514)
...
### \_\_tid\_AnimGraphNode\_SaveCachedPose\_\_

• **\_\_tid\_AnimGraphNode\_SaveCachedPose\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19520](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19520)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_SaveCachedPose`](ue_ue.AnimGraphNode_SaveCachedPose.md)
...
[ue/ue.d.ts:19517](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19517)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_SaveCachedPose`](ue_ue.AnimGraphNode_SaveCachedPose.md)
...
[ue/ue.d.ts:19518](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19518)
...
[ue/ue.d.ts:19516](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L19516)
