[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_ScaleChainLength

# Class: AnimGraphNode\_ScaleChainLength

[ue/ue](../modules/ue_ue.md).AnimGraphNode_ScaleChainLength
...
- [constructor](ue_ue.AnimGraphNode_ScaleChainLength.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_ScaleChainLength.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_ScaleChainLength.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_ScaleChainLength.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_ScaleChainLength.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_ScaleChainLength.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_ScaleChainLength.md#errortype)
- [Node](ue_ue.AnimGraphNode_ScaleChainLength.md#node)
- [NodeComment](ue_ue.AnimGraphNode_ScaleChainLength.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_ScaleChainLength.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_ScaleChainLength.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_ScaleChainLength.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_ScaleChainLength.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_ScaleChainLength.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_ScaleChainLength.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_ScaleChainLength.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_ScaleChainLength.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_ScaleChainLength\_\_](ue_ue.AnimGraphNode_ScaleChainLength.md#__tid_animgraphnode_scalechainlength__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_ScaleChainLength.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_ScaleChainLength.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_ScaleChainLength.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_ScaleChainLength.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_ScaleChainLength.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_ScaleChainLength.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_ScaleChainLength.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_ScaleChainLength.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_ScaleChainLength.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_ScaleChainLength.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_ScaleChainLength.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_ScaleChainLength.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_ScaleChainLength.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_ScaleChainLength.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_ScaleChainLength.md#getclass)
- [GetName](ue_ue.AnimGraphNode_ScaleChainLength.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_ScaleChainLength.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_ScaleChainLength.md#getworld)
- [Find](ue_ue.AnimGraphNode_ScaleChainLength.md#find)
- [Load](ue_ue.AnimGraphNode_ScaleChainLength.md#load)
- [StaticClass](ue_ue.AnimGraphNode_ScaleChainLength.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_ScaleChainLength**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19544](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19544)
...
• **Node**: [`AnimNode_ScaleChainLength`](ue_ue.AnimNode_ScaleChainLength.md)

#### Defined in

[ue/ue.d.ts:19545](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19545)
...
### \_\_tid\_AnimGraphNode\_ScaleChainLength\_\_

• **\_\_tid\_AnimGraphNode\_ScaleChainLength\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19550](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19550)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_ScaleChainLength`](ue_ue.AnimGraphNode_ScaleChainLength.md)
...
[ue/ue.d.ts:19547](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19547)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_ScaleChainLength`](ue_ue.AnimGraphNode_ScaleChainLength.md)
...
[ue/ue.d.ts:19548](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19548)
...
[ue/ue.d.ts:19546](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19546)
