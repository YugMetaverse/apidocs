[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimGraphNode\_SpringBone

# Class: AnimGraphNode\_SpringBone

[ue/ue](../modules/ue_ue.md).AnimGraphNode_SpringBone
...
- [constructor](ue_ue.AnimGraphNode_SpringBone.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.AnimGraphNode_SpringBone.md#advancedpindisplay)
- [BlueprintUsage](ue_ue.AnimGraphNode_SpringBone.md#blueprintusage)
- [DeprecatedPins](ue_ue.AnimGraphNode_SpringBone.md#deprecatedpins)
- [EnabledState](ue_ue.AnimGraphNode_SpringBone.md#enabledstate)
- [ErrorMsg](ue_ue.AnimGraphNode_SpringBone.md#errormsg)
- [ErrorType](ue_ue.AnimGraphNode_SpringBone.md#errortype)
- [Node](ue_ue.AnimGraphNode_SpringBone.md#node)
- [NodeComment](ue_ue.AnimGraphNode_SpringBone.md#nodecomment)
- [NodeGuid](ue_ue.AnimGraphNode_SpringBone.md#nodeguid)
- [NodeHeight](ue_ue.AnimGraphNode_SpringBone.md#nodeheight)
- [NodePosX](ue_ue.AnimGraphNode_SpringBone.md#nodeposx)
- [NodePosY](ue_ue.AnimGraphNode_SpringBone.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.AnimGraphNode_SpringBone.md#nodeupgrademessage)
- [NodeWidth](ue_ue.AnimGraphNode_SpringBone.md#nodewidth)
- [ShowPinForProperties](ue_ue.AnimGraphNode_SpringBone.md#showpinforproperties)
- [\_\_tid\_AnimGraphNode\_Base\_\_](ue_ue.AnimGraphNode_SpringBone.md#__tid_animgraphnode_base__)
- [\_\_tid\_AnimGraphNode\_SkeletalControlBase\_\_](ue_ue.AnimGraphNode_SpringBone.md#__tid_animgraphnode_skeletalcontrolbase__)
- [\_\_tid\_AnimGraphNode\_SpringBone\_\_](ue_ue.AnimGraphNode_SpringBone.md#__tid_animgraphnode_springbone__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.AnimGraphNode_SpringBone.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_\_](ue_ue.AnimGraphNode_SpringBone.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.AnimGraphNode_SpringBone.md#__tid_object__)
- [bCanRenameNode](ue_ue.AnimGraphNode_SpringBone.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.AnimGraphNode_SpringBone.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.AnimGraphNode_SpringBone.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.AnimGraphNode_SpringBone.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.AnimGraphNode_SpringBone.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.AnimGraphNode_SpringBone.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.AnimGraphNode_SpringBone.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.AnimGraphNode_SpringBone.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.AnimGraphNode_SpringBone.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimGraphNode_SpringBone.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimGraphNode_SpringBone.md#executeubergraph)
- [GetClass](ue_ue.AnimGraphNode_SpringBone.md#getclass)
- [GetName](ue_ue.AnimGraphNode_SpringBone.md#getname)
- [GetOuter](ue_ue.AnimGraphNode_SpringBone.md#getouter)
- [GetWorld](ue_ue.AnimGraphNode_SpringBone.md#getworld)
- [Find](ue_ue.AnimGraphNode_SpringBone.md#find)
- [Load](ue_ue.AnimGraphNode_SpringBone.md#load)
- [StaticClass](ue_ue.AnimGraphNode_SpringBone.md#staticclass)

## Constructors

### constructor

• **new AnimGraphNode_SpringBone**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:19691](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19691)
...
• **Node**: [`AnimNode_SpringBone`](ue_ue.AnimNode_SpringBone.md)

#### Defined in

[ue/ue.d.ts:19692](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19692)
...
### \_\_tid\_AnimGraphNode\_SpringBone\_\_

• **\_\_tid\_AnimGraphNode\_SpringBone\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:19697](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19697)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimGraphNode_SpringBone`](ue_ue.AnimGraphNode_SpringBone.md)
...
[ue/ue.d.ts:19694](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19694)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimGraphNode_SpringBone`](ue_ue.AnimGraphNode_SpringBone.md)
...
[ue/ue.d.ts:19695](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19695)
...
[ue/ue.d.ts:19693](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L19693)
