[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimSequenceThumbnailRenderer

# Class: AnimSequenceThumbnailRenderer

[ue/ue](../modules/ue_ue.md).AnimSequenceThumbnailRenderer
...
- [constructor](ue_ue.AnimSequenceThumbnailRenderer.md#constructor)

### Properties

- [DefaultSizeX](ue_ue.AnimSequenceThumbnailRenderer.md#defaultsizex)
- [DefaultSizeY](ue_ue.AnimSequenceThumbnailRenderer.md#defaultsizey)
- [\_\_tid\_AnimSequenceThumbnailRenderer\_\_](ue_ue.AnimSequenceThumbnailRenderer.md#__tid_animsequencethumbnailrenderer__)
- [\_\_tid\_DefaultSizedThumbnailRenderer\_\_](ue_ue.AnimSequenceThumbnailRenderer.md#__tid_defaultsizedthumbnailrenderer__)
- [\_\_tid\_Object\_\_](ue_ue.AnimSequenceThumbnailRenderer.md#__tid_object__)
- [\_\_tid\_ThumbnailRenderer\_\_](ue_ue.AnimSequenceThumbnailRenderer.md#__tid_thumbnailrenderer__)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimSequenceThumbnailRenderer.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimSequenceThumbnailRenderer.md#executeubergraph)
- [GetClass](ue_ue.AnimSequenceThumbnailRenderer.md#getclass)
- [GetName](ue_ue.AnimSequenceThumbnailRenderer.md#getname)
- [GetOuter](ue_ue.AnimSequenceThumbnailRenderer.md#getouter)
- [GetWorld](ue_ue.AnimSequenceThumbnailRenderer.md#getworld)
- [Find](ue_ue.AnimSequenceThumbnailRenderer.md#find)
- [Load](ue_ue.AnimSequenceThumbnailRenderer.md#load)
- [StaticClass](ue_ue.AnimSequenceThumbnailRenderer.md#staticclass)

## Constructors

### constructor

• **new AnimSequenceThumbnailRenderer**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:20380](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L20380)
...
### \_\_tid\_AnimSequenceThumbnailRenderer\_\_

• **\_\_tid\_AnimSequenceThumbnailRenderer\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:20385](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L20385)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimSequenceThumbnailRenderer`](ue_ue.AnimSequenceThumbnailRenderer.md)
...
[ue/ue.d.ts:20382](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L20382)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimSequenceThumbnailRenderer`](ue_ue.AnimSequenceThumbnailRenderer.md)
...
[ue/ue.d.ts:20383](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L20383)
...
[ue/ue.d.ts:20381](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L20381)
