[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimationSharingSetupFactory

# Class: AnimationSharingSetupFactory

[ue/ue](../modules/ue_ue.md).AnimationSharingSetupFactory
...
- [constructor](ue_ue.AnimationSharingSetupFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.AnimationSharingSetupFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.AnimationSharingSetupFactory.md#automatedimportdata)
- [ContextClass](ue_ue.AnimationSharingSetupFactory.md#contextclass)
- [Formats](ue_ue.AnimationSharingSetupFactory.md#formats)
- [ImportPriority](ue_ue.AnimationSharingSetupFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.AnimationSharingSetupFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.AnimationSharingSetupFactory.md#supportedclass)
- [\_\_tid\_AnimationSharingSetupFactory\_\_](ue_ue.AnimationSharingSetupFactory.md#__tid_animationsharingsetupfactory__)
- [\_\_tid\_Factory\_\_](ue_ue.AnimationSharingSetupFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.AnimationSharingSetupFactory.md#__tid_object__)
- [bCreateNew](ue_ue.AnimationSharingSetupFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.AnimationSharingSetupFactory.md#beditafternew)
- [bEditorImport](ue_ue.AnimationSharingSetupFactory.md#beditorimport)
- [bText](ue_ue.AnimationSharingSetupFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimationSharingSetupFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimationSharingSetupFactory.md#executeubergraph)
- [GetClass](ue_ue.AnimationSharingSetupFactory.md#getclass)
- [GetName](ue_ue.AnimationSharingSetupFactory.md#getname)
- [GetOuter](ue_ue.AnimationSharingSetupFactory.md#getouter)
- [GetWorld](ue_ue.AnimationSharingSetupFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.AnimationSharingSetupFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.AnimationSharingSetupFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.AnimationSharingSetupFactory.md#find)
- [Load](ue_ue.AnimationSharingSetupFactory.md#load)
- [StaticClass](ue_ue.AnimationSharingSetupFactory.md#staticclass)

## Constructors

### constructor

• **new AnimationSharingSetupFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:17110](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17110)
...
### \_\_tid\_AnimationSharingSetupFactory\_\_

• **\_\_tid\_AnimationSharingSetupFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:17115](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17115)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimationSharingSetupFactory`](ue_ue.AnimationSharingSetupFactory.md)
...
[ue/ue.d.ts:17112](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17112)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimationSharingSetupFactory`](ue_ue.AnimationSharingSetupFactory.md)
...
[ue/ue.d.ts:17113](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17113)
...
[ue/ue.d.ts:17111](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17111)
