[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AnimationTransitionSchema

# Class: AnimationTransitionSchema

[ue/ue](../modules/ue_ue.md).AnimationTransitionSchema
...
- [constructor](ue_ue.AnimationTransitionSchema.md#constructor)

### Properties

- [EditoronlyBPFunctionRedirects](ue_ue.AnimationTransitionSchema.md#editoronlybpfunctionredirects)
- [\_\_tid\_AnimationTransitionSchema\_\_](ue_ue.AnimationTransitionSchema.md#__tid_animationtransitionschema__)
- [\_\_tid\_EdGraphSchema\_K2\_\_](ue_ue.AnimationTransitionSchema.md#__tid_edgraphschema_k2__)
- [\_\_tid\_EdGraphSchema\_\_](ue_ue.AnimationTransitionSchema.md#__tid_edgraphschema__)
- [\_\_tid\_Object\_\_](ue_ue.AnimationTransitionSchema.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.AnimationTransitionSchema.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AnimationTransitionSchema.md#executeubergraph)
- [GetClass](ue_ue.AnimationTransitionSchema.md#getclass)
- [GetName](ue_ue.AnimationTransitionSchema.md#getname)
- [GetOuter](ue_ue.AnimationTransitionSchema.md#getouter)
- [GetWorld](ue_ue.AnimationTransitionSchema.md#getworld)
- [Find](ue_ue.AnimationTransitionSchema.md#find)
- [Load](ue_ue.AnimationTransitionSchema.md#load)
- [StaticClass](ue_ue.AnimationTransitionSchema.md#staticclass)

## Constructors

### constructor

• **new AnimationTransitionSchema**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:17238](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17238)
...
### \_\_tid\_AnimationTransitionSchema\_\_

• **\_\_tid\_AnimationTransitionSchema\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:17243](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17243)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AnimationTransitionSchema`](ue_ue.AnimationTransitionSchema.md)
...
[`AnimationTransitionSchema`](ue_ue.AnimationTransitionSchema.md)
...
[ue/ue.d.ts:17240](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17240)

___

### Load

▸ `Static` **Load**(`InName`): [`AnimationTransitionSchema`](ue_ue.AnimationTransitionSchema.md)
...
[ue/ue.d.ts:17241](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17241)
...
[ue/ue.d.ts:17239](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L17239)
