[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / AvfFileMediaSourceFactory

# Class: AvfFileMediaSourceFactory

[ue/ue](../modules/ue_ue.md).AvfFileMediaSourceFactory
...
- [constructor](ue_ue.AvfFileMediaSourceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.AvfFileMediaSourceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.AvfFileMediaSourceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.AvfFileMediaSourceFactory.md#contextclass)
- [Formats](ue_ue.AvfFileMediaSourceFactory.md#formats)
- [ImportPriority](ue_ue.AvfFileMediaSourceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.AvfFileMediaSourceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.AvfFileMediaSourceFactory.md#supportedclass)
- [\_\_tid\_AvfFileMediaSourceFactory\_\_](ue_ue.AvfFileMediaSourceFactory.md#__tid_avffilemediasourcefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.AvfFileMediaSourceFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.AvfFileMediaSourceFactory.md#__tid_object__)
- [bCreateNew](ue_ue.AvfFileMediaSourceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.AvfFileMediaSourceFactory.md#beditafternew)
- [bEditorImport](ue_ue.AvfFileMediaSourceFactory.md#beditorimport)
- [bText](ue_ue.AvfFileMediaSourceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.AvfFileMediaSourceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.AvfFileMediaSourceFactory.md#executeubergraph)
- [GetClass](ue_ue.AvfFileMediaSourceFactory.md#getclass)
- [GetName](ue_ue.AvfFileMediaSourceFactory.md#getname)
- [GetOuter](ue_ue.AvfFileMediaSourceFactory.md#getouter)
- [GetWorld](ue_ue.AvfFileMediaSourceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.AvfFileMediaSourceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.AvfFileMediaSourceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.AvfFileMediaSourceFactory.md#find)
- [Load](ue_ue.AvfFileMediaSourceFactory.md#load)
- [StaticClass](ue_ue.AvfFileMediaSourceFactory.md#staticclass)

## Constructors

### constructor

• **new AvfFileMediaSourceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:23228](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23228)
...
### \_\_tid\_AvfFileMediaSourceFactory\_\_

• **\_\_tid\_AvfFileMediaSourceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:23233](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23233)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`AvfFileMediaSourceFactory`](ue_ue.AvfFileMediaSourceFactory.md)
...
[ue/ue.d.ts:23230](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23230)

___

### Load

▸ `Static` **Load**(`InName`): [`AvfFileMediaSourceFactory`](ue_ue.AvfFileMediaSourceFactory.md)
...
[ue/ue.d.ts:23231](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23231)
...
[ue/ue.d.ts:23229](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23229)
