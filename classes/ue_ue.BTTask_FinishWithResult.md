[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BTTask\_FinishWithResult

# Class: BTTask\_FinishWithResult

[ue/ue](../modules/ue_ue.md).BTTask_FinishWithResult
...
- [constructor](ue_ue.BTTask_FinishWithResult.md#constructor)

### Properties

- [NodeName](ue_ue.BTTask_FinishWithResult.md#nodename)
- [ParentNode](ue_ue.BTTask_FinishWithResult.md#parentnode)
- [Result](ue_ue.BTTask_FinishWithResult.md#result)
- [Services](ue_ue.BTTask_FinishWithResult.md#services)
- [TreeAsset](ue_ue.BTTask_FinishWithResult.md#treeasset)
- [\_\_tid\_BTNode\_\_](ue_ue.BTTask_FinishWithResult.md#__tid_btnode__)
- [\_\_tid\_BTTaskNode\_\_](ue_ue.BTTask_FinishWithResult.md#__tid_bttasknode__)
- [\_\_tid\_BTTask\_FinishWithResult\_\_](ue_ue.BTTask_FinishWithResult.md#__tid_bttask_finishwithresult__)
- [\_\_tid\_Object\_\_](ue_ue.BTTask_FinishWithResult.md#__tid_object__)
- [bIgnoreRestartSelf](ue_ue.BTTask_FinishWithResult.md#bignorerestartself)

### Methods

- [CreateDefaultSubobject](ue_ue.BTTask_FinishWithResult.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BTTask_FinishWithResult.md#executeubergraph)
- [GetClass](ue_ue.BTTask_FinishWithResult.md#getclass)
- [GetName](ue_ue.BTTask_FinishWithResult.md#getname)
- [GetOuter](ue_ue.BTTask_FinishWithResult.md#getouter)
- [GetWorld](ue_ue.BTTask_FinishWithResult.md#getworld)
- [Find](ue_ue.BTTask_FinishWithResult.md#find)
- [Load](ue_ue.BTTask_FinishWithResult.md#load)
- [StaticClass](ue_ue.BTTask_FinishWithResult.md#staticclass)

## Constructors

### constructor

• **new BTTask_FinishWithResult**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:25268](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L25268)
...
• **Result**: [`EBTNodeResult`](../enums/ue_ue.EBTNodeResult.md)

#### Defined in

[ue/ue.d.ts:25269](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L25269)
...
### \_\_tid\_BTTask\_FinishWithResult\_\_

• **\_\_tid\_BTTask\_FinishWithResult\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:25274](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L25274)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BTTask_FinishWithResult`](ue_ue.BTTask_FinishWithResult.md)
...
[ue/ue.d.ts:25271](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L25271)

___

### Load

▸ `Static` **Load**(`InName`): [`BTTask_FinishWithResult`](ue_ue.BTTask_FinishWithResult.md)
...
[ue/ue.d.ts:25272](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L25272)
...
[ue/ue.d.ts:25270](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L25270)
