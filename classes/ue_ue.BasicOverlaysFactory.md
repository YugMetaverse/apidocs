[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BasicOverlaysFactory

# Class: BasicOverlaysFactory

[ue/ue](../modules/ue_ue.md).BasicOverlaysFactory
...
- [constructor](ue_ue.BasicOverlaysFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.BasicOverlaysFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.BasicOverlaysFactory.md#automatedimportdata)
- [ContextClass](ue_ue.BasicOverlaysFactory.md#contextclass)
- [Formats](ue_ue.BasicOverlaysFactory.md#formats)
- [ImportPriority](ue_ue.BasicOverlaysFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.BasicOverlaysFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.BasicOverlaysFactory.md#supportedclass)
- [\_\_tid\_BasicOverlaysFactory\_\_](ue_ue.BasicOverlaysFactory.md#__tid_basicoverlaysfactory__)
- [\_\_tid\_Factory\_\_](ue_ue.BasicOverlaysFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.BasicOverlaysFactory.md#__tid_object__)
- [bCreateNew](ue_ue.BasicOverlaysFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.BasicOverlaysFactory.md#beditafternew)
- [bEditorImport](ue_ue.BasicOverlaysFactory.md#beditorimport)
- [bText](ue_ue.BasicOverlaysFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.BasicOverlaysFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BasicOverlaysFactory.md#executeubergraph)
- [GetClass](ue_ue.BasicOverlaysFactory.md#getclass)
- [GetName](ue_ue.BasicOverlaysFactory.md#getname)
- [GetOuter](ue_ue.BasicOverlaysFactory.md#getouter)
- [GetWorld](ue_ue.BasicOverlaysFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.BasicOverlaysFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.BasicOverlaysFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.BasicOverlaysFactory.md#find)
- [Load](ue_ue.BasicOverlaysFactory.md#load)
- [StaticClass](ue_ue.BasicOverlaysFactory.md#staticclass)

## Constructors

### constructor

• **new BasicOverlaysFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:23572](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23572)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BasicOverlaysFactory`](ue_ue.BasicOverlaysFactory.md)
...
[ue/ue.d.ts:23574](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23574)

___

### Load

▸ `Static` **Load**(`InName`): [`BasicOverlaysFactory`](ue_ue.BasicOverlaysFactory.md)
...
[ue/ue.d.ts:23575](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23575)
...
[ue/ue.d.ts:23573](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23573)
