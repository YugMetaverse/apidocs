[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BasicOverlaysFactoryNew

# Class: BasicOverlaysFactoryNew

[ue/ue](../modules/ue_ue.md).BasicOverlaysFactoryNew
...
- [constructor](ue_ue.BasicOverlaysFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.BasicOverlaysFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.BasicOverlaysFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.BasicOverlaysFactoryNew.md#contextclass)
- [Formats](ue_ue.BasicOverlaysFactoryNew.md#formats)
- [ImportPriority](ue_ue.BasicOverlaysFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.BasicOverlaysFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.BasicOverlaysFactoryNew.md#supportedclass)
- [\_\_tid\_BasicOverlaysFactoryNew\_\_](ue_ue.BasicOverlaysFactoryNew.md#__tid_basicoverlaysfactorynew__)
- [\_\_tid\_Factory\_\_](ue_ue.BasicOverlaysFactoryNew.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.BasicOverlaysFactoryNew.md#__tid_object__)
- [bCreateNew](ue_ue.BasicOverlaysFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.BasicOverlaysFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.BasicOverlaysFactoryNew.md#beditorimport)
- [bText](ue_ue.BasicOverlaysFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.BasicOverlaysFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BasicOverlaysFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.BasicOverlaysFactoryNew.md#getclass)
- [GetName](ue_ue.BasicOverlaysFactoryNew.md#getname)
- [GetOuter](ue_ue.BasicOverlaysFactoryNew.md#getouter)
- [GetWorld](ue_ue.BasicOverlaysFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.BasicOverlaysFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.BasicOverlaysFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.BasicOverlaysFactoryNew.md#find)
- [Load](ue_ue.BasicOverlaysFactoryNew.md#load)
- [StaticClass](ue_ue.BasicOverlaysFactoryNew.md#staticclass)

## Constructors

### constructor

• **new BasicOverlaysFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:23581](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23581)
...
### \_\_tid\_BasicOverlaysFactoryNew\_\_

• **\_\_tid\_BasicOverlaysFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:23586](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23586)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BasicOverlaysFactoryNew`](ue_ue.BasicOverlaysFactoryNew.md)
...
[ue/ue.d.ts:23583](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23583)

___

### Load

▸ `Static` **Load**(`InName`): [`BasicOverlaysFactoryNew`](ue_ue.BasicOverlaysFactoryNew.md)
...
[ue/ue.d.ts:23584](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23584)
...
[ue/ue.d.ts:23582](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23582)
