[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BehaviorTreeFactory

# Class: BehaviorTreeFactory

[ue/ue](../modules/ue_ue.md).BehaviorTreeFactory
...
- [constructor](ue_ue.BehaviorTreeFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.BehaviorTreeFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.BehaviorTreeFactory.md#automatedimportdata)
- [ContextClass](ue_ue.BehaviorTreeFactory.md#contextclass)
- [Formats](ue_ue.BehaviorTreeFactory.md#formats)
- [ImportPriority](ue_ue.BehaviorTreeFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.BehaviorTreeFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.BehaviorTreeFactory.md#supportedclass)
- [\_\_tid\_BehaviorTreeFactory\_\_](ue_ue.BehaviorTreeFactory.md#__tid_behaviortreefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.BehaviorTreeFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.BehaviorTreeFactory.md#__tid_object__)
- [bCreateNew](ue_ue.BehaviorTreeFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.BehaviorTreeFactory.md#beditafternew)
- [bEditorImport](ue_ue.BehaviorTreeFactory.md#beditorimport)
- [bText](ue_ue.BehaviorTreeFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.BehaviorTreeFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BehaviorTreeFactory.md#executeubergraph)
- [GetClass](ue_ue.BehaviorTreeFactory.md#getclass)
- [GetName](ue_ue.BehaviorTreeFactory.md#getname)
- [GetOuter](ue_ue.BehaviorTreeFactory.md#getouter)
- [GetWorld](ue_ue.BehaviorTreeFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.BehaviorTreeFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.BehaviorTreeFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.BehaviorTreeFactory.md#find)
- [Load](ue_ue.BehaviorTreeFactory.md#load)
- [StaticClass](ue_ue.BehaviorTreeFactory.md#staticclass)

## Constructors

### constructor

• **new BehaviorTreeFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:23642](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L23642)
...
### \_\_tid\_BehaviorTreeFactory\_\_

• **\_\_tid\_BehaviorTreeFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:23647](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L23647)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BehaviorTreeFactory`](ue_ue.BehaviorTreeFactory.md)
...
[ue/ue.d.ts:23644](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L23644)

___

### Load

▸ `Static` **Load**(`InName`): [`BehaviorTreeFactory`](ue_ue.BehaviorTreeFactory.md)
...
[ue/ue.d.ts:23645](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L23645)
...
[ue/ue.d.ts:23643](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L23643)
