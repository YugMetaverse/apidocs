[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BehaviorTreeGraphNode\_Decorator

# Class: BehaviorTreeGraphNode\_Decorator

[ue/ue](../modules/ue_ue.md).BehaviorTreeGraphNode_Decorator
...
- [constructor](ue_ue.BehaviorTreeGraphNode_Decorator.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.BehaviorTreeGraphNode_Decorator.md#advancedpindisplay)
- [ClassData](ue_ue.BehaviorTreeGraphNode_Decorator.md#classdata)
- [CopySubNodeIndex](ue_ue.BehaviorTreeGraphNode_Decorator.md#copysubnodeindex)
- [Decorators](ue_ue.BehaviorTreeGraphNode_Decorator.md#decorators)
- [DeprecatedPins](ue_ue.BehaviorTreeGraphNode_Decorator.md#deprecatedpins)
- [EnabledState](ue_ue.BehaviorTreeGraphNode_Decorator.md#enabledstate)
- [ErrorMessage](ue_ue.BehaviorTreeGraphNode_Decorator.md#errormessage)
- [ErrorMsg](ue_ue.BehaviorTreeGraphNode_Decorator.md#errormsg)
- [ErrorType](ue_ue.BehaviorTreeGraphNode_Decorator.md#errortype)
- [NodeComment](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodecomment)
- [NodeGuid](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodeguid)
- [NodeHeight](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodeheight)
- [NodeInstance](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodeinstance)
- [NodePosX](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodeposx)
- [NodePosY](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodeupgrademessage)
- [NodeWidth](ue_ue.BehaviorTreeGraphNode_Decorator.md#nodewidth)
- [ParentNode](ue_ue.BehaviorTreeGraphNode_Decorator.md#parentnode)
- [Services](ue_ue.BehaviorTreeGraphNode_Decorator.md#services)
- [SubNodes](ue_ue.BehaviorTreeGraphNode_Decorator.md#subnodes)
- [\_\_tid\_AIGraphNode\_\_](ue_ue.BehaviorTreeGraphNode_Decorator.md#__tid_aigraphnode__)
- [\_\_tid\_BehaviorTreeGraphNode\_Decorator\_\_](ue_ue.BehaviorTreeGraphNode_Decorator.md#__tid_behaviortreegraphnode_decorator__)
- [\_\_tid\_BehaviorTreeGraphNode\_\_](ue_ue.BehaviorTreeGraphNode_Decorator.md#__tid_behaviortreegraphnode__)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.BehaviorTreeGraphNode_Decorator.md#__tid_edgraphnode__)
- [\_\_tid\_Object\_\_](ue_ue.BehaviorTreeGraphNode_Decorator.md#__tid_object__)
- [bCanRenameNode](ue_ue.BehaviorTreeGraphNode_Decorator.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.BehaviorTreeGraphNode_Decorator.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.BehaviorTreeGraphNode_Decorator.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.BehaviorTreeGraphNode_Decorator.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.BehaviorTreeGraphNode_Decorator.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.BehaviorTreeGraphNode_Decorator.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.BehaviorTreeGraphNode_Decorator.md#bhascompilermessage)
- [bInjectedNode](ue_ue.BehaviorTreeGraphNode_Decorator.md#binjectednode)
- [bIsNodeEnabled](ue_ue.BehaviorTreeGraphNode_Decorator.md#bisnodeenabled)
- [bIsReadOnly](ue_ue.BehaviorTreeGraphNode_Decorator.md#bisreadonly)
- [bIsSubNode](ue_ue.BehaviorTreeGraphNode_Decorator.md#bissubnode)
- [bUserSetEnabledState](ue_ue.BehaviorTreeGraphNode_Decorator.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.BehaviorTreeGraphNode_Decorator.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BehaviorTreeGraphNode_Decorator.md#executeubergraph)
- [GetClass](ue_ue.BehaviorTreeGraphNode_Decorator.md#getclass)
- [GetName](ue_ue.BehaviorTreeGraphNode_Decorator.md#getname)
- [GetOuter](ue_ue.BehaviorTreeGraphNode_Decorator.md#getouter)
- [GetWorld](ue_ue.BehaviorTreeGraphNode_Decorator.md#getworld)
- [Find](ue_ue.BehaviorTreeGraphNode_Decorator.md#find)
- [Load](ue_ue.BehaviorTreeGraphNode_Decorator.md#load)
- [StaticClass](ue_ue.BehaviorTreeGraphNode_Decorator.md#staticclass)

## Constructors

### constructor

• **new BehaviorTreeGraphNode_Decorator**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:23698](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23698)
...
### \_\_tid\_BehaviorTreeGraphNode\_Decorator\_\_

• **\_\_tid\_BehaviorTreeGraphNode\_Decorator\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:23703](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23703)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BehaviorTreeGraphNode_Decorator`](ue_ue.BehaviorTreeGraphNode_Decorator.md)
...
[ue/ue.d.ts:23700](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23700)

___

### Load

▸ `Static` **Load**(`InName`): [`BehaviorTreeGraphNode_Decorator`](ue_ue.BehaviorTreeGraphNode_Decorator.md)
...
[ue/ue.d.ts:23701](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23701)
...
[ue/ue.d.ts:23699](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23699)
