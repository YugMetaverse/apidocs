[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BlendSpaceFactory1D

# Class: BlendSpaceFactory1D

[ue/ue](../modules/ue_ue.md).BlendSpaceFactory1D
...
- [constructor](ue_ue.BlendSpaceFactory1D.md#constructor)

### Properties

- [AssetImportTask](ue_ue.BlendSpaceFactory1D.md#assetimporttask)
- [AutomatedImportData](ue_ue.BlendSpaceFactory1D.md#automatedimportdata)
- [ContextClass](ue_ue.BlendSpaceFactory1D.md#contextclass)
- [Formats](ue_ue.BlendSpaceFactory1D.md#formats)
- [ImportPriority](ue_ue.BlendSpaceFactory1D.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.BlendSpaceFactory1D.md#overwriteyesornotoallstate)
- [PreviewSkeletalMesh](ue_ue.BlendSpaceFactory1D.md#previewskeletalmesh)
- [SupportedClass](ue_ue.BlendSpaceFactory1D.md#supportedclass)
- [TargetSkeleton](ue_ue.BlendSpaceFactory1D.md#targetskeleton)
- [\_\_tid\_BlendSpaceFactory1D\_\_](ue_ue.BlendSpaceFactory1D.md#__tid_blendspacefactory1d__)
- [\_\_tid\_Factory\_\_](ue_ue.BlendSpaceFactory1D.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.BlendSpaceFactory1D.md#__tid_object__)
- [bCreateNew](ue_ue.BlendSpaceFactory1D.md#bcreatenew)
- [bEditAfterNew](ue_ue.BlendSpaceFactory1D.md#beditafternew)
- [bEditorImport](ue_ue.BlendSpaceFactory1D.md#beditorimport)
- [bText](ue_ue.BlendSpaceFactory1D.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.BlendSpaceFactory1D.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BlendSpaceFactory1D.md#executeubergraph)
- [GetClass](ue_ue.BlendSpaceFactory1D.md#getclass)
- [GetName](ue_ue.BlendSpaceFactory1D.md#getname)
- [GetOuter](ue_ue.BlendSpaceFactory1D.md#getouter)
- [GetWorld](ue_ue.BlendSpaceFactory1D.md#getworld)
- [ScriptFactoryCanImport](ue_ue.BlendSpaceFactory1D.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.BlendSpaceFactory1D.md#scriptfactorycreatefile)
- [Find](ue_ue.BlendSpaceFactory1D.md#find)
- [Load](ue_ue.BlendSpaceFactory1D.md#load)
- [StaticClass](ue_ue.BlendSpaceFactory1D.md#staticclass)

## Constructors

### constructor

• **new BlendSpaceFactory1D**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:15350](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15350)
...
[ue/ue.d.ts:15352](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15352)
...
[ue/ue.d.ts:15351](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15351)
...
[ue/ue.d.ts:15357](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15357)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BlendSpaceFactory1D`](ue_ue.BlendSpaceFactory1D.md)
...
[ue/ue.d.ts:15354](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15354)

___

### Load

▸ `Static` **Load**(`InName`): [`BlendSpaceFactory1D`](ue_ue.BlendSpaceFactory1D.md)
...
[ue/ue.d.ts:15355](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15355)
...
[ue/ue.d.ts:15353](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15353)
