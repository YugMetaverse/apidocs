[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BlendSpaceFactoryNew

# Class: BlendSpaceFactoryNew

[ue/ue](../modules/ue_ue.md).BlendSpaceFactoryNew
...
- [constructor](ue_ue.BlendSpaceFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.BlendSpaceFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.BlendSpaceFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.BlendSpaceFactoryNew.md#contextclass)
- [Formats](ue_ue.BlendSpaceFactoryNew.md#formats)
- [ImportPriority](ue_ue.BlendSpaceFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.BlendSpaceFactoryNew.md#overwriteyesornotoallstate)
- [PreviewSkeletalMesh](ue_ue.BlendSpaceFactoryNew.md#previewskeletalmesh)
- [SupportedClass](ue_ue.BlendSpaceFactoryNew.md#supportedclass)
- [TargetSkeleton](ue_ue.BlendSpaceFactoryNew.md#targetskeleton)
- [\_\_tid\_BlendSpaceFactoryNew\_\_](ue_ue.BlendSpaceFactoryNew.md#__tid_blendspacefactorynew__)
- [\_\_tid\_Factory\_\_](ue_ue.BlendSpaceFactoryNew.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.BlendSpaceFactoryNew.md#__tid_object__)
- [bCreateNew](ue_ue.BlendSpaceFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.BlendSpaceFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.BlendSpaceFactoryNew.md#beditorimport)
- [bText](ue_ue.BlendSpaceFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.BlendSpaceFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BlendSpaceFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.BlendSpaceFactoryNew.md#getclass)
- [GetName](ue_ue.BlendSpaceFactoryNew.md#getname)
- [GetOuter](ue_ue.BlendSpaceFactoryNew.md#getouter)
- [GetWorld](ue_ue.BlendSpaceFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.BlendSpaceFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.BlendSpaceFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.BlendSpaceFactoryNew.md#find)
- [Load](ue_ue.BlendSpaceFactoryNew.md#load)
- [StaticClass](ue_ue.BlendSpaceFactoryNew.md#staticclass)

## Constructors

### constructor

• **new BlendSpaceFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:15370](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15370)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BlendSpaceFactoryNew`](ue_ue.BlendSpaceFactoryNew.md)
...
[ue/ue.d.ts:15374](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15374)

___

### Load

▸ `Static` **Load**(`InName`): [`BlendSpaceFactoryNew`](ue_ue.BlendSpaceFactoryNew.md)
...
[ue/ue.d.ts:15375](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15375)
...
[ue/ue.d.ts:15373](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L15373)
