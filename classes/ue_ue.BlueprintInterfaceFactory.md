[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BlueprintInterfaceFactory

# Class: BlueprintInterfaceFactory

[ue/ue](../modules/ue_ue.md).BlueprintInterfaceFactory
...
- [constructor](ue_ue.BlueprintInterfaceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.BlueprintInterfaceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.BlueprintInterfaceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.BlueprintInterfaceFactory.md#contextclass)
- [Formats](ue_ue.BlueprintInterfaceFactory.md#formats)
- [ImportPriority](ue_ue.BlueprintInterfaceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.BlueprintInterfaceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.BlueprintInterfaceFactory.md#supportedclass)
- [\_\_tid\_BlueprintInterfaceFactory\_\_](ue_ue.BlueprintInterfaceFactory.md#__tid_blueprintinterfacefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.BlueprintInterfaceFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.BlueprintInterfaceFactory.md#__tid_object__)
- [bCreateNew](ue_ue.BlueprintInterfaceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.BlueprintInterfaceFactory.md#beditafternew)
- [bEditorImport](ue_ue.BlueprintInterfaceFactory.md#beditorimport)
- [bText](ue_ue.BlueprintInterfaceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.BlueprintInterfaceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BlueprintInterfaceFactory.md#executeubergraph)
- [GetClass](ue_ue.BlueprintInterfaceFactory.md#getclass)
- [GetName](ue_ue.BlueprintInterfaceFactory.md#getname)
- [GetOuter](ue_ue.BlueprintInterfaceFactory.md#getouter)
- [GetWorld](ue_ue.BlueprintInterfaceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.BlueprintInterfaceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.BlueprintInterfaceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.BlueprintInterfaceFactory.md#find)
- [Load](ue_ue.BlueprintInterfaceFactory.md#load)
- [StaticClass](ue_ue.BlueprintInterfaceFactory.md#staticclass)

## Constructors

### constructor

• **new BlueprintInterfaceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:24160](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L24160)
...
### \_\_tid\_BlueprintInterfaceFactory\_\_

• **\_\_tid\_BlueprintInterfaceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:24165](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L24165)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BlueprintInterfaceFactory`](ue_ue.BlueprintInterfaceFactory.md)
...
[ue/ue.d.ts:24162](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L24162)

___

### Load

▸ `Static` **Load**(`InName`): [`BlueprintInterfaceFactory`](ue_ue.BlueprintInterfaceFactory.md)
...
[ue/ue.d.ts:24163](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L24163)
...
[ue/ue.d.ts:24161](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L24161)
