[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / BlueprintThumbnailRenderer

# Class: BlueprintThumbnailRenderer

[ue/ue](../modules/ue_ue.md).BlueprintThumbnailRenderer
...
- [constructor](ue_ue.BlueprintThumbnailRenderer.md#constructor)

### Properties

- [DefaultSizeX](ue_ue.BlueprintThumbnailRenderer.md#defaultsizex)
- [DefaultSizeY](ue_ue.BlueprintThumbnailRenderer.md#defaultsizey)
- [\_\_tid\_BlueprintThumbnailRenderer\_\_](ue_ue.BlueprintThumbnailRenderer.md#__tid_blueprintthumbnailrenderer__)
- [\_\_tid\_DefaultSizedThumbnailRenderer\_\_](ue_ue.BlueprintThumbnailRenderer.md#__tid_defaultsizedthumbnailrenderer__)
- [\_\_tid\_Object\_\_](ue_ue.BlueprintThumbnailRenderer.md#__tid_object__)
- [\_\_tid\_ThumbnailRenderer\_\_](ue_ue.BlueprintThumbnailRenderer.md#__tid_thumbnailrenderer__)

### Methods

- [CreateDefaultSubobject](ue_ue.BlueprintThumbnailRenderer.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.BlueprintThumbnailRenderer.md#executeubergraph)
- [GetClass](ue_ue.BlueprintThumbnailRenderer.md#getclass)
- [GetName](ue_ue.BlueprintThumbnailRenderer.md#getname)
- [GetOuter](ue_ue.BlueprintThumbnailRenderer.md#getouter)
- [GetWorld](ue_ue.BlueprintThumbnailRenderer.md#getworld)
- [Find](ue_ue.BlueprintThumbnailRenderer.md#find)
- [Load](ue_ue.BlueprintThumbnailRenderer.md#load)
- [StaticClass](ue_ue.BlueprintThumbnailRenderer.md#staticclass)

## Constructors

### constructor

• **new BlueprintThumbnailRenderer**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:24359](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L24359)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`BlueprintThumbnailRenderer`](ue_ue.BlueprintThumbnailRenderer.md)
...
[ue/ue.d.ts:24361](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L24361)

___

### Load

▸ `Static` **Load**(`InName`): [`BlueprintThumbnailRenderer`](ue_ue.BlueprintThumbnailRenderer.md)
...
[ue/ue.d.ts:24362](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L24362)
...
[ue/ue.d.ts:24360](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L24360)
