[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / CameraAnimFactory

# Class: CameraAnimFactory

[ue/ue](../modules/ue_ue.md).CameraAnimFactory
...
- [constructor](ue_ue.CameraAnimFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.CameraAnimFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.CameraAnimFactory.md#automatedimportdata)
- [ContextClass](ue_ue.CameraAnimFactory.md#contextclass)
- [Formats](ue_ue.CameraAnimFactory.md#formats)
- [ImportPriority](ue_ue.CameraAnimFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.CameraAnimFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.CameraAnimFactory.md#supportedclass)
- [\_\_tid\_CameraAnimFactory\_\_](ue_ue.CameraAnimFactory.md#__tid_cameraanimfactory__)
- [\_\_tid\_Factory\_\_](ue_ue.CameraAnimFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.CameraAnimFactory.md#__tid_object__)
- [bCreateNew](ue_ue.CameraAnimFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.CameraAnimFactory.md#beditafternew)
- [bEditorImport](ue_ue.CameraAnimFactory.md#beditorimport)
- [bText](ue_ue.CameraAnimFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.CameraAnimFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.CameraAnimFactory.md#executeubergraph)
- [GetClass](ue_ue.CameraAnimFactory.md#getclass)
- [GetName](ue_ue.CameraAnimFactory.md#getname)
- [GetOuter](ue_ue.CameraAnimFactory.md#getouter)
- [GetWorld](ue_ue.CameraAnimFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.CameraAnimFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.CameraAnimFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.CameraAnimFactory.md#find)
- [Load](ue_ue.CameraAnimFactory.md#load)
- [StaticClass](ue_ue.CameraAnimFactory.md#staticclass)

## Constructors

### constructor

• **new CameraAnimFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:25768](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L25768)
...
### \_\_tid\_CameraAnimFactory\_\_

• **\_\_tid\_CameraAnimFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:25773](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L25773)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`CameraAnimFactory`](ue_ue.CameraAnimFactory.md)
...
[ue/ue.d.ts:25770](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L25770)

___

### Load

▸ `Static` **Load**(`InName`): [`CameraAnimFactory`](ue_ue.CameraAnimFactory.md)
...
[ue/ue.d.ts:25771](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L25771)
...
[ue/ue.d.ts:25769](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L25769)
