[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / CanvasPanel

# Class: CanvasPanel

[ue/ue](../modules/ue_ue.md).CanvasPanel
...
- [constructor](ue_ue.CanvasPanel.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.CanvasPanel.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.CanvasPanel.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.CanvasPanel.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.CanvasPanel.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.CanvasPanel.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.CanvasPanel.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.CanvasPanel.md#accessiblewidgetdata)
- [CategoryName](ue_ue.CanvasPanel.md#categoryname)
- [Clipping](ue_ue.CanvasPanel.md#clipping)
- [Cursor](ue_ue.CanvasPanel.md#cursor)
- [DesignerFlags](ue_ue.CanvasPanel.md#designerflags)
- [DisplayLabel](ue_ue.CanvasPanel.md#displaylabel)
- [FlowDirectionPreference](ue_ue.CanvasPanel.md#flowdirectionpreference)
- [NativeBindings](ue_ue.CanvasPanel.md#nativebindings)
- [Navigation](ue_ue.CanvasPanel.md#navigation)
- [RenderOpacity](ue_ue.CanvasPanel.md#renderopacity)
- [RenderTransform](ue_ue.CanvasPanel.md#rendertransform)
- [RenderTransformPivot](ue_ue.CanvasPanel.md#rendertransformpivot)
- [Slot](ue_ue.CanvasPanel.md#slot)
- [Slots](ue_ue.CanvasPanel.md#slots)
- [ToolTipText](ue_ue.CanvasPanel.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.CanvasPanel.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.CanvasPanel.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.CanvasPanel.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.CanvasPanel.md#visibility)
- [VisibilityDelegate](ue_ue.CanvasPanel.md#visibilitydelegate)
- [\_\_tid\_CanvasPanel\_\_](ue_ue.CanvasPanel.md#__tid_canvaspanel__)
- [\_\_tid\_Object\_\_](ue_ue.CanvasPanel.md#__tid_object__)
- [\_\_tid\_PanelWidget\_\_](ue_ue.CanvasPanel.md#__tid_panelwidget__)
- [\_\_tid\_Visual\_\_](ue_ue.CanvasPanel.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.CanvasPanel.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.CanvasPanel.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.CanvasPanel.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.CanvasPanel.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.CanvasPanel.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.CanvasPanel.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.CanvasPanel.md#bisenableddelegate)
- [bIsVariable](ue_ue.CanvasPanel.md#bisvariable)
- [bIsVolatile](ue_ue.CanvasPanel.md#bisvolatile)
- [bLockedInDesigner](ue_ue.CanvasPanel.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.CanvasPanel.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.CanvasPanel.md#boverride_cursor)

### Methods

- [AddChild](ue_ue.CanvasPanel.md#addchild)
- [AddChildToCanvas](ue_ue.CanvasPanel.md#addchildtocanvas)
- [ClearChildren](ue_ue.CanvasPanel.md#clearchildren)
- [CreateDefaultSubobject](ue_ue.CanvasPanel.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.CanvasPanel.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.CanvasPanel.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.CanvasPanel.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.CanvasPanel.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.CanvasPanel.md#generatewidgetforstring__delegatesignature)
- [GetAllChildren](ue_ue.CanvasPanel.md#getallchildren)
- [GetBool\_\_DelegateSignature](ue_ue.CanvasPanel.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.CanvasPanel.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.CanvasPanel.md#getcheckboxstate__delegatesignature)
- [GetChildAt](ue_ue.CanvasPanel.md#getchildat)
- [GetChildIndex](ue_ue.CanvasPanel.md#getchildindex)
- [GetChildrenCount](ue_ue.CanvasPanel.md#getchildrencount)
- [GetClass](ue_ue.CanvasPanel.md#getclass)
- [GetClipping](ue_ue.CanvasPanel.md#getclipping)
- [GetDesiredSize](ue_ue.CanvasPanel.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.CanvasPanel.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.CanvasPanel.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.CanvasPanel.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.CanvasPanel.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.CanvasPanel.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.CanvasPanel.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.CanvasPanel.md#getname)
- [GetOuter](ue_ue.CanvasPanel.md#getouter)
- [GetOwningLocalPlayer](ue_ue.CanvasPanel.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.CanvasPanel.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.CanvasPanel.md#getpaintspacegeometry)
- [GetParent](ue_ue.CanvasPanel.md#getparent)
- [GetRenderOpacity](ue_ue.CanvasPanel.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.CanvasPanel.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.CanvasPanel.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.CanvasPanel.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.CanvasPanel.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.CanvasPanel.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.CanvasPanel.md#gettickspacegeometry)
- [GetVisibility](ue_ue.CanvasPanel.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.CanvasPanel.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.CanvasPanel.md#getworld)
- [HasAnyChildren](ue_ue.CanvasPanel.md#hasanychildren)
- [HasAnyUserFocus](ue_ue.CanvasPanel.md#hasanyuserfocus)
- [HasChild](ue_ue.CanvasPanel.md#haschild)
- [HasFocusedDescendants](ue_ue.CanvasPanel.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.CanvasPanel.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.CanvasPanel.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.CanvasPanel.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.CanvasPanel.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.CanvasPanel.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.CanvasPanel.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.CanvasPanel.md#ishovered)
- [IsVisible](ue_ue.CanvasPanel.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.CanvasPanel.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.CanvasPanel.md#onreply__delegatesignature)
- [RemoveChild](ue_ue.CanvasPanel.md#removechild)
- [RemoveChildAt](ue_ue.CanvasPanel.md#removechildat)
- [RemoveFromParent](ue_ue.CanvasPanel.md#removefromparent)
- [ResetCursor](ue_ue.CanvasPanel.md#resetcursor)
- [SetAllNavigationRules](ue_ue.CanvasPanel.md#setallnavigationrules)
- [SetClipping](ue_ue.CanvasPanel.md#setclipping)
- [SetCursor](ue_ue.CanvasPanel.md#setcursor)
- [SetFocus](ue_ue.CanvasPanel.md#setfocus)
- [SetIsEnabled](ue_ue.CanvasPanel.md#setisenabled)
- [SetKeyboardFocus](ue_ue.CanvasPanel.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.CanvasPanel.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.CanvasPanel.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.CanvasPanel.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.CanvasPanel.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.CanvasPanel.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.CanvasPanel.md#setrenderopacity)
- [SetRenderScale](ue_ue.CanvasPanel.md#setrenderscale)
- [SetRenderShear](ue_ue.CanvasPanel.md#setrendershear)
- [SetRenderTransform](ue_ue.CanvasPanel.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.CanvasPanel.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.CanvasPanel.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.CanvasPanel.md#setrendertranslation)
- [SetToolTip](ue_ue.CanvasPanel.md#settooltip)
- [SetToolTipText](ue_ue.CanvasPanel.md#settooltiptext)
- [SetUserFocus](ue_ue.CanvasPanel.md#setuserfocus)
- [SetVisibility](ue_ue.CanvasPanel.md#setvisibility)
- [Find](ue_ue.CanvasPanel.md#find)
- [Load](ue_ue.CanvasPanel.md#load)
- [StaticClass](ue_ue.CanvasPanel.md#staticclass)

## Constructors

### constructor

• **new CanvasPanel**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:26176](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26176)
...
### \_\_tid\_CanvasPanel\_\_

• **\_\_tid\_CanvasPanel\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:26182](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26182)
...
▸ **AddChildToCanvas**(`Content`): [`CanvasPanelSlot`](ue_ue.CanvasPanelSlot.md)
...
[ue/ue.d.ts:26177](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26177)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`CanvasPanel`](ue_ue.CanvasPanel.md)
...
[`CanvasPanel`](ue_ue.CanvasPanel.md)
...
[ue/ue.d.ts:26179](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26179)

___

### Load

▸ `Static` **Load**(`InName`): [`CanvasPanel`](ue_ue.CanvasPanel.md)
...
[ue/ue.d.ts:26180](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26180)
...
[ue/ue.d.ts:26178](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26178)
