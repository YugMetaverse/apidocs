[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ClassThumbnailRenderer

# Class: ClassThumbnailRenderer

[ue/ue](../modules/ue_ue.md).ClassThumbnailRenderer
...
- [constructor](ue_ue.ClassThumbnailRenderer.md#constructor)

### Properties

- [DefaultSizeX](ue_ue.ClassThumbnailRenderer.md#defaultsizex)
- [DefaultSizeY](ue_ue.ClassThumbnailRenderer.md#defaultsizey)
- [\_\_tid\_ClassThumbnailRenderer\_\_](ue_ue.ClassThumbnailRenderer.md#__tid_classthumbnailrenderer__)
- [\_\_tid\_DefaultSizedThumbnailRenderer\_\_](ue_ue.ClassThumbnailRenderer.md#__tid_defaultsizedthumbnailrenderer__)
- [\_\_tid\_Object\_\_](ue_ue.ClassThumbnailRenderer.md#__tid_object__)
- [\_\_tid\_ThumbnailRenderer\_\_](ue_ue.ClassThumbnailRenderer.md#__tid_thumbnailrenderer__)

### Methods

- [CreateDefaultSubobject](ue_ue.ClassThumbnailRenderer.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ClassThumbnailRenderer.md#executeubergraph)
- [GetClass](ue_ue.ClassThumbnailRenderer.md#getclass)
- [GetName](ue_ue.ClassThumbnailRenderer.md#getname)
- [GetOuter](ue_ue.ClassThumbnailRenderer.md#getouter)
- [GetWorld](ue_ue.ClassThumbnailRenderer.md#getworld)
- [Find](ue_ue.ClassThumbnailRenderer.md#find)
- [Load](ue_ue.ClassThumbnailRenderer.md#load)
- [StaticClass](ue_ue.ClassThumbnailRenderer.md#staticclass)

## Constructors

### constructor

• **new ClassThumbnailRenderer**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:27439](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L27439)
...
### \_\_tid\_ClassThumbnailRenderer\_\_

• **\_\_tid\_ClassThumbnailRenderer\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:27444](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L27444)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ClassThumbnailRenderer`](ue_ue.ClassThumbnailRenderer.md)
...
[ue/ue.d.ts:27441](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L27441)

___

### Load

▸ `Static` **Load**(`InName`): [`ClassThumbnailRenderer`](ue_ue.ClassThumbnailRenderer.md)
...
[ue/ue.d.ts:27442](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L27442)
...
[ue/ue.d.ts:27440](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L27440)
