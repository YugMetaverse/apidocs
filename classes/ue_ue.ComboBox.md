[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ComboBox

# Class: ComboBox

[ue/ue](../modules/ue_ue.md).ComboBox
...
- [constructor](ue_ue.ComboBox.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.ComboBox.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.ComboBox.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.ComboBox.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.ComboBox.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.ComboBox.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.ComboBox.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.ComboBox.md#accessiblewidgetdata)
- [CategoryName](ue_ue.ComboBox.md#categoryname)
- [Clipping](ue_ue.ComboBox.md#clipping)
- [Cursor](ue_ue.ComboBox.md#cursor)
- [DesignerFlags](ue_ue.ComboBox.md#designerflags)
- [DisplayLabel](ue_ue.ComboBox.md#displaylabel)
- [FlowDirectionPreference](ue_ue.ComboBox.md#flowdirectionpreference)
- [Items](ue_ue.ComboBox.md#items)
- [NativeBindings](ue_ue.ComboBox.md#nativebindings)
- [Navigation](ue_ue.ComboBox.md#navigation)
- [OnGenerateWidgetEvent](ue_ue.ComboBox.md#ongeneratewidgetevent)
- [RenderOpacity](ue_ue.ComboBox.md#renderopacity)
- [RenderTransform](ue_ue.ComboBox.md#rendertransform)
- [RenderTransformPivot](ue_ue.ComboBox.md#rendertransformpivot)
- [Slot](ue_ue.ComboBox.md#slot)
- [ToolTipText](ue_ue.ComboBox.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.ComboBox.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.ComboBox.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.ComboBox.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.ComboBox.md#visibility)
- [VisibilityDelegate](ue_ue.ComboBox.md#visibilitydelegate)
- [\_\_tid\_ComboBox\_\_](ue_ue.ComboBox.md#__tid_combobox__)
- [\_\_tid\_Object\_\_](ue_ue.ComboBox.md#__tid_object__)
- [\_\_tid\_Visual\_\_](ue_ue.ComboBox.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.ComboBox.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.ComboBox.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.ComboBox.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.ComboBox.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.ComboBox.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.ComboBox.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.ComboBox.md#bisenableddelegate)
- [bIsFocusable](ue_ue.ComboBox.md#bisfocusable)
- [bIsVariable](ue_ue.ComboBox.md#bisvariable)
- [bIsVolatile](ue_ue.ComboBox.md#bisvolatile)
- [bLockedInDesigner](ue_ue.ComboBox.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.ComboBox.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.ComboBox.md#boverride_cursor)

### Methods

- [CreateDefaultSubobject](ue_ue.ComboBox.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ComboBox.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.ComboBox.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.ComboBox.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.ComboBox.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.ComboBox.md#generatewidgetforstring__delegatesignature)
- [GetBool\_\_DelegateSignature](ue_ue.ComboBox.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.ComboBox.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.ComboBox.md#getcheckboxstate__delegatesignature)
- [GetClass](ue_ue.ComboBox.md#getclass)
- [GetClipping](ue_ue.ComboBox.md#getclipping)
- [GetDesiredSize](ue_ue.ComboBox.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.ComboBox.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.ComboBox.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.ComboBox.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.ComboBox.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.ComboBox.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.ComboBox.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.ComboBox.md#getname)
- [GetOuter](ue_ue.ComboBox.md#getouter)
- [GetOwningLocalPlayer](ue_ue.ComboBox.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.ComboBox.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.ComboBox.md#getpaintspacegeometry)
- [GetParent](ue_ue.ComboBox.md#getparent)
- [GetRenderOpacity](ue_ue.ComboBox.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.ComboBox.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.ComboBox.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.ComboBox.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.ComboBox.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.ComboBox.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.ComboBox.md#gettickspacegeometry)
- [GetVisibility](ue_ue.ComboBox.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.ComboBox.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.ComboBox.md#getworld)
- [HasAnyUserFocus](ue_ue.ComboBox.md#hasanyuserfocus)
- [HasFocusedDescendants](ue_ue.ComboBox.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.ComboBox.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.ComboBox.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.ComboBox.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.ComboBox.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.ComboBox.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.ComboBox.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.ComboBox.md#ishovered)
- [IsVisible](ue_ue.ComboBox.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.ComboBox.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.ComboBox.md#onreply__delegatesignature)
- [RemoveFromParent](ue_ue.ComboBox.md#removefromparent)
- [ResetCursor](ue_ue.ComboBox.md#resetcursor)
- [SetAllNavigationRules](ue_ue.ComboBox.md#setallnavigationrules)
- [SetClipping](ue_ue.ComboBox.md#setclipping)
- [SetCursor](ue_ue.ComboBox.md#setcursor)
- [SetFocus](ue_ue.ComboBox.md#setfocus)
- [SetIsEnabled](ue_ue.ComboBox.md#setisenabled)
- [SetKeyboardFocus](ue_ue.ComboBox.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.ComboBox.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.ComboBox.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.ComboBox.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.ComboBox.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.ComboBox.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.ComboBox.md#setrenderopacity)
- [SetRenderScale](ue_ue.ComboBox.md#setrenderscale)
- [SetRenderShear](ue_ue.ComboBox.md#setrendershear)
- [SetRenderTransform](ue_ue.ComboBox.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.ComboBox.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.ComboBox.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.ComboBox.md#setrendertranslation)
- [SetToolTip](ue_ue.ComboBox.md#settooltip)
- [SetToolTipText](ue_ue.ComboBox.md#settooltiptext)
- [SetUserFocus](ue_ue.ComboBox.md#setuserfocus)
- [SetVisibility](ue_ue.ComboBox.md#setvisibility)
- [Find](ue_ue.ComboBox.md#find)
- [Load](ue_ue.ComboBox.md#load)
- [StaticClass](ue_ue.ComboBox.md#staticclass)

## Constructors

### constructor

• **new ComboBox**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:28199](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28199)
...
• **Items**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Object`](ue_ue.Object.md)\>

#### Defined in

[ue/ue.d.ts:28200](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28200)
...
• **OnGenerateWidgetEvent**: [`$Delegate`](../interfaces/ue_puerts._Delegate.md)<(`Item`: [`$Nullable`](../modules/puerts.md#$nullable)<[`Object`](ue_ue.Object.md)\>) => [`Widget`](ue_ue.Widget.md)\>

#### Defined in

[ue/ue.d.ts:28201](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28201)
...
### \_\_tid\_ComboBox\_\_

• **\_\_tid\_ComboBox\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:28207](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28207)
...
[ue/ue.d.ts:28202](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28202)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ComboBox`](ue_ue.ComboBox.md)
...
[ue/ue.d.ts:28204](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28204)

___

### Load

▸ `Static` **Load**(`InName`): [`ComboBox`](ue_ue.ComboBox.md)
...
[ue/ue.d.ts:28205](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28205)
...
[ue/ue.d.ts:28203](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28203)
