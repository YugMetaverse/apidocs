[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / CompositeCurveTableFactory

# Class: CompositeCurveTableFactory

[ue/ue](../modules/ue_ue.md).CompositeCurveTableFactory
...
- [constructor](ue_ue.CompositeCurveTableFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.CompositeCurveTableFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.CompositeCurveTableFactory.md#automatedimportdata)
- [ContextClass](ue_ue.CompositeCurveTableFactory.md#contextclass)
- [Formats](ue_ue.CompositeCurveTableFactory.md#formats)
- [ImportPriority](ue_ue.CompositeCurveTableFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.CompositeCurveTableFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.CompositeCurveTableFactory.md#supportedclass)
- [\_\_tid\_CompositeCurveTableFactory\_\_](ue_ue.CompositeCurveTableFactory.md#__tid_compositecurvetablefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.CompositeCurveTableFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.CompositeCurveTableFactory.md#__tid_object__)
- [bCreateNew](ue_ue.CompositeCurveTableFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.CompositeCurveTableFactory.md#beditafternew)
- [bEditorImport](ue_ue.CompositeCurveTableFactory.md#beditorimport)
- [bText](ue_ue.CompositeCurveTableFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.CompositeCurveTableFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.CompositeCurveTableFactory.md#executeubergraph)
- [GetClass](ue_ue.CompositeCurveTableFactory.md#getclass)
- [GetName](ue_ue.CompositeCurveTableFactory.md#getname)
- [GetOuter](ue_ue.CompositeCurveTableFactory.md#getouter)
- [GetWorld](ue_ue.CompositeCurveTableFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.CompositeCurveTableFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.CompositeCurveTableFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.CompositeCurveTableFactory.md#find)
- [Load](ue_ue.CompositeCurveTableFactory.md#load)
- [StaticClass](ue_ue.CompositeCurveTableFactory.md#staticclass)

## Constructors

### constructor

• **new CompositeCurveTableFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:28406](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28406)
...
### \_\_tid\_CompositeCurveTableFactory\_\_

• **\_\_tid\_CompositeCurveTableFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:28411](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28411)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`CompositeCurveTableFactory`](ue_ue.CompositeCurveTableFactory.md)
...
[ue/ue.d.ts:28408](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28408)

___

### Load

▸ `Static` **Load**(`InName`): [`CompositeCurveTableFactory`](ue_ue.CompositeCurveTableFactory.md)
...
[ue/ue.d.ts:28409](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28409)
...
[ue/ue.d.ts:28407](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L28407)
