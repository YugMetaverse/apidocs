[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ContentWidget

# Class: ContentWidget

[ue/ue](../modules/ue_ue.md).ContentWidget
...
- [`PanelWidget`](ue_ue.PanelWidget.md)
  ...
  ↳↳ [`NamedSlot`](ue_ue.NamedSlot.md)

  ↳↳ [`RetainerBox`](ue_ue.RetainerBox.md)

  ↳↳ [`SafeZone`](ue_ue.SafeZone.md)
...
- [constructor](ue_ue.ContentWidget.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.ContentWidget.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.ContentWidget.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.ContentWidget.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.ContentWidget.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.ContentWidget.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.ContentWidget.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.ContentWidget.md#accessiblewidgetdata)
- [CategoryName](ue_ue.ContentWidget.md#categoryname)
- [Clipping](ue_ue.ContentWidget.md#clipping)
- [Cursor](ue_ue.ContentWidget.md#cursor)
- [DesignerFlags](ue_ue.ContentWidget.md#designerflags)
- [DisplayLabel](ue_ue.ContentWidget.md#displaylabel)
- [FlowDirectionPreference](ue_ue.ContentWidget.md#flowdirectionpreference)
- [NativeBindings](ue_ue.ContentWidget.md#nativebindings)
- [Navigation](ue_ue.ContentWidget.md#navigation)
- [RenderOpacity](ue_ue.ContentWidget.md#renderopacity)
- [RenderTransform](ue_ue.ContentWidget.md#rendertransform)
- [RenderTransformPivot](ue_ue.ContentWidget.md#rendertransformpivot)
- [Slot](ue_ue.ContentWidget.md#slot)
- [Slots](ue_ue.ContentWidget.md#slots)
- [ToolTipText](ue_ue.ContentWidget.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.ContentWidget.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.ContentWidget.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.ContentWidget.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.ContentWidget.md#visibility)
- [VisibilityDelegate](ue_ue.ContentWidget.md#visibilitydelegate)
- [\_\_tid\_ContentWidget\_\_](ue_ue.ContentWidget.md#__tid_contentwidget__)
- [\_\_tid\_Object\_\_](ue_ue.ContentWidget.md#__tid_object__)
- [\_\_tid\_PanelWidget\_\_](ue_ue.ContentWidget.md#__tid_panelwidget__)
- [\_\_tid\_Visual\_\_](ue_ue.ContentWidget.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.ContentWidget.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.ContentWidget.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.ContentWidget.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.ContentWidget.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.ContentWidget.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.ContentWidget.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.ContentWidget.md#bisenableddelegate)
- [bIsVariable](ue_ue.ContentWidget.md#bisvariable)
- [bIsVolatile](ue_ue.ContentWidget.md#bisvolatile)
- [bLockedInDesigner](ue_ue.ContentWidget.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.ContentWidget.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.ContentWidget.md#boverride_cursor)

### Methods

- [AddChild](ue_ue.ContentWidget.md#addchild)
- [ClearChildren](ue_ue.ContentWidget.md#clearchildren)
- [CreateDefaultSubobject](ue_ue.ContentWidget.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ContentWidget.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.ContentWidget.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.ContentWidget.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.ContentWidget.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.ContentWidget.md#generatewidgetforstring__delegatesignature)
- [GetAllChildren](ue_ue.ContentWidget.md#getallchildren)
- [GetBool\_\_DelegateSignature](ue_ue.ContentWidget.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.ContentWidget.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.ContentWidget.md#getcheckboxstate__delegatesignature)
- [GetChildAt](ue_ue.ContentWidget.md#getchildat)
- [GetChildIndex](ue_ue.ContentWidget.md#getchildindex)
- [GetChildrenCount](ue_ue.ContentWidget.md#getchildrencount)
- [GetClass](ue_ue.ContentWidget.md#getclass)
- [GetClipping](ue_ue.ContentWidget.md#getclipping)
- [GetContent](ue_ue.ContentWidget.md#getcontent)
- [GetContentSlot](ue_ue.ContentWidget.md#getcontentslot)
- [GetDesiredSize](ue_ue.ContentWidget.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.ContentWidget.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.ContentWidget.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.ContentWidget.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.ContentWidget.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.ContentWidget.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.ContentWidget.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.ContentWidget.md#getname)
- [GetOuter](ue_ue.ContentWidget.md#getouter)
- [GetOwningLocalPlayer](ue_ue.ContentWidget.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.ContentWidget.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.ContentWidget.md#getpaintspacegeometry)
- [GetParent](ue_ue.ContentWidget.md#getparent)
- [GetRenderOpacity](ue_ue.ContentWidget.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.ContentWidget.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.ContentWidget.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.ContentWidget.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.ContentWidget.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.ContentWidget.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.ContentWidget.md#gettickspacegeometry)
- [GetVisibility](ue_ue.ContentWidget.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.ContentWidget.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.ContentWidget.md#getworld)
- [HasAnyChildren](ue_ue.ContentWidget.md#hasanychildren)
- [HasAnyUserFocus](ue_ue.ContentWidget.md#hasanyuserfocus)
- [HasChild](ue_ue.ContentWidget.md#haschild)
- [HasFocusedDescendants](ue_ue.ContentWidget.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.ContentWidget.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.ContentWidget.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.ContentWidget.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.ContentWidget.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.ContentWidget.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.ContentWidget.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.ContentWidget.md#ishovered)
- [IsVisible](ue_ue.ContentWidget.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.ContentWidget.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.ContentWidget.md#onreply__delegatesignature)
- [RemoveChild](ue_ue.ContentWidget.md#removechild)
- [RemoveChildAt](ue_ue.ContentWidget.md#removechildat)
- [RemoveFromParent](ue_ue.ContentWidget.md#removefromparent)
- [ResetCursor](ue_ue.ContentWidget.md#resetcursor)
- [SetAllNavigationRules](ue_ue.ContentWidget.md#setallnavigationrules)
- [SetClipping](ue_ue.ContentWidget.md#setclipping)
- [SetContent](ue_ue.ContentWidget.md#setcontent)
- [SetCursor](ue_ue.ContentWidget.md#setcursor)
- [SetFocus](ue_ue.ContentWidget.md#setfocus)
- [SetIsEnabled](ue_ue.ContentWidget.md#setisenabled)
- [SetKeyboardFocus](ue_ue.ContentWidget.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.ContentWidget.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.ContentWidget.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.ContentWidget.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.ContentWidget.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.ContentWidget.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.ContentWidget.md#setrenderopacity)
- [SetRenderScale](ue_ue.ContentWidget.md#setrenderscale)
- [SetRenderShear](ue_ue.ContentWidget.md#setrendershear)
- [SetRenderTransform](ue_ue.ContentWidget.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.ContentWidget.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.ContentWidget.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.ContentWidget.md#setrendertranslation)
- [SetToolTip](ue_ue.ContentWidget.md#settooltip)
- [SetToolTipText](ue_ue.ContentWidget.md#settooltiptext)
- [SetUserFocus](ue_ue.ContentWidget.md#setuserfocus)
- [SetVisibility](ue_ue.ContentWidget.md#setvisibility)
- [Find](ue_ue.ContentWidget.md#find)
- [Load](ue_ue.ContentWidget.md#load)
- [StaticClass](ue_ue.ContentWidget.md#staticclass)

## Constructors

### constructor

• **new ContentWidget**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:23404](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23404)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ContentWidget`](ue_ue.ContentWidget.md)
...
[ue/ue.d.ts:23409](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23409)

___

### Load

▸ `Static` **Load**(`InName`): [`ContentWidget`](ue_ue.ContentWidget.md)
...
[ue/ue.d.ts:23410](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23410)
...
[ue/ue.d.ts:23408](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L23408)
