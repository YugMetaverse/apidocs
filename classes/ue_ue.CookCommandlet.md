[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / CookCommandlet

# Class: CookCommandlet

[ue/ue](../modules/ue_ue.md).CookCommandlet
...
- [constructor](ue_ue.CookCommandlet.md#constructor)

### Properties

- [FullGCAssetClassNames](ue_ue.CookCommandlet.md#fullgcassetclassnames)
- [HelpDescription](ue_ue.CookCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.CookCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.CookCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.CookCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.CookCommandlet.md#helpweblink)
- [IsClient](ue_ue.CookCommandlet.md#isclient)
- [IsEditor](ue_ue.CookCommandlet.md#iseditor)
- [IsServer](ue_ue.CookCommandlet.md#isserver)
- [LogToConsole](ue_ue.CookCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.CookCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.CookCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.CookCommandlet.md#__tid_commandlet__)
- [\_\_tid\_CookCommandlet\_\_](ue_ue.CookCommandlet.md#__tid_cookcommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.CookCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.CookCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.CookCommandlet.md#executeubergraph)
- [GetClass](ue_ue.CookCommandlet.md#getclass)
- [GetName](ue_ue.CookCommandlet.md#getname)
- [GetOuter](ue_ue.CookCommandlet.md#getouter)
- [GetWorld](ue_ue.CookCommandlet.md#getworld)
- [Find](ue_ue.CookCommandlet.md#find)
- [Load](ue_ue.CookCommandlet.md#load)
- [StaticClass](ue_ue.CookCommandlet.md#staticclass)

## Constructors

### constructor

• **new CookCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:28742](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28742)

## Properties

### FullGCAssetClassNames

• **FullGCAssetClassNames**: [`TArray`](../interfaces/ue_puerts.TArray.md)<`string`\>

#### Defined in

[ue/ue.d.ts:28743](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28743)
...
### \_\_tid\_CookCommandlet\_\_

• **\_\_tid\_CookCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:28748](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28748)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`CookCommandlet`](ue_ue.CookCommandlet.md)
...
[ue/ue.d.ts:28745](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28745)

___

### Load

▸ `Static` **Load**(`InName`): [`CookCommandlet`](ue_ue.CookCommandlet.md)
...
[ue/ue.d.ts:28746](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28746)
...
[ue/ue.d.ts:28744](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28744)
