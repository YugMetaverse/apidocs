[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / CurveLinearColor
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`CurveLinearColor`](ue_ue.CurveLinearColor.md)
