[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DataTableFactory

# Class: DataTableFactory

[ue/ue](../modules/ue_ue.md).DataTableFactory
...
- [constructor](ue_ue.DataTableFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.DataTableFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.DataTableFactory.md#automatedimportdata)
- [ContextClass](ue_ue.DataTableFactory.md#contextclass)
- [Formats](ue_ue.DataTableFactory.md#formats)
- [ImportPriority](ue_ue.DataTableFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.DataTableFactory.md#overwriteyesornotoallstate)
- [Struct](ue_ue.DataTableFactory.md#struct)
- [SupportedClass](ue_ue.DataTableFactory.md#supportedclass)
- [\_\_tid\_DataTableFactory\_\_](ue_ue.DataTableFactory.md#__tid_datatablefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.DataTableFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.DataTableFactory.md#__tid_object__)
- [bCreateNew](ue_ue.DataTableFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.DataTableFactory.md#beditafternew)
- [bEditorImport](ue_ue.DataTableFactory.md#beditorimport)
- [bText](ue_ue.DataTableFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.DataTableFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.DataTableFactory.md#executeubergraph)
- [GetClass](ue_ue.DataTableFactory.md#getclass)
- [GetName](ue_ue.DataTableFactory.md#getname)
- [GetOuter](ue_ue.DataTableFactory.md#getouter)
- [GetWorld](ue_ue.DataTableFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.DataTableFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.DataTableFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.DataTableFactory.md#find)
- [Load](ue_ue.DataTableFactory.md#load)
- [StaticClass](ue_ue.DataTableFactory.md#staticclass)

## Constructors

### constructor

• **new DataTableFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:28445](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28445)
...
[ue/ue.d.ts:28446](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28446)
...
[ue/ue.d.ts:28451](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28451)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DataTableFactory`](ue_ue.DataTableFactory.md)
...
[ue/ue.d.ts:28448](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28448)

___

### Load

▸ `Static` **Load**(`InName`): [`DataTableFactory`](ue_ue.DataTableFactory.md)
...
[ue/ue.d.ts:28449](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28449)
...
[ue/ue.d.ts:28447](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L28447)
