[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DataValidationCommandlet

# Class: DataValidationCommandlet

[ue/ue](../modules/ue_ue.md).DataValidationCommandlet
...
- [constructor](ue_ue.DataValidationCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.DataValidationCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.DataValidationCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.DataValidationCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.DataValidationCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.DataValidationCommandlet.md#helpweblink)
- [IsClient](ue_ue.DataValidationCommandlet.md#isclient)
- [IsEditor](ue_ue.DataValidationCommandlet.md#iseditor)
- [IsServer](ue_ue.DataValidationCommandlet.md#isserver)
- [LogToConsole](ue_ue.DataValidationCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.DataValidationCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.DataValidationCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.DataValidationCommandlet.md#__tid_commandlet__)
- [\_\_tid\_DataValidationCommandlet\_\_](ue_ue.DataValidationCommandlet.md#__tid_datavalidationcommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.DataValidationCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.DataValidationCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.DataValidationCommandlet.md#executeubergraph)
- [GetClass](ue_ue.DataValidationCommandlet.md#getclass)
- [GetName](ue_ue.DataValidationCommandlet.md#getname)
- [GetOuter](ue_ue.DataValidationCommandlet.md#getouter)
- [GetWorld](ue_ue.DataValidationCommandlet.md#getworld)
- [Find](ue_ue.DataValidationCommandlet.md#find)
- [Load](ue_ue.DataValidationCommandlet.md#load)
- [StaticClass](ue_ue.DataValidationCommandlet.md#staticclass)

## Constructors

### constructor

• **new DataValidationCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:30214](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30214)
...
### \_\_tid\_DataValidationCommandlet\_\_

• **\_\_tid\_DataValidationCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:30219](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30219)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DataValidationCommandlet`](ue_ue.DataValidationCommandlet.md)
...
[ue/ue.d.ts:30216](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30216)

___

### Load

▸ `Static` **Load**(`InName`): [`DataValidationCommandlet`](ue_ue.DataValidationCommandlet.md)
...
[ue/ue.d.ts:30217](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30217)
...
[ue/ue.d.ts:30215](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30215)
