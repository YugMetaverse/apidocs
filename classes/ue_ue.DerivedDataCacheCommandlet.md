[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DerivedDataCacheCommandlet

# Class: DerivedDataCacheCommandlet

[ue/ue](../modules/ue_ue.md).DerivedDataCacheCommandlet
...
- [constructor](ue_ue.DerivedDataCacheCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.DerivedDataCacheCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.DerivedDataCacheCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.DerivedDataCacheCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.DerivedDataCacheCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.DerivedDataCacheCommandlet.md#helpweblink)
- [IsClient](ue_ue.DerivedDataCacheCommandlet.md#isclient)
- [IsEditor](ue_ue.DerivedDataCacheCommandlet.md#iseditor)
- [IsServer](ue_ue.DerivedDataCacheCommandlet.md#isserver)
- [LogToConsole](ue_ue.DerivedDataCacheCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.DerivedDataCacheCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.DerivedDataCacheCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.DerivedDataCacheCommandlet.md#__tid_commandlet__)
- [\_\_tid\_DerivedDataCacheCommandlet\_\_](ue_ue.DerivedDataCacheCommandlet.md#__tid_deriveddatacachecommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.DerivedDataCacheCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.DerivedDataCacheCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.DerivedDataCacheCommandlet.md#executeubergraph)
- [GetClass](ue_ue.DerivedDataCacheCommandlet.md#getclass)
- [GetName](ue_ue.DerivedDataCacheCommandlet.md#getname)
- [GetOuter](ue_ue.DerivedDataCacheCommandlet.md#getouter)
- [GetWorld](ue_ue.DerivedDataCacheCommandlet.md#getworld)
- [Find](ue_ue.DerivedDataCacheCommandlet.md#find)
- [Load](ue_ue.DerivedDataCacheCommandlet.md#load)
- [StaticClass](ue_ue.DerivedDataCacheCommandlet.md#staticclass)

## Constructors

### constructor

• **new DerivedDataCacheCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:30686](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30686)
...
### \_\_tid\_DerivedDataCacheCommandlet\_\_

• **\_\_tid\_DerivedDataCacheCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:30691](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30691)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DerivedDataCacheCommandlet`](ue_ue.DerivedDataCacheCommandlet.md)
...
[ue/ue.d.ts:30688](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30688)

___

### Load

▸ `Static` **Load**(`InName`): [`DerivedDataCacheCommandlet`](ue_ue.DerivedDataCacheCommandlet.md)
...
[ue/ue.d.ts:30689](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30689)
...
[ue/ue.d.ts:30687](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30687)
