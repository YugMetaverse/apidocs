[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DialogueVoiceFactory

# Class: DialogueVoiceFactory

[ue/ue](../modules/ue_ue.md).DialogueVoiceFactory
...
- [constructor](ue_ue.DialogueVoiceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.DialogueVoiceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.DialogueVoiceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.DialogueVoiceFactory.md#contextclass)
- [Formats](ue_ue.DialogueVoiceFactory.md#formats)
- [ImportPriority](ue_ue.DialogueVoiceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.DialogueVoiceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.DialogueVoiceFactory.md#supportedclass)
- [\_\_tid\_DialogueVoiceFactory\_\_](ue_ue.DialogueVoiceFactory.md#__tid_dialoguevoicefactory__)
- [\_\_tid\_Factory\_\_](ue_ue.DialogueVoiceFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.DialogueVoiceFactory.md#__tid_object__)
- [bCreateNew](ue_ue.DialogueVoiceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.DialogueVoiceFactory.md#beditafternew)
- [bEditorImport](ue_ue.DialogueVoiceFactory.md#beditorimport)
- [bText](ue_ue.DialogueVoiceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.DialogueVoiceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.DialogueVoiceFactory.md#executeubergraph)
- [GetClass](ue_ue.DialogueVoiceFactory.md#getclass)
- [GetName](ue_ue.DialogueVoiceFactory.md#getname)
- [GetOuter](ue_ue.DialogueVoiceFactory.md#getouter)
- [GetWorld](ue_ue.DialogueVoiceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.DialogueVoiceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.DialogueVoiceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.DialogueVoiceFactory.md#find)
- [Load](ue_ue.DialogueVoiceFactory.md#load)
- [StaticClass](ue_ue.DialogueVoiceFactory.md#staticclass)

## Constructors

### constructor

• **new DialogueVoiceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:30844](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30844)
...
### \_\_tid\_DialogueVoiceFactory\_\_

• **\_\_tid\_DialogueVoiceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:30849](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30849)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DialogueVoiceFactory`](ue_ue.DialogueVoiceFactory.md)
...
[ue/ue.d.ts:30846](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30846)

___

### Load

▸ `Static` **Load**(`InName`): [`DialogueVoiceFactory`](ue_ue.DialogueVoiceFactory.md)
...
[ue/ue.d.ts:30847](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30847)
...
[ue/ue.d.ts:30845](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30845)
