[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DiffFilesCommandlet

# Class: DiffFilesCommandlet

[ue/ue](../modules/ue_ue.md).DiffFilesCommandlet
...
- [constructor](ue_ue.DiffFilesCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.DiffFilesCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.DiffFilesCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.DiffFilesCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.DiffFilesCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.DiffFilesCommandlet.md#helpweblink)
- [IsClient](ue_ue.DiffFilesCommandlet.md#isclient)
- [IsEditor](ue_ue.DiffFilesCommandlet.md#iseditor)
- [IsServer](ue_ue.DiffFilesCommandlet.md#isserver)
- [LogToConsole](ue_ue.DiffFilesCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.DiffFilesCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.DiffFilesCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.DiffFilesCommandlet.md#__tid_commandlet__)
- [\_\_tid\_DiffFilesCommandlet\_\_](ue_ue.DiffFilesCommandlet.md#__tid_difffilescommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.DiffFilesCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.DiffFilesCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.DiffFilesCommandlet.md#executeubergraph)
- [GetClass](ue_ue.DiffFilesCommandlet.md#getclass)
- [GetName](ue_ue.DiffFilesCommandlet.md#getname)
- [GetOuter](ue_ue.DiffFilesCommandlet.md#getouter)
- [GetWorld](ue_ue.DiffFilesCommandlet.md#getworld)
- [Find](ue_ue.DiffFilesCommandlet.md#find)
- [Load](ue_ue.DiffFilesCommandlet.md#load)
- [StaticClass](ue_ue.DiffFilesCommandlet.md#staticclass)

## Constructors

### constructor

• **new DiffFilesCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:30935](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30935)
...
### \_\_tid\_DiffFilesCommandlet\_\_

• **\_\_tid\_DiffFilesCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:30940](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30940)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DiffFilesCommandlet`](ue_ue.DiffFilesCommandlet.md)
...
[ue/ue.d.ts:30937](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30937)

___

### Load

▸ `Static` **Load**(`InName`): [`DiffFilesCommandlet`](ue_ue.DiffFilesCommandlet.md)
...
[ue/ue.d.ts:30938](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30938)
...
[ue/ue.d.ts:30936](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L30936)
