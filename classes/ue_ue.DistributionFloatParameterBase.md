[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DistributionFloatParameterBase
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DistributionFloatParameterBase`](ue_ue.DistributionFloatParameterBase.md)
