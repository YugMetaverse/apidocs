[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / DumpHiddenCategoriesCommandlet

# Class: DumpHiddenCategoriesCommandlet

[ue/ue](../modules/ue_ue.md).DumpHiddenCategoriesCommandlet
...
- [constructor](ue_ue.DumpHiddenCategoriesCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.DumpHiddenCategoriesCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.DumpHiddenCategoriesCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.DumpHiddenCategoriesCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.DumpHiddenCategoriesCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.DumpHiddenCategoriesCommandlet.md#helpweblink)
- [IsClient](ue_ue.DumpHiddenCategoriesCommandlet.md#isclient)
- [IsEditor](ue_ue.DumpHiddenCategoriesCommandlet.md#iseditor)
- [IsServer](ue_ue.DumpHiddenCategoriesCommandlet.md#isserver)
- [LogToConsole](ue_ue.DumpHiddenCategoriesCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.DumpHiddenCategoriesCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.DumpHiddenCategoriesCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.DumpHiddenCategoriesCommandlet.md#__tid_commandlet__)
- [\_\_tid\_DumpHiddenCategoriesCommandlet\_\_](ue_ue.DumpHiddenCategoriesCommandlet.md#__tid_dumphiddencategoriescommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.DumpHiddenCategoriesCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.DumpHiddenCategoriesCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.DumpHiddenCategoriesCommandlet.md#executeubergraph)
- [GetClass](ue_ue.DumpHiddenCategoriesCommandlet.md#getclass)
- [GetName](ue_ue.DumpHiddenCategoriesCommandlet.md#getname)
- [GetOuter](ue_ue.DumpHiddenCategoriesCommandlet.md#getouter)
- [GetWorld](ue_ue.DumpHiddenCategoriesCommandlet.md#getworld)
- [Find](ue_ue.DumpHiddenCategoriesCommandlet.md#find)
- [Load](ue_ue.DumpHiddenCategoriesCommandlet.md#load)
- [StaticClass](ue_ue.DumpHiddenCategoriesCommandlet.md#staticclass)

## Constructors

### constructor

• **new DumpHiddenCategoriesCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:31270](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L31270)
...
### \_\_tid\_DumpHiddenCategoriesCommandlet\_\_

• **\_\_tid\_DumpHiddenCategoriesCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:31275](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L31275)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`DumpHiddenCategoriesCommandlet`](ue_ue.DumpHiddenCategoriesCommandlet.md)
...
[ue/ue.d.ts:31272](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L31272)

___

### Load

▸ `Static` **Load**(`InName`): [`DumpHiddenCategoriesCommandlet`](ue_ue.DumpHiddenCategoriesCommandlet.md)
...
[ue/ue.d.ts:31273](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L31273)
...
[ue/ue.d.ts:31271](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L31271)
