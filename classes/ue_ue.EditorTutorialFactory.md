[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / EditorTutorialFactory

# Class: EditorTutorialFactory

[ue/ue](../modules/ue_ue.md).EditorTutorialFactory
...
- [constructor](ue_ue.EditorTutorialFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.EditorTutorialFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.EditorTutorialFactory.md#automatedimportdata)
- [ContextClass](ue_ue.EditorTutorialFactory.md#contextclass)
- [Formats](ue_ue.EditorTutorialFactory.md#formats)
- [ImportPriority](ue_ue.EditorTutorialFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.EditorTutorialFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.EditorTutorialFactory.md#supportedclass)
- [\_\_tid\_EditorTutorialFactory\_\_](ue_ue.EditorTutorialFactory.md#__tid_editortutorialfactory__)
- [\_\_tid\_Factory\_\_](ue_ue.EditorTutorialFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.EditorTutorialFactory.md#__tid_object__)
- [bCreateNew](ue_ue.EditorTutorialFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.EditorTutorialFactory.md#beditafternew)
- [bEditorImport](ue_ue.EditorTutorialFactory.md#beditorimport)
- [bText](ue_ue.EditorTutorialFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.EditorTutorialFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.EditorTutorialFactory.md#executeubergraph)
- [GetClass](ue_ue.EditorTutorialFactory.md#getclass)
- [GetName](ue_ue.EditorTutorialFactory.md#getname)
- [GetOuter](ue_ue.EditorTutorialFactory.md#getouter)
- [GetWorld](ue_ue.EditorTutorialFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.EditorTutorialFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.EditorTutorialFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.EditorTutorialFactory.md#find)
- [Load](ue_ue.EditorTutorialFactory.md#load)
- [StaticClass](ue_ue.EditorTutorialFactory.md#staticclass)

## Constructors

### constructor

• **new EditorTutorialFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:33452](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33452)
...
### \_\_tid\_EditorTutorialFactory\_\_

• **\_\_tid\_EditorTutorialFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:33457](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33457)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`EditorTutorialFactory`](ue_ue.EditorTutorialFactory.md)
...
[ue/ue.d.ts:33454](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33454)

___

### Load

▸ `Static` **Load**(`InName`): [`EditorTutorialFactory`](ue_ue.EditorTutorialFactory.md)
...
[ue/ue.d.ts:33455](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33455)
...
[ue/ue.d.ts:33453](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33453)
