[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / EditorUtilityActorComponent

# Class: EditorUtilityActorComponent

[ue/ue](../modules/ue_ue.md).EditorUtilityActorComponent
...
- [constructor](ue_ue.EditorUtilityActorComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.EditorUtilityActorComponent.md#assetuserdata)
- [ComponentTags](ue_ue.EditorUtilityActorComponent.md#componenttags)
- [CreationMethod](ue_ue.EditorUtilityActorComponent.md#creationmethod)
- [OnComponentActivated](ue_ue.EditorUtilityActorComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.EditorUtilityActorComponent.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.EditorUtilityActorComponent.md#primarycomponenttick)
- [UCSModifiedProperties](ue_ue.EditorUtilityActorComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.EditorUtilityActorComponent.md#__tid_actorcomponent__)
- [\_\_tid\_EditorUtilityActorComponent\_\_](ue_ue.EditorUtilityActorComponent.md#__tid_editorutilityactorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.EditorUtilityActorComponent.md#__tid_object__)
- [bAutoActivate](ue_ue.EditorUtilityActorComponent.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.EditorUtilityActorComponent.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.EditorUtilityActorComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.EditorUtilityActorComponent.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.EditorUtilityActorComponent.md#binstancecomponent)
- [bIsActive](ue_ue.EditorUtilityActorComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.EditorUtilityActorComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.EditorUtilityActorComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.EditorUtilityActorComponent.md#bnetaddressable)
- [bReplicates](ue_ue.EditorUtilityActorComponent.md#breplicates)

### Methods

- [Activate](ue_ue.EditorUtilityActorComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.EditorUtilityActorComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.EditorUtilityActorComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.EditorUtilityActorComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.EditorUtilityActorComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.EditorUtilityActorComponent.md#deactivate)
- [ExecuteUbergraph](ue_ue.EditorUtilityActorComponent.md#executeubergraph)
- [GetClass](ue_ue.EditorUtilityActorComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.EditorUtilityActorComponent.md#getcomponenttickinterval)
- [GetName](ue_ue.EditorUtilityActorComponent.md#getname)
- [GetOuter](ue_ue.EditorUtilityActorComponent.md#getouter)
- [GetOwner](ue_ue.EditorUtilityActorComponent.md#getowner)
- [GetWorld](ue_ue.EditorUtilityActorComponent.md#getworld)
- [IsActive](ue_ue.EditorUtilityActorComponent.md#isactive)
- [IsBeingDestroyed](ue_ue.EditorUtilityActorComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.EditorUtilityActorComponent.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.EditorUtilityActorComponent.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.EditorUtilityActorComponent.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.EditorUtilityActorComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.EditorUtilityActorComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.EditorUtilityActorComponent.md#receivetick)
- [RegisterComponent](ue_ue.EditorUtilityActorComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.EditorUtilityActorComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.EditorUtilityActorComponent.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.EditorUtilityActorComponent.md#setactive)
- [SetAutoActivate](ue_ue.EditorUtilityActorComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.EditorUtilityActorComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.EditorUtilityActorComponent.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.EditorUtilityActorComponent.md#setisreplicated)
- [SetTickGroup](ue_ue.EditorUtilityActorComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.EditorUtilityActorComponent.md#settickablewhenpaused)
- [ToggleActive](ue_ue.EditorUtilityActorComponent.md#toggleactive)
- [Find](ue_ue.EditorUtilityActorComponent.md#find)
- [Load](ue_ue.EditorUtilityActorComponent.md#load)
- [StaticClass](ue_ue.EditorUtilityActorComponent.md#staticclass)

## Constructors

### constructor

• **new EditorUtilityActorComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:33525](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33525)
...
### \_\_tid\_EditorUtilityActorComponent\_\_

• **\_\_tid\_EditorUtilityActorComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:33530](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33530)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`EditorUtilityActorComponent`](ue_ue.EditorUtilityActorComponent.md)
...
[ue/ue.d.ts:33527](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33527)

___

### Load

▸ `Static` **Load**(`InName`): [`EditorUtilityActorComponent`](ue_ue.EditorUtilityActorComponent.md)
...
[ue/ue.d.ts:33528](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33528)
...
[ue/ue.d.ts:33526](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L33526)
