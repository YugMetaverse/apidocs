[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / EnvQueryGenerator\_SimpleGrid
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`EnvQueryGenerator_SimpleGrid`](ue_ue.EnvQueryGenerator_SimpleGrid.md)
