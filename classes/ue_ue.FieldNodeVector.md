[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / FieldNodeVector

# Class: FieldNodeVector

[ue/ue](../modules/ue_ue.md).FieldNodeVector
...
- [constructor](ue_ue.FieldNodeVector.md#constructor)

### Properties

- [AssetUserData](ue_ue.FieldNodeVector.md#assetuserdata)
- [ComponentTags](ue_ue.FieldNodeVector.md#componenttags)
- [CreationMethod](ue_ue.FieldNodeVector.md#creationmethod)
- [OnComponentActivated](ue_ue.FieldNodeVector.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.FieldNodeVector.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.FieldNodeVector.md#primarycomponenttick)
- [UCSModifiedProperties](ue_ue.FieldNodeVector.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.FieldNodeVector.md#__tid_actorcomponent__)
- [\_\_tid\_FieldNodeBase\_\_](ue_ue.FieldNodeVector.md#__tid_fieldnodebase__)
- [\_\_tid\_FieldNodeVector\_\_](ue_ue.FieldNodeVector.md#__tid_fieldnodevector__)
- [\_\_tid\_Object\_\_](ue_ue.FieldNodeVector.md#__tid_object__)
- [bAutoActivate](ue_ue.FieldNodeVector.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.FieldNodeVector.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.FieldNodeVector.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.FieldNodeVector.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.FieldNodeVector.md#binstancecomponent)
- [bIsActive](ue_ue.FieldNodeVector.md#bisactive)
- [bIsEditorOnly](ue_ue.FieldNodeVector.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.FieldNodeVector.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.FieldNodeVector.md#bnetaddressable)
- [bReplicates](ue_ue.FieldNodeVector.md#breplicates)

### Methods

- [Activate](ue_ue.FieldNodeVector.md#activate)
- [AddTickPrerequisiteActor](ue_ue.FieldNodeVector.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.FieldNodeVector.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.FieldNodeVector.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.FieldNodeVector.md#createdefaultsubobject)
- [Deactivate](ue_ue.FieldNodeVector.md#deactivate)
- [ExecuteUbergraph](ue_ue.FieldNodeVector.md#executeubergraph)
- [GetClass](ue_ue.FieldNodeVector.md#getclass)
- [GetComponentTickInterval](ue_ue.FieldNodeVector.md#getcomponenttickinterval)
- [GetName](ue_ue.FieldNodeVector.md#getname)
- [GetOuter](ue_ue.FieldNodeVector.md#getouter)
- [GetOwner](ue_ue.FieldNodeVector.md#getowner)
- [GetWorld](ue_ue.FieldNodeVector.md#getworld)
- [IsActive](ue_ue.FieldNodeVector.md#isactive)
- [IsBeingDestroyed](ue_ue.FieldNodeVector.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.FieldNodeVector.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.FieldNodeVector.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.FieldNodeVector.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.FieldNodeVector.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.FieldNodeVector.md#receiveendplay)
- [ReceiveTick](ue_ue.FieldNodeVector.md#receivetick)
- [RegisterComponent](ue_ue.FieldNodeVector.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.FieldNodeVector.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.FieldNodeVector.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.FieldNodeVector.md#setactive)
- [SetAutoActivate](ue_ue.FieldNodeVector.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.FieldNodeVector.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.FieldNodeVector.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.FieldNodeVector.md#setisreplicated)
- [SetTickGroup](ue_ue.FieldNodeVector.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.FieldNodeVector.md#settickablewhenpaused)
- [ToggleActive](ue_ue.FieldNodeVector.md#toggleactive)
- [Find](ue_ue.FieldNodeVector.md#find)
- [Load](ue_ue.FieldNodeVector.md#load)
- [StaticClass](ue_ue.FieldNodeVector.md#staticclass)

## Constructors

### constructor

• **new FieldNodeVector**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:35486](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35486)
...
[ue/ue.d.ts:35491](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35491)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`FieldNodeVector`](ue_ue.FieldNodeVector.md)
...
[ue/ue.d.ts:35488](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35488)

___

### Load

▸ `Static` **Load**(`InName`): [`FieldNodeVector`](ue_ue.FieldNodeVector.md)
...
[ue/ue.d.ts:35489](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35489)
...
[ue/ue.d.ts:35487](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35487)
