[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / FileMediaSourceFactoryNew

# Class: FileMediaSourceFactoryNew

[ue/ue](../modules/ue_ue.md).FileMediaSourceFactoryNew
...
- [constructor](ue_ue.FileMediaSourceFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.FileMediaSourceFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.FileMediaSourceFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.FileMediaSourceFactoryNew.md#contextclass)
- [Formats](ue_ue.FileMediaSourceFactoryNew.md#formats)
- [ImportPriority](ue_ue.FileMediaSourceFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.FileMediaSourceFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.FileMediaSourceFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.FileMediaSourceFactoryNew.md#__tid_factory__)
- [\_\_tid\_FileMediaSourceFactoryNew\_\_](ue_ue.FileMediaSourceFactoryNew.md#__tid_filemediasourcefactorynew__)
- [\_\_tid\_Object\_\_](ue_ue.FileMediaSourceFactoryNew.md#__tid_object__)
- [bCreateNew](ue_ue.FileMediaSourceFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.FileMediaSourceFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.FileMediaSourceFactoryNew.md#beditorimport)
- [bText](ue_ue.FileMediaSourceFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.FileMediaSourceFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.FileMediaSourceFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.FileMediaSourceFactoryNew.md#getclass)
- [GetName](ue_ue.FileMediaSourceFactoryNew.md#getname)
- [GetOuter](ue_ue.FileMediaSourceFactoryNew.md#getouter)
- [GetWorld](ue_ue.FileMediaSourceFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.FileMediaSourceFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.FileMediaSourceFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.FileMediaSourceFactoryNew.md#find)
- [Load](ue_ue.FileMediaSourceFactoryNew.md#load)
- [StaticClass](ue_ue.FileMediaSourceFactoryNew.md#staticclass)

## Constructors

### constructor

• **new FileMediaSourceFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:35529](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35529)
...
### \_\_tid\_FileMediaSourceFactoryNew\_\_

• **\_\_tid\_FileMediaSourceFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:35534](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35534)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`FileMediaSourceFactoryNew`](ue_ue.FileMediaSourceFactoryNew.md)
...
[ue/ue.d.ts:35531](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35531)

___

### Load

▸ `Static` **Load**(`InName`): [`FileMediaSourceFactoryNew`](ue_ue.FileMediaSourceFactoryNew.md)
...
[ue/ue.d.ts:35532](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35532)
...
[ue/ue.d.ts:35530](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35530)
