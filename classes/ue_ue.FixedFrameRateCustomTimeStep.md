[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / FixedFrameRateCustomTimeStep
...
▸ `Static` **Load**(`InName`): [`FixedFrameRateCustomTimeStep`](ue_ue.FixedFrameRateCustomTimeStep.md)
