[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / FoliageType\_ActorFactory

# Class: FoliageType\_ActorFactory

[ue/ue](../modules/ue_ue.md).FoliageType_ActorFactory
...
- [constructor](ue_ue.FoliageType_ActorFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.FoliageType_ActorFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.FoliageType_ActorFactory.md#automatedimportdata)
- [ContextClass](ue_ue.FoliageType_ActorFactory.md#contextclass)
- [Formats](ue_ue.FoliageType_ActorFactory.md#formats)
- [ImportPriority](ue_ue.FoliageType_ActorFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.FoliageType_ActorFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.FoliageType_ActorFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.FoliageType_ActorFactory.md#__tid_factory__)
- [\_\_tid\_FoliageType\_ActorFactory\_\_](ue_ue.FoliageType_ActorFactory.md#__tid_foliagetype_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.FoliageType_ActorFactory.md#__tid_object__)
- [bCreateNew](ue_ue.FoliageType_ActorFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.FoliageType_ActorFactory.md#beditafternew)
- [bEditorImport](ue_ue.FoliageType_ActorFactory.md#beditorimport)
- [bText](ue_ue.FoliageType_ActorFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.FoliageType_ActorFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.FoliageType_ActorFactory.md#executeubergraph)
- [GetClass](ue_ue.FoliageType_ActorFactory.md#getclass)
- [GetName](ue_ue.FoliageType_ActorFactory.md#getname)
- [GetOuter](ue_ue.FoliageType_ActorFactory.md#getouter)
- [GetWorld](ue_ue.FoliageType_ActorFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.FoliageType_ActorFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.FoliageType_ActorFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.FoliageType_ActorFactory.md#find)
- [Load](ue_ue.FoliageType_ActorFactory.md#load)
- [StaticClass](ue_ue.FoliageType_ActorFactory.md#staticclass)

## Constructors

### constructor

• **new FoliageType_ActorFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:36032](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36032)
...
### \_\_tid\_FoliageType\_ActorFactory\_\_

• **\_\_tid\_FoliageType\_ActorFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:36037](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36037)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`FoliageType_ActorFactory`](ue_ue.FoliageType_ActorFactory.md)
...
[ue/ue.d.ts:36034](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36034)

___

### Load

▸ `Static` **Load**(`InName`): [`FoliageType_ActorFactory`](ue_ue.FoliageType_ActorFactory.md)
...
[ue/ue.d.ts:36035](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36035)
...
[ue/ue.d.ts:36033](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36033)
