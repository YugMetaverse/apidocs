[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / FoliageType\_InstancedStaticMeshFactory

# Class: FoliageType\_InstancedStaticMeshFactory

[ue/ue](../modules/ue_ue.md).FoliageType_InstancedStaticMeshFactory
...
- [constructor](ue_ue.FoliageType_InstancedStaticMeshFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.FoliageType_InstancedStaticMeshFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.FoliageType_InstancedStaticMeshFactory.md#automatedimportdata)
- [ContextClass](ue_ue.FoliageType_InstancedStaticMeshFactory.md#contextclass)
- [Formats](ue_ue.FoliageType_InstancedStaticMeshFactory.md#formats)
- [ImportPriority](ue_ue.FoliageType_InstancedStaticMeshFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.FoliageType_InstancedStaticMeshFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.FoliageType_InstancedStaticMeshFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.FoliageType_InstancedStaticMeshFactory.md#__tid_factory__)
- [\_\_tid\_FoliageType\_InstancedStaticMeshFactory\_\_](ue_ue.FoliageType_InstancedStaticMeshFactory.md#__tid_foliagetype_instancedstaticmeshfactory__)
- [\_\_tid\_Object\_\_](ue_ue.FoliageType_InstancedStaticMeshFactory.md#__tid_object__)
- [bCreateNew](ue_ue.FoliageType_InstancedStaticMeshFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.FoliageType_InstancedStaticMeshFactory.md#beditafternew)
- [bEditorImport](ue_ue.FoliageType_InstancedStaticMeshFactory.md#beditorimport)
- [bText](ue_ue.FoliageType_InstancedStaticMeshFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.FoliageType_InstancedStaticMeshFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.FoliageType_InstancedStaticMeshFactory.md#executeubergraph)
- [GetClass](ue_ue.FoliageType_InstancedStaticMeshFactory.md#getclass)
- [GetName](ue_ue.FoliageType_InstancedStaticMeshFactory.md#getname)
- [GetOuter](ue_ue.FoliageType_InstancedStaticMeshFactory.md#getouter)
- [GetWorld](ue_ue.FoliageType_InstancedStaticMeshFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.FoliageType_InstancedStaticMeshFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.FoliageType_InstancedStaticMeshFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.FoliageType_InstancedStaticMeshFactory.md#find)
- [Load](ue_ue.FoliageType_InstancedStaticMeshFactory.md#load)
- [StaticClass](ue_ue.FoliageType_InstancedStaticMeshFactory.md#staticclass)

## Constructors

### constructor

• **new FoliageType_InstancedStaticMeshFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:36062](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36062)
...
### \_\_tid\_FoliageType\_InstancedStaticMeshFactory\_\_

• **\_\_tid\_FoliageType\_InstancedStaticMeshFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:36067](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36067)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`FoliageType_InstancedStaticMeshFactory`](ue_ue.FoliageType_InstancedStaticMeshFactory.md)
...
[ue/ue.d.ts:36064](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36064)

___

### Load

▸ `Static` **Load**(`InName`): [`FoliageType_InstancedStaticMeshFactory`](ue_ue.FoliageType_InstancedStaticMeshFactory.md)
...
[ue/ue.d.ts:36065](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36065)
...
[ue/ue.d.ts:36063](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36063)
