[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / FontFactory

# Class: FontFactory

[ue/ue](../modules/ue_ue.md).FontFactory
...
- [constructor](ue_ue.FontFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.FontFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.FontFactory.md#automatedimportdata)
- [ContextClass](ue_ue.FontFactory.md#contextclass)
- [Formats](ue_ue.FontFactory.md#formats)
- [ImportPriority](ue_ue.FontFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.FontFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.FontFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.FontFactory.md#__tid_factory__)
- [\_\_tid\_FontFactory\_\_](ue_ue.FontFactory.md#__tid_fontfactory__)
- [\_\_tid\_Object\_\_](ue_ue.FontFactory.md#__tid_object__)
- [bCreateNew](ue_ue.FontFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.FontFactory.md#beditafternew)
- [bEditorImport](ue_ue.FontFactory.md#beditorimport)
- [bText](ue_ue.FontFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.FontFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.FontFactory.md#executeubergraph)
- [GetClass](ue_ue.FontFactory.md#getclass)
- [GetName](ue_ue.FontFactory.md#getname)
- [GetOuter](ue_ue.FontFactory.md#getouter)
- [GetWorld](ue_ue.FontFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.FontFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.FontFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.FontFactory.md#find)
- [Load](ue_ue.FontFactory.md#load)
- [StaticClass](ue_ue.FontFactory.md#staticclass)

## Constructors

### constructor

• **new FontFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:36104](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36104)
...
### \_\_tid\_FontFactory\_\_

• **\_\_tid\_FontFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:36109](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36109)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`FontFactory`](ue_ue.FontFactory.md)
...
[ue/ue.d.ts:36106](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36106)

___

### Load

▸ `Static` **Load**(`InName`): [`FontFactory`](ue_ue.FontFactory.md)
...
[ue/ue.d.ts:36107](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36107)
...
[ue/ue.d.ts:36105](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36105)
