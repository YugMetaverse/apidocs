[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ForceFeedbackAttenuationFactory

# Class: ForceFeedbackAttenuationFactory

[ue/ue](../modules/ue_ue.md).ForceFeedbackAttenuationFactory
...
- [constructor](ue_ue.ForceFeedbackAttenuationFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.ForceFeedbackAttenuationFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.ForceFeedbackAttenuationFactory.md#automatedimportdata)
- [ContextClass](ue_ue.ForceFeedbackAttenuationFactory.md#contextclass)
- [Formats](ue_ue.ForceFeedbackAttenuationFactory.md#formats)
- [ImportPriority](ue_ue.ForceFeedbackAttenuationFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.ForceFeedbackAttenuationFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.ForceFeedbackAttenuationFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.ForceFeedbackAttenuationFactory.md#__tid_factory__)
- [\_\_tid\_ForceFeedbackAttenuationFactory\_\_](ue_ue.ForceFeedbackAttenuationFactory.md#__tid_forcefeedbackattenuationfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ForceFeedbackAttenuationFactory.md#__tid_object__)
- [bCreateNew](ue_ue.ForceFeedbackAttenuationFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.ForceFeedbackAttenuationFactory.md#beditafternew)
- [bEditorImport](ue_ue.ForceFeedbackAttenuationFactory.md#beditorimport)
- [bText](ue_ue.ForceFeedbackAttenuationFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.ForceFeedbackAttenuationFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ForceFeedbackAttenuationFactory.md#executeubergraph)
- [GetClass](ue_ue.ForceFeedbackAttenuationFactory.md#getclass)
- [GetName](ue_ue.ForceFeedbackAttenuationFactory.md#getname)
- [GetOuter](ue_ue.ForceFeedbackAttenuationFactory.md#getouter)
- [GetWorld](ue_ue.ForceFeedbackAttenuationFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.ForceFeedbackAttenuationFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.ForceFeedbackAttenuationFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.ForceFeedbackAttenuationFactory.md#find)
- [Load](ue_ue.ForceFeedbackAttenuationFactory.md#load)
- [StaticClass](ue_ue.ForceFeedbackAttenuationFactory.md#staticclass)

## Constructors

### constructor

• **new ForceFeedbackAttenuationFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:36179](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36179)
...
### \_\_tid\_ForceFeedbackAttenuationFactory\_\_

• **\_\_tid\_ForceFeedbackAttenuationFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:36184](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36184)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ForceFeedbackAttenuationFactory`](ue_ue.ForceFeedbackAttenuationFactory.md)
...
[ue/ue.d.ts:36181](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36181)

___

### Load

▸ `Static` **Load**(`InName`): [`ForceFeedbackAttenuationFactory`](ue_ue.ForceFeedbackAttenuationFactory.md)
...
[ue/ue.d.ts:36182](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36182)
...
[ue/ue.d.ts:36180](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36180)
