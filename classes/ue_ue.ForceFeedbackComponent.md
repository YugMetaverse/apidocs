[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ForceFeedbackComponent

# Class: ForceFeedbackComponent

[ue/ue](../modules/ue_ue.md).ForceFeedbackComponent
...
- [constructor](ue_ue.ForceFeedbackComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.ForceFeedbackComponent.md#assetuserdata)
- [AttachChildren](ue_ue.ForceFeedbackComponent.md#attachchildren)
- [AttachParent](ue_ue.ForceFeedbackComponent.md#attachparent)
- [AttachSocketName](ue_ue.ForceFeedbackComponent.md#attachsocketname)
- [AttenuationOverrides](ue_ue.ForceFeedbackComponent.md#attenuationoverrides)
- [AttenuationSettings](ue_ue.ForceFeedbackComponent.md#attenuationsettings)
- [ClientAttachedChildren](ue_ue.ForceFeedbackComponent.md#clientattachedchildren)
- [ComponentTags](ue_ue.ForceFeedbackComponent.md#componenttags)
- [ComponentVelocity](ue_ue.ForceFeedbackComponent.md#componentvelocity)
- [CreationMethod](ue_ue.ForceFeedbackComponent.md#creationmethod)
- [DetailMode](ue_ue.ForceFeedbackComponent.md#detailmode)
- [ForceFeedbackEffect](ue_ue.ForceFeedbackComponent.md#forcefeedbackeffect)
- [IntensityMultiplier](ue_ue.ForceFeedbackComponent.md#intensitymultiplier)
- [Mobility](ue_ue.ForceFeedbackComponent.md#mobility)
- [OnComponentActivated](ue_ue.ForceFeedbackComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.ForceFeedbackComponent.md#oncomponentdeactivated)
- [OnForceFeedbackFinished](ue_ue.ForceFeedbackComponent.md#onforcefeedbackfinished)
- [PhysicsVolume](ue_ue.ForceFeedbackComponent.md#physicsvolume)
- [PhysicsVolumeChangedDelegate](ue_ue.ForceFeedbackComponent.md#physicsvolumechangeddelegate)
- [PrimaryComponentTick](ue_ue.ForceFeedbackComponent.md#primarycomponenttick)
- [RelativeLocation](ue_ue.ForceFeedbackComponent.md#relativelocation)
- [RelativeRotation](ue_ue.ForceFeedbackComponent.md#relativerotation)
- [RelativeScale3D](ue_ue.ForceFeedbackComponent.md#relativescale3d)
- [UCSModifiedProperties](ue_ue.ForceFeedbackComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.ForceFeedbackComponent.md#__tid_actorcomponent__)
- [\_\_tid\_ForceFeedbackComponent\_\_](ue_ue.ForceFeedbackComponent.md#__tid_forcefeedbackcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.ForceFeedbackComponent.md#__tid_object__)
- [\_\_tid\_SceneComponent\_\_](ue_ue.ForceFeedbackComponent.md#__tid_scenecomponent__)
- [bAbsoluteLocation](ue_ue.ForceFeedbackComponent.md#babsolutelocation)
- [bAbsoluteRotation](ue_ue.ForceFeedbackComponent.md#babsoluterotation)
- [bAbsoluteScale](ue_ue.ForceFeedbackComponent.md#babsolutescale)
- [bAutoActivate](ue_ue.ForceFeedbackComponent.md#bautoactivate)
- [bAutoDestroy](ue_ue.ForceFeedbackComponent.md#bautodestroy)
- [bBoundsChangeTriggersStreamingDataRebuild](ue_ue.ForceFeedbackComponent.md#bboundschangetriggersstreamingdatarebuild)
- [bCanEverAffectNavigation](ue_ue.ForceFeedbackComponent.md#bcaneveraffectnavigation)
- [bComponentToWorldUpdated](ue_ue.ForceFeedbackComponent.md#bcomponenttoworldupdated)
- [bCreatedByConstructionScript](ue_ue.ForceFeedbackComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.ForceFeedbackComponent.md#beditablewheninherited)
- [bHiddenInGame](ue_ue.ForceFeedbackComponent.md#bhiddeningame)
- [bIgnoreTimeDilation](ue_ue.ForceFeedbackComponent.md#bignoretimedilation)
- [bInstanceComponent](ue_ue.ForceFeedbackComponent.md#binstancecomponent)
- [bIsActive](ue_ue.ForceFeedbackComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.ForceFeedbackComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.ForceFeedbackComponent.md#bisvisualizationcomponent)
- [bLooping](ue_ue.ForceFeedbackComponent.md#blooping)
- [bNetAddressable](ue_ue.ForceFeedbackComponent.md#bnetaddressable)
- [bOverrideAttenuation](ue_ue.ForceFeedbackComponent.md#boverrideattenuation)
- [bReplicates](ue_ue.ForceFeedbackComponent.md#breplicates)
- [bShouldBeAttached](ue_ue.ForceFeedbackComponent.md#bshouldbeattached)
- [bShouldSnapLocationWhenAttached](ue_ue.ForceFeedbackComponent.md#bshouldsnaplocationwhenattached)
- [bShouldSnapRotationWhenAttached](ue_ue.ForceFeedbackComponent.md#bshouldsnaprotationwhenattached)
- [bShouldUpdatePhysicsVolume](ue_ue.ForceFeedbackComponent.md#bshouldupdatephysicsvolume)
- [bStopWhenOwnerDestroyed](ue_ue.ForceFeedbackComponent.md#bstopwhenownerdestroyed)
- [bUseAttachParentBound](ue_ue.ForceFeedbackComponent.md#buseattachparentbound)
- [bVisible](ue_ue.ForceFeedbackComponent.md#bvisible)
- [bVisualizeComponent](ue_ue.ForceFeedbackComponent.md#bvisualizecomponent)

### Methods

- [Activate](ue_ue.ForceFeedbackComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.ForceFeedbackComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.ForceFeedbackComponent.md#addtickprerequisitecomponent)
- [AdjustAttenuation](ue_ue.ForceFeedbackComponent.md#adjustattenuation)
- [BP\_GetAttenuationSettingsToApply](ue_ue.ForceFeedbackComponent.md#bp_getattenuationsettingstoapply)
- [ComponentHasTag](ue_ue.ForceFeedbackComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.ForceFeedbackComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.ForceFeedbackComponent.md#deactivate)
- [DetachFromParent](ue_ue.ForceFeedbackComponent.md#detachfromparent)
- [DoesSocketExist](ue_ue.ForceFeedbackComponent.md#doessocketexist)
- [ExecuteUbergraph](ue_ue.ForceFeedbackComponent.md#executeubergraph)
- [GetAllSocketNames](ue_ue.ForceFeedbackComponent.md#getallsocketnames)
- [GetAttachParent](ue_ue.ForceFeedbackComponent.md#getattachparent)
- [GetAttachSocketName](ue_ue.ForceFeedbackComponent.md#getattachsocketname)
- [GetChildComponent](ue_ue.ForceFeedbackComponent.md#getchildcomponent)
- [GetChildrenComponents](ue_ue.ForceFeedbackComponent.md#getchildrencomponents)
- [GetClass](ue_ue.ForceFeedbackComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.ForceFeedbackComponent.md#getcomponenttickinterval)
- [GetComponentVelocity](ue_ue.ForceFeedbackComponent.md#getcomponentvelocity)
- [GetForwardVector](ue_ue.ForceFeedbackComponent.md#getforwardvector)
- [GetName](ue_ue.ForceFeedbackComponent.md#getname)
- [GetNumChildrenComponents](ue_ue.ForceFeedbackComponent.md#getnumchildrencomponents)
- [GetOuter](ue_ue.ForceFeedbackComponent.md#getouter)
- [GetOwner](ue_ue.ForceFeedbackComponent.md#getowner)
- [GetParentComponents](ue_ue.ForceFeedbackComponent.md#getparentcomponents)
- [GetPhysicsVolume](ue_ue.ForceFeedbackComponent.md#getphysicsvolume)
- [GetRelativeTransform](ue_ue.ForceFeedbackComponent.md#getrelativetransform)
- [GetRightVector](ue_ue.ForceFeedbackComponent.md#getrightvector)
- [GetShouldUpdatePhysicsVolume](ue_ue.ForceFeedbackComponent.md#getshouldupdatephysicsvolume)
- [GetSocketLocation](ue_ue.ForceFeedbackComponent.md#getsocketlocation)
- [GetSocketQuaternion](ue_ue.ForceFeedbackComponent.md#getsocketquaternion)
- [GetSocketRotation](ue_ue.ForceFeedbackComponent.md#getsocketrotation)
- [GetSocketTransform](ue_ue.ForceFeedbackComponent.md#getsockettransform)
- [GetUpVector](ue_ue.ForceFeedbackComponent.md#getupvector)
- [GetWorld](ue_ue.ForceFeedbackComponent.md#getworld)
- [IsActive](ue_ue.ForceFeedbackComponent.md#isactive)
- [IsAnySimulatingPhysics](ue_ue.ForceFeedbackComponent.md#isanysimulatingphysics)
- [IsBeingDestroyed](ue_ue.ForceFeedbackComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.ForceFeedbackComponent.md#iscomponenttickenabled)
- [IsSimulatingPhysics](ue_ue.ForceFeedbackComponent.md#issimulatingphysics)
- [IsVisible](ue_ue.ForceFeedbackComponent.md#isvisible)
- [K2\_AddLocalOffset](ue_ue.ForceFeedbackComponent.md#k2_addlocaloffset)
- [K2\_AddLocalRotation](ue_ue.ForceFeedbackComponent.md#k2_addlocalrotation)
- [K2\_AddLocalTransform](ue_ue.ForceFeedbackComponent.md#k2_addlocaltransform)
- [K2\_AddRelativeLocation](ue_ue.ForceFeedbackComponent.md#k2_addrelativelocation)
- [K2\_AddRelativeRotation](ue_ue.ForceFeedbackComponent.md#k2_addrelativerotation)
- [K2\_AddWorldOffset](ue_ue.ForceFeedbackComponent.md#k2_addworldoffset)
- [K2\_AddWorldRotation](ue_ue.ForceFeedbackComponent.md#k2_addworldrotation)
- [K2\_AddWorldTransform](ue_ue.ForceFeedbackComponent.md#k2_addworldtransform)
- [K2\_AttachTo](ue_ue.ForceFeedbackComponent.md#k2_attachto)
- [K2\_AttachToComponent](ue_ue.ForceFeedbackComponent.md#k2_attachtocomponent)
- [K2\_DestroyComponent](ue_ue.ForceFeedbackComponent.md#k2_destroycomponent)
- [K2\_DetachFromComponent](ue_ue.ForceFeedbackComponent.md#k2_detachfromcomponent)
- [K2\_GetComponentLocation](ue_ue.ForceFeedbackComponent.md#k2_getcomponentlocation)
- [K2\_GetComponentRotation](ue_ue.ForceFeedbackComponent.md#k2_getcomponentrotation)
- [K2\_GetComponentScale](ue_ue.ForceFeedbackComponent.md#k2_getcomponentscale)
- [K2\_GetComponentToWorld](ue_ue.ForceFeedbackComponent.md#k2_getcomponenttoworld)
- [K2\_SetRelativeLocation](ue_ue.ForceFeedbackComponent.md#k2_setrelativelocation)
- [K2\_SetRelativeLocationAndRotation](ue_ue.ForceFeedbackComponent.md#k2_setrelativelocationandrotation)
- [K2\_SetRelativeRotation](ue_ue.ForceFeedbackComponent.md#k2_setrelativerotation)
- [K2\_SetRelativeTransform](ue_ue.ForceFeedbackComponent.md#k2_setrelativetransform)
- [K2\_SetWorldLocation](ue_ue.ForceFeedbackComponent.md#k2_setworldlocation)
- [K2\_SetWorldLocationAndRotation](ue_ue.ForceFeedbackComponent.md#k2_setworldlocationandrotation)
- [K2\_SetWorldRotation](ue_ue.ForceFeedbackComponent.md#k2_setworldrotation)
- [K2\_SetWorldTransform](ue_ue.ForceFeedbackComponent.md#k2_setworldtransform)
- [OnRep\_AttachChildren](ue_ue.ForceFeedbackComponent.md#onrep_attachchildren)
- [OnRep\_AttachParent](ue_ue.ForceFeedbackComponent.md#onrep_attachparent)
- [OnRep\_AttachSocketName](ue_ue.ForceFeedbackComponent.md#onrep_attachsocketname)
- [OnRep\_IsActive](ue_ue.ForceFeedbackComponent.md#onrep_isactive)
- [OnRep\_Transform](ue_ue.ForceFeedbackComponent.md#onrep_transform)
- [OnRep\_Visibility](ue_ue.ForceFeedbackComponent.md#onrep_visibility)
- [Play](ue_ue.ForceFeedbackComponent.md#play)
- [ReceiveBeginPlay](ue_ue.ForceFeedbackComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.ForceFeedbackComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.ForceFeedbackComponent.md#receivetick)
- [RegisterComponent](ue_ue.ForceFeedbackComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.ForceFeedbackComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.ForceFeedbackComponent.md#removetickprerequisitecomponent)
- [ResetRelativeTransform](ue_ue.ForceFeedbackComponent.md#resetrelativetransform)
- [SetAbsolute](ue_ue.ForceFeedbackComponent.md#setabsolute)
- [SetActive](ue_ue.ForceFeedbackComponent.md#setactive)
- [SetAutoActivate](ue_ue.ForceFeedbackComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.ForceFeedbackComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.ForceFeedbackComponent.md#setcomponenttickinterval)
- [SetForceFeedbackEffect](ue_ue.ForceFeedbackComponent.md#setforcefeedbackeffect)
- [SetHiddenInGame](ue_ue.ForceFeedbackComponent.md#sethiddeningame)
- [SetIntensityMultiplier](ue_ue.ForceFeedbackComponent.md#setintensitymultiplier)
- [SetIsReplicated](ue_ue.ForceFeedbackComponent.md#setisreplicated)
- [SetMobility](ue_ue.ForceFeedbackComponent.md#setmobility)
- [SetRelativeScale3D](ue_ue.ForceFeedbackComponent.md#setrelativescale3d)
- [SetShouldUpdatePhysicsVolume](ue_ue.ForceFeedbackComponent.md#setshouldupdatephysicsvolume)
- [SetTickGroup](ue_ue.ForceFeedbackComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.ForceFeedbackComponent.md#settickablewhenpaused)
- [SetVisibility](ue_ue.ForceFeedbackComponent.md#setvisibility)
- [SetWorldScale3D](ue_ue.ForceFeedbackComponent.md#setworldscale3d)
- [SetupAttachment](ue_ue.ForceFeedbackComponent.md#setupattachment)
- [SnapTo](ue_ue.ForceFeedbackComponent.md#snapto)
- [Stop](ue_ue.ForceFeedbackComponent.md#stop)
- [ToggleActive](ue_ue.ForceFeedbackComponent.md#toggleactive)
- [ToggleVisibility](ue_ue.ForceFeedbackComponent.md#togglevisibility)
- [Find](ue_ue.ForceFeedbackComponent.md#find)
- [Load](ue_ue.ForceFeedbackComponent.md#load)
- [StaticClass](ue_ue.ForceFeedbackComponent.md#staticclass)

## Constructors

### constructor

• **new ForceFeedbackComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:36188](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36188)
...
• **AttenuationOverrides**: [`ForceFeedbackAttenuationSettings`](ue_ue.ForceFeedbackAttenuationSettings.md)

#### Defined in

[ue/ue.d.ts:36197](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36197)
...
[ue/ue.d.ts:36196](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36196)
...
[ue/ue.d.ts:36189](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36189)
...
[ue/ue.d.ts:36195](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36195)
...
• **OnForceFeedbackFinished**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<(`ForceFeedbackComponent`: [`$Nullable`](../modules/puerts.md#$nullable)<[`ForceFeedbackComponent`](ue_ue.ForceFeedbackComponent.md)\>) => `void`\>

#### Defined in

[ue/ue.d.ts:36198](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36198)
...
### \_\_tid\_ForceFeedbackComponent\_\_

• **\_\_tid\_ForceFeedbackComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:36209](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36209)
...
[ue/ue.d.ts:36190](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36190)
...
[ue/ue.d.ts:36193](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36193)
...
[ue/ue.d.ts:36192](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36192)
...
[ue/ue.d.ts:36194](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36194)
...
[ue/ue.d.ts:36191](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36191)
...
| Name | Type |
| :------ | :------ |
| `InAttenuationSettings` | [`ForceFeedbackAttenuationSettings`](ue_ue.ForceFeedbackAttenuationSettings.md) |
...
[ue/ue.d.ts:36199](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36199)
...
| Name | Type |
| :------ | :------ |
| `OutAttenuationSettings` | [`$Ref`](../interfaces/puerts._Ref.md)<[`ForceFeedbackAttenuationSettings`](ue_ue.ForceFeedbackAttenuationSettings.md)\> |
...
[ue/ue.d.ts:36200](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36200)
...
[ue/ue.d.ts:36201](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36201)
...
▸ **SetForceFeedbackEffect**(`NewForceFeedbackEffect`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `NewForceFeedbackEffect` | [`$Nullable`](../modules/puerts.md#$nullable)<[`ForceFeedbackEffect`](ue_ue.ForceFeedbackEffect.md)\> |
...
[ue/ue.d.ts:36202](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36202)
...
▸ **SetIntensityMultiplier**(`NewIntensityMultiplier`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `NewIntensityMultiplier` | `number` |
...
[ue/ue.d.ts:36203](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36203)
...
[ue/ue.d.ts:36204](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36204)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ForceFeedbackComponent`](ue_ue.ForceFeedbackComponent.md)
...
[ue/ue.d.ts:36206](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36206)

___

### Load

▸ `Static` **Load**(`InName`): [`ForceFeedbackComponent`](ue_ue.ForceFeedbackComponent.md)
...
[ue/ue.d.ts:36207](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36207)
...
[ue/ue.d.ts:36205](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L36205)
