[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ForceFeedbackEffectFactory

# Class: ForceFeedbackEffectFactory

[ue/ue](../modules/ue_ue.md).ForceFeedbackEffectFactory
...
- [constructor](ue_ue.ForceFeedbackEffectFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.ForceFeedbackEffectFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.ForceFeedbackEffectFactory.md#automatedimportdata)
- [ContextClass](ue_ue.ForceFeedbackEffectFactory.md#contextclass)
- [Formats](ue_ue.ForceFeedbackEffectFactory.md#formats)
- [ImportPriority](ue_ue.ForceFeedbackEffectFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.ForceFeedbackEffectFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.ForceFeedbackEffectFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.ForceFeedbackEffectFactory.md#__tid_factory__)
- [\_\_tid\_ForceFeedbackEffectFactory\_\_](ue_ue.ForceFeedbackEffectFactory.md#__tid_forcefeedbackeffectfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ForceFeedbackEffectFactory.md#__tid_object__)
- [bCreateNew](ue_ue.ForceFeedbackEffectFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.ForceFeedbackEffectFactory.md#beditafternew)
- [bEditorImport](ue_ue.ForceFeedbackEffectFactory.md#beditorimport)
- [bText](ue_ue.ForceFeedbackEffectFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.ForceFeedbackEffectFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ForceFeedbackEffectFactory.md#executeubergraph)
- [GetClass](ue_ue.ForceFeedbackEffectFactory.md#getclass)
- [GetName](ue_ue.ForceFeedbackEffectFactory.md#getname)
- [GetOuter](ue_ue.ForceFeedbackEffectFactory.md#getouter)
- [GetWorld](ue_ue.ForceFeedbackEffectFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.ForceFeedbackEffectFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.ForceFeedbackEffectFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.ForceFeedbackEffectFactory.md#find)
- [Load](ue_ue.ForceFeedbackEffectFactory.md#load)
- [StaticClass](ue_ue.ForceFeedbackEffectFactory.md#staticclass)

## Constructors

### constructor

• **new ForceFeedbackEffectFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:36213](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36213)
...
### \_\_tid\_ForceFeedbackEffectFactory\_\_

• **\_\_tid\_ForceFeedbackEffectFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:36218](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36218)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ForceFeedbackEffectFactory`](ue_ue.ForceFeedbackEffectFactory.md)
...
[ue/ue.d.ts:36215](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36215)

___

### Load

▸ `Static` **Load**(`InName`): [`ForceFeedbackEffectFactory`](ue_ue.ForceFeedbackEffectFactory.md)
...
[ue/ue.d.ts:36216](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36216)
...
[ue/ue.d.ts:36214](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L36214)
