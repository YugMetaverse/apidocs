[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GatherTextCommandlet

# Class: GatherTextCommandlet

[ue/ue](../modules/ue_ue.md).GatherTextCommandlet
...
- [constructor](ue_ue.GatherTextCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.GatherTextCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.GatherTextCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.GatherTextCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.GatherTextCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.GatherTextCommandlet.md#helpweblink)
- [IsClient](ue_ue.GatherTextCommandlet.md#isclient)
- [IsEditor](ue_ue.GatherTextCommandlet.md#iseditor)
- [IsServer](ue_ue.GatherTextCommandlet.md#isserver)
- [LogToConsole](ue_ue.GatherTextCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.GatherTextCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.GatherTextCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.GatherTextCommandlet.md#__tid_commandlet__)
- [\_\_tid\_GatherTextCommandletBase\_\_](ue_ue.GatherTextCommandlet.md#__tid_gathertextcommandletbase__)
- [\_\_tid\_GatherTextCommandlet\_\_](ue_ue.GatherTextCommandlet.md#__tid_gathertextcommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.GatherTextCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.GatherTextCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GatherTextCommandlet.md#executeubergraph)
- [GetClass](ue_ue.GatherTextCommandlet.md#getclass)
- [GetName](ue_ue.GatherTextCommandlet.md#getname)
- [GetOuter](ue_ue.GatherTextCommandlet.md#getouter)
- [GetWorld](ue_ue.GatherTextCommandlet.md#getworld)
- [Find](ue_ue.GatherTextCommandlet.md#find)
- [Load](ue_ue.GatherTextCommandlet.md#load)
- [StaticClass](ue_ue.GatherTextCommandlet.md#staticclass)

## Constructors

### constructor

• **new GatherTextCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37308](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37308)
...
### \_\_tid\_GatherTextCommandlet\_\_

• **\_\_tid\_GatherTextCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:37313](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37313)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GatherTextCommandlet`](ue_ue.GatherTextCommandlet.md)
...
[ue/ue.d.ts:37310](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37310)

___

### Load

▸ `Static` **Load**(`InName`): [`GatherTextCommandlet`](ue_ue.GatherTextCommandlet.md)
...
[ue/ue.d.ts:37311](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37311)
...
[ue/ue.d.ts:37309](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37309)
