[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GatherTextCommandletBase

# Class: GatherTextCommandletBase

[ue/ue](../modules/ue_ue.md).GatherTextCommandletBase
...
- [`Commandlet`](ue_ue.Commandlet.md)
  ...
  ↳↳ [`ExportDialogueScriptCommandlet`](ue_ue.ExportDialogueScriptCommandlet.md)

  ↳↳ [`GatherTextCommandlet`](ue_ue.GatherTextCommandlet.md)

  ↳↳ [`GatherTextFromAssetsCommandlet`](ue_ue.GatherTextFromAssetsCommandlet.md)

  ↳↳ [`GatherTextFromMetaDataCommandlet`](ue_ue.GatherTextFromMetaDataCommandlet.md)

  ↳↳ [`GatherTextFromSourceCommandlet`](ue_ue.GatherTextFromSourceCommandlet.md)

  ↳↳ [`GenerateGatherArchiveCommandlet`](ue_ue.GenerateGatherArchiveCommandlet.md)

  ↳↳ [`GenerateGatherManifestCommandlet`](ue_ue.GenerateGatherManifestCommandlet.md)
  ...
  ↳↳ [`ImportDialogueScriptCommandlet`](ue_ue.ImportDialogueScriptCommandlet.md)
...
- [constructor](ue_ue.GatherTextCommandletBase.md#constructor)

### Properties

- [HelpDescription](ue_ue.GatherTextCommandletBase.md#helpdescription)
- [HelpParamDescriptions](ue_ue.GatherTextCommandletBase.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.GatherTextCommandletBase.md#helpparamnames)
- [HelpUsage](ue_ue.GatherTextCommandletBase.md#helpusage)
- [HelpWebLink](ue_ue.GatherTextCommandletBase.md#helpweblink)
- [IsClient](ue_ue.GatherTextCommandletBase.md#isclient)
- [IsEditor](ue_ue.GatherTextCommandletBase.md#iseditor)
- [IsServer](ue_ue.GatherTextCommandletBase.md#isserver)
- [LogToConsole](ue_ue.GatherTextCommandletBase.md#logtoconsole)
- [ShowErrorCount](ue_ue.GatherTextCommandletBase.md#showerrorcount)
- [ShowProgress](ue_ue.GatherTextCommandletBase.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.GatherTextCommandletBase.md#__tid_commandlet__)
- [\_\_tid\_GatherTextCommandletBase\_\_](ue_ue.GatherTextCommandletBase.md#__tid_gathertextcommandletbase__)
- [\_\_tid\_Object\_\_](ue_ue.GatherTextCommandletBase.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.GatherTextCommandletBase.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GatherTextCommandletBase.md#executeubergraph)
- [GetClass](ue_ue.GatherTextCommandletBase.md#getclass)
- [GetName](ue_ue.GatherTextCommandletBase.md#getname)
- [GetOuter](ue_ue.GatherTextCommandletBase.md#getouter)
- [GetWorld](ue_ue.GatherTextCommandletBase.md#getworld)
- [Find](ue_ue.GatherTextCommandletBase.md#find)
- [Load](ue_ue.GatherTextCommandletBase.md#load)
- [StaticClass](ue_ue.GatherTextCommandletBase.md#staticclass)

## Constructors

### constructor

• **new GatherTextCommandletBase**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:35006](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35006)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GatherTextCommandletBase`](ue_ue.GatherTextCommandletBase.md)
...
[ue/ue.d.ts:35008](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35008)

___

### Load

▸ `Static` **Load**(`InName`): [`GatherTextCommandletBase`](ue_ue.GatherTextCommandletBase.md)
...
[ue/ue.d.ts:35009](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35009)
...
[ue/ue.d.ts:35007](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35007)
