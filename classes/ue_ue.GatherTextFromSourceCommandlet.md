[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GatherTextFromSourceCommandlet

# Class: GatherTextFromSourceCommandlet

[ue/ue](../modules/ue_ue.md).GatherTextFromSourceCommandlet
...
- [constructor](ue_ue.GatherTextFromSourceCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.GatherTextFromSourceCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.GatherTextFromSourceCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.GatherTextFromSourceCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.GatherTextFromSourceCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.GatherTextFromSourceCommandlet.md#helpweblink)
- [IsClient](ue_ue.GatherTextFromSourceCommandlet.md#isclient)
- [IsEditor](ue_ue.GatherTextFromSourceCommandlet.md#iseditor)
- [IsServer](ue_ue.GatherTextFromSourceCommandlet.md#isserver)
- [LogToConsole](ue_ue.GatherTextFromSourceCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.GatherTextFromSourceCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.GatherTextFromSourceCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.GatherTextFromSourceCommandlet.md#__tid_commandlet__)
- [\_\_tid\_GatherTextCommandletBase\_\_](ue_ue.GatherTextFromSourceCommandlet.md#__tid_gathertextcommandletbase__)
- [\_\_tid\_GatherTextFromSourceCommandlet\_\_](ue_ue.GatherTextFromSourceCommandlet.md#__tid_gathertextfromsourcecommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.GatherTextFromSourceCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.GatherTextFromSourceCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GatherTextFromSourceCommandlet.md#executeubergraph)
- [GetClass](ue_ue.GatherTextFromSourceCommandlet.md#getclass)
- [GetName](ue_ue.GatherTextFromSourceCommandlet.md#getname)
- [GetOuter](ue_ue.GatherTextFromSourceCommandlet.md#getouter)
- [GetWorld](ue_ue.GatherTextFromSourceCommandlet.md#getworld)
- [Find](ue_ue.GatherTextFromSourceCommandlet.md#find)
- [Load](ue_ue.GatherTextFromSourceCommandlet.md#load)
- [StaticClass](ue_ue.GatherTextFromSourceCommandlet.md#staticclass)

## Constructors

### constructor

• **new GatherTextFromSourceCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37335](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L37335)
...
### \_\_tid\_GatherTextFromSourceCommandlet\_\_

• **\_\_tid\_GatherTextFromSourceCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:37340](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L37340)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GatherTextFromSourceCommandlet`](ue_ue.GatherTextFromSourceCommandlet.md)
...
[ue/ue.d.ts:37337](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L37337)

___

### Load

▸ `Static` **Load**(`InName`): [`GatherTextFromSourceCommandlet`](ue_ue.GatherTextFromSourceCommandlet.md)
...
[ue/ue.d.ts:37338](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L37338)
...
[ue/ue.d.ts:37336](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L37336)
