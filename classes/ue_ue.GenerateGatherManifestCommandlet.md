[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GenerateGatherManifestCommandlet

# Class: GenerateGatherManifestCommandlet

[ue/ue](../modules/ue_ue.md).GenerateGatherManifestCommandlet
...
- [constructor](ue_ue.GenerateGatherManifestCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.GenerateGatherManifestCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.GenerateGatherManifestCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.GenerateGatherManifestCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.GenerateGatherManifestCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.GenerateGatherManifestCommandlet.md#helpweblink)
- [IsClient](ue_ue.GenerateGatherManifestCommandlet.md#isclient)
- [IsEditor](ue_ue.GenerateGatherManifestCommandlet.md#iseditor)
- [IsServer](ue_ue.GenerateGatherManifestCommandlet.md#isserver)
- [LogToConsole](ue_ue.GenerateGatherManifestCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.GenerateGatherManifestCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.GenerateGatherManifestCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.GenerateGatherManifestCommandlet.md#__tid_commandlet__)
- [\_\_tid\_GatherTextCommandletBase\_\_](ue_ue.GenerateGatherManifestCommandlet.md#__tid_gathertextcommandletbase__)
- [\_\_tid\_GenerateGatherManifestCommandlet\_\_](ue_ue.GenerateGatherManifestCommandlet.md#__tid_generategathermanifestcommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.GenerateGatherManifestCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.GenerateGatherManifestCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GenerateGatherManifestCommandlet.md#executeubergraph)
- [GetClass](ue_ue.GenerateGatherManifestCommandlet.md#getclass)
- [GetName](ue_ue.GenerateGatherManifestCommandlet.md#getname)
- [GetOuter](ue_ue.GenerateGatherManifestCommandlet.md#getouter)
- [GetWorld](ue_ue.GenerateGatherManifestCommandlet.md#getworld)
- [Find](ue_ue.GenerateGatherManifestCommandlet.md#find)
- [Load](ue_ue.GenerateGatherManifestCommandlet.md#load)
- [StaticClass](ue_ue.GenerateGatherManifestCommandlet.md#staticclass)

## Constructors

### constructor

• **new GenerateGatherManifestCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37509](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37509)
...
[ue/ue.d.ts:37514](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37514)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GenerateGatherManifestCommandlet`](ue_ue.GenerateGatherManifestCommandlet.md)
...
[ue/ue.d.ts:37511](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37511)

___

### Load

▸ `Static` **Load**(`InName`): [`GenerateGatherManifestCommandlet`](ue_ue.GenerateGatherManifestCommandlet.md)
...
[ue/ue.d.ts:37512](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37512)
...
[ue/ue.d.ts:37510](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37510)
