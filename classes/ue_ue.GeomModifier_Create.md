[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GeomModifier\_Create

# Class: GeomModifier\_Create

[ue/ue](../modules/ue_ue.md).GeomModifier_Create
...
- [constructor](ue_ue.GeomModifier_Create.md#constructor)

### Properties

- [CachedPolys](ue_ue.GeomModifier_Create.md#cachedpolys)
- [Description](ue_ue.GeomModifier_Create.md#description)
- [Tooltip](ue_ue.GeomModifier_Create.md#tooltip)
- [\_\_tid\_GeomModifier\_Create\_\_](ue_ue.GeomModifier_Create.md#__tid_geommodifier_create__)
- [\_\_tid\_GeomModifier\_Edit\_\_](ue_ue.GeomModifier_Create.md#__tid_geommodifier_edit__)
- [\_\_tid\_GeomModifier\_\_](ue_ue.GeomModifier_Create.md#__tid_geommodifier__)
- [\_\_tid\_Object\_\_](ue_ue.GeomModifier_Create.md#__tid_object__)
- [bInitialized](ue_ue.GeomModifier_Create.md#binitialized)
- [bPendingPivotOffsetUpdate](ue_ue.GeomModifier_Create.md#bpendingpivotoffsetupdate)
- [bPushButton](ue_ue.GeomModifier_Create.md#bpushbutton)

### Methods

- [CreateDefaultSubobject](ue_ue.GeomModifier_Create.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GeomModifier_Create.md#executeubergraph)
- [GetClass](ue_ue.GeomModifier_Create.md#getclass)
- [GetName](ue_ue.GeomModifier_Create.md#getname)
- [GetOuter](ue_ue.GeomModifier_Create.md#getouter)
- [GetWorld](ue_ue.GeomModifier_Create.md#getworld)
- [Find](ue_ue.GeomModifier_Create.md#find)
- [Load](ue_ue.GeomModifier_Create.md#load)
- [StaticClass](ue_ue.GeomModifier_Create.md#staticclass)

## Constructors

### constructor

• **new GeomModifier_Create**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37755](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37755)
...
### \_\_tid\_GeomModifier\_Create\_\_

• **\_\_tid\_GeomModifier\_Create\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:37760](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37760)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GeomModifier_Create`](ue_ue.GeomModifier_Create.md)
...
[ue/ue.d.ts:37757](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37757)

___

### Load

▸ `Static` **Load**(`InName`): [`GeomModifier_Create`](ue_ue.GeomModifier_Create.md)
...
[ue/ue.d.ts:37758](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37758)
...
[ue/ue.d.ts:37756](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37756)
