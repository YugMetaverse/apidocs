[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GeomModifier\_Delete

# Class: GeomModifier\_Delete

[ue/ue](../modules/ue_ue.md).GeomModifier_Delete
...
- [constructor](ue_ue.GeomModifier_Delete.md#constructor)

### Properties

- [CachedPolys](ue_ue.GeomModifier_Delete.md#cachedpolys)
- [Description](ue_ue.GeomModifier_Delete.md#description)
- [Tooltip](ue_ue.GeomModifier_Delete.md#tooltip)
- [\_\_tid\_GeomModifier\_Delete\_\_](ue_ue.GeomModifier_Delete.md#__tid_geommodifier_delete__)
- [\_\_tid\_GeomModifier\_Edit\_\_](ue_ue.GeomModifier_Delete.md#__tid_geommodifier_edit__)
- [\_\_tid\_GeomModifier\_\_](ue_ue.GeomModifier_Delete.md#__tid_geommodifier__)
- [\_\_tid\_Object\_\_](ue_ue.GeomModifier_Delete.md#__tid_object__)
- [bInitialized](ue_ue.GeomModifier_Delete.md#binitialized)
- [bPendingPivotOffsetUpdate](ue_ue.GeomModifier_Delete.md#bpendingpivotoffsetupdate)
- [bPushButton](ue_ue.GeomModifier_Delete.md#bpushbutton)

### Methods

- [CreateDefaultSubobject](ue_ue.GeomModifier_Delete.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GeomModifier_Delete.md#executeubergraph)
- [GetClass](ue_ue.GeomModifier_Delete.md#getclass)
- [GetName](ue_ue.GeomModifier_Delete.md#getname)
- [GetOuter](ue_ue.GeomModifier_Delete.md#getouter)
- [GetWorld](ue_ue.GeomModifier_Delete.md#getworld)
- [Find](ue_ue.GeomModifier_Delete.md#find)
- [Load](ue_ue.GeomModifier_Delete.md#load)
- [StaticClass](ue_ue.GeomModifier_Delete.md#staticclass)

## Constructors

### constructor

• **new GeomModifier_Delete**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37764](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37764)
...
### \_\_tid\_GeomModifier\_Delete\_\_

• **\_\_tid\_GeomModifier\_Delete\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:37769](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37769)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GeomModifier_Delete`](ue_ue.GeomModifier_Delete.md)
...
[ue/ue.d.ts:37766](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37766)

___

### Load

▸ `Static` **Load**(`InName`): [`GeomModifier_Delete`](ue_ue.GeomModifier_Delete.md)
...
[ue/ue.d.ts:37767](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37767)
...
[ue/ue.d.ts:37765](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37765)
