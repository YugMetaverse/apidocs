[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GeomModifier\_Turn

# Class: GeomModifier\_Turn

[ue/ue](../modules/ue_ue.md).GeomModifier_Turn
...
- [constructor](ue_ue.GeomModifier_Turn.md#constructor)

### Properties

- [CachedPolys](ue_ue.GeomModifier_Turn.md#cachedpolys)
- [Description](ue_ue.GeomModifier_Turn.md#description)
- [Tooltip](ue_ue.GeomModifier_Turn.md#tooltip)
- [\_\_tid\_GeomModifier\_Edit\_\_](ue_ue.GeomModifier_Turn.md#__tid_geommodifier_edit__)
- [\_\_tid\_GeomModifier\_Turn\_\_](ue_ue.GeomModifier_Turn.md#__tid_geommodifier_turn__)
- [\_\_tid\_GeomModifier\_\_](ue_ue.GeomModifier_Turn.md#__tid_geommodifier__)
- [\_\_tid\_Object\_\_](ue_ue.GeomModifier_Turn.md#__tid_object__)
- [bInitialized](ue_ue.GeomModifier_Turn.md#binitialized)
- [bPendingPivotOffsetUpdate](ue_ue.GeomModifier_Turn.md#bpendingpivotoffsetupdate)
- [bPushButton](ue_ue.GeomModifier_Turn.md#bpushbutton)

### Methods

- [CreateDefaultSubobject](ue_ue.GeomModifier_Turn.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.GeomModifier_Turn.md#executeubergraph)
- [GetClass](ue_ue.GeomModifier_Turn.md#getclass)
- [GetName](ue_ue.GeomModifier_Turn.md#getname)
- [GetOuter](ue_ue.GeomModifier_Turn.md#getouter)
- [GetWorld](ue_ue.GeomModifier_Turn.md#getworld)
- [Find](ue_ue.GeomModifier_Turn.md#find)
- [Load](ue_ue.GeomModifier_Turn.md#load)
- [StaticClass](ue_ue.GeomModifier_Turn.md#staticclass)

## Constructors

### constructor

• **new GeomModifier_Turn**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37849](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37849)
...
### \_\_tid\_GeomModifier\_Turn\_\_

• **\_\_tid\_GeomModifier\_Turn\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:37854](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37854)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GeomModifier_Turn`](ue_ue.GeomModifier_Turn.md)
...
[ue/ue.d.ts:37851](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37851)

___

### Load

▸ `Static` **Load**(`InName`): [`GeomModifier_Turn`](ue_ue.GeomModifier_Turn.md)
...
[ue/ue.d.ts:37852](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37852)
...
[ue/ue.d.ts:37850](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37850)
