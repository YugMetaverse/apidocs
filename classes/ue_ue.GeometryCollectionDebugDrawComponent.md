[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GeometryCollectionDebugDrawComponent

# Class: GeometryCollectionDebugDrawComponent

[ue/ue](../modules/ue_ue.md).GeometryCollectionDebugDrawComponent
...
- [constructor](ue_ue.GeometryCollectionDebugDrawComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.GeometryCollectionDebugDrawComponent.md#assetuserdata)
- [ComponentTags](ue_ue.GeometryCollectionDebugDrawComponent.md#componenttags)
- [CreationMethod](ue_ue.GeometryCollectionDebugDrawComponent.md#creationmethod)
- [GeometryCollectionDebugDrawActor](ue_ue.GeometryCollectionDebugDrawComponent.md#geometrycollectiondebugdrawactor)
- [GeometryCollectionRenderLevelSetActor](ue_ue.GeometryCollectionDebugDrawComponent.md#geometrycollectionrenderlevelsetactor)
- [OnComponentActivated](ue_ue.GeometryCollectionDebugDrawComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.GeometryCollectionDebugDrawComponent.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.GeometryCollectionDebugDrawComponent.md#primarycomponenttick)
- [UCSModifiedProperties](ue_ue.GeometryCollectionDebugDrawComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.GeometryCollectionDebugDrawComponent.md#__tid_actorcomponent__)
- [\_\_tid\_GeometryCollectionDebugDrawComponent\_\_](ue_ue.GeometryCollectionDebugDrawComponent.md#__tid_geometrycollectiondebugdrawcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.GeometryCollectionDebugDrawComponent.md#__tid_object__)
- [bAutoActivate](ue_ue.GeometryCollectionDebugDrawComponent.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.GeometryCollectionDebugDrawComponent.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.GeometryCollectionDebugDrawComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.GeometryCollectionDebugDrawComponent.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.GeometryCollectionDebugDrawComponent.md#binstancecomponent)
- [bIsActive](ue_ue.GeometryCollectionDebugDrawComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.GeometryCollectionDebugDrawComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.GeometryCollectionDebugDrawComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.GeometryCollectionDebugDrawComponent.md#bnetaddressable)
- [bReplicates](ue_ue.GeometryCollectionDebugDrawComponent.md#breplicates)

### Methods

- [Activate](ue_ue.GeometryCollectionDebugDrawComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.GeometryCollectionDebugDrawComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.GeometryCollectionDebugDrawComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.GeometryCollectionDebugDrawComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.GeometryCollectionDebugDrawComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.GeometryCollectionDebugDrawComponent.md#deactivate)
- [ExecuteUbergraph](ue_ue.GeometryCollectionDebugDrawComponent.md#executeubergraph)
- [GetClass](ue_ue.GeometryCollectionDebugDrawComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.GeometryCollectionDebugDrawComponent.md#getcomponenttickinterval)
- [GetName](ue_ue.GeometryCollectionDebugDrawComponent.md#getname)
- [GetOuter](ue_ue.GeometryCollectionDebugDrawComponent.md#getouter)
- [GetOwner](ue_ue.GeometryCollectionDebugDrawComponent.md#getowner)
- [GetWorld](ue_ue.GeometryCollectionDebugDrawComponent.md#getworld)
- [IsActive](ue_ue.GeometryCollectionDebugDrawComponent.md#isactive)
- [IsBeingDestroyed](ue_ue.GeometryCollectionDebugDrawComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.GeometryCollectionDebugDrawComponent.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.GeometryCollectionDebugDrawComponent.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.GeometryCollectionDebugDrawComponent.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.GeometryCollectionDebugDrawComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.GeometryCollectionDebugDrawComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.GeometryCollectionDebugDrawComponent.md#receivetick)
- [RegisterComponent](ue_ue.GeometryCollectionDebugDrawComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.GeometryCollectionDebugDrawComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.GeometryCollectionDebugDrawComponent.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.GeometryCollectionDebugDrawComponent.md#setactive)
- [SetAutoActivate](ue_ue.GeometryCollectionDebugDrawComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.GeometryCollectionDebugDrawComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.GeometryCollectionDebugDrawComponent.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.GeometryCollectionDebugDrawComponent.md#setisreplicated)
- [SetTickGroup](ue_ue.GeometryCollectionDebugDrawComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.GeometryCollectionDebugDrawComponent.md#settickablewhenpaused)
- [ToggleActive](ue_ue.GeometryCollectionDebugDrawComponent.md#toggleactive)
- [Find](ue_ue.GeometryCollectionDebugDrawComponent.md#find)
- [Load](ue_ue.GeometryCollectionDebugDrawComponent.md#load)
- [StaticClass](ue_ue.GeometryCollectionDebugDrawComponent.md#staticclass)

## Constructors

### constructor

• **new GeometryCollectionDebugDrawComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:26955](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26955)
...
• **GeometryCollectionDebugDrawActor**: [`GeometryCollectionDebugDrawActor`](ue_ue.GeometryCollectionDebugDrawActor.md)

#### Defined in

[ue/ue.d.ts:26956](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26956)

___

### GeometryCollectionRenderLevelSetActor

• **GeometryCollectionRenderLevelSetActor**: [`GeometryCollectionRenderLevelSetActor`](ue_ue.GeometryCollectionRenderLevelSetActor.md)

#### Defined in

[ue/ue.d.ts:26957](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26957)
...
### \_\_tid\_GeometryCollectionDebugDrawComponent\_\_

• **\_\_tid\_GeometryCollectionDebugDrawComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:26962](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26962)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`GeometryCollectionDebugDrawComponent`](ue_ue.GeometryCollectionDebugDrawComponent.md)
...
[ue/ue.d.ts:26959](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26959)

___

### Load

▸ `Static` **Load**(`InName`): [`GeometryCollectionDebugDrawComponent`](ue_ue.GeometryCollectionDebugDrawComponent.md)
...
[ue/ue.d.ts:26960](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26960)
...
[ue/ue.d.ts:26958](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L26958)
