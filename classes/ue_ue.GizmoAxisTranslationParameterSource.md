[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / GizmoAxisTranslationParameterSource
...
• **new GizmoAxisTranslationParameterSource**(`Outer?`, `Name?`, `ObjectFlags?`)
