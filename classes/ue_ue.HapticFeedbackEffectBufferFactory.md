[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / HapticFeedbackEffectBufferFactory

# Class: HapticFeedbackEffectBufferFactory

[ue/ue](../modules/ue_ue.md).HapticFeedbackEffectBufferFactory
...
- [constructor](ue_ue.HapticFeedbackEffectBufferFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.HapticFeedbackEffectBufferFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.HapticFeedbackEffectBufferFactory.md#automatedimportdata)
- [ContextClass](ue_ue.HapticFeedbackEffectBufferFactory.md#contextclass)
- [Formats](ue_ue.HapticFeedbackEffectBufferFactory.md#formats)
- [ImportPriority](ue_ue.HapticFeedbackEffectBufferFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.HapticFeedbackEffectBufferFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.HapticFeedbackEffectBufferFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.HapticFeedbackEffectBufferFactory.md#__tid_factory__)
- [\_\_tid\_HapticFeedbackEffectBufferFactory\_\_](ue_ue.HapticFeedbackEffectBufferFactory.md#__tid_hapticfeedbackeffectbufferfactory__)
- [\_\_tid\_Object\_\_](ue_ue.HapticFeedbackEffectBufferFactory.md#__tid_object__)
- [bCreateNew](ue_ue.HapticFeedbackEffectBufferFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.HapticFeedbackEffectBufferFactory.md#beditafternew)
- [bEditorImport](ue_ue.HapticFeedbackEffectBufferFactory.md#beditorimport)
- [bText](ue_ue.HapticFeedbackEffectBufferFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.HapticFeedbackEffectBufferFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.HapticFeedbackEffectBufferFactory.md#executeubergraph)
- [GetClass](ue_ue.HapticFeedbackEffectBufferFactory.md#getclass)
- [GetName](ue_ue.HapticFeedbackEffectBufferFactory.md#getname)
- [GetOuter](ue_ue.HapticFeedbackEffectBufferFactory.md#getouter)
- [GetWorld](ue_ue.HapticFeedbackEffectBufferFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.HapticFeedbackEffectBufferFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.HapticFeedbackEffectBufferFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.HapticFeedbackEffectBufferFactory.md#find)
- [Load](ue_ue.HapticFeedbackEffectBufferFactory.md#load)
- [StaticClass](ue_ue.HapticFeedbackEffectBufferFactory.md#staticclass)

## Constructors

### constructor

• **new HapticFeedbackEffectBufferFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:38477](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L38477)
...
### \_\_tid\_HapticFeedbackEffectBufferFactory\_\_

• **\_\_tid\_HapticFeedbackEffectBufferFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:38482](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L38482)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`HapticFeedbackEffectBufferFactory`](ue_ue.HapticFeedbackEffectBufferFactory.md)
...
[ue/ue.d.ts:38479](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L38479)

___

### Load

▸ `Static` **Load**(`InName`): [`HapticFeedbackEffectBufferFactory`](ue_ue.HapticFeedbackEffectBufferFactory.md)
...
[ue/ue.d.ts:38480](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L38480)
...
[ue/ue.d.ts:38478](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L38478)
