[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / HapticFeedbackEffectCurveFactory

# Class: HapticFeedbackEffectCurveFactory

[ue/ue](../modules/ue_ue.md).HapticFeedbackEffectCurveFactory
...
- [constructor](ue_ue.HapticFeedbackEffectCurveFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.HapticFeedbackEffectCurveFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.HapticFeedbackEffectCurveFactory.md#automatedimportdata)
- [ContextClass](ue_ue.HapticFeedbackEffectCurveFactory.md#contextclass)
- [Formats](ue_ue.HapticFeedbackEffectCurveFactory.md#formats)
- [ImportPriority](ue_ue.HapticFeedbackEffectCurveFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.HapticFeedbackEffectCurveFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.HapticFeedbackEffectCurveFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.HapticFeedbackEffectCurveFactory.md#__tid_factory__)
- [\_\_tid\_HapticFeedbackEffectCurveFactory\_\_](ue_ue.HapticFeedbackEffectCurveFactory.md#__tid_hapticfeedbackeffectcurvefactory__)
- [\_\_tid\_Object\_\_](ue_ue.HapticFeedbackEffectCurveFactory.md#__tid_object__)
- [bCreateNew](ue_ue.HapticFeedbackEffectCurveFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.HapticFeedbackEffectCurveFactory.md#beditafternew)
- [bEditorImport](ue_ue.HapticFeedbackEffectCurveFactory.md#beditorimport)
- [bText](ue_ue.HapticFeedbackEffectCurveFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.HapticFeedbackEffectCurveFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.HapticFeedbackEffectCurveFactory.md#executeubergraph)
- [GetClass](ue_ue.HapticFeedbackEffectCurveFactory.md#getclass)
- [GetName](ue_ue.HapticFeedbackEffectCurveFactory.md#getname)
- [GetOuter](ue_ue.HapticFeedbackEffectCurveFactory.md#getouter)
- [GetWorld](ue_ue.HapticFeedbackEffectCurveFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.HapticFeedbackEffectCurveFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.HapticFeedbackEffectCurveFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.HapticFeedbackEffectCurveFactory.md#find)
- [Load](ue_ue.HapticFeedbackEffectCurveFactory.md#load)
- [StaticClass](ue_ue.HapticFeedbackEffectCurveFactory.md#staticclass)

## Constructors

### constructor

• **new HapticFeedbackEffectCurveFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:38486](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38486)
...
### \_\_tid\_HapticFeedbackEffectCurveFactory\_\_

• **\_\_tid\_HapticFeedbackEffectCurveFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:38491](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38491)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`HapticFeedbackEffectCurveFactory`](ue_ue.HapticFeedbackEffectCurveFactory.md)
...
[ue/ue.d.ts:38488](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38488)

___

### Load

▸ `Static` **Load**(`InName`): [`HapticFeedbackEffectCurveFactory`](ue_ue.HapticFeedbackEffectCurveFactory.md)
...
[ue/ue.d.ts:38489](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38489)
...
[ue/ue.d.ts:38487](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38487)
