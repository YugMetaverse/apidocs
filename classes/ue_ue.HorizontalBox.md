[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / HorizontalBox

# Class: HorizontalBox

[ue/ue](../modules/ue_ue.md).HorizontalBox
...
- [constructor](ue_ue.HorizontalBox.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.HorizontalBox.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.HorizontalBox.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.HorizontalBox.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.HorizontalBox.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.HorizontalBox.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.HorizontalBox.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.HorizontalBox.md#accessiblewidgetdata)
- [CategoryName](ue_ue.HorizontalBox.md#categoryname)
- [Clipping](ue_ue.HorizontalBox.md#clipping)
- [Cursor](ue_ue.HorizontalBox.md#cursor)
- [DesignerFlags](ue_ue.HorizontalBox.md#designerflags)
- [DisplayLabel](ue_ue.HorizontalBox.md#displaylabel)
- [FlowDirectionPreference](ue_ue.HorizontalBox.md#flowdirectionpreference)
- [NativeBindings](ue_ue.HorizontalBox.md#nativebindings)
- [Navigation](ue_ue.HorizontalBox.md#navigation)
- [RenderOpacity](ue_ue.HorizontalBox.md#renderopacity)
- [RenderTransform](ue_ue.HorizontalBox.md#rendertransform)
- [RenderTransformPivot](ue_ue.HorizontalBox.md#rendertransformpivot)
- [Slot](ue_ue.HorizontalBox.md#slot)
- [Slots](ue_ue.HorizontalBox.md#slots)
- [ToolTipText](ue_ue.HorizontalBox.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.HorizontalBox.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.HorizontalBox.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.HorizontalBox.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.HorizontalBox.md#visibility)
- [VisibilityDelegate](ue_ue.HorizontalBox.md#visibilitydelegate)
- [\_\_tid\_HorizontalBox\_\_](ue_ue.HorizontalBox.md#__tid_horizontalbox__)
- [\_\_tid\_Object\_\_](ue_ue.HorizontalBox.md#__tid_object__)
- [\_\_tid\_PanelWidget\_\_](ue_ue.HorizontalBox.md#__tid_panelwidget__)
- [\_\_tid\_Visual\_\_](ue_ue.HorizontalBox.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.HorizontalBox.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.HorizontalBox.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.HorizontalBox.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.HorizontalBox.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.HorizontalBox.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.HorizontalBox.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.HorizontalBox.md#bisenableddelegate)
- [bIsVariable](ue_ue.HorizontalBox.md#bisvariable)
- [bIsVolatile](ue_ue.HorizontalBox.md#bisvolatile)
- [bLockedInDesigner](ue_ue.HorizontalBox.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.HorizontalBox.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.HorizontalBox.md#boverride_cursor)

### Methods

- [AddChild](ue_ue.HorizontalBox.md#addchild)
- [AddChildToHorizontalBox](ue_ue.HorizontalBox.md#addchildtohorizontalbox)
- [ClearChildren](ue_ue.HorizontalBox.md#clearchildren)
- [CreateDefaultSubobject](ue_ue.HorizontalBox.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.HorizontalBox.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.HorizontalBox.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.HorizontalBox.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.HorizontalBox.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.HorizontalBox.md#generatewidgetforstring__delegatesignature)
- [GetAllChildren](ue_ue.HorizontalBox.md#getallchildren)
- [GetBool\_\_DelegateSignature](ue_ue.HorizontalBox.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.HorizontalBox.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.HorizontalBox.md#getcheckboxstate__delegatesignature)
- [GetChildAt](ue_ue.HorizontalBox.md#getchildat)
- [GetChildIndex](ue_ue.HorizontalBox.md#getchildindex)
- [GetChildrenCount](ue_ue.HorizontalBox.md#getchildrencount)
- [GetClass](ue_ue.HorizontalBox.md#getclass)
- [GetClipping](ue_ue.HorizontalBox.md#getclipping)
- [GetDesiredSize](ue_ue.HorizontalBox.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.HorizontalBox.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.HorizontalBox.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.HorizontalBox.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.HorizontalBox.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.HorizontalBox.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.HorizontalBox.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.HorizontalBox.md#getname)
- [GetOuter](ue_ue.HorizontalBox.md#getouter)
- [GetOwningLocalPlayer](ue_ue.HorizontalBox.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.HorizontalBox.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.HorizontalBox.md#getpaintspacegeometry)
- [GetParent](ue_ue.HorizontalBox.md#getparent)
- [GetRenderOpacity](ue_ue.HorizontalBox.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.HorizontalBox.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.HorizontalBox.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.HorizontalBox.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.HorizontalBox.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.HorizontalBox.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.HorizontalBox.md#gettickspacegeometry)
- [GetVisibility](ue_ue.HorizontalBox.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.HorizontalBox.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.HorizontalBox.md#getworld)
- [HasAnyChildren](ue_ue.HorizontalBox.md#hasanychildren)
- [HasAnyUserFocus](ue_ue.HorizontalBox.md#hasanyuserfocus)
- [HasChild](ue_ue.HorizontalBox.md#haschild)
- [HasFocusedDescendants](ue_ue.HorizontalBox.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.HorizontalBox.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.HorizontalBox.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.HorizontalBox.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.HorizontalBox.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.HorizontalBox.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.HorizontalBox.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.HorizontalBox.md#ishovered)
- [IsVisible](ue_ue.HorizontalBox.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.HorizontalBox.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.HorizontalBox.md#onreply__delegatesignature)
- [RemoveChild](ue_ue.HorizontalBox.md#removechild)
- [RemoveChildAt](ue_ue.HorizontalBox.md#removechildat)
- [RemoveFromParent](ue_ue.HorizontalBox.md#removefromparent)
- [ResetCursor](ue_ue.HorizontalBox.md#resetcursor)
- [SetAllNavigationRules](ue_ue.HorizontalBox.md#setallnavigationrules)
- [SetClipping](ue_ue.HorizontalBox.md#setclipping)
- [SetCursor](ue_ue.HorizontalBox.md#setcursor)
- [SetFocus](ue_ue.HorizontalBox.md#setfocus)
- [SetIsEnabled](ue_ue.HorizontalBox.md#setisenabled)
- [SetKeyboardFocus](ue_ue.HorizontalBox.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.HorizontalBox.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.HorizontalBox.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.HorizontalBox.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.HorizontalBox.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.HorizontalBox.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.HorizontalBox.md#setrenderopacity)
- [SetRenderScale](ue_ue.HorizontalBox.md#setrenderscale)
- [SetRenderShear](ue_ue.HorizontalBox.md#setrendershear)
- [SetRenderTransform](ue_ue.HorizontalBox.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.HorizontalBox.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.HorizontalBox.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.HorizontalBox.md#setrendertranslation)
- [SetToolTip](ue_ue.HorizontalBox.md#settooltip)
- [SetToolTipText](ue_ue.HorizontalBox.md#settooltiptext)
- [SetUserFocus](ue_ue.HorizontalBox.md#setuserfocus)
- [SetVisibility](ue_ue.HorizontalBox.md#setvisibility)
- [Find](ue_ue.HorizontalBox.md#find)
- [Load](ue_ue.HorizontalBox.md#load)
- [StaticClass](ue_ue.HorizontalBox.md#staticclass)

## Constructors

### constructor

• **new HorizontalBox**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:38674](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38674)
...
### \_\_tid\_HorizontalBox\_\_

• **\_\_tid\_HorizontalBox\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:38680](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38680)
...
▸ **AddChildToHorizontalBox**(`Content`): [`HorizontalBoxSlot`](ue_ue.HorizontalBoxSlot.md)
...
[ue/ue.d.ts:38675](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38675)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`HorizontalBox`](ue_ue.HorizontalBox.md)
...
[`HorizontalBox`](ue_ue.HorizontalBox.md)
...
[ue/ue.d.ts:38677](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38677)

___

### Load

▸ `Static` **Load**(`InName`): [`HorizontalBox`](ue_ue.HorizontalBox.md)
...
[ue/ue.d.ts:38678](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38678)
...
[ue/ue.d.ts:38676](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38676)
