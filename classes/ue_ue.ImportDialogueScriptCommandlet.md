[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ImportDialogueScriptCommandlet

# Class: ImportDialogueScriptCommandlet

[ue/ue](../modules/ue_ue.md).ImportDialogueScriptCommandlet
...
- [constructor](ue_ue.ImportDialogueScriptCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.ImportDialogueScriptCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.ImportDialogueScriptCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.ImportDialogueScriptCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.ImportDialogueScriptCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.ImportDialogueScriptCommandlet.md#helpweblink)
- [IsClient](ue_ue.ImportDialogueScriptCommandlet.md#isclient)
- [IsEditor](ue_ue.ImportDialogueScriptCommandlet.md#iseditor)
- [IsServer](ue_ue.ImportDialogueScriptCommandlet.md#isserver)
- [LogToConsole](ue_ue.ImportDialogueScriptCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.ImportDialogueScriptCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.ImportDialogueScriptCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.ImportDialogueScriptCommandlet.md#__tid_commandlet__)
- [\_\_tid\_GatherTextCommandletBase\_\_](ue_ue.ImportDialogueScriptCommandlet.md#__tid_gathertextcommandletbase__)
- [\_\_tid\_ImportDialogueScriptCommandlet\_\_](ue_ue.ImportDialogueScriptCommandlet.md#__tid_importdialoguescriptcommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.ImportDialogueScriptCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.ImportDialogueScriptCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ImportDialogueScriptCommandlet.md#executeubergraph)
- [GetClass](ue_ue.ImportDialogueScriptCommandlet.md#getclass)
- [GetName](ue_ue.ImportDialogueScriptCommandlet.md#getname)
- [GetOuter](ue_ue.ImportDialogueScriptCommandlet.md#getouter)
- [GetWorld](ue_ue.ImportDialogueScriptCommandlet.md#getworld)
- [Find](ue_ue.ImportDialogueScriptCommandlet.md#find)
- [Load](ue_ue.ImportDialogueScriptCommandlet.md#load)
- [StaticClass](ue_ue.ImportDialogueScriptCommandlet.md#staticclass)

## Constructors

### constructor

• **new ImportDialogueScriptCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:38906](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38906)
...
### \_\_tid\_ImportDialogueScriptCommandlet\_\_

• **\_\_tid\_ImportDialogueScriptCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:38911](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38911)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ImportDialogueScriptCommandlet`](ue_ue.ImportDialogueScriptCommandlet.md)
...
[ue/ue.d.ts:38908](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38908)

___

### Load

▸ `Static` **Load**(`InName`): [`ImportDialogueScriptCommandlet`](ue_ue.ImportDialogueScriptCommandlet.md)
...
[ue/ue.d.ts:38909](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38909)
...
[ue/ue.d.ts:38907](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L38907)
