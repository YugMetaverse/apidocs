[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / Int32Binding

# Class: Int32Binding

[ue/ue](../modules/ue_ue.md).Int32Binding
...
- [constructor](ue_ue.Int32Binding.md#constructor)

### Properties

- [DestinationProperty](ue_ue.Int32Binding.md#destinationproperty)
- [SourceObject](ue_ue.Int32Binding.md#sourceobject)
- [SourcePath](ue_ue.Int32Binding.md#sourcepath)
- [\_\_tid\_Int32Binding\_\_](ue_ue.Int32Binding.md#__tid_int32binding__)
- [\_\_tid\_Object\_\_](ue_ue.Int32Binding.md#__tid_object__)
- [\_\_tid\_PropertyBinding\_\_](ue_ue.Int32Binding.md#__tid_propertybinding__)

### Methods

- [CreateDefaultSubobject](ue_ue.Int32Binding.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.Int32Binding.md#executeubergraph)
- [GetClass](ue_ue.Int32Binding.md#getclass)
- [GetName](ue_ue.Int32Binding.md#getname)
- [GetOuter](ue_ue.Int32Binding.md#getouter)
- [GetValue](ue_ue.Int32Binding.md#getvalue)
- [GetWorld](ue_ue.Int32Binding.md#getworld)
- [Find](ue_ue.Int32Binding.md#find)
- [Load](ue_ue.Int32Binding.md#load)
- [StaticClass](ue_ue.Int32Binding.md#staticclass)

## Constructors

### constructor

• **new Int32Binding**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:39462](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L39462)
...
### \_\_tid\_Int32Binding\_\_

• **\_\_tid\_Int32Binding\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:39468](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L39468)
...
[ue/ue.d.ts:39463](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L39463)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`Int32Binding`](ue_ue.Int32Binding.md)
...
[ue/ue.d.ts:39465](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L39465)

___

### Load

▸ `Static` **Load**(`InName`): [`Int32Binding`](ue_ue.Int32Binding.md)
...
[ue/ue.d.ts:39466](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L39466)
...
[ue/ue.d.ts:39464](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L39464)
