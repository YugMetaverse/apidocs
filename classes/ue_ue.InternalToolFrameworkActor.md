[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / InternalToolFrameworkActor

# Class: InternalToolFrameworkActor

[ue/ue](../modules/ue_ue.md).InternalToolFrameworkActor
...
- [constructor](ue_ue.InternalToolFrameworkActor.md#constructor)

### Properties

- [ActorLabel](ue_ue.InternalToolFrameworkActor.md#actorlabel)
- [AttachmentReplication](ue_ue.InternalToolFrameworkActor.md#attachmentreplication)
- [AutoReceiveInput](ue_ue.InternalToolFrameworkActor.md#autoreceiveinput)
- [BlueprintCreatedComponents](ue_ue.InternalToolFrameworkActor.md#blueprintcreatedcomponents)
- [Children](ue_ue.InternalToolFrameworkActor.md#children)
- [ControllingMatineeActors](ue_ue.InternalToolFrameworkActor.md#controllingmatineeactors)
- [CustomTimeDilation](ue_ue.InternalToolFrameworkActor.md#customtimedilation)
- [DefaultUpdateOverlapsMethodDuringLevelStreaming](ue_ue.InternalToolFrameworkActor.md#defaultupdateoverlapsmethodduringlevelstreaming)
- [FolderPath](ue_ue.InternalToolFrameworkActor.md#folderpath)
- [GroupActor](ue_ue.InternalToolFrameworkActor.md#groupactor)
- [HiddenEditorViews](ue_ue.InternalToolFrameworkActor.md#hiddeneditorviews)
- [InitialLifeSpan](ue_ue.InternalToolFrameworkActor.md#initiallifespan)
- [InputComponent](ue_ue.InternalToolFrameworkActor.md#inputcomponent)
- [InputPriority](ue_ue.InternalToolFrameworkActor.md#inputpriority)
- [InstanceComponents](ue_ue.InternalToolFrameworkActor.md#instancecomponents)
- [Instigator](ue_ue.InternalToolFrameworkActor.md#instigator)
- [Layers](ue_ue.InternalToolFrameworkActor.md#layers)
- [MinNetUpdateFrequency](ue_ue.InternalToolFrameworkActor.md#minnetupdatefrequency)
- [NetCullDistanceSquared](ue_ue.InternalToolFrameworkActor.md#netculldistancesquared)
- [NetDormancy](ue_ue.InternalToolFrameworkActor.md#netdormancy)
- [NetDriverName](ue_ue.InternalToolFrameworkActor.md#netdrivername)
- [NetPriority](ue_ue.InternalToolFrameworkActor.md#netpriority)
- [NetTag](ue_ue.InternalToolFrameworkActor.md#nettag)
- [NetUpdateFrequency](ue_ue.InternalToolFrameworkActor.md#netupdatefrequency)
- [OnActorBeginOverlap](ue_ue.InternalToolFrameworkActor.md#onactorbeginoverlap)
- [OnActorEndOverlap](ue_ue.InternalToolFrameworkActor.md#onactorendoverlap)
- [OnActorHit](ue_ue.InternalToolFrameworkActor.md#onactorhit)
- [OnBeginCursorOver](ue_ue.InternalToolFrameworkActor.md#onbegincursorover)
- [OnClicked](ue_ue.InternalToolFrameworkActor.md#onclicked)
- [OnDestroyed](ue_ue.InternalToolFrameworkActor.md#ondestroyed)
- [OnEndCursorOver](ue_ue.InternalToolFrameworkActor.md#onendcursorover)
- [OnEndPlay](ue_ue.InternalToolFrameworkActor.md#onendplay)
- [OnInputTouchBegin](ue_ue.InternalToolFrameworkActor.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue.InternalToolFrameworkActor.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue.InternalToolFrameworkActor.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue.InternalToolFrameworkActor.md#oninputtouchleave)
- [OnReleased](ue_ue.InternalToolFrameworkActor.md#onreleased)
- [OnTakeAnyDamage](ue_ue.InternalToolFrameworkActor.md#ontakeanydamage)
- [OnTakePointDamage](ue_ue.InternalToolFrameworkActor.md#ontakepointdamage)
- [OnTakeRadialDamage](ue_ue.InternalToolFrameworkActor.md#ontakeradialdamage)
- [Owner](ue_ue.InternalToolFrameworkActor.md#owner)
- [ParentComponent](ue_ue.InternalToolFrameworkActor.md#parentcomponent)
- [ParentComponentActor](ue_ue.InternalToolFrameworkActor.md#parentcomponentactor)
- [PivotOffset](ue_ue.InternalToolFrameworkActor.md#pivotoffset)
- [PrimaryActorTick](ue_ue.InternalToolFrameworkActor.md#primaryactortick)
- [RemoteRole](ue_ue.InternalToolFrameworkActor.md#remoterole)
- [ReplicatedMovement](ue_ue.InternalToolFrameworkActor.md#replicatedmovement)
- [Role](ue_ue.InternalToolFrameworkActor.md#role)
- [RootComponent](ue_ue.InternalToolFrameworkActor.md#rootcomponent)
- [SpawnCollisionHandlingMethod](ue_ue.InternalToolFrameworkActor.md#spawncollisionhandlingmethod)
- [SpriteScale](ue_ue.InternalToolFrameworkActor.md#spritescale)
- [Tags](ue_ue.InternalToolFrameworkActor.md#tags)
- [UpdateOverlapsMethodDuringLevelStreaming](ue_ue.InternalToolFrameworkActor.md#updateoverlapsmethodduringlevelstreaming)
- [\_\_tid\_Actor\_\_](ue_ue.InternalToolFrameworkActor.md#__tid_actor__)
- [\_\_tid\_InternalToolFrameworkActor\_\_](ue_ue.InternalToolFrameworkActor.md#__tid_internaltoolframeworkactor__)
- [\_\_tid\_Object\_\_](ue_ue.InternalToolFrameworkActor.md#__tid_object__)
- [bActorEnableCollision](ue_ue.InternalToolFrameworkActor.md#bactorenablecollision)
- [bActorIsBeingDestroyed](ue_ue.InternalToolFrameworkActor.md#bactorisbeingdestroyed)
- [bActorLabelEditable](ue_ue.InternalToolFrameworkActor.md#bactorlabeleditable)
- [bActorSeamlessTraveled](ue_ue.InternalToolFrameworkActor.md#bactorseamlesstraveled)
- [bAllowReceiveTickEventOnDedicatedServer](ue_ue.InternalToolFrameworkActor.md#ballowreceivetickeventondedicatedserver)
- [bAllowTickBeforeBeginPlay](ue_ue.InternalToolFrameworkActor.md#ballowtickbeforebeginplay)
- [bAlwaysRelevant](ue_ue.InternalToolFrameworkActor.md#balwaysrelevant)
- [bAutoDestroyWhenFinished](ue_ue.InternalToolFrameworkActor.md#bautodestroywhenfinished)
- [bBlockInput](ue_ue.InternalToolFrameworkActor.md#bblockinput)
- [bCanBeDamaged](ue_ue.InternalToolFrameworkActor.md#bcanbedamaged)
- [bCanBeInCluster](ue_ue.InternalToolFrameworkActor.md#bcanbeincluster)
- [bCollideWhenPlacing](ue_ue.InternalToolFrameworkActor.md#bcollidewhenplacing)
- [bEditable](ue_ue.InternalToolFrameworkActor.md#beditable)
- [bEnableAutoLODGeneration](ue_ue.InternalToolFrameworkActor.md#benableautolodgeneration)
- [bExchangedRoles](ue_ue.InternalToolFrameworkActor.md#bexchangedroles)
- [bFindCameraComponentWhenViewTarget](ue_ue.InternalToolFrameworkActor.md#bfindcameracomponentwhenviewtarget)
- [bGenerateOverlapEventsDuringLevelStreaming](ue_ue.InternalToolFrameworkActor.md#bgenerateoverlapeventsduringlevelstreaming)
- [bHidden](ue_ue.InternalToolFrameworkActor.md#bhidden)
- [bHiddenEd](ue_ue.InternalToolFrameworkActor.md#bhiddened)
- [bHiddenEdLayer](ue_ue.InternalToolFrameworkActor.md#bhiddenedlayer)
- [bHiddenEdLevel](ue_ue.InternalToolFrameworkActor.md#bhiddenedlevel)
- [bHiddenEdTemporary](ue_ue.InternalToolFrameworkActor.md#bhiddenedtemporary)
- [bIgnoresOriginShifting](ue_ue.InternalToolFrameworkActor.md#bignoresoriginshifting)
- [bIsEditorOnlyActor](ue_ue.InternalToolFrameworkActor.md#biseditoronlyactor)
- [bIsEditorPreviewActor](ue_ue.InternalToolFrameworkActor.md#biseditorpreviewactor)
- [bListedInSceneOutliner](ue_ue.InternalToolFrameworkActor.md#blistedinsceneoutliner)
- [bLockLocation](ue_ue.InternalToolFrameworkActor.md#blocklocation)
- [bNetLoadOnClient](ue_ue.InternalToolFrameworkActor.md#bnetloadonclient)
- [bNetStartup](ue_ue.InternalToolFrameworkActor.md#bnetstartup)
- [bNetTemporary](ue_ue.InternalToolFrameworkActor.md#bnettemporary)
- [bNetUseOwnerRelevancy](ue_ue.InternalToolFrameworkActor.md#bnetuseownerrelevancy)
- [bOnlyRelevantToOwner](ue_ue.InternalToolFrameworkActor.md#bonlyrelevanttoowner)
- [bOptimizeBPComponentData](ue_ue.InternalToolFrameworkActor.md#boptimizebpcomponentdata)
- [bRelevantForLevelBounds](ue_ue.InternalToolFrameworkActor.md#brelevantforlevelbounds)
- [bRelevantForNetworkReplays](ue_ue.InternalToolFrameworkActor.md#brelevantfornetworkreplays)
- [bReplayRewindable](ue_ue.InternalToolFrameworkActor.md#breplayrewindable)
- [bReplicateMovement](ue_ue.InternalToolFrameworkActor.md#breplicatemovement)
- [bReplicates](ue_ue.InternalToolFrameworkActor.md#breplicates)
- [bTearOff](ue_ue.InternalToolFrameworkActor.md#btearoff)

### Methods

- [ActorHasTag](ue_ue.InternalToolFrameworkActor.md#actorhastag)
- [AddComponent](ue_ue.InternalToolFrameworkActor.md#addcomponent)
- [AddTickPrerequisiteActor](ue_ue.InternalToolFrameworkActor.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.InternalToolFrameworkActor.md#addtickprerequisitecomponent)
- [CreateDefaultSubobject](ue_ue.InternalToolFrameworkActor.md#createdefaultsubobject)
- [DetachRootComponentFromParent](ue_ue.InternalToolFrameworkActor.md#detachrootcomponentfromparent)
- [DisableInput](ue_ue.InternalToolFrameworkActor.md#disableinput)
- [EnableInput](ue_ue.InternalToolFrameworkActor.md#enableinput)
- [ExecuteUbergraph](ue_ue.InternalToolFrameworkActor.md#executeubergraph)
- [FlushNetDormancy](ue_ue.InternalToolFrameworkActor.md#flushnetdormancy)
- [ForceNetUpdate](ue_ue.InternalToolFrameworkActor.md#forcenetupdate)
- [GetActorBounds](ue_ue.InternalToolFrameworkActor.md#getactorbounds)
- [GetActorEnableCollision](ue_ue.InternalToolFrameworkActor.md#getactorenablecollision)
- [GetActorEyesViewPoint](ue_ue.InternalToolFrameworkActor.md#getactoreyesviewpoint)
- [GetActorForwardVector](ue_ue.InternalToolFrameworkActor.md#getactorforwardvector)
- [GetActorLabel](ue_ue.InternalToolFrameworkActor.md#getactorlabel)
- [GetActorRelativeScale3D](ue_ue.InternalToolFrameworkActor.md#getactorrelativescale3d)
- [GetActorRightVector](ue_ue.InternalToolFrameworkActor.md#getactorrightvector)
- [GetActorScale3D](ue_ue.InternalToolFrameworkActor.md#getactorscale3d)
- [GetActorTickInterval](ue_ue.InternalToolFrameworkActor.md#getactortickinterval)
- [GetActorTimeDilation](ue_ue.InternalToolFrameworkActor.md#getactortimedilation)
- [GetActorUpVector](ue_ue.InternalToolFrameworkActor.md#getactorupvector)
- [GetAllChildActors](ue_ue.InternalToolFrameworkActor.md#getallchildactors)
- [GetAttachParentActor](ue_ue.InternalToolFrameworkActor.md#getattachparentactor)
- [GetAttachParentSocketName](ue_ue.InternalToolFrameworkActor.md#getattachparentsocketname)
- [GetAttachedActors](ue_ue.InternalToolFrameworkActor.md#getattachedactors)
- [GetClass](ue_ue.InternalToolFrameworkActor.md#getclass)
- [GetComponentByClass](ue_ue.InternalToolFrameworkActor.md#getcomponentbyclass)
- [GetComponentsByInterface](ue_ue.InternalToolFrameworkActor.md#getcomponentsbyinterface)
- [GetComponentsByTag](ue_ue.InternalToolFrameworkActor.md#getcomponentsbytag)
- [GetDistanceTo](ue_ue.InternalToolFrameworkActor.md#getdistanceto)
- [GetDotProductTo](ue_ue.InternalToolFrameworkActor.md#getdotproductto)
- [GetFolderPath](ue_ue.InternalToolFrameworkActor.md#getfolderpath)
- [GetGameTimeSinceCreation](ue_ue.InternalToolFrameworkActor.md#getgametimesincecreation)
- [GetHorizontalDistanceTo](ue_ue.InternalToolFrameworkActor.md#gethorizontaldistanceto)
- [GetHorizontalDotProductTo](ue_ue.InternalToolFrameworkActor.md#gethorizontaldotproductto)
- [GetInputAxisKeyValue](ue_ue.InternalToolFrameworkActor.md#getinputaxiskeyvalue)
- [GetInputAxisValue](ue_ue.InternalToolFrameworkActor.md#getinputaxisvalue)
- [GetInputVectorAxisValue](ue_ue.InternalToolFrameworkActor.md#getinputvectoraxisvalue)
- [GetInstigator](ue_ue.InternalToolFrameworkActor.md#getinstigator)
- [GetInstigatorController](ue_ue.InternalToolFrameworkActor.md#getinstigatorcontroller)
- [GetLifeSpan](ue_ue.InternalToolFrameworkActor.md#getlifespan)
- [GetLocalRole](ue_ue.InternalToolFrameworkActor.md#getlocalrole)
- [GetName](ue_ue.InternalToolFrameworkActor.md#getname)
- [GetOuter](ue_ue.InternalToolFrameworkActor.md#getouter)
- [GetOverlappingActors](ue_ue.InternalToolFrameworkActor.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue.InternalToolFrameworkActor.md#getoverlappingcomponents)
- [GetOwner](ue_ue.InternalToolFrameworkActor.md#getowner)
- [GetParentActor](ue_ue.InternalToolFrameworkActor.md#getparentactor)
- [GetParentComponent](ue_ue.InternalToolFrameworkActor.md#getparentcomponent)
- [GetRemoteRole](ue_ue.InternalToolFrameworkActor.md#getremoterole)
- [GetSquaredDistanceTo](ue_ue.InternalToolFrameworkActor.md#getsquareddistanceto)
- [GetTickableWhenPaused](ue_ue.InternalToolFrameworkActor.md#gettickablewhenpaused)
- [GetTransform](ue_ue.InternalToolFrameworkActor.md#gettransform)
- [GetVelocity](ue_ue.InternalToolFrameworkActor.md#getvelocity)
- [GetVerticalDistanceTo](ue_ue.InternalToolFrameworkActor.md#getverticaldistanceto)
- [GetWorld](ue_ue.InternalToolFrameworkActor.md#getworld)
- [HasAuthority](ue_ue.InternalToolFrameworkActor.md#hasauthority)
- [IsActorBeingDestroyed](ue_ue.InternalToolFrameworkActor.md#isactorbeingdestroyed)
- [IsActorTickEnabled](ue_ue.InternalToolFrameworkActor.md#isactortickenabled)
- [IsChildActor](ue_ue.InternalToolFrameworkActor.md#ischildactor)
- [IsEditable](ue_ue.InternalToolFrameworkActor.md#iseditable)
- [IsHiddenEd](ue_ue.InternalToolFrameworkActor.md#ishiddened)
- [IsHiddenEdAtStartup](ue_ue.InternalToolFrameworkActor.md#ishiddenedatstartup)
- [IsOverlappingActor](ue_ue.InternalToolFrameworkActor.md#isoverlappingactor)
- [IsSelectable](ue_ue.InternalToolFrameworkActor.md#isselectable)
- [IsTemporarilyHiddenInEditor](ue_ue.InternalToolFrameworkActor.md#istemporarilyhiddenineditor)
- [K2\_AddActorLocalOffset](ue_ue.InternalToolFrameworkActor.md#k2_addactorlocaloffset)
- [K2\_AddActorLocalRotation](ue_ue.InternalToolFrameworkActor.md#k2_addactorlocalrotation)
- [K2\_AddActorLocalTransform](ue_ue.InternalToolFrameworkActor.md#k2_addactorlocaltransform)
- [K2\_AddActorWorldOffset](ue_ue.InternalToolFrameworkActor.md#k2_addactorworldoffset)
- [K2\_AddActorWorldRotation](ue_ue.InternalToolFrameworkActor.md#k2_addactorworldrotation)
- [K2\_AddActorWorldTransform](ue_ue.InternalToolFrameworkActor.md#k2_addactorworldtransform)
- [K2\_AttachRootComponentTo](ue_ue.InternalToolFrameworkActor.md#k2_attachrootcomponentto)
- [K2\_AttachRootComponentToActor](ue_ue.InternalToolFrameworkActor.md#k2_attachrootcomponenttoactor)
- [K2\_AttachToActor](ue_ue.InternalToolFrameworkActor.md#k2_attachtoactor)
- [K2\_AttachToComponent](ue_ue.InternalToolFrameworkActor.md#k2_attachtocomponent)
- [K2\_DestroyActor](ue_ue.InternalToolFrameworkActor.md#k2_destroyactor)
- [K2\_DestroyComponent](ue_ue.InternalToolFrameworkActor.md#k2_destroycomponent)
- [K2\_DetachFromActor](ue_ue.InternalToolFrameworkActor.md#k2_detachfromactor)
- [K2\_GetActorLocation](ue_ue.InternalToolFrameworkActor.md#k2_getactorlocation)
- [K2\_GetActorRotation](ue_ue.InternalToolFrameworkActor.md#k2_getactorrotation)
- [K2\_GetComponentsByClass](ue_ue.InternalToolFrameworkActor.md#k2_getcomponentsbyclass)
- [K2\_GetRootComponent](ue_ue.InternalToolFrameworkActor.md#k2_getrootcomponent)
- [K2\_OnBecomeViewTarget](ue_ue.InternalToolFrameworkActor.md#k2_onbecomeviewtarget)
- [K2\_OnEndViewTarget](ue_ue.InternalToolFrameworkActor.md#k2_onendviewtarget)
- [K2\_OnReset](ue_ue.InternalToolFrameworkActor.md#k2_onreset)
- [K2\_SetActorLocation](ue_ue.InternalToolFrameworkActor.md#k2_setactorlocation)
- [K2\_SetActorLocationAndRotation](ue_ue.InternalToolFrameworkActor.md#k2_setactorlocationandrotation)
- [K2\_SetActorRelativeLocation](ue_ue.InternalToolFrameworkActor.md#k2_setactorrelativelocation)
- [K2\_SetActorRelativeRotation](ue_ue.InternalToolFrameworkActor.md#k2_setactorrelativerotation)
- [K2\_SetActorRelativeTransform](ue_ue.InternalToolFrameworkActor.md#k2_setactorrelativetransform)
- [K2\_SetActorRotation](ue_ue.InternalToolFrameworkActor.md#k2_setactorrotation)
- [K2\_SetActorTransform](ue_ue.InternalToolFrameworkActor.md#k2_setactortransform)
- [K2\_TeleportTo](ue_ue.InternalToolFrameworkActor.md#k2_teleportto)
- [MakeMIDForMaterial](ue_ue.InternalToolFrameworkActor.md#makemidformaterial)
- [MakeNoise](ue_ue.InternalToolFrameworkActor.md#makenoise)
- [OnRep\_AttachmentReplication](ue_ue.InternalToolFrameworkActor.md#onrep_attachmentreplication)
- [OnRep\_Instigator](ue_ue.InternalToolFrameworkActor.md#onrep_instigator)
- [OnRep\_Owner](ue_ue.InternalToolFrameworkActor.md#onrep_owner)
- [OnRep\_ReplicateMovement](ue_ue.InternalToolFrameworkActor.md#onrep_replicatemovement)
- [OnRep\_ReplicatedMovement](ue_ue.InternalToolFrameworkActor.md#onrep_replicatedmovement)
- [PrestreamTextures](ue_ue.InternalToolFrameworkActor.md#prestreamtextures)
- [ReceiveActorBeginCursorOver](ue_ue.InternalToolFrameworkActor.md#receiveactorbegincursorover)
- [ReceiveActorBeginOverlap](ue_ue.InternalToolFrameworkActor.md#receiveactorbeginoverlap)
- [ReceiveActorEndCursorOver](ue_ue.InternalToolFrameworkActor.md#receiveactorendcursorover)
- [ReceiveActorEndOverlap](ue_ue.InternalToolFrameworkActor.md#receiveactorendoverlap)
- [ReceiveActorOnClicked](ue_ue.InternalToolFrameworkActor.md#receiveactoronclicked)
- [ReceiveActorOnInputTouchBegin](ue_ue.InternalToolFrameworkActor.md#receiveactoroninputtouchbegin)
- [ReceiveActorOnInputTouchEnd](ue_ue.InternalToolFrameworkActor.md#receiveactoroninputtouchend)
- [ReceiveActorOnInputTouchEnter](ue_ue.InternalToolFrameworkActor.md#receiveactoroninputtouchenter)
- [ReceiveActorOnInputTouchLeave](ue_ue.InternalToolFrameworkActor.md#receiveactoroninputtouchleave)
- [ReceiveActorOnReleased](ue_ue.InternalToolFrameworkActor.md#receiveactoronreleased)
- [ReceiveAnyDamage](ue_ue.InternalToolFrameworkActor.md#receiveanydamage)
- [ReceiveBeginPlay](ue_ue.InternalToolFrameworkActor.md#receivebeginplay)
- [ReceiveDestroyed](ue_ue.InternalToolFrameworkActor.md#receivedestroyed)
- [ReceiveEndPlay](ue_ue.InternalToolFrameworkActor.md#receiveendplay)
- [ReceiveHit](ue_ue.InternalToolFrameworkActor.md#receivehit)
- [ReceivePointDamage](ue_ue.InternalToolFrameworkActor.md#receivepointdamage)
- [ReceiveRadialDamage](ue_ue.InternalToolFrameworkActor.md#receiveradialdamage)
- [ReceiveTick](ue_ue.InternalToolFrameworkActor.md#receivetick)
- [RemoveTickPrerequisiteActor](ue_ue.InternalToolFrameworkActor.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.InternalToolFrameworkActor.md#removetickprerequisitecomponent)
- [SetActorEnableCollision](ue_ue.InternalToolFrameworkActor.md#setactorenablecollision)
- [SetActorHiddenInGame](ue_ue.InternalToolFrameworkActor.md#setactorhiddeningame)
- [SetActorLabel](ue_ue.InternalToolFrameworkActor.md#setactorlabel)
- [SetActorRelativeScale3D](ue_ue.InternalToolFrameworkActor.md#setactorrelativescale3d)
- [SetActorScale3D](ue_ue.InternalToolFrameworkActor.md#setactorscale3d)
- [SetActorTickEnabled](ue_ue.InternalToolFrameworkActor.md#setactortickenabled)
- [SetActorTickInterval](ue_ue.InternalToolFrameworkActor.md#setactortickinterval)
- [SetFolderPath](ue_ue.InternalToolFrameworkActor.md#setfolderpath)
- [SetIsTemporarilyHiddenInEditor](ue_ue.InternalToolFrameworkActor.md#setistemporarilyhiddenineditor)
- [SetLifeSpan](ue_ue.InternalToolFrameworkActor.md#setlifespan)
- [SetNetDormancy](ue_ue.InternalToolFrameworkActor.md#setnetdormancy)
- [SetOwner](ue_ue.InternalToolFrameworkActor.md#setowner)
- [SetReplicateMovement](ue_ue.InternalToolFrameworkActor.md#setreplicatemovement)
- [SetReplicates](ue_ue.InternalToolFrameworkActor.md#setreplicates)
- [SetTickGroup](ue_ue.InternalToolFrameworkActor.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.InternalToolFrameworkActor.md#settickablewhenpaused)
- [SnapRootComponentTo](ue_ue.InternalToolFrameworkActor.md#snaprootcomponentto)
- [TearOff](ue_ue.InternalToolFrameworkActor.md#tearoff)
- [UserConstructionScript](ue_ue.InternalToolFrameworkActor.md#userconstructionscript)
- [WasRecentlyRendered](ue_ue.InternalToolFrameworkActor.md#wasrecentlyrendered)
- [Find](ue_ue.InternalToolFrameworkActor.md#find)
- [Load](ue_ue.InternalToolFrameworkActor.md#load)
- [StaticClass](ue_ue.InternalToolFrameworkActor.md#staticclass)

## Constructors

### constructor

• **new InternalToolFrameworkActor**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37867](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37867)
...
[ue/ue.d.ts:37872](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37872)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`InternalToolFrameworkActor`](ue_ue.InternalToolFrameworkActor.md)
...
[ue/ue.d.ts:37869](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37869)

___

### Load

▸ `Static` **Load**(`InName`): [`InternalToolFrameworkActor`](ue_ue.InternalToolFrameworkActor.md)
...
[ue/ue.d.ts:37870](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37870)
...
[ue/ue.d.ts:37868](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37868)
