[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / InterpTrackInstProperty

# Class: InterpTrackInstProperty

[ue/ue](../modules/ue_ue.md).InterpTrackInstProperty
...
- [constructor](ue_ue.InterpTrackInstProperty.md#constructor)

### Properties

- [InterpProperty](ue_ue.InterpTrackInstProperty.md#interpproperty)
- [PropertyOuterObjectInst](ue_ue.InterpTrackInstProperty.md#propertyouterobjectinst)
- [\_\_tid\_InterpTrackInstProperty\_\_](ue_ue.InterpTrackInstProperty.md#__tid_interptrackinstproperty__)
- [\_\_tid\_InterpTrackInst\_\_](ue_ue.InterpTrackInstProperty.md#__tid_interptrackinst__)
- [\_\_tid\_Object\_\_](ue_ue.InterpTrackInstProperty.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.InterpTrackInstProperty.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.InterpTrackInstProperty.md#executeubergraph)
- [GetClass](ue_ue.InterpTrackInstProperty.md#getclass)
- [GetName](ue_ue.InterpTrackInstProperty.md#getname)
- [GetOuter](ue_ue.InterpTrackInstProperty.md#getouter)
- [GetWorld](ue_ue.InterpTrackInstProperty.md#getworld)
- [Find](ue_ue.InterpTrackInstProperty.md#find)
- [Load](ue_ue.InterpTrackInstProperty.md#load)
- [StaticClass](ue_ue.InterpTrackInstProperty.md#staticclass)

## Constructors

### constructor

• **new InterpTrackInstProperty**(`Outer?`, `Name?`, `ObjectFlags?`)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`InterpTrackInstProperty`](ue_ue.InterpTrackInstProperty.md)
...
▸ `Static` **Load**(`InName`): [`InterpTrackInstProperty`](ue_ue.InterpTrackInstProperty.md)
