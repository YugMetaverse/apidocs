[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_AssignmentStatement

# Class: K2Node\_AssignmentStatement

[ue/ue](../modules/ue_ue.md).K2Node_AssignmentStatement
...
- [constructor](ue_ue.K2Node_AssignmentStatement.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_AssignmentStatement.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_AssignmentStatement.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_AssignmentStatement.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_AssignmentStatement.md#errormsg)
- [ErrorType](ue_ue.K2Node_AssignmentStatement.md#errortype)
- [NodeComment](ue_ue.K2Node_AssignmentStatement.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_AssignmentStatement.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_AssignmentStatement.md#nodeheight)
- [NodePosX](ue_ue.K2Node_AssignmentStatement.md#nodeposx)
- [NodePosY](ue_ue.K2Node_AssignmentStatement.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_AssignmentStatement.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_AssignmentStatement.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_AssignmentStatement.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_AssignmentStatement\_\_](ue_ue.K2Node_AssignmentStatement.md#__tid_k2node_assignmentstatement__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_AssignmentStatement.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_AssignmentStatement.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_AssignmentStatement.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_AssignmentStatement.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_AssignmentStatement.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_AssignmentStatement.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_AssignmentStatement.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_AssignmentStatement.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_AssignmentStatement.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_AssignmentStatement.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_AssignmentStatement.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_AssignmentStatement.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_AssignmentStatement.md#executeubergraph)
- [GetClass](ue_ue.K2Node_AssignmentStatement.md#getclass)
- [GetName](ue_ue.K2Node_AssignmentStatement.md#getname)
- [GetOuter](ue_ue.K2Node_AssignmentStatement.md#getouter)
- [GetWorld](ue_ue.K2Node_AssignmentStatement.md#getworld)
- [Find](ue_ue.K2Node_AssignmentStatement.md#find)
- [Load](ue_ue.K2Node_AssignmentStatement.md#load)
- [StaticClass](ue_ue.K2Node_AssignmentStatement.md#staticclass)

## Constructors

### constructor

• **new K2Node_AssignmentStatement**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:40849](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40849)
...
### \_\_tid\_K2Node\_AssignmentStatement\_\_

• **\_\_tid\_K2Node\_AssignmentStatement\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:40854](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40854)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_AssignmentStatement`](ue_ue.K2Node_AssignmentStatement.md)
...
[ue/ue.d.ts:40851](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40851)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_AssignmentStatement`](ue_ue.K2Node_AssignmentStatement.md)
...
[ue/ue.d.ts:40852](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40852)
...
[ue/ue.d.ts:40850](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40850)
