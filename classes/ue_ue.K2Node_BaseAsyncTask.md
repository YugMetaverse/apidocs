[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_BaseAsyncTask

# Class: K2Node\_BaseAsyncTask

[ue/ue](../modules/ue_ue.md).K2Node_BaseAsyncTask
...
- [`K2Node`](ue_ue.K2Node.md)
  ...
  ↳↳ [`K2Node_AIMoveTo`](ue_ue.K2Node_AIMoveTo.md)

  ↳↳ [`K2Node_AsyncAction`](ue_ue.K2Node_AsyncAction.md)

  ↳↳ [`K2Node_ConvertToHEIF`](ue_ue.K2Node_ConvertToHEIF.md)

  ↳↳ [`K2Node_ConvertToJPEG`](ue_ue.K2Node_ConvertToJPEG.md)

  ↳↳ [`K2Node_ConvertToPNG`](ue_ue.K2Node_ConvertToPNG.md)

  ↳↳ [`K2Node_ConvertToTIFF`](ue_ue.K2Node_ConvertToTIFF.md)

  ↳↳ [`K2Node_InAppPurchase`](ue_ue.K2Node_InAppPurchase.md)
  ...
  ↳↳ [`K2Node_LatentOnlineCall`](ue_ue.K2Node_LatentOnlineCall.md)

  ↳↳ [`K2Node_LeaderboardFlush`](ue_ue.K2Node_LeaderboardFlush.md)

  ↳↳ [`K2Node_LeaderboardQuery`](ue_ue.K2Node_LeaderboardQuery.md)

  ↳↳ [`K2Node_PlayAnimation`](ue_ue.K2Node_PlayAnimation.md)

  ↳↳ [`K2Node_PlayAnimationTimeRange`](ue_ue.K2Node_PlayAnimationTimeRange.md)

  ↳↳ [`K2Node_PlayMontage`](ue_ue.K2Node_PlayMontage.md)

## Table of contents

### Constructors

- [constructor](ue_ue.K2Node_BaseAsyncTask.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_BaseAsyncTask.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_BaseAsyncTask.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_BaseAsyncTask.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_BaseAsyncTask.md#errormsg)
- [ErrorType](ue_ue.K2Node_BaseAsyncTask.md#errortype)
- [NodeComment](ue_ue.K2Node_BaseAsyncTask.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_BaseAsyncTask.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_BaseAsyncTask.md#nodeheight)
- [NodePosX](ue_ue.K2Node_BaseAsyncTask.md#nodeposx)
- [NodePosY](ue_ue.K2Node_BaseAsyncTask.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_BaseAsyncTask.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_BaseAsyncTask.md#nodewidth)
- [ProxyActivateFunctionName](ue_ue.K2Node_BaseAsyncTask.md#proxyactivatefunctionname)
- [ProxyClass](ue_ue.K2Node_BaseAsyncTask.md#proxyclass)
- [ProxyFactoryClass](ue_ue.K2Node_BaseAsyncTask.md#proxyfactoryclass)
- [ProxyFactoryFunctionName](ue_ue.K2Node_BaseAsyncTask.md#proxyfactoryfunctionname)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_BaseAsyncTask.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseAsyncTask\_\_](ue_ue.K2Node_BaseAsyncTask.md#__tid_k2node_baseasynctask__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_BaseAsyncTask.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_BaseAsyncTask.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_BaseAsyncTask.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_BaseAsyncTask.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_BaseAsyncTask.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_BaseAsyncTask.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_BaseAsyncTask.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_BaseAsyncTask.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_BaseAsyncTask.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_BaseAsyncTask.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_BaseAsyncTask.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_BaseAsyncTask.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_BaseAsyncTask.md#executeubergraph)
- [GetClass](ue_ue.K2Node_BaseAsyncTask.md#getclass)
- [GetName](ue_ue.K2Node_BaseAsyncTask.md#getname)
- [GetOuter](ue_ue.K2Node_BaseAsyncTask.md#getouter)
- [GetWorld](ue_ue.K2Node_BaseAsyncTask.md#getworld)
- [Find](ue_ue.K2Node_BaseAsyncTask.md#find)
- [Load](ue_ue.K2Node_BaseAsyncTask.md#load)
- [StaticClass](ue_ue.K2Node_BaseAsyncTask.md#staticclass)

## Constructors

### constructor

• **new K2Node_BaseAsyncTask**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:40803](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40803)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_BaseAsyncTask`](ue_ue.K2Node_BaseAsyncTask.md)
...
[ue/ue.d.ts:40809](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40809)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_BaseAsyncTask`](ue_ue.K2Node_BaseAsyncTask.md)
...
[ue/ue.d.ts:40810](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40810)
...
[ue/ue.d.ts:40808](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40808)
