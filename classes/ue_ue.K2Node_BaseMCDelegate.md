[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_BaseMCDelegate

# Class: K2Node\_BaseMCDelegate

[ue/ue](../modules/ue_ue.md).K2Node_BaseMCDelegate
...
- [constructor](ue_ue.K2Node_BaseMCDelegate.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_BaseMCDelegate.md#advancedpindisplay)
- [DelegateReference](ue_ue.K2Node_BaseMCDelegate.md#delegatereference)
- [DeprecatedPins](ue_ue.K2Node_BaseMCDelegate.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_BaseMCDelegate.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_BaseMCDelegate.md#errormsg)
- [ErrorType](ue_ue.K2Node_BaseMCDelegate.md#errortype)
- [NodeComment](ue_ue.K2Node_BaseMCDelegate.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_BaseMCDelegate.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_BaseMCDelegate.md#nodeheight)
- [NodePosX](ue_ue.K2Node_BaseMCDelegate.md#nodeposx)
- [NodePosY](ue_ue.K2Node_BaseMCDelegate.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_BaseMCDelegate.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_BaseMCDelegate.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_BaseMCDelegate.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseMCDelegate\_\_](ue_ue.K2Node_BaseMCDelegate.md#__tid_k2node_basemcdelegate__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_BaseMCDelegate.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_BaseMCDelegate.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_BaseMCDelegate.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_BaseMCDelegate.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_BaseMCDelegate.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_BaseMCDelegate.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_BaseMCDelegate.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_BaseMCDelegate.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_BaseMCDelegate.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_BaseMCDelegate.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_BaseMCDelegate.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_BaseMCDelegate.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_BaseMCDelegate.md#executeubergraph)
- [GetClass](ue_ue.K2Node_BaseMCDelegate.md#getclass)
- [GetName](ue_ue.K2Node_BaseMCDelegate.md#getname)
- [GetOuter](ue_ue.K2Node_BaseMCDelegate.md#getouter)
- [GetWorld](ue_ue.K2Node_BaseMCDelegate.md#getworld)
- [Find](ue_ue.K2Node_BaseMCDelegate.md#find)
- [Load](ue_ue.K2Node_BaseMCDelegate.md#load)
- [StaticClass](ue_ue.K2Node_BaseMCDelegate.md#staticclass)

## Constructors

### constructor

• **new K2Node_BaseMCDelegate**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:40775](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40775)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_BaseMCDelegate`](ue_ue.K2Node_BaseMCDelegate.md)
...
[ue/ue.d.ts:40778](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40778)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_BaseMCDelegate`](ue_ue.K2Node_BaseMCDelegate.md)
...
[ue/ue.d.ts:40779](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40779)
...
[ue/ue.d.ts:40777](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40777)
