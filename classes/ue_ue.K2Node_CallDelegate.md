[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_CallDelegate

# Class: K2Node\_CallDelegate

[ue/ue](../modules/ue_ue.md).K2Node_CallDelegate
...
- [constructor](ue_ue.K2Node_CallDelegate.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_CallDelegate.md#advancedpindisplay)
- [DelegateReference](ue_ue.K2Node_CallDelegate.md#delegatereference)
- [DeprecatedPins](ue_ue.K2Node_CallDelegate.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_CallDelegate.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_CallDelegate.md#errormsg)
- [ErrorType](ue_ue.K2Node_CallDelegate.md#errortype)
- [NodeComment](ue_ue.K2Node_CallDelegate.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_CallDelegate.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_CallDelegate.md#nodeheight)
- [NodePosX](ue_ue.K2Node_CallDelegate.md#nodeposx)
- [NodePosY](ue_ue.K2Node_CallDelegate.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_CallDelegate.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_CallDelegate.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_CallDelegate.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseMCDelegate\_\_](ue_ue.K2Node_CallDelegate.md#__tid_k2node_basemcdelegate__)
- [\_\_tid\_K2Node\_CallDelegate\_\_](ue_ue.K2Node_CallDelegate.md#__tid_k2node_calldelegate__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_CallDelegate.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_CallDelegate.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_CallDelegate.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_CallDelegate.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_CallDelegate.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_CallDelegate.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_CallDelegate.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_CallDelegate.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_CallDelegate.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_CallDelegate.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_CallDelegate.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_CallDelegate.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_CallDelegate.md#executeubergraph)
- [GetClass](ue_ue.K2Node_CallDelegate.md#getclass)
- [GetName](ue_ue.K2Node_CallDelegate.md#getname)
- [GetOuter](ue_ue.K2Node_CallDelegate.md#getouter)
- [GetWorld](ue_ue.K2Node_CallDelegate.md#getworld)
- [Find](ue_ue.K2Node_CallDelegate.md#find)
- [Load](ue_ue.K2Node_CallDelegate.md#load)
- [StaticClass](ue_ue.K2Node_CallDelegate.md#staticclass)

## Constructors

### constructor

• **new K2Node_CallDelegate**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:40939](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40939)
...
### \_\_tid\_K2Node\_CallDelegate\_\_

• **\_\_tid\_K2Node\_CallDelegate\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:40944](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40944)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_CallDelegate`](ue_ue.K2Node_CallDelegate.md)
...
[`K2Node_CallDelegate`](ue_ue.K2Node_CallDelegate.md)
...
[ue/ue.d.ts:40941](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40941)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_CallDelegate`](ue_ue.K2Node_CallDelegate.md)
...
[ue/ue.d.ts:40942](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40942)
...
[ue/ue.d.ts:40940](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40940)
