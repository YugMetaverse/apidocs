[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_CastByteToEnum

# Class: K2Node\_CastByteToEnum

[ue/ue](../modules/ue_ue.md).K2Node_CastByteToEnum
...
- [constructor](ue_ue.K2Node_CastByteToEnum.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_CastByteToEnum.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_CastByteToEnum.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_CastByteToEnum.md#enabledstate)
- [Enum](ue_ue.K2Node_CastByteToEnum.md#enum)
- [ErrorMsg](ue_ue.K2Node_CastByteToEnum.md#errormsg)
- [ErrorType](ue_ue.K2Node_CastByteToEnum.md#errortype)
- [NodeComment](ue_ue.K2Node_CastByteToEnum.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_CastByteToEnum.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_CastByteToEnum.md#nodeheight)
- [NodePosX](ue_ue.K2Node_CastByteToEnum.md#nodeposx)
- [NodePosY](ue_ue.K2Node_CastByteToEnum.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_CastByteToEnum.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_CastByteToEnum.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_CastByteToEnum.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_CastByteToEnum\_\_](ue_ue.K2Node_CastByteToEnum.md#__tid_k2node_castbytetoenum__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_CastByteToEnum.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_CastByteToEnum.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_CastByteToEnum.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_CastByteToEnum.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_CastByteToEnum.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_CastByteToEnum.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_CastByteToEnum.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_CastByteToEnum.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_CastByteToEnum.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_CastByteToEnum.md#bisnodeenabled)
- [bSafe](ue_ue.K2Node_CastByteToEnum.md#bsafe)
- [bUserSetEnabledState](ue_ue.K2Node_CastByteToEnum.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_CastByteToEnum.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_CastByteToEnum.md#executeubergraph)
- [GetClass](ue_ue.K2Node_CastByteToEnum.md#getclass)
- [GetName](ue_ue.K2Node_CastByteToEnum.md#getname)
- [GetOuter](ue_ue.K2Node_CastByteToEnum.md#getouter)
- [GetWorld](ue_ue.K2Node_CastByteToEnum.md#getworld)
- [Find](ue_ue.K2Node_CastByteToEnum.md#find)
- [Load](ue_ue.K2Node_CastByteToEnum.md#load)
- [StaticClass](ue_ue.K2Node_CastByteToEnum.md#staticclass)

## Constructors

### constructor

• **new K2Node_CastByteToEnum**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:40976](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40976)
...
[ue/ue.d.ts:40977](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40977)
...
### \_\_tid\_K2Node\_CastByteToEnum\_\_

• **\_\_tid\_K2Node\_CastByteToEnum\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:40983](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40983)
...
[ue/ue.d.ts:40978](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40978)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_CastByteToEnum`](ue_ue.K2Node_CastByteToEnum.md)
...
[ue/ue.d.ts:40980](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40980)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_CastByteToEnum`](ue_ue.K2Node_CastByteToEnum.md)
...
[ue/ue.d.ts:40981](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40981)
...
[ue/ue.d.ts:40979](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L40979)
