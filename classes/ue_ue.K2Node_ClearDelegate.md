[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_ClearDelegate

# Class: K2Node\_ClearDelegate

[ue/ue](../modules/ue_ue.md).K2Node_ClearDelegate
...
- [constructor](ue_ue.K2Node_ClearDelegate.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_ClearDelegate.md#advancedpindisplay)
- [DelegateReference](ue_ue.K2Node_ClearDelegate.md#delegatereference)
- [DeprecatedPins](ue_ue.K2Node_ClearDelegate.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_ClearDelegate.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_ClearDelegate.md#errormsg)
- [ErrorType](ue_ue.K2Node_ClearDelegate.md#errortype)
- [NodeComment](ue_ue.K2Node_ClearDelegate.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_ClearDelegate.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_ClearDelegate.md#nodeheight)
- [NodePosX](ue_ue.K2Node_ClearDelegate.md#nodeposx)
- [NodePosY](ue_ue.K2Node_ClearDelegate.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_ClearDelegate.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_ClearDelegate.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_ClearDelegate.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseMCDelegate\_\_](ue_ue.K2Node_ClearDelegate.md#__tid_k2node_basemcdelegate__)
- [\_\_tid\_K2Node\_ClearDelegate\_\_](ue_ue.K2Node_ClearDelegate.md#__tid_k2node_cleardelegate__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_ClearDelegate.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_ClearDelegate.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_ClearDelegate.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_ClearDelegate.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_ClearDelegate.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_ClearDelegate.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_ClearDelegate.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_ClearDelegate.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_ClearDelegate.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_ClearDelegate.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_ClearDelegate.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_ClearDelegate.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_ClearDelegate.md#executeubergraph)
- [GetClass](ue_ue.K2Node_ClearDelegate.md#getclass)
- [GetName](ue_ue.K2Node_ClearDelegate.md#getname)
- [GetOuter](ue_ue.K2Node_ClearDelegate.md#getouter)
- [GetWorld](ue_ue.K2Node_ClearDelegate.md#getworld)
- [Find](ue_ue.K2Node_ClearDelegate.md#find)
- [Load](ue_ue.K2Node_ClearDelegate.md#load)
- [StaticClass](ue_ue.K2Node_ClearDelegate.md#staticclass)

## Constructors

### constructor

• **new K2Node_ClearDelegate**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41007](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41007)
...
### \_\_tid\_K2Node\_ClearDelegate\_\_

• **\_\_tid\_K2Node\_ClearDelegate\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41012](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41012)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_ClearDelegate`](ue_ue.K2Node_ClearDelegate.md)
...
[`K2Node_ClearDelegate`](ue_ue.K2Node_ClearDelegate.md)
...
[ue/ue.d.ts:41009](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41009)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_ClearDelegate`](ue_ue.K2Node_ClearDelegate.md)
...
[ue/ue.d.ts:41010](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41010)
...
[ue/ue.d.ts:41008](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41008)
