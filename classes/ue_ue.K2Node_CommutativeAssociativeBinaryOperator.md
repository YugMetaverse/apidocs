[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_CommutativeAssociativeBinaryOperator

# Class: K2Node\_CommutativeAssociativeBinaryOperator

[ue/ue](../modules/ue_ue.md).K2Node_CommutativeAssociativeBinaryOperator
...
- [constructor](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#advancedpindisplay)
- [CallFunctionClass](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#callfunctionclass)
- [CallFunctionName](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#callfunctionname)
- [DeprecatedPins](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#errormsg)
- [ErrorType](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#errortype)
- [FunctionReference](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#functionreference)
- [NodeComment](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodeheight)
- [NodePosX](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodeposx)
- [NodePosY](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#nodewidth)
- [NumAdditionalInputs](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#numadditionalinputs)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_CallFunction\_\_](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#__tid_k2node_callfunction__)
- [\_\_tid\_K2Node\_CommutativeAssociativeBinaryOperator\_\_](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#__tid_k2node_commutativeassociativebinaryoperator__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bhascompilermessage)
- [bIsBeadFunction](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bisbeadfunction)
- [bIsConstFunc](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bisconstfunc)
- [bIsFinalFunction](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bisfinalfunction)
- [bIsInterfaceCall](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bisinterfacecall)
- [bIsNodeEnabled](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bisnodeenabled)
- [bIsPureFunc](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bispurefunc)
- [bUserSetEnabledState](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#busersetenabledstate)
- [bWantsEnumToExecExpansion](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#bwantsenumtoexecexpansion)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#executeubergraph)
- [GetClass](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#getclass)
- [GetName](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#getname)
- [GetOuter](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#getouter)
- [GetWorld](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#getworld)
- [Find](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#find)
- [Load](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#load)
- [StaticClass](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md#staticclass)

## Constructors

### constructor

• **new K2Node_CommutativeAssociativeBinaryOperator**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41016](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41016)
...
[ue/ue.d.ts:41017](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41017)
...
### \_\_tid\_K2Node\_CommutativeAssociativeBinaryOperator\_\_

• **\_\_tid\_K2Node\_CommutativeAssociativeBinaryOperator\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41022](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41022)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_CommutativeAssociativeBinaryOperator`](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md)
...
[`K2Node_CommutativeAssociativeBinaryOperator`](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md)
...
[ue/ue.d.ts:41019](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41019)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_CommutativeAssociativeBinaryOperator`](ue_ue.K2Node_CommutativeAssociativeBinaryOperator.md)
...
[ue/ue.d.ts:41020](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41020)
...
[ue/ue.d.ts:41018](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41018)
