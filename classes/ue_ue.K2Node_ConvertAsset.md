[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_ConvertAsset

# Class: K2Node\_ConvertAsset

[ue/ue](../modules/ue_ue.md).K2Node_ConvertAsset
...
- [constructor](ue_ue.K2Node_ConvertAsset.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_ConvertAsset.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_ConvertAsset.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_ConvertAsset.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_ConvertAsset.md#errormsg)
- [ErrorType](ue_ue.K2Node_ConvertAsset.md#errortype)
- [NodeComment](ue_ue.K2Node_ConvertAsset.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_ConvertAsset.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_ConvertAsset.md#nodeheight)
- [NodePosX](ue_ue.K2Node_ConvertAsset.md#nodeposx)
- [NodePosY](ue_ue.K2Node_ConvertAsset.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_ConvertAsset.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_ConvertAsset.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_ConvertAsset.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_ConvertAsset\_\_](ue_ue.K2Node_ConvertAsset.md#__tid_k2node_convertasset__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_ConvertAsset.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_ConvertAsset.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_ConvertAsset.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_ConvertAsset.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_ConvertAsset.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_ConvertAsset.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_ConvertAsset.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_ConvertAsset.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_ConvertAsset.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_ConvertAsset.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_ConvertAsset.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_ConvertAsset.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_ConvertAsset.md#executeubergraph)
- [GetClass](ue_ue.K2Node_ConvertAsset.md#getclass)
- [GetName](ue_ue.K2Node_ConvertAsset.md#getname)
- [GetOuter](ue_ue.K2Node_ConvertAsset.md#getouter)
- [GetWorld](ue_ue.K2Node_ConvertAsset.md#getworld)
- [Find](ue_ue.K2Node_ConvertAsset.md#find)
- [Load](ue_ue.K2Node_ConvertAsset.md#load)
- [StaticClass](ue_ue.K2Node_ConvertAsset.md#staticclass)

## Constructors

### constructor

• **new K2Node_ConvertAsset**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41092](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41092)
...
### \_\_tid\_K2Node\_ConvertAsset\_\_

• **\_\_tid\_K2Node\_ConvertAsset\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41097](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41097)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_ConvertAsset`](ue_ue.K2Node_ConvertAsset.md)
...
[ue/ue.d.ts:41094](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41094)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_ConvertAsset`](ue_ue.K2Node_ConvertAsset.md)
...
[ue/ue.d.ts:41095](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41095)
...
[ue/ue.d.ts:41093](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41093)
