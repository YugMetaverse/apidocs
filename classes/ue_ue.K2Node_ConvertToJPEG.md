[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_ConvertToJPEG

# Class: K2Node\_ConvertToJPEG

[ue/ue](../modules/ue_ue.md).K2Node_ConvertToJPEG
...
- [constructor](ue_ue.K2Node_ConvertToJPEG.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_ConvertToJPEG.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_ConvertToJPEG.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_ConvertToJPEG.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_ConvertToJPEG.md#errormsg)
- [ErrorType](ue_ue.K2Node_ConvertToJPEG.md#errortype)
- [NodeComment](ue_ue.K2Node_ConvertToJPEG.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_ConvertToJPEG.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_ConvertToJPEG.md#nodeheight)
- [NodePosX](ue_ue.K2Node_ConvertToJPEG.md#nodeposx)
- [NodePosY](ue_ue.K2Node_ConvertToJPEG.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_ConvertToJPEG.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_ConvertToJPEG.md#nodewidth)
- [ProxyActivateFunctionName](ue_ue.K2Node_ConvertToJPEG.md#proxyactivatefunctionname)
- [ProxyClass](ue_ue.K2Node_ConvertToJPEG.md#proxyclass)
- [ProxyFactoryClass](ue_ue.K2Node_ConvertToJPEG.md#proxyfactoryclass)
- [ProxyFactoryFunctionName](ue_ue.K2Node_ConvertToJPEG.md#proxyfactoryfunctionname)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_ConvertToJPEG.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseAsyncTask\_\_](ue_ue.K2Node_ConvertToJPEG.md#__tid_k2node_baseasynctask__)
- [\_\_tid\_K2Node\_ConvertToJPEG\_\_](ue_ue.K2Node_ConvertToJPEG.md#__tid_k2node_converttojpeg__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_ConvertToJPEG.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_ConvertToJPEG.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_ConvertToJPEG.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_ConvertToJPEG.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_ConvertToJPEG.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_ConvertToJPEG.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_ConvertToJPEG.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_ConvertToJPEG.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_ConvertToJPEG.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_ConvertToJPEG.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_ConvertToJPEG.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_ConvertToJPEG.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_ConvertToJPEG.md#executeubergraph)
- [GetClass](ue_ue.K2Node_ConvertToJPEG.md#getclass)
- [GetName](ue_ue.K2Node_ConvertToJPEG.md#getname)
- [GetOuter](ue_ue.K2Node_ConvertToJPEG.md#getouter)
- [GetWorld](ue_ue.K2Node_ConvertToJPEG.md#getworld)
- [Find](ue_ue.K2Node_ConvertToJPEG.md#find)
- [Load](ue_ue.K2Node_ConvertToJPEG.md#load)
- [StaticClass](ue_ue.K2Node_ConvertToJPEG.md#staticclass)

## Constructors

### constructor

• **new K2Node_ConvertToJPEG**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41110](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41110)
...
### \_\_tid\_K2Node\_ConvertToJPEG\_\_

• **\_\_tid\_K2Node\_ConvertToJPEG\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41115](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41115)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_ConvertToJPEG`](ue_ue.K2Node_ConvertToJPEG.md)
...
[ue/ue.d.ts:41112](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41112)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_ConvertToJPEG`](ue_ue.K2Node_ConvertToJPEG.md)
...
[ue/ue.d.ts:41113](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41113)
...
[ue/ue.d.ts:41111](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41111)
