[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_Copy

# Class: K2Node\_Copy

[ue/ue](../modules/ue_ue.md).K2Node_Copy
...
- [constructor](ue_ue.K2Node_Copy.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_Copy.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_Copy.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_Copy.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_Copy.md#errormsg)
- [ErrorType](ue_ue.K2Node_Copy.md#errortype)
- [NodeComment](ue_ue.K2Node_Copy.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_Copy.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_Copy.md#nodeheight)
- [NodePosX](ue_ue.K2Node_Copy.md#nodeposx)
- [NodePosY](ue_ue.K2Node_Copy.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_Copy.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_Copy.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_Copy.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_Copy\_\_](ue_ue.K2Node_Copy.md#__tid_k2node_copy__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_Copy.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_Copy.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_Copy.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_Copy.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_Copy.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_Copy.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_Copy.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_Copy.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_Copy.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_Copy.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_Copy.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_Copy.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_Copy.md#executeubergraph)
- [GetClass](ue_ue.K2Node_Copy.md#getclass)
- [GetName](ue_ue.K2Node_Copy.md#getname)
- [GetOuter](ue_ue.K2Node_Copy.md#getouter)
- [GetWorld](ue_ue.K2Node_Copy.md#getworld)
- [Find](ue_ue.K2Node_Copy.md#find)
- [Load](ue_ue.K2Node_Copy.md#load)
- [StaticClass](ue_ue.K2Node_Copy.md#staticclass)

## Constructors

### constructor

• **new K2Node_Copy**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41137](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41137)
...
### \_\_tid\_K2Node\_Copy\_\_

• **\_\_tid\_K2Node\_Copy\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41142](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41142)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_Copy`](ue_ue.K2Node_Copy.md)
...
[ue/ue.d.ts:41139](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41139)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_Copy`](ue_ue.K2Node_Copy.md)
...
[ue/ue.d.ts:41140](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41140)
...
[ue/ue.d.ts:41138](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41138)
