[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_DeadClass

# Class: K2Node\_DeadClass

[ue/ue](../modules/ue_ue.md).K2Node_DeadClass
...
- [constructor](ue_ue.K2Node_DeadClass.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_DeadClass.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_DeadClass.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_DeadClass.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_DeadClass.md#errormsg)
- [ErrorType](ue_ue.K2Node_DeadClass.md#errortype)
- [NodeComment](ue_ue.K2Node_DeadClass.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_DeadClass.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_DeadClass.md#nodeheight)
- [NodePosX](ue_ue.K2Node_DeadClass.md#nodeposx)
- [NodePosY](ue_ue.K2Node_DeadClass.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_DeadClass.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_DeadClass.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_DeadClass.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_DeadClass\_\_](ue_ue.K2Node_DeadClass.md#__tid_k2node_deadclass__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_DeadClass.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_DeadClass.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_DeadClass.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_DeadClass.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_DeadClass.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_DeadClass.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_DeadClass.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_DeadClass.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_DeadClass.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_DeadClass.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_DeadClass.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_DeadClass.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_DeadClass.md#executeubergraph)
- [GetClass](ue_ue.K2Node_DeadClass.md#getclass)
- [GetName](ue_ue.K2Node_DeadClass.md#getname)
- [GetOuter](ue_ue.K2Node_DeadClass.md#getouter)
- [GetWorld](ue_ue.K2Node_DeadClass.md#getworld)
- [Find](ue_ue.K2Node_DeadClass.md#find)
- [Load](ue_ue.K2Node_DeadClass.md#load)
- [StaticClass](ue_ue.K2Node_DeadClass.md#staticclass)

## Constructors

### constructor

• **new K2Node_DeadClass**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41188](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41188)
...
### \_\_tid\_K2Node\_DeadClass\_\_

• **\_\_tid\_K2Node\_DeadClass\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41193](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41193)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_DeadClass`](ue_ue.K2Node_DeadClass.md)
...
[ue/ue.d.ts:41190](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41190)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_DeadClass`](ue_ue.K2Node_DeadClass.md)
...
[ue/ue.d.ts:41191](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41191)
...
[ue/ue.d.ts:41189](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41189)
