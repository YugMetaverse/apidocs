[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_DelegateSet

# Class: K2Node\_DelegateSet

[ue/ue](../modules/ue_ue.md).K2Node_DelegateSet
...
- [constructor](ue_ue.K2Node_DelegateSet.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_DelegateSet.md#advancedpindisplay)
- [DelegatePropertyClass](ue_ue.K2Node_DelegateSet.md#delegatepropertyclass)
- [DelegatePropertyName](ue_ue.K2Node_DelegateSet.md#delegatepropertyname)
- [DeprecatedPins](ue_ue.K2Node_DelegateSet.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_DelegateSet.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_DelegateSet.md#errormsg)
- [ErrorType](ue_ue.K2Node_DelegateSet.md#errortype)
- [NodeComment](ue_ue.K2Node_DelegateSet.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_DelegateSet.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_DelegateSet.md#nodeheight)
- [NodePosX](ue_ue.K2Node_DelegateSet.md#nodeposx)
- [NodePosY](ue_ue.K2Node_DelegateSet.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_DelegateSet.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_DelegateSet.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_DelegateSet.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_DelegateSet\_\_](ue_ue.K2Node_DelegateSet.md#__tid_k2node_delegateset__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_DelegateSet.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_DelegateSet.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_DelegateSet.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_DelegateSet.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_DelegateSet.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_DelegateSet.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_DelegateSet.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_DelegateSet.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_DelegateSet.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_DelegateSet.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_DelegateSet.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_DelegateSet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_DelegateSet.md#executeubergraph)
- [GetClass](ue_ue.K2Node_DelegateSet.md#getclass)
- [GetName](ue_ue.K2Node_DelegateSet.md#getname)
- [GetOuter](ue_ue.K2Node_DelegateSet.md#getouter)
- [GetWorld](ue_ue.K2Node_DelegateSet.md#getworld)
- [Find](ue_ue.K2Node_DelegateSet.md#find)
- [Load](ue_ue.K2Node_DelegateSet.md#load)
- [StaticClass](ue_ue.K2Node_DelegateSet.md#staticclass)

## Constructors

### constructor

• **new K2Node_DelegateSet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41197](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41197)
...
• **DelegatePropertyClass**: [`Class`](ue_ue.Class.md)

#### Defined in

[ue/ue.d.ts:41199](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41199)
...
[ue/ue.d.ts:41198](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41198)
...
### \_\_tid\_K2Node\_DelegateSet\_\_

• **\_\_tid\_K2Node\_DelegateSet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41204](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41204)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_DelegateSet`](ue_ue.K2Node_DelegateSet.md)
...
[ue/ue.d.ts:41201](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41201)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_DelegateSet`](ue_ue.K2Node_DelegateSet.md)
...
[ue/ue.d.ts:41202](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41202)
...
[ue/ue.d.ts:41200](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41200)
