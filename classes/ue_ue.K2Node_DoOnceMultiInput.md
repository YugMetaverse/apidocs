[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_DoOnceMultiInput

# Class: K2Node\_DoOnceMultiInput

[ue/ue](../modules/ue_ue.md).K2Node_DoOnceMultiInput
...
- [constructor](ue_ue.K2Node_DoOnceMultiInput.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_DoOnceMultiInput.md#advancedpindisplay)
- [DataNode](ue_ue.K2Node_DoOnceMultiInput.md#datanode)
- [DeprecatedPins](ue_ue.K2Node_DoOnceMultiInput.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_DoOnceMultiInput.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_DoOnceMultiInput.md#errormsg)
- [ErrorType](ue_ue.K2Node_DoOnceMultiInput.md#errortype)
- [NodeComment](ue_ue.K2Node_DoOnceMultiInput.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_DoOnceMultiInput.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_DoOnceMultiInput.md#nodeheight)
- [NodePosX](ue_ue.K2Node_DoOnceMultiInput.md#nodeposx)
- [NodePosY](ue_ue.K2Node_DoOnceMultiInput.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_DoOnceMultiInput.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_DoOnceMultiInput.md#nodewidth)
- [NumAdditionalInputs](ue_ue.K2Node_DoOnceMultiInput.md#numadditionalinputs)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_DoOnceMultiInput.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_DoOnceMultiInput\_\_](ue_ue.K2Node_DoOnceMultiInput.md#__tid_k2node_dooncemultiinput__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_DoOnceMultiInput.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_DoOnceMultiInput.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_DoOnceMultiInput.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_DoOnceMultiInput.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_DoOnceMultiInput.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_DoOnceMultiInput.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_DoOnceMultiInput.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_DoOnceMultiInput.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_DoOnceMultiInput.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_DoOnceMultiInput.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_DoOnceMultiInput.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_DoOnceMultiInput.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_DoOnceMultiInput.md#executeubergraph)
- [GetClass](ue_ue.K2Node_DoOnceMultiInput.md#getclass)
- [GetName](ue_ue.K2Node_DoOnceMultiInput.md#getname)
- [GetOuter](ue_ue.K2Node_DoOnceMultiInput.md#getouter)
- [GetWorld](ue_ue.K2Node_DoOnceMultiInput.md#getworld)
- [Find](ue_ue.K2Node_DoOnceMultiInput.md#find)
- [Load](ue_ue.K2Node_DoOnceMultiInput.md#load)
- [StaticClass](ue_ue.K2Node_DoOnceMultiInput.md#staticclass)

## Constructors

### constructor

• **new K2Node_DoOnceMultiInput**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41219](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41219)
...
• **DataNode**: [`K2Node_TemporaryVariable`](ue_ue.K2Node_TemporaryVariable.md)

#### Defined in

[ue/ue.d.ts:41221](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41221)
...
[ue/ue.d.ts:41220](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41220)
...
### \_\_tid\_K2Node\_DoOnceMultiInput\_\_

• **\_\_tid\_K2Node\_DoOnceMultiInput\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41226](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41226)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_DoOnceMultiInput`](ue_ue.K2Node_DoOnceMultiInput.md)
...
[ue/ue.d.ts:41223](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41223)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_DoOnceMultiInput`](ue_ue.K2Node_DoOnceMultiInput.md)
...
[ue/ue.d.ts:41224](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41224)
...
[ue/ue.d.ts:41222](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41222)
