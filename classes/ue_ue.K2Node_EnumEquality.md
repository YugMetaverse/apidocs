[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_EnumEquality

# Class: K2Node\_EnumEquality

[ue/ue](../modules/ue_ue.md).K2Node_EnumEquality
...
- [constructor](ue_ue.K2Node_EnumEquality.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_EnumEquality.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_EnumEquality.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_EnumEquality.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_EnumEquality.md#errormsg)
- [ErrorType](ue_ue.K2Node_EnumEquality.md#errortype)
- [NodeComment](ue_ue.K2Node_EnumEquality.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_EnumEquality.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_EnumEquality.md#nodeheight)
- [NodePosX](ue_ue.K2Node_EnumEquality.md#nodeposx)
- [NodePosY](ue_ue.K2Node_EnumEquality.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_EnumEquality.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_EnumEquality.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_EnumEquality.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_EnumEquality\_\_](ue_ue.K2Node_EnumEquality.md#__tid_k2node_enumequality__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_EnumEquality.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_EnumEquality.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_EnumEquality.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_EnumEquality.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_EnumEquality.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_EnumEquality.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_EnumEquality.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_EnumEquality.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_EnumEquality.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_EnumEquality.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_EnumEquality.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_EnumEquality.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_EnumEquality.md#executeubergraph)
- [GetClass](ue_ue.K2Node_EnumEquality.md#getclass)
- [GetName](ue_ue.K2Node_EnumEquality.md#getname)
- [GetOuter](ue_ue.K2Node_EnumEquality.md#getouter)
- [GetWorld](ue_ue.K2Node_EnumEquality.md#getworld)
- [Find](ue_ue.K2Node_EnumEquality.md#find)
- [Load](ue_ue.K2Node_EnumEquality.md#load)
- [StaticClass](ue_ue.K2Node_EnumEquality.md#staticclass)

## Constructors

### constructor

• **new K2Node_EnumEquality**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41240](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41240)
...
[ue/ue.d.ts:41245](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41245)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_EnumEquality`](ue_ue.K2Node_EnumEquality.md)
...
[ue/ue.d.ts:41242](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41242)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_EnumEquality`](ue_ue.K2Node_EnumEquality.md)
...
[ue/ue.d.ts:41243](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41243)
...
[ue/ue.d.ts:41241](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41241)
