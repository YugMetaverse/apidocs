[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_EnumLiteral

# Class: K2Node\_EnumLiteral

[ue/ue](../modules/ue_ue.md).K2Node_EnumLiteral
...
- [constructor](ue_ue.K2Node_EnumLiteral.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_EnumLiteral.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_EnumLiteral.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_EnumLiteral.md#enabledstate)
- [Enum](ue_ue.K2Node_EnumLiteral.md#enum)
- [ErrorMsg](ue_ue.K2Node_EnumLiteral.md#errormsg)
- [ErrorType](ue_ue.K2Node_EnumLiteral.md#errortype)
- [NodeComment](ue_ue.K2Node_EnumLiteral.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_EnumLiteral.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_EnumLiteral.md#nodeheight)
- [NodePosX](ue_ue.K2Node_EnumLiteral.md#nodeposx)
- [NodePosY](ue_ue.K2Node_EnumLiteral.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_EnumLiteral.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_EnumLiteral.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_EnumLiteral.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_EnumLiteral\_\_](ue_ue.K2Node_EnumLiteral.md#__tid_k2node_enumliteral__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_EnumLiteral.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_EnumLiteral.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_EnumLiteral.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_EnumLiteral.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_EnumLiteral.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_EnumLiteral.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_EnumLiteral.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_EnumLiteral.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_EnumLiteral.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_EnumLiteral.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_EnumLiteral.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_EnumLiteral.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_EnumLiteral.md#executeubergraph)
- [GetClass](ue_ue.K2Node_EnumLiteral.md#getclass)
- [GetName](ue_ue.K2Node_EnumLiteral.md#getname)
- [GetOuter](ue_ue.K2Node_EnumLiteral.md#getouter)
- [GetWorld](ue_ue.K2Node_EnumLiteral.md#getworld)
- [Find](ue_ue.K2Node_EnumLiteral.md#find)
- [Load](ue_ue.K2Node_EnumLiteral.md#load)
- [StaticClass](ue_ue.K2Node_EnumLiteral.md#staticclass)

## Constructors

### constructor

• **new K2Node_EnumLiteral**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41258](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41258)
...
[ue/ue.d.ts:41259](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41259)
...
### \_\_tid\_K2Node\_EnumLiteral\_\_

• **\_\_tid\_K2Node\_EnumLiteral\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41264](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41264)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_EnumLiteral`](ue_ue.K2Node_EnumLiteral.md)
...
[ue/ue.d.ts:41261](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41261)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_EnumLiteral`](ue_ue.K2Node_EnumLiteral.md)
...
[ue/ue.d.ts:41262](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41262)
...
[ue/ue.d.ts:41260](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41260)
