[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_ExecutionSequence

# Class: K2Node\_ExecutionSequence

[ue/ue](../modules/ue_ue.md).K2Node_ExecutionSequence
...
- [constructor](ue_ue.K2Node_ExecutionSequence.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_ExecutionSequence.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_ExecutionSequence.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_ExecutionSequence.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_ExecutionSequence.md#errormsg)
- [ErrorType](ue_ue.K2Node_ExecutionSequence.md#errortype)
- [NodeComment](ue_ue.K2Node_ExecutionSequence.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_ExecutionSequence.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_ExecutionSequence.md#nodeheight)
- [NodePosX](ue_ue.K2Node_ExecutionSequence.md#nodeposx)
- [NodePosY](ue_ue.K2Node_ExecutionSequence.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_ExecutionSequence.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_ExecutionSequence.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_ExecutionSequence.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_ExecutionSequence\_\_](ue_ue.K2Node_ExecutionSequence.md#__tid_k2node_executionsequence__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_ExecutionSequence.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_ExecutionSequence.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_ExecutionSequence.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_ExecutionSequence.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_ExecutionSequence.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_ExecutionSequence.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_ExecutionSequence.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_ExecutionSequence.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_ExecutionSequence.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_ExecutionSequence.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_ExecutionSequence.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_ExecutionSequence.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_ExecutionSequence.md#executeubergraph)
- [GetClass](ue_ue.K2Node_ExecutionSequence.md#getclass)
- [GetName](ue_ue.K2Node_ExecutionSequence.md#getname)
- [GetOuter](ue_ue.K2Node_ExecutionSequence.md#getouter)
- [GetWorld](ue_ue.K2Node_ExecutionSequence.md#getworld)
- [Find](ue_ue.K2Node_ExecutionSequence.md#find)
- [Load](ue_ue.K2Node_ExecutionSequence.md#load)
- [StaticClass](ue_ue.K2Node_ExecutionSequence.md#staticclass)

## Constructors

### constructor

• **new K2Node_ExecutionSequence**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41277](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41277)
...
[ue/ue.d.ts:41282](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41282)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_ExecutionSequence`](ue_ue.K2Node_ExecutionSequence.md)
...
[ue/ue.d.ts:41279](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41279)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_ExecutionSequence`](ue_ue.K2Node_ExecutionSequence.md)
...
[ue/ue.d.ts:41280](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41280)
...
[ue/ue.d.ts:41278](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41278)
