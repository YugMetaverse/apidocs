[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_GetArrayItem

# Class: K2Node\_GetArrayItem

[ue/ue](../modules/ue_ue.md).K2Node_GetArrayItem
...
- [constructor](ue_ue.K2Node_GetArrayItem.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_GetArrayItem.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_GetArrayItem.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_GetArrayItem.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_GetArrayItem.md#errormsg)
- [ErrorType](ue_ue.K2Node_GetArrayItem.md#errortype)
- [NodeComment](ue_ue.K2Node_GetArrayItem.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_GetArrayItem.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_GetArrayItem.md#nodeheight)
- [NodePosX](ue_ue.K2Node_GetArrayItem.md#nodeposx)
- [NodePosY](ue_ue.K2Node_GetArrayItem.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_GetArrayItem.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_GetArrayItem.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_GetArrayItem.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_GetArrayItem\_\_](ue_ue.K2Node_GetArrayItem.md#__tid_k2node_getarrayitem__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_GetArrayItem.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_GetArrayItem.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_GetArrayItem.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_GetArrayItem.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_GetArrayItem.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_GetArrayItem.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_GetArrayItem.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_GetArrayItem.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_GetArrayItem.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_GetArrayItem.md#bisnodeenabled)
- [bReturnByRefDesired](ue_ue.K2Node_GetArrayItem.md#breturnbyrefdesired)
- [bUserSetEnabledState](ue_ue.K2Node_GetArrayItem.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_GetArrayItem.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_GetArrayItem.md#executeubergraph)
- [GetClass](ue_ue.K2Node_GetArrayItem.md#getclass)
- [GetName](ue_ue.K2Node_GetArrayItem.md#getname)
- [GetOuter](ue_ue.K2Node_GetArrayItem.md#getouter)
- [GetWorld](ue_ue.K2Node_GetArrayItem.md#getworld)
- [Find](ue_ue.K2Node_GetArrayItem.md#find)
- [Load](ue_ue.K2Node_GetArrayItem.md#load)
- [StaticClass](ue_ue.K2Node_GetArrayItem.md#staticclass)

## Constructors

### constructor

• **new K2Node_GetArrayItem**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41350](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41350)
...
### \_\_tid\_K2Node\_GetArrayItem\_\_

• **\_\_tid\_K2Node\_GetArrayItem\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41356](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41356)
...
[ue/ue.d.ts:41351](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41351)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_GetArrayItem`](ue_ue.K2Node_GetArrayItem.md)
...
[ue/ue.d.ts:41353](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41353)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_GetArrayItem`](ue_ue.K2Node_GetArrayItem.md)
...
[ue/ue.d.ts:41354](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41354)
...
[ue/ue.d.ts:41352](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41352)
