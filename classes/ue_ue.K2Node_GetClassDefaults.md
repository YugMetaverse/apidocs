[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_GetClassDefaults

# Class: K2Node\_GetClassDefaults

[ue/ue](../modules/ue_ue.md).K2Node_GetClassDefaults
...
- [constructor](ue_ue.K2Node_GetClassDefaults.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_GetClassDefaults.md#advancedpindisplay)
- [BlueprintSubscribedTo](ue_ue.K2Node_GetClassDefaults.md#blueprintsubscribedto)
- [DeprecatedPins](ue_ue.K2Node_GetClassDefaults.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_GetClassDefaults.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_GetClassDefaults.md#errormsg)
- [ErrorType](ue_ue.K2Node_GetClassDefaults.md#errortype)
- [NodeComment](ue_ue.K2Node_GetClassDefaults.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_GetClassDefaults.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_GetClassDefaults.md#nodeheight)
- [NodePosX](ue_ue.K2Node_GetClassDefaults.md#nodeposx)
- [NodePosY](ue_ue.K2Node_GetClassDefaults.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_GetClassDefaults.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_GetClassDefaults.md#nodewidth)
- [ShowPinForProperties](ue_ue.K2Node_GetClassDefaults.md#showpinforproperties)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_GetClassDefaults.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_GetClassDefaults\_\_](ue_ue.K2Node_GetClassDefaults.md#__tid_k2node_getclassdefaults__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_GetClassDefaults.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_GetClassDefaults.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_GetClassDefaults.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_GetClassDefaults.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_GetClassDefaults.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_GetClassDefaults.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_GetClassDefaults.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_GetClassDefaults.md#bdisplayasdisabled)
- [bExcludeObjectArrays](ue_ue.K2Node_GetClassDefaults.md#bexcludeobjectarrays)
- [bExcludeObjectContainers](ue_ue.K2Node_GetClassDefaults.md#bexcludeobjectcontainers)
- [bHasCompilerMessage](ue_ue.K2Node_GetClassDefaults.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_GetClassDefaults.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_GetClassDefaults.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_GetClassDefaults.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_GetClassDefaults.md#executeubergraph)
- [GetClass](ue_ue.K2Node_GetClassDefaults.md#getclass)
- [GetName](ue_ue.K2Node_GetClassDefaults.md#getname)
- [GetOuter](ue_ue.K2Node_GetClassDefaults.md#getouter)
- [GetWorld](ue_ue.K2Node_GetClassDefaults.md#getworld)
- [Find](ue_ue.K2Node_GetClassDefaults.md#find)
- [Load](ue_ue.K2Node_GetClassDefaults.md#load)
- [StaticClass](ue_ue.K2Node_GetClassDefaults.md#staticclass)

## Constructors

### constructor

• **new K2Node_GetClassDefaults**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41360](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41360)
...
### BlueprintSubscribedTo

• **BlueprintSubscribedTo**: [`Blueprint`](ue_ue.Blueprint.md)

#### Defined in

[ue/ue.d.ts:41361](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41361)
...
[ue/ue.d.ts:41362](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41362)
...
### \_\_tid\_K2Node\_GetClassDefaults\_\_

• **\_\_tid\_K2Node\_GetClassDefaults\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41369](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41369)
...
### bExcludeObjectArrays

• **bExcludeObjectArrays**: `boolean`

#### Defined in

[ue/ue.d.ts:41364](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41364)

___

### bExcludeObjectContainers

• **bExcludeObjectContainers**: `boolean`

#### Defined in

[ue/ue.d.ts:41363](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41363)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_GetClassDefaults`](ue_ue.K2Node_GetClassDefaults.md)
...
[ue/ue.d.ts:41366](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41366)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_GetClassDefaults`](ue_ue.K2Node_GetClassDefaults.md)
...
[ue/ue.d.ts:41367](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41367)
...
[ue/ue.d.ts:41365](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41365)
