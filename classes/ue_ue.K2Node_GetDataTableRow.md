[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_GetDataTableRow

# Class: K2Node\_GetDataTableRow

[ue/ue](../modules/ue_ue.md).K2Node_GetDataTableRow
...
- [constructor](ue_ue.K2Node_GetDataTableRow.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_GetDataTableRow.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_GetDataTableRow.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_GetDataTableRow.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_GetDataTableRow.md#errormsg)
- [ErrorType](ue_ue.K2Node_GetDataTableRow.md#errortype)
- [NodeComment](ue_ue.K2Node_GetDataTableRow.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_GetDataTableRow.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_GetDataTableRow.md#nodeheight)
- [NodePosX](ue_ue.K2Node_GetDataTableRow.md#nodeposx)
- [NodePosY](ue_ue.K2Node_GetDataTableRow.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_GetDataTableRow.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_GetDataTableRow.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_GetDataTableRow.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_GetDataTableRow\_\_](ue_ue.K2Node_GetDataTableRow.md#__tid_k2node_getdatatablerow__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_GetDataTableRow.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_GetDataTableRow.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_GetDataTableRow.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_GetDataTableRow.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_GetDataTableRow.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_GetDataTableRow.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_GetDataTableRow.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_GetDataTableRow.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_GetDataTableRow.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_GetDataTableRow.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_GetDataTableRow.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_GetDataTableRow.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_GetDataTableRow.md#executeubergraph)
- [GetClass](ue_ue.K2Node_GetDataTableRow.md#getclass)
- [GetName](ue_ue.K2Node_GetDataTableRow.md#getname)
- [GetOuter](ue_ue.K2Node_GetDataTableRow.md#getouter)
- [GetWorld](ue_ue.K2Node_GetDataTableRow.md#getworld)
- [Find](ue_ue.K2Node_GetDataTableRow.md#find)
- [Load](ue_ue.K2Node_GetDataTableRow.md#load)
- [StaticClass](ue_ue.K2Node_GetDataTableRow.md#staticclass)

## Constructors

### constructor

• **new K2Node_GetDataTableRow**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41373](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41373)
...
### \_\_tid\_K2Node\_GetDataTableRow\_\_

• **\_\_tid\_K2Node\_GetDataTableRow\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41378](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41378)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_GetDataTableRow`](ue_ue.K2Node_GetDataTableRow.md)
...
[ue/ue.d.ts:41375](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41375)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_GetDataTableRow`](ue_ue.K2Node_GetDataTableRow.md)
...
[ue/ue.d.ts:41376](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41376)
...
[ue/ue.d.ts:41374](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41374)
