[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_GetEnumeratorName

# Class: K2Node\_GetEnumeratorName

[ue/ue](../modules/ue_ue.md).K2Node_GetEnumeratorName
...
- [constructor](ue_ue.K2Node_GetEnumeratorName.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_GetEnumeratorName.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_GetEnumeratorName.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_GetEnumeratorName.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_GetEnumeratorName.md#errormsg)
- [ErrorType](ue_ue.K2Node_GetEnumeratorName.md#errortype)
- [NodeComment](ue_ue.K2Node_GetEnumeratorName.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_GetEnumeratorName.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_GetEnumeratorName.md#nodeheight)
- [NodePosX](ue_ue.K2Node_GetEnumeratorName.md#nodeposx)
- [NodePosY](ue_ue.K2Node_GetEnumeratorName.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_GetEnumeratorName.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_GetEnumeratorName.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_GetEnumeratorName.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_GetEnumeratorName\_\_](ue_ue.K2Node_GetEnumeratorName.md#__tid_k2node_getenumeratorname__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_GetEnumeratorName.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_GetEnumeratorName.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_GetEnumeratorName.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_GetEnumeratorName.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_GetEnumeratorName.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_GetEnumeratorName.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_GetEnumeratorName.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_GetEnumeratorName.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_GetEnumeratorName.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_GetEnumeratorName.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_GetEnumeratorName.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_GetEnumeratorName.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_GetEnumeratorName.md#executeubergraph)
- [GetClass](ue_ue.K2Node_GetEnumeratorName.md#getclass)
- [GetName](ue_ue.K2Node_GetEnumeratorName.md#getname)
- [GetOuter](ue_ue.K2Node_GetEnumeratorName.md#getouter)
- [GetWorld](ue_ue.K2Node_GetEnumeratorName.md#getworld)
- [Find](ue_ue.K2Node_GetEnumeratorName.md#find)
- [Load](ue_ue.K2Node_GetEnumeratorName.md#load)
- [StaticClass](ue_ue.K2Node_GetEnumeratorName.md#staticclass)

## Constructors

### constructor

• **new K2Node_GetEnumeratorName**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41410](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41410)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_GetEnumeratorName`](ue_ue.K2Node_GetEnumeratorName.md)
...
[ue/ue.d.ts:41412](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41412)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_GetEnumeratorName`](ue_ue.K2Node_GetEnumeratorName.md)
...
[ue/ue.d.ts:41413](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41413)
...
[ue/ue.d.ts:41411](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41411)
