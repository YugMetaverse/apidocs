[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_GetSubsystem

# Class: K2Node\_GetSubsystem

[ue/ue](../modules/ue_ue.md).K2Node_GetSubsystem
...
- [constructor](ue_ue.K2Node_GetSubsystem.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_GetSubsystem.md#advancedpindisplay)
- [CustomClass](ue_ue.K2Node_GetSubsystem.md#customclass)
- [DeprecatedPins](ue_ue.K2Node_GetSubsystem.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_GetSubsystem.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_GetSubsystem.md#errormsg)
- [ErrorType](ue_ue.K2Node_GetSubsystem.md#errortype)
- [NodeComment](ue_ue.K2Node_GetSubsystem.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_GetSubsystem.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_GetSubsystem.md#nodeheight)
- [NodePosX](ue_ue.K2Node_GetSubsystem.md#nodeposx)
- [NodePosY](ue_ue.K2Node_GetSubsystem.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_GetSubsystem.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_GetSubsystem.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_GetSubsystem.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_GetSubsystem\_\_](ue_ue.K2Node_GetSubsystem.md#__tid_k2node_getsubsystem__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_GetSubsystem.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_GetSubsystem.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_GetSubsystem.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_GetSubsystem.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_GetSubsystem.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_GetSubsystem.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_GetSubsystem.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_GetSubsystem.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_GetSubsystem.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_GetSubsystem.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_GetSubsystem.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_GetSubsystem.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_GetSubsystem.md#executeubergraph)
- [GetClass](ue_ue.K2Node_GetSubsystem.md#getclass)
- [GetName](ue_ue.K2Node_GetSubsystem.md#getname)
- [GetOuter](ue_ue.K2Node_GetSubsystem.md#getouter)
- [GetWorld](ue_ue.K2Node_GetSubsystem.md#getworld)
- [Find](ue_ue.K2Node_GetSubsystem.md#find)
- [Load](ue_ue.K2Node_GetSubsystem.md#load)
- [StaticClass](ue_ue.K2Node_GetSubsystem.md#staticclass)

## Constructors

### constructor

• **new K2Node_GetSubsystem**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41382](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41382)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_GetSubsystem`](ue_ue.K2Node_GetSubsystem.md)
...
[ue/ue.d.ts:41385](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41385)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_GetSubsystem`](ue_ue.K2Node_GetSubsystem.md)
...
[ue/ue.d.ts:41386](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41386)
...
[ue/ue.d.ts:41384](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41384)
