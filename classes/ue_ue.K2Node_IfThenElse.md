[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_IfThenElse

# Class: K2Node\_IfThenElse

[ue/ue](../modules/ue_ue.md).K2Node_IfThenElse
...
- [constructor](ue_ue.K2Node_IfThenElse.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_IfThenElse.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_IfThenElse.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_IfThenElse.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_IfThenElse.md#errormsg)
- [ErrorType](ue_ue.K2Node_IfThenElse.md#errortype)
- [NodeComment](ue_ue.K2Node_IfThenElse.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_IfThenElse.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_IfThenElse.md#nodeheight)
- [NodePosX](ue_ue.K2Node_IfThenElse.md#nodeposx)
- [NodePosY](ue_ue.K2Node_IfThenElse.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_IfThenElse.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_IfThenElse.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_IfThenElse.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_IfThenElse\_\_](ue_ue.K2Node_IfThenElse.md#__tid_k2node_ifthenelse__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_IfThenElse.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_IfThenElse.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_IfThenElse.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_IfThenElse.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_IfThenElse.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_IfThenElse.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_IfThenElse.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_IfThenElse.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_IfThenElse.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_IfThenElse.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_IfThenElse.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_IfThenElse.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_IfThenElse.md#executeubergraph)
- [GetClass](ue_ue.K2Node_IfThenElse.md#getclass)
- [GetName](ue_ue.K2Node_IfThenElse.md#getname)
- [GetOuter](ue_ue.K2Node_IfThenElse.md#getouter)
- [GetWorld](ue_ue.K2Node_IfThenElse.md#getworld)
- [Find](ue_ue.K2Node_IfThenElse.md#find)
- [Load](ue_ue.K2Node_IfThenElse.md#load)
- [StaticClass](ue_ue.K2Node_IfThenElse.md#staticclass)

## Constructors

### constructor

• **new K2Node_IfThenElse**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41491](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41491)
...
### \_\_tid\_K2Node\_IfThenElse\_\_

• **\_\_tid\_K2Node\_IfThenElse\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41496](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41496)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_IfThenElse`](ue_ue.K2Node_IfThenElse.md)
...
[ue/ue.d.ts:41493](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41493)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_IfThenElse`](ue_ue.K2Node_IfThenElse.md)
...
[ue/ue.d.ts:41494](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41494)
...
[ue/ue.d.ts:41492](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L41492)
