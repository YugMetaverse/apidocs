[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_MakeContainer

# Class: K2Node\_MakeContainer

[ue/ue](../modules/ue_ue.md).K2Node_MakeContainer
...
- [constructor](ue_ue.K2Node_MakeContainer.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_MakeContainer.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_MakeContainer.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_MakeContainer.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_MakeContainer.md#errormsg)
- [ErrorType](ue_ue.K2Node_MakeContainer.md#errortype)
- [NodeComment](ue_ue.K2Node_MakeContainer.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_MakeContainer.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_MakeContainer.md#nodeheight)
- [NodePosX](ue_ue.K2Node_MakeContainer.md#nodeposx)
- [NodePosY](ue_ue.K2Node_MakeContainer.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_MakeContainer.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_MakeContainer.md#nodewidth)
- [NumInputs](ue_ue.K2Node_MakeContainer.md#numinputs)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_MakeContainer.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_MakeContainer\_\_](ue_ue.K2Node_MakeContainer.md#__tid_k2node_makecontainer__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_MakeContainer.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_MakeContainer.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_MakeContainer.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_MakeContainer.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_MakeContainer.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_MakeContainer.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_MakeContainer.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_MakeContainer.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_MakeContainer.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_MakeContainer.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_MakeContainer.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_MakeContainer.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_MakeContainer.md#executeubergraph)
- [GetClass](ue_ue.K2Node_MakeContainer.md#getclass)
- [GetName](ue_ue.K2Node_MakeContainer.md#getname)
- [GetOuter](ue_ue.K2Node_MakeContainer.md#getouter)
- [GetWorld](ue_ue.K2Node_MakeContainer.md#getworld)
- [Find](ue_ue.K2Node_MakeContainer.md#find)
- [Load](ue_ue.K2Node_MakeContainer.md#load)
- [StaticClass](ue_ue.K2Node_MakeContainer.md#staticclass)

## Constructors

### constructor

• **new K2Node_MakeContainer**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41756](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41756)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_MakeContainer`](ue_ue.K2Node_MakeContainer.md)
...
[ue/ue.d.ts:41759](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41759)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_MakeContainer`](ue_ue.K2Node_MakeContainer.md)
...
[ue/ue.d.ts:41760](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41760)
...
[ue/ue.d.ts:41758](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41758)
