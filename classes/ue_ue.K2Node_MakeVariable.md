[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_MakeVariable

# Class: K2Node\_MakeVariable

[ue/ue](../modules/ue_ue.md).K2Node_MakeVariable
...
- [constructor](ue_ue.K2Node_MakeVariable.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_MakeVariable.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_MakeVariable.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_MakeVariable.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_MakeVariable.md#errormsg)
- [ErrorType](ue_ue.K2Node_MakeVariable.md#errortype)
- [NodeComment](ue_ue.K2Node_MakeVariable.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_MakeVariable.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_MakeVariable.md#nodeheight)
- [NodePosX](ue_ue.K2Node_MakeVariable.md#nodeposx)
- [NodePosY](ue_ue.K2Node_MakeVariable.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_MakeVariable.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_MakeVariable.md#nodewidth)
- [VariableType](ue_ue.K2Node_MakeVariable.md#variabletype)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_MakeVariable.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_MakeVariable\_\_](ue_ue.K2Node_MakeVariable.md#__tid_k2node_makevariable__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_MakeVariable.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_MakeVariable.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_MakeVariable.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_MakeVariable.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_MakeVariable.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_MakeVariable.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_MakeVariable.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_MakeVariable.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_MakeVariable.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_MakeVariable.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_MakeVariable.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_MakeVariable.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_MakeVariable.md#executeubergraph)
- [GetClass](ue_ue.K2Node_MakeVariable.md#getclass)
- [GetName](ue_ue.K2Node_MakeVariable.md#getname)
- [GetOuter](ue_ue.K2Node_MakeVariable.md#getouter)
- [GetWorld](ue_ue.K2Node_MakeVariable.md#getworld)
- [Find](ue_ue.K2Node_MakeVariable.md#find)
- [Load](ue_ue.K2Node_MakeVariable.md#load)
- [StaticClass](ue_ue.K2Node_MakeVariable.md#staticclass)

## Constructors

### constructor

• **new K2Node_MakeVariable**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41813](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41813)
...
• **VariableType**: [`BPVariableDescription`](ue_ue.BPVariableDescription.md)

#### Defined in

[ue/ue.d.ts:41814](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41814)
...
### \_\_tid\_K2Node\_MakeVariable\_\_

• **\_\_tid\_K2Node\_MakeVariable\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41819](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41819)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_MakeVariable`](ue_ue.K2Node_MakeVariable.md)
...
[ue/ue.d.ts:41816](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41816)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_MakeVariable`](ue_ue.K2Node_MakeVariable.md)
...
[ue/ue.d.ts:41817](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41817)
...
[ue/ue.d.ts:41815](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41815)
