[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_PlayAnimation

# Class: K2Node\_PlayAnimation

[ue/ue](../modules/ue_ue.md).K2Node_PlayAnimation

## Hierarchy

- [`K2Node_BaseAsyncTask`](ue_ue.K2Node_BaseAsyncTask.md)

  ↳ **`K2Node_PlayAnimation`**

## Table of contents

### Constructors

- [constructor](ue_ue.K2Node_PlayAnimation.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_PlayAnimation.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_PlayAnimation.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_PlayAnimation.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_PlayAnimation.md#errormsg)
- [ErrorType](ue_ue.K2Node_PlayAnimation.md#errortype)
- [NodeComment](ue_ue.K2Node_PlayAnimation.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_PlayAnimation.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_PlayAnimation.md#nodeheight)
- [NodePosX](ue_ue.K2Node_PlayAnimation.md#nodeposx)
- [NodePosY](ue_ue.K2Node_PlayAnimation.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_PlayAnimation.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_PlayAnimation.md#nodewidth)
- [ProxyActivateFunctionName](ue_ue.K2Node_PlayAnimation.md#proxyactivatefunctionname)
- [ProxyClass](ue_ue.K2Node_PlayAnimation.md#proxyclass)
- [ProxyFactoryClass](ue_ue.K2Node_PlayAnimation.md#proxyfactoryclass)
- [ProxyFactoryFunctionName](ue_ue.K2Node_PlayAnimation.md#proxyfactoryfunctionname)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_PlayAnimation.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseAsyncTask\_\_](ue_ue.K2Node_PlayAnimation.md#__tid_k2node_baseasynctask__)
- [\_\_tid\_K2Node\_PlayAnimation\_\_](ue_ue.K2Node_PlayAnimation.md#__tid_k2node_playanimation__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_PlayAnimation.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_PlayAnimation.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_PlayAnimation.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_PlayAnimation.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_PlayAnimation.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_PlayAnimation.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_PlayAnimation.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_PlayAnimation.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_PlayAnimation.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_PlayAnimation.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_PlayAnimation.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_PlayAnimation.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_PlayAnimation.md#executeubergraph)
- [GetClass](ue_ue.K2Node_PlayAnimation.md#getclass)
- [GetName](ue_ue.K2Node_PlayAnimation.md#getname)
- [GetOuter](ue_ue.K2Node_PlayAnimation.md#getouter)
- [GetWorld](ue_ue.K2Node_PlayAnimation.md#getworld)
- [Find](ue_ue.K2Node_PlayAnimation.md#find)
- [Load](ue_ue.K2Node_PlayAnimation.md#load)
- [StaticClass](ue_ue.K2Node_PlayAnimation.md#staticclass)

## Constructors

### constructor

• **new K2Node_PlayAnimation**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41863](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41863)
...
### \_\_tid\_K2Node\_PlayAnimation\_\_

• **\_\_tid\_K2Node\_PlayAnimation\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41868](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41868)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_PlayAnimation`](ue_ue.K2Node_PlayAnimation.md)
...
[ue/ue.d.ts:41865](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41865)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_PlayAnimation`](ue_ue.K2Node_PlayAnimation.md)
...
[ue/ue.d.ts:41866](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41866)
...
[ue/ue.d.ts:41864](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41864)
