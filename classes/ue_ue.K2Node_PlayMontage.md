[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_PlayMontage

# Class: K2Node\_PlayMontage

[ue/ue](../modules/ue_ue.md).K2Node_PlayMontage
...
- [constructor](ue_ue.K2Node_PlayMontage.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_PlayMontage.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_PlayMontage.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_PlayMontage.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_PlayMontage.md#errormsg)
- [ErrorType](ue_ue.K2Node_PlayMontage.md#errortype)
- [NodeComment](ue_ue.K2Node_PlayMontage.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_PlayMontage.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_PlayMontage.md#nodeheight)
- [NodePosX](ue_ue.K2Node_PlayMontage.md#nodeposx)
- [NodePosY](ue_ue.K2Node_PlayMontage.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_PlayMontage.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_PlayMontage.md#nodewidth)
- [ProxyActivateFunctionName](ue_ue.K2Node_PlayMontage.md#proxyactivatefunctionname)
- [ProxyClass](ue_ue.K2Node_PlayMontage.md#proxyclass)
- [ProxyFactoryClass](ue_ue.K2Node_PlayMontage.md#proxyfactoryclass)
- [ProxyFactoryFunctionName](ue_ue.K2Node_PlayMontage.md#proxyfactoryfunctionname)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_PlayMontage.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_BaseAsyncTask\_\_](ue_ue.K2Node_PlayMontage.md#__tid_k2node_baseasynctask__)
- [\_\_tid\_K2Node\_PlayMontage\_\_](ue_ue.K2Node_PlayMontage.md#__tid_k2node_playmontage__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_PlayMontage.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_PlayMontage.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_PlayMontage.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_PlayMontage.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_PlayMontage.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_PlayMontage.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_PlayMontage.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_PlayMontage.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_PlayMontage.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_PlayMontage.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_PlayMontage.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_PlayMontage.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_PlayMontage.md#executeubergraph)
- [GetClass](ue_ue.K2Node_PlayMontage.md#getclass)
- [GetName](ue_ue.K2Node_PlayMontage.md#getname)
- [GetOuter](ue_ue.K2Node_PlayMontage.md#getouter)
- [GetWorld](ue_ue.K2Node_PlayMontage.md#getworld)
- [Find](ue_ue.K2Node_PlayMontage.md#find)
- [Load](ue_ue.K2Node_PlayMontage.md#load)
- [StaticClass](ue_ue.K2Node_PlayMontage.md#staticclass)

## Constructors

### constructor

• **new K2Node_PlayMontage**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41881](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41881)
...
### \_\_tid\_K2Node\_PlayMontage\_\_

• **\_\_tid\_K2Node\_PlayMontage\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41886](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41886)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_PlayMontage`](ue_ue.K2Node_PlayMontage.md)
...
[ue/ue.d.ts:41883](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41883)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_PlayMontage`](ue_ue.K2Node_PlayMontage.md)
...
[ue/ue.d.ts:41884](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41884)
...
[ue/ue.d.ts:41882](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41882)
