[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_PureAssignmentStatement

# Class: K2Node\_PureAssignmentStatement

[ue/ue](../modules/ue_ue.md).K2Node_PureAssignmentStatement
...
- [constructor](ue_ue.K2Node_PureAssignmentStatement.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_PureAssignmentStatement.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_PureAssignmentStatement.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_PureAssignmentStatement.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_PureAssignmentStatement.md#errormsg)
- [ErrorType](ue_ue.K2Node_PureAssignmentStatement.md#errortype)
- [NodeComment](ue_ue.K2Node_PureAssignmentStatement.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_PureAssignmentStatement.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_PureAssignmentStatement.md#nodeheight)
- [NodePosX](ue_ue.K2Node_PureAssignmentStatement.md#nodeposx)
- [NodePosY](ue_ue.K2Node_PureAssignmentStatement.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_PureAssignmentStatement.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_PureAssignmentStatement.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_PureAssignmentStatement.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_PureAssignmentStatement\_\_](ue_ue.K2Node_PureAssignmentStatement.md#__tid_k2node_pureassignmentstatement__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_PureAssignmentStatement.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_PureAssignmentStatement.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_PureAssignmentStatement.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_PureAssignmentStatement.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_PureAssignmentStatement.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_PureAssignmentStatement.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_PureAssignmentStatement.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_PureAssignmentStatement.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_PureAssignmentStatement.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_PureAssignmentStatement.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_PureAssignmentStatement.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_PureAssignmentStatement.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_PureAssignmentStatement.md#executeubergraph)
- [GetClass](ue_ue.K2Node_PureAssignmentStatement.md#getclass)
- [GetName](ue_ue.K2Node_PureAssignmentStatement.md#getname)
- [GetOuter](ue_ue.K2Node_PureAssignmentStatement.md#getouter)
- [GetWorld](ue_ue.K2Node_PureAssignmentStatement.md#getworld)
- [Find](ue_ue.K2Node_PureAssignmentStatement.md#find)
- [Load](ue_ue.K2Node_PureAssignmentStatement.md#load)
- [StaticClass](ue_ue.K2Node_PureAssignmentStatement.md#staticclass)

## Constructors

### constructor

• **new K2Node_PureAssignmentStatement**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41890](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41890)
...
### \_\_tid\_K2Node\_PureAssignmentStatement\_\_

• **\_\_tid\_K2Node\_PureAssignmentStatement\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41895](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41895)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_PureAssignmentStatement`](ue_ue.K2Node_PureAssignmentStatement.md)
...
[ue/ue.d.ts:41892](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41892)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_PureAssignmentStatement`](ue_ue.K2Node_PureAssignmentStatement.md)
...
[ue/ue.d.ts:41893](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41893)
...
[ue/ue.d.ts:41891](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41891)
