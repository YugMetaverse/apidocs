[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_SpawnActor

# Class: K2Node\_SpawnActor

[ue/ue](../modules/ue_ue.md).K2Node_SpawnActor
...
- [constructor](ue_ue.K2Node_SpawnActor.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_SpawnActor.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_SpawnActor.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_SpawnActor.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_SpawnActor.md#errormsg)
- [ErrorType](ue_ue.K2Node_SpawnActor.md#errortype)
- [NodeComment](ue_ue.K2Node_SpawnActor.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_SpawnActor.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_SpawnActor.md#nodeheight)
- [NodePosX](ue_ue.K2Node_SpawnActor.md#nodeposx)
- [NodePosY](ue_ue.K2Node_SpawnActor.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_SpawnActor.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_SpawnActor.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_SpawnActor.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_SpawnActor\_\_](ue_ue.K2Node_SpawnActor.md#__tid_k2node_spawnactor__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_SpawnActor.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_SpawnActor.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_SpawnActor.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_SpawnActor.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_SpawnActor.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_SpawnActor.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_SpawnActor.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_SpawnActor.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_SpawnActor.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_SpawnActor.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_SpawnActor.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_SpawnActor.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_SpawnActor.md#executeubergraph)
- [GetClass](ue_ue.K2Node_SpawnActor.md#getclass)
- [GetName](ue_ue.K2Node_SpawnActor.md#getname)
- [GetOuter](ue_ue.K2Node_SpawnActor.md#getouter)
- [GetWorld](ue_ue.K2Node_SpawnActor.md#getworld)
- [Find](ue_ue.K2Node_SpawnActor.md#find)
- [Load](ue_ue.K2Node_SpawnActor.md#load)
- [StaticClass](ue_ue.K2Node_SpawnActor.md#staticclass)

## Constructors

### constructor

• **new K2Node_SpawnActor**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41950](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41950)
...
### \_\_tid\_K2Node\_SpawnActor\_\_

• **\_\_tid\_K2Node\_SpawnActor\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41955](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41955)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_SpawnActor`](ue_ue.K2Node_SpawnActor.md)
...
[ue/ue.d.ts:41952](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41952)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_SpawnActor`](ue_ue.K2Node_SpawnActor.md)
...
[ue/ue.d.ts:41953](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41953)
...
[ue/ue.d.ts:41951](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41951)
