[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_SpawnActorFromClass

# Class: K2Node\_SpawnActorFromClass

[ue/ue](../modules/ue_ue.md).K2Node_SpawnActorFromClass
...
- [constructor](ue_ue.K2Node_SpawnActorFromClass.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_SpawnActorFromClass.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_SpawnActorFromClass.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_SpawnActorFromClass.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_SpawnActorFromClass.md#errormsg)
- [ErrorType](ue_ue.K2Node_SpawnActorFromClass.md#errortype)
- [NodeComment](ue_ue.K2Node_SpawnActorFromClass.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_SpawnActorFromClass.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_SpawnActorFromClass.md#nodeheight)
- [NodePosX](ue_ue.K2Node_SpawnActorFromClass.md#nodeposx)
- [NodePosY](ue_ue.K2Node_SpawnActorFromClass.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_SpawnActorFromClass.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_SpawnActorFromClass.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_SpawnActorFromClass.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_ConstructObjectFromClass\_\_](ue_ue.K2Node_SpawnActorFromClass.md#__tid_k2node_constructobjectfromclass__)
- [\_\_tid\_K2Node\_SpawnActorFromClass\_\_](ue_ue.K2Node_SpawnActorFromClass.md#__tid_k2node_spawnactorfromclass__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_SpawnActorFromClass.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_SpawnActorFromClass.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_SpawnActorFromClass.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_SpawnActorFromClass.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_SpawnActorFromClass.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_SpawnActorFromClass.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_SpawnActorFromClass.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_SpawnActorFromClass.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_SpawnActorFromClass.md#bhascompilermessage)
- [bIsNodeEnabled](ue_ue.K2Node_SpawnActorFromClass.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_SpawnActorFromClass.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_SpawnActorFromClass.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_SpawnActorFromClass.md#executeubergraph)
- [GetClass](ue_ue.K2Node_SpawnActorFromClass.md#getclass)
- [GetName](ue_ue.K2Node_SpawnActorFromClass.md#getname)
- [GetOuter](ue_ue.K2Node_SpawnActorFromClass.md#getouter)
- [GetWorld](ue_ue.K2Node_SpawnActorFromClass.md#getworld)
- [Find](ue_ue.K2Node_SpawnActorFromClass.md#find)
- [Load](ue_ue.K2Node_SpawnActorFromClass.md#load)
- [StaticClass](ue_ue.K2Node_SpawnActorFromClass.md#staticclass)

## Constructors

### constructor

• **new K2Node_SpawnActorFromClass**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:41959](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41959)
...
### \_\_tid\_K2Node\_SpawnActorFromClass\_\_

• **\_\_tid\_K2Node\_SpawnActorFromClass\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:41964](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41964)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_SpawnActorFromClass`](ue_ue.K2Node_SpawnActorFromClass.md)
...
[`K2Node_SpawnActorFromClass`](ue_ue.K2Node_SpawnActorFromClass.md)
...
[ue/ue.d.ts:41961](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41961)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_SpawnActorFromClass`](ue_ue.K2Node_SpawnActorFromClass.md)
...
[ue/ue.d.ts:41962](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41962)
...
[ue/ue.d.ts:41960](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L41960)
