[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / K2Node\_Switch

# Class: K2Node\_Switch

[ue/ue](../modules/ue_ue.md).K2Node_Switch
...
- [constructor](ue_ue.K2Node_Switch.md#constructor)

### Properties

- [AdvancedPinDisplay](ue_ue.K2Node_Switch.md#advancedpindisplay)
- [DeprecatedPins](ue_ue.K2Node_Switch.md#deprecatedpins)
- [EnabledState](ue_ue.K2Node_Switch.md#enabledstate)
- [ErrorMsg](ue_ue.K2Node_Switch.md#errormsg)
- [ErrorType](ue_ue.K2Node_Switch.md#errortype)
- [FunctionClass](ue_ue.K2Node_Switch.md#functionclass)
- [FunctionName](ue_ue.K2Node_Switch.md#functionname)
- [NodeComment](ue_ue.K2Node_Switch.md#nodecomment)
- [NodeGuid](ue_ue.K2Node_Switch.md#nodeguid)
- [NodeHeight](ue_ue.K2Node_Switch.md#nodeheight)
- [NodePosX](ue_ue.K2Node_Switch.md#nodeposx)
- [NodePosY](ue_ue.K2Node_Switch.md#nodeposy)
- [NodeUpgradeMessage](ue_ue.K2Node_Switch.md#nodeupgrademessage)
- [NodeWidth](ue_ue.K2Node_Switch.md#nodewidth)
- [\_\_tid\_EdGraphNode\_\_](ue_ue.K2Node_Switch.md#__tid_edgraphnode__)
- [\_\_tid\_K2Node\_Switch\_\_](ue_ue.K2Node_Switch.md#__tid_k2node_switch__)
- [\_\_tid\_K2Node\_\_](ue_ue.K2Node_Switch.md#__tid_k2node__)
- [\_\_tid\_Object\_\_](ue_ue.K2Node_Switch.md#__tid_object__)
- [bCanRenameNode](ue_ue.K2Node_Switch.md#bcanrenamenode)
- [bCanResizeNode](ue_ue.K2Node_Switch.md#bcanresizenode)
- [bCommentBubbleMakeVisible](ue_ue.K2Node_Switch.md#bcommentbubblemakevisible)
- [bCommentBubblePinned](ue_ue.K2Node_Switch.md#bcommentbubblepinned)
- [bCommentBubbleVisible](ue_ue.K2Node_Switch.md#bcommentbubblevisible)
- [bDisplayAsDisabled](ue_ue.K2Node_Switch.md#bdisplayasdisabled)
- [bHasCompilerMessage](ue_ue.K2Node_Switch.md#bhascompilermessage)
- [bHasDefaultPin](ue_ue.K2Node_Switch.md#bhasdefaultpin)
- [bIsNodeEnabled](ue_ue.K2Node_Switch.md#bisnodeenabled)
- [bUserSetEnabledState](ue_ue.K2Node_Switch.md#busersetenabledstate)

### Methods

- [CreateDefaultSubobject](ue_ue.K2Node_Switch.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.K2Node_Switch.md#executeubergraph)
- [GetClass](ue_ue.K2Node_Switch.md#getclass)
- [GetName](ue_ue.K2Node_Switch.md#getname)
- [GetOuter](ue_ue.K2Node_Switch.md#getouter)
- [GetWorld](ue_ue.K2Node_Switch.md#getworld)
- [Find](ue_ue.K2Node_Switch.md#find)
- [Load](ue_ue.K2Node_Switch.md#load)
- [StaticClass](ue_ue.K2Node_Switch.md#staticclass)

## Constructors

### constructor

• **new K2Node_Switch**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:37055](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37055)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`K2Node_Switch`](ue_ue.K2Node_Switch.md)
...
[ue/ue.d.ts:37060](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37060)

___

### Load

▸ `Static` **Load**(`InName`): [`K2Node_Switch`](ue_ue.K2Node_Switch.md)
...
[ue/ue.d.ts:37061](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37061)
...
[ue/ue.d.ts:37059](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L37059)
