[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / LandscapeGrassTypeFactory

# Class: LandscapeGrassTypeFactory

[ue/ue](../modules/ue_ue.md).LandscapeGrassTypeFactory
...
- [constructor](ue_ue.LandscapeGrassTypeFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.LandscapeGrassTypeFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.LandscapeGrassTypeFactory.md#automatedimportdata)
- [ContextClass](ue_ue.LandscapeGrassTypeFactory.md#contextclass)
- [Formats](ue_ue.LandscapeGrassTypeFactory.md#formats)
- [ImportPriority](ue_ue.LandscapeGrassTypeFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.LandscapeGrassTypeFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.LandscapeGrassTypeFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.LandscapeGrassTypeFactory.md#__tid_factory__)
- [\_\_tid\_LandscapeGrassTypeFactory\_\_](ue_ue.LandscapeGrassTypeFactory.md#__tid_landscapegrasstypefactory__)
- [\_\_tid\_Object\_\_](ue_ue.LandscapeGrassTypeFactory.md#__tid_object__)
- [bCreateNew](ue_ue.LandscapeGrassTypeFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.LandscapeGrassTypeFactory.md#beditafternew)
- [bEditorImport](ue_ue.LandscapeGrassTypeFactory.md#beditorimport)
- [bText](ue_ue.LandscapeGrassTypeFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.LandscapeGrassTypeFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.LandscapeGrassTypeFactory.md#executeubergraph)
- [GetClass](ue_ue.LandscapeGrassTypeFactory.md#getclass)
- [GetName](ue_ue.LandscapeGrassTypeFactory.md#getname)
- [GetOuter](ue_ue.LandscapeGrassTypeFactory.md#getouter)
- [GetWorld](ue_ue.LandscapeGrassTypeFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.LandscapeGrassTypeFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.LandscapeGrassTypeFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.LandscapeGrassTypeFactory.md#find)
- [Load](ue_ue.LandscapeGrassTypeFactory.md#load)
- [StaticClass](ue_ue.LandscapeGrassTypeFactory.md#staticclass)

## Constructors

### constructor

• **new LandscapeGrassTypeFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:44535](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L44535)
...
### \_\_tid\_LandscapeGrassTypeFactory\_\_

• **\_\_tid\_LandscapeGrassTypeFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:44540](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L44540)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`LandscapeGrassTypeFactory`](ue_ue.LandscapeGrassTypeFactory.md)
...
[ue/ue.d.ts:44537](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L44537)

___

### Load

▸ `Static` **Load**(`InName`): [`LandscapeGrassTypeFactory`](ue_ue.LandscapeGrassTypeFactory.md)
...
[ue/ue.d.ts:44538](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L44538)
...
[ue/ue.d.ts:44536](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L44536)
