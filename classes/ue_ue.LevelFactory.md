[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / LevelFactory

# Class: LevelFactory

[ue/ue](../modules/ue_ue.md).LevelFactory
...
- [constructor](ue_ue.LevelFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.LevelFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.LevelFactory.md#automatedimportdata)
- [ContextClass](ue_ue.LevelFactory.md#contextclass)
- [Formats](ue_ue.LevelFactory.md#formats)
- [ImportPriority](ue_ue.LevelFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.LevelFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.LevelFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.LevelFactory.md#__tid_factory__)
- [\_\_tid\_LevelFactory\_\_](ue_ue.LevelFactory.md#__tid_levelfactory__)
- [\_\_tid\_Object\_\_](ue_ue.LevelFactory.md#__tid_object__)
- [bCreateNew](ue_ue.LevelFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.LevelFactory.md#beditafternew)
- [bEditorImport](ue_ue.LevelFactory.md#beditorimport)
- [bText](ue_ue.LevelFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.LevelFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.LevelFactory.md#executeubergraph)
- [GetClass](ue_ue.LevelFactory.md#getclass)
- [GetName](ue_ue.LevelFactory.md#getname)
- [GetOuter](ue_ue.LevelFactory.md#getouter)
- [GetWorld](ue_ue.LevelFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.LevelFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.LevelFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.LevelFactory.md#find)
- [Load](ue_ue.LevelFactory.md#load)
- [StaticClass](ue_ue.LevelFactory.md#staticclass)

## Constructors

### constructor

• **new LevelFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:45166](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45166)
...
### \_\_tid\_LevelFactory\_\_

• **\_\_tid\_LevelFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:45171](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45171)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`LevelFactory`](ue_ue.LevelFactory.md)
...
[ue/ue.d.ts:45168](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45168)

___

### Load

▸ `Static` **Load**(`InName`): [`LevelFactory`](ue_ue.LevelFactory.md)
...
[ue/ue.d.ts:45169](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45169)
...
[ue/ue.d.ts:45167](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45167)
