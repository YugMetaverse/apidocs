[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / LevelThumbnailRenderer

# Class: LevelThumbnailRenderer

[ue/ue](../modules/ue_ue.md).LevelThumbnailRenderer
...
- [constructor](ue_ue.LevelThumbnailRenderer.md#constructor)

### Properties

- [DefaultSizeX](ue_ue.LevelThumbnailRenderer.md#defaultsizex)
- [DefaultSizeY](ue_ue.LevelThumbnailRenderer.md#defaultsizey)
- [\_\_tid\_DefaultSizedThumbnailRenderer\_\_](ue_ue.LevelThumbnailRenderer.md#__tid_defaultsizedthumbnailrenderer__)
- [\_\_tid\_LevelThumbnailRenderer\_\_](ue_ue.LevelThumbnailRenderer.md#__tid_levelthumbnailrenderer__)
- [\_\_tid\_Object\_\_](ue_ue.LevelThumbnailRenderer.md#__tid_object__)
- [\_\_tid\_ThumbnailRenderer\_\_](ue_ue.LevelThumbnailRenderer.md#__tid_thumbnailrenderer__)

### Methods

- [CreateDefaultSubobject](ue_ue.LevelThumbnailRenderer.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.LevelThumbnailRenderer.md#executeubergraph)
- [GetClass](ue_ue.LevelThumbnailRenderer.md#getclass)
- [GetName](ue_ue.LevelThumbnailRenderer.md#getname)
- [GetOuter](ue_ue.LevelThumbnailRenderer.md#getouter)
- [GetWorld](ue_ue.LevelThumbnailRenderer.md#getworld)
- [Find](ue_ue.LevelThumbnailRenderer.md#find)
- [Load](ue_ue.LevelThumbnailRenderer.md#load)
- [StaticClass](ue_ue.LevelThumbnailRenderer.md#staticclass)

## Constructors

### constructor

• **new LevelThumbnailRenderer**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:45311](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45311)
...
### \_\_tid\_LevelThumbnailRenderer\_\_

• **\_\_tid\_LevelThumbnailRenderer\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:45316](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45316)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`LevelThumbnailRenderer`](ue_ue.LevelThumbnailRenderer.md)
...
[ue/ue.d.ts:45313](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45313)

___

### Load

▸ `Static` **Load**(`InName`): [`LevelThumbnailRenderer`](ue_ue.LevelThumbnailRenderer.md)
...
[ue/ue.d.ts:45314](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45314)
...
[ue/ue.d.ts:45312](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45312)
