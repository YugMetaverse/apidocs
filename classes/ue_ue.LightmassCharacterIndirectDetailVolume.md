[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / LightmassCharacterIndirectDetailVolume

# Class: LightmassCharacterIndirectDetailVolume

[ue/ue](../modules/ue_ue.md).LightmassCharacterIndirectDetailVolume
...
- [constructor](ue_ue.LightmassCharacterIndirectDetailVolume.md#constructor)

### Properties

- [ActorLabel](ue_ue.LightmassCharacterIndirectDetailVolume.md#actorlabel)
- [AttachmentReplication](ue_ue.LightmassCharacterIndirectDetailVolume.md#attachmentreplication)
- [AutoReceiveInput](ue_ue.LightmassCharacterIndirectDetailVolume.md#autoreceiveinput)
- [BlueprintCreatedComponents](ue_ue.LightmassCharacterIndirectDetailVolume.md#blueprintcreatedcomponents)
- [Brush](ue_ue.LightmassCharacterIndirectDetailVolume.md#brush)
- [BrushBuilder](ue_ue.LightmassCharacterIndirectDetailVolume.md#brushbuilder)
- [BrushColor](ue_ue.LightmassCharacterIndirectDetailVolume.md#brushcolor)
- [BrushComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#brushcomponent)
- [BrushType](ue_ue.LightmassCharacterIndirectDetailVolume.md#brushtype)
- [Children](ue_ue.LightmassCharacterIndirectDetailVolume.md#children)
- [ControllingMatineeActors](ue_ue.LightmassCharacterIndirectDetailVolume.md#controllingmatineeactors)
- [CustomTimeDilation](ue_ue.LightmassCharacterIndirectDetailVolume.md#customtimedilation)
- [DefaultUpdateOverlapsMethodDuringLevelStreaming](ue_ue.LightmassCharacterIndirectDetailVolume.md#defaultupdateoverlapsmethodduringlevelstreaming)
- [FolderPath](ue_ue.LightmassCharacterIndirectDetailVolume.md#folderpath)
- [GroupActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#groupactor)
- [HiddenEditorViews](ue_ue.LightmassCharacterIndirectDetailVolume.md#hiddeneditorviews)
- [InitialLifeSpan](ue_ue.LightmassCharacterIndirectDetailVolume.md#initiallifespan)
- [InputComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#inputcomponent)
- [InputPriority](ue_ue.LightmassCharacterIndirectDetailVolume.md#inputpriority)
- [InstanceComponents](ue_ue.LightmassCharacterIndirectDetailVolume.md#instancecomponents)
- [Instigator](ue_ue.LightmassCharacterIndirectDetailVolume.md#instigator)
- [Layers](ue_ue.LightmassCharacterIndirectDetailVolume.md#layers)
- [MinNetUpdateFrequency](ue_ue.LightmassCharacterIndirectDetailVolume.md#minnetupdatefrequency)
- [NetCullDistanceSquared](ue_ue.LightmassCharacterIndirectDetailVolume.md#netculldistancesquared)
- [NetDormancy](ue_ue.LightmassCharacterIndirectDetailVolume.md#netdormancy)
- [NetDriverName](ue_ue.LightmassCharacterIndirectDetailVolume.md#netdrivername)
- [NetPriority](ue_ue.LightmassCharacterIndirectDetailVolume.md#netpriority)
- [NetTag](ue_ue.LightmassCharacterIndirectDetailVolume.md#nettag)
- [NetUpdateFrequency](ue_ue.LightmassCharacterIndirectDetailVolume.md#netupdatefrequency)
- [OnActorBeginOverlap](ue_ue.LightmassCharacterIndirectDetailVolume.md#onactorbeginoverlap)
- [OnActorEndOverlap](ue_ue.LightmassCharacterIndirectDetailVolume.md#onactorendoverlap)
- [OnActorHit](ue_ue.LightmassCharacterIndirectDetailVolume.md#onactorhit)
- [OnBeginCursorOver](ue_ue.LightmassCharacterIndirectDetailVolume.md#onbegincursorover)
- [OnClicked](ue_ue.LightmassCharacterIndirectDetailVolume.md#onclicked)
- [OnDestroyed](ue_ue.LightmassCharacterIndirectDetailVolume.md#ondestroyed)
- [OnEndCursorOver](ue_ue.LightmassCharacterIndirectDetailVolume.md#onendcursorover)
- [OnEndPlay](ue_ue.LightmassCharacterIndirectDetailVolume.md#onendplay)
- [OnInputTouchBegin](ue_ue.LightmassCharacterIndirectDetailVolume.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue.LightmassCharacterIndirectDetailVolume.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue.LightmassCharacterIndirectDetailVolume.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue.LightmassCharacterIndirectDetailVolume.md#oninputtouchleave)
- [OnReleased](ue_ue.LightmassCharacterIndirectDetailVolume.md#onreleased)
- [OnTakeAnyDamage](ue_ue.LightmassCharacterIndirectDetailVolume.md#ontakeanydamage)
- [OnTakePointDamage](ue_ue.LightmassCharacterIndirectDetailVolume.md#ontakepointdamage)
- [OnTakeRadialDamage](ue_ue.LightmassCharacterIndirectDetailVolume.md#ontakeradialdamage)
- [Owner](ue_ue.LightmassCharacterIndirectDetailVolume.md#owner)
- [ParentComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#parentcomponent)
- [ParentComponentActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#parentcomponentactor)
- [PivotOffset](ue_ue.LightmassCharacterIndirectDetailVolume.md#pivotoffset)
- [PolyFlags](ue_ue.LightmassCharacterIndirectDetailVolume.md#polyflags)
- [PrimaryActorTick](ue_ue.LightmassCharacterIndirectDetailVolume.md#primaryactortick)
- [RemoteRole](ue_ue.LightmassCharacterIndirectDetailVolume.md#remoterole)
- [ReplicatedMovement](ue_ue.LightmassCharacterIndirectDetailVolume.md#replicatedmovement)
- [Role](ue_ue.LightmassCharacterIndirectDetailVolume.md#role)
- [RootComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#rootcomponent)
- [SavedSelections](ue_ue.LightmassCharacterIndirectDetailVolume.md#savedselections)
- [SpawnCollisionHandlingMethod](ue_ue.LightmassCharacterIndirectDetailVolume.md#spawncollisionhandlingmethod)
- [SpriteScale](ue_ue.LightmassCharacterIndirectDetailVolume.md#spritescale)
- [Tags](ue_ue.LightmassCharacterIndirectDetailVolume.md#tags)
- [UpdateOverlapsMethodDuringLevelStreaming](ue_ue.LightmassCharacterIndirectDetailVolume.md#updateoverlapsmethodduringlevelstreaming)
- [\_\_tid\_Actor\_\_](ue_ue.LightmassCharacterIndirectDetailVolume.md#__tid_actor__)
- [\_\_tid\_Brush\_\_](ue_ue.LightmassCharacterIndirectDetailVolume.md#__tid_brush__)
- [\_\_tid\_LightmassCharacterIndirectDetailVolume\_\_](ue_ue.LightmassCharacterIndirectDetailVolume.md#__tid_lightmasscharacterindirectdetailvolume__)
- [\_\_tid\_Object\_\_](ue_ue.LightmassCharacterIndirectDetailVolume.md#__tid_object__)
- [\_\_tid\_Volume\_\_](ue_ue.LightmassCharacterIndirectDetailVolume.md#__tid_volume__)
- [bActorEnableCollision](ue_ue.LightmassCharacterIndirectDetailVolume.md#bactorenablecollision)
- [bActorIsBeingDestroyed](ue_ue.LightmassCharacterIndirectDetailVolume.md#bactorisbeingdestroyed)
- [bActorLabelEditable](ue_ue.LightmassCharacterIndirectDetailVolume.md#bactorlabeleditable)
- [bActorSeamlessTraveled](ue_ue.LightmassCharacterIndirectDetailVolume.md#bactorseamlesstraveled)
- [bAllowReceiveTickEventOnDedicatedServer](ue_ue.LightmassCharacterIndirectDetailVolume.md#ballowreceivetickeventondedicatedserver)
- [bAllowTickBeforeBeginPlay](ue_ue.LightmassCharacterIndirectDetailVolume.md#ballowtickbeforebeginplay)
- [bAlwaysRelevant](ue_ue.LightmassCharacterIndirectDetailVolume.md#balwaysrelevant)
- [bAutoDestroyWhenFinished](ue_ue.LightmassCharacterIndirectDetailVolume.md#bautodestroywhenfinished)
- [bBlockInput](ue_ue.LightmassCharacterIndirectDetailVolume.md#bblockinput)
- [bCanBeDamaged](ue_ue.LightmassCharacterIndirectDetailVolume.md#bcanbedamaged)
- [bCanBeInCluster](ue_ue.LightmassCharacterIndirectDetailVolume.md#bcanbeincluster)
- [bCollideWhenPlacing](ue_ue.LightmassCharacterIndirectDetailVolume.md#bcollidewhenplacing)
- [bColored](ue_ue.LightmassCharacterIndirectDetailVolume.md#bcolored)
- [bEditable](ue_ue.LightmassCharacterIndirectDetailVolume.md#beditable)
- [bEnableAutoLODGeneration](ue_ue.LightmassCharacterIndirectDetailVolume.md#benableautolodgeneration)
- [bExchangedRoles](ue_ue.LightmassCharacterIndirectDetailVolume.md#bexchangedroles)
- [bFindCameraComponentWhenViewTarget](ue_ue.LightmassCharacterIndirectDetailVolume.md#bfindcameracomponentwhenviewtarget)
- [bGenerateOverlapEventsDuringLevelStreaming](ue_ue.LightmassCharacterIndirectDetailVolume.md#bgenerateoverlapeventsduringlevelstreaming)
- [bHidden](ue_ue.LightmassCharacterIndirectDetailVolume.md#bhidden)
- [bHiddenEd](ue_ue.LightmassCharacterIndirectDetailVolume.md#bhiddened)
- [bHiddenEdLayer](ue_ue.LightmassCharacterIndirectDetailVolume.md#bhiddenedlayer)
- [bHiddenEdLevel](ue_ue.LightmassCharacterIndirectDetailVolume.md#bhiddenedlevel)
- [bHiddenEdTemporary](ue_ue.LightmassCharacterIndirectDetailVolume.md#bhiddenedtemporary)
- [bIgnoresOriginShifting](ue_ue.LightmassCharacterIndirectDetailVolume.md#bignoresoriginshifting)
- [bInManipulation](ue_ue.LightmassCharacterIndirectDetailVolume.md#binmanipulation)
- [bIsEditorOnlyActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#biseditoronlyactor)
- [bIsEditorPreviewActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#biseditorpreviewactor)
- [bListedInSceneOutliner](ue_ue.LightmassCharacterIndirectDetailVolume.md#blistedinsceneoutliner)
- [bLockLocation](ue_ue.LightmassCharacterIndirectDetailVolume.md#blocklocation)
- [bNetLoadOnClient](ue_ue.LightmassCharacterIndirectDetailVolume.md#bnetloadonclient)
- [bNetStartup](ue_ue.LightmassCharacterIndirectDetailVolume.md#bnetstartup)
- [bNetTemporary](ue_ue.LightmassCharacterIndirectDetailVolume.md#bnettemporary)
- [bNetUseOwnerRelevancy](ue_ue.LightmassCharacterIndirectDetailVolume.md#bnetuseownerrelevancy)
- [bNotForClientOrServer](ue_ue.LightmassCharacterIndirectDetailVolume.md#bnotforclientorserver)
- [bOnlyRelevantToOwner](ue_ue.LightmassCharacterIndirectDetailVolume.md#bonlyrelevanttoowner)
- [bOptimizeBPComponentData](ue_ue.LightmassCharacterIndirectDetailVolume.md#boptimizebpcomponentdata)
- [bPlaceableFromClassBrowser](ue_ue.LightmassCharacterIndirectDetailVolume.md#bplaceablefromclassbrowser)
- [bRelevantForLevelBounds](ue_ue.LightmassCharacterIndirectDetailVolume.md#brelevantforlevelbounds)
- [bRelevantForNetworkReplays](ue_ue.LightmassCharacterIndirectDetailVolume.md#brelevantfornetworkreplays)
- [bReplayRewindable](ue_ue.LightmassCharacterIndirectDetailVolume.md#breplayrewindable)
- [bReplicateMovement](ue_ue.LightmassCharacterIndirectDetailVolume.md#breplicatemovement)
- [bReplicates](ue_ue.LightmassCharacterIndirectDetailVolume.md#breplicates)
- [bSolidWhenSelected](ue_ue.LightmassCharacterIndirectDetailVolume.md#bsolidwhenselected)
- [bTearOff](ue_ue.LightmassCharacterIndirectDetailVolume.md#btearoff)

### Methods

- [ActorHasTag](ue_ue.LightmassCharacterIndirectDetailVolume.md#actorhastag)
- [AddComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#addcomponent)
- [AddTickPrerequisiteActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#addtickprerequisitecomponent)
- [CreateDefaultSubobject](ue_ue.LightmassCharacterIndirectDetailVolume.md#createdefaultsubobject)
- [DetachRootComponentFromParent](ue_ue.LightmassCharacterIndirectDetailVolume.md#detachrootcomponentfromparent)
- [DisableInput](ue_ue.LightmassCharacterIndirectDetailVolume.md#disableinput)
- [EnableInput](ue_ue.LightmassCharacterIndirectDetailVolume.md#enableinput)
- [ExecuteUbergraph](ue_ue.LightmassCharacterIndirectDetailVolume.md#executeubergraph)
- [FlushNetDormancy](ue_ue.LightmassCharacterIndirectDetailVolume.md#flushnetdormancy)
- [ForceNetUpdate](ue_ue.LightmassCharacterIndirectDetailVolume.md#forcenetupdate)
- [GetActorBounds](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorbounds)
- [GetActorEnableCollision](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorenablecollision)
- [GetActorEyesViewPoint](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactoreyesviewpoint)
- [GetActorForwardVector](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorforwardvector)
- [GetActorLabel](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorlabel)
- [GetActorRelativeScale3D](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorrelativescale3d)
- [GetActorRightVector](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorrightvector)
- [GetActorScale3D](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorscale3d)
- [GetActorTickInterval](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactortickinterval)
- [GetActorTimeDilation](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactortimedilation)
- [GetActorUpVector](ue_ue.LightmassCharacterIndirectDetailVolume.md#getactorupvector)
- [GetAllChildActors](ue_ue.LightmassCharacterIndirectDetailVolume.md#getallchildactors)
- [GetAttachParentActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#getattachparentactor)
- [GetAttachParentSocketName](ue_ue.LightmassCharacterIndirectDetailVolume.md#getattachparentsocketname)
- [GetAttachedActors](ue_ue.LightmassCharacterIndirectDetailVolume.md#getattachedactors)
- [GetClass](ue_ue.LightmassCharacterIndirectDetailVolume.md#getclass)
- [GetComponentByClass](ue_ue.LightmassCharacterIndirectDetailVolume.md#getcomponentbyclass)
- [GetComponentsByInterface](ue_ue.LightmassCharacterIndirectDetailVolume.md#getcomponentsbyinterface)
- [GetComponentsByTag](ue_ue.LightmassCharacterIndirectDetailVolume.md#getcomponentsbytag)
- [GetDistanceTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#getdistanceto)
- [GetDotProductTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#getdotproductto)
- [GetFolderPath](ue_ue.LightmassCharacterIndirectDetailVolume.md#getfolderpath)
- [GetGameTimeSinceCreation](ue_ue.LightmassCharacterIndirectDetailVolume.md#getgametimesincecreation)
- [GetHorizontalDistanceTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#gethorizontaldistanceto)
- [GetHorizontalDotProductTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#gethorizontaldotproductto)
- [GetInputAxisKeyValue](ue_ue.LightmassCharacterIndirectDetailVolume.md#getinputaxiskeyvalue)
- [GetInputAxisValue](ue_ue.LightmassCharacterIndirectDetailVolume.md#getinputaxisvalue)
- [GetInputVectorAxisValue](ue_ue.LightmassCharacterIndirectDetailVolume.md#getinputvectoraxisvalue)
- [GetInstigator](ue_ue.LightmassCharacterIndirectDetailVolume.md#getinstigator)
- [GetInstigatorController](ue_ue.LightmassCharacterIndirectDetailVolume.md#getinstigatorcontroller)
- [GetLifeSpan](ue_ue.LightmassCharacterIndirectDetailVolume.md#getlifespan)
- [GetLocalRole](ue_ue.LightmassCharacterIndirectDetailVolume.md#getlocalrole)
- [GetName](ue_ue.LightmassCharacterIndirectDetailVolume.md#getname)
- [GetOuter](ue_ue.LightmassCharacterIndirectDetailVolume.md#getouter)
- [GetOverlappingActors](ue_ue.LightmassCharacterIndirectDetailVolume.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue.LightmassCharacterIndirectDetailVolume.md#getoverlappingcomponents)
- [GetOwner](ue_ue.LightmassCharacterIndirectDetailVolume.md#getowner)
- [GetParentActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#getparentactor)
- [GetParentComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#getparentcomponent)
- [GetRemoteRole](ue_ue.LightmassCharacterIndirectDetailVolume.md#getremoterole)
- [GetSquaredDistanceTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#getsquareddistanceto)
- [GetTickableWhenPaused](ue_ue.LightmassCharacterIndirectDetailVolume.md#gettickablewhenpaused)
- [GetTransform](ue_ue.LightmassCharacterIndirectDetailVolume.md#gettransform)
- [GetVelocity](ue_ue.LightmassCharacterIndirectDetailVolume.md#getvelocity)
- [GetVerticalDistanceTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#getverticaldistanceto)
- [GetWorld](ue_ue.LightmassCharacterIndirectDetailVolume.md#getworld)
- [HasAuthority](ue_ue.LightmassCharacterIndirectDetailVolume.md#hasauthority)
- [IsActorBeingDestroyed](ue_ue.LightmassCharacterIndirectDetailVolume.md#isactorbeingdestroyed)
- [IsActorTickEnabled](ue_ue.LightmassCharacterIndirectDetailVolume.md#isactortickenabled)
- [IsChildActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#ischildactor)
- [IsEditable](ue_ue.LightmassCharacterIndirectDetailVolume.md#iseditable)
- [IsHiddenEd](ue_ue.LightmassCharacterIndirectDetailVolume.md#ishiddened)
- [IsHiddenEdAtStartup](ue_ue.LightmassCharacterIndirectDetailVolume.md#ishiddenedatstartup)
- [IsOverlappingActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#isoverlappingactor)
- [IsSelectable](ue_ue.LightmassCharacterIndirectDetailVolume.md#isselectable)
- [IsTemporarilyHiddenInEditor](ue_ue.LightmassCharacterIndirectDetailVolume.md#istemporarilyhiddenineditor)
- [K2\_AddActorLocalOffset](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_addactorlocaloffset)
- [K2\_AddActorLocalRotation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_addactorlocalrotation)
- [K2\_AddActorLocalTransform](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_addactorlocaltransform)
- [K2\_AddActorWorldOffset](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_addactorworldoffset)
- [K2\_AddActorWorldRotation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_addactorworldrotation)
- [K2\_AddActorWorldTransform](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_addactorworldtransform)
- [K2\_AttachRootComponentTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_attachrootcomponentto)
- [K2\_AttachRootComponentToActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_attachrootcomponenttoactor)
- [K2\_AttachToActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_attachtoactor)
- [K2\_AttachToComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_attachtocomponent)
- [K2\_DestroyActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_destroyactor)
- [K2\_DestroyComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_destroycomponent)
- [K2\_DetachFromActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_detachfromactor)
- [K2\_GetActorLocation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_getactorlocation)
- [K2\_GetActorRotation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_getactorrotation)
- [K2\_GetComponentsByClass](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_getcomponentsbyclass)
- [K2\_GetRootComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_getrootcomponent)
- [K2\_OnBecomeViewTarget](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_onbecomeviewtarget)
- [K2\_OnEndViewTarget](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_onendviewtarget)
- [K2\_OnReset](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_onreset)
- [K2\_SetActorLocation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactorlocation)
- [K2\_SetActorLocationAndRotation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactorlocationandrotation)
- [K2\_SetActorRelativeLocation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactorrelativelocation)
- [K2\_SetActorRelativeRotation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactorrelativerotation)
- [K2\_SetActorRelativeTransform](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactorrelativetransform)
- [K2\_SetActorRotation](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactorrotation)
- [K2\_SetActorTransform](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_setactortransform)
- [K2\_TeleportTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#k2_teleportto)
- [MakeMIDForMaterial](ue_ue.LightmassCharacterIndirectDetailVolume.md#makemidformaterial)
- [MakeNoise](ue_ue.LightmassCharacterIndirectDetailVolume.md#makenoise)
- [OnRep\_AttachmentReplication](ue_ue.LightmassCharacterIndirectDetailVolume.md#onrep_attachmentreplication)
- [OnRep\_Instigator](ue_ue.LightmassCharacterIndirectDetailVolume.md#onrep_instigator)
- [OnRep\_Owner](ue_ue.LightmassCharacterIndirectDetailVolume.md#onrep_owner)
- [OnRep\_ReplicateMovement](ue_ue.LightmassCharacterIndirectDetailVolume.md#onrep_replicatemovement)
- [OnRep\_ReplicatedMovement](ue_ue.LightmassCharacterIndirectDetailVolume.md#onrep_replicatedmovement)
- [PrestreamTextures](ue_ue.LightmassCharacterIndirectDetailVolume.md#prestreamtextures)
- [ReceiveActorBeginCursorOver](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactorbegincursorover)
- [ReceiveActorBeginOverlap](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactorbeginoverlap)
- [ReceiveActorEndCursorOver](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactorendcursorover)
- [ReceiveActorEndOverlap](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactorendoverlap)
- [ReceiveActorOnClicked](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactoronclicked)
- [ReceiveActorOnInputTouchBegin](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactoroninputtouchbegin)
- [ReceiveActorOnInputTouchEnd](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactoroninputtouchend)
- [ReceiveActorOnInputTouchEnter](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactoroninputtouchenter)
- [ReceiveActorOnInputTouchLeave](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactoroninputtouchleave)
- [ReceiveActorOnReleased](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveactoronreleased)
- [ReceiveAnyDamage](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveanydamage)
- [ReceiveBeginPlay](ue_ue.LightmassCharacterIndirectDetailVolume.md#receivebeginplay)
- [ReceiveDestroyed](ue_ue.LightmassCharacterIndirectDetailVolume.md#receivedestroyed)
- [ReceiveEndPlay](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveendplay)
- [ReceiveHit](ue_ue.LightmassCharacterIndirectDetailVolume.md#receivehit)
- [ReceivePointDamage](ue_ue.LightmassCharacterIndirectDetailVolume.md#receivepointdamage)
- [ReceiveRadialDamage](ue_ue.LightmassCharacterIndirectDetailVolume.md#receiveradialdamage)
- [ReceiveTick](ue_ue.LightmassCharacterIndirectDetailVolume.md#receivetick)
- [RemoveTickPrerequisiteActor](ue_ue.LightmassCharacterIndirectDetailVolume.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.LightmassCharacterIndirectDetailVolume.md#removetickprerequisitecomponent)
- [SetActorEnableCollision](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactorenablecollision)
- [SetActorHiddenInGame](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactorhiddeningame)
- [SetActorLabel](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactorlabel)
- [SetActorRelativeScale3D](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactorrelativescale3d)
- [SetActorScale3D](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactorscale3d)
- [SetActorTickEnabled](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactortickenabled)
- [SetActorTickInterval](ue_ue.LightmassCharacterIndirectDetailVolume.md#setactortickinterval)
- [SetFolderPath](ue_ue.LightmassCharacterIndirectDetailVolume.md#setfolderpath)
- [SetIsTemporarilyHiddenInEditor](ue_ue.LightmassCharacterIndirectDetailVolume.md#setistemporarilyhiddenineditor)
- [SetLifeSpan](ue_ue.LightmassCharacterIndirectDetailVolume.md#setlifespan)
- [SetNetDormancy](ue_ue.LightmassCharacterIndirectDetailVolume.md#setnetdormancy)
- [SetOwner](ue_ue.LightmassCharacterIndirectDetailVolume.md#setowner)
- [SetReplicateMovement](ue_ue.LightmassCharacterIndirectDetailVolume.md#setreplicatemovement)
- [SetReplicates](ue_ue.LightmassCharacterIndirectDetailVolume.md#setreplicates)
- [SetTickGroup](ue_ue.LightmassCharacterIndirectDetailVolume.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.LightmassCharacterIndirectDetailVolume.md#settickablewhenpaused)
- [SnapRootComponentTo](ue_ue.LightmassCharacterIndirectDetailVolume.md#snaprootcomponentto)
- [TearOff](ue_ue.LightmassCharacterIndirectDetailVolume.md#tearoff)
- [UserConstructionScript](ue_ue.LightmassCharacterIndirectDetailVolume.md#userconstructionscript)
- [WasRecentlyRendered](ue_ue.LightmassCharacterIndirectDetailVolume.md#wasrecentlyrendered)
- [Find](ue_ue.LightmassCharacterIndirectDetailVolume.md#find)
- [Load](ue_ue.LightmassCharacterIndirectDetailVolume.md#load)
- [StaticClass](ue_ue.LightmassCharacterIndirectDetailVolume.md#staticclass)

## Constructors

### constructor

• **new LightmassCharacterIndirectDetailVolume**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:45415](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45415)
...
### \_\_tid\_LightmassCharacterIndirectDetailVolume\_\_

• **\_\_tid\_LightmassCharacterIndirectDetailVolume\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:45420](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45420)
...
[Volume](ue_ue.Volume.md).[GetName](ue_ue.Volume.md#getname)
...
[Volume](ue_ue.Volume.md).[GetOverlappingComponents](ue_ue.Volume.md#getoverlappingcomponents)
...
[Volume](ue_ue.Volume.md).[K2_AttachRootComponentToActor](ue_ue.Volume.md#k2_attachrootcomponenttoactor)
...
[Volume](ue_ue.Volume.md).[OnRep_AttachmentReplication](ue_ue.Volume.md#onrep_attachmentreplication)
...
[Volume](ue_ue.Volume.md).[OnRep_ReplicatedMovement](ue_ue.Volume.md#onrep_replicatedmovement)
...
[Volume](ue_ue.Volume.md).[PrestreamTextures](ue_ue.Volume.md#prestreamtextures)
...
[Volume](ue_ue.Volume.md).[ReceiveActorBeginCursorOver](ue_ue.Volume.md#receiveactorbegincursorover)
...
[Volume](ue_ue.Volume.md).[ReceiveActorBeginOverlap](ue_ue.Volume.md#receiveactorbeginoverlap)
...
[Volume](ue_ue.Volume.md).[ReceiveActorEndCursorOver](ue_ue.Volume.md#receiveactorendcursorover)
...
[Volume](ue_ue.Volume.md).[ReceiveActorEndOverlap](ue_ue.Volume.md#receiveactorendoverlap)
...
[Volume](ue_ue.Volume.md).[ReceiveActorOnClicked](ue_ue.Volume.md#receiveactoronclicked)
...
[Volume](ue_ue.Volume.md).[ReceiveActorOnInputTouchBegin](ue_ue.Volume.md#receiveactoroninputtouchbegin)
...
[Volume](ue_ue.Volume.md).[ReceiveActorOnInputTouchEnd](ue_ue.Volume.md#receiveactoroninputtouchend)
...
[Volume](ue_ue.Volume.md).[ReceiveActorOnInputTouchEnter](ue_ue.Volume.md#receiveactoroninputtouchenter)
...
[Volume](ue_ue.Volume.md).[ReceiveActorOnInputTouchLeave](ue_ue.Volume.md#receiveactoroninputtouchleave)
...
[Volume](ue_ue.Volume.md).[ReceiveActorOnReleased](ue_ue.Volume.md#receiveactoronreleased)
...
[Volume](ue_ue.Volume.md).[ReceiveAnyDamage](ue_ue.Volume.md#receiveanydamage)
...
[Volume](ue_ue.Volume.md).[ReceiveBeginPlay](ue_ue.Volume.md#receivebeginplay)
...
[Volume](ue_ue.Volume.md).[ReceiveDestroyed](ue_ue.Volume.md#receivedestroyed)
...
[Volume](ue_ue.Volume.md).[ReceiveEndPlay](ue_ue.Volume.md#receiveendplay)
...
[Volume](ue_ue.Volume.md).[ReceiveHit](ue_ue.Volume.md#receivehit)
...
[Volume](ue_ue.Volume.md).[ReceivePointDamage](ue_ue.Volume.md#receivepointdamage)
...
[Volume](ue_ue.Volume.md).[ReceiveRadialDamage](ue_ue.Volume.md#receiveradialdamage)
...
[Volume](ue_ue.Volume.md).[ReceiveTick](ue_ue.Volume.md#receivetick)
...
[Volume](ue_ue.Volume.md).[RemoveTickPrerequisiteActor](ue_ue.Volume.md#removetickprerequisiteactor)
...
[Volume](ue_ue.Volume.md).[RemoveTickPrerequisiteComponent](ue_ue.Volume.md#removetickprerequisitecomponent)
...
[Volume](ue_ue.Volume.md).[SetActorEnableCollision](ue_ue.Volume.md#setactorenablecollision)
...
[Volume](ue_ue.Volume.md).[SetActorHiddenInGame](ue_ue.Volume.md#setactorhiddeningame)
...
[Volume](ue_ue.Volume.md).[SetActorLabel](ue_ue.Volume.md#setactorlabel)
...
[Volume](ue_ue.Volume.md).[SetActorRelativeScale3D](ue_ue.Volume.md#setactorrelativescale3d)
...
[Volume](ue_ue.Volume.md).[SetActorScale3D](ue_ue.Volume.md#setactorscale3d)
...
[Volume](ue_ue.Volume.md).[SetActorTickEnabled](ue_ue.Volume.md#setactortickenabled)
...
[Volume](ue_ue.Volume.md).[SetActorTickInterval](ue_ue.Volume.md#setactortickinterval)
...
[Volume](ue_ue.Volume.md).[SetFolderPath](ue_ue.Volume.md#setfolderpath)
...
[Volume](ue_ue.Volume.md).[SetIsTemporarilyHiddenInEditor](ue_ue.Volume.md#setistemporarilyhiddenineditor)
...
[Volume](ue_ue.Volume.md).[SetLifeSpan](ue_ue.Volume.md#setlifespan)
...
[Volume](ue_ue.Volume.md).[SetNetDormancy](ue_ue.Volume.md#setnetdormancy)
...
[Volume](ue_ue.Volume.md).[SetOwner](ue_ue.Volume.md#setowner)
...
[Volume](ue_ue.Volume.md).[SetReplicateMovement](ue_ue.Volume.md#setreplicatemovement)
...
[Volume](ue_ue.Volume.md).[SetReplicates](ue_ue.Volume.md#setreplicates)
...
[Volume](ue_ue.Volume.md).[SetTickGroup](ue_ue.Volume.md#settickgroup)
...
[Volume](ue_ue.Volume.md).[SetTickableWhenPaused](ue_ue.Volume.md#settickablewhenpaused)
...
[Volume](ue_ue.Volume.md).[SnapRootComponentTo](ue_ue.Volume.md#snaprootcomponentto)
...
[Volume](ue_ue.Volume.md).[TearOff](ue_ue.Volume.md#tearoff)
...
[Volume](ue_ue.Volume.md).[UserConstructionScript](ue_ue.Volume.md#userconstructionscript)
...
[Volume](ue_ue.Volume.md).[WasRecentlyRendered](ue_ue.Volume.md#wasrecentlyrendered)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`LightmassCharacterIndirectDetailVolume`](ue_ue.LightmassCharacterIndirectDetailVolume.md)
...
[Volume](ue_ue.Volume.md).[Find](ue_ue.Volume.md#find)

#### Defined in

[ue/ue.d.ts:45417](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45417)

___

### Load

▸ `Static` **Load**(`InName`): [`LightmassCharacterIndirectDetailVolume`](ue_ue.LightmassCharacterIndirectDetailVolume.md)
...
[Volume](ue_ue.Volume.md).[Load](ue_ue.Volume.md#load)

#### Defined in

[ue/ue.d.ts:45418](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45418)
...
[Volume](ue_ue.Volume.md).[StaticClass](ue_ue.Volume.md#staticclass)

#### Defined in

[ue/ue.d.ts:45416](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45416)
