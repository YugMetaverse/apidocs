[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ListViewBase

# Class: ListViewBase

[ue/ue](../modules/ue_ue.md).ListViewBase
...
- [constructor](ue_ue.ListViewBase.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.ListViewBase.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.ListViewBase.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.ListViewBase.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.ListViewBase.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.ListViewBase.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.ListViewBase.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.ListViewBase.md#accessiblewidgetdata)
- [BP\_OnEntryGenerated](ue_ue.ListViewBase.md#bp_onentrygenerated)
- [BP\_OnEntryReleased](ue_ue.ListViewBase.md#bp_onentryreleased)
- [CategoryName](ue_ue.ListViewBase.md#categoryname)
- [Clipping](ue_ue.ListViewBase.md#clipping)
- [Cursor](ue_ue.ListViewBase.md#cursor)
- [DesignerFlags](ue_ue.ListViewBase.md#designerflags)
- [DisplayLabel](ue_ue.ListViewBase.md#displaylabel)
- [EntryWidgetClass](ue_ue.ListViewBase.md#entrywidgetclass)
- [EntryWidgetPool](ue_ue.ListViewBase.md#entrywidgetpool)
- [FixedLineScrollOffset](ue_ue.ListViewBase.md#fixedlinescrolloffset)
- [FlowDirectionPreference](ue_ue.ListViewBase.md#flowdirectionpreference)
- [NativeBindings](ue_ue.ListViewBase.md#nativebindings)
- [Navigation](ue_ue.ListViewBase.md#navigation)
- [NumDesignerPreviewEntries](ue_ue.ListViewBase.md#numdesignerpreviewentries)
- [RenderOpacity](ue_ue.ListViewBase.md#renderopacity)
- [RenderTransform](ue_ue.ListViewBase.md#rendertransform)
- [RenderTransformPivot](ue_ue.ListViewBase.md#rendertransformpivot)
- [Slot](ue_ue.ListViewBase.md#slot)
- [ToolTipText](ue_ue.ListViewBase.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.ListViewBase.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.ListViewBase.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.ListViewBase.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.ListViewBase.md#visibility)
- [VisibilityDelegate](ue_ue.ListViewBase.md#visibilitydelegate)
- [WheelScrollMultiplier](ue_ue.ListViewBase.md#wheelscrollmultiplier)
- [\_\_tid\_ListViewBase\_\_](ue_ue.ListViewBase.md#__tid_listviewbase__)
- [\_\_tid\_Object\_\_](ue_ue.ListViewBase.md#__tid_object__)
- [\_\_tid\_Visual\_\_](ue_ue.ListViewBase.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.ListViewBase.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.ListViewBase.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.ListViewBase.md#bcreatedbyconstructionscript)
- [bEnableFixedLineOffset](ue_ue.ListViewBase.md#benablefixedlineoffset)
- [bEnableScrollAnimation](ue_ue.ListViewBase.md#benablescrollanimation)
- [bExpandedInDesigner](ue_ue.ListViewBase.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.ListViewBase.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.ListViewBase.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.ListViewBase.md#bisenableddelegate)
- [bIsVariable](ue_ue.ListViewBase.md#bisvariable)
- [bIsVolatile](ue_ue.ListViewBase.md#bisvolatile)
- [bLockedInDesigner](ue_ue.ListViewBase.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.ListViewBase.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.ListViewBase.md#boverride_cursor)

### Methods

- [CreateDefaultSubobject](ue_ue.ListViewBase.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ListViewBase.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.ListViewBase.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.ListViewBase.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.ListViewBase.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.ListViewBase.md#generatewidgetforstring__delegatesignature)
- [GetBool\_\_DelegateSignature](ue_ue.ListViewBase.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.ListViewBase.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.ListViewBase.md#getcheckboxstate__delegatesignature)
- [GetClass](ue_ue.ListViewBase.md#getclass)
- [GetClipping](ue_ue.ListViewBase.md#getclipping)
- [GetDesiredSize](ue_ue.ListViewBase.md#getdesiredsize)
- [GetDisplayedEntryWidgets](ue_ue.ListViewBase.md#getdisplayedentrywidgets)
- [GetFloat\_\_DelegateSignature](ue_ue.ListViewBase.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.ListViewBase.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.ListViewBase.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.ListViewBase.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.ListViewBase.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.ListViewBase.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.ListViewBase.md#getname)
- [GetOuter](ue_ue.ListViewBase.md#getouter)
- [GetOwningLocalPlayer](ue_ue.ListViewBase.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.ListViewBase.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.ListViewBase.md#getpaintspacegeometry)
- [GetParent](ue_ue.ListViewBase.md#getparent)
- [GetRenderOpacity](ue_ue.ListViewBase.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.ListViewBase.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.ListViewBase.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.ListViewBase.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.ListViewBase.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.ListViewBase.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.ListViewBase.md#gettickspacegeometry)
- [GetVisibility](ue_ue.ListViewBase.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.ListViewBase.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.ListViewBase.md#getworld)
- [HasAnyUserFocus](ue_ue.ListViewBase.md#hasanyuserfocus)
- [HasFocusedDescendants](ue_ue.ListViewBase.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.ListViewBase.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.ListViewBase.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.ListViewBase.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.ListViewBase.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.ListViewBase.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.ListViewBase.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.ListViewBase.md#ishovered)
- [IsVisible](ue_ue.ListViewBase.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.ListViewBase.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.ListViewBase.md#onreply__delegatesignature)
- [RegenerateAllEntries](ue_ue.ListViewBase.md#regenerateallentries)
- [RemoveFromParent](ue_ue.ListViewBase.md#removefromparent)
- [RequestRefresh](ue_ue.ListViewBase.md#requestrefresh)
- [ResetCursor](ue_ue.ListViewBase.md#resetcursor)
- [ScrollToBottom](ue_ue.ListViewBase.md#scrolltobottom)
- [ScrollToTop](ue_ue.ListViewBase.md#scrolltotop)
- [SetAllNavigationRules](ue_ue.ListViewBase.md#setallnavigationrules)
- [SetClipping](ue_ue.ListViewBase.md#setclipping)
- [SetCursor](ue_ue.ListViewBase.md#setcursor)
- [SetFocus](ue_ue.ListViewBase.md#setfocus)
- [SetIsEnabled](ue_ue.ListViewBase.md#setisenabled)
- [SetKeyboardFocus](ue_ue.ListViewBase.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.ListViewBase.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.ListViewBase.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.ListViewBase.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.ListViewBase.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.ListViewBase.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.ListViewBase.md#setrenderopacity)
- [SetRenderScale](ue_ue.ListViewBase.md#setrenderscale)
- [SetRenderShear](ue_ue.ListViewBase.md#setrendershear)
- [SetRenderTransform](ue_ue.ListViewBase.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.ListViewBase.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.ListViewBase.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.ListViewBase.md#setrendertranslation)
- [SetScrollOffset](ue_ue.ListViewBase.md#setscrolloffset)
- [SetScrollbarVisibility](ue_ue.ListViewBase.md#setscrollbarvisibility)
- [SetToolTip](ue_ue.ListViewBase.md#settooltip)
- [SetToolTipText](ue_ue.ListViewBase.md#settooltiptext)
- [SetUserFocus](ue_ue.ListViewBase.md#setuserfocus)
- [SetVisibility](ue_ue.ListViewBase.md#setvisibility)
- [SetWheelScrollMultiplier](ue_ue.ListViewBase.md#setwheelscrollmultiplier)
- [Find](ue_ue.ListViewBase.md#find)
- [Load](ue_ue.ListViewBase.md#load)
- [StaticClass](ue_ue.ListViewBase.md#staticclass)

## Constructors

### constructor

• **new ListViewBase**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:45648](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45648)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ListViewBase`](ue_ue.ListViewBase.md)
...
[ue/ue.d.ts:45667](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45667)

___

### Load

▸ `Static` **Load**(`InName`): [`ListViewBase`](ue_ue.ListViewBase.md)
...
[ue/ue.d.ts:45668](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45668)
...
[ue/ue.d.ts:45666](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L45666)
