[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / LoadPackageCommandlet

# Class: LoadPackageCommandlet

[ue/ue](../modules/ue_ue.md).LoadPackageCommandlet
...
- [constructor](ue_ue.LoadPackageCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.LoadPackageCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.LoadPackageCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.LoadPackageCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.LoadPackageCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.LoadPackageCommandlet.md#helpweblink)
- [IsClient](ue_ue.LoadPackageCommandlet.md#isclient)
- [IsEditor](ue_ue.LoadPackageCommandlet.md#iseditor)
- [IsServer](ue_ue.LoadPackageCommandlet.md#isserver)
- [LogToConsole](ue_ue.LoadPackageCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.LoadPackageCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.LoadPackageCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.LoadPackageCommandlet.md#__tid_commandlet__)
- [\_\_tid\_LoadPackageCommandlet\_\_](ue_ue.LoadPackageCommandlet.md#__tid_loadpackagecommandlet__)
- [\_\_tid\_Object\_\_](ue_ue.LoadPackageCommandlet.md#__tid_object__)

### Methods

- [CreateDefaultSubobject](ue_ue.LoadPackageCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.LoadPackageCommandlet.md#executeubergraph)
- [GetClass](ue_ue.LoadPackageCommandlet.md#getclass)
- [GetName](ue_ue.LoadPackageCommandlet.md#getname)
- [GetOuter](ue_ue.LoadPackageCommandlet.md#getouter)
- [GetWorld](ue_ue.LoadPackageCommandlet.md#getworld)
- [Find](ue_ue.LoadPackageCommandlet.md#find)
- [Load](ue_ue.LoadPackageCommandlet.md#load)
- [StaticClass](ue_ue.LoadPackageCommandlet.md#staticclass)

## Constructors

### constructor

• **new LoadPackageCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:45961](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45961)
...
### \_\_tid\_LoadPackageCommandlet\_\_

• **\_\_tid\_LoadPackageCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:45966](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45966)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`LoadPackageCommandlet`](ue_ue.LoadPackageCommandlet.md)
...
[ue/ue.d.ts:45963](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45963)

___

### Load

▸ `Static` **Load**(`InName`): [`LoadPackageCommandlet`](ue_ue.LoadPackageCommandlet.md)
...
[ue/ue.d.ts:45964](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45964)
...
[ue/ue.d.ts:45962](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L45962)
