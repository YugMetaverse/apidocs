[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MagicLeapFileMediaSourceFactory

# Class: MagicLeapFileMediaSourceFactory

[ue/ue](../modules/ue_ue.md).MagicLeapFileMediaSourceFactory
...
- [constructor](ue_ue.MagicLeapFileMediaSourceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.MagicLeapFileMediaSourceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.MagicLeapFileMediaSourceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.MagicLeapFileMediaSourceFactory.md#contextclass)
- [Formats](ue_ue.MagicLeapFileMediaSourceFactory.md#formats)
- [ImportPriority](ue_ue.MagicLeapFileMediaSourceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.MagicLeapFileMediaSourceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.MagicLeapFileMediaSourceFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.MagicLeapFileMediaSourceFactory.md#__tid_factory__)
- [\_\_tid\_MagicLeapFileMediaSourceFactory\_\_](ue_ue.MagicLeapFileMediaSourceFactory.md#__tid_magicleapfilemediasourcefactory__)
- [\_\_tid\_Object\_\_](ue_ue.MagicLeapFileMediaSourceFactory.md#__tid_object__)
- [bCreateNew](ue_ue.MagicLeapFileMediaSourceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.MagicLeapFileMediaSourceFactory.md#beditafternew)
- [bEditorImport](ue_ue.MagicLeapFileMediaSourceFactory.md#beditorimport)
- [bText](ue_ue.MagicLeapFileMediaSourceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.MagicLeapFileMediaSourceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MagicLeapFileMediaSourceFactory.md#executeubergraph)
- [GetClass](ue_ue.MagicLeapFileMediaSourceFactory.md#getclass)
- [GetName](ue_ue.MagicLeapFileMediaSourceFactory.md#getname)
- [GetOuter](ue_ue.MagicLeapFileMediaSourceFactory.md#getouter)
- [GetWorld](ue_ue.MagicLeapFileMediaSourceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.MagicLeapFileMediaSourceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.MagicLeapFileMediaSourceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.MagicLeapFileMediaSourceFactory.md#find)
- [Load](ue_ue.MagicLeapFileMediaSourceFactory.md#load)
- [StaticClass](ue_ue.MagicLeapFileMediaSourceFactory.md#staticclass)

## Constructors

### constructor

• **new MagicLeapFileMediaSourceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:46666](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46666)
...
### \_\_tid\_MagicLeapFileMediaSourceFactory\_\_

• **\_\_tid\_MagicLeapFileMediaSourceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:46671](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46671)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MagicLeapFileMediaSourceFactory`](ue_ue.MagicLeapFileMediaSourceFactory.md)
...
[ue/ue.d.ts:46668](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46668)

___

### Load

▸ `Static` **Load**(`InName`): [`MagicLeapFileMediaSourceFactory`](ue_ue.MagicLeapFileMediaSourceFactory.md)
...
[ue/ue.d.ts:46669](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46669)
...
[ue/ue.d.ts:46667](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46667)
