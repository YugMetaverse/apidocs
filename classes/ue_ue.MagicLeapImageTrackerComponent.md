[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MagicLeapImageTrackerComponent

# Class: MagicLeapImageTrackerComponent

[ue/ue](../modules/ue_ue.md).MagicLeapImageTrackerComponent
...
- [constructor](ue_ue.MagicLeapImageTrackerComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.MagicLeapImageTrackerComponent.md#assetuserdata)
- [AttachChildren](ue_ue.MagicLeapImageTrackerComponent.md#attachchildren)
- [AttachParent](ue_ue.MagicLeapImageTrackerComponent.md#attachparent)
- [AttachSocketName](ue_ue.MagicLeapImageTrackerComponent.md#attachsocketname)
- [ClientAttachedChildren](ue_ue.MagicLeapImageTrackerComponent.md#clientattachedchildren)
- [ComponentTags](ue_ue.MagicLeapImageTrackerComponent.md#componenttags)
- [ComponentVelocity](ue_ue.MagicLeapImageTrackerComponent.md#componentvelocity)
- [CreationMethod](ue_ue.MagicLeapImageTrackerComponent.md#creationmethod)
- [DetailMode](ue_ue.MagicLeapImageTrackerComponent.md#detailmode)
- [LongerDimension](ue_ue.MagicLeapImageTrackerComponent.md#longerdimension)
- [Mobility](ue_ue.MagicLeapImageTrackerComponent.md#mobility)
- [Name](ue_ue.MagicLeapImageTrackerComponent.md#name)
- [OnComponentActivated](ue_ue.MagicLeapImageTrackerComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.MagicLeapImageTrackerComponent.md#oncomponentdeactivated)
- [OnImageTargetFound](ue_ue.MagicLeapImageTrackerComponent.md#onimagetargetfound)
- [OnImageTargetLost](ue_ue.MagicLeapImageTrackerComponent.md#onimagetargetlost)
- [OnImageTargetUnreliableTracking](ue_ue.MagicLeapImageTrackerComponent.md#onimagetargetunreliabletracking)
- [OnSetImageTargetFailed](ue_ue.MagicLeapImageTrackerComponent.md#onsetimagetargetfailed)
- [OnSetImageTargetSucceeded](ue_ue.MagicLeapImageTrackerComponent.md#onsetimagetargetsucceeded)
- [PhysicsVolume](ue_ue.MagicLeapImageTrackerComponent.md#physicsvolume)
- [PhysicsVolumeChangedDelegate](ue_ue.MagicLeapImageTrackerComponent.md#physicsvolumechangeddelegate)
- [PrimaryComponentTick](ue_ue.MagicLeapImageTrackerComponent.md#primarycomponenttick)
- [RelativeLocation](ue_ue.MagicLeapImageTrackerComponent.md#relativelocation)
- [RelativeRotation](ue_ue.MagicLeapImageTrackerComponent.md#relativerotation)
- [RelativeScale3D](ue_ue.MagicLeapImageTrackerComponent.md#relativescale3d)
- [TargetImageTexture](ue_ue.MagicLeapImageTrackerComponent.md#targetimagetexture)
- [UCSModifiedProperties](ue_ue.MagicLeapImageTrackerComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.MagicLeapImageTrackerComponent.md#__tid_actorcomponent__)
- [\_\_tid\_MagicLeapImageTrackerComponent\_\_](ue_ue.MagicLeapImageTrackerComponent.md#__tid_magicleapimagetrackercomponent__)
- [\_\_tid\_Object\_\_](ue_ue.MagicLeapImageTrackerComponent.md#__tid_object__)
- [\_\_tid\_SceneComponent\_\_](ue_ue.MagicLeapImageTrackerComponent.md#__tid_scenecomponent__)
- [bAbsoluteLocation](ue_ue.MagicLeapImageTrackerComponent.md#babsolutelocation)
- [bAbsoluteRotation](ue_ue.MagicLeapImageTrackerComponent.md#babsoluterotation)
- [bAbsoluteScale](ue_ue.MagicLeapImageTrackerComponent.md#babsolutescale)
- [bAutoActivate](ue_ue.MagicLeapImageTrackerComponent.md#bautoactivate)
- [bBoundsChangeTriggersStreamingDataRebuild](ue_ue.MagicLeapImageTrackerComponent.md#bboundschangetriggersstreamingdatarebuild)
- [bCanEverAffectNavigation](ue_ue.MagicLeapImageTrackerComponent.md#bcaneveraffectnavigation)
- [bComponentToWorldUpdated](ue_ue.MagicLeapImageTrackerComponent.md#bcomponenttoworldupdated)
- [bCreatedByConstructionScript](ue_ue.MagicLeapImageTrackerComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.MagicLeapImageTrackerComponent.md#beditablewheninherited)
- [bHiddenInGame](ue_ue.MagicLeapImageTrackerComponent.md#bhiddeningame)
- [bInstanceComponent](ue_ue.MagicLeapImageTrackerComponent.md#binstancecomponent)
- [bIsActive](ue_ue.MagicLeapImageTrackerComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.MagicLeapImageTrackerComponent.md#biseditoronly)
- [bIsStationary](ue_ue.MagicLeapImageTrackerComponent.md#bisstationary)
- [bIsVisualizationComponent](ue_ue.MagicLeapImageTrackerComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.MagicLeapImageTrackerComponent.md#bnetaddressable)
- [bReplicates](ue_ue.MagicLeapImageTrackerComponent.md#breplicates)
- [bShouldBeAttached](ue_ue.MagicLeapImageTrackerComponent.md#bshouldbeattached)
- [bShouldSnapLocationWhenAttached](ue_ue.MagicLeapImageTrackerComponent.md#bshouldsnaplocationwhenattached)
- [bShouldSnapRotationWhenAttached](ue_ue.MagicLeapImageTrackerComponent.md#bshouldsnaprotationwhenattached)
- [bShouldUpdatePhysicsVolume](ue_ue.MagicLeapImageTrackerComponent.md#bshouldupdatephysicsvolume)
- [bUseAttachParentBound](ue_ue.MagicLeapImageTrackerComponent.md#buseattachparentbound)
- [bUseUnreliablePose](ue_ue.MagicLeapImageTrackerComponent.md#buseunreliablepose)
- [bVisible](ue_ue.MagicLeapImageTrackerComponent.md#bvisible)
- [bVisualizeComponent](ue_ue.MagicLeapImageTrackerComponent.md#bvisualizecomponent)

### Methods

- [Activate](ue_ue.MagicLeapImageTrackerComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.MagicLeapImageTrackerComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.MagicLeapImageTrackerComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.MagicLeapImageTrackerComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.MagicLeapImageTrackerComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.MagicLeapImageTrackerComponent.md#deactivate)
- [DetachFromParent](ue_ue.MagicLeapImageTrackerComponent.md#detachfromparent)
- [DoesSocketExist](ue_ue.MagicLeapImageTrackerComponent.md#doessocketexist)
- [ExecuteUbergraph](ue_ue.MagicLeapImageTrackerComponent.md#executeubergraph)
- [GetAllSocketNames](ue_ue.MagicLeapImageTrackerComponent.md#getallsocketnames)
- [GetAttachParent](ue_ue.MagicLeapImageTrackerComponent.md#getattachparent)
- [GetAttachSocketName](ue_ue.MagicLeapImageTrackerComponent.md#getattachsocketname)
- [GetChildComponent](ue_ue.MagicLeapImageTrackerComponent.md#getchildcomponent)
- [GetChildrenComponents](ue_ue.MagicLeapImageTrackerComponent.md#getchildrencomponents)
- [GetClass](ue_ue.MagicLeapImageTrackerComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.MagicLeapImageTrackerComponent.md#getcomponenttickinterval)
- [GetComponentVelocity](ue_ue.MagicLeapImageTrackerComponent.md#getcomponentvelocity)
- [GetForwardVector](ue_ue.MagicLeapImageTrackerComponent.md#getforwardvector)
- [GetName](ue_ue.MagicLeapImageTrackerComponent.md#getname)
- [GetNumChildrenComponents](ue_ue.MagicLeapImageTrackerComponent.md#getnumchildrencomponents)
- [GetOuter](ue_ue.MagicLeapImageTrackerComponent.md#getouter)
- [GetOwner](ue_ue.MagicLeapImageTrackerComponent.md#getowner)
- [GetParentComponents](ue_ue.MagicLeapImageTrackerComponent.md#getparentcomponents)
- [GetPhysicsVolume](ue_ue.MagicLeapImageTrackerComponent.md#getphysicsvolume)
- [GetRelativeTransform](ue_ue.MagicLeapImageTrackerComponent.md#getrelativetransform)
- [GetRightVector](ue_ue.MagicLeapImageTrackerComponent.md#getrightvector)
- [GetShouldUpdatePhysicsVolume](ue_ue.MagicLeapImageTrackerComponent.md#getshouldupdatephysicsvolume)
- [GetSocketLocation](ue_ue.MagicLeapImageTrackerComponent.md#getsocketlocation)
- [GetSocketQuaternion](ue_ue.MagicLeapImageTrackerComponent.md#getsocketquaternion)
- [GetSocketRotation](ue_ue.MagicLeapImageTrackerComponent.md#getsocketrotation)
- [GetSocketTransform](ue_ue.MagicLeapImageTrackerComponent.md#getsockettransform)
- [GetUpVector](ue_ue.MagicLeapImageTrackerComponent.md#getupvector)
- [GetWorld](ue_ue.MagicLeapImageTrackerComponent.md#getworld)
- [IsActive](ue_ue.MagicLeapImageTrackerComponent.md#isactive)
- [IsAnySimulatingPhysics](ue_ue.MagicLeapImageTrackerComponent.md#isanysimulatingphysics)
- [IsBeingDestroyed](ue_ue.MagicLeapImageTrackerComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.MagicLeapImageTrackerComponent.md#iscomponenttickenabled)
- [IsSimulatingPhysics](ue_ue.MagicLeapImageTrackerComponent.md#issimulatingphysics)
- [IsVisible](ue_ue.MagicLeapImageTrackerComponent.md#isvisible)
- [K2\_AddLocalOffset](ue_ue.MagicLeapImageTrackerComponent.md#k2_addlocaloffset)
- [K2\_AddLocalRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_addlocalrotation)
- [K2\_AddLocalTransform](ue_ue.MagicLeapImageTrackerComponent.md#k2_addlocaltransform)
- [K2\_AddRelativeLocation](ue_ue.MagicLeapImageTrackerComponent.md#k2_addrelativelocation)
- [K2\_AddRelativeRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_addrelativerotation)
- [K2\_AddWorldOffset](ue_ue.MagicLeapImageTrackerComponent.md#k2_addworldoffset)
- [K2\_AddWorldRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_addworldrotation)
- [K2\_AddWorldTransform](ue_ue.MagicLeapImageTrackerComponent.md#k2_addworldtransform)
- [K2\_AttachTo](ue_ue.MagicLeapImageTrackerComponent.md#k2_attachto)
- [K2\_AttachToComponent](ue_ue.MagicLeapImageTrackerComponent.md#k2_attachtocomponent)
- [K2\_DestroyComponent](ue_ue.MagicLeapImageTrackerComponent.md#k2_destroycomponent)
- [K2\_DetachFromComponent](ue_ue.MagicLeapImageTrackerComponent.md#k2_detachfromcomponent)
- [K2\_GetComponentLocation](ue_ue.MagicLeapImageTrackerComponent.md#k2_getcomponentlocation)
- [K2\_GetComponentRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_getcomponentrotation)
- [K2\_GetComponentScale](ue_ue.MagicLeapImageTrackerComponent.md#k2_getcomponentscale)
- [K2\_GetComponentToWorld](ue_ue.MagicLeapImageTrackerComponent.md#k2_getcomponenttoworld)
- [K2\_SetRelativeLocation](ue_ue.MagicLeapImageTrackerComponent.md#k2_setrelativelocation)
- [K2\_SetRelativeLocationAndRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_setrelativelocationandrotation)
- [K2\_SetRelativeRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_setrelativerotation)
- [K2\_SetRelativeTransform](ue_ue.MagicLeapImageTrackerComponent.md#k2_setrelativetransform)
- [K2\_SetWorldLocation](ue_ue.MagicLeapImageTrackerComponent.md#k2_setworldlocation)
- [K2\_SetWorldLocationAndRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_setworldlocationandrotation)
- [K2\_SetWorldRotation](ue_ue.MagicLeapImageTrackerComponent.md#k2_setworldrotation)
- [K2\_SetWorldTransform](ue_ue.MagicLeapImageTrackerComponent.md#k2_setworldtransform)
- [OnRep\_AttachChildren](ue_ue.MagicLeapImageTrackerComponent.md#onrep_attachchildren)
- [OnRep\_AttachParent](ue_ue.MagicLeapImageTrackerComponent.md#onrep_attachparent)
- [OnRep\_AttachSocketName](ue_ue.MagicLeapImageTrackerComponent.md#onrep_attachsocketname)
- [OnRep\_IsActive](ue_ue.MagicLeapImageTrackerComponent.md#onrep_isactive)
- [OnRep\_Transform](ue_ue.MagicLeapImageTrackerComponent.md#onrep_transform)
- [OnRep\_Visibility](ue_ue.MagicLeapImageTrackerComponent.md#onrep_visibility)
- [ReceiveBeginPlay](ue_ue.MagicLeapImageTrackerComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.MagicLeapImageTrackerComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.MagicLeapImageTrackerComponent.md#receivetick)
- [RegisterComponent](ue_ue.MagicLeapImageTrackerComponent.md#registercomponent)
- [RemoveTargetAsync](ue_ue.MagicLeapImageTrackerComponent.md#removetargetasync)
- [RemoveTickPrerequisiteActor](ue_ue.MagicLeapImageTrackerComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.MagicLeapImageTrackerComponent.md#removetickprerequisitecomponent)
- [ResetRelativeTransform](ue_ue.MagicLeapImageTrackerComponent.md#resetrelativetransform)
- [SetAbsolute](ue_ue.MagicLeapImageTrackerComponent.md#setabsolute)
- [SetActive](ue_ue.MagicLeapImageTrackerComponent.md#setactive)
- [SetAutoActivate](ue_ue.MagicLeapImageTrackerComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.MagicLeapImageTrackerComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.MagicLeapImageTrackerComponent.md#setcomponenttickinterval)
- [SetHiddenInGame](ue_ue.MagicLeapImageTrackerComponent.md#sethiddeningame)
- [SetIsReplicated](ue_ue.MagicLeapImageTrackerComponent.md#setisreplicated)
- [SetMobility](ue_ue.MagicLeapImageTrackerComponent.md#setmobility)
- [SetRelativeScale3D](ue_ue.MagicLeapImageTrackerComponent.md#setrelativescale3d)
- [SetShouldUpdatePhysicsVolume](ue_ue.MagicLeapImageTrackerComponent.md#setshouldupdatephysicsvolume)
- [SetTargetAsync](ue_ue.MagicLeapImageTrackerComponent.md#settargetasync)
- [SetTickGroup](ue_ue.MagicLeapImageTrackerComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.MagicLeapImageTrackerComponent.md#settickablewhenpaused)
- [SetVisibility](ue_ue.MagicLeapImageTrackerComponent.md#setvisibility)
- [SetWorldScale3D](ue_ue.MagicLeapImageTrackerComponent.md#setworldscale3d)
- [SetupAttachment](ue_ue.MagicLeapImageTrackerComponent.md#setupattachment)
- [SnapTo](ue_ue.MagicLeapImageTrackerComponent.md#snapto)
- [ToggleActive](ue_ue.MagicLeapImageTrackerComponent.md#toggleactive)
- [ToggleVisibility](ue_ue.MagicLeapImageTrackerComponent.md#togglevisibility)
- [Find](ue_ue.MagicLeapImageTrackerComponent.md#find)
- [Load](ue_ue.MagicLeapImageTrackerComponent.md#load)
- [StaticClass](ue_ue.MagicLeapImageTrackerComponent.md#staticclass)

## Constructors

### constructor

• **new MagicLeapImageTrackerComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:46828](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46828)
...
[ue/ue.d.ts:46831](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46831)
...
[ue/ue.d.ts:46830](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46830)
...
• **OnImageTargetFound**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<() => `void`\>

#### Defined in

[ue/ue.d.ts:46836](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46836)

___

### OnImageTargetLost

• **OnImageTargetLost**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<() => `void`\>

#### Defined in

[ue/ue.d.ts:46837](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46837)

___

### OnImageTargetUnreliableTracking

• **OnImageTargetUnreliableTracking**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<(`LastTrackedLocation`: [`Vector`](ue_ue_s.Vector.md), `LastTrackedRotation`: [`Rotator`](ue_ue_s.Rotator.md), `NewUnreliableLocation`: [`Vector`](ue_ue_s.Vector.md), `NewUnreliableRotation`: [`Rotator`](ue_ue_s.Rotator.md)) => `void`\>

#### Defined in

[ue/ue.d.ts:46838](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46838)

___

### OnSetImageTargetFailed

• **OnSetImageTargetFailed**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<() => `void`\>

#### Defined in

[ue/ue.d.ts:46835](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46835)

___

### OnSetImageTargetSucceeded

• **OnSetImageTargetSucceeded**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<() => `void`\>

#### Defined in

[ue/ue.d.ts:46834](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46834)
...
• **TargetImageTexture**: [`Texture2D`](ue_ue.Texture2D.md)

#### Defined in

[ue/ue.d.ts:46829](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46829)
...
### \_\_tid\_MagicLeapImageTrackerComponent\_\_

• **\_\_tid\_MagicLeapImageTrackerComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:46845](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46845)
...
[ue/ue.d.ts:46832](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46832)
...
[ue/ue.d.ts:46833](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46833)
...
[ue/ue.d.ts:46839](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46839)
...
▸ **SetTargetAsync**(`ImageTarget`): `boolean`

#### Parameters

| Name | Type |
| :------ | :------ |
| `ImageTarget` | [`$Nullable`](../modules/puerts.md#$nullable)<[`Texture2D`](ue_ue.Texture2D.md)\> |
...
[ue/ue.d.ts:46840](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46840)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MagicLeapImageTrackerComponent`](ue_ue.MagicLeapImageTrackerComponent.md)
...
[ue/ue.d.ts:46842](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46842)

___

### Load

▸ `Static` **Load**(`InName`): [`MagicLeapImageTrackerComponent`](ue_ue.MagicLeapImageTrackerComponent.md)
...
[ue/ue.d.ts:46843](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46843)
...
[ue/ue.d.ts:46841](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L46841)
