[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionAtmosphericLightColor

# Class: MaterialExpressionAtmosphericLightColor

[ue/ue](../modules/ue_ue.md).MaterialExpressionAtmosphericLightColor
...
- [constructor](ue_ue.MaterialExpressionAtmosphericLightColor.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionAtmosphericLightColor.md#desc)
- [Function](ue_ue.MaterialExpressionAtmosphericLightColor.md#function)
- [GraphNode](ue_ue.MaterialExpressionAtmosphericLightColor.md#graphnode)
- [Material](ue_ue.MaterialExpressionAtmosphericLightColor.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionAtmosphericLightColor.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionAtmosphericLightColor.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionAtmosphericLightColor.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionAtmosphericLightColor.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionAtmosphericLightColor.md#outputs)
- [\_\_tid\_MaterialExpressionAtmosphericLightColor\_\_](ue_ue.MaterialExpressionAtmosphericLightColor.md#__tid_materialexpressionatmosphericlightcolor__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionAtmosphericLightColor.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionAtmosphericLightColor.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionAtmosphericLightColor.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionAtmosphericLightColor.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionAtmosphericLightColor.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionAtmosphericLightColor.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionAtmosphericLightColor.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionAtmosphericLightColor.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionAtmosphericLightColor.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionAtmosphericLightColor.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionAtmosphericLightColor.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionAtmosphericLightColor.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionAtmosphericLightColor.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionAtmosphericLightColor.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionAtmosphericLightColor.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionAtmosphericLightColor.md#getclass)
- [GetName](ue_ue.MaterialExpressionAtmosphericLightColor.md#getname)
- [GetOuter](ue_ue.MaterialExpressionAtmosphericLightColor.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionAtmosphericLightColor.md#getworld)
- [Find](ue_ue.MaterialExpressionAtmosphericLightColor.md#find)
- [Load](ue_ue.MaterialExpressionAtmosphericLightColor.md#load)
- [StaticClass](ue_ue.MaterialExpressionAtmosphericLightColor.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionAtmosphericLightColor**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47681](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47681)
...
### \_\_tid\_MaterialExpressionAtmosphericLightColor\_\_

• **\_\_tid\_MaterialExpressionAtmosphericLightColor\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47686](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47686)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionAtmosphericLightColor`](ue_ue.MaterialExpressionAtmosphericLightColor.md)
...
[ue/ue.d.ts:47683](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47683)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionAtmosphericLightColor`](ue_ue.MaterialExpressionAtmosphericLightColor.md)
...
[ue/ue.d.ts:47684](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47684)
...
[ue/ue.d.ts:47682](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47682)
