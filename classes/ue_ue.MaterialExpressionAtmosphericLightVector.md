[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionAtmosphericLightVector

# Class: MaterialExpressionAtmosphericLightVector

[ue/ue](../modules/ue_ue.md).MaterialExpressionAtmosphericLightVector
...
- [constructor](ue_ue.MaterialExpressionAtmosphericLightVector.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionAtmosphericLightVector.md#desc)
- [Function](ue_ue.MaterialExpressionAtmosphericLightVector.md#function)
- [GraphNode](ue_ue.MaterialExpressionAtmosphericLightVector.md#graphnode)
- [Material](ue_ue.MaterialExpressionAtmosphericLightVector.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionAtmosphericLightVector.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionAtmosphericLightVector.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionAtmosphericLightVector.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionAtmosphericLightVector.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionAtmosphericLightVector.md#outputs)
- [\_\_tid\_MaterialExpressionAtmosphericLightVector\_\_](ue_ue.MaterialExpressionAtmosphericLightVector.md#__tid_materialexpressionatmosphericlightvector__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionAtmosphericLightVector.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionAtmosphericLightVector.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionAtmosphericLightVector.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionAtmosphericLightVector.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionAtmosphericLightVector.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionAtmosphericLightVector.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionAtmosphericLightVector.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionAtmosphericLightVector.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionAtmosphericLightVector.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionAtmosphericLightVector.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionAtmosphericLightVector.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionAtmosphericLightVector.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionAtmosphericLightVector.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionAtmosphericLightVector.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionAtmosphericLightVector.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionAtmosphericLightVector.md#getclass)
- [GetName](ue_ue.MaterialExpressionAtmosphericLightVector.md#getname)
- [GetOuter](ue_ue.MaterialExpressionAtmosphericLightVector.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionAtmosphericLightVector.md#getworld)
- [Find](ue_ue.MaterialExpressionAtmosphericLightVector.md#find)
- [Load](ue_ue.MaterialExpressionAtmosphericLightVector.md#load)
- [StaticClass](ue_ue.MaterialExpressionAtmosphericLightVector.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionAtmosphericLightVector**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47690](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47690)
...
### \_\_tid\_MaterialExpressionAtmosphericLightVector\_\_

• **\_\_tid\_MaterialExpressionAtmosphericLightVector\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47695](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47695)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionAtmosphericLightVector`](ue_ue.MaterialExpressionAtmosphericLightVector.md)
...
[ue/ue.d.ts:47692](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47692)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionAtmosphericLightVector`](ue_ue.MaterialExpressionAtmosphericLightVector.md)
...
[ue/ue.d.ts:47693](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47693)
...
[ue/ue.d.ts:47691](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47691)
