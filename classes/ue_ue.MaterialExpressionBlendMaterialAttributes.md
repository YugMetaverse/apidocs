[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionBlendMaterialAttributes

# Class: MaterialExpressionBlendMaterialAttributes

[ue/ue](../modules/ue_ue.md).MaterialExpressionBlendMaterialAttributes
...
- [constructor](ue_ue.MaterialExpressionBlendMaterialAttributes.md#constructor)

### Properties

- [A](ue_ue.MaterialExpressionBlendMaterialAttributes.md#a)
- [Alpha](ue_ue.MaterialExpressionBlendMaterialAttributes.md#alpha)
- [B](ue_ue.MaterialExpressionBlendMaterialAttributes.md#b)
- [Desc](ue_ue.MaterialExpressionBlendMaterialAttributes.md#desc)
- [Function](ue_ue.MaterialExpressionBlendMaterialAttributes.md#function)
- [GraphNode](ue_ue.MaterialExpressionBlendMaterialAttributes.md#graphnode)
- [Material](ue_ue.MaterialExpressionBlendMaterialAttributes.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionBlendMaterialAttributes.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionBlendMaterialAttributes.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionBlendMaterialAttributes.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionBlendMaterialAttributes.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionBlendMaterialAttributes.md#outputs)
- [PixelAttributeBlendType](ue_ue.MaterialExpressionBlendMaterialAttributes.md#pixelattributeblendtype)
- [VertexAttributeBlendType](ue_ue.MaterialExpressionBlendMaterialAttributes.md#vertexattributeblendtype)
- [\_\_tid\_MaterialExpressionBlendMaterialAttributes\_\_](ue_ue.MaterialExpressionBlendMaterialAttributes.md#__tid_materialexpressionblendmaterialattributes__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionBlendMaterialAttributes.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionBlendMaterialAttributes.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionBlendMaterialAttributes.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionBlendMaterialAttributes.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionBlendMaterialAttributes.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionBlendMaterialAttributes.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionBlendMaterialAttributes.md#getclass)
- [GetName](ue_ue.MaterialExpressionBlendMaterialAttributes.md#getname)
- [GetOuter](ue_ue.MaterialExpressionBlendMaterialAttributes.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionBlendMaterialAttributes.md#getworld)
- [Find](ue_ue.MaterialExpressionBlendMaterialAttributes.md#find)
- [Load](ue_ue.MaterialExpressionBlendMaterialAttributes.md#load)
- [StaticClass](ue_ue.MaterialExpressionBlendMaterialAttributes.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionBlendMaterialAttributes**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47728](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47728)

## Properties

### A

• **A**: [`MaterialAttributesInput`](ue_ue.MaterialAttributesInput.md)

#### Defined in

[ue/ue.d.ts:47729](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47729)

___

### Alpha

• **Alpha**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:47731](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47731)

___

### B

• **B**: [`MaterialAttributesInput`](ue_ue.MaterialAttributesInput.md)

#### Defined in

[ue/ue.d.ts:47730](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47730)
...
• **PixelAttributeBlendType**: [`EMaterialAttributeBlend`](../enums/ue_ue.EMaterialAttributeBlend.md)

#### Defined in

[ue/ue.d.ts:47732](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47732)

___

### VertexAttributeBlendType

• **VertexAttributeBlendType**: [`EMaterialAttributeBlend`](../enums/ue_ue.EMaterialAttributeBlend.md)

#### Defined in

[ue/ue.d.ts:47733](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47733)

___

### \_\_tid\_MaterialExpressionBlendMaterialAttributes\_\_

• **\_\_tid\_MaterialExpressionBlendMaterialAttributes\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47738](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47738)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionBlendMaterialAttributes`](ue_ue.MaterialExpressionBlendMaterialAttributes.md)
...
[ue/ue.d.ts:47735](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47735)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionBlendMaterialAttributes`](ue_ue.MaterialExpressionBlendMaterialAttributes.md)
...
[ue/ue.d.ts:47736](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47736)
...
[ue/ue.d.ts:47734](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47734)
