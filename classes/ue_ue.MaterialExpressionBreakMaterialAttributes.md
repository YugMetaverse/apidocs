[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionBreakMaterialAttributes

# Class: MaterialExpressionBreakMaterialAttributes

[ue/ue](../modules/ue_ue.md).MaterialExpressionBreakMaterialAttributes
...
- [constructor](ue_ue.MaterialExpressionBreakMaterialAttributes.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionBreakMaterialAttributes.md#desc)
- [Function](ue_ue.MaterialExpressionBreakMaterialAttributes.md#function)
- [GraphNode](ue_ue.MaterialExpressionBreakMaterialAttributes.md#graphnode)
- [Material](ue_ue.MaterialExpressionBreakMaterialAttributes.md#material)
- [MaterialAttributes](ue_ue.MaterialExpressionBreakMaterialAttributes.md#materialattributes)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionBreakMaterialAttributes.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionBreakMaterialAttributes.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionBreakMaterialAttributes.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionBreakMaterialAttributes.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionBreakMaterialAttributes.md#outputs)
- [\_\_tid\_MaterialExpressionBreakMaterialAttributes\_\_](ue_ue.MaterialExpressionBreakMaterialAttributes.md#__tid_materialexpressionbreakmaterialattributes__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionBreakMaterialAttributes.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionBreakMaterialAttributes.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionBreakMaterialAttributes.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionBreakMaterialAttributes.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionBreakMaterialAttributes.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionBreakMaterialAttributes.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionBreakMaterialAttributes.md#getclass)
- [GetName](ue_ue.MaterialExpressionBreakMaterialAttributes.md#getname)
- [GetOuter](ue_ue.MaterialExpressionBreakMaterialAttributes.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionBreakMaterialAttributes.md#getworld)
- [Find](ue_ue.MaterialExpressionBreakMaterialAttributes.md#find)
- [Load](ue_ue.MaterialExpressionBreakMaterialAttributes.md#load)
- [StaticClass](ue_ue.MaterialExpressionBreakMaterialAttributes.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionBreakMaterialAttributes**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47742](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47742)
...
[ue/ue.d.ts:47743](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47743)
...
### \_\_tid\_MaterialExpressionBreakMaterialAttributes\_\_

• **\_\_tid\_MaterialExpressionBreakMaterialAttributes\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47748](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47748)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionBreakMaterialAttributes`](ue_ue.MaterialExpressionBreakMaterialAttributes.md)
...
[ue/ue.d.ts:47745](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47745)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionBreakMaterialAttributes`](ue_ue.MaterialExpressionBreakMaterialAttributes.md)
...
[ue/ue.d.ts:47746](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47746)
...
[ue/ue.d.ts:47744](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47744)
