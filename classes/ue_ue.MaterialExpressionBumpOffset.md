[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionBumpOffset

# Class: MaterialExpressionBumpOffset

[ue/ue](../modules/ue_ue.md).MaterialExpressionBumpOffset
...
- [constructor](ue_ue.MaterialExpressionBumpOffset.md#constructor)

### Properties

- [ConstCoordinate](ue_ue.MaterialExpressionBumpOffset.md#constcoordinate)
- [Coordinate](ue_ue.MaterialExpressionBumpOffset.md#coordinate)
- [Desc](ue_ue.MaterialExpressionBumpOffset.md#desc)
- [Function](ue_ue.MaterialExpressionBumpOffset.md#function)
- [GraphNode](ue_ue.MaterialExpressionBumpOffset.md#graphnode)
- [Height](ue_ue.MaterialExpressionBumpOffset.md#height)
- [HeightRatio](ue_ue.MaterialExpressionBumpOffset.md#heightratio)
- [HeightRatioInput](ue_ue.MaterialExpressionBumpOffset.md#heightratioinput)
- [Material](ue_ue.MaterialExpressionBumpOffset.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionBumpOffset.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionBumpOffset.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionBumpOffset.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionBumpOffset.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionBumpOffset.md#outputs)
- [ReferencePlane](ue_ue.MaterialExpressionBumpOffset.md#referenceplane)
- [\_\_tid\_MaterialExpressionBumpOffset\_\_](ue_ue.MaterialExpressionBumpOffset.md#__tid_materialexpressionbumpoffset__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionBumpOffset.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionBumpOffset.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionBumpOffset.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionBumpOffset.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionBumpOffset.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionBumpOffset.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionBumpOffset.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionBumpOffset.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionBumpOffset.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionBumpOffset.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionBumpOffset.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionBumpOffset.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionBumpOffset.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionBumpOffset.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionBumpOffset.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionBumpOffset.md#getclass)
- [GetName](ue_ue.MaterialExpressionBumpOffset.md#getname)
- [GetOuter](ue_ue.MaterialExpressionBumpOffset.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionBumpOffset.md#getworld)
- [Find](ue_ue.MaterialExpressionBumpOffset.md#find)
- [Load](ue_ue.MaterialExpressionBumpOffset.md#load)
- [StaticClass](ue_ue.MaterialExpressionBumpOffset.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionBumpOffset**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47752](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47752)
...
[ue/ue.d.ts:47758](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47758)
...
[ue/ue.d.ts:47753](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47753)
...
• **Height**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:47754](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47754)
...
[ue/ue.d.ts:47756](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47756)

___

### HeightRatioInput

• **HeightRatioInput**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:47755](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47755)
...
[ue/ue.d.ts:47757](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47757)

___

### \_\_tid\_MaterialExpressionBumpOffset\_\_

• **\_\_tid\_MaterialExpressionBumpOffset\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47763](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47763)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionBumpOffset`](ue_ue.MaterialExpressionBumpOffset.md)
...
[ue/ue.d.ts:47760](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47760)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionBumpOffset`](ue_ue.MaterialExpressionBumpOffset.md)
...
[ue/ue.d.ts:47761](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47761)
...
[ue/ue.d.ts:47759](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47759)
