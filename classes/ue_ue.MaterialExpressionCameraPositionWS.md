[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionCameraPositionWS

# Class: MaterialExpressionCameraPositionWS

[ue/ue](../modules/ue_ue.md).MaterialExpressionCameraPositionWS
...
- [constructor](ue_ue.MaterialExpressionCameraPositionWS.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionCameraPositionWS.md#desc)
- [Function](ue_ue.MaterialExpressionCameraPositionWS.md#function)
- [GraphNode](ue_ue.MaterialExpressionCameraPositionWS.md#graphnode)
- [Material](ue_ue.MaterialExpressionCameraPositionWS.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionCameraPositionWS.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionCameraPositionWS.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionCameraPositionWS.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionCameraPositionWS.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionCameraPositionWS.md#outputs)
- [\_\_tid\_MaterialExpressionCameraPositionWS\_\_](ue_ue.MaterialExpressionCameraPositionWS.md#__tid_materialexpressioncamerapositionws__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionCameraPositionWS.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionCameraPositionWS.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionCameraPositionWS.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionCameraPositionWS.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionCameraPositionWS.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionCameraPositionWS.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionCameraPositionWS.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionCameraPositionWS.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionCameraPositionWS.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionCameraPositionWS.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionCameraPositionWS.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionCameraPositionWS.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionCameraPositionWS.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionCameraPositionWS.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionCameraPositionWS.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionCameraPositionWS.md#getclass)
- [GetName](ue_ue.MaterialExpressionCameraPositionWS.md#getname)
- [GetOuter](ue_ue.MaterialExpressionCameraPositionWS.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionCameraPositionWS.md#getworld)
- [Find](ue_ue.MaterialExpressionCameraPositionWS.md#find)
- [Load](ue_ue.MaterialExpressionCameraPositionWS.md#load)
- [StaticClass](ue_ue.MaterialExpressionCameraPositionWS.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionCameraPositionWS**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47767](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47767)
...
### \_\_tid\_MaterialExpressionCameraPositionWS\_\_

• **\_\_tid\_MaterialExpressionCameraPositionWS\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47772](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47772)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionCameraPositionWS`](ue_ue.MaterialExpressionCameraPositionWS.md)
...
[ue/ue.d.ts:47769](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47769)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionCameraPositionWS`](ue_ue.MaterialExpressionCameraPositionWS.md)
...
[ue/ue.d.ts:47770](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47770)
...
[ue/ue.d.ts:47768](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47768)
