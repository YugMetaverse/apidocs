[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionClamp

# Class: MaterialExpressionClamp

[ue/ue](../modules/ue_ue.md).MaterialExpressionClamp
...
- [constructor](ue_ue.MaterialExpressionClamp.md#constructor)

### Properties

- [ClampMode](ue_ue.MaterialExpressionClamp.md#clampmode)
- [Desc](ue_ue.MaterialExpressionClamp.md#desc)
- [Function](ue_ue.MaterialExpressionClamp.md#function)
- [GraphNode](ue_ue.MaterialExpressionClamp.md#graphnode)
- [Input](ue_ue.MaterialExpressionClamp.md#input)
- [Material](ue_ue.MaterialExpressionClamp.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionClamp.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionClamp.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionClamp.md#materialexpressionguid)
- [Max](ue_ue.MaterialExpressionClamp.md#max)
- [MaxDefault](ue_ue.MaterialExpressionClamp.md#maxdefault)
- [MenuCategories](ue_ue.MaterialExpressionClamp.md#menucategories)
- [Min](ue_ue.MaterialExpressionClamp.md#min)
- [MinDefault](ue_ue.MaterialExpressionClamp.md#mindefault)
- [Outputs](ue_ue.MaterialExpressionClamp.md#outputs)
- [\_\_tid\_MaterialExpressionClamp\_\_](ue_ue.MaterialExpressionClamp.md#__tid_materialexpressionclamp__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionClamp.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionClamp.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionClamp.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionClamp.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionClamp.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionClamp.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionClamp.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionClamp.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionClamp.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionClamp.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionClamp.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionClamp.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionClamp.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionClamp.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionClamp.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionClamp.md#getclass)
- [GetName](ue_ue.MaterialExpressionClamp.md#getname)
- [GetOuter](ue_ue.MaterialExpressionClamp.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionClamp.md#getworld)
- [Find](ue_ue.MaterialExpressionClamp.md#find)
- [Load](ue_ue.MaterialExpressionClamp.md#load)
- [StaticClass](ue_ue.MaterialExpressionClamp.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionClamp**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47832](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47832)

## Properties

### ClampMode

• **ClampMode**: [`EClampMode`](../enums/ue_ue.EClampMode.md)

#### Defined in

[ue/ue.d.ts:47836](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47836)
...
[ue/ue.d.ts:47833](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47833)
...
• **Max**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:47835](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47835)
...
[ue/ue.d.ts:47838](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47838)
...
• **Min**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:47834](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47834)
...
[ue/ue.d.ts:47837](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47837)
...
### \_\_tid\_MaterialExpressionClamp\_\_

• **\_\_tid\_MaterialExpressionClamp\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47843](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47843)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionClamp`](ue_ue.MaterialExpressionClamp.md)
...
[ue/ue.d.ts:47840](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47840)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionClamp`](ue_ue.MaterialExpressionClamp.md)
...
[ue/ue.d.ts:47841](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47841)
...
[ue/ue.d.ts:47839](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47839)
