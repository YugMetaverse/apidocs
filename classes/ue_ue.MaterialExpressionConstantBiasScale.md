[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionConstantBiasScale

# Class: MaterialExpressionConstantBiasScale

[ue/ue](../modules/ue_ue.md).MaterialExpressionConstantBiasScale
...
- [constructor](ue_ue.MaterialExpressionConstantBiasScale.md#constructor)

### Properties

- [Bias](ue_ue.MaterialExpressionConstantBiasScale.md#bias)
- [Desc](ue_ue.MaterialExpressionConstantBiasScale.md#desc)
- [Function](ue_ue.MaterialExpressionConstantBiasScale.md#function)
- [GraphNode](ue_ue.MaterialExpressionConstantBiasScale.md#graphnode)
- [Input](ue_ue.MaterialExpressionConstantBiasScale.md#input)
- [Material](ue_ue.MaterialExpressionConstantBiasScale.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionConstantBiasScale.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionConstantBiasScale.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionConstantBiasScale.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionConstantBiasScale.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionConstantBiasScale.md#outputs)
- [Scale](ue_ue.MaterialExpressionConstantBiasScale.md#scale)
- [\_\_tid\_MaterialExpressionConstantBiasScale\_\_](ue_ue.MaterialExpressionConstantBiasScale.md#__tid_materialexpressionconstantbiasscale__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionConstantBiasScale.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionConstantBiasScale.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionConstantBiasScale.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionConstantBiasScale.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionConstantBiasScale.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionConstantBiasScale.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionConstantBiasScale.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionConstantBiasScale.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionConstantBiasScale.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionConstantBiasScale.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionConstantBiasScale.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionConstantBiasScale.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionConstantBiasScale.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionConstantBiasScale.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionConstantBiasScale.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionConstantBiasScale.md#getclass)
- [GetName](ue_ue.MaterialExpressionConstantBiasScale.md#getname)
- [GetOuter](ue_ue.MaterialExpressionConstantBiasScale.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionConstantBiasScale.md#getworld)
- [Find](ue_ue.MaterialExpressionConstantBiasScale.md#find)
- [Load](ue_ue.MaterialExpressionConstantBiasScale.md#load)
- [StaticClass](ue_ue.MaterialExpressionConstantBiasScale.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionConstantBiasScale**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47924](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47924)
...
[ue/ue.d.ts:47926](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47926)
...
[ue/ue.d.ts:47925](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47925)
...
[ue/ue.d.ts:47927](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47927)

___

### \_\_tid\_MaterialExpressionConstantBiasScale\_\_

• **\_\_tid\_MaterialExpressionConstantBiasScale\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:47932](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47932)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionConstantBiasScale`](ue_ue.MaterialExpressionConstantBiasScale.md)
...
[ue/ue.d.ts:47929](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47929)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionConstantBiasScale`](ue_ue.MaterialExpressionConstantBiasScale.md)
...
[ue/ue.d.ts:47930](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47930)
...
[ue/ue.d.ts:47928](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L47928)
