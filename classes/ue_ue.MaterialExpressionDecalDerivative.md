[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionDecalDerivative

# Class: MaterialExpressionDecalDerivative

[ue/ue](../modules/ue_ue.md).MaterialExpressionDecalDerivative
...
- [constructor](ue_ue.MaterialExpressionDecalDerivative.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionDecalDerivative.md#desc)
- [Function](ue_ue.MaterialExpressionDecalDerivative.md#function)
- [GraphNode](ue_ue.MaterialExpressionDecalDerivative.md#graphnode)
- [Material](ue_ue.MaterialExpressionDecalDerivative.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionDecalDerivative.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionDecalDerivative.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionDecalDerivative.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionDecalDerivative.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionDecalDerivative.md#outputs)
- [\_\_tid\_MaterialExpressionDecalDerivative\_\_](ue_ue.MaterialExpressionDecalDerivative.md#__tid_materialexpressiondecalderivative__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionDecalDerivative.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionDecalDerivative.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionDecalDerivative.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionDecalDerivative.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionDecalDerivative.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionDecalDerivative.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionDecalDerivative.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionDecalDerivative.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionDecalDerivative.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionDecalDerivative.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionDecalDerivative.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionDecalDerivative.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionDecalDerivative.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionDecalDerivative.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionDecalDerivative.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionDecalDerivative.md#getclass)
- [GetName](ue_ue.MaterialExpressionDecalDerivative.md#getname)
- [GetOuter](ue_ue.MaterialExpressionDecalDerivative.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionDecalDerivative.md#getworld)
- [Find](ue_ue.MaterialExpressionDecalDerivative.md#find)
- [Load](ue_ue.MaterialExpressionDecalDerivative.md#load)
- [StaticClass](ue_ue.MaterialExpressionDecalDerivative.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionDecalDerivative**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48030](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48030)
...
### \_\_tid\_MaterialExpressionDecalDerivative\_\_

• **\_\_tid\_MaterialExpressionDecalDerivative\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48035](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48035)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionDecalDerivative`](ue_ue.MaterialExpressionDecalDerivative.md)
...
[ue/ue.d.ts:48032](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48032)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionDecalDerivative`](ue_ue.MaterialExpressionDecalDerivative.md)
...
[ue/ue.d.ts:48033](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48033)
...
[ue/ue.d.ts:48031](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48031)
