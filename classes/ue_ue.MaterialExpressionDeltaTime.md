[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionDeltaTime

# Class: MaterialExpressionDeltaTime

[ue/ue](../modules/ue_ue.md).MaterialExpressionDeltaTime
...
- [constructor](ue_ue.MaterialExpressionDeltaTime.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionDeltaTime.md#desc)
- [Function](ue_ue.MaterialExpressionDeltaTime.md#function)
- [GraphNode](ue_ue.MaterialExpressionDeltaTime.md#graphnode)
- [Material](ue_ue.MaterialExpressionDeltaTime.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionDeltaTime.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionDeltaTime.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionDeltaTime.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionDeltaTime.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionDeltaTime.md#outputs)
- [\_\_tid\_MaterialExpressionDeltaTime\_\_](ue_ue.MaterialExpressionDeltaTime.md#__tid_materialexpressiondeltatime__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionDeltaTime.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionDeltaTime.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionDeltaTime.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionDeltaTime.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionDeltaTime.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionDeltaTime.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionDeltaTime.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionDeltaTime.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionDeltaTime.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionDeltaTime.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionDeltaTime.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionDeltaTime.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionDeltaTime.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionDeltaTime.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionDeltaTime.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionDeltaTime.md#getclass)
- [GetName](ue_ue.MaterialExpressionDeltaTime.md#getname)
- [GetOuter](ue_ue.MaterialExpressionDeltaTime.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionDeltaTime.md#getworld)
- [Find](ue_ue.MaterialExpressionDeltaTime.md#find)
- [Load](ue_ue.MaterialExpressionDeltaTime.md#load)
- [StaticClass](ue_ue.MaterialExpressionDeltaTime.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionDeltaTime**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48060](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48060)
...
### \_\_tid\_MaterialExpressionDeltaTime\_\_

• **\_\_tid\_MaterialExpressionDeltaTime\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48065](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48065)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionDeltaTime`](ue_ue.MaterialExpressionDeltaTime.md)
...
[ue/ue.d.ts:48062](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48062)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionDeltaTime`](ue_ue.MaterialExpressionDeltaTime.md)
...
[ue/ue.d.ts:48063](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48063)
...
[ue/ue.d.ts:48061](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48061)
