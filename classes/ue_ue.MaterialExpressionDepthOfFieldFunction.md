[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionDepthOfFieldFunction

# Class: MaterialExpressionDepthOfFieldFunction

[ue/ue](../modules/ue_ue.md).MaterialExpressionDepthOfFieldFunction
...
- [constructor](ue_ue.MaterialExpressionDepthOfFieldFunction.md#constructor)

### Properties

- [Depth](ue_ue.MaterialExpressionDepthOfFieldFunction.md#depth)
- [Desc](ue_ue.MaterialExpressionDepthOfFieldFunction.md#desc)
- [Function](ue_ue.MaterialExpressionDepthOfFieldFunction.md#function)
- [FunctionValue](ue_ue.MaterialExpressionDepthOfFieldFunction.md#functionvalue)
- [GraphNode](ue_ue.MaterialExpressionDepthOfFieldFunction.md#graphnode)
- [Material](ue_ue.MaterialExpressionDepthOfFieldFunction.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionDepthOfFieldFunction.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionDepthOfFieldFunction.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionDepthOfFieldFunction.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionDepthOfFieldFunction.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionDepthOfFieldFunction.md#outputs)
- [\_\_tid\_MaterialExpressionDepthOfFieldFunction\_\_](ue_ue.MaterialExpressionDepthOfFieldFunction.md#__tid_materialexpressiondepthoffieldfunction__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionDepthOfFieldFunction.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionDepthOfFieldFunction.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionDepthOfFieldFunction.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionDepthOfFieldFunction.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionDepthOfFieldFunction.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionDepthOfFieldFunction.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionDepthOfFieldFunction.md#getclass)
- [GetName](ue_ue.MaterialExpressionDepthOfFieldFunction.md#getname)
- [GetOuter](ue_ue.MaterialExpressionDepthOfFieldFunction.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionDepthOfFieldFunction.md#getworld)
- [Find](ue_ue.MaterialExpressionDepthOfFieldFunction.md#find)
- [Load](ue_ue.MaterialExpressionDepthOfFieldFunction.md#load)
- [StaticClass](ue_ue.MaterialExpressionDepthOfFieldFunction.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionDepthOfFieldFunction**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48082](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48082)

## Properties

### Depth

• **Depth**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48084](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48084)
...
• **FunctionValue**: [`EDepthOfFieldFunctionValue`](../enums/ue_ue.EDepthOfFieldFunctionValue.md)

#### Defined in

[ue/ue.d.ts:48083](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48083)
...
### \_\_tid\_MaterialExpressionDepthOfFieldFunction\_\_

• **\_\_tid\_MaterialExpressionDepthOfFieldFunction\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48089](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48089)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionDepthOfFieldFunction`](ue_ue.MaterialExpressionDepthOfFieldFunction.md)
...
[ue/ue.d.ts:48086](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48086)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionDepthOfFieldFunction`](ue_ue.MaterialExpressionDepthOfFieldFunction.md)
...
[ue/ue.d.ts:48087](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48087)
...
[ue/ue.d.ts:48085](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48085)
