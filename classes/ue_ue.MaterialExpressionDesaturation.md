[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionDesaturation

# Class: MaterialExpressionDesaturation

[ue/ue](../modules/ue_ue.md).MaterialExpressionDesaturation
...
- [constructor](ue_ue.MaterialExpressionDesaturation.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionDesaturation.md#desc)
- [Fraction](ue_ue.MaterialExpressionDesaturation.md#fraction)
- [Function](ue_ue.MaterialExpressionDesaturation.md#function)
- [GraphNode](ue_ue.MaterialExpressionDesaturation.md#graphnode)
- [Input](ue_ue.MaterialExpressionDesaturation.md#input)
- [LuminanceFactors](ue_ue.MaterialExpressionDesaturation.md#luminancefactors)
- [Material](ue_ue.MaterialExpressionDesaturation.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionDesaturation.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionDesaturation.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionDesaturation.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionDesaturation.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionDesaturation.md#outputs)
- [\_\_tid\_MaterialExpressionDesaturation\_\_](ue_ue.MaterialExpressionDesaturation.md#__tid_materialexpressiondesaturation__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionDesaturation.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionDesaturation.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionDesaturation.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionDesaturation.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionDesaturation.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionDesaturation.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionDesaturation.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionDesaturation.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionDesaturation.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionDesaturation.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionDesaturation.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionDesaturation.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionDesaturation.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionDesaturation.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionDesaturation.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionDesaturation.md#getclass)
- [GetName](ue_ue.MaterialExpressionDesaturation.md#getname)
- [GetOuter](ue_ue.MaterialExpressionDesaturation.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionDesaturation.md#getworld)
- [Find](ue_ue.MaterialExpressionDesaturation.md#find)
- [Load](ue_ue.MaterialExpressionDesaturation.md#load)
- [StaticClass](ue_ue.MaterialExpressionDesaturation.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionDesaturation**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48103](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48103)
...
• **Fraction**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48105](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48105)
...
[ue/ue.d.ts:48104](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48104)

___

### LuminanceFactors

• **LuminanceFactors**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:48106](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48106)
...
### \_\_tid\_MaterialExpressionDesaturation\_\_

• **\_\_tid\_MaterialExpressionDesaturation\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48111](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48111)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionDesaturation`](ue_ue.MaterialExpressionDesaturation.md)
...
[ue/ue.d.ts:48108](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48108)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionDesaturation`](ue_ue.MaterialExpressionDesaturation.md)
...
[ue/ue.d.ts:48109](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48109)
...
[ue/ue.d.ts:48107](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48107)
