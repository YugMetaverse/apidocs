[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionDistanceToNearestSurface

# Class: MaterialExpressionDistanceToNearestSurface

[ue/ue](../modules/ue_ue.md).MaterialExpressionDistanceToNearestSurface
...
- [constructor](ue_ue.MaterialExpressionDistanceToNearestSurface.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionDistanceToNearestSurface.md#desc)
- [Function](ue_ue.MaterialExpressionDistanceToNearestSurface.md#function)
- [GraphNode](ue_ue.MaterialExpressionDistanceToNearestSurface.md#graphnode)
- [Material](ue_ue.MaterialExpressionDistanceToNearestSurface.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionDistanceToNearestSurface.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionDistanceToNearestSurface.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionDistanceToNearestSurface.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionDistanceToNearestSurface.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionDistanceToNearestSurface.md#outputs)
- [Position](ue_ue.MaterialExpressionDistanceToNearestSurface.md#position)
- [\_\_tid\_MaterialExpressionDistanceToNearestSurface\_\_](ue_ue.MaterialExpressionDistanceToNearestSurface.md#__tid_materialexpressiondistancetonearestsurface__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionDistanceToNearestSurface.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionDistanceToNearestSurface.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionDistanceToNearestSurface.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionDistanceToNearestSurface.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionDistanceToNearestSurface.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionDistanceToNearestSurface.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionDistanceToNearestSurface.md#getclass)
- [GetName](ue_ue.MaterialExpressionDistanceToNearestSurface.md#getname)
- [GetOuter](ue_ue.MaterialExpressionDistanceToNearestSurface.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionDistanceToNearestSurface.md#getworld)
- [Find](ue_ue.MaterialExpressionDistanceToNearestSurface.md#find)
- [Load](ue_ue.MaterialExpressionDistanceToNearestSurface.md#load)
- [StaticClass](ue_ue.MaterialExpressionDistanceToNearestSurface.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionDistanceToNearestSurface**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48145](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48145)
...
[ue/ue.d.ts:48146](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48146)

___

### \_\_tid\_MaterialExpressionDistanceToNearestSurface\_\_

• **\_\_tid\_MaterialExpressionDistanceToNearestSurface\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48151](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48151)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionDistanceToNearestSurface`](ue_ue.MaterialExpressionDistanceToNearestSurface.md)
...
[ue/ue.d.ts:48148](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48148)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionDistanceToNearestSurface`](ue_ue.MaterialExpressionDistanceToNearestSurface.md)
...
[ue/ue.d.ts:48149](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48149)
...
[ue/ue.d.ts:48147](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48147)
