[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionDynamicParameter

# Class: MaterialExpressionDynamicParameter

[ue/ue](../modules/ue_ue.md).MaterialExpressionDynamicParameter
...
- [constructor](ue_ue.MaterialExpressionDynamicParameter.md#constructor)

### Properties

- [DefaultValue](ue_ue.MaterialExpressionDynamicParameter.md#defaultvalue)
- [Desc](ue_ue.MaterialExpressionDynamicParameter.md#desc)
- [Function](ue_ue.MaterialExpressionDynamicParameter.md#function)
- [GraphNode](ue_ue.MaterialExpressionDynamicParameter.md#graphnode)
- [Material](ue_ue.MaterialExpressionDynamicParameter.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionDynamicParameter.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionDynamicParameter.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionDynamicParameter.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionDynamicParameter.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionDynamicParameter.md#outputs)
- [ParamNames](ue_ue.MaterialExpressionDynamicParameter.md#paramnames)
- [ParameterIndex](ue_ue.MaterialExpressionDynamicParameter.md#parameterindex)
- [\_\_tid\_MaterialExpressionDynamicParameter\_\_](ue_ue.MaterialExpressionDynamicParameter.md#__tid_materialexpressiondynamicparameter__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionDynamicParameter.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionDynamicParameter.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionDynamicParameter.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionDynamicParameter.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionDynamicParameter.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionDynamicParameter.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionDynamicParameter.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionDynamicParameter.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionDynamicParameter.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionDynamicParameter.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionDynamicParameter.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionDynamicParameter.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionDynamicParameter.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionDynamicParameter.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionDynamicParameter.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionDynamicParameter.md#getclass)
- [GetName](ue_ue.MaterialExpressionDynamicParameter.md#getname)
- [GetOuter](ue_ue.MaterialExpressionDynamicParameter.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionDynamicParameter.md#getworld)
- [Find](ue_ue.MaterialExpressionDynamicParameter.md#find)
- [Load](ue_ue.MaterialExpressionDynamicParameter.md#load)
- [StaticClass](ue_ue.MaterialExpressionDynamicParameter.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionDynamicParameter**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48179](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48179)
...
[ue/ue.d.ts:48181](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48181)
...
• **ParamNames**: [`TArray`](../interfaces/ue_puerts.TArray.md)<`string`\>

#### Defined in

[ue/ue.d.ts:48180](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48180)
...
[ue/ue.d.ts:48182](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48182)

___

### \_\_tid\_MaterialExpressionDynamicParameter\_\_

• **\_\_tid\_MaterialExpressionDynamicParameter\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48187](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48187)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionDynamicParameter`](ue_ue.MaterialExpressionDynamicParameter.md)
...
[ue/ue.d.ts:48184](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48184)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionDynamicParameter`](ue_ue.MaterialExpressionDynamicParameter.md)
...
[ue/ue.d.ts:48185](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48185)
...
[ue/ue.d.ts:48183](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48183)
