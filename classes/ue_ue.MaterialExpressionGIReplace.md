[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionGIReplace

# Class: MaterialExpressionGIReplace

[ue/ue](../modules/ue_ue.md).MaterialExpressionGIReplace
...
- [constructor](ue_ue.MaterialExpressionGIReplace.md#constructor)

### Properties

- [Default](ue_ue.MaterialExpressionGIReplace.md#default)
- [Desc](ue_ue.MaterialExpressionGIReplace.md#desc)
- [DynamicIndirect](ue_ue.MaterialExpressionGIReplace.md#dynamicindirect)
- [Function](ue_ue.MaterialExpressionGIReplace.md#function)
- [GraphNode](ue_ue.MaterialExpressionGIReplace.md#graphnode)
- [Material](ue_ue.MaterialExpressionGIReplace.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionGIReplace.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionGIReplace.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionGIReplace.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionGIReplace.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionGIReplace.md#outputs)
- [StaticIndirect](ue_ue.MaterialExpressionGIReplace.md#staticindirect)
- [\_\_tid\_MaterialExpressionGIReplace\_\_](ue_ue.MaterialExpressionGIReplace.md#__tid_materialexpressiongireplace__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionGIReplace.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionGIReplace.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionGIReplace.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionGIReplace.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionGIReplace.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionGIReplace.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionGIReplace.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionGIReplace.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionGIReplace.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionGIReplace.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionGIReplace.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionGIReplace.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionGIReplace.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionGIReplace.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionGIReplace.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionGIReplace.md#getclass)
- [GetName](ue_ue.MaterialExpressionGIReplace.md#getname)
- [GetOuter](ue_ue.MaterialExpressionGIReplace.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionGIReplace.md#getworld)
- [Find](ue_ue.MaterialExpressionGIReplace.md#find)
- [Load](ue_ue.MaterialExpressionGIReplace.md#load)
- [StaticClass](ue_ue.MaterialExpressionGIReplace.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionGIReplace**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48324](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48324)
...
[ue/ue.d.ts:48325](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48325)
...
• **DynamicIndirect**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48327](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48327)
...
• **StaticIndirect**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48326](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48326)

___

### \_\_tid\_MaterialExpressionGIReplace\_\_

• **\_\_tid\_MaterialExpressionGIReplace\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48332](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48332)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionGIReplace`](ue_ue.MaterialExpressionGIReplace.md)
...
[ue/ue.d.ts:48329](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48329)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionGIReplace`](ue_ue.MaterialExpressionGIReplace.md)
...
[ue/ue.d.ts:48330](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48330)
...
[ue/ue.d.ts:48328](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48328)
