[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionGetMaterialAttributes

# Class: MaterialExpressionGetMaterialAttributes

[ue/ue](../modules/ue_ue.md).MaterialExpressionGetMaterialAttributes
...
- [constructor](ue_ue.MaterialExpressionGetMaterialAttributes.md#constructor)

### Properties

- [AttributeGetTypes](ue_ue.MaterialExpressionGetMaterialAttributes.md#attributegettypes)
- [Desc](ue_ue.MaterialExpressionGetMaterialAttributes.md#desc)
- [Function](ue_ue.MaterialExpressionGetMaterialAttributes.md#function)
- [GraphNode](ue_ue.MaterialExpressionGetMaterialAttributes.md#graphnode)
- [Material](ue_ue.MaterialExpressionGetMaterialAttributes.md#material)
- [MaterialAttributes](ue_ue.MaterialExpressionGetMaterialAttributes.md#materialattributes)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionGetMaterialAttributes.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionGetMaterialAttributes.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionGetMaterialAttributes.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionGetMaterialAttributes.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionGetMaterialAttributes.md#outputs)
- [\_\_tid\_MaterialExpressionGetMaterialAttributes\_\_](ue_ue.MaterialExpressionGetMaterialAttributes.md#__tid_materialexpressiongetmaterialattributes__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionGetMaterialAttributes.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionGetMaterialAttributes.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionGetMaterialAttributes.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionGetMaterialAttributes.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionGetMaterialAttributes.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionGetMaterialAttributes.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionGetMaterialAttributes.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionGetMaterialAttributes.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionGetMaterialAttributes.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionGetMaterialAttributes.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionGetMaterialAttributes.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionGetMaterialAttributes.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionGetMaterialAttributes.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionGetMaterialAttributes.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionGetMaterialAttributes.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionGetMaterialAttributes.md#getclass)
- [GetName](ue_ue.MaterialExpressionGetMaterialAttributes.md#getname)
- [GetOuter](ue_ue.MaterialExpressionGetMaterialAttributes.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionGetMaterialAttributes.md#getworld)
- [Find](ue_ue.MaterialExpressionGetMaterialAttributes.md#find)
- [Load](ue_ue.MaterialExpressionGetMaterialAttributes.md#load)
- [StaticClass](ue_ue.MaterialExpressionGetMaterialAttributes.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionGetMaterialAttributes**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48313](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48313)

## Properties

### AttributeGetTypes

• **AttributeGetTypes**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Guid`](ue_ue_s.Guid.md)\>

#### Defined in

[ue/ue.d.ts:48315](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48315)
...
[ue/ue.d.ts:48314](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48314)
...
### \_\_tid\_MaterialExpressionGetMaterialAttributes\_\_

• **\_\_tid\_MaterialExpressionGetMaterialAttributes\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48320](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48320)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionGetMaterialAttributes`](ue_ue.MaterialExpressionGetMaterialAttributes.md)
...
[ue/ue.d.ts:48317](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48317)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionGetMaterialAttributes`](ue_ue.MaterialExpressionGetMaterialAttributes.md)
...
[ue/ue.d.ts:48318](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48318)
...
[ue/ue.d.ts:48316](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48316)
