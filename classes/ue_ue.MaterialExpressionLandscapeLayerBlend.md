[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionLandscapeLayerBlend

# Class: MaterialExpressionLandscapeLayerBlend

[ue/ue](../modules/ue_ue.md).MaterialExpressionLandscapeLayerBlend
...
- [constructor](ue_ue.MaterialExpressionLandscapeLayerBlend.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionLandscapeLayerBlend.md#desc)
- [ExpressionGUID](ue_ue.MaterialExpressionLandscapeLayerBlend.md#expressionguid)
- [Function](ue_ue.MaterialExpressionLandscapeLayerBlend.md#function)
- [GraphNode](ue_ue.MaterialExpressionLandscapeLayerBlend.md#graphnode)
- [Layers](ue_ue.MaterialExpressionLandscapeLayerBlend.md#layers)
- [Material](ue_ue.MaterialExpressionLandscapeLayerBlend.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionLandscapeLayerBlend.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionLandscapeLayerBlend.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionLandscapeLayerBlend.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionLandscapeLayerBlend.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionLandscapeLayerBlend.md#outputs)
- [\_\_tid\_MaterialExpressionLandscapeLayerBlend\_\_](ue_ue.MaterialExpressionLandscapeLayerBlend.md#__tid_materialexpressionlandscapelayerblend__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionLandscapeLayerBlend.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionLandscapeLayerBlend.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionLandscapeLayerBlend.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionLandscapeLayerBlend.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionLandscapeLayerBlend.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionLandscapeLayerBlend.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionLandscapeLayerBlend.md#getclass)
- [GetName](ue_ue.MaterialExpressionLandscapeLayerBlend.md#getname)
- [GetOuter](ue_ue.MaterialExpressionLandscapeLayerBlend.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionLandscapeLayerBlend.md#getworld)
- [Find](ue_ue.MaterialExpressionLandscapeLayerBlend.md#find)
- [Load](ue_ue.MaterialExpressionLandscapeLayerBlend.md#load)
- [StaticClass](ue_ue.MaterialExpressionLandscapeLayerBlend.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionLandscapeLayerBlend**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48404](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48404)
...
[ue/ue.d.ts:48406](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48406)
...
• **Layers**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`LayerBlendInput`](ue_ue.LayerBlendInput.md)\>

#### Defined in

[ue/ue.d.ts:48405](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48405)
...
### \_\_tid\_MaterialExpressionLandscapeLayerBlend\_\_

• **\_\_tid\_MaterialExpressionLandscapeLayerBlend\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48411](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48411)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionLandscapeLayerBlend`](ue_ue.MaterialExpressionLandscapeLayerBlend.md)
...
[ue/ue.d.ts:48408](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48408)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionLandscapeLayerBlend`](ue_ue.MaterialExpressionLandscapeLayerBlend.md)
...
[ue/ue.d.ts:48409](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48409)
...
[ue/ue.d.ts:48407](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48407)
