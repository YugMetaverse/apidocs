[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionLandscapeVisibilityMask

# Class: MaterialExpressionLandscapeVisibilityMask

[ue/ue](../modules/ue_ue.md).MaterialExpressionLandscapeVisibilityMask
...
- [constructor](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#desc)
- [ExpressionGUID](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#expressionguid)
- [Function](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#function)
- [GraphNode](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#graphnode)
- [Material](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#outputs)
- [\_\_tid\_MaterialExpressionLandscapeVisibilityMask\_\_](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#__tid_materialexpressionlandscapevisibilitymask__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#getclass)
- [GetName](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#getname)
- [GetOuter](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#getworld)
- [Find](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#find)
- [Load](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#load)
- [StaticClass](ue_ue.MaterialExpressionLandscapeVisibilityMask.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionLandscapeVisibilityMask**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48471](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48471)
...
[ue/ue.d.ts:48472](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48472)
...
### \_\_tid\_MaterialExpressionLandscapeVisibilityMask\_\_

• **\_\_tid\_MaterialExpressionLandscapeVisibilityMask\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48477](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48477)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionLandscapeVisibilityMask`](ue_ue.MaterialExpressionLandscapeVisibilityMask.md)
...
[ue/ue.d.ts:48474](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48474)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionLandscapeVisibilityMask`](ue_ue.MaterialExpressionLandscapeVisibilityMask.md)
...
[ue/ue.d.ts:48475](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48475)
...
[ue/ue.d.ts:48473](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48473)
