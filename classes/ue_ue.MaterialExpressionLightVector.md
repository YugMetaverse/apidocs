[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionLightVector

# Class: MaterialExpressionLightVector

[ue/ue](../modules/ue_ue.md).MaterialExpressionLightVector
...
- [constructor](ue_ue.MaterialExpressionLightVector.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionLightVector.md#desc)
- [Function](ue_ue.MaterialExpressionLightVector.md#function)
- [GraphNode](ue_ue.MaterialExpressionLightVector.md#graphnode)
- [Material](ue_ue.MaterialExpressionLightVector.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionLightVector.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionLightVector.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionLightVector.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionLightVector.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionLightVector.md#outputs)
- [\_\_tid\_MaterialExpressionLightVector\_\_](ue_ue.MaterialExpressionLightVector.md#__tid_materialexpressionlightvector__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionLightVector.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionLightVector.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionLightVector.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionLightVector.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionLightVector.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionLightVector.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionLightVector.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionLightVector.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionLightVector.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionLightVector.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionLightVector.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionLightVector.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionLightVector.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionLightVector.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionLightVector.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionLightVector.md#getclass)
- [GetName](ue_ue.MaterialExpressionLightVector.md#getname)
- [GetOuter](ue_ue.MaterialExpressionLightVector.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionLightVector.md#getworld)
- [Find](ue_ue.MaterialExpressionLightVector.md#find)
- [Load](ue_ue.MaterialExpressionLightVector.md#load)
- [StaticClass](ue_ue.MaterialExpressionLightVector.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionLightVector**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48501](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48501)
...
### \_\_tid\_MaterialExpressionLightVector\_\_

• **\_\_tid\_MaterialExpressionLightVector\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48506](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48506)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionLightVector`](ue_ue.MaterialExpressionLightVector.md)
...
[ue/ue.d.ts:48503](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48503)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionLightVector`](ue_ue.MaterialExpressionLightVector.md)
...
[ue/ue.d.ts:48504](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48504)
...
[ue/ue.d.ts:48502](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48502)
