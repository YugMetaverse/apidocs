[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionLightmassReplace

# Class: MaterialExpressionLightmassReplace

[ue/ue](../modules/ue_ue.md).MaterialExpressionLightmassReplace
...
- [constructor](ue_ue.MaterialExpressionLightmassReplace.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionLightmassReplace.md#desc)
- [Function](ue_ue.MaterialExpressionLightmassReplace.md#function)
- [GraphNode](ue_ue.MaterialExpressionLightmassReplace.md#graphnode)
- [Lightmass](ue_ue.MaterialExpressionLightmassReplace.md#lightmass)
- [Material](ue_ue.MaterialExpressionLightmassReplace.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionLightmassReplace.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionLightmassReplace.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionLightmassReplace.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionLightmassReplace.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionLightmassReplace.md#outputs)
- [Realtime](ue_ue.MaterialExpressionLightmassReplace.md#realtime)
- [\_\_tid\_MaterialExpressionLightmassReplace\_\_](ue_ue.MaterialExpressionLightmassReplace.md#__tid_materialexpressionlightmassreplace__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionLightmassReplace.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionLightmassReplace.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionLightmassReplace.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionLightmassReplace.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionLightmassReplace.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionLightmassReplace.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionLightmassReplace.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionLightmassReplace.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionLightmassReplace.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionLightmassReplace.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionLightmassReplace.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionLightmassReplace.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionLightmassReplace.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionLightmassReplace.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionLightmassReplace.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionLightmassReplace.md#getclass)
- [GetName](ue_ue.MaterialExpressionLightmassReplace.md#getname)
- [GetOuter](ue_ue.MaterialExpressionLightmassReplace.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionLightmassReplace.md#getworld)
- [Find](ue_ue.MaterialExpressionLightmassReplace.md#find)
- [Load](ue_ue.MaterialExpressionLightmassReplace.md#load)
- [StaticClass](ue_ue.MaterialExpressionLightmassReplace.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionLightmassReplace**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48490](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48490)
...
• **Lightmass**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48492](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48492)
...
[ue/ue.d.ts:48491](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48491)

___

### \_\_tid\_MaterialExpressionLightmassReplace\_\_

• **\_\_tid\_MaterialExpressionLightmassReplace\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48497](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48497)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionLightmassReplace`](ue_ue.MaterialExpressionLightmassReplace.md)
...
[ue/ue.d.ts:48494](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48494)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionLightmassReplace`](ue_ue.MaterialExpressionLightmassReplace.md)
...
[ue/ue.d.ts:48495](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48495)
...
[ue/ue.d.ts:48493](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48493)
