[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionMapARPassthroughCameraUV

# Class: MaterialExpressionMapARPassthroughCameraUV

[ue/ue](../modules/ue_ue.md).MaterialExpressionMapARPassthroughCameraUV
...
- [constructor](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#constructor)

### Properties

- [Coordinates](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#coordinates)
- [Desc](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#desc)
- [Function](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#function)
- [GraphNode](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#graphnode)
- [Material](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#outputs)
- [\_\_tid\_MaterialExpressionMapARPassthroughCameraUV\_\_](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#__tid_materialexpressionmaparpassthroughcamerauv__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#getclass)
- [GetName](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#getname)
- [GetOuter](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#getworld)
- [Find](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#find)
- [Load](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#load)
- [StaticClass](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionMapARPassthroughCameraUV**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48573](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48573)
...
[ue/ue.d.ts:48574](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48574)
...
### \_\_tid\_MaterialExpressionMapARPassthroughCameraUV\_\_

• **\_\_tid\_MaterialExpressionMapARPassthroughCameraUV\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48579](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48579)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionMapARPassthroughCameraUV`](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md)
...
[ue/ue.d.ts:48576](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48576)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionMapARPassthroughCameraUV`](ue_ue.MaterialExpressionMapARPassthroughCameraUV.md)
...
[ue/ue.d.ts:48577](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48577)
...
[ue/ue.d.ts:48575](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48575)
