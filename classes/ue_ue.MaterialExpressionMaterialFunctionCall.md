[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionMaterialFunctionCall

# Class: MaterialExpressionMaterialFunctionCall

[ue/ue](../modules/ue_ue.md).MaterialExpressionMaterialFunctionCall
...
- [constructor](ue_ue.MaterialExpressionMaterialFunctionCall.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionMaterialFunctionCall.md#desc)
- [Function](ue_ue.MaterialExpressionMaterialFunctionCall.md#function)
- [FunctionInputs](ue_ue.MaterialExpressionMaterialFunctionCall.md#functioninputs)
- [FunctionOutputs](ue_ue.MaterialExpressionMaterialFunctionCall.md#functionoutputs)
- [FunctionParameterInfo](ue_ue.MaterialExpressionMaterialFunctionCall.md#functionparameterinfo)
- [GraphNode](ue_ue.MaterialExpressionMaterialFunctionCall.md#graphnode)
- [Material](ue_ue.MaterialExpressionMaterialFunctionCall.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionMaterialFunctionCall.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionMaterialFunctionCall.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionMaterialFunctionCall.md#materialexpressionguid)
- [MaterialFunction](ue_ue.MaterialExpressionMaterialFunctionCall.md#materialfunction)
- [MenuCategories](ue_ue.MaterialExpressionMaterialFunctionCall.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionMaterialFunctionCall.md#outputs)
- [\_\_tid\_MaterialExpressionMaterialFunctionCall\_\_](ue_ue.MaterialExpressionMaterialFunctionCall.md#__tid_materialexpressionmaterialfunctioncall__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionMaterialFunctionCall.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionMaterialFunctionCall.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionMaterialFunctionCall.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionMaterialFunctionCall.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionMaterialFunctionCall.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionMaterialFunctionCall.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionMaterialFunctionCall.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionMaterialFunctionCall.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionMaterialFunctionCall.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionMaterialFunctionCall.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionMaterialFunctionCall.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionMaterialFunctionCall.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionMaterialFunctionCall.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionMaterialFunctionCall.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionMaterialFunctionCall.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionMaterialFunctionCall.md#getclass)
- [GetName](ue_ue.MaterialExpressionMaterialFunctionCall.md#getname)
- [GetOuter](ue_ue.MaterialExpressionMaterialFunctionCall.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionMaterialFunctionCall.md#getworld)
- [SetMaterialFunction](ue_ue.MaterialExpressionMaterialFunctionCall.md#setmaterialfunction)
- [Find](ue_ue.MaterialExpressionMaterialFunctionCall.md#find)
- [Load](ue_ue.MaterialExpressionMaterialFunctionCall.md#load)
- [StaticClass](ue_ue.MaterialExpressionMaterialFunctionCall.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionMaterialFunctionCall**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48611](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48611)
...
• **FunctionInputs**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`FunctionExpressionInput`](ue_ue.FunctionExpressionInput.md)\>

#### Defined in

[ue/ue.d.ts:48613](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48613)

___

### FunctionOutputs

• **FunctionOutputs**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`FunctionExpressionOutput`](ue_ue.FunctionExpressionOutput.md)\>

#### Defined in

[ue/ue.d.ts:48614](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48614)

___

### FunctionParameterInfo

• **FunctionParameterInfo**: [`MaterialParameterInfo`](ue_ue.MaterialParameterInfo.md)

#### Defined in

[ue/ue.d.ts:48615](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48615)
...
• **MaterialFunction**: [`MaterialFunctionInterface`](ue_ue.MaterialFunctionInterface.md)

#### Defined in

[ue/ue.d.ts:48612](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48612)
...
### \_\_tid\_MaterialExpressionMaterialFunctionCall\_\_

• **\_\_tid\_MaterialExpressionMaterialFunctionCall\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48621](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48621)
...
▸ **SetMaterialFunction**(`NewMaterialFunction`): `boolean`

#### Parameters

| Name | Type |
| :------ | :------ |
| `NewMaterialFunction` | [`$Nullable`](../modules/puerts.md#$nullable)<[`MaterialFunctionInterface`](ue_ue.MaterialFunctionInterface.md)\> |
...
[ue/ue.d.ts:48616](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48616)

___

### Find

▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionMaterialFunctionCall`](ue_ue.MaterialExpressionMaterialFunctionCall.md)
...
[ue/ue.d.ts:48618](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48618)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionMaterialFunctionCall`](ue_ue.MaterialExpressionMaterialFunctionCall.md)
...
[ue/ue.d.ts:48619](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48619)
...
[ue/ue.d.ts:48617](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48617)
