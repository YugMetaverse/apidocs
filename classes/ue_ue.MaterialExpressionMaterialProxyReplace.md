[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionMaterialProxyReplace

# Class: MaterialExpressionMaterialProxyReplace

[ue/ue](../modules/ue_ue.md).MaterialExpressionMaterialProxyReplace
...
- [constructor](ue_ue.MaterialExpressionMaterialProxyReplace.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionMaterialProxyReplace.md#desc)
- [Function](ue_ue.MaterialExpressionMaterialProxyReplace.md#function)
- [GraphNode](ue_ue.MaterialExpressionMaterialProxyReplace.md#graphnode)
- [Material](ue_ue.MaterialExpressionMaterialProxyReplace.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionMaterialProxyReplace.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionMaterialProxyReplace.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionMaterialProxyReplace.md#materialexpressionguid)
- [MaterialProxy](ue_ue.MaterialExpressionMaterialProxyReplace.md#materialproxy)
- [MenuCategories](ue_ue.MaterialExpressionMaterialProxyReplace.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionMaterialProxyReplace.md#outputs)
- [Realtime](ue_ue.MaterialExpressionMaterialProxyReplace.md#realtime)
- [\_\_tid\_MaterialExpressionMaterialProxyReplace\_\_](ue_ue.MaterialExpressionMaterialProxyReplace.md#__tid_materialexpressionmaterialproxyreplace__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionMaterialProxyReplace.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionMaterialProxyReplace.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionMaterialProxyReplace.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionMaterialProxyReplace.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionMaterialProxyReplace.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionMaterialProxyReplace.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionMaterialProxyReplace.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionMaterialProxyReplace.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionMaterialProxyReplace.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionMaterialProxyReplace.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionMaterialProxyReplace.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionMaterialProxyReplace.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionMaterialProxyReplace.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionMaterialProxyReplace.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionMaterialProxyReplace.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionMaterialProxyReplace.md#getclass)
- [GetName](ue_ue.MaterialExpressionMaterialProxyReplace.md#getname)
- [GetOuter](ue_ue.MaterialExpressionMaterialProxyReplace.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionMaterialProxyReplace.md#getworld)
- [Find](ue_ue.MaterialExpressionMaterialProxyReplace.md#find)
- [Load](ue_ue.MaterialExpressionMaterialProxyReplace.md#load)
- [StaticClass](ue_ue.MaterialExpressionMaterialProxyReplace.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionMaterialProxyReplace**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48652](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48652)
...
• **MaterialProxy**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48654](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48654)
...
• **Realtime**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48653](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48653)

___

### \_\_tid\_MaterialExpressionMaterialProxyReplace\_\_

• **\_\_tid\_MaterialExpressionMaterialProxyReplace\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48659](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48659)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionMaterialProxyReplace`](ue_ue.MaterialExpressionMaterialProxyReplace.md)
...
[ue/ue.d.ts:48656](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48656)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionMaterialProxyReplace`](ue_ue.MaterialExpressionMaterialProxyReplace.md)
...
[ue/ue.d.ts:48657](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48657)
...
[ue/ue.d.ts:48655](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48655)
