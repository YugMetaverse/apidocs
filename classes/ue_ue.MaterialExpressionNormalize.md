[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionNormalize

# Class: MaterialExpressionNormalize

[ue/ue](../modules/ue_ue.md).MaterialExpressionNormalize
...
- [constructor](ue_ue.MaterialExpressionNormalize.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionNormalize.md#desc)
- [Function](ue_ue.MaterialExpressionNormalize.md#function)
- [GraphNode](ue_ue.MaterialExpressionNormalize.md#graphnode)
- [Material](ue_ue.MaterialExpressionNormalize.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionNormalize.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionNormalize.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionNormalize.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionNormalize.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionNormalize.md#outputs)
- [VectorInput](ue_ue.MaterialExpressionNormalize.md#vectorinput)
- [\_\_tid\_MaterialExpressionNormalize\_\_](ue_ue.MaterialExpressionNormalize.md#__tid_materialexpressionnormalize__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionNormalize.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionNormalize.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionNormalize.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionNormalize.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionNormalize.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionNormalize.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionNormalize.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionNormalize.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionNormalize.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionNormalize.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionNormalize.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionNormalize.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionNormalize.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionNormalize.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionNormalize.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionNormalize.md#getclass)
- [GetName](ue_ue.MaterialExpressionNormalize.md#getname)
- [GetOuter](ue_ue.MaterialExpressionNormalize.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionNormalize.md#getworld)
- [Find](ue_ue.MaterialExpressionNormalize.md#find)
- [Load](ue_ue.MaterialExpressionNormalize.md#load)
- [StaticClass](ue_ue.MaterialExpressionNormalize.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionNormalize**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48723](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48723)
...
• **VectorInput**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:48724](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48724)

___

### \_\_tid\_MaterialExpressionNormalize\_\_

• **\_\_tid\_MaterialExpressionNormalize\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48729](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48729)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionNormalize`](ue_ue.MaterialExpressionNormalize.md)
...
[ue/ue.d.ts:48726](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48726)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionNormalize`](ue_ue.MaterialExpressionNormalize.md)
...
[ue/ue.d.ts:48727](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48727)
...
[ue/ue.d.ts:48725](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48725)
