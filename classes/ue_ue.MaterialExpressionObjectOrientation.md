[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionObjectOrientation

# Class: MaterialExpressionObjectOrientation

[ue/ue](../modules/ue_ue.md).MaterialExpressionObjectOrientation
...
- [constructor](ue_ue.MaterialExpressionObjectOrientation.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionObjectOrientation.md#desc)
- [Function](ue_ue.MaterialExpressionObjectOrientation.md#function)
- [GraphNode](ue_ue.MaterialExpressionObjectOrientation.md#graphnode)
- [Material](ue_ue.MaterialExpressionObjectOrientation.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionObjectOrientation.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionObjectOrientation.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionObjectOrientation.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionObjectOrientation.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionObjectOrientation.md#outputs)
- [\_\_tid\_MaterialExpressionObjectOrientation\_\_](ue_ue.MaterialExpressionObjectOrientation.md#__tid_materialexpressionobjectorientation__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionObjectOrientation.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionObjectOrientation.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionObjectOrientation.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionObjectOrientation.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionObjectOrientation.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionObjectOrientation.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionObjectOrientation.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionObjectOrientation.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionObjectOrientation.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionObjectOrientation.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionObjectOrientation.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionObjectOrientation.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionObjectOrientation.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionObjectOrientation.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionObjectOrientation.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionObjectOrientation.md#getclass)
- [GetName](ue_ue.MaterialExpressionObjectOrientation.md#getname)
- [GetOuter](ue_ue.MaterialExpressionObjectOrientation.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionObjectOrientation.md#getworld)
- [Find](ue_ue.MaterialExpressionObjectOrientation.md#find)
- [Load](ue_ue.MaterialExpressionObjectOrientation.md#load)
- [StaticClass](ue_ue.MaterialExpressionObjectOrientation.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionObjectOrientation**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48742](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48742)
...
### \_\_tid\_MaterialExpressionObjectOrientation\_\_

• **\_\_tid\_MaterialExpressionObjectOrientation\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48747](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48747)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionObjectOrientation`](ue_ue.MaterialExpressionObjectOrientation.md)
...
[ue/ue.d.ts:48744](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48744)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionObjectOrientation`](ue_ue.MaterialExpressionObjectOrientation.md)
...
[ue/ue.d.ts:48745](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48745)
...
[ue/ue.d.ts:48743](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48743)
