[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticleDirection

# Class: MaterialExpressionParticleDirection

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticleDirection
...
- [constructor](ue_ue.MaterialExpressionParticleDirection.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticleDirection.md#desc)
- [Function](ue_ue.MaterialExpressionParticleDirection.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticleDirection.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticleDirection.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticleDirection.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticleDirection.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticleDirection.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticleDirection.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticleDirection.md#outputs)
- [\_\_tid\_MaterialExpressionParticleDirection\_\_](ue_ue.MaterialExpressionParticleDirection.md#__tid_materialexpressionparticledirection__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticleDirection.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticleDirection.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticleDirection.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticleDirection.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticleDirection.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticleDirection.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticleDirection.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticleDirection.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticleDirection.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticleDirection.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticleDirection.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticleDirection.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticleDirection.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticleDirection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticleDirection.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticleDirection.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticleDirection.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticleDirection.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticleDirection.md#getworld)
- [Find](ue_ue.MaterialExpressionParticleDirection.md#find)
- [Load](ue_ue.MaterialExpressionParticleDirection.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticleDirection.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticleDirection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48804](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48804)
...
### \_\_tid\_MaterialExpressionParticleDirection\_\_

• **\_\_tid\_MaterialExpressionParticleDirection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48809](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48809)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticleDirection`](ue_ue.MaterialExpressionParticleDirection.md)
...
[ue/ue.d.ts:48806](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48806)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticleDirection`](ue_ue.MaterialExpressionParticleDirection.md)
...
[ue/ue.d.ts:48807](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48807)
...
[ue/ue.d.ts:48805](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48805)
