[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticleMotionBlurFade

# Class: MaterialExpressionParticleMotionBlurFade

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticleMotionBlurFade
...
- [constructor](ue_ue.MaterialExpressionParticleMotionBlurFade.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticleMotionBlurFade.md#desc)
- [Function](ue_ue.MaterialExpressionParticleMotionBlurFade.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticleMotionBlurFade.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticleMotionBlurFade.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticleMotionBlurFade.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticleMotionBlurFade.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticleMotionBlurFade.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticleMotionBlurFade.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticleMotionBlurFade.md#outputs)
- [\_\_tid\_MaterialExpressionParticleMotionBlurFade\_\_](ue_ue.MaterialExpressionParticleMotionBlurFade.md#__tid_materialexpressionparticlemotionblurfade__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticleMotionBlurFade.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticleMotionBlurFade.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticleMotionBlurFade.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticleMotionBlurFade.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticleMotionBlurFade.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticleMotionBlurFade.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticleMotionBlurFade.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticleMotionBlurFade.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticleMotionBlurFade.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticleMotionBlurFade.md#getworld)
- [Find](ue_ue.MaterialExpressionParticleMotionBlurFade.md#find)
- [Load](ue_ue.MaterialExpressionParticleMotionBlurFade.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticleMotionBlurFade.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticleMotionBlurFade**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48822](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48822)
...
### \_\_tid\_MaterialExpressionParticleMotionBlurFade\_\_

• **\_\_tid\_MaterialExpressionParticleMotionBlurFade\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48827](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48827)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticleMotionBlurFade`](ue_ue.MaterialExpressionParticleMotionBlurFade.md)
...
[ue/ue.d.ts:48824](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48824)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticleMotionBlurFade`](ue_ue.MaterialExpressionParticleMotionBlurFade.md)
...
[ue/ue.d.ts:48825](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48825)
...
[ue/ue.d.ts:48823](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48823)
