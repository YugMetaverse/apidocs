[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticlePositionWS

# Class: MaterialExpressionParticlePositionWS

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticlePositionWS
...
- [constructor](ue_ue.MaterialExpressionParticlePositionWS.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticlePositionWS.md#desc)
- [Function](ue_ue.MaterialExpressionParticlePositionWS.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticlePositionWS.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticlePositionWS.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticlePositionWS.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticlePositionWS.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticlePositionWS.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticlePositionWS.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticlePositionWS.md#outputs)
- [\_\_tid\_MaterialExpressionParticlePositionWS\_\_](ue_ue.MaterialExpressionParticlePositionWS.md#__tid_materialexpressionparticlepositionws__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticlePositionWS.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticlePositionWS.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticlePositionWS.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticlePositionWS.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticlePositionWS.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticlePositionWS.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticlePositionWS.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticlePositionWS.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticlePositionWS.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticlePositionWS.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticlePositionWS.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticlePositionWS.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticlePositionWS.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticlePositionWS.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticlePositionWS.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticlePositionWS.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticlePositionWS.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticlePositionWS.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticlePositionWS.md#getworld)
- [Find](ue_ue.MaterialExpressionParticlePositionWS.md#find)
- [Load](ue_ue.MaterialExpressionParticlePositionWS.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticlePositionWS.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticlePositionWS**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48831](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48831)
...
### \_\_tid\_MaterialExpressionParticlePositionWS\_\_

• **\_\_tid\_MaterialExpressionParticlePositionWS\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48836](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48836)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticlePositionWS`](ue_ue.MaterialExpressionParticlePositionWS.md)
...
[ue/ue.d.ts:48833](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48833)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticlePositionWS`](ue_ue.MaterialExpressionParticlePositionWS.md)
...
[ue/ue.d.ts:48834](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48834)
...
[ue/ue.d.ts:48832](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48832)
