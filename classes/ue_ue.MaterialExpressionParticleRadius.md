[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticleRadius

# Class: MaterialExpressionParticleRadius

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticleRadius
...
- [constructor](ue_ue.MaterialExpressionParticleRadius.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticleRadius.md#desc)
- [Function](ue_ue.MaterialExpressionParticleRadius.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticleRadius.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticleRadius.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticleRadius.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticleRadius.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticleRadius.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticleRadius.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticleRadius.md#outputs)
- [\_\_tid\_MaterialExpressionParticleRadius\_\_](ue_ue.MaterialExpressionParticleRadius.md#__tid_materialexpressionparticleradius__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticleRadius.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticleRadius.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticleRadius.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticleRadius.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticleRadius.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticleRadius.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticleRadius.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticleRadius.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticleRadius.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticleRadius.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticleRadius.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticleRadius.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticleRadius.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticleRadius.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticleRadius.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticleRadius.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticleRadius.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticleRadius.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticleRadius.md#getworld)
- [Find](ue_ue.MaterialExpressionParticleRadius.md#find)
- [Load](ue_ue.MaterialExpressionParticleRadius.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticleRadius.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticleRadius**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48840](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48840)
...
### \_\_tid\_MaterialExpressionParticleRadius\_\_

• **\_\_tid\_MaterialExpressionParticleRadius\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48845](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48845)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticleRadius`](ue_ue.MaterialExpressionParticleRadius.md)
...
[ue/ue.d.ts:48842](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48842)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticleRadius`](ue_ue.MaterialExpressionParticleRadius.md)
...
[ue/ue.d.ts:48843](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48843)
...
[ue/ue.d.ts:48841](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48841)
