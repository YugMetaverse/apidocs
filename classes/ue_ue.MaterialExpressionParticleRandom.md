[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticleRandom

# Class: MaterialExpressionParticleRandom

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticleRandom
...
- [constructor](ue_ue.MaterialExpressionParticleRandom.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticleRandom.md#desc)
- [Function](ue_ue.MaterialExpressionParticleRandom.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticleRandom.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticleRandom.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticleRandom.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticleRandom.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticleRandom.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticleRandom.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticleRandom.md#outputs)
- [\_\_tid\_MaterialExpressionParticleRandom\_\_](ue_ue.MaterialExpressionParticleRandom.md#__tid_materialexpressionparticlerandom__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticleRandom.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticleRandom.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticleRandom.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticleRandom.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticleRandom.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticleRandom.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticleRandom.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticleRandom.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticleRandom.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticleRandom.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticleRandom.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticleRandom.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticleRandom.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticleRandom.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticleRandom.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticleRandom.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticleRandom.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticleRandom.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticleRandom.md#getworld)
- [Find](ue_ue.MaterialExpressionParticleRandom.md#find)
- [Load](ue_ue.MaterialExpressionParticleRandom.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticleRandom.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticleRandom**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48849](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48849)
...
### \_\_tid\_MaterialExpressionParticleRandom\_\_

• **\_\_tid\_MaterialExpressionParticleRandom\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48854](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48854)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticleRandom`](ue_ue.MaterialExpressionParticleRandom.md)
...
[ue/ue.d.ts:48851](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48851)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticleRandom`](ue_ue.MaterialExpressionParticleRandom.md)
...
[ue/ue.d.ts:48852](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48852)
...
[ue/ue.d.ts:48850](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48850)
