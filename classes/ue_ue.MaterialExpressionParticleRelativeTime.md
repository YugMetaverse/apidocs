[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticleRelativeTime

# Class: MaterialExpressionParticleRelativeTime

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticleRelativeTime
...
- [constructor](ue_ue.MaterialExpressionParticleRelativeTime.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticleRelativeTime.md#desc)
- [Function](ue_ue.MaterialExpressionParticleRelativeTime.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticleRelativeTime.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticleRelativeTime.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticleRelativeTime.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticleRelativeTime.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticleRelativeTime.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticleRelativeTime.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticleRelativeTime.md#outputs)
- [\_\_tid\_MaterialExpressionParticleRelativeTime\_\_](ue_ue.MaterialExpressionParticleRelativeTime.md#__tid_materialexpressionparticlerelativetime__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticleRelativeTime.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticleRelativeTime.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticleRelativeTime.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticleRelativeTime.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticleRelativeTime.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticleRelativeTime.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticleRelativeTime.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticleRelativeTime.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticleRelativeTime.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticleRelativeTime.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticleRelativeTime.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticleRelativeTime.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticleRelativeTime.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticleRelativeTime.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticleRelativeTime.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticleRelativeTime.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticleRelativeTime.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticleRelativeTime.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticleRelativeTime.md#getworld)
- [Find](ue_ue.MaterialExpressionParticleRelativeTime.md#find)
- [Load](ue_ue.MaterialExpressionParticleRelativeTime.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticleRelativeTime.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticleRelativeTime**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48858](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48858)
...
### \_\_tid\_MaterialExpressionParticleRelativeTime\_\_

• **\_\_tid\_MaterialExpressionParticleRelativeTime\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48863](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48863)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticleRelativeTime`](ue_ue.MaterialExpressionParticleRelativeTime.md)
...
[ue/ue.d.ts:48860](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48860)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticleRelativeTime`](ue_ue.MaterialExpressionParticleRelativeTime.md)
...
[ue/ue.d.ts:48861](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48861)
...
[ue/ue.d.ts:48859](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48859)
