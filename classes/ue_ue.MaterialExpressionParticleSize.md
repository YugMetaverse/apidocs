[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionParticleSize

# Class: MaterialExpressionParticleSize

[ue/ue](../modules/ue_ue.md).MaterialExpressionParticleSize
...
- [constructor](ue_ue.MaterialExpressionParticleSize.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionParticleSize.md#desc)
- [Function](ue_ue.MaterialExpressionParticleSize.md#function)
- [GraphNode](ue_ue.MaterialExpressionParticleSize.md#graphnode)
- [Material](ue_ue.MaterialExpressionParticleSize.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionParticleSize.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionParticleSize.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionParticleSize.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionParticleSize.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionParticleSize.md#outputs)
- [\_\_tid\_MaterialExpressionParticleSize\_\_](ue_ue.MaterialExpressionParticleSize.md#__tid_materialexpressionparticlesize__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionParticleSize.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionParticleSize.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionParticleSize.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionParticleSize.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionParticleSize.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionParticleSize.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionParticleSize.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionParticleSize.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionParticleSize.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionParticleSize.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionParticleSize.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionParticleSize.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionParticleSize.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionParticleSize.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionParticleSize.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionParticleSize.md#getclass)
- [GetName](ue_ue.MaterialExpressionParticleSize.md#getname)
- [GetOuter](ue_ue.MaterialExpressionParticleSize.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionParticleSize.md#getworld)
- [Find](ue_ue.MaterialExpressionParticleSize.md#find)
- [Load](ue_ue.MaterialExpressionParticleSize.md#load)
- [StaticClass](ue_ue.MaterialExpressionParticleSize.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionParticleSize**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48867](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48867)
...
### \_\_tid\_MaterialExpressionParticleSize\_\_

• **\_\_tid\_MaterialExpressionParticleSize\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48872](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48872)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionParticleSize`](ue_ue.MaterialExpressionParticleSize.md)
...
[ue/ue.d.ts:48869](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48869)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionParticleSize`](ue_ue.MaterialExpressionParticleSize.md)
...
[ue/ue.d.ts:48870](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48870)
...
[ue/ue.d.ts:48868](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48868)
