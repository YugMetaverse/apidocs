[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionPerInstanceFadeAmount

# Class: MaterialExpressionPerInstanceFadeAmount

[ue/ue](../modules/ue_ue.md).MaterialExpressionPerInstanceFadeAmount
...
- [constructor](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#desc)
- [Function](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#function)
- [GraphNode](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#graphnode)
- [Material](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#outputs)
- [\_\_tid\_MaterialExpressionPerInstanceFadeAmount\_\_](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#__tid_materialexpressionperinstancefadeamount__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#getclass)
- [GetName](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#getname)
- [GetOuter](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#getworld)
- [Find](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#find)
- [Load](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#load)
- [StaticClass](ue_ue.MaterialExpressionPerInstanceFadeAmount.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionPerInstanceFadeAmount**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48904](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48904)
...
### \_\_tid\_MaterialExpressionPerInstanceFadeAmount\_\_

• **\_\_tid\_MaterialExpressionPerInstanceFadeAmount\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48909](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48909)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionPerInstanceFadeAmount`](ue_ue.MaterialExpressionPerInstanceFadeAmount.md)
...
[ue/ue.d.ts:48906](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48906)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionPerInstanceFadeAmount`](ue_ue.MaterialExpressionPerInstanceFadeAmount.md)
...
[ue/ue.d.ts:48907](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48907)
...
[ue/ue.d.ts:48905](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L48905)
