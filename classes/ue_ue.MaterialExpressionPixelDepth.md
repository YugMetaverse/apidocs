[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionPixelDepth

# Class: MaterialExpressionPixelDepth

[ue/ue](../modules/ue_ue.md).MaterialExpressionPixelDepth
...
- [constructor](ue_ue.MaterialExpressionPixelDepth.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionPixelDepth.md#desc)
- [Function](ue_ue.MaterialExpressionPixelDepth.md#function)
- [GraphNode](ue_ue.MaterialExpressionPixelDepth.md#graphnode)
- [Material](ue_ue.MaterialExpressionPixelDepth.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionPixelDepth.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionPixelDepth.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionPixelDepth.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionPixelDepth.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionPixelDepth.md#outputs)
- [\_\_tid\_MaterialExpressionPixelDepth\_\_](ue_ue.MaterialExpressionPixelDepth.md#__tid_materialexpressionpixeldepth__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionPixelDepth.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionPixelDepth.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionPixelDepth.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionPixelDepth.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionPixelDepth.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionPixelDepth.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionPixelDepth.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionPixelDepth.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionPixelDepth.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionPixelDepth.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionPixelDepth.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionPixelDepth.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionPixelDepth.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionPixelDepth.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionPixelDepth.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionPixelDepth.md#getclass)
- [GetName](ue_ue.MaterialExpressionPixelDepth.md#getname)
- [GetOuter](ue_ue.MaterialExpressionPixelDepth.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionPixelDepth.md#getworld)
- [Find](ue_ue.MaterialExpressionPixelDepth.md#find)
- [Load](ue_ue.MaterialExpressionPixelDepth.md#load)
- [StaticClass](ue_ue.MaterialExpressionPixelDepth.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionPixelDepth**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:48922](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48922)
...
### \_\_tid\_MaterialExpressionPixelDepth\_\_

• **\_\_tid\_MaterialExpressionPixelDepth\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:48927](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48927)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionPixelDepth`](ue_ue.MaterialExpressionPixelDepth.md)
...
[ue/ue.d.ts:48924](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48924)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionPixelDepth`](ue_ue.MaterialExpressionPixelDepth.md)
...
[ue/ue.d.ts:48925](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48925)
...
[ue/ue.d.ts:48923](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L48923)
