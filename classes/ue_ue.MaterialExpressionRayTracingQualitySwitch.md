[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionRayTracingQualitySwitch

# Class: MaterialExpressionRayTracingQualitySwitch

[ue/ue](../modules/ue_ue.md).MaterialExpressionRayTracingQualitySwitch
...
- [constructor](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#desc)
- [Function](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#function)
- [GraphNode](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#graphnode)
- [Material](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#menucategories)
- [Normal](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#normal)
- [Outputs](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#outputs)
- [RayTraced](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#raytraced)
- [\_\_tid\_MaterialExpressionRayTracingQualitySwitch\_\_](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#__tid_materialexpressionraytracingqualityswitch__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#getclass)
- [GetName](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#getname)
- [GetOuter](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#getworld)
- [Find](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#find)
- [Load](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#load)
- [StaticClass](ue_ue.MaterialExpressionRayTracingQualitySwitch.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionRayTracingQualitySwitch**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49010](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49010)
...
[ue/ue.d.ts:49011](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49011)
...
• **RayTraced**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:49012](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49012)

___

### \_\_tid\_MaterialExpressionRayTracingQualitySwitch\_\_

• **\_\_tid\_MaterialExpressionRayTracingQualitySwitch\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49017](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49017)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionRayTracingQualitySwitch`](ue_ue.MaterialExpressionRayTracingQualitySwitch.md)
...
[ue/ue.d.ts:49014](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49014)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionRayTracingQualitySwitch`](ue_ue.MaterialExpressionRayTracingQualitySwitch.md)
...
[ue/ue.d.ts:49015](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49015)
...
[ue/ue.d.ts:49013](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49013)
