[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionRotateAboutAxis

# Class: MaterialExpressionRotateAboutAxis

[ue/ue](../modules/ue_ue.md).MaterialExpressionRotateAboutAxis
...
- [constructor](ue_ue.MaterialExpressionRotateAboutAxis.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionRotateAboutAxis.md#desc)
- [Function](ue_ue.MaterialExpressionRotateAboutAxis.md#function)
- [GraphNode](ue_ue.MaterialExpressionRotateAboutAxis.md#graphnode)
- [Material](ue_ue.MaterialExpressionRotateAboutAxis.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionRotateAboutAxis.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionRotateAboutAxis.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionRotateAboutAxis.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionRotateAboutAxis.md#menucategories)
- [NormalizedRotationAxis](ue_ue.MaterialExpressionRotateAboutAxis.md#normalizedrotationaxis)
- [Outputs](ue_ue.MaterialExpressionRotateAboutAxis.md#outputs)
- [Period](ue_ue.MaterialExpressionRotateAboutAxis.md#period)
- [PivotPoint](ue_ue.MaterialExpressionRotateAboutAxis.md#pivotpoint)
- [Position](ue_ue.MaterialExpressionRotateAboutAxis.md#position)
- [RotationAngle](ue_ue.MaterialExpressionRotateAboutAxis.md#rotationangle)
- [\_\_tid\_MaterialExpressionRotateAboutAxis\_\_](ue_ue.MaterialExpressionRotateAboutAxis.md#__tid_materialexpressionrotateaboutaxis__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionRotateAboutAxis.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionRotateAboutAxis.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionRotateAboutAxis.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionRotateAboutAxis.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionRotateAboutAxis.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionRotateAboutAxis.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionRotateAboutAxis.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionRotateAboutAxis.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionRotateAboutAxis.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionRotateAboutAxis.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionRotateAboutAxis.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionRotateAboutAxis.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionRotateAboutAxis.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionRotateAboutAxis.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionRotateAboutAxis.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionRotateAboutAxis.md#getclass)
- [GetName](ue_ue.MaterialExpressionRotateAboutAxis.md#getname)
- [GetOuter](ue_ue.MaterialExpressionRotateAboutAxis.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionRotateAboutAxis.md#getworld)
- [Find](ue_ue.MaterialExpressionRotateAboutAxis.md#find)
- [Load](ue_ue.MaterialExpressionRotateAboutAxis.md#load)
- [StaticClass](ue_ue.MaterialExpressionRotateAboutAxis.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionRotateAboutAxis**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49042](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49042)
...
• **NormalizedRotationAxis**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:49043](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49043)
...
[ue/ue.d.ts:49047](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49047)

___

### PivotPoint

• **PivotPoint**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:49045](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49045)
...
[ue/ue.d.ts:49046](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49046)

___

### RotationAngle

• **RotationAngle**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:49044](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49044)

___

### \_\_tid\_MaterialExpressionRotateAboutAxis\_\_

• **\_\_tid\_MaterialExpressionRotateAboutAxis\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49052](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49052)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionRotateAboutAxis`](ue_ue.MaterialExpressionRotateAboutAxis.md)
...
[ue/ue.d.ts:49049](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49049)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionRotateAboutAxis`](ue_ue.MaterialExpressionRotateAboutAxis.md)
...
[ue/ue.d.ts:49050](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49050)
...
[ue/ue.d.ts:49048](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49048)
