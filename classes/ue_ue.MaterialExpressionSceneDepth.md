[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionSceneDepth

# Class: MaterialExpressionSceneDepth

[ue/ue](../modules/ue_ue.md).MaterialExpressionSceneDepth
...
- [constructor](ue_ue.MaterialExpressionSceneDepth.md#constructor)

### Properties

- [ConstInput](ue_ue.MaterialExpressionSceneDepth.md#constinput)
- [Coordinates](ue_ue.MaterialExpressionSceneDepth.md#coordinates)
- [Desc](ue_ue.MaterialExpressionSceneDepth.md#desc)
- [Function](ue_ue.MaterialExpressionSceneDepth.md#function)
- [GraphNode](ue_ue.MaterialExpressionSceneDepth.md#graphnode)
- [Input](ue_ue.MaterialExpressionSceneDepth.md#input)
- [InputMode](ue_ue.MaterialExpressionSceneDepth.md#inputmode)
- [Material](ue_ue.MaterialExpressionSceneDepth.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionSceneDepth.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionSceneDepth.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionSceneDepth.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionSceneDepth.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionSceneDepth.md#outputs)
- [\_\_tid\_MaterialExpressionSceneDepth\_\_](ue_ue.MaterialExpressionSceneDepth.md#__tid_materialexpressionscenedepth__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionSceneDepth.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionSceneDepth.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionSceneDepth.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionSceneDepth.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionSceneDepth.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionSceneDepth.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionSceneDepth.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionSceneDepth.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionSceneDepth.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionSceneDepth.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionSceneDepth.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionSceneDepth.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionSceneDepth.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionSceneDepth.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionSceneDepth.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionSceneDepth.md#getclass)
- [GetName](ue_ue.MaterialExpressionSceneDepth.md#getname)
- [GetOuter](ue_ue.MaterialExpressionSceneDepth.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionSceneDepth.md#getworld)
- [Find](ue_ue.MaterialExpressionSceneDepth.md#find)
- [Load](ue_ue.MaterialExpressionSceneDepth.md#load)
- [StaticClass](ue_ue.MaterialExpressionSceneDepth.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionSceneDepth**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49158](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49158)
...
[ue/ue.d.ts:49162](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49162)
...
[ue/ue.d.ts:49161](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49161)
...
[ue/ue.d.ts:49160](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49160)
...
[ue/ue.d.ts:49159](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49159)
...
### \_\_tid\_MaterialExpressionSceneDepth\_\_

• **\_\_tid\_MaterialExpressionSceneDepth\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49167](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49167)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionSceneDepth`](ue_ue.MaterialExpressionSceneDepth.md)
...
[ue/ue.d.ts:49164](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49164)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionSceneDepth`](ue_ue.MaterialExpressionSceneDepth.md)
...
[ue/ue.d.ts:49165](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49165)
...
[ue/ue.d.ts:49163](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49163)
