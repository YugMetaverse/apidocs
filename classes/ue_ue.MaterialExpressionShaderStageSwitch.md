[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionShaderStageSwitch

# Class: MaterialExpressionShaderStageSwitch

[ue/ue](../modules/ue_ue.md).MaterialExpressionShaderStageSwitch
...
- [constructor](ue_ue.MaterialExpressionShaderStageSwitch.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionShaderStageSwitch.md#desc)
- [Function](ue_ue.MaterialExpressionShaderStageSwitch.md#function)
- [GraphNode](ue_ue.MaterialExpressionShaderStageSwitch.md#graphnode)
- [Material](ue_ue.MaterialExpressionShaderStageSwitch.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionShaderStageSwitch.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionShaderStageSwitch.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionShaderStageSwitch.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionShaderStageSwitch.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionShaderStageSwitch.md#outputs)
- [PixelShader](ue_ue.MaterialExpressionShaderStageSwitch.md#pixelshader)
- [VertexShader](ue_ue.MaterialExpressionShaderStageSwitch.md#vertexshader)
- [\_\_tid\_MaterialExpressionShaderStageSwitch\_\_](ue_ue.MaterialExpressionShaderStageSwitch.md#__tid_materialexpressionshaderstageswitch__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionShaderStageSwitch.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionShaderStageSwitch.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionShaderStageSwitch.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionShaderStageSwitch.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionShaderStageSwitch.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionShaderStageSwitch.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionShaderStageSwitch.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionShaderStageSwitch.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionShaderStageSwitch.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionShaderStageSwitch.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionShaderStageSwitch.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionShaderStageSwitch.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionShaderStageSwitch.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionShaderStageSwitch.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionShaderStageSwitch.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionShaderStageSwitch.md#getclass)
- [GetName](ue_ue.MaterialExpressionShaderStageSwitch.md#getname)
- [GetOuter](ue_ue.MaterialExpressionShaderStageSwitch.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionShaderStageSwitch.md#getworld)
- [Find](ue_ue.MaterialExpressionShaderStageSwitch.md#find)
- [Load](ue_ue.MaterialExpressionShaderStageSwitch.md#load)
- [StaticClass](ue_ue.MaterialExpressionShaderStageSwitch.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionShaderStageSwitch**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49212](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49212)
...
• **PixelShader**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:49213](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49213)

___

### VertexShader

• **VertexShader**: [`ExpressionInput`](ue_ue.ExpressionInput.md)

#### Defined in

[ue/ue.d.ts:49214](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49214)

___

### \_\_tid\_MaterialExpressionShaderStageSwitch\_\_

• **\_\_tid\_MaterialExpressionShaderStageSwitch\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49219](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49219)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionShaderStageSwitch`](ue_ue.MaterialExpressionShaderStageSwitch.md)
...
[ue/ue.d.ts:49216](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49216)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionShaderStageSwitch`](ue_ue.MaterialExpressionShaderStageSwitch.md)
...
[ue/ue.d.ts:49217](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49217)
...
[ue/ue.d.ts:49215](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L49215)
