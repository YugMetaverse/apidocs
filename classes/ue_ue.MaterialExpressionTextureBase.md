[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionTextureBase

# Class: MaterialExpressionTextureBase

[ue/ue](../modules/ue_ue.md).MaterialExpressionTextureBase
...
- [constructor](ue_ue.MaterialExpressionTextureBase.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionTextureBase.md#desc)
- [Function](ue_ue.MaterialExpressionTextureBase.md#function)
- [GraphNode](ue_ue.MaterialExpressionTextureBase.md#graphnode)
- [IsDefaultMeshpaintTexture](ue_ue.MaterialExpressionTextureBase.md#isdefaultmeshpainttexture)
- [Material](ue_ue.MaterialExpressionTextureBase.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionTextureBase.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionTextureBase.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionTextureBase.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionTextureBase.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionTextureBase.md#outputs)
- [SamplerType](ue_ue.MaterialExpressionTextureBase.md#samplertype)
- [Texture](ue_ue.MaterialExpressionTextureBase.md#texture)
- [\_\_tid\_MaterialExpressionTextureBase\_\_](ue_ue.MaterialExpressionTextureBase.md#__tid_materialexpressiontexturebase__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionTextureBase.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionTextureBase.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionTextureBase.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionTextureBase.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionTextureBase.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionTextureBase.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionTextureBase.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionTextureBase.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionTextureBase.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionTextureBase.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionTextureBase.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionTextureBase.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionTextureBase.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionTextureBase.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionTextureBase.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionTextureBase.md#getclass)
- [GetName](ue_ue.MaterialExpressionTextureBase.md#getname)
- [GetOuter](ue_ue.MaterialExpressionTextureBase.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionTextureBase.md#getworld)
- [Find](ue_ue.MaterialExpressionTextureBase.md#find)
- [Load](ue_ue.MaterialExpressionTextureBase.md#load)
- [StaticClass](ue_ue.MaterialExpressionTextureBase.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionTextureBase**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:47512](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47512)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionTextureBase`](ue_ue.MaterialExpressionTextureBase.md)
...
[ue/ue.d.ts:47517](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47517)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionTextureBase`](ue_ue.MaterialExpressionTextureBase.md)
...
[ue/ue.d.ts:47518](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47518)
...
[ue/ue.d.ts:47516](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L47516)
