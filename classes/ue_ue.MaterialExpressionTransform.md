[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionTransform

# Class: MaterialExpressionTransform

[ue/ue](../modules/ue_ue.md).MaterialExpressionTransform
...
- [constructor](ue_ue.MaterialExpressionTransform.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionTransform.md#desc)
- [Function](ue_ue.MaterialExpressionTransform.md#function)
- [GraphNode](ue_ue.MaterialExpressionTransform.md#graphnode)
- [Input](ue_ue.MaterialExpressionTransform.md#input)
- [Material](ue_ue.MaterialExpressionTransform.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionTransform.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionTransform.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionTransform.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionTransform.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionTransform.md#outputs)
- [TransformSourceType](ue_ue.MaterialExpressionTransform.md#transformsourcetype)
- [TransformType](ue_ue.MaterialExpressionTransform.md#transformtype)
- [\_\_tid\_MaterialExpressionTransform\_\_](ue_ue.MaterialExpressionTransform.md#__tid_materialexpressiontransform__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionTransform.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionTransform.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionTransform.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionTransform.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionTransform.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionTransform.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionTransform.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionTransform.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionTransform.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionTransform.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionTransform.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionTransform.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionTransform.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionTransform.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionTransform.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionTransform.md#getclass)
- [GetName](ue_ue.MaterialExpressionTransform.md#getname)
- [GetOuter](ue_ue.MaterialExpressionTransform.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionTransform.md#getworld)
- [Find](ue_ue.MaterialExpressionTransform.md#find)
- [Load](ue_ue.MaterialExpressionTransform.md#load)
- [StaticClass](ue_ue.MaterialExpressionTransform.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionTransform**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49624](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49624)
...
[ue/ue.d.ts:49625](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49625)
...
• **TransformSourceType**: [`EMaterialVectorCoordTransformSource`](../enums/ue_ue.EMaterialVectorCoordTransformSource.md)

#### Defined in

[ue/ue.d.ts:49626](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49626)

___

### TransformType

• **TransformType**: [`EMaterialVectorCoordTransform`](../enums/ue_ue.EMaterialVectorCoordTransform.md)

#### Defined in

[ue/ue.d.ts:49627](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49627)

___

### \_\_tid\_MaterialExpressionTransform\_\_

• **\_\_tid\_MaterialExpressionTransform\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49632](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49632)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionTransform`](ue_ue.MaterialExpressionTransform.md)
...
[ue/ue.d.ts:49629](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49629)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionTransform`](ue_ue.MaterialExpressionTransform.md)
...
[ue/ue.d.ts:49630](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49630)
...
[ue/ue.d.ts:49628](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49628)
