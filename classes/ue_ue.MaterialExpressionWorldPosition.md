[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialExpressionWorldPosition

# Class: MaterialExpressionWorldPosition

[ue/ue](../modules/ue_ue.md).MaterialExpressionWorldPosition
...
- [constructor](ue_ue.MaterialExpressionWorldPosition.md#constructor)

### Properties

- [Desc](ue_ue.MaterialExpressionWorldPosition.md#desc)
- [Function](ue_ue.MaterialExpressionWorldPosition.md#function)
- [GraphNode](ue_ue.MaterialExpressionWorldPosition.md#graphnode)
- [Material](ue_ue.MaterialExpressionWorldPosition.md#material)
- [MaterialExpressionEditorX](ue_ue.MaterialExpressionWorldPosition.md#materialexpressioneditorx)
- [MaterialExpressionEditorY](ue_ue.MaterialExpressionWorldPosition.md#materialexpressioneditory)
- [MaterialExpressionGuid](ue_ue.MaterialExpressionWorldPosition.md#materialexpressionguid)
- [MenuCategories](ue_ue.MaterialExpressionWorldPosition.md#menucategories)
- [Outputs](ue_ue.MaterialExpressionWorldPosition.md#outputs)
- [WorldPositionShaderOffset](ue_ue.MaterialExpressionWorldPosition.md#worldpositionshaderoffset)
- [\_\_tid\_MaterialExpressionWorldPosition\_\_](ue_ue.MaterialExpressionWorldPosition.md#__tid_materialexpressionworldposition__)
- [\_\_tid\_MaterialExpression\_\_](ue_ue.MaterialExpressionWorldPosition.md#__tid_materialexpression__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialExpressionWorldPosition.md#__tid_object__)
- [bCollapsed](ue_ue.MaterialExpressionWorldPosition.md#bcollapsed)
- [bCommentBubbleVisible](ue_ue.MaterialExpressionWorldPosition.md#bcommentbubblevisible)
- [bHidePreviewWindow](ue_ue.MaterialExpressionWorldPosition.md#bhidepreviewwindow)
- [bIsParameterExpression](ue_ue.MaterialExpressionWorldPosition.md#bisparameterexpression)
- [bNeedToUpdatePreview](ue_ue.MaterialExpressionWorldPosition.md#bneedtoupdatepreview)
- [bRealtimePreview](ue_ue.MaterialExpressionWorldPosition.md#brealtimepreview)
- [bShaderInputData](ue_ue.MaterialExpressionWorldPosition.md#bshaderinputdata)
- [bShowInputs](ue_ue.MaterialExpressionWorldPosition.md#bshowinputs)
- [bShowMaskColorsOnPin](ue_ue.MaterialExpressionWorldPosition.md#bshowmaskcolorsonpin)
- [bShowOutputNameOnPin](ue_ue.MaterialExpressionWorldPosition.md#bshowoutputnameonpin)
- [bShowOutputs](ue_ue.MaterialExpressionWorldPosition.md#bshowoutputs)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialExpressionWorldPosition.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialExpressionWorldPosition.md#executeubergraph)
- [GetClass](ue_ue.MaterialExpressionWorldPosition.md#getclass)
- [GetName](ue_ue.MaterialExpressionWorldPosition.md#getname)
- [GetOuter](ue_ue.MaterialExpressionWorldPosition.md#getouter)
- [GetWorld](ue_ue.MaterialExpressionWorldPosition.md#getworld)
- [Find](ue_ue.MaterialExpressionWorldPosition.md#find)
- [Load](ue_ue.MaterialExpressionWorldPosition.md#load)
- [StaticClass](ue_ue.MaterialExpressionWorldPosition.md#staticclass)

## Constructors

### constructor

• **new MaterialExpressionWorldPosition**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49739](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49739)
...
• **WorldPositionShaderOffset**: [`EWorldPositionIncludedOffsets`](../enums/ue_ue.EWorldPositionIncludedOffsets.md)

#### Defined in

[ue/ue.d.ts:49740](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49740)

___

### \_\_tid\_MaterialExpressionWorldPosition\_\_

• **\_\_tid\_MaterialExpressionWorldPosition\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49745](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49745)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialExpressionWorldPosition`](ue_ue.MaterialExpressionWorldPosition.md)
...
[ue/ue.d.ts:49742](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49742)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialExpressionWorldPosition`](ue_ue.MaterialExpressionWorldPosition.md)
...
[ue/ue.d.ts:49743](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49743)
...
[ue/ue.d.ts:49741](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49741)
