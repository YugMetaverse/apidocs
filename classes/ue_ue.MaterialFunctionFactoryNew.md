[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialFunctionFactoryNew

# Class: MaterialFunctionFactoryNew

[ue/ue](../modules/ue_ue.md).MaterialFunctionFactoryNew
...
- [constructor](ue_ue.MaterialFunctionFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.MaterialFunctionFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.MaterialFunctionFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.MaterialFunctionFactoryNew.md#contextclass)
- [Formats](ue_ue.MaterialFunctionFactoryNew.md#formats)
- [ImportPriority](ue_ue.MaterialFunctionFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.MaterialFunctionFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.MaterialFunctionFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.MaterialFunctionFactoryNew.md#__tid_factory__)
- [\_\_tid\_MaterialFunctionFactoryNew\_\_](ue_ue.MaterialFunctionFactoryNew.md#__tid_materialfunctionfactorynew__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialFunctionFactoryNew.md#__tid_object__)
- [bCreateNew](ue_ue.MaterialFunctionFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.MaterialFunctionFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.MaterialFunctionFactoryNew.md#beditorimport)
- [bText](ue_ue.MaterialFunctionFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialFunctionFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialFunctionFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.MaterialFunctionFactoryNew.md#getclass)
- [GetName](ue_ue.MaterialFunctionFactoryNew.md#getname)
- [GetOuter](ue_ue.MaterialFunctionFactoryNew.md#getouter)
- [GetWorld](ue_ue.MaterialFunctionFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.MaterialFunctionFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.MaterialFunctionFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.MaterialFunctionFactoryNew.md#find)
- [Load](ue_ue.MaterialFunctionFactoryNew.md#load)
- [StaticClass](ue_ue.MaterialFunctionFactoryNew.md#staticclass)

## Constructors

### constructor

• **new MaterialFunctionFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49759](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49759)
...
### \_\_tid\_MaterialFunctionFactoryNew\_\_

• **\_\_tid\_MaterialFunctionFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49764](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49764)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialFunctionFactoryNew`](ue_ue.MaterialFunctionFactoryNew.md)
...
[ue/ue.d.ts:49761](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49761)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialFunctionFactoryNew`](ue_ue.MaterialFunctionFactoryNew.md)
...
[ue/ue.d.ts:49762](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49762)
...
[ue/ue.d.ts:49760](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49760)
