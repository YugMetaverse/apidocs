[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MaterialFunctionMaterialLayerFactory

# Class: MaterialFunctionMaterialLayerFactory

[ue/ue](../modules/ue_ue.md).MaterialFunctionMaterialLayerFactory
...
- [constructor](ue_ue.MaterialFunctionMaterialLayerFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.MaterialFunctionMaterialLayerFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.MaterialFunctionMaterialLayerFactory.md#automatedimportdata)
- [ContextClass](ue_ue.MaterialFunctionMaterialLayerFactory.md#contextclass)
- [Formats](ue_ue.MaterialFunctionMaterialLayerFactory.md#formats)
- [ImportPriority](ue_ue.MaterialFunctionMaterialLayerFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.MaterialFunctionMaterialLayerFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.MaterialFunctionMaterialLayerFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.MaterialFunctionMaterialLayerFactory.md#__tid_factory__)
- [\_\_tid\_MaterialFunctionMaterialLayerFactory\_\_](ue_ue.MaterialFunctionMaterialLayerFactory.md#__tid_materialfunctionmateriallayerfactory__)
- [\_\_tid\_Object\_\_](ue_ue.MaterialFunctionMaterialLayerFactory.md#__tid_object__)
- [bCreateNew](ue_ue.MaterialFunctionMaterialLayerFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.MaterialFunctionMaterialLayerFactory.md#beditafternew)
- [bEditorImport](ue_ue.MaterialFunctionMaterialLayerFactory.md#beditorimport)
- [bText](ue_ue.MaterialFunctionMaterialLayerFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.MaterialFunctionMaterialLayerFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MaterialFunctionMaterialLayerFactory.md#executeubergraph)
- [GetClass](ue_ue.MaterialFunctionMaterialLayerFactory.md#getclass)
- [GetName](ue_ue.MaterialFunctionMaterialLayerFactory.md#getname)
- [GetOuter](ue_ue.MaterialFunctionMaterialLayerFactory.md#getouter)
- [GetWorld](ue_ue.MaterialFunctionMaterialLayerFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.MaterialFunctionMaterialLayerFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.MaterialFunctionMaterialLayerFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.MaterialFunctionMaterialLayerFactory.md#find)
- [Load](ue_ue.MaterialFunctionMaterialLayerFactory.md#load)
- [StaticClass](ue_ue.MaterialFunctionMaterialLayerFactory.md#staticclass)

## Constructors

### constructor

• **new MaterialFunctionMaterialLayerFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:49823](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49823)
...
### \_\_tid\_MaterialFunctionMaterialLayerFactory\_\_

• **\_\_tid\_MaterialFunctionMaterialLayerFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:49828](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49828)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MaterialFunctionMaterialLayerFactory`](ue_ue.MaterialFunctionMaterialLayerFactory.md)
...
[ue/ue.d.ts:49825](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49825)

___

### Load

▸ `Static` **Load**(`InName`): [`MaterialFunctionMaterialLayerFactory`](ue_ue.MaterialFunctionMaterialLayerFactory.md)
...
[ue/ue.d.ts:49826](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49826)
...
[ue/ue.d.ts:49824](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L49824)
