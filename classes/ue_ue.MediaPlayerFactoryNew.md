[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MediaPlayerFactoryNew

# Class: MediaPlayerFactoryNew

[ue/ue](../modules/ue_ue.md).MediaPlayerFactoryNew
...
- [constructor](ue_ue.MediaPlayerFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.MediaPlayerFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.MediaPlayerFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.MediaPlayerFactoryNew.md#contextclass)
- [Formats](ue_ue.MediaPlayerFactoryNew.md#formats)
- [ImportPriority](ue_ue.MediaPlayerFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.MediaPlayerFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.MediaPlayerFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.MediaPlayerFactoryNew.md#__tid_factory__)
- [\_\_tid\_MediaPlayerFactoryNew\_\_](ue_ue.MediaPlayerFactoryNew.md#__tid_mediaplayerfactorynew__)
- [\_\_tid\_Object\_\_](ue_ue.MediaPlayerFactoryNew.md#__tid_object__)
- [bCreateNew](ue_ue.MediaPlayerFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.MediaPlayerFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.MediaPlayerFactoryNew.md#beditorimport)
- [bText](ue_ue.MediaPlayerFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.MediaPlayerFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MediaPlayerFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.MediaPlayerFactoryNew.md#getclass)
- [GetName](ue_ue.MediaPlayerFactoryNew.md#getname)
- [GetOuter](ue_ue.MediaPlayerFactoryNew.md#getouter)
- [GetWorld](ue_ue.MediaPlayerFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.MediaPlayerFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.MediaPlayerFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.MediaPlayerFactoryNew.md#find)
- [Load](ue_ue.MediaPlayerFactoryNew.md#load)
- [StaticClass](ue_ue.MediaPlayerFactoryNew.md#staticclass)

## Constructors

### constructor

• **new MediaPlayerFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:50314](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50314)
...
### \_\_tid\_MediaPlayerFactoryNew\_\_

• **\_\_tid\_MediaPlayerFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:50319](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50319)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MediaPlayerFactoryNew`](ue_ue.MediaPlayerFactoryNew.md)
...
[ue/ue.d.ts:50316](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50316)

___

### Load

▸ `Static` **Load**(`InName`): [`MediaPlayerFactoryNew`](ue_ue.MediaPlayerFactoryNew.md)
...
[ue/ue.d.ts:50317](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50317)
...
[ue/ue.d.ts:50315](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50315)
