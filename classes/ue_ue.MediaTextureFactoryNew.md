[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MediaTextureFactoryNew

# Class: MediaTextureFactoryNew

[ue/ue](../modules/ue_ue.md).MediaTextureFactoryNew
...
- [constructor](ue_ue.MediaTextureFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.MediaTextureFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.MediaTextureFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.MediaTextureFactoryNew.md#contextclass)
- [Formats](ue_ue.MediaTextureFactoryNew.md#formats)
- [ImportPriority](ue_ue.MediaTextureFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.MediaTextureFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.MediaTextureFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.MediaTextureFactoryNew.md#__tid_factory__)
- [\_\_tid\_MediaTextureFactoryNew\_\_](ue_ue.MediaTextureFactoryNew.md#__tid_mediatexturefactorynew__)
- [\_\_tid\_Object\_\_](ue_ue.MediaTextureFactoryNew.md#__tid_object__)
- [bCreateNew](ue_ue.MediaTextureFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.MediaTextureFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.MediaTextureFactoryNew.md#beditorimport)
- [bText](ue_ue.MediaTextureFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.MediaTextureFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MediaTextureFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.MediaTextureFactoryNew.md#getclass)
- [GetName](ue_ue.MediaTextureFactoryNew.md#getname)
- [GetOuter](ue_ue.MediaTextureFactoryNew.md#getouter)
- [GetWorld](ue_ue.MediaTextureFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.MediaTextureFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.MediaTextureFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.MediaTextureFactoryNew.md#find)
- [Load](ue_ue.MediaTextureFactoryNew.md#load)
- [StaticClass](ue_ue.MediaTextureFactoryNew.md#staticclass)

## Constructors

### constructor

• **new MediaTextureFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:50427](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50427)
...
### \_\_tid\_MediaTextureFactoryNew\_\_

• **\_\_tid\_MediaTextureFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:50432](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50432)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MediaTextureFactoryNew`](ue_ue.MediaTextureFactoryNew.md)
...
[ue/ue.d.ts:50429](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50429)

___

### Load

▸ `Static` **Load**(`InName`): [`MediaTextureFactoryNew`](ue_ue.MediaTextureFactoryNew.md)
...
[ue/ue.d.ts:50430](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50430)
...
[ue/ue.d.ts:50428](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50428)
