[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ModelExporterT3D

# Class: ModelExporterT3D

[ue/ue](../modules/ue_ue.md).ModelExporterT3D
...
- [constructor](ue_ue.ModelExporterT3D.md#constructor)

### Properties

- [ExportRootScope](ue_ue.ModelExporterT3D.md#exportrootscope)
- [ExportTask](ue_ue.ModelExporterT3D.md#exporttask)
- [FormatDescription](ue_ue.ModelExporterT3D.md#formatdescription)
- [FormatExtension](ue_ue.ModelExporterT3D.md#formatextension)
- [PreferredFormatIndex](ue_ue.ModelExporterT3D.md#preferredformatindex)
- [SupportedClass](ue_ue.ModelExporterT3D.md#supportedclass)
- [TextIndent](ue_ue.ModelExporterT3D.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.ModelExporterT3D.md#__tid_exporter__)
- [\_\_tid\_ModelExporterT3D\_\_](ue_ue.ModelExporterT3D.md#__tid_modelexportert3d__)
- [\_\_tid\_Object\_\_](ue_ue.ModelExporterT3D.md#__tid_object__)
- [bForceFileOperations](ue_ue.ModelExporterT3D.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.ModelExporterT3D.md#bselectedonly)
- [bText](ue_ue.ModelExporterT3D.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.ModelExporterT3D.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ModelExporterT3D.md#executeubergraph)
- [GetClass](ue_ue.ModelExporterT3D.md#getclass)
- [GetName](ue_ue.ModelExporterT3D.md#getname)
- [GetOuter](ue_ue.ModelExporterT3D.md#getouter)
- [GetWorld](ue_ue.ModelExporterT3D.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.ModelExporterT3D.md#scriptrunassetexporttask)
- [Find](ue_ue.ModelExporterT3D.md#find)
- [Load](ue_ue.ModelExporterT3D.md#load)
- [RunAssetExportTask](ue_ue.ModelExporterT3D.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.ModelExporterT3D.md#runassetexporttasks)
- [StaticClass](ue_ue.ModelExporterT3D.md#staticclass)

## Constructors

### constructor

• **new ModelExporterT3D**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:50815](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50815)
...
### \_\_tid\_ModelExporterT3D\_\_

• **\_\_tid\_ModelExporterT3D\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:50820](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50820)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ModelExporterT3D`](ue_ue.ModelExporterT3D.md)
...
[ue/ue.d.ts:50817](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50817)

___

### Load

▸ `Static` **Load**(`InName`): [`ModelExporterT3D`](ue_ue.ModelExporterT3D.md)
...
[ue/ue.d.ts:50818](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50818)
...
[ue/ue.d.ts:50816](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50816)
