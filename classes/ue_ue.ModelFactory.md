[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ModelFactory

# Class: ModelFactory

[ue/ue](../modules/ue_ue.md).ModelFactory
...
- [constructor](ue_ue.ModelFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.ModelFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.ModelFactory.md#automatedimportdata)
- [ContextClass](ue_ue.ModelFactory.md#contextclass)
- [Formats](ue_ue.ModelFactory.md#formats)
- [ImportPriority](ue_ue.ModelFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.ModelFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.ModelFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.ModelFactory.md#__tid_factory__)
- [\_\_tid\_ModelFactory\_\_](ue_ue.ModelFactory.md#__tid_modelfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ModelFactory.md#__tid_object__)
- [bCreateNew](ue_ue.ModelFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.ModelFactory.md#beditafternew)
- [bEditorImport](ue_ue.ModelFactory.md#beditorimport)
- [bText](ue_ue.ModelFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.ModelFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ModelFactory.md#executeubergraph)
- [GetClass](ue_ue.ModelFactory.md#getclass)
- [GetName](ue_ue.ModelFactory.md#getname)
- [GetOuter](ue_ue.ModelFactory.md#getouter)
- [GetWorld](ue_ue.ModelFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.ModelFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.ModelFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.ModelFactory.md#find)
- [Load](ue_ue.ModelFactory.md#load)
- [StaticClass](ue_ue.ModelFactory.md#staticclass)

## Constructors

### constructor

• **new ModelFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:50824](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50824)
...
### \_\_tid\_ModelFactory\_\_

• **\_\_tid\_ModelFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:50829](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50829)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ModelFactory`](ue_ue.ModelFactory.md)
...
[ue/ue.d.ts:50826](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50826)

___

### Load

▸ `Static` **Load**(`InName`): [`ModelFactory`](ue_ue.ModelFactory.md)
...
[ue/ue.d.ts:50827](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50827)
...
[ue/ue.d.ts:50825](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L50825)
