[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MotionControllerComponent

# Class: MotionControllerComponent

[ue/ue](../modules/ue_ue.md).MotionControllerComponent
...
- [constructor](ue_ue.MotionControllerComponent.md#constructor)

### Properties

- [AlwaysLoadOnClient](ue_ue.MotionControllerComponent.md#alwaysloadonclient)
- [AlwaysLoadOnServer](ue_ue.MotionControllerComponent.md#alwaysloadonserver)
- [AssetUserData](ue_ue.MotionControllerComponent.md#assetuserdata)
- [AttachChildren](ue_ue.MotionControllerComponent.md#attachchildren)
- [AttachParent](ue_ue.MotionControllerComponent.md#attachparent)
- [AttachSocketName](ue_ue.MotionControllerComponent.md#attachsocketname)
- [BodyInstance](ue_ue.MotionControllerComponent.md#bodyinstance)
- [BoundsScale](ue_ue.MotionControllerComponent.md#boundsscale)
- [CachedMaxDrawDistance](ue_ue.MotionControllerComponent.md#cachedmaxdrawdistance)
- [CanBeCharacterBase](ue_ue.MotionControllerComponent.md#canbecharacterbase)
- [CanCharacterStepUpOn](ue_ue.MotionControllerComponent.md#cancharacterstepupon)
- [CastShadow](ue_ue.MotionControllerComponent.md#castshadow)
- [ClientAttachedChildren](ue_ue.MotionControllerComponent.md#clientattachedchildren)
- [ComponentTags](ue_ue.MotionControllerComponent.md#componenttags)
- [ComponentVelocity](ue_ue.MotionControllerComponent.md#componentvelocity)
- [CreationMethod](ue_ue.MotionControllerComponent.md#creationmethod)
- [CurrentTrackingStatus](ue_ue.MotionControllerComponent.md#currenttrackingstatus)
- [CustomDepthStencilValue](ue_ue.MotionControllerComponent.md#customdepthstencilvalue)
- [CustomDepthStencilWriteMask](ue_ue.MotionControllerComponent.md#customdepthstencilwritemask)
- [CustomDisplayMesh](ue_ue.MotionControllerComponent.md#customdisplaymesh)
- [CustomPrimitiveData](ue_ue.MotionControllerComponent.md#customprimitivedata)
- [DepthPriorityGroup](ue_ue.MotionControllerComponent.md#depthprioritygroup)
- [DetailMode](ue_ue.MotionControllerComponent.md#detailmode)
- [DisplayComponent](ue_ue.MotionControllerComponent.md#displaycomponent)
- [DisplayMeshMaterialOverrides](ue_ue.MotionControllerComponent.md#displaymeshmaterialoverrides)
- [DisplayModelSource](ue_ue.MotionControllerComponent.md#displaymodelsource)
- [ExcludeForSpecificHLODLevels](ue_ue.MotionControllerComponent.md#excludeforspecifichlodlevels)
- [Hand](ue_ue.MotionControllerComponent.md#hand)
- [IndirectLightingCacheQuality](ue_ue.MotionControllerComponent.md#indirectlightingcachequality)
- [LDMaxDrawDistance](ue_ue.MotionControllerComponent.md#ldmaxdrawdistance)
- [LODParentPrimitive](ue_ue.MotionControllerComponent.md#lodparentprimitive)
- [LightingChannels](ue_ue.MotionControllerComponent.md#lightingchannels)
- [LightmapType](ue_ue.MotionControllerComponent.md#lightmaptype)
- [LpvBiasMultiplier](ue_ue.MotionControllerComponent.md#lpvbiasmultiplier)
- [MinDrawDistance](ue_ue.MotionControllerComponent.md#mindrawdistance)
- [Mobility](ue_ue.MotionControllerComponent.md#mobility)
- [MotionSource](ue_ue.MotionControllerComponent.md#motionsource)
- [MoveIgnoreActors](ue_ue.MotionControllerComponent.md#moveignoreactors)
- [MoveIgnoreComponents](ue_ue.MotionControllerComponent.md#moveignorecomponents)
- [OnBeginCursorOver](ue_ue.MotionControllerComponent.md#onbegincursorover)
- [OnClicked](ue_ue.MotionControllerComponent.md#onclicked)
- [OnComponentActivated](ue_ue.MotionControllerComponent.md#oncomponentactivated)
- [OnComponentBeginOverlap](ue_ue.MotionControllerComponent.md#oncomponentbeginoverlap)
- [OnComponentDeactivated](ue_ue.MotionControllerComponent.md#oncomponentdeactivated)
- [OnComponentEndOverlap](ue_ue.MotionControllerComponent.md#oncomponentendoverlap)
- [OnComponentHit](ue_ue.MotionControllerComponent.md#oncomponenthit)
- [OnComponentSleep](ue_ue.MotionControllerComponent.md#oncomponentsleep)
- [OnComponentWake](ue_ue.MotionControllerComponent.md#oncomponentwake)
- [OnEndCursorOver](ue_ue.MotionControllerComponent.md#onendcursorover)
- [OnInputTouchBegin](ue_ue.MotionControllerComponent.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue.MotionControllerComponent.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue.MotionControllerComponent.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue.MotionControllerComponent.md#oninputtouchleave)
- [OnReleased](ue_ue.MotionControllerComponent.md#onreleased)
- [PhysicsVolume](ue_ue.MotionControllerComponent.md#physicsvolume)
- [PhysicsVolumeChangedDelegate](ue_ue.MotionControllerComponent.md#physicsvolumechangeddelegate)
- [PlayerIndex](ue_ue.MotionControllerComponent.md#playerindex)
- [PrimaryComponentTick](ue_ue.MotionControllerComponent.md#primarycomponenttick)
- [RelativeLocation](ue_ue.MotionControllerComponent.md#relativelocation)
- [RelativeRotation](ue_ue.MotionControllerComponent.md#relativerotation)
- [RelativeScale3D](ue_ue.MotionControllerComponent.md#relativescale3d)
- [RuntimeVirtualTextures](ue_ue.MotionControllerComponent.md#runtimevirtualtextures)
- [TranslucencySortPriority](ue_ue.MotionControllerComponent.md#translucencysortpriority)
- [UCSModifiedProperties](ue_ue.MotionControllerComponent.md#ucsmodifiedproperties)
- [ViewOwnerDepthPriorityGroup](ue_ue.MotionControllerComponent.md#viewownerdepthprioritygroup)
- [VirtualTextureCullMips](ue_ue.MotionControllerComponent.md#virtualtexturecullmips)
- [VirtualTextureLodBias](ue_ue.MotionControllerComponent.md#virtualtexturelodbias)
- [VirtualTextureMinCoverage](ue_ue.MotionControllerComponent.md#virtualtexturemincoverage)
- [VirtualTextureRenderPassType](ue_ue.MotionControllerComponent.md#virtualtexturerenderpasstype)
- [VisibilityId](ue_ue.MotionControllerComponent.md#visibilityid)
- [\_\_tid\_ActorComponent\_\_](ue_ue.MotionControllerComponent.md#__tid_actorcomponent__)
- [\_\_tid\_MotionControllerComponent\_\_](ue_ue.MotionControllerComponent.md#__tid_motioncontrollercomponent__)
- [\_\_tid\_Object\_\_](ue_ue.MotionControllerComponent.md#__tid_object__)
- [\_\_tid\_PrimitiveComponent\_\_](ue_ue.MotionControllerComponent.md#__tid_primitivecomponent__)
- [\_\_tid\_SceneComponent\_\_](ue_ue.MotionControllerComponent.md#__tid_scenecomponent__)
- [bAbsoluteLocation](ue_ue.MotionControllerComponent.md#babsolutelocation)
- [bAbsoluteRotation](ue_ue.MotionControllerComponent.md#babsoluterotation)
- [bAbsoluteScale](ue_ue.MotionControllerComponent.md#babsolutescale)
- [bAffectDistanceFieldLighting](ue_ue.MotionControllerComponent.md#baffectdistancefieldlighting)
- [bAffectDynamicIndirectLighting](ue_ue.MotionControllerComponent.md#baffectdynamicindirectlighting)
- [bAllowCullDistanceVolume](ue_ue.MotionControllerComponent.md#ballowculldistancevolume)
- [bAlwaysCreatePhysicsState](ue_ue.MotionControllerComponent.md#balwayscreatephysicsstate)
- [bApplyImpulseOnDamage](ue_ue.MotionControllerComponent.md#bapplyimpulseondamage)
- [bAutoActivate](ue_ue.MotionControllerComponent.md#bautoactivate)
- [bBatchImpostersAsInstances](ue_ue.MotionControllerComponent.md#bbatchimpostersasinstances)
- [bBoundsChangeTriggersStreamingDataRebuild](ue_ue.MotionControllerComponent.md#bboundschangetriggersstreamingdatarebuild)
- [bCanEverAffectNavigation](ue_ue.MotionControllerComponent.md#bcaneveraffectnavigation)
- [bCastCinematicShadow](ue_ue.MotionControllerComponent.md#bcastcinematicshadow)
- [bCastDynamicShadow](ue_ue.MotionControllerComponent.md#bcastdynamicshadow)
- [bCastFarShadow](ue_ue.MotionControllerComponent.md#bcastfarshadow)
- [bCastHiddenShadow](ue_ue.MotionControllerComponent.md#bcasthiddenshadow)
- [bCastInsetShadow](ue_ue.MotionControllerComponent.md#bcastinsetshadow)
- [bCastShadowAsTwoSided](ue_ue.MotionControllerComponent.md#bcastshadowastwosided)
- [bCastStaticShadow](ue_ue.MotionControllerComponent.md#bcaststaticshadow)
- [bCastVolumetricTranslucentShadow](ue_ue.MotionControllerComponent.md#bcastvolumetrictranslucentshadow)
- [bComponentToWorldUpdated](ue_ue.MotionControllerComponent.md#bcomponenttoworldupdated)
- [bCreatedByConstructionScript](ue_ue.MotionControllerComponent.md#bcreatedbyconstructionscript)
- [bDisableLowLatencyUpdate](ue_ue.MotionControllerComponent.md#bdisablelowlatencyupdate)
- [bDisplayDeviceModel](ue_ue.MotionControllerComponent.md#bdisplaydevicemodel)
- [bEditableWhenInherited](ue_ue.MotionControllerComponent.md#beditablewheninherited)
- [bEnableAutoLODGeneration](ue_ue.MotionControllerComponent.md#benableautolodgeneration)
- [bExcludeFromLightAttachmentGroup](ue_ue.MotionControllerComponent.md#bexcludefromlightattachmentgroup)
- [bForceMipStreaming](ue_ue.MotionControllerComponent.md#bforcemipstreaming)
- [bGenerateOverlapEvents](ue_ue.MotionControllerComponent.md#bgenerateoverlapevents)
- [bHasCustomNavigableGeometry](ue_ue.MotionControllerComponent.md#bhascustomnavigablegeometry)
- [bHasMotionBlurVelocityMeshes](ue_ue.MotionControllerComponent.md#bhasmotionblurvelocitymeshes)
- [bHasPerInstanceHitProxies](ue_ue.MotionControllerComponent.md#bhasperinstancehitproxies)
- [bHiddenInGame](ue_ue.MotionControllerComponent.md#bhiddeningame)
- [bIgnoreRadialForce](ue_ue.MotionControllerComponent.md#bignoreradialforce)
- [bIgnoreRadialImpulse](ue_ue.MotionControllerComponent.md#bignoreradialimpulse)
- [bInstanceComponent](ue_ue.MotionControllerComponent.md#binstancecomponent)
- [bIsActive](ue_ue.MotionControllerComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.MotionControllerComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.MotionControllerComponent.md#bisvisualizationcomponent)
- [bLightAsIfStatic](ue_ue.MotionControllerComponent.md#blightasifstatic)
- [bLightAttachmentsAsGroup](ue_ue.MotionControllerComponent.md#blightattachmentsasgroup)
- [bMultiBodyOverlap](ue_ue.MotionControllerComponent.md#bmultibodyoverlap)
- [bNetAddressable](ue_ue.MotionControllerComponent.md#bnetaddressable)
- [bNeverDistanceCull](ue_ue.MotionControllerComponent.md#bneverdistancecull)
- [bOnlyOwnerSee](ue_ue.MotionControllerComponent.md#bonlyownersee)
- [bOwnerNoSee](ue_ue.MotionControllerComponent.md#bownernosee)
- [bReceiveMobileCSMShadows](ue_ue.MotionControllerComponent.md#breceivemobilecsmshadows)
- [bReceivesDecals](ue_ue.MotionControllerComponent.md#breceivesdecals)
- [bRenderCustomDepth](ue_ue.MotionControllerComponent.md#brendercustomdepth)
- [bRenderInDepthPass](ue_ue.MotionControllerComponent.md#brenderindepthpass)
- [bRenderInMainPass](ue_ue.MotionControllerComponent.md#brenderinmainpass)
- [bReplicatePhysicsToAutonomousProxy](ue_ue.MotionControllerComponent.md#breplicatephysicstoautonomousproxy)
- [bReplicates](ue_ue.MotionControllerComponent.md#breplicates)
- [bReturnMaterialOnMove](ue_ue.MotionControllerComponent.md#breturnmaterialonmove)
- [bSelectable](ue_ue.MotionControllerComponent.md#bselectable)
- [bSelfShadowOnly](ue_ue.MotionControllerComponent.md#bselfshadowonly)
- [bShouldBeAttached](ue_ue.MotionControllerComponent.md#bshouldbeattached)
- [bShouldSnapLocationWhenAttached](ue_ue.MotionControllerComponent.md#bshouldsnaplocationwhenattached)
- [bShouldSnapRotationWhenAttached](ue_ue.MotionControllerComponent.md#bshouldsnaprotationwhenattached)
- [bShouldUpdatePhysicsVolume](ue_ue.MotionControllerComponent.md#bshouldupdatephysicsvolume)
- [bSingleSampleShadowFromStationaryLights](ue_ue.MotionControllerComponent.md#bsinglesampleshadowfromstationarylights)
- [bTraceComplexOnMove](ue_ue.MotionControllerComponent.md#btracecomplexonmove)
- [bTreatAsBackgroundForOcclusion](ue_ue.MotionControllerComponent.md#btreatasbackgroundforocclusion)
- [bUseAsOccluder](ue_ue.MotionControllerComponent.md#buseasoccluder)
- [bUseAttachParentBound](ue_ue.MotionControllerComponent.md#buseattachparentbound)
- [bUseEditorCompositing](ue_ue.MotionControllerComponent.md#buseeditorcompositing)
- [bUseMaxLODAsImposter](ue_ue.MotionControllerComponent.md#busemaxlodasimposter)
- [bUseViewOwnerDepthPriorityGroup](ue_ue.MotionControllerComponent.md#buseviewownerdepthprioritygroup)
- [bVisible](ue_ue.MotionControllerComponent.md#bvisible)
- [bVisibleInRayTracing](ue_ue.MotionControllerComponent.md#bvisibleinraytracing)
- [bVisibleInReflectionCaptures](ue_ue.MotionControllerComponent.md#bvisibleinreflectioncaptures)
- [bVisualizeComponent](ue_ue.MotionControllerComponent.md#bvisualizecomponent)

### Methods

- [Activate](ue_ue.MotionControllerComponent.md#activate)
- [AddAngularImpulse](ue_ue.MotionControllerComponent.md#addangularimpulse)
- [AddAngularImpulseInDegrees](ue_ue.MotionControllerComponent.md#addangularimpulseindegrees)
- [AddAngularImpulseInRadians](ue_ue.MotionControllerComponent.md#addangularimpulseinradians)
- [AddForce](ue_ue.MotionControllerComponent.md#addforce)
- [AddForceAtLocation](ue_ue.MotionControllerComponent.md#addforceatlocation)
- [AddForceAtLocationLocal](ue_ue.MotionControllerComponent.md#addforceatlocationlocal)
- [AddImpulse](ue_ue.MotionControllerComponent.md#addimpulse)
- [AddImpulseAtLocation](ue_ue.MotionControllerComponent.md#addimpulseatlocation)
- [AddRadialForce](ue_ue.MotionControllerComponent.md#addradialforce)
- [AddRadialImpulse](ue_ue.MotionControllerComponent.md#addradialimpulse)
- [AddTickPrerequisiteActor](ue_ue.MotionControllerComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.MotionControllerComponent.md#addtickprerequisitecomponent)
- [AddTorque](ue_ue.MotionControllerComponent.md#addtorque)
- [AddTorqueInDegrees](ue_ue.MotionControllerComponent.md#addtorqueindegrees)
- [AddTorqueInRadians](ue_ue.MotionControllerComponent.md#addtorqueinradians)
- [CanCharacterStepUp](ue_ue.MotionControllerComponent.md#cancharacterstepup)
- [ClearMoveIgnoreActors](ue_ue.MotionControllerComponent.md#clearmoveignoreactors)
- [ClearMoveIgnoreComponents](ue_ue.MotionControllerComponent.md#clearmoveignorecomponents)
- [ComponentHasTag](ue_ue.MotionControllerComponent.md#componenthastag)
- [CopyArrayOfMoveIgnoreActors](ue_ue.MotionControllerComponent.md#copyarrayofmoveignoreactors)
- [CopyArrayOfMoveIgnoreComponents](ue_ue.MotionControllerComponent.md#copyarrayofmoveignorecomponents)
- [CreateAndSetMaterialInstanceDynamic](ue_ue.MotionControllerComponent.md#createandsetmaterialinstancedynamic)
- [CreateAndSetMaterialInstanceDynamicFromMaterial](ue_ue.MotionControllerComponent.md#createandsetmaterialinstancedynamicfrommaterial)
- [CreateDefaultSubobject](ue_ue.MotionControllerComponent.md#createdefaultsubobject)
- [CreateDynamicMaterialInstance](ue_ue.MotionControllerComponent.md#createdynamicmaterialinstance)
- [Deactivate](ue_ue.MotionControllerComponent.md#deactivate)
- [DetachFromParent](ue_ue.MotionControllerComponent.md#detachfromparent)
- [DoesSocketExist](ue_ue.MotionControllerComponent.md#doessocketexist)
- [ExecuteUbergraph](ue_ue.MotionControllerComponent.md#executeubergraph)
- [GetAllSocketNames](ue_ue.MotionControllerComponent.md#getallsocketnames)
- [GetAngularDamping](ue_ue.MotionControllerComponent.md#getangulardamping)
- [GetAttachParent](ue_ue.MotionControllerComponent.md#getattachparent)
- [GetAttachSocketName](ue_ue.MotionControllerComponent.md#getattachsocketname)
- [GetCenterOfMass](ue_ue.MotionControllerComponent.md#getcenterofmass)
- [GetChildComponent](ue_ue.MotionControllerComponent.md#getchildcomponent)
- [GetChildrenComponents](ue_ue.MotionControllerComponent.md#getchildrencomponents)
- [GetClass](ue_ue.MotionControllerComponent.md#getclass)
- [GetClosestPointOnCollision](ue_ue.MotionControllerComponent.md#getclosestpointoncollision)
- [GetCollisionEnabled](ue_ue.MotionControllerComponent.md#getcollisionenabled)
- [GetCollisionObjectType](ue_ue.MotionControllerComponent.md#getcollisionobjecttype)
- [GetCollisionProfileName](ue_ue.MotionControllerComponent.md#getcollisionprofilename)
- [GetCollisionResponseToChannel](ue_ue.MotionControllerComponent.md#getcollisionresponsetochannel)
- [GetComponentTickInterval](ue_ue.MotionControllerComponent.md#getcomponenttickinterval)
- [GetComponentVelocity](ue_ue.MotionControllerComponent.md#getcomponentvelocity)
- [GetForwardVector](ue_ue.MotionControllerComponent.md#getforwardvector)
- [GetGenerateOverlapEvents](ue_ue.MotionControllerComponent.md#getgenerateoverlapevents)
- [GetHandJointPosition](ue_ue.MotionControllerComponent.md#gethandjointposition)
- [GetInertiaTensor](ue_ue.MotionControllerComponent.md#getinertiatensor)
- [GetLinearDamping](ue_ue.MotionControllerComponent.md#getlineardamping)
- [GetMass](ue_ue.MotionControllerComponent.md#getmass)
- [GetMassScale](ue_ue.MotionControllerComponent.md#getmassscale)
- [GetMaterial](ue_ue.MotionControllerComponent.md#getmaterial)
- [GetMaterialFromCollisionFaceIndex](ue_ue.MotionControllerComponent.md#getmaterialfromcollisionfaceindex)
- [GetName](ue_ue.MotionControllerComponent.md#getname)
- [GetNumChildrenComponents](ue_ue.MotionControllerComponent.md#getnumchildrencomponents)
- [GetNumMaterials](ue_ue.MotionControllerComponent.md#getnummaterials)
- [GetOuter](ue_ue.MotionControllerComponent.md#getouter)
- [GetOverlappingActors](ue_ue.MotionControllerComponent.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue.MotionControllerComponent.md#getoverlappingcomponents)
- [GetOwner](ue_ue.MotionControllerComponent.md#getowner)
- [GetParameterValue](ue_ue.MotionControllerComponent.md#getparametervalue)
- [GetParentComponents](ue_ue.MotionControllerComponent.md#getparentcomponents)
- [GetPhysicsAngularVelocity](ue_ue.MotionControllerComponent.md#getphysicsangularvelocity)
- [GetPhysicsAngularVelocityInDegrees](ue_ue.MotionControllerComponent.md#getphysicsangularvelocityindegrees)
- [GetPhysicsAngularVelocityInRadians](ue_ue.MotionControllerComponent.md#getphysicsangularvelocityinradians)
- [GetPhysicsLinearVelocity](ue_ue.MotionControllerComponent.md#getphysicslinearvelocity)
- [GetPhysicsLinearVelocityAtPoint](ue_ue.MotionControllerComponent.md#getphysicslinearvelocityatpoint)
- [GetPhysicsVolume](ue_ue.MotionControllerComponent.md#getphysicsvolume)
- [GetRelativeTransform](ue_ue.MotionControllerComponent.md#getrelativetransform)
- [GetRightVector](ue_ue.MotionControllerComponent.md#getrightvector)
- [GetShouldUpdatePhysicsVolume](ue_ue.MotionControllerComponent.md#getshouldupdatephysicsvolume)
- [GetSocketLocation](ue_ue.MotionControllerComponent.md#getsocketlocation)
- [GetSocketQuaternion](ue_ue.MotionControllerComponent.md#getsocketquaternion)
- [GetSocketRotation](ue_ue.MotionControllerComponent.md#getsocketrotation)
- [GetSocketTransform](ue_ue.MotionControllerComponent.md#getsockettransform)
- [GetTrackingSource](ue_ue.MotionControllerComponent.md#gettrackingsource)
- [GetUpVector](ue_ue.MotionControllerComponent.md#getupvector)
- [GetWalkableSlopeOverride](ue_ue.MotionControllerComponent.md#getwalkableslopeoverride)
- [GetWorld](ue_ue.MotionControllerComponent.md#getworld)
- [IgnoreActorWhenMoving](ue_ue.MotionControllerComponent.md#ignoreactorwhenmoving)
- [IgnoreComponentWhenMoving](ue_ue.MotionControllerComponent.md#ignorecomponentwhenmoving)
- [IsActive](ue_ue.MotionControllerComponent.md#isactive)
- [IsAnyRigidBodyAwake](ue_ue.MotionControllerComponent.md#isanyrigidbodyawake)
- [IsAnySimulatingPhysics](ue_ue.MotionControllerComponent.md#isanysimulatingphysics)
- [IsBeingDestroyed](ue_ue.MotionControllerComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.MotionControllerComponent.md#iscomponenttickenabled)
- [IsGravityEnabled](ue_ue.MotionControllerComponent.md#isgravityenabled)
- [IsOverlappingActor](ue_ue.MotionControllerComponent.md#isoverlappingactor)
- [IsOverlappingComponent](ue_ue.MotionControllerComponent.md#isoverlappingcomponent)
- [IsSimulatingPhysics](ue_ue.MotionControllerComponent.md#issimulatingphysics)
- [IsTracked](ue_ue.MotionControllerComponent.md#istracked)
- [IsVisible](ue_ue.MotionControllerComponent.md#isvisible)
- [K2\_AddLocalOffset](ue_ue.MotionControllerComponent.md#k2_addlocaloffset)
- [K2\_AddLocalRotation](ue_ue.MotionControllerComponent.md#k2_addlocalrotation)
- [K2\_AddLocalTransform](ue_ue.MotionControllerComponent.md#k2_addlocaltransform)
- [K2\_AddRelativeLocation](ue_ue.MotionControllerComponent.md#k2_addrelativelocation)
- [K2\_AddRelativeRotation](ue_ue.MotionControllerComponent.md#k2_addrelativerotation)
- [K2\_AddWorldOffset](ue_ue.MotionControllerComponent.md#k2_addworldoffset)
- [K2\_AddWorldRotation](ue_ue.MotionControllerComponent.md#k2_addworldrotation)
- [K2\_AddWorldTransform](ue_ue.MotionControllerComponent.md#k2_addworldtransform)
- [K2\_AttachTo](ue_ue.MotionControllerComponent.md#k2_attachto)
- [K2\_AttachToComponent](ue_ue.MotionControllerComponent.md#k2_attachtocomponent)
- [K2\_BoxOverlapComponent](ue_ue.MotionControllerComponent.md#k2_boxoverlapcomponent)
- [K2\_DestroyComponent](ue_ue.MotionControllerComponent.md#k2_destroycomponent)
- [K2\_DetachFromComponent](ue_ue.MotionControllerComponent.md#k2_detachfromcomponent)
- [K2\_GetComponentLocation](ue_ue.MotionControllerComponent.md#k2_getcomponentlocation)
- [K2\_GetComponentRotation](ue_ue.MotionControllerComponent.md#k2_getcomponentrotation)
- [K2\_GetComponentScale](ue_ue.MotionControllerComponent.md#k2_getcomponentscale)
- [K2\_GetComponentToWorld](ue_ue.MotionControllerComponent.md#k2_getcomponenttoworld)
- [K2\_IsCollisionEnabled](ue_ue.MotionControllerComponent.md#k2_iscollisionenabled)
- [K2\_IsPhysicsCollisionEnabled](ue_ue.MotionControllerComponent.md#k2_isphysicscollisionenabled)
- [K2\_IsQueryCollisionEnabled](ue_ue.MotionControllerComponent.md#k2_isquerycollisionenabled)
- [K2\_LineTraceComponent](ue_ue.MotionControllerComponent.md#k2_linetracecomponent)
- [K2\_SetRelativeLocation](ue_ue.MotionControllerComponent.md#k2_setrelativelocation)
- [K2\_SetRelativeLocationAndRotation](ue_ue.MotionControllerComponent.md#k2_setrelativelocationandrotation)
- [K2\_SetRelativeRotation](ue_ue.MotionControllerComponent.md#k2_setrelativerotation)
- [K2\_SetRelativeTransform](ue_ue.MotionControllerComponent.md#k2_setrelativetransform)
- [K2\_SetWorldLocation](ue_ue.MotionControllerComponent.md#k2_setworldlocation)
- [K2\_SetWorldLocationAndRotation](ue_ue.MotionControllerComponent.md#k2_setworldlocationandrotation)
- [K2\_SetWorldRotation](ue_ue.MotionControllerComponent.md#k2_setworldrotation)
- [K2\_SetWorldTransform](ue_ue.MotionControllerComponent.md#k2_setworldtransform)
- [K2\_SphereOverlapComponent](ue_ue.MotionControllerComponent.md#k2_sphereoverlapcomponent)
- [K2\_SphereTraceComponent](ue_ue.MotionControllerComponent.md#k2_spheretracecomponent)
- [OnMotionControllerUpdated](ue_ue.MotionControllerComponent.md#onmotioncontrollerupdated)
- [OnRep\_AttachChildren](ue_ue.MotionControllerComponent.md#onrep_attachchildren)
- [OnRep\_AttachParent](ue_ue.MotionControllerComponent.md#onrep_attachparent)
- [OnRep\_AttachSocketName](ue_ue.MotionControllerComponent.md#onrep_attachsocketname)
- [OnRep\_IsActive](ue_ue.MotionControllerComponent.md#onrep_isactive)
- [OnRep\_Transform](ue_ue.MotionControllerComponent.md#onrep_transform)
- [OnRep\_Visibility](ue_ue.MotionControllerComponent.md#onrep_visibility)
- [PutRigidBodyToSleep](ue_ue.MotionControllerComponent.md#putrigidbodytosleep)
- [ReceiveBeginPlay](ue_ue.MotionControllerComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.MotionControllerComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.MotionControllerComponent.md#receivetick)
- [RegisterComponent](ue_ue.MotionControllerComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.MotionControllerComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.MotionControllerComponent.md#removetickprerequisitecomponent)
- [ResetRelativeTransform](ue_ue.MotionControllerComponent.md#resetrelativetransform)
- [ScaleByMomentOfInertia](ue_ue.MotionControllerComponent.md#scalebymomentofinertia)
- [SetAbsolute](ue_ue.MotionControllerComponent.md#setabsolute)
- [SetActive](ue_ue.MotionControllerComponent.md#setactive)
- [SetAllMassScale](ue_ue.MotionControllerComponent.md#setallmassscale)
- [SetAllPhysicsAngularVelocityInDegrees](ue_ue.MotionControllerComponent.md#setallphysicsangularvelocityindegrees)
- [SetAllPhysicsAngularVelocityInRadians](ue_ue.MotionControllerComponent.md#setallphysicsangularvelocityinradians)
- [SetAllPhysicsLinearVelocity](ue_ue.MotionControllerComponent.md#setallphysicslinearvelocity)
- [SetAllUseCCD](ue_ue.MotionControllerComponent.md#setalluseccd)
- [SetAngularDamping](ue_ue.MotionControllerComponent.md#setangulardamping)
- [SetAssociatedPlayerIndex](ue_ue.MotionControllerComponent.md#setassociatedplayerindex)
- [SetAutoActivate](ue_ue.MotionControllerComponent.md#setautoactivate)
- [SetBoundsScale](ue_ue.MotionControllerComponent.md#setboundsscale)
- [SetCastInsetShadow](ue_ue.MotionControllerComponent.md#setcastinsetshadow)
- [SetCastShadow](ue_ue.MotionControllerComponent.md#setcastshadow)
- [SetCenterOfMass](ue_ue.MotionControllerComponent.md#setcenterofmass)
- [SetCollisionEnabled](ue_ue.MotionControllerComponent.md#setcollisionenabled)
- [SetCollisionObjectType](ue_ue.MotionControllerComponent.md#setcollisionobjecttype)
- [SetCollisionProfileName](ue_ue.MotionControllerComponent.md#setcollisionprofilename)
- [SetCollisionResponseToAllChannels](ue_ue.MotionControllerComponent.md#setcollisionresponsetoallchannels)
- [SetCollisionResponseToChannel](ue_ue.MotionControllerComponent.md#setcollisionresponsetochannel)
- [SetComponentTickEnabled](ue_ue.MotionControllerComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.MotionControllerComponent.md#setcomponenttickinterval)
- [SetConstraintMode](ue_ue.MotionControllerComponent.md#setconstraintmode)
- [SetCullDistance](ue_ue.MotionControllerComponent.md#setculldistance)
- [SetCustomDepthStencilValue](ue_ue.MotionControllerComponent.md#setcustomdepthstencilvalue)
- [SetCustomDepthStencilWriteMask](ue_ue.MotionControllerComponent.md#setcustomdepthstencilwritemask)
- [SetCustomDisplayMesh](ue_ue.MotionControllerComponent.md#setcustomdisplaymesh)
- [SetCustomPrimitiveDataFloat](ue_ue.MotionControllerComponent.md#setcustomprimitivedatafloat)
- [SetCustomPrimitiveDataVector2](ue_ue.MotionControllerComponent.md#setcustomprimitivedatavector2)
- [SetCustomPrimitiveDataVector3](ue_ue.MotionControllerComponent.md#setcustomprimitivedatavector3)
- [SetCustomPrimitiveDataVector4](ue_ue.MotionControllerComponent.md#setcustomprimitivedatavector4)
- [SetDisplayModelSource](ue_ue.MotionControllerComponent.md#setdisplaymodelsource)
- [SetEnableGravity](ue_ue.MotionControllerComponent.md#setenablegravity)
- [SetExcludeFromLightAttachmentGroup](ue_ue.MotionControllerComponent.md#setexcludefromlightattachmentgroup)
- [SetGenerateOverlapEvents](ue_ue.MotionControllerComponent.md#setgenerateoverlapevents)
- [SetHiddenInGame](ue_ue.MotionControllerComponent.md#sethiddeningame)
- [SetIsReplicated](ue_ue.MotionControllerComponent.md#setisreplicated)
- [SetLightAttachmentsAsGroup](ue_ue.MotionControllerComponent.md#setlightattachmentsasgroup)
- [SetLinearDamping](ue_ue.MotionControllerComponent.md#setlineardamping)
- [SetMassOverrideInKg](ue_ue.MotionControllerComponent.md#setmassoverrideinkg)
- [SetMassScale](ue_ue.MotionControllerComponent.md#setmassscale)
- [SetMaterial](ue_ue.MotionControllerComponent.md#setmaterial)
- [SetMaterialByName](ue_ue.MotionControllerComponent.md#setmaterialbyname)
- [SetMobility](ue_ue.MotionControllerComponent.md#setmobility)
- [SetNotifyRigidBodyCollision](ue_ue.MotionControllerComponent.md#setnotifyrigidbodycollision)
- [SetOnlyOwnerSee](ue_ue.MotionControllerComponent.md#setonlyownersee)
- [SetOwnerNoSee](ue_ue.MotionControllerComponent.md#setownernosee)
- [SetPhysMaterialOverride](ue_ue.MotionControllerComponent.md#setphysmaterialoverride)
- [SetPhysicsAngularVelocity](ue_ue.MotionControllerComponent.md#setphysicsangularvelocity)
- [SetPhysicsAngularVelocityInDegrees](ue_ue.MotionControllerComponent.md#setphysicsangularvelocityindegrees)
- [SetPhysicsAngularVelocityInRadians](ue_ue.MotionControllerComponent.md#setphysicsangularvelocityinradians)
- [SetPhysicsLinearVelocity](ue_ue.MotionControllerComponent.md#setphysicslinearvelocity)
- [SetPhysicsMaxAngularVelocity](ue_ue.MotionControllerComponent.md#setphysicsmaxangularvelocity)
- [SetPhysicsMaxAngularVelocityInDegrees](ue_ue.MotionControllerComponent.md#setphysicsmaxangularvelocityindegrees)
- [SetPhysicsMaxAngularVelocityInRadians](ue_ue.MotionControllerComponent.md#setphysicsmaxangularvelocityinradians)
- [SetReceivesDecals](ue_ue.MotionControllerComponent.md#setreceivesdecals)
- [SetRelativeScale3D](ue_ue.MotionControllerComponent.md#setrelativescale3d)
- [SetRenderCustomDepth](ue_ue.MotionControllerComponent.md#setrendercustomdepth)
- [SetRenderInMainPass](ue_ue.MotionControllerComponent.md#setrenderinmainpass)
- [SetShouldUpdatePhysicsVolume](ue_ue.MotionControllerComponent.md#setshouldupdatephysicsvolume)
- [SetShowDeviceModel](ue_ue.MotionControllerComponent.md#setshowdevicemodel)
- [SetSimulatePhysics](ue_ue.MotionControllerComponent.md#setsimulatephysics)
- [SetSingleSampleShadowFromStationaryLights](ue_ue.MotionControllerComponent.md#setsinglesampleshadowfromstationarylights)
- [SetTickGroup](ue_ue.MotionControllerComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.MotionControllerComponent.md#settickablewhenpaused)
- [SetTrackingMotionSource](ue_ue.MotionControllerComponent.md#settrackingmotionsource)
- [SetTrackingSource](ue_ue.MotionControllerComponent.md#settrackingsource)
- [SetTranslucentSortPriority](ue_ue.MotionControllerComponent.md#settranslucentsortpriority)
- [SetUseCCD](ue_ue.MotionControllerComponent.md#setuseccd)
- [SetVisibility](ue_ue.MotionControllerComponent.md#setvisibility)
- [SetWalkableSlopeOverride](ue_ue.MotionControllerComponent.md#setwalkableslopeoverride)
- [SetWorldScale3D](ue_ue.MotionControllerComponent.md#setworldscale3d)
- [SetupAttachment](ue_ue.MotionControllerComponent.md#setupattachment)
- [SnapTo](ue_ue.MotionControllerComponent.md#snapto)
- [ToggleActive](ue_ue.MotionControllerComponent.md#toggleactive)
- [ToggleVisibility](ue_ue.MotionControllerComponent.md#togglevisibility)
- [WakeAllRigidBodies](ue_ue.MotionControllerComponent.md#wakeallrigidbodies)
- [WakeRigidBody](ue_ue.MotionControllerComponent.md#wakerigidbody)
- [Find](ue_ue.MotionControllerComponent.md#find)
- [Load](ue_ue.MotionControllerComponent.md#load)
- [StaticClass](ue_ue.MotionControllerComponent.md#staticclass)

## Constructors

### constructor

• **new MotionControllerComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:50834](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50834)
...
• **CurrentTrackingStatus**: [`ETrackingStatus`](../enums/ue_ue.ETrackingStatus.md)

#### Defined in

[ue/ue.d.ts:50839](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50839)
...
• **CustomDisplayMesh**: [`StaticMesh`](ue_ue.StaticMesh.md)

#### Defined in

[ue/ue.d.ts:50842](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50842)
...
• **DisplayComponent**: [`PrimitiveComponent`](ue_ue.PrimitiveComponent.md)

#### Defined in

[ue/ue.d.ts:50844](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50844)

___

### DisplayMeshMaterialOverrides

• **DisplayMeshMaterialOverrides**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`MaterialInterface`](ue_ue.MaterialInterface.md)\>

#### Defined in

[ue/ue.d.ts:50843](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50843)
...
[ue/ue.d.ts:50841](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50841)
...
[ue/ue.d.ts:50836](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50836)
...
[ue/ue.d.ts:50837](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50837)
...
[ue/ue.d.ts:50835](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50835)
...
### \_\_tid\_MotionControllerComponent\_\_

• **\_\_tid\_MotionControllerComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:50860](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50860)
...
[ue/ue.d.ts:50838](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50838)
...
[ue/ue.d.ts:50840](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50840)
...
▸ **GetHandJointPosition**(`jointIndex`, `bValueFound`): [`Vector`](ue_ue_s.Vector.md)
...
| :------ | :------ |
| `jointIndex` | `number` |
| `bValueFound` | [`$Ref`](../interfaces/puerts._Ref.md)<`boolean`\> |
...
[ue/ue.d.ts:50845](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50845)
...
▸ **GetParameterValue**(`InName`, `bValueFound`): `number`
...
[ue/ue.d.ts:50846](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50846)
...
▸ **GetTrackingSource**(): [`EControllerHand`](../enums/ue_ue.EControllerHand.md)
...
[ue/ue.d.ts:50847](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50847)
...
[ue/ue.d.ts:50848](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50848)
...
[ue/ue.d.ts:50849](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50849)
...
▸ **SetAssociatedPlayerIndex**(`NewPlayer`): `void`
...
[ue/ue.d.ts:50850](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50850)
...
▸ **SetCustomDisplayMesh**(`NewDisplayMesh`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `NewDisplayMesh` | [`$Nullable`](../modules/puerts.md#$nullable)<[`StaticMesh`](ue_ue.StaticMesh.md)\> |
...
[ue/ue.d.ts:50851](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50851)
...
▸ **SetDisplayModelSource**(`NewDisplayModelSource`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `NewDisplayModelSource` | `string` |
...
[ue/ue.d.ts:50852](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50852)
...
▸ **SetShowDeviceModel**(`bShowControllerModel`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `bShowControllerModel` | `boolean` |
...
[ue/ue.d.ts:50853](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50853)
...
▸ **SetTrackingMotionSource**(`NewSource`): `void`
...
[ue/ue.d.ts:50854](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50854)

___

### SetTrackingSource

▸ **SetTrackingSource**(`NewSource`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `NewSource` | [`EControllerHand`](../enums/ue_ue.EControllerHand.md) |
...
[ue/ue.d.ts:50855](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50855)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MotionControllerComponent`](ue_ue.MotionControllerComponent.md)
...
[ue/ue.d.ts:50857](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50857)

___

### Load

▸ `Static` **Load**(`InName`): [`MotionControllerComponent`](ue_ue.MotionControllerComponent.md)
...
[ue/ue.d.ts:50858](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50858)
...
[ue/ue.d.ts:50856](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L50856)
