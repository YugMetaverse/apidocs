[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieScene3DConstraintTrack

# Class: MovieScene3DConstraintTrack

[ue/ue](../modules/ue_ue.md).MovieScene3DConstraintTrack
...
- [constructor](ue_ue.MovieScene3DConstraintTrack.md#constructor)

### Properties

- [ConstraintSections](ue_ue.MovieScene3DConstraintTrack.md#constraintsections)
- [DisplayOptions](ue_ue.MovieScene3DConstraintTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieScene3DConstraintTrack.md#evaloptions)
- [Signature](ue_ue.MovieScene3DConstraintTrack.md#signature)
- [SortingOrder](ue_ue.MovieScene3DConstraintTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieScene3DConstraintTrack.md#tracktint)
- [\_\_tid\_MovieScene3DConstraintTrack\_\_](ue_ue.MovieScene3DConstraintTrack.md#__tid_moviescene3dconstrainttrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieScene3DConstraintTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieScene3DConstraintTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieScene3DConstraintTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieScene3DConstraintTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieScene3DConstraintTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieScene3DConstraintTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieScene3DConstraintTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieScene3DConstraintTrack.md#getclass)
- [GetName](ue_ue.MovieScene3DConstraintTrack.md#getname)
- [GetOuter](ue_ue.MovieScene3DConstraintTrack.md#getouter)
- [GetWorld](ue_ue.MovieScene3DConstraintTrack.md#getworld)
- [Find](ue_ue.MovieScene3DConstraintTrack.md#find)
- [Load](ue_ue.MovieScene3DConstraintTrack.md#load)
- [StaticClass](ue_ue.MovieScene3DConstraintTrack.md#staticclass)

## Constructors

### constructor

• **new MovieScene3DConstraintTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51062](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51062)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieScene3DConstraintTrack`](ue_ue.MovieScene3DConstraintTrack.md)
...
[ue/ue.d.ts:51065](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51065)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieScene3DConstraintTrack`](ue_ue.MovieScene3DConstraintTrack.md)
...
[ue/ue.d.ts:51066](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51066)
...
[ue/ue.d.ts:51064](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51064)
