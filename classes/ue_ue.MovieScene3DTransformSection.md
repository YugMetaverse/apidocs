[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieScene3DTransformSection

# Class: MovieScene3DTransformSection

[ue/ue](../modules/ue_ue.md).MovieScene3DTransformSection
...
- [constructor](ue_ue.MovieScene3DTransformSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieScene3DTransformSection.md#blendtype)
- [Easing](ue_ue.MovieScene3DTransformSection.md#easing)
- [EndTime](ue_ue.MovieScene3DTransformSection.md#endtime)
- [EvalOptions](ue_ue.MovieScene3DTransformSection.md#evaloptions)
- [ManualWeight](ue_ue.MovieScene3DTransformSection.md#manualweight)
- [OverlapPriority](ue_ue.MovieScene3DTransformSection.md#overlappriority)
- [PostRollFrames](ue_ue.MovieScene3DTransformSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieScene3DTransformSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieScene3DTransformSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieScene3DTransformSection.md#prerolltime)
- [Rotation](ue_ue.MovieScene3DTransformSection.md#rotation)
- [RowIndex](ue_ue.MovieScene3DTransformSection.md#rowindex)
- [Scale](ue_ue.MovieScene3DTransformSection.md#scale)
- [SectionRange](ue_ue.MovieScene3DTransformSection.md#sectionrange)
- [Show3DTrajectory](ue_ue.MovieScene3DTransformSection.md#show3dtrajectory)
- [Signature](ue_ue.MovieScene3DTransformSection.md#signature)
- [StartTime](ue_ue.MovieScene3DTransformSection.md#starttime)
- [TimecodeSource](ue_ue.MovieScene3DTransformSection.md#timecodesource)
- [TransformMask](ue_ue.MovieScene3DTransformSection.md#transformmask)
- [Translation](ue_ue.MovieScene3DTransformSection.md#translation)
- [\_\_tid\_MovieScene3DTransformSection\_\_](ue_ue.MovieScene3DTransformSection.md#__tid_moviescene3dtransformsection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieScene3DTransformSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieScene3DTransformSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieScene3DTransformSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieScene3DTransformSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieScene3DTransformSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieScene3DTransformSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieScene3DTransformSection.md#bsupportsinfiniterange)
- [bUseQuaternionInterpolation](ue_ue.MovieScene3DTransformSection.md#busequaternioninterpolation)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieScene3DTransformSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieScene3DTransformSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieScene3DTransformSection.md#getblendtype)
- [GetClass](ue_ue.MovieScene3DTransformSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieScene3DTransformSection.md#getcompletionmode)
- [GetName](ue_ue.MovieScene3DTransformSection.md#getname)
- [GetOuter](ue_ue.MovieScene3DTransformSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieScene3DTransformSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieScene3DTransformSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieScene3DTransformSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieScene3DTransformSection.md#getrowindex)
- [GetWorld](ue_ue.MovieScene3DTransformSection.md#getworld)
- [IsActive](ue_ue.MovieScene3DTransformSection.md#isactive)
- [IsLocked](ue_ue.MovieScene3DTransformSection.md#islocked)
- [SetBlendType](ue_ue.MovieScene3DTransformSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieScene3DTransformSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieScene3DTransformSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieScene3DTransformSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieScene3DTransformSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieScene3DTransformSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieScene3DTransformSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieScene3DTransformSection.md#setrowindex)
- [Find](ue_ue.MovieScene3DTransformSection.md#find)
- [Load](ue_ue.MovieScene3DTransformSection.md#load)
- [StaticClass](ue_ue.MovieScene3DTransformSection.md#staticclass)

## Constructors

### constructor

• **new MovieScene3DTransformSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51118](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51118)
...
• **ManualWeight**: [`MovieSceneFloatChannel`](ue_ue.MovieSceneFloatChannel.md)

#### Defined in

[ue/ue.d.ts:51123](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51123)
...
[ue/ue.d.ts:51121](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51121)
...
[ue/ue.d.ts:51122](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51122)
...
• **Show3DTrajectory**: [`EShow3DTrajectory`](../enums/ue_ue.EShow3DTrajectory.md)

#### Defined in

[ue/ue.d.ts:51125](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51125)
...
• **TransformMask**: [`MovieSceneTransformMask`](ue_ue.MovieSceneTransformMask.md)

#### Defined in

[ue/ue.d.ts:51119](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51119)
...
[ue/ue.d.ts:51120](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51120)

___

### \_\_tid\_MovieScene3DTransformSection\_\_

• **\_\_tid\_MovieScene3DTransformSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51130](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51130)
...
### bUseQuaternionInterpolation

• **bUseQuaternionInterpolation**: `boolean`

#### Defined in

[ue/ue.d.ts:51124](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51124)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieScene3DTransformSection`](ue_ue.MovieScene3DTransformSection.md)
...
[ue/ue.d.ts:51127](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51127)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieScene3DTransformSection`](ue_ue.MovieScene3DTransformSection.md)
...
[ue/ue.d.ts:51128](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51128)
...
[ue/ue.d.ts:51126](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51126)
