[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneBoolTrack

# Class: MovieSceneBoolTrack

[ue/ue](../modules/ue_ue.md).MovieSceneBoolTrack
...
- [constructor](ue_ue.MovieSceneBoolTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneBoolTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneBoolTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneBoolTrack.md#evaloptions)
- [PropertyName](ue_ue.MovieSceneBoolTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieSceneBoolTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieSceneBoolTrack.md#sectiontokey)
- [Sections](ue_ue.MovieSceneBoolTrack.md#sections)
- [Signature](ue_ue.MovieSceneBoolTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneBoolTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneBoolTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieSceneBoolTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneBoolTrack\_\_](ue_ue.MovieSceneBoolTrack.md#__tid_moviescenebooltrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneBoolTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieSceneBoolTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneBoolTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneBoolTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneBoolTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneBoolTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneBoolTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneBoolTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneBoolTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneBoolTrack.md#getclass)
- [GetName](ue_ue.MovieSceneBoolTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneBoolTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneBoolTrack.md#getworld)
- [Find](ue_ue.MovieSceneBoolTrack.md#find)
- [Load](ue_ue.MovieSceneBoolTrack.md#load)
- [StaticClass](ue_ue.MovieSceneBoolTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneBoolTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51300](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51300)
...
[ue/ue.d.ts:51305](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51305)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneBoolTrack`](ue_ue.MovieSceneBoolTrack.md)
...
[ue/ue.d.ts:51302](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51302)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneBoolTrack`](ue_ue.MovieSceneBoolTrack.md)
...
[ue/ue.d.ts:51303](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51303)
...
[ue/ue.d.ts:51301](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51301)
