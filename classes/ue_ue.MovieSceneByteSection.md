[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneByteSection

# Class: MovieSceneByteSection

[ue/ue](../modules/ue_ue.md).MovieSceneByteSection
...
- [constructor](ue_ue.MovieSceneByteSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieSceneByteSection.md#blendtype)
- [ByteCurve](ue_ue.MovieSceneByteSection.md#bytecurve)
- [Easing](ue_ue.MovieSceneByteSection.md#easing)
- [EndTime](ue_ue.MovieSceneByteSection.md#endtime)
- [EvalOptions](ue_ue.MovieSceneByteSection.md#evaloptions)
- [OverlapPriority](ue_ue.MovieSceneByteSection.md#overlappriority)
- [PostRollFrames](ue_ue.MovieSceneByteSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieSceneByteSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieSceneByteSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieSceneByteSection.md#prerolltime)
- [RowIndex](ue_ue.MovieSceneByteSection.md#rowindex)
- [SectionRange](ue_ue.MovieSceneByteSection.md#sectionrange)
- [Signature](ue_ue.MovieSceneByteSection.md#signature)
- [StartTime](ue_ue.MovieSceneByteSection.md#starttime)
- [TimecodeSource](ue_ue.MovieSceneByteSection.md#timecodesource)
- [\_\_tid\_MovieSceneByteSection\_\_](ue_ue.MovieSceneByteSection.md#__tid_moviescenebytesection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieSceneByteSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneByteSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneByteSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieSceneByteSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieSceneByteSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieSceneByteSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieSceneByteSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneByteSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneByteSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieSceneByteSection.md#getblendtype)
- [GetClass](ue_ue.MovieSceneByteSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieSceneByteSection.md#getcompletionmode)
- [GetName](ue_ue.MovieSceneByteSection.md#getname)
- [GetOuter](ue_ue.MovieSceneByteSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieSceneByteSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieSceneByteSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieSceneByteSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieSceneByteSection.md#getrowindex)
- [GetWorld](ue_ue.MovieSceneByteSection.md#getworld)
- [IsActive](ue_ue.MovieSceneByteSection.md#isactive)
- [IsLocked](ue_ue.MovieSceneByteSection.md#islocked)
- [SetBlendType](ue_ue.MovieSceneByteSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieSceneByteSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieSceneByteSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieSceneByteSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieSceneByteSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieSceneByteSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieSceneByteSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieSceneByteSection.md#setrowindex)
- [Find](ue_ue.MovieSceneByteSection.md#find)
- [Load](ue_ue.MovieSceneByteSection.md#load)
- [StaticClass](ue_ue.MovieSceneByteSection.md#staticclass)

## Constructors

### constructor

• **new MovieSceneByteSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51335](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51335)
...
• **ByteCurve**: [`MovieSceneByteChannel`](ue_ue.MovieSceneByteChannel.md)

#### Defined in

[ue/ue.d.ts:51336](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51336)
...
### \_\_tid\_MovieSceneByteSection\_\_

• **\_\_tid\_MovieSceneByteSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51341](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51341)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneByteSection`](ue_ue.MovieSceneByteSection.md)
...
[ue/ue.d.ts:51338](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51338)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneByteSection`](ue_ue.MovieSceneByteSection.md)
...
[ue/ue.d.ts:51339](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51339)
...
[ue/ue.d.ts:51337](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51337)
