[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneByteTrack

# Class: MovieSceneByteTrack

[ue/ue](../modules/ue_ue.md).MovieSceneByteTrack
...
- [constructor](ue_ue.MovieSceneByteTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneByteTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneByteTrack.md#displayoptions)
- [Enum](ue_ue.MovieSceneByteTrack.md#enum)
- [EvalOptions](ue_ue.MovieSceneByteTrack.md#evaloptions)
- [PropertyName](ue_ue.MovieSceneByteTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieSceneByteTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieSceneByteTrack.md#sectiontokey)
- [Sections](ue_ue.MovieSceneByteTrack.md#sections)
- [Signature](ue_ue.MovieSceneByteTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneByteTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneByteTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieSceneByteTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneByteTrack\_\_](ue_ue.MovieSceneByteTrack.md#__tid_moviescenebytetrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneByteTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieSceneByteTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneByteTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneByteTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneByteTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneByteTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneByteTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneByteTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneByteTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneByteTrack.md#getclass)
- [GetName](ue_ue.MovieSceneByteTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneByteTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneByteTrack.md#getworld)
- [Find](ue_ue.MovieSceneByteTrack.md#find)
- [Load](ue_ue.MovieSceneByteTrack.md#load)
- [StaticClass](ue_ue.MovieSceneByteTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneByteTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51345](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51345)
...
[ue/ue.d.ts:51346](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51346)
...
### \_\_tid\_MovieSceneByteTrack\_\_

• **\_\_tid\_MovieSceneByteTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51351](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51351)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneByteTrack`](ue_ue.MovieSceneByteTrack.md)
...
[ue/ue.d.ts:51348](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51348)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneByteTrack`](ue_ue.MovieSceneByteTrack.md)
...
[ue/ue.d.ts:51349](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51349)
...
[ue/ue.d.ts:51347](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51347)
