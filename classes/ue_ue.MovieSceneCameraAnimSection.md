[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneCameraAnimSection

# Class: MovieSceneCameraAnimSection

[ue/ue](../modules/ue_ue.md).MovieSceneCameraAnimSection
...
- [constructor](ue_ue.MovieSceneCameraAnimSection.md#constructor)

### Properties

- [AnimData](ue_ue.MovieSceneCameraAnimSection.md#animdata)
- [BlendInTime](ue_ue.MovieSceneCameraAnimSection.md#blendintime)
- [BlendOutTime](ue_ue.MovieSceneCameraAnimSection.md#blendouttime)
- [BlendType](ue_ue.MovieSceneCameraAnimSection.md#blendtype)
- [CameraAnim](ue_ue.MovieSceneCameraAnimSection.md#cameraanim)
- [Easing](ue_ue.MovieSceneCameraAnimSection.md#easing)
- [EndTime](ue_ue.MovieSceneCameraAnimSection.md#endtime)
- [EvalOptions](ue_ue.MovieSceneCameraAnimSection.md#evaloptions)
- [OverlapPriority](ue_ue.MovieSceneCameraAnimSection.md#overlappriority)
- [PlayRate](ue_ue.MovieSceneCameraAnimSection.md#playrate)
- [PlayScale](ue_ue.MovieSceneCameraAnimSection.md#playscale)
- [PostRollFrames](ue_ue.MovieSceneCameraAnimSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieSceneCameraAnimSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieSceneCameraAnimSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieSceneCameraAnimSection.md#prerolltime)
- [RowIndex](ue_ue.MovieSceneCameraAnimSection.md#rowindex)
- [SectionRange](ue_ue.MovieSceneCameraAnimSection.md#sectionrange)
- [Signature](ue_ue.MovieSceneCameraAnimSection.md#signature)
- [StartTime](ue_ue.MovieSceneCameraAnimSection.md#starttime)
- [TimecodeSource](ue_ue.MovieSceneCameraAnimSection.md#timecodesource)
- [\_\_tid\_MovieSceneCameraAnimSection\_\_](ue_ue.MovieSceneCameraAnimSection.md#__tid_moviescenecameraanimsection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieSceneCameraAnimSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneCameraAnimSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneCameraAnimSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieSceneCameraAnimSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieSceneCameraAnimSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieSceneCameraAnimSection.md#bislocked)
- [bLooping](ue_ue.MovieSceneCameraAnimSection.md#blooping)
- [bSupportsInfiniteRange](ue_ue.MovieSceneCameraAnimSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneCameraAnimSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneCameraAnimSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieSceneCameraAnimSection.md#getblendtype)
- [GetClass](ue_ue.MovieSceneCameraAnimSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieSceneCameraAnimSection.md#getcompletionmode)
- [GetName](ue_ue.MovieSceneCameraAnimSection.md#getname)
- [GetOuter](ue_ue.MovieSceneCameraAnimSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieSceneCameraAnimSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieSceneCameraAnimSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieSceneCameraAnimSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieSceneCameraAnimSection.md#getrowindex)
- [GetWorld](ue_ue.MovieSceneCameraAnimSection.md#getworld)
- [IsActive](ue_ue.MovieSceneCameraAnimSection.md#isactive)
- [IsLocked](ue_ue.MovieSceneCameraAnimSection.md#islocked)
- [SetBlendType](ue_ue.MovieSceneCameraAnimSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieSceneCameraAnimSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieSceneCameraAnimSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieSceneCameraAnimSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieSceneCameraAnimSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieSceneCameraAnimSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieSceneCameraAnimSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieSceneCameraAnimSection.md#setrowindex)
- [Find](ue_ue.MovieSceneCameraAnimSection.md#find)
- [Load](ue_ue.MovieSceneCameraAnimSection.md#load)
- [StaticClass](ue_ue.MovieSceneCameraAnimSection.md#staticclass)

## Constructors

### constructor

• **new MovieSceneCameraAnimSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51372](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51372)

## Properties

### AnimData

• **AnimData**: [`MovieSceneCameraAnimSectionData`](ue_ue.MovieSceneCameraAnimSectionData.md)

#### Defined in

[ue/ue.d.ts:51373](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51373)
...
[ue/ue.d.ts:51377](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51377)
...
[ue/ue.d.ts:51378](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51378)
...
[ue/ue.d.ts:51374](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51374)
...
[ue/ue.d.ts:51375](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51375)
...
[ue/ue.d.ts:51376](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51376)
...
### \_\_tid\_MovieSceneCameraAnimSection\_\_

• **\_\_tid\_MovieSceneCameraAnimSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51384](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51384)
...
[ue/ue.d.ts:51379](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51379)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneCameraAnimSection`](ue_ue.MovieSceneCameraAnimSection.md)
...
[ue/ue.d.ts:51381](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51381)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneCameraAnimSection`](ue_ue.MovieSceneCameraAnimSection.md)
...
[ue/ue.d.ts:51382](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51382)
...
[ue/ue.d.ts:51380](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51380)
