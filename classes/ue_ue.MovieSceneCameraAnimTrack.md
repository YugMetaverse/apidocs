[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneCameraAnimTrack

# Class: MovieSceneCameraAnimTrack

[ue/ue](../modules/ue_ue.md).MovieSceneCameraAnimTrack
...
- [constructor](ue_ue.MovieSceneCameraAnimTrack.md#constructor)

### Properties

- [CameraAnimSections](ue_ue.MovieSceneCameraAnimTrack.md#cameraanimsections)
- [DisplayName](ue_ue.MovieSceneCameraAnimTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneCameraAnimTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneCameraAnimTrack.md#evaloptions)
- [Signature](ue_ue.MovieSceneCameraAnimTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneCameraAnimTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneCameraAnimTrack.md#tracktint)
- [\_\_tid\_MovieSceneCameraAnimTrack\_\_](ue_ue.MovieSceneCameraAnimTrack.md#__tid_moviescenecameraanimtrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneCameraAnimTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneCameraAnimTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneCameraAnimTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneCameraAnimTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneCameraAnimTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneCameraAnimTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneCameraAnimTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneCameraAnimTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneCameraAnimTrack.md#getclass)
- [GetName](ue_ue.MovieSceneCameraAnimTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneCameraAnimTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneCameraAnimTrack.md#getworld)
- [Find](ue_ue.MovieSceneCameraAnimTrack.md#find)
- [Load](ue_ue.MovieSceneCameraAnimTrack.md#load)
- [StaticClass](ue_ue.MovieSceneCameraAnimTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneCameraAnimTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51388](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51388)

## Properties

### CameraAnimSections

• **CameraAnimSections**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`MovieSceneSection`](ue_ue.MovieSceneSection.md)\>

#### Defined in

[ue/ue.d.ts:51389](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51389)
...
### \_\_tid\_MovieSceneCameraAnimTrack\_\_

• **\_\_tid\_MovieSceneCameraAnimTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51394](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51394)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneCameraAnimTrack`](ue_ue.MovieSceneCameraAnimTrack.md)
...
[ue/ue.d.ts:51391](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51391)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneCameraAnimTrack`](ue_ue.MovieSceneCameraAnimTrack.md)
...
[ue/ue.d.ts:51392](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51392)
...
[ue/ue.d.ts:51390](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51390)
