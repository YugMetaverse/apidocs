[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneCameraCutSection

# Class: MovieSceneCameraCutSection

[ue/ue](../modules/ue_ue.md).MovieSceneCameraCutSection
...
- [constructor](ue_ue.MovieSceneCameraCutSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieSceneCameraCutSection.md#blendtype)
- [CameraBindingID](ue_ue.MovieSceneCameraCutSection.md#camerabindingid)
- [CameraGuid](ue_ue.MovieSceneCameraCutSection.md#cameraguid)
- [Easing](ue_ue.MovieSceneCameraCutSection.md#easing)
- [EndTime](ue_ue.MovieSceneCameraCutSection.md#endtime)
- [EvalOptions](ue_ue.MovieSceneCameraCutSection.md#evaloptions)
- [OverlapPriority](ue_ue.MovieSceneCameraCutSection.md#overlappriority)
- [PostRollFrames](ue_ue.MovieSceneCameraCutSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieSceneCameraCutSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieSceneCameraCutSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieSceneCameraCutSection.md#prerolltime)
- [RowIndex](ue_ue.MovieSceneCameraCutSection.md#rowindex)
- [SectionRange](ue_ue.MovieSceneCameraCutSection.md#sectionrange)
- [Signature](ue_ue.MovieSceneCameraCutSection.md#signature)
- [StartTime](ue_ue.MovieSceneCameraCutSection.md#starttime)
- [ThumbnailReferenceOffset](ue_ue.MovieSceneCameraCutSection.md#thumbnailreferenceoffset)
- [TimecodeSource](ue_ue.MovieSceneCameraCutSection.md#timecodesource)
- [\_\_tid\_MovieSceneCameraCutSection\_\_](ue_ue.MovieSceneCameraCutSection.md#__tid_moviescenecameracutsection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieSceneCameraCutSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneCameraCutSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneCameraCutSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieSceneCameraCutSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieSceneCameraCutSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieSceneCameraCutSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieSceneCameraCutSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneCameraCutSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneCameraCutSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieSceneCameraCutSection.md#getblendtype)
- [GetCameraBindingID](ue_ue.MovieSceneCameraCutSection.md#getcamerabindingid)
- [GetClass](ue_ue.MovieSceneCameraCutSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieSceneCameraCutSection.md#getcompletionmode)
- [GetName](ue_ue.MovieSceneCameraCutSection.md#getname)
- [GetOuter](ue_ue.MovieSceneCameraCutSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieSceneCameraCutSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieSceneCameraCutSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieSceneCameraCutSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieSceneCameraCutSection.md#getrowindex)
- [GetWorld](ue_ue.MovieSceneCameraCutSection.md#getworld)
- [IsActive](ue_ue.MovieSceneCameraCutSection.md#isactive)
- [IsLocked](ue_ue.MovieSceneCameraCutSection.md#islocked)
- [SetBlendType](ue_ue.MovieSceneCameraCutSection.md#setblendtype)
- [SetCameraBindingID](ue_ue.MovieSceneCameraCutSection.md#setcamerabindingid)
- [SetCompletionMode](ue_ue.MovieSceneCameraCutSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieSceneCameraCutSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieSceneCameraCutSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieSceneCameraCutSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieSceneCameraCutSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieSceneCameraCutSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieSceneCameraCutSection.md#setrowindex)
- [Find](ue_ue.MovieSceneCameraCutSection.md#find)
- [Load](ue_ue.MovieSceneCameraCutSection.md#load)
- [StaticClass](ue_ue.MovieSceneCameraCutSection.md#staticclass)

## Constructors

### constructor

• **new MovieSceneCameraCutSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51398](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51398)
...
• **CameraBindingID**: [`MovieSceneObjectBindingID`](ue_ue.MovieSceneObjectBindingID.md)

#### Defined in

[ue/ue.d.ts:51400](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51400)

___

### CameraGuid

• **CameraGuid**: [`Guid`](ue_ue_s.Guid.md)

#### Defined in

[ue/ue.d.ts:51399](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51399)
...
[ue/ue.d.ts:51401](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51401)
...
### \_\_tid\_MovieSceneCameraCutSection\_\_

• **\_\_tid\_MovieSceneCameraCutSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51408](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51408)
...
▸ **GetCameraBindingID**(): [`MovieSceneObjectBindingID`](ue_ue.MovieSceneObjectBindingID.md)
...
[ue/ue.d.ts:51402](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51402)
...
▸ **SetCameraBindingID**(`InCameraBindingID`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `InCameraBindingID` | [`MovieSceneObjectBindingID`](ue_ue.MovieSceneObjectBindingID.md) |
...
[ue/ue.d.ts:51403](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51403)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneCameraCutSection`](ue_ue.MovieSceneCameraCutSection.md)
...
[ue/ue.d.ts:51405](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51405)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneCameraCutSection`](ue_ue.MovieSceneCameraCutSection.md)
...
[ue/ue.d.ts:51406](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51406)
...
[ue/ue.d.ts:51404](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51404)
