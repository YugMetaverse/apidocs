[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneCameraCutTrack

# Class: MovieSceneCameraCutTrack

[ue/ue](../modules/ue_ue.md).MovieSceneCameraCutTrack
...
- [constructor](ue_ue.MovieSceneCameraCutTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneCameraCutTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneCameraCutTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneCameraCutTrack.md#evaloptions)
- [Sections](ue_ue.MovieSceneCameraCutTrack.md#sections)
- [Signature](ue_ue.MovieSceneCameraCutTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneCameraCutTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneCameraCutTrack.md#tracktint)
- [\_\_tid\_MovieSceneCameraCutTrack\_\_](ue_ue.MovieSceneCameraCutTrack.md#__tid_moviescenecameracuttrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneCameraCutTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneCameraCutTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneCameraCutTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneCameraCutTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneCameraCutTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneCameraCutTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneCameraCutTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneCameraCutTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneCameraCutTrack.md#getclass)
- [GetName](ue_ue.MovieSceneCameraCutTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneCameraCutTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneCameraCutTrack.md#getworld)
- [Find](ue_ue.MovieSceneCameraCutTrack.md#find)
- [Load](ue_ue.MovieSceneCameraCutTrack.md#load)
- [StaticClass](ue_ue.MovieSceneCameraCutTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneCameraCutTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51412](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51412)
...
[ue/ue.d.ts:51413](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51413)
...
### \_\_tid\_MovieSceneCameraCutTrack\_\_

• **\_\_tid\_MovieSceneCameraCutTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51418](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51418)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneCameraCutTrack`](ue_ue.MovieSceneCameraCutTrack.md)
...
[ue/ue.d.ts:51415](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51415)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneCameraCutTrack`](ue_ue.MovieSceneCameraCutTrack.md)
...
[ue/ue.d.ts:51416](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51416)
...
[ue/ue.d.ts:51414](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51414)
