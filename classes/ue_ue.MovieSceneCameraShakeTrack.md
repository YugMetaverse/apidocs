[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneCameraShakeTrack

# Class: MovieSceneCameraShakeTrack

[ue/ue](../modules/ue_ue.md).MovieSceneCameraShakeTrack
...
- [constructor](ue_ue.MovieSceneCameraShakeTrack.md#constructor)

### Properties

- [CameraShakeSections](ue_ue.MovieSceneCameraShakeTrack.md#camerashakesections)
- [DisplayName](ue_ue.MovieSceneCameraShakeTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneCameraShakeTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneCameraShakeTrack.md#evaloptions)
- [Signature](ue_ue.MovieSceneCameraShakeTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneCameraShakeTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneCameraShakeTrack.md#tracktint)
- [\_\_tid\_MovieSceneCameraShakeTrack\_\_](ue_ue.MovieSceneCameraShakeTrack.md#__tid_moviescenecamerashaketrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneCameraShakeTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneCameraShakeTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneCameraShakeTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneCameraShakeTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneCameraShakeTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneCameraShakeTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneCameraShakeTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneCameraShakeTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneCameraShakeTrack.md#getclass)
- [GetName](ue_ue.MovieSceneCameraShakeTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneCameraShakeTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneCameraShakeTrack.md#getworld)
- [Find](ue_ue.MovieSceneCameraShakeTrack.md#find)
- [Load](ue_ue.MovieSceneCameraShakeTrack.md#load)
- [StaticClass](ue_ue.MovieSceneCameraShakeTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneCameraShakeTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51451](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51451)

## Properties

### CameraShakeSections

• **CameraShakeSections**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`MovieSceneSection`](ue_ue.MovieSceneSection.md)\>

#### Defined in

[ue/ue.d.ts:51452](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51452)
...
### \_\_tid\_MovieSceneCameraShakeTrack\_\_

• **\_\_tid\_MovieSceneCameraShakeTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51457](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51457)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneCameraShakeTrack`](ue_ue.MovieSceneCameraShakeTrack.md)
...
[ue/ue.d.ts:51454](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51454)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneCameraShakeTrack`](ue_ue.MovieSceneCameraShakeTrack.md)
...
[ue/ue.d.ts:51455](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51455)
...
[ue/ue.d.ts:51453](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51453)
