[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneEnumTrack

# Class: MovieSceneEnumTrack

[ue/ue](../modules/ue_ue.md).MovieSceneEnumTrack
...
- [constructor](ue_ue.MovieSceneEnumTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneEnumTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneEnumTrack.md#displayoptions)
- [Enum](ue_ue.MovieSceneEnumTrack.md#enum)
- [EvalOptions](ue_ue.MovieSceneEnumTrack.md#evaloptions)
- [PropertyName](ue_ue.MovieSceneEnumTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieSceneEnumTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieSceneEnumTrack.md#sectiontokey)
- [Sections](ue_ue.MovieSceneEnumTrack.md#sections)
- [Signature](ue_ue.MovieSceneEnumTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneEnumTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneEnumTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieSceneEnumTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneEnumTrack\_\_](ue_ue.MovieSceneEnumTrack.md#__tid_moviesceneenumtrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneEnumTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieSceneEnumTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneEnumTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneEnumTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneEnumTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneEnumTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneEnumTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneEnumTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneEnumTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneEnumTrack.md#getclass)
- [GetName](ue_ue.MovieSceneEnumTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneEnumTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneEnumTrack.md#getworld)
- [Find](ue_ue.MovieSceneEnumTrack.md#find)
- [Load](ue_ue.MovieSceneEnumTrack.md#load)
- [StaticClass](ue_ue.MovieSceneEnumTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneEnumTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51641](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51641)
...
[ue/ue.d.ts:51642](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51642)
...
### \_\_tid\_MovieSceneEnumTrack\_\_

• **\_\_tid\_MovieSceneEnumTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51647](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51647)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneEnumTrack`](ue_ue.MovieSceneEnumTrack.md)
...
[ue/ue.d.ts:51644](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51644)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneEnumTrack`](ue_ue.MovieSceneEnumTrack.md)
...
[ue/ue.d.ts:51645](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51645)
...
[ue/ue.d.ts:51643](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51643)
