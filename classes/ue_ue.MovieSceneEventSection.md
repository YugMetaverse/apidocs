[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneEventSection

# Class: MovieSceneEventSection

[ue/ue](../modules/ue_ue.md).MovieSceneEventSection
...
- [constructor](ue_ue.MovieSceneEventSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieSceneEventSection.md#blendtype)
- [Easing](ue_ue.MovieSceneEventSection.md#easing)
- [EndTime](ue_ue.MovieSceneEventSection.md#endtime)
- [EvalOptions](ue_ue.MovieSceneEventSection.md#evaloptions)
- [EventData](ue_ue.MovieSceneEventSection.md#eventdata)
- [Events](ue_ue.MovieSceneEventSection.md#events)
- [OverlapPriority](ue_ue.MovieSceneEventSection.md#overlappriority)
- [PostRollFrames](ue_ue.MovieSceneEventSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieSceneEventSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieSceneEventSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieSceneEventSection.md#prerolltime)
- [RowIndex](ue_ue.MovieSceneEventSection.md#rowindex)
- [SectionRange](ue_ue.MovieSceneEventSection.md#sectionrange)
- [Signature](ue_ue.MovieSceneEventSection.md#signature)
- [StartTime](ue_ue.MovieSceneEventSection.md#starttime)
- [TimecodeSource](ue_ue.MovieSceneEventSection.md#timecodesource)
- [\_\_tid\_MovieSceneEventSection\_\_](ue_ue.MovieSceneEventSection.md#__tid_moviesceneeventsection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieSceneEventSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneEventSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneEventSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieSceneEventSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieSceneEventSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieSceneEventSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieSceneEventSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneEventSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneEventSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieSceneEventSection.md#getblendtype)
- [GetClass](ue_ue.MovieSceneEventSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieSceneEventSection.md#getcompletionmode)
- [GetName](ue_ue.MovieSceneEventSection.md#getname)
- [GetOuter](ue_ue.MovieSceneEventSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieSceneEventSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieSceneEventSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieSceneEventSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieSceneEventSection.md#getrowindex)
- [GetWorld](ue_ue.MovieSceneEventSection.md#getworld)
- [IsActive](ue_ue.MovieSceneEventSection.md#isactive)
- [IsLocked](ue_ue.MovieSceneEventSection.md#islocked)
- [SetBlendType](ue_ue.MovieSceneEventSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieSceneEventSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieSceneEventSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieSceneEventSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieSceneEventSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieSceneEventSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieSceneEventSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieSceneEventSection.md#setrowindex)
- [Find](ue_ue.MovieSceneEventSection.md#find)
- [Load](ue_ue.MovieSceneEventSection.md#load)
- [StaticClass](ue_ue.MovieSceneEventSection.md#staticclass)

## Constructors

### constructor

• **new MovieSceneEventSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51796](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51796)
...
• **EventData**: [`MovieSceneEventSectionData`](ue_ue.MovieSceneEventSectionData.md)

#### Defined in

[ue/ue.d.ts:51798](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51798)

___

### Events

• **Events**: [`NameCurve`](ue_ue.NameCurve.md)

#### Defined in

[ue/ue.d.ts:51797](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51797)
...
### \_\_tid\_MovieSceneEventSection\_\_

• **\_\_tid\_MovieSceneEventSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51803](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51803)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneEventSection`](ue_ue.MovieSceneEventSection.md)
...
[ue/ue.d.ts:51800](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51800)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneEventSection`](ue_ue.MovieSceneEventSection.md)
...
[ue/ue.d.ts:51801](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51801)
...
[ue/ue.d.ts:51799](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51799)
