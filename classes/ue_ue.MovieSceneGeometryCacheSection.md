[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneGeometryCacheSection

# Class: MovieSceneGeometryCacheSection

[ue/ue](../modules/ue_ue.md).MovieSceneGeometryCacheSection
...
- [constructor](ue_ue.MovieSceneGeometryCacheSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieSceneGeometryCacheSection.md#blendtype)
- [Easing](ue_ue.MovieSceneGeometryCacheSection.md#easing)
- [EndTime](ue_ue.MovieSceneGeometryCacheSection.md#endtime)
- [EvalOptions](ue_ue.MovieSceneGeometryCacheSection.md#evaloptions)
- [OverlapPriority](ue_ue.MovieSceneGeometryCacheSection.md#overlappriority)
- [Params](ue_ue.MovieSceneGeometryCacheSection.md#params)
- [PostRollFrames](ue_ue.MovieSceneGeometryCacheSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieSceneGeometryCacheSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieSceneGeometryCacheSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieSceneGeometryCacheSection.md#prerolltime)
- [RowIndex](ue_ue.MovieSceneGeometryCacheSection.md#rowindex)
- [SectionRange](ue_ue.MovieSceneGeometryCacheSection.md#sectionrange)
- [Signature](ue_ue.MovieSceneGeometryCacheSection.md#signature)
- [StartTime](ue_ue.MovieSceneGeometryCacheSection.md#starttime)
- [TimecodeSource](ue_ue.MovieSceneGeometryCacheSection.md#timecodesource)
- [\_\_tid\_MovieSceneGeometryCacheSection\_\_](ue_ue.MovieSceneGeometryCacheSection.md#__tid_moviescenegeometrycachesection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieSceneGeometryCacheSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneGeometryCacheSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneGeometryCacheSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieSceneGeometryCacheSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieSceneGeometryCacheSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieSceneGeometryCacheSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieSceneGeometryCacheSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneGeometryCacheSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneGeometryCacheSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieSceneGeometryCacheSection.md#getblendtype)
- [GetClass](ue_ue.MovieSceneGeometryCacheSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieSceneGeometryCacheSection.md#getcompletionmode)
- [GetName](ue_ue.MovieSceneGeometryCacheSection.md#getname)
- [GetOuter](ue_ue.MovieSceneGeometryCacheSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieSceneGeometryCacheSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieSceneGeometryCacheSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieSceneGeometryCacheSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieSceneGeometryCacheSection.md#getrowindex)
- [GetWorld](ue_ue.MovieSceneGeometryCacheSection.md#getworld)
- [IsActive](ue_ue.MovieSceneGeometryCacheSection.md#isactive)
- [IsLocked](ue_ue.MovieSceneGeometryCacheSection.md#islocked)
- [SetBlendType](ue_ue.MovieSceneGeometryCacheSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieSceneGeometryCacheSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieSceneGeometryCacheSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieSceneGeometryCacheSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieSceneGeometryCacheSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieSceneGeometryCacheSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieSceneGeometryCacheSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieSceneGeometryCacheSection.md#setrowindex)
- [Find](ue_ue.MovieSceneGeometryCacheSection.md#find)
- [Load](ue_ue.MovieSceneGeometryCacheSection.md#load)
- [StaticClass](ue_ue.MovieSceneGeometryCacheSection.md#staticclass)

## Constructors

### constructor

• **new MovieSceneGeometryCacheSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51903](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51903)
...
• **Params**: [`MovieSceneGeometryCacheParams`](ue_ue.MovieSceneGeometryCacheParams.md)

#### Defined in

[ue/ue.d.ts:51904](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51904)
...
### \_\_tid\_MovieSceneGeometryCacheSection\_\_

• **\_\_tid\_MovieSceneGeometryCacheSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51909](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51909)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneGeometryCacheSection`](ue_ue.MovieSceneGeometryCacheSection.md)
...
[ue/ue.d.ts:51906](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51906)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneGeometryCacheSection`](ue_ue.MovieSceneGeometryCacheSection.md)
...
[ue/ue.d.ts:51907](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51907)
...
[ue/ue.d.ts:51905](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51905)
