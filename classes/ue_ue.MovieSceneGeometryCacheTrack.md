[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneGeometryCacheTrack

# Class: MovieSceneGeometryCacheTrack

[ue/ue](../modules/ue_ue.md).MovieSceneGeometryCacheTrack
...
- [constructor](ue_ue.MovieSceneGeometryCacheTrack.md#constructor)

### Properties

- [AnimationSections](ue_ue.MovieSceneGeometryCacheTrack.md#animationsections)
- [DisplayName](ue_ue.MovieSceneGeometryCacheTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneGeometryCacheTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneGeometryCacheTrack.md#evaloptions)
- [Signature](ue_ue.MovieSceneGeometryCacheTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneGeometryCacheTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneGeometryCacheTrack.md#tracktint)
- [\_\_tid\_MovieSceneGeometryCacheTrack\_\_](ue_ue.MovieSceneGeometryCacheTrack.md#__tid_moviescenegeometrycachetrack__)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneGeometryCacheTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneGeometryCacheTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneGeometryCacheTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneGeometryCacheTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneGeometryCacheTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneGeometryCacheTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneGeometryCacheTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneGeometryCacheTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneGeometryCacheTrack.md#getclass)
- [GetName](ue_ue.MovieSceneGeometryCacheTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneGeometryCacheTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneGeometryCacheTrack.md#getworld)
- [Find](ue_ue.MovieSceneGeometryCacheTrack.md#find)
- [Load](ue_ue.MovieSceneGeometryCacheTrack.md#load)
- [StaticClass](ue_ue.MovieSceneGeometryCacheTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneGeometryCacheTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51913](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51913)
...
[ue/ue.d.ts:51914](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51914)
...
### \_\_tid\_MovieSceneGeometryCacheTrack\_\_

• **\_\_tid\_MovieSceneGeometryCacheTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51919](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51919)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneGeometryCacheTrack`](ue_ue.MovieSceneGeometryCacheTrack.md)
...
[ue/ue.d.ts:51916](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51916)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneGeometryCacheTrack`](ue_ue.MovieSceneGeometryCacheTrack.md)
...
[ue/ue.d.ts:51917](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51917)
...
[ue/ue.d.ts:51915](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L51915)
