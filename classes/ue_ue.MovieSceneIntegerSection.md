[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneIntegerSection

# Class: MovieSceneIntegerSection

[ue/ue](../modules/ue_ue.md).MovieSceneIntegerSection
...
- [constructor](ue_ue.MovieSceneIntegerSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieSceneIntegerSection.md#blendtype)
- [Easing](ue_ue.MovieSceneIntegerSection.md#easing)
- [EndTime](ue_ue.MovieSceneIntegerSection.md#endtime)
- [EvalOptions](ue_ue.MovieSceneIntegerSection.md#evaloptions)
- [IntegerCurve](ue_ue.MovieSceneIntegerSection.md#integercurve)
- [OverlapPriority](ue_ue.MovieSceneIntegerSection.md#overlappriority)
- [PostRollFrames](ue_ue.MovieSceneIntegerSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieSceneIntegerSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieSceneIntegerSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieSceneIntegerSection.md#prerolltime)
- [RowIndex](ue_ue.MovieSceneIntegerSection.md#rowindex)
- [SectionRange](ue_ue.MovieSceneIntegerSection.md#sectionrange)
- [Signature](ue_ue.MovieSceneIntegerSection.md#signature)
- [StartTime](ue_ue.MovieSceneIntegerSection.md#starttime)
- [TimecodeSource](ue_ue.MovieSceneIntegerSection.md#timecodesource)
- [\_\_tid\_MovieSceneIntegerSection\_\_](ue_ue.MovieSceneIntegerSection.md#__tid_moviesceneintegersection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieSceneIntegerSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneIntegerSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneIntegerSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieSceneIntegerSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieSceneIntegerSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieSceneIntegerSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieSceneIntegerSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneIntegerSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneIntegerSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieSceneIntegerSection.md#getblendtype)
- [GetClass](ue_ue.MovieSceneIntegerSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieSceneIntegerSection.md#getcompletionmode)
- [GetName](ue_ue.MovieSceneIntegerSection.md#getname)
- [GetOuter](ue_ue.MovieSceneIntegerSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieSceneIntegerSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieSceneIntegerSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieSceneIntegerSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieSceneIntegerSection.md#getrowindex)
- [GetWorld](ue_ue.MovieSceneIntegerSection.md#getworld)
- [IsActive](ue_ue.MovieSceneIntegerSection.md#isactive)
- [IsLocked](ue_ue.MovieSceneIntegerSection.md#islocked)
- [SetBlendType](ue_ue.MovieSceneIntegerSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieSceneIntegerSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieSceneIntegerSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieSceneIntegerSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieSceneIntegerSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieSceneIntegerSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieSceneIntegerSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieSceneIntegerSection.md#setrowindex)
- [Find](ue_ue.MovieSceneIntegerSection.md#find)
- [Load](ue_ue.MovieSceneIntegerSection.md#load)
- [StaticClass](ue_ue.MovieSceneIntegerSection.md#staticclass)

## Constructors

### constructor

• **new MovieSceneIntegerSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:51938](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51938)
...
• **IntegerCurve**: [`MovieSceneIntegerChannel`](ue_ue.MovieSceneIntegerChannel.md)

#### Defined in

[ue/ue.d.ts:51939](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51939)
...
### \_\_tid\_MovieSceneIntegerSection\_\_

• **\_\_tid\_MovieSceneIntegerSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:51944](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51944)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneIntegerSection`](ue_ue.MovieSceneIntegerSection.md)
...
[ue/ue.d.ts:51941](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51941)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneIntegerSection`](ue_ue.MovieSceneIntegerSection.md)
...
[ue/ue.d.ts:51942](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51942)
...
[ue/ue.d.ts:51940](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L51940)
