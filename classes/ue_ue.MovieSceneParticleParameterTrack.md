[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneParticleParameterTrack

# Class: MovieSceneParticleParameterTrack

[ue/ue](../modules/ue_ue.md).MovieSceneParticleParameterTrack
...
- [constructor](ue_ue.MovieSceneParticleParameterTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneParticleParameterTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneParticleParameterTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneParticleParameterTrack.md#evaloptions)
- [Sections](ue_ue.MovieSceneParticleParameterTrack.md#sections)
- [Signature](ue_ue.MovieSceneParticleParameterTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneParticleParameterTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneParticleParameterTrack.md#tracktint)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneParticleParameterTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieSceneParticleParameterTrack\_\_](ue_ue.MovieSceneParticleParameterTrack.md#__tid_moviesceneparticleparametertrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneParticleParameterTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneParticleParameterTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneParticleParameterTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneParticleParameterTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneParticleParameterTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneParticleParameterTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneParticleParameterTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneParticleParameterTrack.md#getclass)
- [GetName](ue_ue.MovieSceneParticleParameterTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneParticleParameterTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneParticleParameterTrack.md#getworld)
- [Find](ue_ue.MovieSceneParticleParameterTrack.md#find)
- [Load](ue_ue.MovieSceneParticleParameterTrack.md#load)
- [StaticClass](ue_ue.MovieSceneParticleParameterTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneParticleParameterTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52183](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52183)
...
[ue/ue.d.ts:52184](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52184)
...
### \_\_tid\_MovieSceneParticleParameterTrack\_\_

• **\_\_tid\_MovieSceneParticleParameterTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52189](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52189)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneParticleParameterTrack`](ue_ue.MovieSceneParticleParameterTrack.md)
...
[ue/ue.d.ts:52186](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52186)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneParticleParameterTrack`](ue_ue.MovieSceneParticleParameterTrack.md)
...
[ue/ue.d.ts:52187](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52187)
...
[ue/ue.d.ts:52185](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52185)
