[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieScenePrimitiveMaterialSection

# Class: MovieScenePrimitiveMaterialSection

[ue/ue](../modules/ue_ue.md).MovieScenePrimitiveMaterialSection
...
- [constructor](ue_ue.MovieScenePrimitiveMaterialSection.md#constructor)

### Properties

- [BlendType](ue_ue.MovieScenePrimitiveMaterialSection.md#blendtype)
- [Easing](ue_ue.MovieScenePrimitiveMaterialSection.md#easing)
- [EndTime](ue_ue.MovieScenePrimitiveMaterialSection.md#endtime)
- [EvalOptions](ue_ue.MovieScenePrimitiveMaterialSection.md#evaloptions)
- [MaterialChannel](ue_ue.MovieScenePrimitiveMaterialSection.md#materialchannel)
- [OverlapPriority](ue_ue.MovieScenePrimitiveMaterialSection.md#overlappriority)
- [PostRollFrames](ue_ue.MovieScenePrimitiveMaterialSection.md#postrollframes)
- [PostRollTime](ue_ue.MovieScenePrimitiveMaterialSection.md#postrolltime)
- [PreRollFrames](ue_ue.MovieScenePrimitiveMaterialSection.md#prerollframes)
- [PreRollTime](ue_ue.MovieScenePrimitiveMaterialSection.md#prerolltime)
- [RowIndex](ue_ue.MovieScenePrimitiveMaterialSection.md#rowindex)
- [SectionRange](ue_ue.MovieScenePrimitiveMaterialSection.md#sectionrange)
- [Signature](ue_ue.MovieScenePrimitiveMaterialSection.md#signature)
- [StartTime](ue_ue.MovieScenePrimitiveMaterialSection.md#starttime)
- [TimecodeSource](ue_ue.MovieScenePrimitiveMaterialSection.md#timecodesource)
- [\_\_tid\_MovieScenePrimitiveMaterialSection\_\_](ue_ue.MovieScenePrimitiveMaterialSection.md#__tid_moviesceneprimitivematerialsection__)
- [\_\_tid\_MovieSceneSection\_\_](ue_ue.MovieScenePrimitiveMaterialSection.md#__tid_moviescenesection__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieScenePrimitiveMaterialSection.md#__tid_moviescenesignedobject__)
- [\_\_tid\_Object\_\_](ue_ue.MovieScenePrimitiveMaterialSection.md#__tid_object__)
- [bIsActive](ue_ue.MovieScenePrimitiveMaterialSection.md#bisactive)
- [bIsInfinite](ue_ue.MovieScenePrimitiveMaterialSection.md#bisinfinite)
- [bIsLocked](ue_ue.MovieScenePrimitiveMaterialSection.md#bislocked)
- [bSupportsInfiniteRange](ue_ue.MovieScenePrimitiveMaterialSection.md#bsupportsinfiniterange)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieScenePrimitiveMaterialSection.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieScenePrimitiveMaterialSection.md#executeubergraph)
- [GetBlendType](ue_ue.MovieScenePrimitiveMaterialSection.md#getblendtype)
- [GetClass](ue_ue.MovieScenePrimitiveMaterialSection.md#getclass)
- [GetCompletionMode](ue_ue.MovieScenePrimitiveMaterialSection.md#getcompletionmode)
- [GetName](ue_ue.MovieScenePrimitiveMaterialSection.md#getname)
- [GetOuter](ue_ue.MovieScenePrimitiveMaterialSection.md#getouter)
- [GetOverlapPriority](ue_ue.MovieScenePrimitiveMaterialSection.md#getoverlappriority)
- [GetPostRollFrames](ue_ue.MovieScenePrimitiveMaterialSection.md#getpostrollframes)
- [GetPreRollFrames](ue_ue.MovieScenePrimitiveMaterialSection.md#getprerollframes)
- [GetRowIndex](ue_ue.MovieScenePrimitiveMaterialSection.md#getrowindex)
- [GetWorld](ue_ue.MovieScenePrimitiveMaterialSection.md#getworld)
- [IsActive](ue_ue.MovieScenePrimitiveMaterialSection.md#isactive)
- [IsLocked](ue_ue.MovieScenePrimitiveMaterialSection.md#islocked)
- [SetBlendType](ue_ue.MovieScenePrimitiveMaterialSection.md#setblendtype)
- [SetCompletionMode](ue_ue.MovieScenePrimitiveMaterialSection.md#setcompletionmode)
- [SetIsActive](ue_ue.MovieScenePrimitiveMaterialSection.md#setisactive)
- [SetIsLocked](ue_ue.MovieScenePrimitiveMaterialSection.md#setislocked)
- [SetOverlapPriority](ue_ue.MovieScenePrimitiveMaterialSection.md#setoverlappriority)
- [SetPostRollFrames](ue_ue.MovieScenePrimitiveMaterialSection.md#setpostrollframes)
- [SetPreRollFrames](ue_ue.MovieScenePrimitiveMaterialSection.md#setprerollframes)
- [SetRowIndex](ue_ue.MovieScenePrimitiveMaterialSection.md#setrowindex)
- [Find](ue_ue.MovieScenePrimitiveMaterialSection.md#find)
- [Load](ue_ue.MovieScenePrimitiveMaterialSection.md#load)
- [StaticClass](ue_ue.MovieScenePrimitiveMaterialSection.md#staticclass)

## Constructors

### constructor

• **new MovieScenePrimitiveMaterialSection**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52233](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52233)
...
• **MaterialChannel**: [`MovieSceneObjectPathChannel`](ue_ue.MovieSceneObjectPathChannel.md)

#### Defined in

[ue/ue.d.ts:52234](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52234)
...
### \_\_tid\_MovieScenePrimitiveMaterialSection\_\_

• **\_\_tid\_MovieScenePrimitiveMaterialSection\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52239](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52239)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieScenePrimitiveMaterialSection`](ue_ue.MovieScenePrimitiveMaterialSection.md)
...
[ue/ue.d.ts:52236](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52236)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieScenePrimitiveMaterialSection`](ue_ue.MovieScenePrimitiveMaterialSection.md)
...
[ue/ue.d.ts:52237](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52237)
...
[ue/ue.d.ts:52235](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52235)
