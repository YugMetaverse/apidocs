[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieScenePrimitiveMaterialTrack

# Class: MovieScenePrimitiveMaterialTrack

[ue/ue](../modules/ue_ue.md).MovieScenePrimitiveMaterialTrack
...
- [constructor](ue_ue.MovieScenePrimitiveMaterialTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieScenePrimitiveMaterialTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieScenePrimitiveMaterialTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieScenePrimitiveMaterialTrack.md#evaloptions)
- [MaterialIndex](ue_ue.MovieScenePrimitiveMaterialTrack.md#materialindex)
- [PropertyName](ue_ue.MovieScenePrimitiveMaterialTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieScenePrimitiveMaterialTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieScenePrimitiveMaterialTrack.md#sectiontokey)
- [Sections](ue_ue.MovieScenePrimitiveMaterialTrack.md#sections)
- [Signature](ue_ue.MovieScenePrimitiveMaterialTrack.md#signature)
- [SortingOrder](ue_ue.MovieScenePrimitiveMaterialTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieScenePrimitiveMaterialTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieScenePrimitiveMaterialTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieScenePrimitiveMaterialTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePrimitiveMaterialTrack\_\_](ue_ue.MovieScenePrimitiveMaterialTrack.md#__tid_moviesceneprimitivematerialtrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieScenePrimitiveMaterialTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieScenePrimitiveMaterialTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieScenePrimitiveMaterialTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieScenePrimitiveMaterialTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieScenePrimitiveMaterialTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieScenePrimitiveMaterialTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieScenePrimitiveMaterialTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieScenePrimitiveMaterialTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieScenePrimitiveMaterialTrack.md#getclass)
- [GetName](ue_ue.MovieScenePrimitiveMaterialTrack.md#getname)
- [GetOuter](ue_ue.MovieScenePrimitiveMaterialTrack.md#getouter)
- [GetWorld](ue_ue.MovieScenePrimitiveMaterialTrack.md#getworld)
- [Find](ue_ue.MovieScenePrimitiveMaterialTrack.md#find)
- [Load](ue_ue.MovieScenePrimitiveMaterialTrack.md#load)
- [StaticClass](ue_ue.MovieScenePrimitiveMaterialTrack.md#staticclass)

## Constructors

### constructor

• **new MovieScenePrimitiveMaterialTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52243](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52243)
...
[ue/ue.d.ts:52244](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52244)
...
### \_\_tid\_MovieScenePrimitiveMaterialTrack\_\_

• **\_\_tid\_MovieScenePrimitiveMaterialTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52249](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52249)
...
[MovieScenePropertyTrack](ue_ue.MovieScenePropertyTrack.md).[__tid_MovieScenePropertyTrack__](ue_ue.MovieScenePropertyTrack.md#__tid_moviescenepropertytrack__)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieScenePrimitiveMaterialTrack`](ue_ue.MovieScenePrimitiveMaterialTrack.md)
...
[ue/ue.d.ts:52246](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52246)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieScenePrimitiveMaterialTrack`](ue_ue.MovieScenePrimitiveMaterialTrack.md)
...
[ue/ue.d.ts:52247](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52247)
...
[ue/ue.d.ts:52245](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52245)
