[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneSkeletalAnimationTrack

# Class: MovieSceneSkeletalAnimationTrack

[ue/ue](../modules/ue_ue.md).MovieSceneSkeletalAnimationTrack
...
- [constructor](ue_ue.MovieSceneSkeletalAnimationTrack.md#constructor)

### Properties

- [AnimationSections](ue_ue.MovieSceneSkeletalAnimationTrack.md#animationsections)
- [DisplayName](ue_ue.MovieSceneSkeletalAnimationTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneSkeletalAnimationTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneSkeletalAnimationTrack.md#evaloptions)
- [Signature](ue_ue.MovieSceneSkeletalAnimationTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneSkeletalAnimationTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneSkeletalAnimationTrack.md#tracktint)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneSkeletalAnimationTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneSkeletalAnimationTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneSkeletalAnimationTrack\_\_](ue_ue.MovieSceneSkeletalAnimationTrack.md#__tid_moviesceneskeletalanimationtrack__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneSkeletalAnimationTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneSkeletalAnimationTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneSkeletalAnimationTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneSkeletalAnimationTrack.md#bsupportsdefaultsections)
- [bUseLegacySectionIndexBlend](ue_ue.MovieSceneSkeletalAnimationTrack.md#buselegacysectionindexblend)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneSkeletalAnimationTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneSkeletalAnimationTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneSkeletalAnimationTrack.md#getclass)
- [GetName](ue_ue.MovieSceneSkeletalAnimationTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneSkeletalAnimationTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneSkeletalAnimationTrack.md#getworld)
- [Find](ue_ue.MovieSceneSkeletalAnimationTrack.md#find)
- [Load](ue_ue.MovieSceneSkeletalAnimationTrack.md#load)
- [StaticClass](ue_ue.MovieSceneSkeletalAnimationTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneSkeletalAnimationTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52293](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52293)

## Properties

### AnimationSections

• **AnimationSections**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`MovieSceneSection`](ue_ue.MovieSceneSection.md)\>

#### Defined in

[ue/ue.d.ts:52294](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52294)
...
### \_\_tid\_MovieSceneSkeletalAnimationTrack\_\_

• **\_\_tid\_MovieSceneSkeletalAnimationTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52300](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52300)
...
[ue/ue.d.ts:52295](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52295)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneSkeletalAnimationTrack`](ue_ue.MovieSceneSkeletalAnimationTrack.md)
...
[ue/ue.d.ts:52297](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52297)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneSkeletalAnimationTrack`](ue_ue.MovieSceneSkeletalAnimationTrack.md)
...
[ue/ue.d.ts:52298](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52298)
...
[ue/ue.d.ts:52296](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52296)
