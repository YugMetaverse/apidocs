[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneStringTrack

# Class: MovieSceneStringTrack

[ue/ue](../modules/ue_ue.md).MovieSceneStringTrack
...
- [constructor](ue_ue.MovieSceneStringTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneStringTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneStringTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneStringTrack.md#evaloptions)
- [PropertyName](ue_ue.MovieSceneStringTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieSceneStringTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieSceneStringTrack.md#sectiontokey)
- [Sections](ue_ue.MovieSceneStringTrack.md#sections)
- [Signature](ue_ue.MovieSceneStringTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneStringTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneStringTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieSceneStringTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneStringTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieSceneStringTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneStringTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneStringTrack\_\_](ue_ue.MovieSceneStringTrack.md#__tid_moviescenestringtrack__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneStringTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneStringTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneStringTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneStringTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneStringTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneStringTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneStringTrack.md#getclass)
- [GetName](ue_ue.MovieSceneStringTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneStringTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneStringTrack.md#getworld)
- [Find](ue_ue.MovieSceneStringTrack.md#find)
- [Load](ue_ue.MovieSceneStringTrack.md#load)
- [StaticClass](ue_ue.MovieSceneStringTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneStringTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52367](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52367)
...
### \_\_tid\_MovieSceneStringTrack\_\_

• **\_\_tid\_MovieSceneStringTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52372](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52372)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneStringTrack`](ue_ue.MovieSceneStringTrack.md)
...
[ue/ue.d.ts:52369](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52369)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneStringTrack`](ue_ue.MovieSceneStringTrack.md)
...
[ue/ue.d.ts:52370](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52370)
...
[ue/ue.d.ts:52368](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L52368)
