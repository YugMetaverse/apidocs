[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneTransformTrack

# Class: MovieSceneTransformTrack

[ue/ue](../modules/ue_ue.md).MovieSceneTransformTrack
...
- [constructor](ue_ue.MovieSceneTransformTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneTransformTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneTransformTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneTransformTrack.md#evaloptions)
- [PropertyName](ue_ue.MovieSceneTransformTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieSceneTransformTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieSceneTransformTrack.md#sectiontokey)
- [Sections](ue_ue.MovieSceneTransformTrack.md#sections)
- [Signature](ue_ue.MovieSceneTransformTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneTransformTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneTransformTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieSceneTransformTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneTransformTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieSceneTransformTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneTransformTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneTransformTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_MovieSceneTransformTrack\_\_](ue_ue.MovieSceneTransformTrack.md#__tid_moviescenetransformtrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneTransformTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneTransformTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneTransformTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneTransformTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneTransformTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneTransformTrack.md#getclass)
- [GetName](ue_ue.MovieSceneTransformTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneTransformTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneTransformTrack.md#getworld)
- [Find](ue_ue.MovieSceneTransformTrack.md#find)
- [Load](ue_ue.MovieSceneTransformTrack.md#load)
- [StaticClass](ue_ue.MovieSceneTransformTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneTransformTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52433](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52433)
...
### \_\_tid\_MovieSceneTransformTrack\_\_

• **\_\_tid\_MovieSceneTransformTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52438](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52438)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneTransformTrack`](ue_ue.MovieSceneTransformTrack.md)
...
[ue/ue.d.ts:52435](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52435)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneTransformTrack`](ue_ue.MovieSceneTransformTrack.md)
...
[ue/ue.d.ts:52436](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52436)
...
[ue/ue.d.ts:52434](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52434)
