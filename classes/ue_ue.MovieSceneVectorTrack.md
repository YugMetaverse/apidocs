[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / MovieSceneVectorTrack

# Class: MovieSceneVectorTrack

[ue/ue](../modules/ue_ue.md).MovieSceneVectorTrack
...
- [constructor](ue_ue.MovieSceneVectorTrack.md#constructor)

### Properties

- [DisplayName](ue_ue.MovieSceneVectorTrack.md#displayname)
- [DisplayOptions](ue_ue.MovieSceneVectorTrack.md#displayoptions)
- [EvalOptions](ue_ue.MovieSceneVectorTrack.md#evaloptions)
- [NumChannelsUsed](ue_ue.MovieSceneVectorTrack.md#numchannelsused)
- [PropertyName](ue_ue.MovieSceneVectorTrack.md#propertyname)
- [PropertyPath](ue_ue.MovieSceneVectorTrack.md#propertypath)
- [SectionToKey](ue_ue.MovieSceneVectorTrack.md#sectiontokey)
- [Sections](ue_ue.MovieSceneVectorTrack.md#sections)
- [Signature](ue_ue.MovieSceneVectorTrack.md#signature)
- [SortingOrder](ue_ue.MovieSceneVectorTrack.md#sortingorder)
- [TrackTint](ue_ue.MovieSceneVectorTrack.md#tracktint)
- [UniqueTrackName](ue_ue.MovieSceneVectorTrack.md#uniquetrackname)
- [\_\_tid\_MovieSceneNameableTrack\_\_](ue_ue.MovieSceneVectorTrack.md#__tid_moviescenenameabletrack__)
- [\_\_tid\_MovieScenePropertyTrack\_\_](ue_ue.MovieSceneVectorTrack.md#__tid_moviescenepropertytrack__)
- [\_\_tid\_MovieSceneSignedObject\_\_](ue_ue.MovieSceneVectorTrack.md#__tid_moviescenesignedobject__)
- [\_\_tid\_MovieSceneTrack\_\_](ue_ue.MovieSceneVectorTrack.md#__tid_moviescenetrack__)
- [\_\_tid\_MovieSceneVectorTrack\_\_](ue_ue.MovieSceneVectorTrack.md#__tid_moviescenevectortrack__)
- [\_\_tid\_Object\_\_](ue_ue.MovieSceneVectorTrack.md#__tid_object__)
- [bIsEvalDisabled](ue_ue.MovieSceneVectorTrack.md#bisevaldisabled)
- [bSupportsDefaultSections](ue_ue.MovieSceneVectorTrack.md#bsupportsdefaultsections)

### Methods

- [CreateDefaultSubobject](ue_ue.MovieSceneVectorTrack.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.MovieSceneVectorTrack.md#executeubergraph)
- [GetClass](ue_ue.MovieSceneVectorTrack.md#getclass)
- [GetName](ue_ue.MovieSceneVectorTrack.md#getname)
- [GetOuter](ue_ue.MovieSceneVectorTrack.md#getouter)
- [GetWorld](ue_ue.MovieSceneVectorTrack.md#getworld)
- [Find](ue_ue.MovieSceneVectorTrack.md#find)
- [Load](ue_ue.MovieSceneVectorTrack.md#load)
- [StaticClass](ue_ue.MovieSceneVectorTrack.md#staticclass)

## Constructors

### constructor

• **new MovieSceneVectorTrack**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:52480](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52480)
...
[ue/ue.d.ts:52481](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52481)
...
### \_\_tid\_MovieSceneVectorTrack\_\_

• **\_\_tid\_MovieSceneVectorTrack\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:52486](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52486)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`MovieSceneVectorTrack`](ue_ue.MovieSceneVectorTrack.md)
...
[ue/ue.d.ts:52483](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52483)

___

### Load

▸ `Static` **Load**(`InName`): [`MovieSceneVectorTrack`](ue_ue.MovieSceneVectorTrack.md)
...
[ue/ue.d.ts:52484](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52484)
...
[ue/ue.d.ts:52482](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L52482)
