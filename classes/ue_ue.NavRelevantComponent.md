[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / NavRelevantComponent

# Class: NavRelevantComponent

[ue/ue](../modules/ue_ue.md).NavRelevantComponent
...
- [constructor](ue_ue.NavRelevantComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.NavRelevantComponent.md#assetuserdata)
- [CachedNavParent](ue_ue.NavRelevantComponent.md#cachednavparent)
- [ComponentTags](ue_ue.NavRelevantComponent.md#componenttags)
- [CreationMethod](ue_ue.NavRelevantComponent.md#creationmethod)
- [OnComponentActivated](ue_ue.NavRelevantComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.NavRelevantComponent.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.NavRelevantComponent.md#primarycomponenttick)
- [UCSModifiedProperties](ue_ue.NavRelevantComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.NavRelevantComponent.md#__tid_actorcomponent__)
- [\_\_tid\_NavRelevantComponent\_\_](ue_ue.NavRelevantComponent.md#__tid_navrelevantcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.NavRelevantComponent.md#__tid_object__)
- [bAttachToOwnersRoot](ue_ue.NavRelevantComponent.md#battachtoownersroot)
- [bAutoActivate](ue_ue.NavRelevantComponent.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.NavRelevantComponent.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.NavRelevantComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.NavRelevantComponent.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.NavRelevantComponent.md#binstancecomponent)
- [bIsActive](ue_ue.NavRelevantComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.NavRelevantComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.NavRelevantComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.NavRelevantComponent.md#bnetaddressable)
- [bReplicates](ue_ue.NavRelevantComponent.md#breplicates)

### Methods

- [Activate](ue_ue.NavRelevantComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.NavRelevantComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.NavRelevantComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.NavRelevantComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.NavRelevantComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.NavRelevantComponent.md#deactivate)
- [ExecuteUbergraph](ue_ue.NavRelevantComponent.md#executeubergraph)
- [GetClass](ue_ue.NavRelevantComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.NavRelevantComponent.md#getcomponenttickinterval)
- [GetName](ue_ue.NavRelevantComponent.md#getname)
- [GetOuter](ue_ue.NavRelevantComponent.md#getouter)
- [GetOwner](ue_ue.NavRelevantComponent.md#getowner)
- [GetWorld](ue_ue.NavRelevantComponent.md#getworld)
- [IsActive](ue_ue.NavRelevantComponent.md#isactive)
- [IsBeingDestroyed](ue_ue.NavRelevantComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.NavRelevantComponent.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.NavRelevantComponent.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.NavRelevantComponent.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.NavRelevantComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.NavRelevantComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.NavRelevantComponent.md#receivetick)
- [RegisterComponent](ue_ue.NavRelevantComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.NavRelevantComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.NavRelevantComponent.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.NavRelevantComponent.md#setactive)
- [SetAutoActivate](ue_ue.NavRelevantComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.NavRelevantComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.NavRelevantComponent.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.NavRelevantComponent.md#setisreplicated)
- [SetNavigationRelevancy](ue_ue.NavRelevantComponent.md#setnavigationrelevancy)
- [SetTickGroup](ue_ue.NavRelevantComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.NavRelevantComponent.md#settickablewhenpaused)
- [ToggleActive](ue_ue.NavRelevantComponent.md#toggleactive)
- [Find](ue_ue.NavRelevantComponent.md#find)
- [Load](ue_ue.NavRelevantComponent.md#load)
- [StaticClass](ue_ue.NavRelevantComponent.md#staticclass)

## Constructors

### constructor

• **new NavRelevantComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:53241](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53241)
...
[ue/ue.d.ts:53243](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53243)
...
[ue/ue.d.ts:53249](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53249)
...
[ue/ue.d.ts:53242](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53242)
...
[ue/ue.d.ts:53244](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53244)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`NavRelevantComponent`](ue_ue.NavRelevantComponent.md)
...
[ue/ue.d.ts:53246](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53246)

___

### Load

▸ `Static` **Load**(`InName`): [`NavRelevantComponent`](ue_ue.NavRelevantComponent.md)
...
[ue/ue.d.ts:53247](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53247)
...
[ue/ue.d.ts:53245](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L53245)
