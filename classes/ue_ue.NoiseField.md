[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / NoiseField

# Class: NoiseField

[ue/ue](../modules/ue_ue.md).NoiseField
...
- [constructor](ue_ue.NoiseField.md#constructor)

### Properties

- [AssetUserData](ue_ue.NoiseField.md#assetuserdata)
- [ComponentTags](ue_ue.NoiseField.md#componenttags)
- [CreationMethod](ue_ue.NoiseField.md#creationmethod)
- [MaxRange](ue_ue.NoiseField.md#maxrange)
- [MinRange](ue_ue.NoiseField.md#minrange)
- [OnComponentActivated](ue_ue.NoiseField.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.NoiseField.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.NoiseField.md#primarycomponenttick)
- [Transform](ue_ue.NoiseField.md#transform)
- [UCSModifiedProperties](ue_ue.NoiseField.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.NoiseField.md#__tid_actorcomponent__)
- [\_\_tid\_FieldNodeBase\_\_](ue_ue.NoiseField.md#__tid_fieldnodebase__)
- [\_\_tid\_FieldNodeFloat\_\_](ue_ue.NoiseField.md#__tid_fieldnodefloat__)
- [\_\_tid\_NoiseField\_\_](ue_ue.NoiseField.md#__tid_noisefield__)
- [\_\_tid\_Object\_\_](ue_ue.NoiseField.md#__tid_object__)
- [bAutoActivate](ue_ue.NoiseField.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.NoiseField.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.NoiseField.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.NoiseField.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.NoiseField.md#binstancecomponent)
- [bIsActive](ue_ue.NoiseField.md#bisactive)
- [bIsEditorOnly](ue_ue.NoiseField.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.NoiseField.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.NoiseField.md#bnetaddressable)
- [bReplicates](ue_ue.NoiseField.md#breplicates)

### Methods

- [Activate](ue_ue.NoiseField.md#activate)
- [AddTickPrerequisiteActor](ue_ue.NoiseField.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.NoiseField.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.NoiseField.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.NoiseField.md#createdefaultsubobject)
- [Deactivate](ue_ue.NoiseField.md#deactivate)
- [ExecuteUbergraph](ue_ue.NoiseField.md#executeubergraph)
- [GetClass](ue_ue.NoiseField.md#getclass)
- [GetComponentTickInterval](ue_ue.NoiseField.md#getcomponenttickinterval)
- [GetName](ue_ue.NoiseField.md#getname)
- [GetOuter](ue_ue.NoiseField.md#getouter)
- [GetOwner](ue_ue.NoiseField.md#getowner)
- [GetWorld](ue_ue.NoiseField.md#getworld)
- [IsActive](ue_ue.NoiseField.md#isactive)
- [IsBeingDestroyed](ue_ue.NoiseField.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.NoiseField.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.NoiseField.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.NoiseField.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.NoiseField.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.NoiseField.md#receiveendplay)
- [ReceiveTick](ue_ue.NoiseField.md#receivetick)
- [RegisterComponent](ue_ue.NoiseField.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.NoiseField.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.NoiseField.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.NoiseField.md#setactive)
- [SetAutoActivate](ue_ue.NoiseField.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.NoiseField.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.NoiseField.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.NoiseField.md#setisreplicated)
- [SetNoiseField](ue_ue.NoiseField.md#setnoisefield)
- [SetTickGroup](ue_ue.NoiseField.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.NoiseField.md#settickablewhenpaused)
- [ToggleActive](ue_ue.NoiseField.md#toggleactive)
- [Find](ue_ue.NoiseField.md#find)
- [Load](ue_ue.NoiseField.md#load)
- [StaticClass](ue_ue.NoiseField.md#staticclass)

## Constructors

### constructor

• **new NoiseField**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:53544](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53544)
...
[ue/ue.d.ts:53546](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53546)
...
[ue/ue.d.ts:53545](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53545)
...
[ue/ue.d.ts:53547](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53547)
...
### \_\_tid\_NoiseField\_\_

• **\_\_tid\_NoiseField\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:53553](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53553)
...
▸ **SetNoiseField**(`MinRange`, `MaxRange`, `Transform`): [`NoiseField`](ue_ue.NoiseField.md)
...
[`NoiseField`](ue_ue.NoiseField.md)

#### Defined in

[ue/ue.d.ts:53548](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53548)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`NoiseField`](ue_ue.NoiseField.md)
...
[ue/ue.d.ts:53550](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53550)

___

### Load

▸ `Static` **Load**(`InName`): [`NoiseField`](ue_ue.NoiseField.md)
...
[ue/ue.d.ts:53551](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53551)
...
[ue/ue.d.ts:53549](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53549)
