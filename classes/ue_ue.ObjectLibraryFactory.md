[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ObjectLibraryFactory

# Class: ObjectLibraryFactory

[ue/ue](../modules/ue_ue.md).ObjectLibraryFactory
...
- [constructor](ue_ue.ObjectLibraryFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.ObjectLibraryFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.ObjectLibraryFactory.md#automatedimportdata)
- [ContextClass](ue_ue.ObjectLibraryFactory.md#contextclass)
- [Formats](ue_ue.ObjectLibraryFactory.md#formats)
- [ImportPriority](ue_ue.ObjectLibraryFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.ObjectLibraryFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.ObjectLibraryFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.ObjectLibraryFactory.md#__tid_factory__)
- [\_\_tid\_ObjectLibraryFactory\_\_](ue_ue.ObjectLibraryFactory.md#__tid_objectlibraryfactory__)
- [\_\_tid\_Object\_\_](ue_ue.ObjectLibraryFactory.md#__tid_object__)
- [bCreateNew](ue_ue.ObjectLibraryFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.ObjectLibraryFactory.md#beditafternew)
- [bEditorImport](ue_ue.ObjectLibraryFactory.md#beditorimport)
- [bText](ue_ue.ObjectLibraryFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.ObjectLibraryFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ObjectLibraryFactory.md#executeubergraph)
- [GetClass](ue_ue.ObjectLibraryFactory.md#getclass)
- [GetName](ue_ue.ObjectLibraryFactory.md#getname)
- [GetOuter](ue_ue.ObjectLibraryFactory.md#getouter)
- [GetWorld](ue_ue.ObjectLibraryFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.ObjectLibraryFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.ObjectLibraryFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.ObjectLibraryFactory.md#find)
- [Load](ue_ue.ObjectLibraryFactory.md#load)
- [StaticClass](ue_ue.ObjectLibraryFactory.md#staticclass)

## Constructors

### constructor

• **new ObjectLibraryFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:53647](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53647)
...
### \_\_tid\_ObjectLibraryFactory\_\_

• **\_\_tid\_ObjectLibraryFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:53652](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53652)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ObjectLibraryFactory`](ue_ue.ObjectLibraryFactory.md)
...
[ue/ue.d.ts:53649](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53649)

___

### Load

▸ `Static` **Load**(`InName`): [`ObjectLibraryFactory`](ue_ue.ObjectLibraryFactory.md)
...
[ue/ue.d.ts:53650](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53650)
...
[ue/ue.d.ts:53648](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L53648)
