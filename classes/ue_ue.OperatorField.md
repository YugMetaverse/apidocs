[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / OperatorField

# Class: OperatorField

[ue/ue](../modules/ue_ue.md).OperatorField
...
- [constructor](ue_ue.OperatorField.md#constructor)

### Properties

- [AssetUserData](ue_ue.OperatorField.md#assetuserdata)
- [ComponentTags](ue_ue.OperatorField.md#componenttags)
- [CreationMethod](ue_ue.OperatorField.md#creationmethod)
- [LeftField](ue_ue.OperatorField.md#leftfield)
- [Magnitude](ue_ue.OperatorField.md#magnitude)
- [OnComponentActivated](ue_ue.OperatorField.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.OperatorField.md#oncomponentdeactivated)
- [Operation](ue_ue.OperatorField.md#operation)
- [PrimaryComponentTick](ue_ue.OperatorField.md#primarycomponenttick)
- [RightField](ue_ue.OperatorField.md#rightfield)
- [UCSModifiedProperties](ue_ue.OperatorField.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.OperatorField.md#__tid_actorcomponent__)
- [\_\_tid\_FieldNodeBase\_\_](ue_ue.OperatorField.md#__tid_fieldnodebase__)
- [\_\_tid\_Object\_\_](ue_ue.OperatorField.md#__tid_object__)
- [\_\_tid\_OperatorField\_\_](ue_ue.OperatorField.md#__tid_operatorfield__)
- [bAutoActivate](ue_ue.OperatorField.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.OperatorField.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.OperatorField.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.OperatorField.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.OperatorField.md#binstancecomponent)
- [bIsActive](ue_ue.OperatorField.md#bisactive)
- [bIsEditorOnly](ue_ue.OperatorField.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.OperatorField.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.OperatorField.md#bnetaddressable)
- [bReplicates](ue_ue.OperatorField.md#breplicates)

### Methods

- [Activate](ue_ue.OperatorField.md#activate)
- [AddTickPrerequisiteActor](ue_ue.OperatorField.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.OperatorField.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.OperatorField.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.OperatorField.md#createdefaultsubobject)
- [Deactivate](ue_ue.OperatorField.md#deactivate)
- [ExecuteUbergraph](ue_ue.OperatorField.md#executeubergraph)
- [GetClass](ue_ue.OperatorField.md#getclass)
- [GetComponentTickInterval](ue_ue.OperatorField.md#getcomponenttickinterval)
- [GetName](ue_ue.OperatorField.md#getname)
- [GetOuter](ue_ue.OperatorField.md#getouter)
- [GetOwner](ue_ue.OperatorField.md#getowner)
- [GetWorld](ue_ue.OperatorField.md#getworld)
- [IsActive](ue_ue.OperatorField.md#isactive)
- [IsBeingDestroyed](ue_ue.OperatorField.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.OperatorField.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.OperatorField.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.OperatorField.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.OperatorField.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.OperatorField.md#receiveendplay)
- [ReceiveTick](ue_ue.OperatorField.md#receivetick)
- [RegisterComponent](ue_ue.OperatorField.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.OperatorField.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.OperatorField.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.OperatorField.md#setactive)
- [SetAutoActivate](ue_ue.OperatorField.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.OperatorField.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.OperatorField.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.OperatorField.md#setisreplicated)
- [SetOperatorField](ue_ue.OperatorField.md#setoperatorfield)
- [SetTickGroup](ue_ue.OperatorField.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.OperatorField.md#settickablewhenpaused)
- [ToggleActive](ue_ue.OperatorField.md#toggleactive)
- [Find](ue_ue.OperatorField.md#find)
- [Load](ue_ue.OperatorField.md#load)
- [StaticClass](ue_ue.OperatorField.md#staticclass)

## Constructors

### constructor

• **new OperatorField**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54275](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54275)
...
• **LeftField**: [`FieldNodeBase`](ue_ue.FieldNodeBase.md)

#### Defined in

[ue/ue.d.ts:54278](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54278)
...
[ue/ue.d.ts:54276](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54276)
...
• **Operation**: [`EFieldOperationType`](../enums/ue_ue.EFieldOperationType.md)

#### Defined in

[ue/ue.d.ts:54279](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54279)
...
• **RightField**: [`FieldNodeBase`](ue_ue.FieldNodeBase.md)

#### Defined in

[ue/ue.d.ts:54277](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54277)
...
### \_\_tid\_OperatorField\_\_

• **\_\_tid\_OperatorField\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54285](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54285)
...
▸ **SetOperatorField**(`Magnitude`, `RightField`, `LeftField`, `Operation`): [`OperatorField`](ue_ue.OperatorField.md)
...
| :------ | :------ |
| `Magnitude` | `number` |
| `RightField` | [`$Nullable`](../modules/puerts.md#$nullable)<[`FieldNodeBase`](ue_ue.FieldNodeBase.md)\> |
| `LeftField` | [`$Nullable`](../modules/puerts.md#$nullable)<[`FieldNodeBase`](ue_ue.FieldNodeBase.md)\> |
| `Operation` | [`EFieldOperationType`](../enums/ue_ue.EFieldOperationType.md) |

#### Returns

[`OperatorField`](ue_ue.OperatorField.md)

#### Defined in

[ue/ue.d.ts:54280](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54280)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`OperatorField`](ue_ue.OperatorField.md)
...
[ue/ue.d.ts:54282](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54282)

___

### Load

▸ `Static` **Load**(`InName`): [`OperatorField`](ue_ue.OperatorField.md)
...
[ue/ue.d.ts:54283](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54283)
...
[ue/ue.d.ts:54281](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54281)
