[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PackFactory

# Class: PackFactory

[ue/ue](../modules/ue_ue.md).PackFactory
...
- [constructor](ue_ue.PackFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PackFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PackFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PackFactory.md#contextclass)
- [Formats](ue_ue.PackFactory.md#formats)
- [ImportPriority](ue_ue.PackFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PackFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PackFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PackFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PackFactory.md#__tid_object__)
- [\_\_tid\_PackFactory\_\_](ue_ue.PackFactory.md#__tid_packfactory__)
- [bCreateNew](ue_ue.PackFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PackFactory.md#beditafternew)
- [bEditorImport](ue_ue.PackFactory.md#beditorimport)
- [bText](ue_ue.PackFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PackFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PackFactory.md#executeubergraph)
- [GetClass](ue_ue.PackFactory.md#getclass)
- [GetName](ue_ue.PackFactory.md#getname)
- [GetOuter](ue_ue.PackFactory.md#getouter)
- [GetWorld](ue_ue.PackFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PackFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PackFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PackFactory.md#find)
- [Load](ue_ue.PackFactory.md#load)
- [StaticClass](ue_ue.PackFactory.md#staticclass)

## Constructors

### constructor

• **new PackFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54361](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54361)
...
### \_\_tid\_PackFactory\_\_

• **\_\_tid\_PackFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54366](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54366)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PackFactory`](ue_ue.PackFactory.md)
...
[ue/ue.d.ts:54363](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54363)

___

### Load

▸ `Static` **Load**(`InName`): [`PackFactory`](ue_ue.PackFactory.md)
...
[ue/ue.d.ts:54364](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54364)
...
[ue/ue.d.ts:54362](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54362)
