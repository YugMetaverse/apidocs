[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaintModeSettings
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaintModeSettings`](ue_ue.PaintModeSettings.md)
