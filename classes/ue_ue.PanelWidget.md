[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PanelWidget

# Class: PanelWidget

[ue/ue](../modules/ue_ue.md).PanelWidget
...
- [constructor](ue_ue.PanelWidget.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.PanelWidget.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.PanelWidget.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.PanelWidget.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.PanelWidget.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.PanelWidget.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.PanelWidget.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.PanelWidget.md#accessiblewidgetdata)
- [CategoryName](ue_ue.PanelWidget.md#categoryname)
- [Clipping](ue_ue.PanelWidget.md#clipping)
- [Cursor](ue_ue.PanelWidget.md#cursor)
- [DesignerFlags](ue_ue.PanelWidget.md#designerflags)
- [DisplayLabel](ue_ue.PanelWidget.md#displaylabel)
- [FlowDirectionPreference](ue_ue.PanelWidget.md#flowdirectionpreference)
- [NativeBindings](ue_ue.PanelWidget.md#nativebindings)
- [Navigation](ue_ue.PanelWidget.md#navigation)
- [RenderOpacity](ue_ue.PanelWidget.md#renderopacity)
- [RenderTransform](ue_ue.PanelWidget.md#rendertransform)
- [RenderTransformPivot](ue_ue.PanelWidget.md#rendertransformpivot)
- [Slot](ue_ue.PanelWidget.md#slot)
- [Slots](ue_ue.PanelWidget.md#slots)
- [ToolTipText](ue_ue.PanelWidget.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.PanelWidget.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.PanelWidget.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.PanelWidget.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.PanelWidget.md#visibility)
- [VisibilityDelegate](ue_ue.PanelWidget.md#visibilitydelegate)
- [\_\_tid\_Object\_\_](ue_ue.PanelWidget.md#__tid_object__)
- [\_\_tid\_PanelWidget\_\_](ue_ue.PanelWidget.md#__tid_panelwidget__)
- [\_\_tid\_Visual\_\_](ue_ue.PanelWidget.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.PanelWidget.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.PanelWidget.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.PanelWidget.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.PanelWidget.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.PanelWidget.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.PanelWidget.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.PanelWidget.md#bisenableddelegate)
- [bIsVariable](ue_ue.PanelWidget.md#bisvariable)
- [bIsVolatile](ue_ue.PanelWidget.md#bisvolatile)
- [bLockedInDesigner](ue_ue.PanelWidget.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.PanelWidget.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.PanelWidget.md#boverride_cursor)

### Methods

- [AddChild](ue_ue.PanelWidget.md#addchild)
- [ClearChildren](ue_ue.PanelWidget.md#clearchildren)
- [CreateDefaultSubobject](ue_ue.PanelWidget.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PanelWidget.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.PanelWidget.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.PanelWidget.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.PanelWidget.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.PanelWidget.md#generatewidgetforstring__delegatesignature)
- [GetAllChildren](ue_ue.PanelWidget.md#getallchildren)
- [GetBool\_\_DelegateSignature](ue_ue.PanelWidget.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.PanelWidget.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.PanelWidget.md#getcheckboxstate__delegatesignature)
- [GetChildAt](ue_ue.PanelWidget.md#getchildat)
- [GetChildIndex](ue_ue.PanelWidget.md#getchildindex)
- [GetChildrenCount](ue_ue.PanelWidget.md#getchildrencount)
- [GetClass](ue_ue.PanelWidget.md#getclass)
- [GetClipping](ue_ue.PanelWidget.md#getclipping)
- [GetDesiredSize](ue_ue.PanelWidget.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.PanelWidget.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.PanelWidget.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.PanelWidget.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.PanelWidget.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.PanelWidget.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.PanelWidget.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.PanelWidget.md#getname)
- [GetOuter](ue_ue.PanelWidget.md#getouter)
- [GetOwningLocalPlayer](ue_ue.PanelWidget.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.PanelWidget.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.PanelWidget.md#getpaintspacegeometry)
- [GetParent](ue_ue.PanelWidget.md#getparent)
- [GetRenderOpacity](ue_ue.PanelWidget.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.PanelWidget.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.PanelWidget.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.PanelWidget.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.PanelWidget.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.PanelWidget.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.PanelWidget.md#gettickspacegeometry)
- [GetVisibility](ue_ue.PanelWidget.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.PanelWidget.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.PanelWidget.md#getworld)
- [HasAnyChildren](ue_ue.PanelWidget.md#hasanychildren)
- [HasAnyUserFocus](ue_ue.PanelWidget.md#hasanyuserfocus)
- [HasChild](ue_ue.PanelWidget.md#haschild)
- [HasFocusedDescendants](ue_ue.PanelWidget.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.PanelWidget.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.PanelWidget.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.PanelWidget.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.PanelWidget.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.PanelWidget.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.PanelWidget.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.PanelWidget.md#ishovered)
- [IsVisible](ue_ue.PanelWidget.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.PanelWidget.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.PanelWidget.md#onreply__delegatesignature)
- [RemoveChild](ue_ue.PanelWidget.md#removechild)
- [RemoveChildAt](ue_ue.PanelWidget.md#removechildat)
- [RemoveFromParent](ue_ue.PanelWidget.md#removefromparent)
- [ResetCursor](ue_ue.PanelWidget.md#resetcursor)
- [SetAllNavigationRules](ue_ue.PanelWidget.md#setallnavigationrules)
- [SetClipping](ue_ue.PanelWidget.md#setclipping)
- [SetCursor](ue_ue.PanelWidget.md#setcursor)
- [SetFocus](ue_ue.PanelWidget.md#setfocus)
- [SetIsEnabled](ue_ue.PanelWidget.md#setisenabled)
- [SetKeyboardFocus](ue_ue.PanelWidget.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.PanelWidget.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.PanelWidget.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.PanelWidget.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.PanelWidget.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.PanelWidget.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.PanelWidget.md#setrenderopacity)
- [SetRenderScale](ue_ue.PanelWidget.md#setrenderscale)
- [SetRenderShear](ue_ue.PanelWidget.md#setrendershear)
- [SetRenderTransform](ue_ue.PanelWidget.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.PanelWidget.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.PanelWidget.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.PanelWidget.md#setrendertranslation)
- [SetToolTip](ue_ue.PanelWidget.md#settooltip)
- [SetToolTipText](ue_ue.PanelWidget.md#settooltiptext)
- [SetUserFocus](ue_ue.PanelWidget.md#setuserfocus)
- [SetVisibility](ue_ue.PanelWidget.md#setvisibility)
- [Find](ue_ue.PanelWidget.md#find)
- [Load](ue_ue.PanelWidget.md#load)
- [StaticClass](ue_ue.PanelWidget.md#staticclass)

## Constructors

### constructor

• **new PanelWidget**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:10677](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L10677)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PanelWidget`](ue_ue.PanelWidget.md)
...
[ue/ue.d.ts:10690](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L10690)

___

### Load

▸ `Static` **Load**(`InName`): [`PanelWidget`](ue_ue.PanelWidget.md)
...
[ue/ue.d.ts:10691](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L10691)
...
[ue/ue.d.ts:10689](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L10689)
