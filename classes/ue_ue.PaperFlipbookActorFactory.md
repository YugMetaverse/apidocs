[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperFlipbookActorFactory

# Class: PaperFlipbookActorFactory

[ue/ue](../modules/ue_ue.md).PaperFlipbookActorFactory
...
- [constructor](ue_ue.PaperFlipbookActorFactory.md#constructor)

### Properties

- [DisplayName](ue_ue.PaperFlipbookActorFactory.md#displayname)
- [MenuPriority](ue_ue.PaperFlipbookActorFactory.md#menupriority)
- [NewActorClass](ue_ue.PaperFlipbookActorFactory.md#newactorclass)
- [NewActorClassName](ue_ue.PaperFlipbookActorFactory.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.PaperFlipbookActorFactory.md#spawnpositionoffset)
- [\_\_tid\_ActorFactory\_\_](ue_ue.PaperFlipbookActorFactory.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperFlipbookActorFactory.md#__tid_object__)
- [\_\_tid\_PaperFlipbookActorFactory\_\_](ue_ue.PaperFlipbookActorFactory.md#__tid_paperflipbookactorfactory__)
- [bShowInEditorQuickMenu](ue_ue.PaperFlipbookActorFactory.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.PaperFlipbookActorFactory.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperFlipbookActorFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperFlipbookActorFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperFlipbookActorFactory.md#getclass)
- [GetName](ue_ue.PaperFlipbookActorFactory.md#getname)
- [GetOuter](ue_ue.PaperFlipbookActorFactory.md#getouter)
- [GetWorld](ue_ue.PaperFlipbookActorFactory.md#getworld)
- [Find](ue_ue.PaperFlipbookActorFactory.md#find)
- [Load](ue_ue.PaperFlipbookActorFactory.md#load)
- [StaticClass](ue_ue.PaperFlipbookActorFactory.md#staticclass)

## Constructors

### constructor

• **new PaperFlipbookActorFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54712](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54712)
...
### \_\_tid\_PaperFlipbookActorFactory\_\_

• **\_\_tid\_PaperFlipbookActorFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54717](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54717)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperFlipbookActorFactory`](ue_ue.PaperFlipbookActorFactory.md)
...
[ue/ue.d.ts:54714](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54714)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperFlipbookActorFactory`](ue_ue.PaperFlipbookActorFactory.md)
...
[ue/ue.d.ts:54715](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54715)
...
[ue/ue.d.ts:54713](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54713)
