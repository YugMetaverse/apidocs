[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperFlipbookFactory

# Class: PaperFlipbookFactory

[ue/ue](../modules/ue_ue.md).PaperFlipbookFactory
...
- [constructor](ue_ue.PaperFlipbookFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperFlipbookFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PaperFlipbookFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperFlipbookFactory.md#contextclass)
- [Formats](ue_ue.PaperFlipbookFactory.md#formats)
- [ImportPriority](ue_ue.PaperFlipbookFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperFlipbookFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperFlipbookFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperFlipbookFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperFlipbookFactory.md#__tid_object__)
- [\_\_tid\_PaperFlipbookFactory\_\_](ue_ue.PaperFlipbookFactory.md#__tid_paperflipbookfactory__)
- [bCreateNew](ue_ue.PaperFlipbookFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperFlipbookFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperFlipbookFactory.md#beditorimport)
- [bText](ue_ue.PaperFlipbookFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperFlipbookFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperFlipbookFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperFlipbookFactory.md#getclass)
- [GetName](ue_ue.PaperFlipbookFactory.md#getname)
- [GetOuter](ue_ue.PaperFlipbookFactory.md#getouter)
- [GetWorld](ue_ue.PaperFlipbookFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperFlipbookFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperFlipbookFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperFlipbookFactory.md#find)
- [Load](ue_ue.PaperFlipbookFactory.md#load)
- [StaticClass](ue_ue.PaperFlipbookFactory.md#staticclass)

## Constructors

### constructor

• **new PaperFlipbookFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54721](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54721)
...
### \_\_tid\_PaperFlipbookFactory\_\_

• **\_\_tid\_PaperFlipbookFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54726](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54726)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperFlipbookFactory`](ue_ue.PaperFlipbookFactory.md)
...
[ue/ue.d.ts:54723](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54723)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperFlipbookFactory`](ue_ue.PaperFlipbookFactory.md)
...
[ue/ue.d.ts:54724](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54724)
...
[ue/ue.d.ts:54722](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54722)
