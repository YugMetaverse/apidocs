[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperSpriteActorFactory

# Class: PaperSpriteActorFactory

[ue/ue](../modules/ue_ue.md).PaperSpriteActorFactory
...
- [constructor](ue_ue.PaperSpriteActorFactory.md#constructor)

### Properties

- [DisplayName](ue_ue.PaperSpriteActorFactory.md#displayname)
- [MenuPriority](ue_ue.PaperSpriteActorFactory.md#menupriority)
- [NewActorClass](ue_ue.PaperSpriteActorFactory.md#newactorclass)
- [NewActorClassName](ue_ue.PaperSpriteActorFactory.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.PaperSpriteActorFactory.md#spawnpositionoffset)
- [\_\_tid\_ActorFactory\_\_](ue_ue.PaperSpriteActorFactory.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperSpriteActorFactory.md#__tid_object__)
- [\_\_tid\_PaperSpriteActorFactory\_\_](ue_ue.PaperSpriteActorFactory.md#__tid_paperspriteactorfactory__)
- [bShowInEditorQuickMenu](ue_ue.PaperSpriteActorFactory.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.PaperSpriteActorFactory.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperSpriteActorFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperSpriteActorFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperSpriteActorFactory.md#getclass)
- [GetName](ue_ue.PaperSpriteActorFactory.md#getname)
- [GetOuter](ue_ue.PaperSpriteActorFactory.md#getouter)
- [GetWorld](ue_ue.PaperSpriteActorFactory.md#getworld)
- [Find](ue_ue.PaperSpriteActorFactory.md#find)
- [Load](ue_ue.PaperSpriteActorFactory.md#load)
- [StaticClass](ue_ue.PaperSpriteActorFactory.md#staticclass)

## Constructors

### constructor

• **new PaperSpriteActorFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54853](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54853)
...
### \_\_tid\_PaperSpriteActorFactory\_\_

• **\_\_tid\_PaperSpriteActorFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54858](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54858)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperSpriteActorFactory`](ue_ue.PaperSpriteActorFactory.md)
...
[ue/ue.d.ts:54855](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54855)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperSpriteActorFactory`](ue_ue.PaperSpriteActorFactory.md)
...
[ue/ue.d.ts:54856](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54856)
...
[ue/ue.d.ts:54854](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54854)
