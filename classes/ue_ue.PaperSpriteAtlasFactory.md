[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperSpriteAtlasFactory

# Class: PaperSpriteAtlasFactory

[ue/ue](../modules/ue_ue.md).PaperSpriteAtlasFactory
...
- [constructor](ue_ue.PaperSpriteAtlasFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperSpriteAtlasFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PaperSpriteAtlasFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperSpriteAtlasFactory.md#contextclass)
- [Formats](ue_ue.PaperSpriteAtlasFactory.md#formats)
- [ImportPriority](ue_ue.PaperSpriteAtlasFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperSpriteAtlasFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperSpriteAtlasFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperSpriteAtlasFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperSpriteAtlasFactory.md#__tid_object__)
- [\_\_tid\_PaperSpriteAtlasFactory\_\_](ue_ue.PaperSpriteAtlasFactory.md#__tid_paperspriteatlasfactory__)
- [bCreateNew](ue_ue.PaperSpriteAtlasFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperSpriteAtlasFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperSpriteAtlasFactory.md#beditorimport)
- [bText](ue_ue.PaperSpriteAtlasFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperSpriteAtlasFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperSpriteAtlasFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperSpriteAtlasFactory.md#getclass)
- [GetName](ue_ue.PaperSpriteAtlasFactory.md#getname)
- [GetOuter](ue_ue.PaperSpriteAtlasFactory.md#getouter)
- [GetWorld](ue_ue.PaperSpriteAtlasFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperSpriteAtlasFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperSpriteAtlasFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperSpriteAtlasFactory.md#find)
- [Load](ue_ue.PaperSpriteAtlasFactory.md#load)
- [StaticClass](ue_ue.PaperSpriteAtlasFactory.md#staticclass)

## Constructors

### constructor

• **new PaperSpriteAtlasFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54862](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54862)
...
### \_\_tid\_PaperSpriteAtlasFactory\_\_

• **\_\_tid\_PaperSpriteAtlasFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54867](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54867)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperSpriteAtlasFactory`](ue_ue.PaperSpriteAtlasFactory.md)
...
[ue/ue.d.ts:54864](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54864)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperSpriteAtlasFactory`](ue_ue.PaperSpriteAtlasFactory.md)
...
[ue/ue.d.ts:54865](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54865)
...
[ue/ue.d.ts:54863](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54863)
