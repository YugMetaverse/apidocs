[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperSpriteFactory

# Class: PaperSpriteFactory

[ue/ue](../modules/ue_ue.md).PaperSpriteFactory
...
- [constructor](ue_ue.PaperSpriteFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperSpriteFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PaperSpriteFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperSpriteFactory.md#contextclass)
- [Formats](ue_ue.PaperSpriteFactory.md#formats)
- [ImportPriority](ue_ue.PaperSpriteFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperSpriteFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperSpriteFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperSpriteFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperSpriteFactory.md#__tid_object__)
- [\_\_tid\_PaperSpriteFactory\_\_](ue_ue.PaperSpriteFactory.md#__tid_paperspritefactory__)
- [bCreateNew](ue_ue.PaperSpriteFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperSpriteFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperSpriteFactory.md#beditorimport)
- [bText](ue_ue.PaperSpriteFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperSpriteFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperSpriteFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperSpriteFactory.md#getclass)
- [GetName](ue_ue.PaperSpriteFactory.md#getname)
- [GetOuter](ue_ue.PaperSpriteFactory.md#getouter)
- [GetWorld](ue_ue.PaperSpriteFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperSpriteFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperSpriteFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperSpriteFactory.md#find)
- [Load](ue_ue.PaperSpriteFactory.md#load)
- [StaticClass](ue_ue.PaperSpriteFactory.md#staticclass)

## Constructors

### constructor

• **new PaperSpriteFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54881](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54881)
...
### \_\_tid\_PaperSpriteFactory\_\_

• **\_\_tid\_PaperSpriteFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:54886](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54886)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperSpriteFactory`](ue_ue.PaperSpriteFactory.md)
...
[ue/ue.d.ts:54883](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54883)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperSpriteFactory`](ue_ue.PaperSpriteFactory.md)
...
[ue/ue.d.ts:54884](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54884)
...
[ue/ue.d.ts:54882](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L54882)
