[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperTileMapFactory

# Class: PaperTileMapFactory

[ue/ue](../modules/ue_ue.md).PaperTileMapFactory
...
- [constructor](ue_ue.PaperTileMapFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperTileMapFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PaperTileMapFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperTileMapFactory.md#contextclass)
- [Formats](ue_ue.PaperTileMapFactory.md#formats)
- [ImportPriority](ue_ue.PaperTileMapFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperTileMapFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperTileMapFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperTileMapFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperTileMapFactory.md#__tid_object__)
- [\_\_tid\_PaperTileMapFactory\_\_](ue_ue.PaperTileMapFactory.md#__tid_papertilemapfactory__)
- [bCreateNew](ue_ue.PaperTileMapFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperTileMapFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperTileMapFactory.md#beditorimport)
- [bText](ue_ue.PaperTileMapFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperTileMapFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperTileMapFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperTileMapFactory.md#getclass)
- [GetName](ue_ue.PaperTileMapFactory.md#getname)
- [GetOuter](ue_ue.PaperTileMapFactory.md#getouter)
- [GetWorld](ue_ue.PaperTileMapFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperTileMapFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperTileMapFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperTileMapFactory.md#find)
- [Load](ue_ue.PaperTileMapFactory.md#load)
- [StaticClass](ue_ue.PaperTileMapFactory.md#staticclass)

## Constructors

### constructor

• **new PaperTileMapFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:55202](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55202)
...
### \_\_tid\_PaperTileMapFactory\_\_

• **\_\_tid\_PaperTileMapFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:55207](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55207)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperTileMapFactory`](ue_ue.PaperTileMapFactory.md)
...
[ue/ue.d.ts:55204](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55204)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperTileMapFactory`](ue_ue.PaperTileMapFactory.md)
...
[ue/ue.d.ts:55205](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55205)
...
[ue/ue.d.ts:55203](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55203)
