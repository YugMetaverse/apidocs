[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperTileMapPromotionFactory

# Class: PaperTileMapPromotionFactory

[ue/ue](../modules/ue_ue.md).PaperTileMapPromotionFactory
...
- [constructor](ue_ue.PaperTileMapPromotionFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperTileMapPromotionFactory.md#assetimporttask)
- [AssetToRename](ue_ue.PaperTileMapPromotionFactory.md#assettorename)
- [AutomatedImportData](ue_ue.PaperTileMapPromotionFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperTileMapPromotionFactory.md#contextclass)
- [Formats](ue_ue.PaperTileMapPromotionFactory.md#formats)
- [ImportPriority](ue_ue.PaperTileMapPromotionFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperTileMapPromotionFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperTileMapPromotionFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperTileMapPromotionFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperTileMapPromotionFactory.md#__tid_object__)
- [\_\_tid\_PaperTileMapPromotionFactory\_\_](ue_ue.PaperTileMapPromotionFactory.md#__tid_papertilemappromotionfactory__)
- [bCreateNew](ue_ue.PaperTileMapPromotionFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperTileMapPromotionFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperTileMapPromotionFactory.md#beditorimport)
- [bText](ue_ue.PaperTileMapPromotionFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperTileMapPromotionFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperTileMapPromotionFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperTileMapPromotionFactory.md#getclass)
- [GetName](ue_ue.PaperTileMapPromotionFactory.md#getname)
- [GetOuter](ue_ue.PaperTileMapPromotionFactory.md#getouter)
- [GetWorld](ue_ue.PaperTileMapPromotionFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperTileMapPromotionFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperTileMapPromotionFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperTileMapPromotionFactory.md#find)
- [Load](ue_ue.PaperTileMapPromotionFactory.md#load)
- [StaticClass](ue_ue.PaperTileMapPromotionFactory.md#staticclass)

## Constructors

### constructor

• **new PaperTileMapPromotionFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:55211](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55211)
...
• **AssetToRename**: [`PaperTileMap`](ue_ue.PaperTileMap.md)

#### Defined in

[ue/ue.d.ts:55212](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55212)
...
### \_\_tid\_PaperTileMapPromotionFactory\_\_

• **\_\_tid\_PaperTileMapPromotionFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:55217](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55217)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperTileMapPromotionFactory`](ue_ue.PaperTileMapPromotionFactory.md)
...
[ue/ue.d.ts:55214](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55214)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperTileMapPromotionFactory`](ue_ue.PaperTileMapPromotionFactory.md)
...
[ue/ue.d.ts:55215](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55215)
...
[ue/ue.d.ts:55213](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55213)
