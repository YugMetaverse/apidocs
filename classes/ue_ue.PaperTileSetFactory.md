[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperTileSetFactory

# Class: PaperTileSetFactory

[ue/ue](../modules/ue_ue.md).PaperTileSetFactory
...
- [constructor](ue_ue.PaperTileSetFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperTileSetFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PaperTileSetFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperTileSetFactory.md#contextclass)
- [Formats](ue_ue.PaperTileSetFactory.md#formats)
- [ImportPriority](ue_ue.PaperTileSetFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperTileSetFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperTileSetFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperTileSetFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperTileSetFactory.md#__tid_object__)
- [\_\_tid\_PaperTileSetFactory\_\_](ue_ue.PaperTileSetFactory.md#__tid_papertilesetfactory__)
- [bCreateNew](ue_ue.PaperTileSetFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperTileSetFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperTileSetFactory.md#beditorimport)
- [bText](ue_ue.PaperTileSetFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperTileSetFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperTileSetFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperTileSetFactory.md#getclass)
- [GetName](ue_ue.PaperTileSetFactory.md#getname)
- [GetOuter](ue_ue.PaperTileSetFactory.md#getouter)
- [GetWorld](ue_ue.PaperTileSetFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperTileSetFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperTileSetFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperTileSetFactory.md#find)
- [Load](ue_ue.PaperTileSetFactory.md#load)
- [StaticClass](ue_ue.PaperTileSetFactory.md#staticclass)

## Constructors

### constructor

• **new PaperTileSetFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:55221](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55221)
...
### \_\_tid\_PaperTileSetFactory\_\_

• **\_\_tid\_PaperTileSetFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:55226](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55226)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperTileSetFactory`](ue_ue.PaperTileSetFactory.md)
...
[ue/ue.d.ts:55223](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55223)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperTileSetFactory`](ue_ue.PaperTileSetFactory.md)
...
[ue/ue.d.ts:55224](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55224)
...
[ue/ue.d.ts:55222](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55222)
