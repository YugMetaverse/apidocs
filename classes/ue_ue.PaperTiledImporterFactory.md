[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PaperTiledImporterFactory

# Class: PaperTiledImporterFactory

[ue/ue](../modules/ue_ue.md).PaperTiledImporterFactory
...
- [constructor](ue_ue.PaperTiledImporterFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PaperTiledImporterFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.PaperTiledImporterFactory.md#automatedimportdata)
- [ContextClass](ue_ue.PaperTiledImporterFactory.md#contextclass)
- [Formats](ue_ue.PaperTiledImporterFactory.md#formats)
- [ImportPriority](ue_ue.PaperTiledImporterFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PaperTiledImporterFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PaperTiledImporterFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PaperTiledImporterFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PaperTiledImporterFactory.md#__tid_object__)
- [\_\_tid\_PaperTiledImporterFactory\_\_](ue_ue.PaperTiledImporterFactory.md#__tid_papertiledimporterfactory__)
- [bCreateNew](ue_ue.PaperTiledImporterFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.PaperTiledImporterFactory.md#beditafternew)
- [bEditorImport](ue_ue.PaperTiledImporterFactory.md#beditorimport)
- [bText](ue_ue.PaperTiledImporterFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PaperTiledImporterFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PaperTiledImporterFactory.md#executeubergraph)
- [GetClass](ue_ue.PaperTiledImporterFactory.md#getclass)
- [GetName](ue_ue.PaperTiledImporterFactory.md#getname)
- [GetOuter](ue_ue.PaperTiledImporterFactory.md#getouter)
- [GetWorld](ue_ue.PaperTiledImporterFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PaperTiledImporterFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PaperTiledImporterFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.PaperTiledImporterFactory.md#find)
- [Load](ue_ue.PaperTiledImporterFactory.md#load)
- [StaticClass](ue_ue.PaperTiledImporterFactory.md#staticclass)

## Constructors

### constructor

• **new PaperTiledImporterFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:54997](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54997)
...
### \_\_tid\_PaperTiledImporterFactory\_\_

• **\_\_tid\_PaperTiledImporterFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:55002](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55002)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PaperTiledImporterFactory`](ue_ue.PaperTiledImporterFactory.md)
...
[ue/ue.d.ts:54999](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54999)

___

### Load

▸ `Static` **Load**(`InName`): [`PaperTiledImporterFactory`](ue_ue.PaperTiledImporterFactory.md)
...
[ue/ue.d.ts:55000](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55000)
...
[ue/ue.d.ts:54998](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L54998)
