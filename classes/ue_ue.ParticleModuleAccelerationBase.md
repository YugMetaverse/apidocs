[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ParticleModuleAccelerationBase

# Class: ParticleModuleAccelerationBase

[ue/ue](../modules/ue_ue.md).ParticleModuleAccelerationBase
...
- [constructor](ue_ue.ParticleModuleAccelerationBase.md#constructor)

### Properties

- [LODDuplicate](ue_ue.ParticleModuleAccelerationBase.md#lodduplicate)
- [LODValidity](ue_ue.ParticleModuleAccelerationBase.md#lodvalidity)
- [ModuleEditorColor](ue_ue.ParticleModuleAccelerationBase.md#moduleeditorcolor)
- [\_\_tid\_Object\_\_](ue_ue.ParticleModuleAccelerationBase.md#__tid_object__)
- [\_\_tid\_ParticleModuleAccelerationBase\_\_](ue_ue.ParticleModuleAccelerationBase.md#__tid_particlemoduleaccelerationbase__)
- [\_\_tid\_ParticleModule\_\_](ue_ue.ParticleModuleAccelerationBase.md#__tid_particlemodule__)
- [b3DDrawMode](ue_ue.ParticleModuleAccelerationBase.md#b3ddrawmode)
- [bAlwaysInWorldSpace](ue_ue.ParticleModuleAccelerationBase.md#balwaysinworldspace)
- [bCurvesAsColor](ue_ue.ParticleModuleAccelerationBase.md#bcurvesascolor)
- [bEditable](ue_ue.ParticleModuleAccelerationBase.md#beditable)
- [bEnabled](ue_ue.ParticleModuleAccelerationBase.md#benabled)
- [bFinalUpdateModule](ue_ue.ParticleModuleAccelerationBase.md#bfinalupdatemodule)
- [bRequiresLoopingNotification](ue_ue.ParticleModuleAccelerationBase.md#brequiresloopingnotification)
- [bSpawnModule](ue_ue.ParticleModuleAccelerationBase.md#bspawnmodule)
- [bSupported3DDrawMode](ue_ue.ParticleModuleAccelerationBase.md#bsupported3ddrawmode)
- [bSupportsRandomSeed](ue_ue.ParticleModuleAccelerationBase.md#bsupportsrandomseed)
- [bUpdateForGPUEmitter](ue_ue.ParticleModuleAccelerationBase.md#bupdateforgpuemitter)
- [bUpdateModule](ue_ue.ParticleModuleAccelerationBase.md#bupdatemodule)

### Methods

- [CreateDefaultSubobject](ue_ue.ParticleModuleAccelerationBase.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ParticleModuleAccelerationBase.md#executeubergraph)
- [GetClass](ue_ue.ParticleModuleAccelerationBase.md#getclass)
- [GetName](ue_ue.ParticleModuleAccelerationBase.md#getname)
- [GetOuter](ue_ue.ParticleModuleAccelerationBase.md#getouter)
- [GetWorld](ue_ue.ParticleModuleAccelerationBase.md#getworld)
- [Find](ue_ue.ParticleModuleAccelerationBase.md#find)
- [Load](ue_ue.ParticleModuleAccelerationBase.md#load)
- [StaticClass](ue_ue.ParticleModuleAccelerationBase.md#staticclass)

## Constructors

### constructor

• **new ParticleModuleAccelerationBase**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:55239](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55239)
...
[ue/ue.d.ts:55245](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55245)
...
[ue/ue.d.ts:55240](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55240)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ParticleModuleAccelerationBase`](ue_ue.ParticleModuleAccelerationBase.md)
...
[ue/ue.d.ts:55242](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55242)

___

### Load

▸ `Static` **Load**(`InName`): [`ParticleModuleAccelerationBase`](ue_ue.ParticleModuleAccelerationBase.md)
...
[ue/ue.d.ts:55243](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55243)
...
[ue/ue.d.ts:55241](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55241)
