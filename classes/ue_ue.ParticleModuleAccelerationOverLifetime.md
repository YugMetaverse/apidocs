[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ParticleModuleAccelerationOverLifetime

# Class: ParticleModuleAccelerationOverLifetime

[ue/ue](../modules/ue_ue.md).ParticleModuleAccelerationOverLifetime
...
- [constructor](ue_ue.ParticleModuleAccelerationOverLifetime.md#constructor)

### Properties

- [AccelOverLife](ue_ue.ParticleModuleAccelerationOverLifetime.md#acceloverlife)
- [LODDuplicate](ue_ue.ParticleModuleAccelerationOverLifetime.md#lodduplicate)
- [LODValidity](ue_ue.ParticleModuleAccelerationOverLifetime.md#lodvalidity)
- [ModuleEditorColor](ue_ue.ParticleModuleAccelerationOverLifetime.md#moduleeditorcolor)
- [\_\_tid\_Object\_\_](ue_ue.ParticleModuleAccelerationOverLifetime.md#__tid_object__)
- [\_\_tid\_ParticleModuleAccelerationBase\_\_](ue_ue.ParticleModuleAccelerationOverLifetime.md#__tid_particlemoduleaccelerationbase__)
- [\_\_tid\_ParticleModuleAccelerationOverLifetime\_\_](ue_ue.ParticleModuleAccelerationOverLifetime.md#__tid_particlemoduleaccelerationoverlifetime__)
- [\_\_tid\_ParticleModule\_\_](ue_ue.ParticleModuleAccelerationOverLifetime.md#__tid_particlemodule__)
- [b3DDrawMode](ue_ue.ParticleModuleAccelerationOverLifetime.md#b3ddrawmode)
- [bAlwaysInWorldSpace](ue_ue.ParticleModuleAccelerationOverLifetime.md#balwaysinworldspace)
- [bCurvesAsColor](ue_ue.ParticleModuleAccelerationOverLifetime.md#bcurvesascolor)
- [bEditable](ue_ue.ParticleModuleAccelerationOverLifetime.md#beditable)
- [bEnabled](ue_ue.ParticleModuleAccelerationOverLifetime.md#benabled)
- [bFinalUpdateModule](ue_ue.ParticleModuleAccelerationOverLifetime.md#bfinalupdatemodule)
- [bRequiresLoopingNotification](ue_ue.ParticleModuleAccelerationOverLifetime.md#brequiresloopingnotification)
- [bSpawnModule](ue_ue.ParticleModuleAccelerationOverLifetime.md#bspawnmodule)
- [bSupported3DDrawMode](ue_ue.ParticleModuleAccelerationOverLifetime.md#bsupported3ddrawmode)
- [bSupportsRandomSeed](ue_ue.ParticleModuleAccelerationOverLifetime.md#bsupportsrandomseed)
- [bUpdateForGPUEmitter](ue_ue.ParticleModuleAccelerationOverLifetime.md#bupdateforgpuemitter)
- [bUpdateModule](ue_ue.ParticleModuleAccelerationOverLifetime.md#bupdatemodule)

### Methods

- [CreateDefaultSubobject](ue_ue.ParticleModuleAccelerationOverLifetime.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ParticleModuleAccelerationOverLifetime.md#executeubergraph)
- [GetClass](ue_ue.ParticleModuleAccelerationOverLifetime.md#getclass)
- [GetName](ue_ue.ParticleModuleAccelerationOverLifetime.md#getname)
- [GetOuter](ue_ue.ParticleModuleAccelerationOverLifetime.md#getouter)
- [GetWorld](ue_ue.ParticleModuleAccelerationOverLifetime.md#getworld)
- [Find](ue_ue.ParticleModuleAccelerationOverLifetime.md#find)
- [Load](ue_ue.ParticleModuleAccelerationOverLifetime.md#load)
- [StaticClass](ue_ue.ParticleModuleAccelerationOverLifetime.md#staticclass)

## Constructors

### constructor

• **new ParticleModuleAccelerationOverLifetime**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:55292](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55292)

## Properties

### AccelOverLife

• **AccelOverLife**: [`RawDistributionVector`](ue_ue.RawDistributionVector.md)

#### Defined in

[ue/ue.d.ts:55293](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55293)
...
### \_\_tid\_ParticleModuleAccelerationOverLifetime\_\_

• **\_\_tid\_ParticleModuleAccelerationOverLifetime\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:55298](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55298)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ParticleModuleAccelerationOverLifetime`](ue_ue.ParticleModuleAccelerationOverLifetime.md)
...
[`ParticleModuleAccelerationOverLifetime`](ue_ue.ParticleModuleAccelerationOverLifetime.md)
...
[ue/ue.d.ts:55295](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55295)

___

### Load

▸ `Static` **Load**(`InName`): [`ParticleModuleAccelerationOverLifetime`](ue_ue.ParticleModuleAccelerationOverLifetime.md)
...
[ue/ue.d.ts:55296](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55296)
...
[ue/ue.d.ts:55294](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L55294)
