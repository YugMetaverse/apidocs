[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ParticleModuleLocationEmitter

# Class: ParticleModuleLocationEmitter

[ue/ue](../modules/ue_ue.md).ParticleModuleLocationEmitter
...
- [constructor](ue_ue.ParticleModuleLocationEmitter.md#constructor)

### Properties

- [EmitterName](ue_ue.ParticleModuleLocationEmitter.md#emittername)
- [InheritSourceRotationScale](ue_ue.ParticleModuleLocationEmitter.md#inheritsourcerotationscale)
- [InheritSourceVelocity](ue_ue.ParticleModuleLocationEmitter.md#inheritsourcevelocity)
- [InheritSourceVelocityScale](ue_ue.ParticleModuleLocationEmitter.md#inheritsourcevelocityscale)
- [LODDuplicate](ue_ue.ParticleModuleLocationEmitter.md#lodduplicate)
- [LODValidity](ue_ue.ParticleModuleLocationEmitter.md#lodvalidity)
- [ModuleEditorColor](ue_ue.ParticleModuleLocationEmitter.md#moduleeditorcolor)
- [SelectionMethod](ue_ue.ParticleModuleLocationEmitter.md#selectionmethod)
- [\_\_tid\_Object\_\_](ue_ue.ParticleModuleLocationEmitter.md#__tid_object__)
- [\_\_tid\_ParticleModuleLocationBase\_\_](ue_ue.ParticleModuleLocationEmitter.md#__tid_particlemodulelocationbase__)
- [\_\_tid\_ParticleModuleLocationEmitter\_\_](ue_ue.ParticleModuleLocationEmitter.md#__tid_particlemodulelocationemitter__)
- [\_\_tid\_ParticleModule\_\_](ue_ue.ParticleModuleLocationEmitter.md#__tid_particlemodule__)
- [b3DDrawMode](ue_ue.ParticleModuleLocationEmitter.md#b3ddrawmode)
- [bCurvesAsColor](ue_ue.ParticleModuleLocationEmitter.md#bcurvesascolor)
- [bEditable](ue_ue.ParticleModuleLocationEmitter.md#beditable)
- [bEnabled](ue_ue.ParticleModuleLocationEmitter.md#benabled)
- [bFinalUpdateModule](ue_ue.ParticleModuleLocationEmitter.md#bfinalupdatemodule)
- [bInheritSourceRotation](ue_ue.ParticleModuleLocationEmitter.md#binheritsourcerotation)
- [bRequiresLoopingNotification](ue_ue.ParticleModuleLocationEmitter.md#brequiresloopingnotification)
- [bSpawnModule](ue_ue.ParticleModuleLocationEmitter.md#bspawnmodule)
- [bSupported3DDrawMode](ue_ue.ParticleModuleLocationEmitter.md#bsupported3ddrawmode)
- [bSupportsRandomSeed](ue_ue.ParticleModuleLocationEmitter.md#bsupportsrandomseed)
- [bUpdateForGPUEmitter](ue_ue.ParticleModuleLocationEmitter.md#bupdateforgpuemitter)
- [bUpdateModule](ue_ue.ParticleModuleLocationEmitter.md#bupdatemodule)

### Methods

- [CreateDefaultSubobject](ue_ue.ParticleModuleLocationEmitter.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ParticleModuleLocationEmitter.md#executeubergraph)
- [GetClass](ue_ue.ParticleModuleLocationEmitter.md#getclass)
- [GetName](ue_ue.ParticleModuleLocationEmitter.md#getname)
- [GetOuter](ue_ue.ParticleModuleLocationEmitter.md#getouter)
- [GetWorld](ue_ue.ParticleModuleLocationEmitter.md#getworld)
- [Find](ue_ue.ParticleModuleLocationEmitter.md#find)
- [Load](ue_ue.ParticleModuleLocationEmitter.md#load)
- [StaticClass](ue_ue.ParticleModuleLocationEmitter.md#staticclass)

## Constructors

### constructor

• **new ParticleModuleLocationEmitter**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:55839](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55839)
...
[ue/ue.d.ts:55840](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55840)
...
[ue/ue.d.ts:55845](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55845)
...
[ue/ue.d.ts:55842](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55842)
...
[ue/ue.d.ts:55843](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55843)
...
• **SelectionMethod**: [`ELocationEmitterSelectionMethod`](../enums/ue_ue.ELocationEmitterSelectionMethod.md)

#### Defined in

[ue/ue.d.ts:55841](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55841)
...
### \_\_tid\_ParticleModuleLocationEmitter\_\_

• **\_\_tid\_ParticleModuleLocationEmitter\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:55850](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55850)
...
[ue/ue.d.ts:55844](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55844)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ParticleModuleLocationEmitter`](ue_ue.ParticleModuleLocationEmitter.md)
...
[`ParticleModuleLocationEmitter`](ue_ue.ParticleModuleLocationEmitter.md)
...
[ue/ue.d.ts:55847](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55847)

___

### Load

▸ `Static` **Load**(`InName`): [`ParticleModuleLocationEmitter`](ue_ue.ParticleModuleLocationEmitter.md)
...
[ue/ue.d.ts:55848](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55848)
...
[ue/ue.d.ts:55846](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L55846)
