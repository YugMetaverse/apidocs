[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ParticleModuleRotationBase

# Class: ParticleModuleRotationBase

[ue/ue](../modules/ue_ue.md).ParticleModuleRotationBase
...
- [constructor](ue_ue.ParticleModuleRotationBase.md#constructor)

### Properties

- [LODDuplicate](ue_ue.ParticleModuleRotationBase.md#lodduplicate)
- [LODValidity](ue_ue.ParticleModuleRotationBase.md#lodvalidity)
- [ModuleEditorColor](ue_ue.ParticleModuleRotationBase.md#moduleeditorcolor)
- [\_\_tid\_Object\_\_](ue_ue.ParticleModuleRotationBase.md#__tid_object__)
- [\_\_tid\_ParticleModuleRotationBase\_\_](ue_ue.ParticleModuleRotationBase.md#__tid_particlemodulerotationbase__)
- [\_\_tid\_ParticleModule\_\_](ue_ue.ParticleModuleRotationBase.md#__tid_particlemodule__)
- [b3DDrawMode](ue_ue.ParticleModuleRotationBase.md#b3ddrawmode)
- [bCurvesAsColor](ue_ue.ParticleModuleRotationBase.md#bcurvesascolor)
- [bEditable](ue_ue.ParticleModuleRotationBase.md#beditable)
- [bEnabled](ue_ue.ParticleModuleRotationBase.md#benabled)
- [bFinalUpdateModule](ue_ue.ParticleModuleRotationBase.md#bfinalupdatemodule)
- [bRequiresLoopingNotification](ue_ue.ParticleModuleRotationBase.md#brequiresloopingnotification)
- [bSpawnModule](ue_ue.ParticleModuleRotationBase.md#bspawnmodule)
- [bSupported3DDrawMode](ue_ue.ParticleModuleRotationBase.md#bsupported3ddrawmode)
- [bSupportsRandomSeed](ue_ue.ParticleModuleRotationBase.md#bsupportsrandomseed)
- [bUpdateForGPUEmitter](ue_ue.ParticleModuleRotationBase.md#bupdateforgpuemitter)
- [bUpdateModule](ue_ue.ParticleModuleRotationBase.md#bupdatemodule)

### Methods

- [CreateDefaultSubobject](ue_ue.ParticleModuleRotationBase.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ParticleModuleRotationBase.md#executeubergraph)
- [GetClass](ue_ue.ParticleModuleRotationBase.md#getclass)
- [GetName](ue_ue.ParticleModuleRotationBase.md#getname)
- [GetOuter](ue_ue.ParticleModuleRotationBase.md#getouter)
- [GetWorld](ue_ue.ParticleModuleRotationBase.md#getworld)
- [Find](ue_ue.ParticleModuleRotationBase.md#find)
- [Load](ue_ue.ParticleModuleRotationBase.md#load)
- [StaticClass](ue_ue.ParticleModuleRotationBase.md#staticclass)

## Constructors

### constructor

• **new ParticleModuleRotationBase**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:56003](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L56003)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ParticleModuleRotationBase`](ue_ue.ParticleModuleRotationBase.md)
...
[ue/ue.d.ts:56005](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L56005)

___

### Load

▸ `Static` **Load**(`InName`): [`ParticleModuleRotationBase`](ue_ue.ParticleModuleRotationBase.md)
...
[ue/ue.d.ts:56006](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L56006)
...
[ue/ue.d.ts:56004](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L56004)
