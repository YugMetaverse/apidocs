[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PhysicalAnimationComponent

# Class: PhysicalAnimationComponent

[ue/ue](../modules/ue_ue.md).PhysicalAnimationComponent
...
- [constructor](ue_ue.PhysicalAnimationComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.PhysicalAnimationComponent.md#assetuserdata)
- [ComponentTags](ue_ue.PhysicalAnimationComponent.md#componenttags)
- [CreationMethod](ue_ue.PhysicalAnimationComponent.md#creationmethod)
- [OnComponentActivated](ue_ue.PhysicalAnimationComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.PhysicalAnimationComponent.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.PhysicalAnimationComponent.md#primarycomponenttick)
- [SkeletalMeshComponent](ue_ue.PhysicalAnimationComponent.md#skeletalmeshcomponent)
- [StrengthMultiplyer](ue_ue.PhysicalAnimationComponent.md#strengthmultiplyer)
- [UCSModifiedProperties](ue_ue.PhysicalAnimationComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.PhysicalAnimationComponent.md#__tid_actorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.PhysicalAnimationComponent.md#__tid_object__)
- [\_\_tid\_PhysicalAnimationComponent\_\_](ue_ue.PhysicalAnimationComponent.md#__tid_physicalanimationcomponent__)
- [bAutoActivate](ue_ue.PhysicalAnimationComponent.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.PhysicalAnimationComponent.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.PhysicalAnimationComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.PhysicalAnimationComponent.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.PhysicalAnimationComponent.md#binstancecomponent)
- [bIsActive](ue_ue.PhysicalAnimationComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.PhysicalAnimationComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.PhysicalAnimationComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.PhysicalAnimationComponent.md#bnetaddressable)
- [bReplicates](ue_ue.PhysicalAnimationComponent.md#breplicates)

### Methods

- [Activate](ue_ue.PhysicalAnimationComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.PhysicalAnimationComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.PhysicalAnimationComponent.md#addtickprerequisitecomponent)
- [ApplyPhysicalAnimationProfileBelow](ue_ue.PhysicalAnimationComponent.md#applyphysicalanimationprofilebelow)
- [ApplyPhysicalAnimationSettings](ue_ue.PhysicalAnimationComponent.md#applyphysicalanimationsettings)
- [ApplyPhysicalAnimationSettingsBelow](ue_ue.PhysicalAnimationComponent.md#applyphysicalanimationsettingsbelow)
- [ComponentHasTag](ue_ue.PhysicalAnimationComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.PhysicalAnimationComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.PhysicalAnimationComponent.md#deactivate)
- [ExecuteUbergraph](ue_ue.PhysicalAnimationComponent.md#executeubergraph)
- [GetBodyTargetTransform](ue_ue.PhysicalAnimationComponent.md#getbodytargettransform)
- [GetClass](ue_ue.PhysicalAnimationComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.PhysicalAnimationComponent.md#getcomponenttickinterval)
- [GetName](ue_ue.PhysicalAnimationComponent.md#getname)
- [GetOuter](ue_ue.PhysicalAnimationComponent.md#getouter)
- [GetOwner](ue_ue.PhysicalAnimationComponent.md#getowner)
- [GetWorld](ue_ue.PhysicalAnimationComponent.md#getworld)
- [IsActive](ue_ue.PhysicalAnimationComponent.md#isactive)
- [IsBeingDestroyed](ue_ue.PhysicalAnimationComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.PhysicalAnimationComponent.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.PhysicalAnimationComponent.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.PhysicalAnimationComponent.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.PhysicalAnimationComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.PhysicalAnimationComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.PhysicalAnimationComponent.md#receivetick)
- [RegisterComponent](ue_ue.PhysicalAnimationComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.PhysicalAnimationComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.PhysicalAnimationComponent.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.PhysicalAnimationComponent.md#setactive)
- [SetAutoActivate](ue_ue.PhysicalAnimationComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.PhysicalAnimationComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.PhysicalAnimationComponent.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.PhysicalAnimationComponent.md#setisreplicated)
- [SetSkeletalMeshComponent](ue_ue.PhysicalAnimationComponent.md#setskeletalmeshcomponent)
- [SetStrengthMultiplyer](ue_ue.PhysicalAnimationComponent.md#setstrengthmultiplyer)
- [SetTickGroup](ue_ue.PhysicalAnimationComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.PhysicalAnimationComponent.md#settickablewhenpaused)
- [ToggleActive](ue_ue.PhysicalAnimationComponent.md#toggleactive)
- [Find](ue_ue.PhysicalAnimationComponent.md#find)
- [Load](ue_ue.PhysicalAnimationComponent.md#load)
- [StaticClass](ue_ue.PhysicalAnimationComponent.md#staticclass)

## Constructors

### constructor

• **new PhysicalAnimationComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:57323](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57323)
...
[ue/ue.d.ts:57325](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57325)
...
[ue/ue.d.ts:57324](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57324)
...
### \_\_tid\_PhysicalAnimationComponent\_\_

• **\_\_tid\_PhysicalAnimationComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:57336](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57336)
...
▸ **ApplyPhysicalAnimationProfileBelow**(`BodyName`, `ProfileName`, `bIncludeSelf?`, `bClearNotFound?`): `void`
...
[ue/ue.d.ts:57326](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57326)

___

### ApplyPhysicalAnimationSettings

▸ **ApplyPhysicalAnimationSettings**(`BodyName`, `PhysicalAnimationData`): `void`
...
[ue/ue.d.ts:57327](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57327)

___

### ApplyPhysicalAnimationSettingsBelow

▸ **ApplyPhysicalAnimationSettingsBelow**(`BodyName`, `PhysicalAnimationData`, `bIncludeSelf?`): `void`
...
[ue/ue.d.ts:57328](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57328)
...
▸ **GetBodyTargetTransform**(`BodyName`): [`Transform`](ue_ue_s.Transform.md)
...
[ue/ue.d.ts:57329](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57329)
...
▸ **SetSkeletalMeshComponent**(`InSkeletalMeshComponent`): `void`
...
[ue/ue.d.ts:57330](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57330)

___

### SetStrengthMultiplyer

▸ **SetStrengthMultiplyer**(`InStrengthMultiplyer`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `InStrengthMultiplyer` | `number` |
...
[ue/ue.d.ts:57331](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57331)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PhysicalAnimationComponent`](ue_ue.PhysicalAnimationComponent.md)
...
[ue/ue.d.ts:57333](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57333)

___

### Load

▸ `Static` **Load**(`InName`): [`PhysicalAnimationComponent`](ue_ue.PhysicalAnimationComponent.md)
...
[ue/ue.d.ts:57334](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57334)
...
[ue/ue.d.ts:57332](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57332)
