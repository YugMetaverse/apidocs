[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PhysicalMaterialFactoryNew

# Class: PhysicalMaterialFactoryNew

[ue/ue](../modules/ue_ue.md).PhysicalMaterialFactoryNew
...
- [constructor](ue_ue.PhysicalMaterialFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PhysicalMaterialFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.PhysicalMaterialFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.PhysicalMaterialFactoryNew.md#contextclass)
- [Formats](ue_ue.PhysicalMaterialFactoryNew.md#formats)
- [ImportPriority](ue_ue.PhysicalMaterialFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PhysicalMaterialFactoryNew.md#overwriteyesornotoallstate)
- [PhysicalMaterialClass](ue_ue.PhysicalMaterialFactoryNew.md#physicalmaterialclass)
- [SupportedClass](ue_ue.PhysicalMaterialFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PhysicalMaterialFactoryNew.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PhysicalMaterialFactoryNew.md#__tid_object__)
- [\_\_tid\_PhysicalMaterialFactoryNew\_\_](ue_ue.PhysicalMaterialFactoryNew.md#__tid_physicalmaterialfactorynew__)
- [bCreateNew](ue_ue.PhysicalMaterialFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.PhysicalMaterialFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.PhysicalMaterialFactoryNew.md#beditorimport)
- [bText](ue_ue.PhysicalMaterialFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PhysicalMaterialFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PhysicalMaterialFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.PhysicalMaterialFactoryNew.md#getclass)
- [GetName](ue_ue.PhysicalMaterialFactoryNew.md#getname)
- [GetOuter](ue_ue.PhysicalMaterialFactoryNew.md#getouter)
- [GetWorld](ue_ue.PhysicalMaterialFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PhysicalMaterialFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PhysicalMaterialFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.PhysicalMaterialFactoryNew.md#find)
- [Load](ue_ue.PhysicalMaterialFactoryNew.md#load)
- [StaticClass](ue_ue.PhysicalMaterialFactoryNew.md#staticclass)

## Constructors

### constructor

• **new PhysicalMaterialFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:57340](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57340)
...
• **PhysicalMaterialClass**: [`Class`](ue_ue.Class.md)

#### Defined in

[ue/ue.d.ts:57341](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57341)
...
### \_\_tid\_PhysicalMaterialFactoryNew\_\_

• **\_\_tid\_PhysicalMaterialFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:57346](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57346)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PhysicalMaterialFactoryNew`](ue_ue.PhysicalMaterialFactoryNew.md)
...
[ue/ue.d.ts:57343](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57343)

___

### Load

▸ `Static` **Load**(`InName`): [`PhysicalMaterialFactoryNew`](ue_ue.PhysicalMaterialFactoryNew.md)
...
[ue/ue.d.ts:57344](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57344)
...
[ue/ue.d.ts:57342](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L57342)
