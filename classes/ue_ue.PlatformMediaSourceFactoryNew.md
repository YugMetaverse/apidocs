[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PlatformMediaSourceFactoryNew

# Class: PlatformMediaSourceFactoryNew

[ue/ue](../modules/ue_ue.md).PlatformMediaSourceFactoryNew
...
- [constructor](ue_ue.PlatformMediaSourceFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.PlatformMediaSourceFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.PlatformMediaSourceFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.PlatformMediaSourceFactoryNew.md#contextclass)
- [Formats](ue_ue.PlatformMediaSourceFactoryNew.md#formats)
- [ImportPriority](ue_ue.PlatformMediaSourceFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.PlatformMediaSourceFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.PlatformMediaSourceFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.PlatformMediaSourceFactoryNew.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.PlatformMediaSourceFactoryNew.md#__tid_object__)
- [\_\_tid\_PlatformMediaSourceFactoryNew\_\_](ue_ue.PlatformMediaSourceFactoryNew.md#__tid_platformmediasourcefactorynew__)
- [bCreateNew](ue_ue.PlatformMediaSourceFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.PlatformMediaSourceFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.PlatformMediaSourceFactoryNew.md#beditorimport)
- [bText](ue_ue.PlatformMediaSourceFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PlatformMediaSourceFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PlatformMediaSourceFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.PlatformMediaSourceFactoryNew.md#getclass)
- [GetName](ue_ue.PlatformMediaSourceFactoryNew.md#getname)
- [GetOuter](ue_ue.PlatformMediaSourceFactoryNew.md#getouter)
- [GetWorld](ue_ue.PlatformMediaSourceFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.PlatformMediaSourceFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.PlatformMediaSourceFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.PlatformMediaSourceFactoryNew.md#find)
- [Load](ue_ue.PlatformMediaSourceFactoryNew.md#load)
- [StaticClass](ue_ue.PlatformMediaSourceFactoryNew.md#staticclass)

## Constructors

### constructor

• **new PlatformMediaSourceFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:58095](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58095)
...
### \_\_tid\_PlatformMediaSourceFactoryNew\_\_

• **\_\_tid\_PlatformMediaSourceFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:58100](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58100)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PlatformMediaSourceFactoryNew`](ue_ue.PlatformMediaSourceFactoryNew.md)
...
[ue/ue.d.ts:58097](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58097)

___

### Load

▸ `Static` **Load**(`InName`): [`PlatformMediaSourceFactoryNew`](ue_ue.PlatformMediaSourceFactoryNew.md)
...
[ue/ue.d.ts:58098](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58098)
...
[ue/ue.d.ts:58096](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58096)
