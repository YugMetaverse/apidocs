[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PlayerStartPIE
...
- [OnTakeAnyDamage](ue_ue.PlayerStartPIE.md#ontakeanydamage)
...
- [bTearOff](ue_ue.PlayerStartPIE.md#btearoff)
...
- [IsChildActor](ue_ue.PlayerStartPIE.md#ischildactor)
...
- [SetActorHiddenInGame](ue_ue.PlayerStartPIE.md#setactorhiddeningame)
...
[ue/ue.d.ts:58115](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58115)
...
[ue/ue.d.ts:58106](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58106)
...
[PlayerStart](ue_ue.PlayerStart.md).[NetCullDistanceSquared](ue_ue.PlayerStart.md#netculldistancesquared)
...
[PlayerStart](ue_ue.PlayerStart.md).[OnInputTouchEnd](ue_ue.PlayerStart.md#oninputtouchend)
...
[ue/ue.d.ts:58105](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58105)
...
[ue/ue.d.ts:58120](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58120)
...
[ue/ue.d.ts:58111](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58111)
...
[PlayerStart](ue_ue.PlayerStart.md).[GetActorEnableCollision](ue_ue.PlayerStart.md#getactorenablecollision)
...
[PlayerStart](ue_ue.PlayerStart.md).[GetClass](ue_ue.PlayerStart.md#getclass)
...
[PlayerStart](ue_ue.PlayerStart.md).[GetParentActor](ue_ue.PlayerStart.md#getparentactor)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorBeginOverlap](ue_ue.PlayerStart.md#receiveactorbeginoverlap)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorEndCursorOver](ue_ue.PlayerStart.md#receiveactorendcursorover)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorEndOverlap](ue_ue.PlayerStart.md#receiveactorendoverlap)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorOnClicked](ue_ue.PlayerStart.md#receiveactoronclicked)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorOnInputTouchBegin](ue_ue.PlayerStart.md#receiveactoroninputtouchbegin)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorOnInputTouchEnd](ue_ue.PlayerStart.md#receiveactoroninputtouchend)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorOnInputTouchEnter](ue_ue.PlayerStart.md#receiveactoroninputtouchenter)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorOnInputTouchLeave](ue_ue.PlayerStart.md#receiveactoroninputtouchleave)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveActorOnReleased](ue_ue.PlayerStart.md#receiveactoronreleased)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveAnyDamage](ue_ue.PlayerStart.md#receiveanydamage)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveBeginPlay](ue_ue.PlayerStart.md#receivebeginplay)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveDestroyed](ue_ue.PlayerStart.md#receivedestroyed)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveEndPlay](ue_ue.PlayerStart.md#receiveendplay)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveHit](ue_ue.PlayerStart.md#receivehit)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceivePointDamage](ue_ue.PlayerStart.md#receivepointdamage)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveRadialDamage](ue_ue.PlayerStart.md#receiveradialdamage)
...
[PlayerStart](ue_ue.PlayerStart.md).[ReceiveTick](ue_ue.PlayerStart.md#receivetick)
...
[PlayerStart](ue_ue.PlayerStart.md).[RemoveTickPrerequisiteActor](ue_ue.PlayerStart.md#removetickprerequisiteactor)
...
[PlayerStart](ue_ue.PlayerStart.md).[RemoveTickPrerequisiteComponent](ue_ue.PlayerStart.md#removetickprerequisitecomponent)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorEnableCollision](ue_ue.PlayerStart.md#setactorenablecollision)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorHiddenInGame](ue_ue.PlayerStart.md#setactorhiddeningame)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorLabel](ue_ue.PlayerStart.md#setactorlabel)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorRelativeScale3D](ue_ue.PlayerStart.md#setactorrelativescale3d)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorScale3D](ue_ue.PlayerStart.md#setactorscale3d)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorTickEnabled](ue_ue.PlayerStart.md#setactortickenabled)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetActorTickInterval](ue_ue.PlayerStart.md#setactortickinterval)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetFolderPath](ue_ue.PlayerStart.md#setfolderpath)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetIsTemporarilyHiddenInEditor](ue_ue.PlayerStart.md#setistemporarilyhiddenineditor)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetLifeSpan](ue_ue.PlayerStart.md#setlifespan)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetNetDormancy](ue_ue.PlayerStart.md#setnetdormancy)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetOwner](ue_ue.PlayerStart.md#setowner)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetReplicateMovement](ue_ue.PlayerStart.md#setreplicatemovement)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetReplicates](ue_ue.PlayerStart.md#setreplicates)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetTickGroup](ue_ue.PlayerStart.md#settickgroup)
...
[PlayerStart](ue_ue.PlayerStart.md).[SetTickableWhenPaused](ue_ue.PlayerStart.md#settickablewhenpaused)
...
[PlayerStart](ue_ue.PlayerStart.md).[SnapRootComponentTo](ue_ue.PlayerStart.md#snaprootcomponentto)
...
[PlayerStart](ue_ue.PlayerStart.md).[TearOff](ue_ue.PlayerStart.md#tearoff)
...
[PlayerStart](ue_ue.PlayerStart.md).[UserConstructionScript](ue_ue.PlayerStart.md#userconstructionscript)
...
[PlayerStart](ue_ue.PlayerStart.md).[WasRecentlyRendered](ue_ue.PlayerStart.md#wasrecentlyrendered)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PlayerStartPIE`](ue_ue.PlayerStartPIE.md)
...
[PlayerStart](ue_ue.PlayerStart.md).[Find](ue_ue.PlayerStart.md#find)

#### Defined in

[ue/ue.d.ts:58117](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58117)

___

### Load

▸ `Static` **Load**(`InName`): [`PlayerStartPIE`](ue_ue.PlayerStartPIE.md)
...
[PlayerStart](ue_ue.PlayerStart.md).[Load](ue_ue.PlayerStart.md#load)

#### Defined in

[ue/ue.d.ts:58118](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58118)
...
[PlayerStart](ue_ue.PlayerStart.md).[StaticClass](ue_ue.PlayerStart.md#staticclass)

#### Defined in

[ue/ue.d.ts:58116](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58116)
