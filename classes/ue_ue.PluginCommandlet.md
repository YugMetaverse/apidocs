[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PluginCommandlet

# Class: PluginCommandlet

[ue/ue](../modules/ue_ue.md).PluginCommandlet
...
- [constructor](ue_ue.PluginCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.PluginCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.PluginCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.PluginCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.PluginCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.PluginCommandlet.md#helpweblink)
- [IsClient](ue_ue.PluginCommandlet.md#isclient)
- [IsEditor](ue_ue.PluginCommandlet.md#iseditor)
- [IsServer](ue_ue.PluginCommandlet.md#isserver)
- [LogToConsole](ue_ue.PluginCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.PluginCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.PluginCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.PluginCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.PluginCommandlet.md#__tid_object__)
- [\_\_tid\_PluginCommandlet\_\_](ue_ue.PluginCommandlet.md#__tid_plugincommandlet__)

### Methods

- [CreateDefaultSubobject](ue_ue.PluginCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PluginCommandlet.md#executeubergraph)
- [GetClass](ue_ue.PluginCommandlet.md#getclass)
- [GetName](ue_ue.PluginCommandlet.md#getname)
- [GetOuter](ue_ue.PluginCommandlet.md#getouter)
- [GetWorld](ue_ue.PluginCommandlet.md#getworld)
- [Find](ue_ue.PluginCommandlet.md#find)
- [Load](ue_ue.PluginCommandlet.md#load)
- [StaticClass](ue_ue.PluginCommandlet.md#staticclass)

## Constructors

### constructor

• **new PluginCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:58153](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58153)
...
### \_\_tid\_PluginCommandlet\_\_

• **\_\_tid\_PluginCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:58158](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58158)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PluginCommandlet`](ue_ue.PluginCommandlet.md)
...
[ue/ue.d.ts:58155](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58155)

___

### Load

▸ `Static` **Load**(`InName`): [`PluginCommandlet`](ue_ue.PluginCommandlet.md)
...
[ue/ue.d.ts:58156](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58156)
...
[ue/ue.d.ts:58154](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58154)
