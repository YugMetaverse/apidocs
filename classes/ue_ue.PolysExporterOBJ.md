[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / PolysExporterOBJ

# Class: PolysExporterOBJ

[ue/ue](../modules/ue_ue.md).PolysExporterOBJ
...
- [constructor](ue_ue.PolysExporterOBJ.md#constructor)

### Properties

- [ExportRootScope](ue_ue.PolysExporterOBJ.md#exportrootscope)
- [ExportTask](ue_ue.PolysExporterOBJ.md#exporttask)
- [FormatDescription](ue_ue.PolysExporterOBJ.md#formatdescription)
- [FormatExtension](ue_ue.PolysExporterOBJ.md#formatextension)
- [PreferredFormatIndex](ue_ue.PolysExporterOBJ.md#preferredformatindex)
- [SupportedClass](ue_ue.PolysExporterOBJ.md#supportedclass)
- [TextIndent](ue_ue.PolysExporterOBJ.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.PolysExporterOBJ.md#__tid_exporter__)
- [\_\_tid\_Object\_\_](ue_ue.PolysExporterOBJ.md#__tid_object__)
- [\_\_tid\_PolysExporterOBJ\_\_](ue_ue.PolysExporterOBJ.md#__tid_polysexporterobj__)
- [bForceFileOperations](ue_ue.PolysExporterOBJ.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.PolysExporterOBJ.md#bselectedonly)
- [bText](ue_ue.PolysExporterOBJ.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.PolysExporterOBJ.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.PolysExporterOBJ.md#executeubergraph)
- [GetClass](ue_ue.PolysExporterOBJ.md#getclass)
- [GetName](ue_ue.PolysExporterOBJ.md#getname)
- [GetOuter](ue_ue.PolysExporterOBJ.md#getouter)
- [GetWorld](ue_ue.PolysExporterOBJ.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.PolysExporterOBJ.md#scriptrunassetexporttask)
- [Find](ue_ue.PolysExporterOBJ.md#find)
- [Load](ue_ue.PolysExporterOBJ.md#load)
- [RunAssetExportTask](ue_ue.PolysExporterOBJ.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.PolysExporterOBJ.md#runassetexporttasks)
- [StaticClass](ue_ue.PolysExporterOBJ.md#staticclass)

## Constructors

### constructor

• **new PolysExporterOBJ**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:58195](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58195)
...
### \_\_tid\_PolysExporterOBJ\_\_

• **\_\_tid\_PolysExporterOBJ\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:58200](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58200)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`PolysExporterOBJ`](ue_ue.PolysExporterOBJ.md)
...
[ue/ue.d.ts:58197](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58197)

___

### Load

▸ `Static` **Load**(`InName`): [`PolysExporterOBJ`](ue_ue.PolysExporterOBJ.md)
...
[ue/ue.d.ts:58198](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58198)
...
[ue/ue.d.ts:58196](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L58196)
