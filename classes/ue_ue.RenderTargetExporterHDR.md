[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / RenderTargetExporterHDR

# Class: RenderTargetExporterHDR

[ue/ue](../modules/ue_ue.md).RenderTargetExporterHDR
...
- [constructor](ue_ue.RenderTargetExporterHDR.md#constructor)

### Properties

- [ExportRootScope](ue_ue.RenderTargetExporterHDR.md#exportrootscope)
- [ExportTask](ue_ue.RenderTargetExporterHDR.md#exporttask)
- [FormatDescription](ue_ue.RenderTargetExporterHDR.md#formatdescription)
- [FormatExtension](ue_ue.RenderTargetExporterHDR.md#formatextension)
- [PreferredFormatIndex](ue_ue.RenderTargetExporterHDR.md#preferredformatindex)
- [SupportedClass](ue_ue.RenderTargetExporterHDR.md#supportedclass)
- [TextIndent](ue_ue.RenderTargetExporterHDR.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.RenderTargetExporterHDR.md#__tid_exporter__)
- [\_\_tid\_Object\_\_](ue_ue.RenderTargetExporterHDR.md#__tid_object__)
- [\_\_tid\_RenderTargetExporterHDR\_\_](ue_ue.RenderTargetExporterHDR.md#__tid_rendertargetexporterhdr__)
- [bForceFileOperations](ue_ue.RenderTargetExporterHDR.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.RenderTargetExporterHDR.md#bselectedonly)
- [bText](ue_ue.RenderTargetExporterHDR.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.RenderTargetExporterHDR.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.RenderTargetExporterHDR.md#executeubergraph)
- [GetClass](ue_ue.RenderTargetExporterHDR.md#getclass)
- [GetName](ue_ue.RenderTargetExporterHDR.md#getname)
- [GetOuter](ue_ue.RenderTargetExporterHDR.md#getouter)
- [GetWorld](ue_ue.RenderTargetExporterHDR.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.RenderTargetExporterHDR.md#scriptrunassetexporttask)
- [Find](ue_ue.RenderTargetExporterHDR.md#find)
- [Load](ue_ue.RenderTargetExporterHDR.md#load)
- [RunAssetExportTask](ue_ue.RenderTargetExporterHDR.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.RenderTargetExporterHDR.md#runassetexporttasks)
- [StaticClass](ue_ue.RenderTargetExporterHDR.md#staticclass)

## Constructors

### constructor

• **new RenderTargetExporterHDR**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:59553](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59553)
...
### \_\_tid\_RenderTargetExporterHDR\_\_

• **\_\_tid\_RenderTargetExporterHDR\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:59558](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59558)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`RenderTargetExporterHDR`](ue_ue.RenderTargetExporterHDR.md)
...
[ue/ue.d.ts:59555](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59555)

___

### Load

▸ `Static` **Load**(`InName`): [`RenderTargetExporterHDR`](ue_ue.RenderTargetExporterHDR.md)
...
[ue/ue.d.ts:59556](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59556)
...
[ue/ue.d.ts:59554](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59554)
