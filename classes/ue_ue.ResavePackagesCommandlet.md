[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ResavePackagesCommandlet

# Class: ResavePackagesCommandlet

[ue/ue](../modules/ue_ue.md).ResavePackagesCommandlet
...
- [constructor](ue_ue.ResavePackagesCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.ResavePackagesCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.ResavePackagesCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.ResavePackagesCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.ResavePackagesCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.ResavePackagesCommandlet.md#helpweblink)
- [IsClient](ue_ue.ResavePackagesCommandlet.md#isclient)
- [IsEditor](ue_ue.ResavePackagesCommandlet.md#iseditor)
- [IsServer](ue_ue.ResavePackagesCommandlet.md#isserver)
- [LogToConsole](ue_ue.ResavePackagesCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.ResavePackagesCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.ResavePackagesCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.ResavePackagesCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.ResavePackagesCommandlet.md#__tid_object__)
- [\_\_tid\_ResavePackagesCommandlet\_\_](ue_ue.ResavePackagesCommandlet.md#__tid_resavepackagescommandlet__)

### Methods

- [CreateDefaultSubobject](ue_ue.ResavePackagesCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ResavePackagesCommandlet.md#executeubergraph)
- [GetClass](ue_ue.ResavePackagesCommandlet.md#getclass)
- [GetName](ue_ue.ResavePackagesCommandlet.md#getname)
- [GetOuter](ue_ue.ResavePackagesCommandlet.md#getouter)
- [GetWorld](ue_ue.ResavePackagesCommandlet.md#getworld)
- [Find](ue_ue.ResavePackagesCommandlet.md#find)
- [Load](ue_ue.ResavePackagesCommandlet.md#load)
- [StaticClass](ue_ue.ResavePackagesCommandlet.md#staticclass)

## Constructors

### constructor

• **new ResavePackagesCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:35624](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35624)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ResavePackagesCommandlet`](ue_ue.ResavePackagesCommandlet.md)
...
[ue/ue.d.ts:35626](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35626)

___

### Load

▸ `Static` **Load**(`InName`): [`ResavePackagesCommandlet`](ue_ue.ResavePackagesCommandlet.md)
...
[ue/ue.d.ts:35627](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35627)
...
[ue/ue.d.ts:35625](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L35625)
