[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ScreenshotComparisonCommandlet

# Class: ScreenshotComparisonCommandlet

[ue/ue](../modules/ue_ue.md).ScreenshotComparisonCommandlet
...
- [constructor](ue_ue.ScreenshotComparisonCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.ScreenshotComparisonCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.ScreenshotComparisonCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.ScreenshotComparisonCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.ScreenshotComparisonCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.ScreenshotComparisonCommandlet.md#helpweblink)
- [IsClient](ue_ue.ScreenshotComparisonCommandlet.md#isclient)
- [IsEditor](ue_ue.ScreenshotComparisonCommandlet.md#iseditor)
- [IsServer](ue_ue.ScreenshotComparisonCommandlet.md#isserver)
- [LogToConsole](ue_ue.ScreenshotComparisonCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.ScreenshotComparisonCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.ScreenshotComparisonCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.ScreenshotComparisonCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.ScreenshotComparisonCommandlet.md#__tid_object__)
- [\_\_tid\_ScreenshotComparisonCommandlet\_\_](ue_ue.ScreenshotComparisonCommandlet.md#__tid_screenshotcomparisoncommandlet__)

### Methods

- [CreateDefaultSubobject](ue_ue.ScreenshotComparisonCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ScreenshotComparisonCommandlet.md#executeubergraph)
- [GetClass](ue_ue.ScreenshotComparisonCommandlet.md#getclass)
- [GetName](ue_ue.ScreenshotComparisonCommandlet.md#getname)
- [GetOuter](ue_ue.ScreenshotComparisonCommandlet.md#getouter)
- [GetWorld](ue_ue.ScreenshotComparisonCommandlet.md#getworld)
- [Find](ue_ue.ScreenshotComparisonCommandlet.md#find)
- [Load](ue_ue.ScreenshotComparisonCommandlet.md#load)
- [StaticClass](ue_ue.ScreenshotComparisonCommandlet.md#staticclass)

## Constructors

### constructor

• **new ScreenshotComparisonCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:59932](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59932)
...
### \_\_tid\_ScreenshotComparisonCommandlet\_\_

• **\_\_tid\_ScreenshotComparisonCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:59937](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59937)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ScreenshotComparisonCommandlet`](ue_ue.ScreenshotComparisonCommandlet.md)
...
[ue/ue.d.ts:59934](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59934)

___

### Load

▸ `Static` **Load**(`InName`): [`ScreenshotComparisonCommandlet`](ue_ue.ScreenshotComparisonCommandlet.md)
...
[ue/ue.d.ts:59935](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59935)
...
[ue/ue.d.ts:59933](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L59933)
