[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SequenceExporterT3D

# Class: SequenceExporterT3D

[ue/ue](../modules/ue_ue.md).SequenceExporterT3D
...
- [constructor](ue_ue.SequenceExporterT3D.md#constructor)

### Properties

- [ExportRootScope](ue_ue.SequenceExporterT3D.md#exportrootscope)
- [ExportTask](ue_ue.SequenceExporterT3D.md#exporttask)
- [FormatDescription](ue_ue.SequenceExporterT3D.md#formatdescription)
- [FormatExtension](ue_ue.SequenceExporterT3D.md#formatextension)
- [PreferredFormatIndex](ue_ue.SequenceExporterT3D.md#preferredformatindex)
- [SupportedClass](ue_ue.SequenceExporterT3D.md#supportedclass)
- [TextIndent](ue_ue.SequenceExporterT3D.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.SequenceExporterT3D.md#__tid_exporter__)
- [\_\_tid\_Object\_\_](ue_ue.SequenceExporterT3D.md#__tid_object__)
- [\_\_tid\_SequenceExporterT3D\_\_](ue_ue.SequenceExporterT3D.md#__tid_sequenceexportert3d__)
- [bForceFileOperations](ue_ue.SequenceExporterT3D.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.SequenceExporterT3D.md#bselectedonly)
- [bText](ue_ue.SequenceExporterT3D.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SequenceExporterT3D.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SequenceExporterT3D.md#executeubergraph)
- [GetClass](ue_ue.SequenceExporterT3D.md#getclass)
- [GetName](ue_ue.SequenceExporterT3D.md#getname)
- [GetOuter](ue_ue.SequenceExporterT3D.md#getouter)
- [GetWorld](ue_ue.SequenceExporterT3D.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.SequenceExporterT3D.md#scriptrunassetexporttask)
- [Find](ue_ue.SequenceExporterT3D.md#find)
- [Load](ue_ue.SequenceExporterT3D.md#load)
- [RunAssetExportTask](ue_ue.SequenceExporterT3D.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.SequenceExporterT3D.md#runassetexporttasks)
- [StaticClass](ue_ue.SequenceExporterT3D.md#staticclass)

## Constructors

### constructor

• **new SequenceExporterT3D**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:60071](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60071)
...
[ue/ue.d.ts:60076](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60076)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SequenceExporterT3D`](ue_ue.SequenceExporterT3D.md)
...
[ue/ue.d.ts:60073](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60073)

___

### Load

▸ `Static` **Load**(`InName`): [`SequenceExporterT3D`](ue_ue.SequenceExporterT3D.md)
...
[ue/ue.d.ts:60074](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60074)
...
[ue/ue.d.ts:60072](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60072)
