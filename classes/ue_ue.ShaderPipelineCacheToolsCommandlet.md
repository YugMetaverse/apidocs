[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / ShaderPipelineCacheToolsCommandlet

# Class: ShaderPipelineCacheToolsCommandlet

[ue/ue](../modules/ue_ue.md).ShaderPipelineCacheToolsCommandlet
...
- [constructor](ue_ue.ShaderPipelineCacheToolsCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.ShaderPipelineCacheToolsCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.ShaderPipelineCacheToolsCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.ShaderPipelineCacheToolsCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.ShaderPipelineCacheToolsCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.ShaderPipelineCacheToolsCommandlet.md#helpweblink)
- [IsClient](ue_ue.ShaderPipelineCacheToolsCommandlet.md#isclient)
- [IsEditor](ue_ue.ShaderPipelineCacheToolsCommandlet.md#iseditor)
- [IsServer](ue_ue.ShaderPipelineCacheToolsCommandlet.md#isserver)
- [LogToConsole](ue_ue.ShaderPipelineCacheToolsCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.ShaderPipelineCacheToolsCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.ShaderPipelineCacheToolsCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.ShaderPipelineCacheToolsCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.ShaderPipelineCacheToolsCommandlet.md#__tid_object__)
- [\_\_tid\_ShaderPipelineCacheToolsCommandlet\_\_](ue_ue.ShaderPipelineCacheToolsCommandlet.md#__tid_shaderpipelinecachetoolscommandlet__)

### Methods

- [CreateDefaultSubobject](ue_ue.ShaderPipelineCacheToolsCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.ShaderPipelineCacheToolsCommandlet.md#executeubergraph)
- [GetClass](ue_ue.ShaderPipelineCacheToolsCommandlet.md#getclass)
- [GetName](ue_ue.ShaderPipelineCacheToolsCommandlet.md#getname)
- [GetOuter](ue_ue.ShaderPipelineCacheToolsCommandlet.md#getouter)
- [GetWorld](ue_ue.ShaderPipelineCacheToolsCommandlet.md#getworld)
- [Find](ue_ue.ShaderPipelineCacheToolsCommandlet.md#find)
- [Load](ue_ue.ShaderPipelineCacheToolsCommandlet.md#load)
- [StaticClass](ue_ue.ShaderPipelineCacheToolsCommandlet.md#staticclass)

## Constructors

### constructor

• **new ShaderPipelineCacheToolsCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:60328](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60328)
...
### \_\_tid\_ShaderPipelineCacheToolsCommandlet\_\_

• **\_\_tid\_ShaderPipelineCacheToolsCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:60333](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60333)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ShaderPipelineCacheToolsCommandlet`](ue_ue.ShaderPipelineCacheToolsCommandlet.md)
...
[ue/ue.d.ts:60330](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60330)

___

### Load

▸ `Static` **Load**(`InName`): [`ShaderPipelineCacheToolsCommandlet`](ue_ue.ShaderPipelineCacheToolsCommandlet.md)
...
[ue/ue.d.ts:60331](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60331)
...
[ue/ue.d.ts:60329](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60329)
