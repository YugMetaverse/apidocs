[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SkyAtmosphereComponent

# Class: SkyAtmosphereComponent

[ue/ue](../modules/ue_ue.md).SkyAtmosphereComponent
...
- [constructor](ue_ue.SkyAtmosphereComponent.md#constructor)

### Properties

- [AerialPespectiveViewDistanceScale](ue_ue.SkyAtmosphereComponent.md#aerialpespectiveviewdistancescale)
- [AssetUserData](ue_ue.SkyAtmosphereComponent.md#assetuserdata)
- [AtmosphereHeight](ue_ue.SkyAtmosphereComponent.md#atmosphereheight)
- [AttachChildren](ue_ue.SkyAtmosphereComponent.md#attachchildren)
- [AttachParent](ue_ue.SkyAtmosphereComponent.md#attachparent)
- [AttachSocketName](ue_ue.SkyAtmosphereComponent.md#attachsocketname)
- [BottomRadius](ue_ue.SkyAtmosphereComponent.md#bottomradius)
- [ClientAttachedChildren](ue_ue.SkyAtmosphereComponent.md#clientattachedchildren)
- [ComponentTags](ue_ue.SkyAtmosphereComponent.md#componenttags)
- [ComponentVelocity](ue_ue.SkyAtmosphereComponent.md#componentvelocity)
- [CreationMethod](ue_ue.SkyAtmosphereComponent.md#creationmethod)
- [DetailMode](ue_ue.SkyAtmosphereComponent.md#detailmode)
- [GroundAlbedo](ue_ue.SkyAtmosphereComponent.md#groundalbedo)
- [HeightFogContribution](ue_ue.SkyAtmosphereComponent.md#heightfogcontribution)
- [MieAbsorption](ue_ue.SkyAtmosphereComponent.md#mieabsorption)
- [MieAbsorptionScale](ue_ue.SkyAtmosphereComponent.md#mieabsorptionscale)
- [MieAnisotropy](ue_ue.SkyAtmosphereComponent.md#mieanisotropy)
- [MieExponentialDistribution](ue_ue.SkyAtmosphereComponent.md#mieexponentialdistribution)
- [MieScattering](ue_ue.SkyAtmosphereComponent.md#miescattering)
- [MieScatteringScale](ue_ue.SkyAtmosphereComponent.md#miescatteringscale)
- [Mobility](ue_ue.SkyAtmosphereComponent.md#mobility)
- [MultiScatteringFactor](ue_ue.SkyAtmosphereComponent.md#multiscatteringfactor)
- [OnComponentActivated](ue_ue.SkyAtmosphereComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.SkyAtmosphereComponent.md#oncomponentdeactivated)
- [OtherAbsorption](ue_ue.SkyAtmosphereComponent.md#otherabsorption)
- [OtherAbsorptionScale](ue_ue.SkyAtmosphereComponent.md#otherabsorptionscale)
- [OtherTentDistribution](ue_ue.SkyAtmosphereComponent.md#othertentdistribution)
- [PhysicsVolume](ue_ue.SkyAtmosphereComponent.md#physicsvolume)
- [PhysicsVolumeChangedDelegate](ue_ue.SkyAtmosphereComponent.md#physicsvolumechangeddelegate)
- [PrimaryComponentTick](ue_ue.SkyAtmosphereComponent.md#primarycomponenttick)
- [RayleighExponentialDistribution](ue_ue.SkyAtmosphereComponent.md#rayleighexponentialdistribution)
- [RayleighScattering](ue_ue.SkyAtmosphereComponent.md#rayleighscattering)
- [RayleighScatteringScale](ue_ue.SkyAtmosphereComponent.md#rayleighscatteringscale)
- [RelativeLocation](ue_ue.SkyAtmosphereComponent.md#relativelocation)
- [RelativeRotation](ue_ue.SkyAtmosphereComponent.md#relativerotation)
- [RelativeScale3D](ue_ue.SkyAtmosphereComponent.md#relativescale3d)
- [SkyLuminanceFactor](ue_ue.SkyAtmosphereComponent.md#skyluminancefactor)
- [TransmittanceMinLightElevationAngle](ue_ue.SkyAtmosphereComponent.md#transmittanceminlightelevationangle)
- [UCSModifiedProperties](ue_ue.SkyAtmosphereComponent.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.SkyAtmosphereComponent.md#__tid_actorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.SkyAtmosphereComponent.md#__tid_object__)
- [\_\_tid\_SceneComponent\_\_](ue_ue.SkyAtmosphereComponent.md#__tid_scenecomponent__)
- [\_\_tid\_SkyAtmosphereComponent\_\_](ue_ue.SkyAtmosphereComponent.md#__tid_skyatmospherecomponent__)
- [bAbsoluteLocation](ue_ue.SkyAtmosphereComponent.md#babsolutelocation)
- [bAbsoluteRotation](ue_ue.SkyAtmosphereComponent.md#babsoluterotation)
- [bAbsoluteScale](ue_ue.SkyAtmosphereComponent.md#babsolutescale)
- [bAutoActivate](ue_ue.SkyAtmosphereComponent.md#bautoactivate)
- [bBoundsChangeTriggersStreamingDataRebuild](ue_ue.SkyAtmosphereComponent.md#bboundschangetriggersstreamingdatarebuild)
- [bCanEverAffectNavigation](ue_ue.SkyAtmosphereComponent.md#bcaneveraffectnavigation)
- [bComponentToWorldUpdated](ue_ue.SkyAtmosphereComponent.md#bcomponenttoworldupdated)
- [bCreatedByConstructionScript](ue_ue.SkyAtmosphereComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.SkyAtmosphereComponent.md#beditablewheninherited)
- [bHiddenInGame](ue_ue.SkyAtmosphereComponent.md#bhiddeningame)
- [bInstanceComponent](ue_ue.SkyAtmosphereComponent.md#binstancecomponent)
- [bIsActive](ue_ue.SkyAtmosphereComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.SkyAtmosphereComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.SkyAtmosphereComponent.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.SkyAtmosphereComponent.md#bnetaddressable)
- [bReplicates](ue_ue.SkyAtmosphereComponent.md#breplicates)
- [bShouldBeAttached](ue_ue.SkyAtmosphereComponent.md#bshouldbeattached)
- [bShouldSnapLocationWhenAttached](ue_ue.SkyAtmosphereComponent.md#bshouldsnaplocationwhenattached)
- [bShouldSnapRotationWhenAttached](ue_ue.SkyAtmosphereComponent.md#bshouldsnaprotationwhenattached)
- [bShouldUpdatePhysicsVolume](ue_ue.SkyAtmosphereComponent.md#bshouldupdatephysicsvolume)
- [bStaticLightingBuiltGUID](ue_ue.SkyAtmosphereComponent.md#bstaticlightingbuiltguid)
- [bUseAttachParentBound](ue_ue.SkyAtmosphereComponent.md#buseattachparentbound)
- [bVisible](ue_ue.SkyAtmosphereComponent.md#bvisible)
- [bVisualizeComponent](ue_ue.SkyAtmosphereComponent.md#bvisualizecomponent)

### Methods

- [Activate](ue_ue.SkyAtmosphereComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.SkyAtmosphereComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.SkyAtmosphereComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.SkyAtmosphereComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.SkyAtmosphereComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.SkyAtmosphereComponent.md#deactivate)
- [DetachFromParent](ue_ue.SkyAtmosphereComponent.md#detachfromparent)
- [DoesSocketExist](ue_ue.SkyAtmosphereComponent.md#doessocketexist)
- [ExecuteUbergraph](ue_ue.SkyAtmosphereComponent.md#executeubergraph)
- [GetAllSocketNames](ue_ue.SkyAtmosphereComponent.md#getallsocketnames)
- [GetAttachParent](ue_ue.SkyAtmosphereComponent.md#getattachparent)
- [GetAttachSocketName](ue_ue.SkyAtmosphereComponent.md#getattachsocketname)
- [GetChildComponent](ue_ue.SkyAtmosphereComponent.md#getchildcomponent)
- [GetChildrenComponents](ue_ue.SkyAtmosphereComponent.md#getchildrencomponents)
- [GetClass](ue_ue.SkyAtmosphereComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.SkyAtmosphereComponent.md#getcomponenttickinterval)
- [GetComponentVelocity](ue_ue.SkyAtmosphereComponent.md#getcomponentvelocity)
- [GetForwardVector](ue_ue.SkyAtmosphereComponent.md#getforwardvector)
- [GetName](ue_ue.SkyAtmosphereComponent.md#getname)
- [GetNumChildrenComponents](ue_ue.SkyAtmosphereComponent.md#getnumchildrencomponents)
- [GetOuter](ue_ue.SkyAtmosphereComponent.md#getouter)
- [GetOwner](ue_ue.SkyAtmosphereComponent.md#getowner)
- [GetParentComponents](ue_ue.SkyAtmosphereComponent.md#getparentcomponents)
- [GetPhysicsVolume](ue_ue.SkyAtmosphereComponent.md#getphysicsvolume)
- [GetRelativeTransform](ue_ue.SkyAtmosphereComponent.md#getrelativetransform)
- [GetRightVector](ue_ue.SkyAtmosphereComponent.md#getrightvector)
- [GetShouldUpdatePhysicsVolume](ue_ue.SkyAtmosphereComponent.md#getshouldupdatephysicsvolume)
- [GetSocketLocation](ue_ue.SkyAtmosphereComponent.md#getsocketlocation)
- [GetSocketQuaternion](ue_ue.SkyAtmosphereComponent.md#getsocketquaternion)
- [GetSocketRotation](ue_ue.SkyAtmosphereComponent.md#getsocketrotation)
- [GetSocketTransform](ue_ue.SkyAtmosphereComponent.md#getsockettransform)
- [GetUpVector](ue_ue.SkyAtmosphereComponent.md#getupvector)
- [GetWorld](ue_ue.SkyAtmosphereComponent.md#getworld)
- [IsActive](ue_ue.SkyAtmosphereComponent.md#isactive)
- [IsAnySimulatingPhysics](ue_ue.SkyAtmosphereComponent.md#isanysimulatingphysics)
- [IsBeingDestroyed](ue_ue.SkyAtmosphereComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.SkyAtmosphereComponent.md#iscomponenttickenabled)
- [IsSimulatingPhysics](ue_ue.SkyAtmosphereComponent.md#issimulatingphysics)
- [IsVisible](ue_ue.SkyAtmosphereComponent.md#isvisible)
- [K2\_AddLocalOffset](ue_ue.SkyAtmosphereComponent.md#k2_addlocaloffset)
- [K2\_AddLocalRotation](ue_ue.SkyAtmosphereComponent.md#k2_addlocalrotation)
- [K2\_AddLocalTransform](ue_ue.SkyAtmosphereComponent.md#k2_addlocaltransform)
- [K2\_AddRelativeLocation](ue_ue.SkyAtmosphereComponent.md#k2_addrelativelocation)
- [K2\_AddRelativeRotation](ue_ue.SkyAtmosphereComponent.md#k2_addrelativerotation)
- [K2\_AddWorldOffset](ue_ue.SkyAtmosphereComponent.md#k2_addworldoffset)
- [K2\_AddWorldRotation](ue_ue.SkyAtmosphereComponent.md#k2_addworldrotation)
- [K2\_AddWorldTransform](ue_ue.SkyAtmosphereComponent.md#k2_addworldtransform)
- [K2\_AttachTo](ue_ue.SkyAtmosphereComponent.md#k2_attachto)
- [K2\_AttachToComponent](ue_ue.SkyAtmosphereComponent.md#k2_attachtocomponent)
- [K2\_DestroyComponent](ue_ue.SkyAtmosphereComponent.md#k2_destroycomponent)
- [K2\_DetachFromComponent](ue_ue.SkyAtmosphereComponent.md#k2_detachfromcomponent)
- [K2\_GetComponentLocation](ue_ue.SkyAtmosphereComponent.md#k2_getcomponentlocation)
- [K2\_GetComponentRotation](ue_ue.SkyAtmosphereComponent.md#k2_getcomponentrotation)
- [K2\_GetComponentScale](ue_ue.SkyAtmosphereComponent.md#k2_getcomponentscale)
- [K2\_GetComponentToWorld](ue_ue.SkyAtmosphereComponent.md#k2_getcomponenttoworld)
- [K2\_SetRelativeLocation](ue_ue.SkyAtmosphereComponent.md#k2_setrelativelocation)
- [K2\_SetRelativeLocationAndRotation](ue_ue.SkyAtmosphereComponent.md#k2_setrelativelocationandrotation)
- [K2\_SetRelativeRotation](ue_ue.SkyAtmosphereComponent.md#k2_setrelativerotation)
- [K2\_SetRelativeTransform](ue_ue.SkyAtmosphereComponent.md#k2_setrelativetransform)
- [K2\_SetWorldLocation](ue_ue.SkyAtmosphereComponent.md#k2_setworldlocation)
- [K2\_SetWorldLocationAndRotation](ue_ue.SkyAtmosphereComponent.md#k2_setworldlocationandrotation)
- [K2\_SetWorldRotation](ue_ue.SkyAtmosphereComponent.md#k2_setworldrotation)
- [K2\_SetWorldTransform](ue_ue.SkyAtmosphereComponent.md#k2_setworldtransform)
- [OnRep\_AttachChildren](ue_ue.SkyAtmosphereComponent.md#onrep_attachchildren)
- [OnRep\_AttachParent](ue_ue.SkyAtmosphereComponent.md#onrep_attachparent)
- [OnRep\_AttachSocketName](ue_ue.SkyAtmosphereComponent.md#onrep_attachsocketname)
- [OnRep\_IsActive](ue_ue.SkyAtmosphereComponent.md#onrep_isactive)
- [OnRep\_Transform](ue_ue.SkyAtmosphereComponent.md#onrep_transform)
- [OnRep\_Visibility](ue_ue.SkyAtmosphereComponent.md#onrep_visibility)
- [OverrideAtmosphereLightDirection](ue_ue.SkyAtmosphereComponent.md#overrideatmospherelightdirection)
- [ReceiveBeginPlay](ue_ue.SkyAtmosphereComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.SkyAtmosphereComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.SkyAtmosphereComponent.md#receivetick)
- [RegisterComponent](ue_ue.SkyAtmosphereComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.SkyAtmosphereComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.SkyAtmosphereComponent.md#removetickprerequisitecomponent)
- [ResetRelativeTransform](ue_ue.SkyAtmosphereComponent.md#resetrelativetransform)
- [SetAbsolute](ue_ue.SkyAtmosphereComponent.md#setabsolute)
- [SetActive](ue_ue.SkyAtmosphereComponent.md#setactive)
- [SetAerialPespectiveViewDistanceScale](ue_ue.SkyAtmosphereComponent.md#setaerialpespectiveviewdistancescale)
- [SetAutoActivate](ue_ue.SkyAtmosphereComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.SkyAtmosphereComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.SkyAtmosphereComponent.md#setcomponenttickinterval)
- [SetHeightFogContribution](ue_ue.SkyAtmosphereComponent.md#setheightfogcontribution)
- [SetHiddenInGame](ue_ue.SkyAtmosphereComponent.md#sethiddeningame)
- [SetIsReplicated](ue_ue.SkyAtmosphereComponent.md#setisreplicated)
- [SetMieAbsorption](ue_ue.SkyAtmosphereComponent.md#setmieabsorption)
- [SetMieAbsorptionScale](ue_ue.SkyAtmosphereComponent.md#setmieabsorptionscale)
- [SetMieAnisotropy](ue_ue.SkyAtmosphereComponent.md#setmieanisotropy)
- [SetMieExponentialDistribution](ue_ue.SkyAtmosphereComponent.md#setmieexponentialdistribution)
- [SetMieScattering](ue_ue.SkyAtmosphereComponent.md#setmiescattering)
- [SetMieScatteringScale](ue_ue.SkyAtmosphereComponent.md#setmiescatteringscale)
- [SetMobility](ue_ue.SkyAtmosphereComponent.md#setmobility)
- [SetOtherAbsorption](ue_ue.SkyAtmosphereComponent.md#setotherabsorption)
- [SetOtherAbsorptionScale](ue_ue.SkyAtmosphereComponent.md#setotherabsorptionscale)
- [SetRayleighExponentialDistribution](ue_ue.SkyAtmosphereComponent.md#setrayleighexponentialdistribution)
- [SetRayleighScattering](ue_ue.SkyAtmosphereComponent.md#setrayleighscattering)
- [SetRayleighScatteringScale](ue_ue.SkyAtmosphereComponent.md#setrayleighscatteringscale)
- [SetRelativeScale3D](ue_ue.SkyAtmosphereComponent.md#setrelativescale3d)
- [SetShouldUpdatePhysicsVolume](ue_ue.SkyAtmosphereComponent.md#setshouldupdatephysicsvolume)
- [SetSkyLuminanceFactor](ue_ue.SkyAtmosphereComponent.md#setskyluminancefactor)
- [SetTickGroup](ue_ue.SkyAtmosphereComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.SkyAtmosphereComponent.md#settickablewhenpaused)
- [SetVisibility](ue_ue.SkyAtmosphereComponent.md#setvisibility)
- [SetWorldScale3D](ue_ue.SkyAtmosphereComponent.md#setworldscale3d)
- [SetupAttachment](ue_ue.SkyAtmosphereComponent.md#setupattachment)
- [SnapTo](ue_ue.SkyAtmosphereComponent.md#snapto)
- [ToggleActive](ue_ue.SkyAtmosphereComponent.md#toggleactive)
- [ToggleVisibility](ue_ue.SkyAtmosphereComponent.md#togglevisibility)
- [Find](ue_ue.SkyAtmosphereComponent.md#find)
- [Load](ue_ue.SkyAtmosphereComponent.md#load)
- [StaticClass](ue_ue.SkyAtmosphereComponent.md#staticclass)

## Constructors

### constructor

• **new SkyAtmosphereComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:60819](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60819)
...
[ue/ue.d.ts:60837](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60837)
...
[ue/ue.d.ts:60822](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60822)
...
[ue/ue.d.ts:60820](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60820)
...
• **GroundAlbedo**: [`Color`](ue_ue_s.Color.md)

#### Defined in

[ue/ue.d.ts:60821](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60821)
...
[ue/ue.d.ts:60838](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60838)

___

### MieAbsorption

• **MieAbsorption**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:60830](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60830)
...
[ue/ue.d.ts:60829](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60829)
...
[ue/ue.d.ts:60831](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60831)
...
[ue/ue.d.ts:60832](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60832)

___

### MieScattering

• **MieScattering**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:60828](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60828)
...
[ue/ue.d.ts:60827](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60827)
...
[ue/ue.d.ts:60823](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60823)
...
• **OtherAbsorption**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:60834](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60834)
...
[ue/ue.d.ts:60833](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60833)

___

### OtherTentDistribution

• **OtherTentDistribution**: [`TentDistribution`](ue_ue.TentDistribution.md)

#### Defined in

[ue/ue.d.ts:60835](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60835)
...
[ue/ue.d.ts:60826](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60826)

___

### RayleighScattering

• **RayleighScattering**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:60825](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60825)
...
[ue/ue.d.ts:60824](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60824)
...
• **SkyLuminanceFactor**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:60836](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60836)
...
[ue/ue.d.ts:60839](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60839)
...
### \_\_tid\_SkyAtmosphereComponent\_\_

• **\_\_tid\_SkyAtmosphereComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:60860](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60860)
...
• **bStaticLightingBuiltGUID**: [`Guid`](ue_ue_s.Guid.md)

#### Defined in

[ue/ue.d.ts:60840](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60840)
...
▸ **OverrideAtmosphereLightDirection**(`AtmosphereLightIndex`, `LightDirection`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `AtmosphereLightIndex` | `number` |
| `LightDirection` | [`Vector`](ue_ue_s.Vector.md) |
...
[ue/ue.d.ts:60841](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60841)
...
▸ **SetAerialPespectiveViewDistanceScale**(`NewValue`): `void`
...
[ue/ue.d.ts:60842](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60842)
...
▸ **SetHeightFogContribution**(`NewValue`): `void`
...
[ue/ue.d.ts:60843](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60843)
...
▸ **SetMieAbsorption**(`NewValue`): `void`
...
[ue/ue.d.ts:60844](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60844)

___

### SetMieAbsorptionScale

▸ **SetMieAbsorptionScale**(`NewValue`): `void`
...
[ue/ue.d.ts:60845](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60845)

___

### SetMieAnisotropy

▸ **SetMieAnisotropy**(`NewValue`): `void`
...
[ue/ue.d.ts:60846](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60846)

___

### SetMieExponentialDistribution

▸ **SetMieExponentialDistribution**(`NewValue`): `void`
...
[ue/ue.d.ts:60847](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60847)

___

### SetMieScattering

▸ **SetMieScattering**(`NewValue`): `void`
...
[ue/ue.d.ts:60848](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60848)

___

### SetMieScatteringScale

▸ **SetMieScatteringScale**(`NewValue`): `void`
...
[ue/ue.d.ts:60849](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60849)
...
▸ **SetOtherAbsorption**(`NewValue`): `void`
...
[ue/ue.d.ts:60850](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60850)

___

### SetOtherAbsorptionScale

▸ **SetOtherAbsorptionScale**(`NewValue`): `void`
...
[ue/ue.d.ts:60851](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60851)

___

### SetRayleighExponentialDistribution

▸ **SetRayleighExponentialDistribution**(`NewValue`): `void`
...
[ue/ue.d.ts:60852](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60852)

___

### SetRayleighScattering

▸ **SetRayleighScattering**(`NewValue`): `void`
...
[ue/ue.d.ts:60853](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60853)

___

### SetRayleighScatteringScale

▸ **SetRayleighScatteringScale**(`NewValue`): `void`
...
[ue/ue.d.ts:60854](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60854)
...
▸ **SetSkyLuminanceFactor**(`NewValue`): `void`
...
[ue/ue.d.ts:60855](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60855)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SkyAtmosphereComponent`](ue_ue.SkyAtmosphereComponent.md)
...
[ue/ue.d.ts:60857](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60857)

___

### Load

▸ `Static` **Load**(`InName`): [`SkyAtmosphereComponent`](ue_ue.SkyAtmosphereComponent.md)
...
[ue/ue.d.ts:60858](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60858)
...
[ue/ue.d.ts:60856](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60856)
