[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SlateBlueprintLibrary
...
▸ `Static` **TransformVectorLocalToAbsolute**(`Geometry`, `LocalVector`): [`Vector2D`](ue_ue_s.Vector2D.md)
