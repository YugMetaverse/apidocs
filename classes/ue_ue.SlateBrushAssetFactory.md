[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SlateBrushAssetFactory

# Class: SlateBrushAssetFactory

[ue/ue](../modules/ue_ue.md).SlateBrushAssetFactory
...
- [constructor](ue_ue.SlateBrushAssetFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SlateBrushAssetFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SlateBrushAssetFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SlateBrushAssetFactory.md#contextclass)
- [Formats](ue_ue.SlateBrushAssetFactory.md#formats)
- [ImportPriority](ue_ue.SlateBrushAssetFactory.md#importpriority)
- [InitialTexture](ue_ue.SlateBrushAssetFactory.md#initialtexture)
- [OverwriteYesOrNoToAllState](ue_ue.SlateBrushAssetFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SlateBrushAssetFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SlateBrushAssetFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SlateBrushAssetFactory.md#__tid_object__)
- [\_\_tid\_SlateBrushAssetFactory\_\_](ue_ue.SlateBrushAssetFactory.md#__tid_slatebrushassetfactory__)
- [bCreateNew](ue_ue.SlateBrushAssetFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SlateBrushAssetFactory.md#beditafternew)
- [bEditorImport](ue_ue.SlateBrushAssetFactory.md#beditorimport)
- [bText](ue_ue.SlateBrushAssetFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SlateBrushAssetFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SlateBrushAssetFactory.md#executeubergraph)
- [GetClass](ue_ue.SlateBrushAssetFactory.md#getclass)
- [GetName](ue_ue.SlateBrushAssetFactory.md#getname)
- [GetOuter](ue_ue.SlateBrushAssetFactory.md#getouter)
- [GetWorld](ue_ue.SlateBrushAssetFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SlateBrushAssetFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SlateBrushAssetFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SlateBrushAssetFactory.md#find)
- [Load](ue_ue.SlateBrushAssetFactory.md#load)
- [StaticClass](ue_ue.SlateBrushAssetFactory.md#staticclass)

## Constructors

### constructor

• **new SlateBrushAssetFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:60900](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60900)
...
• **InitialTexture**: [`Texture2D`](ue_ue.Texture2D.md)

#### Defined in

[ue/ue.d.ts:60901](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60901)
...
### \_\_tid\_SlateBrushAssetFactory\_\_

• **\_\_tid\_SlateBrushAssetFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:60906](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60906)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SlateBrushAssetFactory`](ue_ue.SlateBrushAssetFactory.md)
...
[ue/ue.d.ts:60903](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60903)

___

### Load

▸ `Static` **Load**(`InName`): [`SlateBrushAssetFactory`](ue_ue.SlateBrushAssetFactory.md)
...
[ue/ue.d.ts:60904](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60904)
...
[ue/ue.d.ts:60902](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L60902)
