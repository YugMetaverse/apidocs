[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SlateVectorArtDataFactory

# Class: SlateVectorArtDataFactory

[ue/ue](../modules/ue_ue.md).SlateVectorArtDataFactory
...
- [constructor](ue_ue.SlateVectorArtDataFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SlateVectorArtDataFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SlateVectorArtDataFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SlateVectorArtDataFactory.md#contextclass)
- [Formats](ue_ue.SlateVectorArtDataFactory.md#formats)
- [ImportPriority](ue_ue.SlateVectorArtDataFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SlateVectorArtDataFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SlateVectorArtDataFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SlateVectorArtDataFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SlateVectorArtDataFactory.md#__tid_object__)
- [\_\_tid\_SlateVectorArtDataFactory\_\_](ue_ue.SlateVectorArtDataFactory.md#__tid_slatevectorartdatafactory__)
- [bCreateNew](ue_ue.SlateVectorArtDataFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SlateVectorArtDataFactory.md#beditafternew)
- [bEditorImport](ue_ue.SlateVectorArtDataFactory.md#beditorimport)
- [bText](ue_ue.SlateVectorArtDataFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SlateVectorArtDataFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SlateVectorArtDataFactory.md#executeubergraph)
- [GetClass](ue_ue.SlateVectorArtDataFactory.md#getclass)
- [GetName](ue_ue.SlateVectorArtDataFactory.md#getname)
- [GetOuter](ue_ue.SlateVectorArtDataFactory.md#getouter)
- [GetWorld](ue_ue.SlateVectorArtDataFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SlateVectorArtDataFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SlateVectorArtDataFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SlateVectorArtDataFactory.md#find)
- [Load](ue_ue.SlateVectorArtDataFactory.md#load)
- [StaticClass](ue_ue.SlateVectorArtDataFactory.md#staticclass)

## Constructors

### constructor

• **new SlateVectorArtDataFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:60982](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60982)
...
### \_\_tid\_SlateVectorArtDataFactory\_\_

• **\_\_tid\_SlateVectorArtDataFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:60987](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60987)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SlateVectorArtDataFactory`](ue_ue.SlateVectorArtDataFactory.md)
...
[ue/ue.d.ts:60984](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60984)

___

### Load

▸ `Static` **Load**(`InName`): [`SlateVectorArtDataFactory`](ue_ue.SlateVectorArtDataFactory.md)
...
[ue/ue.d.ts:60985](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60985)
...
[ue/ue.d.ts:60983](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60983)
