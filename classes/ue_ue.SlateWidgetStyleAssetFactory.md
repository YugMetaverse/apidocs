[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SlateWidgetStyleAssetFactory

# Class: SlateWidgetStyleAssetFactory

[ue/ue](../modules/ue_ue.md).SlateWidgetStyleAssetFactory
...
- [constructor](ue_ue.SlateWidgetStyleAssetFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SlateWidgetStyleAssetFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SlateWidgetStyleAssetFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SlateWidgetStyleAssetFactory.md#contextclass)
- [Formats](ue_ue.SlateWidgetStyleAssetFactory.md#formats)
- [ImportPriority](ue_ue.SlateWidgetStyleAssetFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SlateWidgetStyleAssetFactory.md#overwriteyesornotoallstate)
- [StyleType](ue_ue.SlateWidgetStyleAssetFactory.md#styletype)
- [SupportedClass](ue_ue.SlateWidgetStyleAssetFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SlateWidgetStyleAssetFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SlateWidgetStyleAssetFactory.md#__tid_object__)
- [\_\_tid\_SlateWidgetStyleAssetFactory\_\_](ue_ue.SlateWidgetStyleAssetFactory.md#__tid_slatewidgetstyleassetfactory__)
- [bCreateNew](ue_ue.SlateWidgetStyleAssetFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SlateWidgetStyleAssetFactory.md#beditafternew)
- [bEditorImport](ue_ue.SlateWidgetStyleAssetFactory.md#beditorimport)
- [bText](ue_ue.SlateWidgetStyleAssetFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SlateWidgetStyleAssetFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SlateWidgetStyleAssetFactory.md#executeubergraph)
- [GetClass](ue_ue.SlateWidgetStyleAssetFactory.md#getclass)
- [GetName](ue_ue.SlateWidgetStyleAssetFactory.md#getname)
- [GetOuter](ue_ue.SlateWidgetStyleAssetFactory.md#getouter)
- [GetWorld](ue_ue.SlateWidgetStyleAssetFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SlateWidgetStyleAssetFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SlateWidgetStyleAssetFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SlateWidgetStyleAssetFactory.md#find)
- [Load](ue_ue.SlateWidgetStyleAssetFactory.md#load)
- [StaticClass](ue_ue.SlateWidgetStyleAssetFactory.md#staticclass)

## Constructors

### constructor

• **new SlateWidgetStyleAssetFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:60991](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60991)
...
• **StyleType**: [`Class`](ue_ue.Class.md)

#### Defined in

[ue/ue.d.ts:60992](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60992)
...
### \_\_tid\_SlateWidgetStyleAssetFactory\_\_

• **\_\_tid\_SlateWidgetStyleAssetFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:60997](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60997)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SlateWidgetStyleAssetFactory`](ue_ue.SlateWidgetStyleAssetFactory.md)
...
[ue/ue.d.ts:60994](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60994)

___

### Load

▸ `Static` **Load**(`InName`): [`SlateWidgetStyleAssetFactory`](ue_ue.SlateWidgetStyleAssetFactory.md)
...
[ue/ue.d.ts:60995](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60995)
...
[ue/ue.d.ts:60993](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L60993)
