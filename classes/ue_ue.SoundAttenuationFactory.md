[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundAttenuationFactory

# Class: SoundAttenuationFactory

[ue/ue](../modules/ue_ue.md).SoundAttenuationFactory
...
- [constructor](ue_ue.SoundAttenuationFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundAttenuationFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundAttenuationFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundAttenuationFactory.md#contextclass)
- [Formats](ue_ue.SoundAttenuationFactory.md#formats)
- [ImportPriority](ue_ue.SoundAttenuationFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundAttenuationFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundAttenuationFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundAttenuationFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundAttenuationFactory.md#__tid_object__)
- [\_\_tid\_SoundAttenuationFactory\_\_](ue_ue.SoundAttenuationFactory.md#__tid_soundattenuationfactory__)
- [bCreateNew](ue_ue.SoundAttenuationFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundAttenuationFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundAttenuationFactory.md#beditorimport)
- [bText](ue_ue.SoundAttenuationFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundAttenuationFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundAttenuationFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundAttenuationFactory.md#getclass)
- [GetName](ue_ue.SoundAttenuationFactory.md#getname)
- [GetOuter](ue_ue.SoundAttenuationFactory.md#getouter)
- [GetWorld](ue_ue.SoundAttenuationFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundAttenuationFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundAttenuationFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundAttenuationFactory.md#find)
- [Load](ue_ue.SoundAttenuationFactory.md#load)
- [StaticClass](ue_ue.SoundAttenuationFactory.md#staticclass)

## Constructors

### constructor

• **new SoundAttenuationFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61093](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61093)
...
### \_\_tid\_SoundAttenuationFactory\_\_

• **\_\_tid\_SoundAttenuationFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61098](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61098)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundAttenuationFactory`](ue_ue.SoundAttenuationFactory.md)
...
[ue/ue.d.ts:61095](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61095)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundAttenuationFactory`](ue_ue.SoundAttenuationFactory.md)
...
[ue/ue.d.ts:61096](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61096)
...
[ue/ue.d.ts:61094](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61094)
