[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundClassFactory

# Class: SoundClassFactory

[ue/ue](../modules/ue_ue.md).SoundClassFactory
...
- [constructor](ue_ue.SoundClassFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundClassFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundClassFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundClassFactory.md#contextclass)
- [Formats](ue_ue.SoundClassFactory.md#formats)
- [ImportPriority](ue_ue.SoundClassFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundClassFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundClassFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundClassFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundClassFactory.md#__tid_object__)
- [\_\_tid\_SoundClassFactory\_\_](ue_ue.SoundClassFactory.md#__tid_soundclassfactory__)
- [bCreateNew](ue_ue.SoundClassFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundClassFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundClassFactory.md#beditorimport)
- [bText](ue_ue.SoundClassFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundClassFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundClassFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundClassFactory.md#getclass)
- [GetName](ue_ue.SoundClassFactory.md#getname)
- [GetOuter](ue_ue.SoundClassFactory.md#getouter)
- [GetWorld](ue_ue.SoundClassFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundClassFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundClassFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundClassFactory.md#find)
- [Load](ue_ue.SoundClassFactory.md#load)
- [StaticClass](ue_ue.SoundClassFactory.md#staticclass)

## Constructors

### constructor

• **new SoundClassFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61102](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61102)
...
### \_\_tid\_SoundClassFactory\_\_

• **\_\_tid\_SoundClassFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61107](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61107)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundClassFactory`](ue_ue.SoundClassFactory.md)
...
[ue/ue.d.ts:61104](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61104)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundClassFactory`](ue_ue.SoundClassFactory.md)
...
[ue/ue.d.ts:61105](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61105)
...
[ue/ue.d.ts:61103](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61103)
