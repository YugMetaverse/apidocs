[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundConcurrencyFactory

# Class: SoundConcurrencyFactory

[ue/ue](../modules/ue_ue.md).SoundConcurrencyFactory
...
- [constructor](ue_ue.SoundConcurrencyFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundConcurrencyFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundConcurrencyFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundConcurrencyFactory.md#contextclass)
- [Formats](ue_ue.SoundConcurrencyFactory.md#formats)
- [ImportPriority](ue_ue.SoundConcurrencyFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundConcurrencyFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundConcurrencyFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundConcurrencyFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundConcurrencyFactory.md#__tid_object__)
- [\_\_tid\_SoundConcurrencyFactory\_\_](ue_ue.SoundConcurrencyFactory.md#__tid_soundconcurrencyfactory__)
- [bCreateNew](ue_ue.SoundConcurrencyFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundConcurrencyFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundConcurrencyFactory.md#beditorimport)
- [bText](ue_ue.SoundConcurrencyFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundConcurrencyFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundConcurrencyFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundConcurrencyFactory.md#getclass)
- [GetName](ue_ue.SoundConcurrencyFactory.md#getname)
- [GetOuter](ue_ue.SoundConcurrencyFactory.md#getouter)
- [GetWorld](ue_ue.SoundConcurrencyFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundConcurrencyFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundConcurrencyFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundConcurrencyFactory.md#find)
- [Load](ue_ue.SoundConcurrencyFactory.md#load)
- [StaticClass](ue_ue.SoundConcurrencyFactory.md#staticclass)

## Constructors

### constructor

• **new SoundConcurrencyFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61139](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61139)
...
### \_\_tid\_SoundConcurrencyFactory\_\_

• **\_\_tid\_SoundConcurrencyFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61144](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61144)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundConcurrencyFactory`](ue_ue.SoundConcurrencyFactory.md)
...
[ue/ue.d.ts:61141](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61141)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundConcurrencyFactory`](ue_ue.SoundConcurrencyFactory.md)
...
[ue/ue.d.ts:61142](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61142)
...
[ue/ue.d.ts:61140](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61140)
