[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundCueTemplateFactory

# Class: SoundCueTemplateFactory

[ue/ue](../modules/ue_ue.md).SoundCueTemplateFactory
...
- [constructor](ue_ue.SoundCueTemplateFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundCueTemplateFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundCueTemplateFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundCueTemplateFactory.md#contextclass)
- [Formats](ue_ue.SoundCueTemplateFactory.md#formats)
- [ImportPriority](ue_ue.SoundCueTemplateFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundCueTemplateFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundCueTemplateFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundCueTemplateFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundCueTemplateFactory.md#__tid_object__)
- [\_\_tid\_SoundCueTemplateFactory\_\_](ue_ue.SoundCueTemplateFactory.md#__tid_soundcuetemplatefactory__)
- [bCreateNew](ue_ue.SoundCueTemplateFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundCueTemplateFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundCueTemplateFactory.md#beditorimport)
- [bText](ue_ue.SoundCueTemplateFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundCueTemplateFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundCueTemplateFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundCueTemplateFactory.md#getclass)
- [GetName](ue_ue.SoundCueTemplateFactory.md#getname)
- [GetOuter](ue_ue.SoundCueTemplateFactory.md#getouter)
- [GetWorld](ue_ue.SoundCueTemplateFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundCueTemplateFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundCueTemplateFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundCueTemplateFactory.md#find)
- [Load](ue_ue.SoundCueTemplateFactory.md#load)
- [StaticClass](ue_ue.SoundCueTemplateFactory.md#staticclass)

## Constructors

### constructor

• **new SoundCueTemplateFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61224](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61224)
...
### \_\_tid\_SoundCueTemplateFactory\_\_

• **\_\_tid\_SoundCueTemplateFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61229](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61229)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundCueTemplateFactory`](ue_ue.SoundCueTemplateFactory.md)
...
[ue/ue.d.ts:61226](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61226)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundCueTemplateFactory`](ue_ue.SoundCueTemplateFactory.md)
...
[ue/ue.d.ts:61227](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61227)
...
[ue/ue.d.ts:61225](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61225)
