[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundExporterOGG

# Class: SoundExporterOGG

[ue/ue](../modules/ue_ue.md).SoundExporterOGG
...
- [constructor](ue_ue.SoundExporterOGG.md#constructor)

### Properties

- [ExportRootScope](ue_ue.SoundExporterOGG.md#exportrootscope)
- [ExportTask](ue_ue.SoundExporterOGG.md#exporttask)
- [FormatDescription](ue_ue.SoundExporterOGG.md#formatdescription)
- [FormatExtension](ue_ue.SoundExporterOGG.md#formatextension)
- [PreferredFormatIndex](ue_ue.SoundExporterOGG.md#preferredformatindex)
- [SupportedClass](ue_ue.SoundExporterOGG.md#supportedclass)
- [TextIndent](ue_ue.SoundExporterOGG.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.SoundExporterOGG.md#__tid_exporter__)
- [\_\_tid\_Object\_\_](ue_ue.SoundExporterOGG.md#__tid_object__)
- [\_\_tid\_SoundExporterOGG\_\_](ue_ue.SoundExporterOGG.md#__tid_soundexporterogg__)
- [bForceFileOperations](ue_ue.SoundExporterOGG.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.SoundExporterOGG.md#bselectedonly)
- [bText](ue_ue.SoundExporterOGG.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundExporterOGG.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundExporterOGG.md#executeubergraph)
- [GetClass](ue_ue.SoundExporterOGG.md#getclass)
- [GetName](ue_ue.SoundExporterOGG.md#getname)
- [GetOuter](ue_ue.SoundExporterOGG.md#getouter)
- [GetWorld](ue_ue.SoundExporterOGG.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.SoundExporterOGG.md#scriptrunassetexporttask)
- [Find](ue_ue.SoundExporterOGG.md#find)
- [Load](ue_ue.SoundExporterOGG.md#load)
- [RunAssetExportTask](ue_ue.SoundExporterOGG.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.SoundExporterOGG.md#runassetexporttasks)
- [StaticClass](ue_ue.SoundExporterOGG.md#staticclass)

## Constructors

### constructor

• **new SoundExporterOGG**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61233](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61233)
...
### \_\_tid\_SoundExporterOGG\_\_

• **\_\_tid\_SoundExporterOGG\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61238](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61238)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundExporterOGG`](ue_ue.SoundExporterOGG.md)
...
[ue/ue.d.ts:61235](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61235)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundExporterOGG`](ue_ue.SoundExporterOGG.md)
...
[ue/ue.d.ts:61236](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61236)
...
[ue/ue.d.ts:61234](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61234)
