[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundMixFactory

# Class: SoundMixFactory

[ue/ue](../modules/ue_ue.md).SoundMixFactory
...
- [constructor](ue_ue.SoundMixFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundMixFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundMixFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundMixFactory.md#contextclass)
- [Formats](ue_ue.SoundMixFactory.md#formats)
- [ImportPriority](ue_ue.SoundMixFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundMixFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundMixFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundMixFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundMixFactory.md#__tid_object__)
- [\_\_tid\_SoundMixFactory\_\_](ue_ue.SoundMixFactory.md#__tid_soundmixfactory__)
- [bCreateNew](ue_ue.SoundMixFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundMixFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundMixFactory.md#beditorimport)
- [bText](ue_ue.SoundMixFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundMixFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundMixFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundMixFactory.md#getclass)
- [GetName](ue_ue.SoundMixFactory.md#getname)
- [GetOuter](ue_ue.SoundMixFactory.md#getouter)
- [GetWorld](ue_ue.SoundMixFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundMixFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundMixFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundMixFactory.md#find)
- [Load](ue_ue.SoundMixFactory.md#load)
- [StaticClass](ue_ue.SoundMixFactory.md#staticclass)

## Constructors

### constructor

• **new SoundMixFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61276](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61276)
...
### \_\_tid\_SoundMixFactory\_\_

• **\_\_tid\_SoundMixFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61281](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61281)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundMixFactory`](ue_ue.SoundMixFactory.md)
...
[ue/ue.d.ts:61278](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61278)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundMixFactory`](ue_ue.SoundMixFactory.md)
...
[ue/ue.d.ts:61279](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61279)
...
[ue/ue.d.ts:61277](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61277)
