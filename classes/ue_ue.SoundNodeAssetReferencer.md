[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundNodeAssetReferencer

# Class: SoundNodeAssetReferencer

[ue/ue](../modules/ue_ue.md).SoundNodeAssetReferencer
...
- [constructor](ue_ue.SoundNodeAssetReferencer.md#constructor)

### Properties

- [ChildNodes](ue_ue.SoundNodeAssetReferencer.md#childnodes)
- [GraphNode](ue_ue.SoundNodeAssetReferencer.md#graphnode)
- [\_\_tid\_Object\_\_](ue_ue.SoundNodeAssetReferencer.md#__tid_object__)
- [\_\_tid\_SoundNodeAssetReferencer\_\_](ue_ue.SoundNodeAssetReferencer.md#__tid_soundnodeassetreferencer__)
- [\_\_tid\_SoundNode\_\_](ue_ue.SoundNodeAssetReferencer.md#__tid_soundnode__)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundNodeAssetReferencer.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundNodeAssetReferencer.md#executeubergraph)
- [GetClass](ue_ue.SoundNodeAssetReferencer.md#getclass)
- [GetName](ue_ue.SoundNodeAssetReferencer.md#getname)
- [GetOuter](ue_ue.SoundNodeAssetReferencer.md#getouter)
- [GetWorld](ue_ue.SoundNodeAssetReferencer.md#getworld)
- [Find](ue_ue.SoundNodeAssetReferencer.md#find)
- [Load](ue_ue.SoundNodeAssetReferencer.md#load)
- [StaticClass](ue_ue.SoundNodeAssetReferencer.md#staticclass)

## Constructors

### constructor

• **new SoundNodeAssetReferencer**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61285](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61285)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundNodeAssetReferencer`](ue_ue.SoundNodeAssetReferencer.md)
...
[ue/ue.d.ts:61287](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61287)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundNodeAssetReferencer`](ue_ue.SoundNodeAssetReferencer.md)
...
[ue/ue.d.ts:61288](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61288)
...
[ue/ue.d.ts:61286](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61286)
