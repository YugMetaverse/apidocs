[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundSourceBusFactory

# Class: SoundSourceBusFactory

[ue/ue](../modules/ue_ue.md).SoundSourceBusFactory
...
- [constructor](ue_ue.SoundSourceBusFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundSourceBusFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundSourceBusFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundSourceBusFactory.md#contextclass)
- [Formats](ue_ue.SoundSourceBusFactory.md#formats)
- [ImportPriority](ue_ue.SoundSourceBusFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundSourceBusFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundSourceBusFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundSourceBusFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundSourceBusFactory.md#__tid_object__)
- [\_\_tid\_SoundSourceBusFactory\_\_](ue_ue.SoundSourceBusFactory.md#__tid_soundsourcebusfactory__)
- [bCreateNew](ue_ue.SoundSourceBusFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundSourceBusFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundSourceBusFactory.md#beditorimport)
- [bText](ue_ue.SoundSourceBusFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundSourceBusFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundSourceBusFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundSourceBusFactory.md#getclass)
- [GetName](ue_ue.SoundSourceBusFactory.md#getname)
- [GetOuter](ue_ue.SoundSourceBusFactory.md#getouter)
- [GetWorld](ue_ue.SoundSourceBusFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundSourceBusFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundSourceBusFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundSourceBusFactory.md#find)
- [Load](ue_ue.SoundSourceBusFactory.md#load)
- [StaticClass](ue_ue.SoundSourceBusFactory.md#staticclass)

## Constructors

### constructor

• **new SoundSourceBusFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61601](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61601)
...
### \_\_tid\_SoundSourceBusFactory\_\_

• **\_\_tid\_SoundSourceBusFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61606](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61606)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundSourceBusFactory`](ue_ue.SoundSourceBusFactory.md)
...
[ue/ue.d.ts:61603](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61603)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundSourceBusFactory`](ue_ue.SoundSourceBusFactory.md)
...
[ue/ue.d.ts:61604](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61604)
...
[ue/ue.d.ts:61602](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61602)
