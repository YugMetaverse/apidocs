[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundSourceEffectChainFactory

# Class: SoundSourceEffectChainFactory

[ue/ue](../modules/ue_ue.md).SoundSourceEffectChainFactory
...
- [constructor](ue_ue.SoundSourceEffectChainFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundSourceEffectChainFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundSourceEffectChainFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundSourceEffectChainFactory.md#contextclass)
- [Formats](ue_ue.SoundSourceEffectChainFactory.md#formats)
- [ImportPriority](ue_ue.SoundSourceEffectChainFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundSourceEffectChainFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundSourceEffectChainFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundSourceEffectChainFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundSourceEffectChainFactory.md#__tid_object__)
- [\_\_tid\_SoundSourceEffectChainFactory\_\_](ue_ue.SoundSourceEffectChainFactory.md#__tid_soundsourceeffectchainfactory__)
- [bCreateNew](ue_ue.SoundSourceEffectChainFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundSourceEffectChainFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundSourceEffectChainFactory.md#beditorimport)
- [bText](ue_ue.SoundSourceEffectChainFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundSourceEffectChainFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundSourceEffectChainFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundSourceEffectChainFactory.md#getclass)
- [GetName](ue_ue.SoundSourceEffectChainFactory.md#getname)
- [GetOuter](ue_ue.SoundSourceEffectChainFactory.md#getouter)
- [GetWorld](ue_ue.SoundSourceEffectChainFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundSourceEffectChainFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundSourceEffectChainFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundSourceEffectChainFactory.md#find)
- [Load](ue_ue.SoundSourceEffectChainFactory.md#load)
- [StaticClass](ue_ue.SoundSourceEffectChainFactory.md#staticclass)

## Constructors

### constructor

• **new SoundSourceEffectChainFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61610](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61610)
...
### \_\_tid\_SoundSourceEffectChainFactory\_\_

• **\_\_tid\_SoundSourceEffectChainFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61615](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61615)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundSourceEffectChainFactory`](ue_ue.SoundSourceEffectChainFactory.md)
...
[ue/ue.d.ts:61612](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61612)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundSourceEffectChainFactory`](ue_ue.SoundSourceEffectChainFactory.md)
...
[ue/ue.d.ts:61613](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61613)
...
[ue/ue.d.ts:61611](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61611)
