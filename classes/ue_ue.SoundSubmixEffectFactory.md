[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundSubmixEffectFactory

# Class: SoundSubmixEffectFactory

[ue/ue](../modules/ue_ue.md).SoundSubmixEffectFactory
...
- [constructor](ue_ue.SoundSubmixEffectFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundSubmixEffectFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundSubmixEffectFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundSubmixEffectFactory.md#contextclass)
- [Formats](ue_ue.SoundSubmixEffectFactory.md#formats)
- [ImportPriority](ue_ue.SoundSubmixEffectFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundSubmixEffectFactory.md#overwriteyesornotoallstate)
- [SoundEffectSubmixPresetClass](ue_ue.SoundSubmixEffectFactory.md#soundeffectsubmixpresetclass)
- [SupportedClass](ue_ue.SoundSubmixEffectFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundSubmixEffectFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundSubmixEffectFactory.md#__tid_object__)
- [\_\_tid\_SoundSubmixEffectFactory\_\_](ue_ue.SoundSubmixEffectFactory.md#__tid_soundsubmixeffectfactory__)
- [bCreateNew](ue_ue.SoundSubmixEffectFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundSubmixEffectFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundSubmixEffectFactory.md#beditorimport)
- [bText](ue_ue.SoundSubmixEffectFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundSubmixEffectFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundSubmixEffectFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundSubmixEffectFactory.md#getclass)
- [GetName](ue_ue.SoundSubmixEffectFactory.md#getname)
- [GetOuter](ue_ue.SoundSubmixEffectFactory.md#getouter)
- [GetWorld](ue_ue.SoundSubmixEffectFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundSubmixEffectFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundSubmixEffectFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundSubmixEffectFactory.md#find)
- [Load](ue_ue.SoundSubmixEffectFactory.md#load)
- [StaticClass](ue_ue.SoundSubmixEffectFactory.md#staticclass)

## Constructors

### constructor

• **new SoundSubmixEffectFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61629](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61629)
...
### SoundEffectSubmixPresetClass

• **SoundEffectSubmixPresetClass**: [`Class`](ue_ue.Class.md)

#### Defined in

[ue/ue.d.ts:61630](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61630)
...
### \_\_tid\_SoundSubmixEffectFactory\_\_

• **\_\_tid\_SoundSubmixEffectFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61635](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61635)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundSubmixEffectFactory`](ue_ue.SoundSubmixEffectFactory.md)
...
[ue/ue.d.ts:61632](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61632)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundSubmixEffectFactory`](ue_ue.SoundSubmixEffectFactory.md)
...
[ue/ue.d.ts:61633](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61633)
...
[ue/ue.d.ts:61631](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61631)
