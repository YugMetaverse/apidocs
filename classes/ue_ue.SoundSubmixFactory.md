[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundSubmixFactory

# Class: SoundSubmixFactory

[ue/ue](../modules/ue_ue.md).SoundSubmixFactory
...
- [constructor](ue_ue.SoundSubmixFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SoundSubmixFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SoundSubmixFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SoundSubmixFactory.md#contextclass)
- [Formats](ue_ue.SoundSubmixFactory.md#formats)
- [ImportPriority](ue_ue.SoundSubmixFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SoundSubmixFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SoundSubmixFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SoundSubmixFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SoundSubmixFactory.md#__tid_object__)
- [\_\_tid\_SoundSubmixFactory\_\_](ue_ue.SoundSubmixFactory.md#__tid_soundsubmixfactory__)
- [bCreateNew](ue_ue.SoundSubmixFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SoundSubmixFactory.md#beditafternew)
- [bEditorImport](ue_ue.SoundSubmixFactory.md#beditorimport)
- [bText](ue_ue.SoundSubmixFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundSubmixFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundSubmixFactory.md#executeubergraph)
- [GetClass](ue_ue.SoundSubmixFactory.md#getclass)
- [GetName](ue_ue.SoundSubmixFactory.md#getname)
- [GetOuter](ue_ue.SoundSubmixFactory.md#getouter)
- [GetWorld](ue_ue.SoundSubmixFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SoundSubmixFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SoundSubmixFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SoundSubmixFactory.md#find)
- [Load](ue_ue.SoundSubmixFactory.md#load)
- [StaticClass](ue_ue.SoundSubmixFactory.md#staticclass)

## Constructors

### constructor

• **new SoundSubmixFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61639](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61639)
...
### \_\_tid\_SoundSubmixFactory\_\_

• **\_\_tid\_SoundSubmixFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61644](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61644)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundSubmixFactory`](ue_ue.SoundSubmixFactory.md)
...
[ue/ue.d.ts:61641](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61641)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundSubmixFactory`](ue_ue.SoundSubmixFactory.md)
...
[ue/ue.d.ts:61642](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61642)
...
[ue/ue.d.ts:61640](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L61640)
