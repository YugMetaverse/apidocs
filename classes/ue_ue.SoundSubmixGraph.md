[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SoundSubmixGraph

# Class: SoundSubmixGraph

[ue/ue](../modules/ue_ue.md).SoundSubmixGraph
...
- [constructor](ue_ue.SoundSubmixGraph.md#constructor)

### Properties

- [GraphGuid](ue_ue.SoundSubmixGraph.md#graphguid)
- [InterfaceGuid](ue_ue.SoundSubmixGraph.md#interfaceguid)
- [Nodes](ue_ue.SoundSubmixGraph.md#nodes)
- [Schema](ue_ue.SoundSubmixGraph.md#schema)
- [SubGraphs](ue_ue.SoundSubmixGraph.md#subgraphs)
- [\_\_tid\_EdGraph\_\_](ue_ue.SoundSubmixGraph.md#__tid_edgraph__)
- [\_\_tid\_Object\_\_](ue_ue.SoundSubmixGraph.md#__tid_object__)
- [\_\_tid\_SoundSubmixGraph\_\_](ue_ue.SoundSubmixGraph.md#__tid_soundsubmixgraph__)
- [bAllowDeletion](ue_ue.SoundSubmixGraph.md#ballowdeletion)
- [bAllowRenaming](ue_ue.SoundSubmixGraph.md#ballowrenaming)
- [bEditable](ue_ue.SoundSubmixGraph.md#beditable)

### Methods

- [CreateDefaultSubobject](ue_ue.SoundSubmixGraph.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SoundSubmixGraph.md#executeubergraph)
- [GetClass](ue_ue.SoundSubmixGraph.md#getclass)
- [GetName](ue_ue.SoundSubmixGraph.md#getname)
- [GetOuter](ue_ue.SoundSubmixGraph.md#getouter)
- [GetWorld](ue_ue.SoundSubmixGraph.md#getworld)
- [Find](ue_ue.SoundSubmixGraph.md#find)
- [Load](ue_ue.SoundSubmixGraph.md#load)
- [StaticClass](ue_ue.SoundSubmixGraph.md#staticclass)

## Constructors

### constructor

• **new SoundSubmixGraph**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:61648](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61648)
...
### \_\_tid\_SoundSubmixGraph\_\_

• **\_\_tid\_SoundSubmixGraph\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:61653](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61653)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SoundSubmixGraph`](ue_ue.SoundSubmixGraph.md)
...
[ue/ue.d.ts:61650](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61650)

___

### Load

▸ `Static` **Load**(`InName`): [`SoundSubmixGraph`](ue_ue.SoundSubmixGraph.md)
...
[ue/ue.d.ts:61651](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61651)
...
[ue/ue.d.ts:61649](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L61649)
