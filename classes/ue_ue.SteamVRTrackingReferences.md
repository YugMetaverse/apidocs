[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SteamVRTrackingReferences

# Class: SteamVRTrackingReferences

[ue/ue](../modules/ue_ue.md).SteamVRTrackingReferences
...
- [constructor](ue_ue.SteamVRTrackingReferences.md#constructor)

### Properties

- [ActiveDevicePollFrequency](ue_ue.SteamVRTrackingReferences.md#activedevicepollfrequency)
- [AssetUserData](ue_ue.SteamVRTrackingReferences.md#assetuserdata)
- [ComponentTags](ue_ue.SteamVRTrackingReferences.md#componenttags)
- [CreationMethod](ue_ue.SteamVRTrackingReferences.md#creationmethod)
- [OnComponentActivated](ue_ue.SteamVRTrackingReferences.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.SteamVRTrackingReferences.md#oncomponentdeactivated)
- [OnTrackedDeviceActivated](ue_ue.SteamVRTrackingReferences.md#ontrackeddeviceactivated)
- [OnTrackedDeviceDeactivated](ue_ue.SteamVRTrackingReferences.md#ontrackeddevicedeactivated)
- [PrimaryComponentTick](ue_ue.SteamVRTrackingReferences.md#primarycomponenttick)
- [TrackingReferenceScale](ue_ue.SteamVRTrackingReferences.md#trackingreferencescale)
- [TrackingReferences](ue_ue.SteamVRTrackingReferences.md#trackingreferences)
- [UCSModifiedProperties](ue_ue.SteamVRTrackingReferences.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.SteamVRTrackingReferences.md#__tid_actorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.SteamVRTrackingReferences.md#__tid_object__)
- [\_\_tid\_SteamVRTrackingReferences\_\_](ue_ue.SteamVRTrackingReferences.md#__tid_steamvrtrackingreferences__)
- [bAutoActivate](ue_ue.SteamVRTrackingReferences.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.SteamVRTrackingReferences.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.SteamVRTrackingReferences.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.SteamVRTrackingReferences.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.SteamVRTrackingReferences.md#binstancecomponent)
- [bIsActive](ue_ue.SteamVRTrackingReferences.md#bisactive)
- [bIsEditorOnly](ue_ue.SteamVRTrackingReferences.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.SteamVRTrackingReferences.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.SteamVRTrackingReferences.md#bnetaddressable)
- [bReplicates](ue_ue.SteamVRTrackingReferences.md#breplicates)

### Methods

- [Activate](ue_ue.SteamVRTrackingReferences.md#activate)
- [AddTickPrerequisiteActor](ue_ue.SteamVRTrackingReferences.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.SteamVRTrackingReferences.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.SteamVRTrackingReferences.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.SteamVRTrackingReferences.md#createdefaultsubobject)
- [Deactivate](ue_ue.SteamVRTrackingReferences.md#deactivate)
- [ExecuteUbergraph](ue_ue.SteamVRTrackingReferences.md#executeubergraph)
- [GetClass](ue_ue.SteamVRTrackingReferences.md#getclass)
- [GetComponentTickInterval](ue_ue.SteamVRTrackingReferences.md#getcomponenttickinterval)
- [GetName](ue_ue.SteamVRTrackingReferences.md#getname)
- [GetOuter](ue_ue.SteamVRTrackingReferences.md#getouter)
- [GetOwner](ue_ue.SteamVRTrackingReferences.md#getowner)
- [GetWorld](ue_ue.SteamVRTrackingReferences.md#getworld)
- [HideTrackingReferences](ue_ue.SteamVRTrackingReferences.md#hidetrackingreferences)
- [IsActive](ue_ue.SteamVRTrackingReferences.md#isactive)
- [IsBeingDestroyed](ue_ue.SteamVRTrackingReferences.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.SteamVRTrackingReferences.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.SteamVRTrackingReferences.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.SteamVRTrackingReferences.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.SteamVRTrackingReferences.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.SteamVRTrackingReferences.md#receiveendplay)
- [ReceiveTick](ue_ue.SteamVRTrackingReferences.md#receivetick)
- [RegisterComponent](ue_ue.SteamVRTrackingReferences.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.SteamVRTrackingReferences.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.SteamVRTrackingReferences.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.SteamVRTrackingReferences.md#setactive)
- [SetAutoActivate](ue_ue.SteamVRTrackingReferences.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.SteamVRTrackingReferences.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.SteamVRTrackingReferences.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.SteamVRTrackingReferences.md#setisreplicated)
- [SetTickGroup](ue_ue.SteamVRTrackingReferences.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.SteamVRTrackingReferences.md#settickablewhenpaused)
- [ShowTrackingReferences](ue_ue.SteamVRTrackingReferences.md#showtrackingreferences)
- [ToggleActive](ue_ue.SteamVRTrackingReferences.md#toggleactive)
- [Find](ue_ue.SteamVRTrackingReferences.md#find)
- [Load](ue_ue.SteamVRTrackingReferences.md#load)
- [StaticClass](ue_ue.SteamVRTrackingReferences.md#staticclass)

## Constructors

### constructor

• **new SteamVRTrackingReferences**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62327](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62327)
...
[ue/ue.d.ts:62330](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62330)
...
• **OnTrackedDeviceActivated**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<(`DeviceID`: `number`, `DeviceClass`: `string`, `DeviceModel`: `string`) => `void`\>

#### Defined in

[ue/ue.d.ts:62328](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62328)

___

### OnTrackedDeviceDeactivated

• **OnTrackedDeviceDeactivated**: [`$MulticastDelegate`](../interfaces/ue_puerts._MulticastDelegate.md)<(`DeviceID`: `number`, `DeviceClass`: `string`, `DeviceModel`: `string`) => `void`\>

#### Defined in

[ue/ue.d.ts:62329](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62329)
...
• **TrackingReferenceScale**: [`Vector`](ue_ue_s.Vector.md)

#### Defined in

[ue/ue.d.ts:62331](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62331)

___

### TrackingReferences

• **TrackingReferences**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`StaticMeshComponent`](ue_ue.StaticMeshComponent.md)\>

#### Defined in

[ue/ue.d.ts:62332](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62332)
...
### \_\_tid\_SteamVRTrackingReferences\_\_

• **\_\_tid\_SteamVRTrackingReferences\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62339](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62339)
...
[ue/ue.d.ts:62333](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62333)
...
▸ **ShowTrackingReferences**(`TrackingReferenceMesh`): `boolean`

#### Parameters

| Name | Type |
| :------ | :------ |
| `TrackingReferenceMesh` | [`$Nullable`](../modules/puerts.md#$nullable)<[`StaticMesh`](ue_ue.StaticMesh.md)\> |
...
[ue/ue.d.ts:62334](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62334)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SteamVRTrackingReferences`](ue_ue.SteamVRTrackingReferences.md)
...
[ue/ue.d.ts:62336](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62336)

___

### Load

▸ `Static` **Load**(`InName`): [`SteamVRTrackingReferences`](ue_ue.SteamVRTrackingReferences.md)
...
[ue/ue.d.ts:62337](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62337)
...
[ue/ue.d.ts:62335](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62335)
