[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / StereoLayerComponent

# Class: StereoLayerComponent

[ue/ue](../modules/ue_ue.md).StereoLayerComponent
...
- [constructor](ue_ue.StereoLayerComponent.md#constructor)

### Properties

- [AssetUserData](ue_ue.StereoLayerComponent.md#assetuserdata)
- [AttachChildren](ue_ue.StereoLayerComponent.md#attachchildren)
- [AttachParent](ue_ue.StereoLayerComponent.md#attachparent)
- [AttachSocketName](ue_ue.StereoLayerComponent.md#attachsocketname)
- [ClientAttachedChildren](ue_ue.StereoLayerComponent.md#clientattachedchildren)
- [ComponentTags](ue_ue.StereoLayerComponent.md#componenttags)
- [ComponentVelocity](ue_ue.StereoLayerComponent.md#componentvelocity)
- [CreationMethod](ue_ue.StereoLayerComponent.md#creationmethod)
- [CylinderHeight](ue_ue.StereoLayerComponent.md#cylinderheight)
- [CylinderOverlayArc](ue_ue.StereoLayerComponent.md#cylinderoverlayarc)
- [CylinderRadius](ue_ue.StereoLayerComponent.md#cylinderradius)
- [DetailMode](ue_ue.StereoLayerComponent.md#detailmode)
- [EquirectProps](ue_ue.StereoLayerComponent.md#equirectprops)
- [LeftTexture](ue_ue.StereoLayerComponent.md#lefttexture)
- [Mobility](ue_ue.StereoLayerComponent.md#mobility)
- [OnComponentActivated](ue_ue.StereoLayerComponent.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.StereoLayerComponent.md#oncomponentdeactivated)
- [PhysicsVolume](ue_ue.StereoLayerComponent.md#physicsvolume)
- [PhysicsVolumeChangedDelegate](ue_ue.StereoLayerComponent.md#physicsvolumechangeddelegate)
- [PrimaryComponentTick](ue_ue.StereoLayerComponent.md#primarycomponenttick)
- [Priority](ue_ue.StereoLayerComponent.md#priority)
- [QuadSize](ue_ue.StereoLayerComponent.md#quadsize)
- [RelativeLocation](ue_ue.StereoLayerComponent.md#relativelocation)
- [RelativeRotation](ue_ue.StereoLayerComponent.md#relativerotation)
- [RelativeScale3D](ue_ue.StereoLayerComponent.md#relativescale3d)
- [StereoLayerShape](ue_ue.StereoLayerComponent.md#stereolayershape)
- [StereoLayerType](ue_ue.StereoLayerComponent.md#stereolayertype)
- [Texture](ue_ue.StereoLayerComponent.md#texture)
- [UCSModifiedProperties](ue_ue.StereoLayerComponent.md#ucsmodifiedproperties)
- [UVRect](ue_ue.StereoLayerComponent.md#uvrect)
- [\_\_tid\_ActorComponent\_\_](ue_ue.StereoLayerComponent.md#__tid_actorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue.StereoLayerComponent.md#__tid_object__)
- [\_\_tid\_SceneComponent\_\_](ue_ue.StereoLayerComponent.md#__tid_scenecomponent__)
- [\_\_tid\_StereoLayerComponent\_\_](ue_ue.StereoLayerComponent.md#__tid_stereolayercomponent__)
- [bAbsoluteLocation](ue_ue.StereoLayerComponent.md#babsolutelocation)
- [bAbsoluteRotation](ue_ue.StereoLayerComponent.md#babsoluterotation)
- [bAbsoluteScale](ue_ue.StereoLayerComponent.md#babsolutescale)
- [bAutoActivate](ue_ue.StereoLayerComponent.md#bautoactivate)
- [bBoundsChangeTriggersStreamingDataRebuild](ue_ue.StereoLayerComponent.md#bboundschangetriggersstreamingdatarebuild)
- [bCanEverAffectNavigation](ue_ue.StereoLayerComponent.md#bcaneveraffectnavigation)
- [bComponentToWorldUpdated](ue_ue.StereoLayerComponent.md#bcomponenttoworldupdated)
- [bCreatedByConstructionScript](ue_ue.StereoLayerComponent.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.StereoLayerComponent.md#beditablewheninherited)
- [bHiddenInGame](ue_ue.StereoLayerComponent.md#bhiddeningame)
- [bInstanceComponent](ue_ue.StereoLayerComponent.md#binstancecomponent)
- [bIsActive](ue_ue.StereoLayerComponent.md#bisactive)
- [bIsEditorOnly](ue_ue.StereoLayerComponent.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.StereoLayerComponent.md#bisvisualizationcomponent)
- [bLiveTexture](ue_ue.StereoLayerComponent.md#blivetexture)
- [bNetAddressable](ue_ue.StereoLayerComponent.md#bnetaddressable)
- [bNoAlphaChannel](ue_ue.StereoLayerComponent.md#bnoalphachannel)
- [bQuadPreserveTextureRatio](ue_ue.StereoLayerComponent.md#bquadpreservetextureratio)
- [bReplicates](ue_ue.StereoLayerComponent.md#breplicates)
- [bShouldBeAttached](ue_ue.StereoLayerComponent.md#bshouldbeattached)
- [bShouldSnapLocationWhenAttached](ue_ue.StereoLayerComponent.md#bshouldsnaplocationwhenattached)
- [bShouldSnapRotationWhenAttached](ue_ue.StereoLayerComponent.md#bshouldsnaprotationwhenattached)
- [bShouldUpdatePhysicsVolume](ue_ue.StereoLayerComponent.md#bshouldupdatephysicsvolume)
- [bSupportsDepth](ue_ue.StereoLayerComponent.md#bsupportsdepth)
- [bUseAttachParentBound](ue_ue.StereoLayerComponent.md#buseattachparentbound)
- [bVisible](ue_ue.StereoLayerComponent.md#bvisible)
- [bVisualizeComponent](ue_ue.StereoLayerComponent.md#bvisualizecomponent)

### Methods

- [Activate](ue_ue.StereoLayerComponent.md#activate)
- [AddTickPrerequisiteActor](ue_ue.StereoLayerComponent.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.StereoLayerComponent.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.StereoLayerComponent.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.StereoLayerComponent.md#createdefaultsubobject)
- [Deactivate](ue_ue.StereoLayerComponent.md#deactivate)
- [DetachFromParent](ue_ue.StereoLayerComponent.md#detachfromparent)
- [DoesSocketExist](ue_ue.StereoLayerComponent.md#doessocketexist)
- [ExecuteUbergraph](ue_ue.StereoLayerComponent.md#executeubergraph)
- [GetAllSocketNames](ue_ue.StereoLayerComponent.md#getallsocketnames)
- [GetAttachParent](ue_ue.StereoLayerComponent.md#getattachparent)
- [GetAttachSocketName](ue_ue.StereoLayerComponent.md#getattachsocketname)
- [GetChildComponent](ue_ue.StereoLayerComponent.md#getchildcomponent)
- [GetChildrenComponents](ue_ue.StereoLayerComponent.md#getchildrencomponents)
- [GetClass](ue_ue.StereoLayerComponent.md#getclass)
- [GetComponentTickInterval](ue_ue.StereoLayerComponent.md#getcomponenttickinterval)
- [GetComponentVelocity](ue_ue.StereoLayerComponent.md#getcomponentvelocity)
- [GetForwardVector](ue_ue.StereoLayerComponent.md#getforwardvector)
- [GetLeftTexture](ue_ue.StereoLayerComponent.md#getlefttexture)
- [GetName](ue_ue.StereoLayerComponent.md#getname)
- [GetNumChildrenComponents](ue_ue.StereoLayerComponent.md#getnumchildrencomponents)
- [GetOuter](ue_ue.StereoLayerComponent.md#getouter)
- [GetOwner](ue_ue.StereoLayerComponent.md#getowner)
- [GetParentComponents](ue_ue.StereoLayerComponent.md#getparentcomponents)
- [GetPhysicsVolume](ue_ue.StereoLayerComponent.md#getphysicsvolume)
- [GetPriority](ue_ue.StereoLayerComponent.md#getpriority)
- [GetQuadSize](ue_ue.StereoLayerComponent.md#getquadsize)
- [GetRelativeTransform](ue_ue.StereoLayerComponent.md#getrelativetransform)
- [GetRightVector](ue_ue.StereoLayerComponent.md#getrightvector)
- [GetShouldUpdatePhysicsVolume](ue_ue.StereoLayerComponent.md#getshouldupdatephysicsvolume)
- [GetSocketLocation](ue_ue.StereoLayerComponent.md#getsocketlocation)
- [GetSocketQuaternion](ue_ue.StereoLayerComponent.md#getsocketquaternion)
- [GetSocketRotation](ue_ue.StereoLayerComponent.md#getsocketrotation)
- [GetSocketTransform](ue_ue.StereoLayerComponent.md#getsockettransform)
- [GetTexture](ue_ue.StereoLayerComponent.md#gettexture)
- [GetUVRect](ue_ue.StereoLayerComponent.md#getuvrect)
- [GetUpVector](ue_ue.StereoLayerComponent.md#getupvector)
- [GetWorld](ue_ue.StereoLayerComponent.md#getworld)
- [IsActive](ue_ue.StereoLayerComponent.md#isactive)
- [IsAnySimulatingPhysics](ue_ue.StereoLayerComponent.md#isanysimulatingphysics)
- [IsBeingDestroyed](ue_ue.StereoLayerComponent.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.StereoLayerComponent.md#iscomponenttickenabled)
- [IsSimulatingPhysics](ue_ue.StereoLayerComponent.md#issimulatingphysics)
- [IsVisible](ue_ue.StereoLayerComponent.md#isvisible)
- [K2\_AddLocalOffset](ue_ue.StereoLayerComponent.md#k2_addlocaloffset)
- [K2\_AddLocalRotation](ue_ue.StereoLayerComponent.md#k2_addlocalrotation)
- [K2\_AddLocalTransform](ue_ue.StereoLayerComponent.md#k2_addlocaltransform)
- [K2\_AddRelativeLocation](ue_ue.StereoLayerComponent.md#k2_addrelativelocation)
- [K2\_AddRelativeRotation](ue_ue.StereoLayerComponent.md#k2_addrelativerotation)
- [K2\_AddWorldOffset](ue_ue.StereoLayerComponent.md#k2_addworldoffset)
- [K2\_AddWorldRotation](ue_ue.StereoLayerComponent.md#k2_addworldrotation)
- [K2\_AddWorldTransform](ue_ue.StereoLayerComponent.md#k2_addworldtransform)
- [K2\_AttachTo](ue_ue.StereoLayerComponent.md#k2_attachto)
- [K2\_AttachToComponent](ue_ue.StereoLayerComponent.md#k2_attachtocomponent)
- [K2\_DestroyComponent](ue_ue.StereoLayerComponent.md#k2_destroycomponent)
- [K2\_DetachFromComponent](ue_ue.StereoLayerComponent.md#k2_detachfromcomponent)
- [K2\_GetComponentLocation](ue_ue.StereoLayerComponent.md#k2_getcomponentlocation)
- [K2\_GetComponentRotation](ue_ue.StereoLayerComponent.md#k2_getcomponentrotation)
- [K2\_GetComponentScale](ue_ue.StereoLayerComponent.md#k2_getcomponentscale)
- [K2\_GetComponentToWorld](ue_ue.StereoLayerComponent.md#k2_getcomponenttoworld)
- [K2\_SetRelativeLocation](ue_ue.StereoLayerComponent.md#k2_setrelativelocation)
- [K2\_SetRelativeLocationAndRotation](ue_ue.StereoLayerComponent.md#k2_setrelativelocationandrotation)
- [K2\_SetRelativeRotation](ue_ue.StereoLayerComponent.md#k2_setrelativerotation)
- [K2\_SetRelativeTransform](ue_ue.StereoLayerComponent.md#k2_setrelativetransform)
- [K2\_SetWorldLocation](ue_ue.StereoLayerComponent.md#k2_setworldlocation)
- [K2\_SetWorldLocationAndRotation](ue_ue.StereoLayerComponent.md#k2_setworldlocationandrotation)
- [K2\_SetWorldRotation](ue_ue.StereoLayerComponent.md#k2_setworldrotation)
- [K2\_SetWorldTransform](ue_ue.StereoLayerComponent.md#k2_setworldtransform)
- [MarkTextureForUpdate](ue_ue.StereoLayerComponent.md#marktextureforupdate)
- [OnRep\_AttachChildren](ue_ue.StereoLayerComponent.md#onrep_attachchildren)
- [OnRep\_AttachParent](ue_ue.StereoLayerComponent.md#onrep_attachparent)
- [OnRep\_AttachSocketName](ue_ue.StereoLayerComponent.md#onrep_attachsocketname)
- [OnRep\_IsActive](ue_ue.StereoLayerComponent.md#onrep_isactive)
- [OnRep\_Transform](ue_ue.StereoLayerComponent.md#onrep_transform)
- [OnRep\_Visibility](ue_ue.StereoLayerComponent.md#onrep_visibility)
- [ReceiveBeginPlay](ue_ue.StereoLayerComponent.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.StereoLayerComponent.md#receiveendplay)
- [ReceiveTick](ue_ue.StereoLayerComponent.md#receivetick)
- [RegisterComponent](ue_ue.StereoLayerComponent.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.StereoLayerComponent.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.StereoLayerComponent.md#removetickprerequisitecomponent)
- [ResetRelativeTransform](ue_ue.StereoLayerComponent.md#resetrelativetransform)
- [SetAbsolute](ue_ue.StereoLayerComponent.md#setabsolute)
- [SetActive](ue_ue.StereoLayerComponent.md#setactive)
- [SetAutoActivate](ue_ue.StereoLayerComponent.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.StereoLayerComponent.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.StereoLayerComponent.md#setcomponenttickinterval)
- [SetEquirectProps](ue_ue.StereoLayerComponent.md#setequirectprops)
- [SetHiddenInGame](ue_ue.StereoLayerComponent.md#sethiddeningame)
- [SetIsReplicated](ue_ue.StereoLayerComponent.md#setisreplicated)
- [SetLeftTexture](ue_ue.StereoLayerComponent.md#setlefttexture)
- [SetMobility](ue_ue.StereoLayerComponent.md#setmobility)
- [SetPriority](ue_ue.StereoLayerComponent.md#setpriority)
- [SetQuadSize](ue_ue.StereoLayerComponent.md#setquadsize)
- [SetRelativeScale3D](ue_ue.StereoLayerComponent.md#setrelativescale3d)
- [SetShouldUpdatePhysicsVolume](ue_ue.StereoLayerComponent.md#setshouldupdatephysicsvolume)
- [SetTexture](ue_ue.StereoLayerComponent.md#settexture)
- [SetTickGroup](ue_ue.StereoLayerComponent.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.StereoLayerComponent.md#settickablewhenpaused)
- [SetUVRect](ue_ue.StereoLayerComponent.md#setuvrect)
- [SetVisibility](ue_ue.StereoLayerComponent.md#setvisibility)
- [SetWorldScale3D](ue_ue.StereoLayerComponent.md#setworldscale3d)
- [SetupAttachment](ue_ue.StereoLayerComponent.md#setupattachment)
- [SnapTo](ue_ue.StereoLayerComponent.md#snapto)
- [ToggleActive](ue_ue.StereoLayerComponent.md#toggleactive)
- [ToggleVisibility](ue_ue.StereoLayerComponent.md#togglevisibility)
- [Find](ue_ue.StereoLayerComponent.md#find)
- [Load](ue_ue.StereoLayerComponent.md#load)
- [StaticClass](ue_ue.StereoLayerComponent.md#staticclass)

## Constructors

### constructor

• **new StereoLayerComponent**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62360](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62360)
...
[ue/ue.d.ts:62371](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62371)
...
[ue/ue.d.ts:62370](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62370)
...
[ue/ue.d.ts:62369](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62369)
...
• **EquirectProps**: [`EquirectProps`](ue_ue.EquirectProps.md)

#### Defined in

[ue/ue.d.ts:62372](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62372)

___

### LeftTexture

• **LeftTexture**: [`Texture`](ue_ue.Texture.md)

#### Defined in

[ue/ue.d.ts:62365](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62365)
...
[ue/ue.d.ts:62375](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62375)

___

### QuadSize

• **QuadSize**: [`Vector2D`](ue_ue_s.Vector2D.md)

#### Defined in

[ue/ue.d.ts:62367](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62367)
...
• **StereoLayerShape**: [`EStereoLayerShape`](../enums/ue_ue.EStereoLayerShape.md)

#### Defined in

[ue/ue.d.ts:62374](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62374)

___

### StereoLayerType

• **StereoLayerType**: [`EStereoLayerType`](../enums/ue_ue.EStereoLayerType.md)

#### Defined in

[ue/ue.d.ts:62373](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62373)
...
[ue/ue.d.ts:62364](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62364)
...
• **UVRect**: [`Box2D`](ue_ue_s.Box2D.md)

#### Defined in

[ue/ue.d.ts:62368](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62368)
...
### \_\_tid\_StereoLayerComponent\_\_

• **\_\_tid\_StereoLayerComponent\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62392](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62392)
...
[ue/ue.d.ts:62361](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62361)
...
[ue/ue.d.ts:62363](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62363)
...
[ue/ue.d.ts:62366](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62366)
...
[ue/ue.d.ts:62362](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62362)
...
▸ **GetLeftTexture**(): [`Texture`](ue_ue.Texture.md)
...
[ue/ue.d.ts:62376](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62376)
...
[ue/ue.d.ts:62377](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62377)

___

### GetQuadSize

▸ **GetQuadSize**(): [`Vector2D`](ue_ue_s.Vector2D.md)
...
[ue/ue.d.ts:62378](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62378)
...
▸ **GetTexture**(): [`Texture`](ue_ue.Texture.md)
...
[ue/ue.d.ts:62379](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62379)

___

### GetUVRect

▸ **GetUVRect**(): [`Box2D`](ue_ue_s.Box2D.md)
...
[ue/ue.d.ts:62380](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62380)
...
[ue/ue.d.ts:62381](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62381)
...
▸ **SetEquirectProps**(`InScaleBiases`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `InScaleBiases` | [`EquirectProps`](ue_ue.EquirectProps.md) |
...
[ue/ue.d.ts:62382](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62382)
...
[ue/ue.d.ts:62383](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62383)
...
[ue/ue.d.ts:62384](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62384)

___

### SetQuadSize

▸ **SetQuadSize**(`InQuadSize`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `InQuadSize` | [`Vector2D`](ue_ue_s.Vector2D.md) |
...
[ue/ue.d.ts:62385](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62385)
...
[ue/ue.d.ts:62386](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62386)
...
▸ **SetUVRect**(`InUVRect`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `InUVRect` | [`Box2D`](ue_ue_s.Box2D.md) |
...
[ue/ue.d.ts:62387](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62387)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`StereoLayerComponent`](ue_ue.StereoLayerComponent.md)
...
[ue/ue.d.ts:62389](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62389)

___

### Load

▸ `Static` **Load**(`InName`): [`StereoLayerComponent`](ue_ue.StereoLayerComponent.md)
...
[ue/ue.d.ts:62390](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62390)
...
[ue/ue.d.ts:62388](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62388)
