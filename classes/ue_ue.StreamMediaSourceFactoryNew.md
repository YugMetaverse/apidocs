[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / StreamMediaSourceFactoryNew

# Class: StreamMediaSourceFactoryNew

[ue/ue](../modules/ue_ue.md).StreamMediaSourceFactoryNew
...
- [constructor](ue_ue.StreamMediaSourceFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.StreamMediaSourceFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.StreamMediaSourceFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.StreamMediaSourceFactoryNew.md#contextclass)
- [Formats](ue_ue.StreamMediaSourceFactoryNew.md#formats)
- [ImportPriority](ue_ue.StreamMediaSourceFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.StreamMediaSourceFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.StreamMediaSourceFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.StreamMediaSourceFactoryNew.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.StreamMediaSourceFactoryNew.md#__tid_object__)
- [\_\_tid\_StreamMediaSourceFactoryNew\_\_](ue_ue.StreamMediaSourceFactoryNew.md#__tid_streammediasourcefactorynew__)
- [bCreateNew](ue_ue.StreamMediaSourceFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.StreamMediaSourceFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.StreamMediaSourceFactoryNew.md#beditorimport)
- [bText](ue_ue.StreamMediaSourceFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.StreamMediaSourceFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.StreamMediaSourceFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.StreamMediaSourceFactoryNew.md#getclass)
- [GetName](ue_ue.StreamMediaSourceFactoryNew.md#getname)
- [GetOuter](ue_ue.StreamMediaSourceFactoryNew.md#getouter)
- [GetWorld](ue_ue.StreamMediaSourceFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.StreamMediaSourceFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.StreamMediaSourceFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.StreamMediaSourceFactoryNew.md#find)
- [Load](ue_ue.StreamMediaSourceFactoryNew.md#load)
- [StaticClass](ue_ue.StreamMediaSourceFactoryNew.md#staticclass)

## Constructors

### constructor

• **new StreamMediaSourceFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62444](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62444)
...
### \_\_tid\_StreamMediaSourceFactoryNew\_\_

• **\_\_tid\_StreamMediaSourceFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62449](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62449)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`StreamMediaSourceFactoryNew`](ue_ue.StreamMediaSourceFactoryNew.md)
...
[ue/ue.d.ts:62446](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62446)

___

### Load

▸ `Static` **Load**(`InName`): [`StreamMediaSourceFactoryNew`](ue_ue.StreamMediaSourceFactoryNew.md)
...
[ue/ue.d.ts:62447](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62447)
...
[ue/ue.d.ts:62445](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L62445)
