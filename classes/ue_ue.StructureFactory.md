[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / StructureFactory

# Class: StructureFactory

[ue/ue](../modules/ue_ue.md).StructureFactory
...
- [constructor](ue_ue.StructureFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.StructureFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.StructureFactory.md#automatedimportdata)
- [ContextClass](ue_ue.StructureFactory.md#contextclass)
- [Formats](ue_ue.StructureFactory.md#formats)
- [ImportPriority](ue_ue.StructureFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.StructureFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.StructureFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.StructureFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.StructureFactory.md#__tid_object__)
- [\_\_tid\_StructureFactory\_\_](ue_ue.StructureFactory.md#__tid_structurefactory__)
- [bCreateNew](ue_ue.StructureFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.StructureFactory.md#beditafternew)
- [bEditorImport](ue_ue.StructureFactory.md#beditorimport)
- [bText](ue_ue.StructureFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.StructureFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.StructureFactory.md#executeubergraph)
- [GetClass](ue_ue.StructureFactory.md#getclass)
- [GetName](ue_ue.StructureFactory.md#getname)
- [GetOuter](ue_ue.StructureFactory.md#getouter)
- [GetWorld](ue_ue.StructureFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.StructureFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.StructureFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.StructureFactory.md#find)
- [Load](ue_ue.StructureFactory.md#load)
- [StaticClass](ue_ue.StructureFactory.md#staticclass)

## Constructors

### constructor

• **new StructureFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62489](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62489)
...
### \_\_tid\_StructureFactory\_\_

• **\_\_tid\_StructureFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62494](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62494)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`StructureFactory`](ue_ue.StructureFactory.md)
...
[ue/ue.d.ts:62491](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62491)

___

### Load

▸ `Static` **Load**(`InName`): [`StructureFactory`](ue_ue.StructureFactory.md)
...
[ue/ue.d.ts:62492](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62492)
...
[ue/ue.d.ts:62490](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62490)
