[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SubsurfaceProfileFactory

# Class: SubsurfaceProfileFactory

[ue/ue](../modules/ue_ue.md).SubsurfaceProfileFactory
...
- [constructor](ue_ue.SubsurfaceProfileFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.SubsurfaceProfileFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.SubsurfaceProfileFactory.md#automatedimportdata)
- [ContextClass](ue_ue.SubsurfaceProfileFactory.md#contextclass)
- [Formats](ue_ue.SubsurfaceProfileFactory.md#formats)
- [ImportPriority](ue_ue.SubsurfaceProfileFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.SubsurfaceProfileFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.SubsurfaceProfileFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.SubsurfaceProfileFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.SubsurfaceProfileFactory.md#__tid_object__)
- [\_\_tid\_SubsurfaceProfileFactory\_\_](ue_ue.SubsurfaceProfileFactory.md#__tid_subsurfaceprofilefactory__)
- [bCreateNew](ue_ue.SubsurfaceProfileFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.SubsurfaceProfileFactory.md#beditafternew)
- [bEditorImport](ue_ue.SubsurfaceProfileFactory.md#beditorimport)
- [bText](ue_ue.SubsurfaceProfileFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.SubsurfaceProfileFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SubsurfaceProfileFactory.md#executeubergraph)
- [GetClass](ue_ue.SubsurfaceProfileFactory.md#getclass)
- [GetName](ue_ue.SubsurfaceProfileFactory.md#getname)
- [GetOuter](ue_ue.SubsurfaceProfileFactory.md#getouter)
- [GetWorld](ue_ue.SubsurfaceProfileFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.SubsurfaceProfileFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.SubsurfaceProfileFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.SubsurfaceProfileFactory.md#find)
- [Load](ue_ue.SubsurfaceProfileFactory.md#load)
- [StaticClass](ue_ue.SubsurfaceProfileFactory.md#staticclass)

## Constructors

### constructor

• **new SubsurfaceProfileFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62664](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62664)
...
### \_\_tid\_SubsurfaceProfileFactory\_\_

• **\_\_tid\_SubsurfaceProfileFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62669](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62669)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SubsurfaceProfileFactory`](ue_ue.SubsurfaceProfileFactory.md)
...
[ue/ue.d.ts:62666](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62666)

___

### Load

▸ `Static` **Load**(`InName`): [`SubsurfaceProfileFactory`](ue_ue.SubsurfaceProfileFactory.md)
...
[ue/ue.d.ts:62667](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62667)
...
[ue/ue.d.ts:62665](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62665)
