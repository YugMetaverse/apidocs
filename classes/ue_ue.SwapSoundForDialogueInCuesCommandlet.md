[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / SwapSoundForDialogueInCuesCommandlet

# Class: SwapSoundForDialogueInCuesCommandlet

[ue/ue](../modules/ue_ue.md).SwapSoundForDialogueInCuesCommandlet
...
- [constructor](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#helpweblink)
- [IsClient](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#isclient)
- [IsEditor](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#iseditor)
- [IsServer](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#isserver)
- [LogToConsole](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#__tid_object__)
- [\_\_tid\_SwapSoundForDialogueInCuesCommandlet\_\_](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#__tid_swapsoundfordialogueincuescommandlet__)

### Methods

- [CreateDefaultSubobject](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#executeubergraph)
- [GetClass](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#getclass)
- [GetName](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#getname)
- [GetOuter](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#getouter)
- [GetWorld](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#getworld)
- [Find](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#find)
- [Load](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#load)
- [StaticClass](ue_ue.SwapSoundForDialogueInCuesCommandlet.md#staticclass)

## Constructors

### constructor

• **new SwapSoundForDialogueInCuesCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62715](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62715)
...
### \_\_tid\_SwapSoundForDialogueInCuesCommandlet\_\_

• **\_\_tid\_SwapSoundForDialogueInCuesCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62720](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62720)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`SwapSoundForDialogueInCuesCommandlet`](ue_ue.SwapSoundForDialogueInCuesCommandlet.md)
...
[ue/ue.d.ts:62717](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62717)

___

### Load

▸ `Static` **Load**(`InName`): [`SwapSoundForDialogueInCuesCommandlet`](ue_ue.SwapSoundForDialogueInCuesCommandlet.md)
...
[ue/ue.d.ts:62718](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62718)
...
[ue/ue.d.ts:62716](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62716)
