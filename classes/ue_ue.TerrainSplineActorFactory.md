[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TerrainSplineActorFactory

# Class: TerrainSplineActorFactory

[ue/ue](../modules/ue_ue.md).TerrainSplineActorFactory
...
- [constructor](ue_ue.TerrainSplineActorFactory.md#constructor)

### Properties

- [DisplayName](ue_ue.TerrainSplineActorFactory.md#displayname)
- [MenuPriority](ue_ue.TerrainSplineActorFactory.md#menupriority)
- [NewActorClass](ue_ue.TerrainSplineActorFactory.md#newactorclass)
- [NewActorClassName](ue_ue.TerrainSplineActorFactory.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.TerrainSplineActorFactory.md#spawnpositionoffset)
- [\_\_tid\_ActorFactory\_\_](ue_ue.TerrainSplineActorFactory.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.TerrainSplineActorFactory.md#__tid_object__)
- [\_\_tid\_TerrainSplineActorFactory\_\_](ue_ue.TerrainSplineActorFactory.md#__tid_terrainsplineactorfactory__)
- [bShowInEditorQuickMenu](ue_ue.TerrainSplineActorFactory.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.TerrainSplineActorFactory.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.TerrainSplineActorFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.TerrainSplineActorFactory.md#executeubergraph)
- [GetClass](ue_ue.TerrainSplineActorFactory.md#getclass)
- [GetName](ue_ue.TerrainSplineActorFactory.md#getname)
- [GetOuter](ue_ue.TerrainSplineActorFactory.md#getouter)
- [GetWorld](ue_ue.TerrainSplineActorFactory.md#getworld)
- [Find](ue_ue.TerrainSplineActorFactory.md#find)
- [Load](ue_ue.TerrainSplineActorFactory.md#load)
- [StaticClass](ue_ue.TerrainSplineActorFactory.md#staticclass)

## Constructors

### constructor

• **new TerrainSplineActorFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62817](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62817)
...
### \_\_tid\_TerrainSplineActorFactory\_\_

• **\_\_tid\_TerrainSplineActorFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62822](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62822)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TerrainSplineActorFactory`](ue_ue.TerrainSplineActorFactory.md)
...
[ue/ue.d.ts:62819](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62819)

___

### Load

▸ `Static` **Load**(`InName`): [`TerrainSplineActorFactory`](ue_ue.TerrainSplineActorFactory.md)
...
[ue/ue.d.ts:62820](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62820)
...
[ue/ue.d.ts:62818](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62818)
