[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TestBTDecorator\_DelayedAbort

# Class: TestBTDecorator\_DelayedAbort

[ue/ue](../modules/ue_ue.md).TestBTDecorator_DelayedAbort
...
- [constructor](ue_ue.TestBTDecorator_DelayedAbort.md#constructor)

### Properties

- [DelayTicks](ue_ue.TestBTDecorator_DelayedAbort.md#delayticks)
- [FlowAbortMode](ue_ue.TestBTDecorator_DelayedAbort.md#flowabortmode)
- [NodeName](ue_ue.TestBTDecorator_DelayedAbort.md#nodename)
- [ParentNode](ue_ue.TestBTDecorator_DelayedAbort.md#parentnode)
- [TreeAsset](ue_ue.TestBTDecorator_DelayedAbort.md#treeasset)
- [\_\_tid\_BTAuxiliaryNode\_\_](ue_ue.TestBTDecorator_DelayedAbort.md#__tid_btauxiliarynode__)
- [\_\_tid\_BTDecorator\_\_](ue_ue.TestBTDecorator_DelayedAbort.md#__tid_btdecorator__)
- [\_\_tid\_BTNode\_\_](ue_ue.TestBTDecorator_DelayedAbort.md#__tid_btnode__)
- [\_\_tid\_Object\_\_](ue_ue.TestBTDecorator_DelayedAbort.md#__tid_object__)
- [\_\_tid\_TestBTDecorator\_DelayedAbort\_\_](ue_ue.TestBTDecorator_DelayedAbort.md#__tid_testbtdecorator_delayedabort__)
- [bInverseCondition](ue_ue.TestBTDecorator_DelayedAbort.md#binversecondition)
- [bOnlyOnce](ue_ue.TestBTDecorator_DelayedAbort.md#bonlyonce)

### Methods

- [CreateDefaultSubobject](ue_ue.TestBTDecorator_DelayedAbort.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.TestBTDecorator_DelayedAbort.md#executeubergraph)
- [GetClass](ue_ue.TestBTDecorator_DelayedAbort.md#getclass)
- [GetName](ue_ue.TestBTDecorator_DelayedAbort.md#getname)
- [GetOuter](ue_ue.TestBTDecorator_DelayedAbort.md#getouter)
- [GetWorld](ue_ue.TestBTDecorator_DelayedAbort.md#getworld)
- [Find](ue_ue.TestBTDecorator_DelayedAbort.md#find)
- [Load](ue_ue.TestBTDecorator_DelayedAbort.md#load)
- [StaticClass](ue_ue.TestBTDecorator_DelayedAbort.md#staticclass)

## Constructors

### constructor

• **new TestBTDecorator_DelayedAbort**(`Outer?`, `Name?`, `ObjectFlags?`)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TestBTDecorator_DelayedAbort`](ue_ue.TestBTDecorator_DelayedAbort.md)
...
▸ `Static` **Load**(`InName`): [`TestBTDecorator_DelayedAbort`](ue_ue.TestBTDecorator_DelayedAbort.md)
