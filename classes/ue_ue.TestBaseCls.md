[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TestBaseCls

# Class: TestBaseCls

[ue/ue](../modules/ue_ue.md).TestBaseCls
...
- [constructor](ue_ue.TestBaseCls.md#constructor)

### Properties

- [ActorLabel](ue_ue.TestBaseCls.md#actorlabel)
- [AttachmentReplication](ue_ue.TestBaseCls.md#attachmentreplication)
- [AutoReceiveInput](ue_ue.TestBaseCls.md#autoreceiveinput)
- [BlueprintCreatedComponents](ue_ue.TestBaseCls.md#blueprintcreatedcomponents)
- [Children](ue_ue.TestBaseCls.md#children)
- [ControllingMatineeActors](ue_ue.TestBaseCls.md#controllingmatineeactors)
- [CustomTimeDilation](ue_ue.TestBaseCls.md#customtimedilation)
- [DefaultUpdateOverlapsMethodDuringLevelStreaming](ue_ue.TestBaseCls.md#defaultupdateoverlapsmethodduringlevelstreaming)
- [FolderPath](ue_ue.TestBaseCls.md#folderpath)
- [GroupActor](ue_ue.TestBaseCls.md#groupactor)
- [HiddenEditorViews](ue_ue.TestBaseCls.md#hiddeneditorviews)
- [InitialLifeSpan](ue_ue.TestBaseCls.md#initiallifespan)
- [InputComponent](ue_ue.TestBaseCls.md#inputcomponent)
- [InputPriority](ue_ue.TestBaseCls.md#inputpriority)
- [InstanceComponents](ue_ue.TestBaseCls.md#instancecomponents)
- [Instigator](ue_ue.TestBaseCls.md#instigator)
- [Layers](ue_ue.TestBaseCls.md#layers)
- [MinNetUpdateFrequency](ue_ue.TestBaseCls.md#minnetupdatefrequency)
- [NetCullDistanceSquared](ue_ue.TestBaseCls.md#netculldistancesquared)
- [NetDormancy](ue_ue.TestBaseCls.md#netdormancy)
- [NetDriverName](ue_ue.TestBaseCls.md#netdrivername)
- [NetPriority](ue_ue.TestBaseCls.md#netpriority)
- [NetTag](ue_ue.TestBaseCls.md#nettag)
- [NetUpdateFrequency](ue_ue.TestBaseCls.md#netupdatefrequency)
- [OnActorBeginOverlap](ue_ue.TestBaseCls.md#onactorbeginoverlap)
- [OnActorEndOverlap](ue_ue.TestBaseCls.md#onactorendoverlap)
- [OnActorHit](ue_ue.TestBaseCls.md#onactorhit)
- [OnBeginCursorOver](ue_ue.TestBaseCls.md#onbegincursorover)
- [OnClicked](ue_ue.TestBaseCls.md#onclicked)
- [OnDestroyed](ue_ue.TestBaseCls.md#ondestroyed)
- [OnEndCursorOver](ue_ue.TestBaseCls.md#onendcursorover)
- [OnEndPlay](ue_ue.TestBaseCls.md#onendplay)
- [OnInputTouchBegin](ue_ue.TestBaseCls.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue.TestBaseCls.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue.TestBaseCls.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue.TestBaseCls.md#oninputtouchleave)
- [OnReleased](ue_ue.TestBaseCls.md#onreleased)
- [OnTakeAnyDamage](ue_ue.TestBaseCls.md#ontakeanydamage)
- [OnTakePointDamage](ue_ue.TestBaseCls.md#ontakepointdamage)
- [OnTakeRadialDamage](ue_ue.TestBaseCls.md#ontakeradialdamage)
- [Owner](ue_ue.TestBaseCls.md#owner)
- [ParentComponent](ue_ue.TestBaseCls.md#parentcomponent)
- [ParentComponentActor](ue_ue.TestBaseCls.md#parentcomponentactor)
- [PivotOffset](ue_ue.TestBaseCls.md#pivotoffset)
- [PrimaryActorTick](ue_ue.TestBaseCls.md#primaryactortick)
- [RemoteRole](ue_ue.TestBaseCls.md#remoterole)
- [ReplicatedMovement](ue_ue.TestBaseCls.md#replicatedmovement)
- [Role](ue_ue.TestBaseCls.md#role)
- [RootComponent](ue_ue.TestBaseCls.md#rootcomponent)
- [SpawnCollisionHandlingMethod](ue_ue.TestBaseCls.md#spawncollisionhandlingmethod)
- [SpriteScale](ue_ue.TestBaseCls.md#spritescale)
- [Tags](ue_ue.TestBaseCls.md#tags)
- [UpdateOverlapsMethodDuringLevelStreaming](ue_ue.TestBaseCls.md#updateoverlapsmethodduringlevelstreaming)
- [\_\_tid\_Actor\_\_](ue_ue.TestBaseCls.md#__tid_actor__)
- [\_\_tid\_Object\_\_](ue_ue.TestBaseCls.md#__tid_object__)
- [\_\_tid\_TestBaseCls\_\_](ue_ue.TestBaseCls.md#__tid_testbasecls__)
- [bActorEnableCollision](ue_ue.TestBaseCls.md#bactorenablecollision)
- [bActorIsBeingDestroyed](ue_ue.TestBaseCls.md#bactorisbeingdestroyed)
- [bActorLabelEditable](ue_ue.TestBaseCls.md#bactorlabeleditable)
- [bActorSeamlessTraveled](ue_ue.TestBaseCls.md#bactorseamlesstraveled)
- [bAllowReceiveTickEventOnDedicatedServer](ue_ue.TestBaseCls.md#ballowreceivetickeventondedicatedserver)
- [bAllowTickBeforeBeginPlay](ue_ue.TestBaseCls.md#ballowtickbeforebeginplay)
- [bAlwaysRelevant](ue_ue.TestBaseCls.md#balwaysrelevant)
- [bAutoDestroyWhenFinished](ue_ue.TestBaseCls.md#bautodestroywhenfinished)
- [bBlockInput](ue_ue.TestBaseCls.md#bblockinput)
- [bCanBeDamaged](ue_ue.TestBaseCls.md#bcanbedamaged)
- [bCanBeInCluster](ue_ue.TestBaseCls.md#bcanbeincluster)
- [bCollideWhenPlacing](ue_ue.TestBaseCls.md#bcollidewhenplacing)
- [bEditable](ue_ue.TestBaseCls.md#beditable)
- [bEnableAutoLODGeneration](ue_ue.TestBaseCls.md#benableautolodgeneration)
- [bExchangedRoles](ue_ue.TestBaseCls.md#bexchangedroles)
- [bFindCameraComponentWhenViewTarget](ue_ue.TestBaseCls.md#bfindcameracomponentwhenviewtarget)
- [bGenerateOverlapEventsDuringLevelStreaming](ue_ue.TestBaseCls.md#bgenerateoverlapeventsduringlevelstreaming)
- [bHidden](ue_ue.TestBaseCls.md#bhidden)
- [bHiddenEd](ue_ue.TestBaseCls.md#bhiddened)
- [bHiddenEdLayer](ue_ue.TestBaseCls.md#bhiddenedlayer)
- [bHiddenEdLevel](ue_ue.TestBaseCls.md#bhiddenedlevel)
- [bHiddenEdTemporary](ue_ue.TestBaseCls.md#bhiddenedtemporary)
- [bIgnoresOriginShifting](ue_ue.TestBaseCls.md#bignoresoriginshifting)
- [bIsEditorOnlyActor](ue_ue.TestBaseCls.md#biseditoronlyactor)
- [bIsEditorPreviewActor](ue_ue.TestBaseCls.md#biseditorpreviewactor)
- [bListedInSceneOutliner](ue_ue.TestBaseCls.md#blistedinsceneoutliner)
- [bLockLocation](ue_ue.TestBaseCls.md#blocklocation)
- [bNetLoadOnClient](ue_ue.TestBaseCls.md#bnetloadonclient)
- [bNetStartup](ue_ue.TestBaseCls.md#bnetstartup)
- [bNetTemporary](ue_ue.TestBaseCls.md#bnettemporary)
- [bNetUseOwnerRelevancy](ue_ue.TestBaseCls.md#bnetuseownerrelevancy)
- [bOnlyRelevantToOwner](ue_ue.TestBaseCls.md#bonlyrelevanttoowner)
- [bOptimizeBPComponentData](ue_ue.TestBaseCls.md#boptimizebpcomponentdata)
- [bRelevantForLevelBounds](ue_ue.TestBaseCls.md#brelevantforlevelbounds)
- [bRelevantForNetworkReplays](ue_ue.TestBaseCls.md#brelevantfornetworkreplays)
- [bReplayRewindable](ue_ue.TestBaseCls.md#breplayrewindable)
- [bReplicateMovement](ue_ue.TestBaseCls.md#breplicatemovement)
- [bReplicates](ue_ue.TestBaseCls.md#breplicates)
- [bTearOff](ue_ue.TestBaseCls.md#btearoff)

### Methods

- [ActorHasTag](ue_ue.TestBaseCls.md#actorhastag)
- [AddComponent](ue_ue.TestBaseCls.md#addcomponent)
- [AddTickPrerequisiteActor](ue_ue.TestBaseCls.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.TestBaseCls.md#addtickprerequisitecomponent)
- [CreateDefaultSubobject](ue_ue.TestBaseCls.md#createdefaultsubobject)
- [DetachRootComponentFromParent](ue_ue.TestBaseCls.md#detachrootcomponentfromparent)
- [DisableInput](ue_ue.TestBaseCls.md#disableinput)
- [EnableInput](ue_ue.TestBaseCls.md#enableinput)
- [Event1](ue_ue.TestBaseCls.md#event1)
- [ExecuteUbergraph](ue_ue.TestBaseCls.md#executeubergraph)
- [FlushNetDormancy](ue_ue.TestBaseCls.md#flushnetdormancy)
- [ForceNetUpdate](ue_ue.TestBaseCls.md#forcenetupdate)
- [GetActorBounds](ue_ue.TestBaseCls.md#getactorbounds)
- [GetActorEnableCollision](ue_ue.TestBaseCls.md#getactorenablecollision)
- [GetActorEyesViewPoint](ue_ue.TestBaseCls.md#getactoreyesviewpoint)
- [GetActorForwardVector](ue_ue.TestBaseCls.md#getactorforwardvector)
- [GetActorLabel](ue_ue.TestBaseCls.md#getactorlabel)
- [GetActorRelativeScale3D](ue_ue.TestBaseCls.md#getactorrelativescale3d)
- [GetActorRightVector](ue_ue.TestBaseCls.md#getactorrightvector)
- [GetActorScale3D](ue_ue.TestBaseCls.md#getactorscale3d)
- [GetActorTickInterval](ue_ue.TestBaseCls.md#getactortickinterval)
- [GetActorTimeDilation](ue_ue.TestBaseCls.md#getactortimedilation)
- [GetActorUpVector](ue_ue.TestBaseCls.md#getactorupvector)
- [GetAllChildActors](ue_ue.TestBaseCls.md#getallchildactors)
- [GetAttachParentActor](ue_ue.TestBaseCls.md#getattachparentactor)
- [GetAttachParentSocketName](ue_ue.TestBaseCls.md#getattachparentsocketname)
- [GetAttachedActors](ue_ue.TestBaseCls.md#getattachedactors)
- [GetClass](ue_ue.TestBaseCls.md#getclass)
- [GetComponentByClass](ue_ue.TestBaseCls.md#getcomponentbyclass)
- [GetComponentsByInterface](ue_ue.TestBaseCls.md#getcomponentsbyinterface)
- [GetComponentsByTag](ue_ue.TestBaseCls.md#getcomponentsbytag)
- [GetDistanceTo](ue_ue.TestBaseCls.md#getdistanceto)
- [GetDotProductTo](ue_ue.TestBaseCls.md#getdotproductto)
- [GetFolderPath](ue_ue.TestBaseCls.md#getfolderpath)
- [GetGameTimeSinceCreation](ue_ue.TestBaseCls.md#getgametimesincecreation)
- [GetHorizontalDistanceTo](ue_ue.TestBaseCls.md#gethorizontaldistanceto)
- [GetHorizontalDotProductTo](ue_ue.TestBaseCls.md#gethorizontaldotproductto)
- [GetInputAxisKeyValue](ue_ue.TestBaseCls.md#getinputaxiskeyvalue)
- [GetInputAxisValue](ue_ue.TestBaseCls.md#getinputaxisvalue)
- [GetInputVectorAxisValue](ue_ue.TestBaseCls.md#getinputvectoraxisvalue)
- [GetInstigator](ue_ue.TestBaseCls.md#getinstigator)
- [GetInstigatorController](ue_ue.TestBaseCls.md#getinstigatorcontroller)
- [GetLifeSpan](ue_ue.TestBaseCls.md#getlifespan)
- [GetLocalRole](ue_ue.TestBaseCls.md#getlocalrole)
- [GetName](ue_ue.TestBaseCls.md#getname)
- [GetOuter](ue_ue.TestBaseCls.md#getouter)
- [GetOverlappingActors](ue_ue.TestBaseCls.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue.TestBaseCls.md#getoverlappingcomponents)
- [GetOwner](ue_ue.TestBaseCls.md#getowner)
- [GetParentActor](ue_ue.TestBaseCls.md#getparentactor)
- [GetParentComponent](ue_ue.TestBaseCls.md#getparentcomponent)
- [GetRemoteRole](ue_ue.TestBaseCls.md#getremoterole)
- [GetSquaredDistanceTo](ue_ue.TestBaseCls.md#getsquareddistanceto)
- [GetTickableWhenPaused](ue_ue.TestBaseCls.md#gettickablewhenpaused)
- [GetTransform](ue_ue.TestBaseCls.md#gettransform)
- [GetVelocity](ue_ue.TestBaseCls.md#getvelocity)
- [GetVerticalDistanceTo](ue_ue.TestBaseCls.md#getverticaldistanceto)
- [GetWorld](ue_ue.TestBaseCls.md#getworld)
- [HasAuthority](ue_ue.TestBaseCls.md#hasauthority)
- [IsActorBeingDestroyed](ue_ue.TestBaseCls.md#isactorbeingdestroyed)
- [IsActorTickEnabled](ue_ue.TestBaseCls.md#isactortickenabled)
- [IsChildActor](ue_ue.TestBaseCls.md#ischildactor)
- [IsEditable](ue_ue.TestBaseCls.md#iseditable)
- [IsHiddenEd](ue_ue.TestBaseCls.md#ishiddened)
- [IsHiddenEdAtStartup](ue_ue.TestBaseCls.md#ishiddenedatstartup)
- [IsOverlappingActor](ue_ue.TestBaseCls.md#isoverlappingactor)
- [IsSelectable](ue_ue.TestBaseCls.md#isselectable)
- [IsTemporarilyHiddenInEditor](ue_ue.TestBaseCls.md#istemporarilyhiddenineditor)
- [K2\_AddActorLocalOffset](ue_ue.TestBaseCls.md#k2_addactorlocaloffset)
- [K2\_AddActorLocalRotation](ue_ue.TestBaseCls.md#k2_addactorlocalrotation)
- [K2\_AddActorLocalTransform](ue_ue.TestBaseCls.md#k2_addactorlocaltransform)
- [K2\_AddActorWorldOffset](ue_ue.TestBaseCls.md#k2_addactorworldoffset)
- [K2\_AddActorWorldRotation](ue_ue.TestBaseCls.md#k2_addactorworldrotation)
- [K2\_AddActorWorldTransform](ue_ue.TestBaseCls.md#k2_addactorworldtransform)
- [K2\_AttachRootComponentTo](ue_ue.TestBaseCls.md#k2_attachrootcomponentto)
- [K2\_AttachRootComponentToActor](ue_ue.TestBaseCls.md#k2_attachrootcomponenttoactor)
- [K2\_AttachToActor](ue_ue.TestBaseCls.md#k2_attachtoactor)
- [K2\_AttachToComponent](ue_ue.TestBaseCls.md#k2_attachtocomponent)
- [K2\_DestroyActor](ue_ue.TestBaseCls.md#k2_destroyactor)
- [K2\_DestroyComponent](ue_ue.TestBaseCls.md#k2_destroycomponent)
- [K2\_DetachFromActor](ue_ue.TestBaseCls.md#k2_detachfromactor)
- [K2\_GetActorLocation](ue_ue.TestBaseCls.md#k2_getactorlocation)
- [K2\_GetActorRotation](ue_ue.TestBaseCls.md#k2_getactorrotation)
- [K2\_GetComponentsByClass](ue_ue.TestBaseCls.md#k2_getcomponentsbyclass)
- [K2\_GetRootComponent](ue_ue.TestBaseCls.md#k2_getrootcomponent)
- [K2\_OnBecomeViewTarget](ue_ue.TestBaseCls.md#k2_onbecomeviewtarget)
- [K2\_OnEndViewTarget](ue_ue.TestBaseCls.md#k2_onendviewtarget)
- [K2\_OnReset](ue_ue.TestBaseCls.md#k2_onreset)
- [K2\_SetActorLocation](ue_ue.TestBaseCls.md#k2_setactorlocation)
- [K2\_SetActorLocationAndRotation](ue_ue.TestBaseCls.md#k2_setactorlocationandrotation)
- [K2\_SetActorRelativeLocation](ue_ue.TestBaseCls.md#k2_setactorrelativelocation)
- [K2\_SetActorRelativeRotation](ue_ue.TestBaseCls.md#k2_setactorrelativerotation)
- [K2\_SetActorRelativeTransform](ue_ue.TestBaseCls.md#k2_setactorrelativetransform)
- [K2\_SetActorRotation](ue_ue.TestBaseCls.md#k2_setactorrotation)
- [K2\_SetActorTransform](ue_ue.TestBaseCls.md#k2_setactortransform)
- [K2\_TeleportTo](ue_ue.TestBaseCls.md#k2_teleportto)
- [MakeMIDForMaterial](ue_ue.TestBaseCls.md#makemidformaterial)
- [MakeNoise](ue_ue.TestBaseCls.md#makenoise)
- [OnEvent1](ue_ue.TestBaseCls.md#onevent1)
- [OnRep\_AttachmentReplication](ue_ue.TestBaseCls.md#onrep_attachmentreplication)
- [OnRep\_Instigator](ue_ue.TestBaseCls.md#onrep_instigator)
- [OnRep\_Owner](ue_ue.TestBaseCls.md#onrep_owner)
- [OnRep\_ReplicateMovement](ue_ue.TestBaseCls.md#onrep_replicatemovement)
- [OnRep\_ReplicatedMovement](ue_ue.TestBaseCls.md#onrep_replicatedmovement)
- [PrestreamTextures](ue_ue.TestBaseCls.md#prestreamtextures)
- [ReceiveActorBeginCursorOver](ue_ue.TestBaseCls.md#receiveactorbegincursorover)
- [ReceiveActorBeginOverlap](ue_ue.TestBaseCls.md#receiveactorbeginoverlap)
- [ReceiveActorEndCursorOver](ue_ue.TestBaseCls.md#receiveactorendcursorover)
- [ReceiveActorEndOverlap](ue_ue.TestBaseCls.md#receiveactorendoverlap)
- [ReceiveActorOnClicked](ue_ue.TestBaseCls.md#receiveactoronclicked)
- [ReceiveActorOnInputTouchBegin](ue_ue.TestBaseCls.md#receiveactoroninputtouchbegin)
- [ReceiveActorOnInputTouchEnd](ue_ue.TestBaseCls.md#receiveactoroninputtouchend)
- [ReceiveActorOnInputTouchEnter](ue_ue.TestBaseCls.md#receiveactoroninputtouchenter)
- [ReceiveActorOnInputTouchLeave](ue_ue.TestBaseCls.md#receiveactoroninputtouchleave)
- [ReceiveActorOnReleased](ue_ue.TestBaseCls.md#receiveactoronreleased)
- [ReceiveAnyDamage](ue_ue.TestBaseCls.md#receiveanydamage)
- [ReceiveBeginPlay](ue_ue.TestBaseCls.md#receivebeginplay)
- [ReceiveDestroyed](ue_ue.TestBaseCls.md#receivedestroyed)
- [ReceiveEndPlay](ue_ue.TestBaseCls.md#receiveendplay)
- [ReceiveHit](ue_ue.TestBaseCls.md#receivehit)
- [ReceivePointDamage](ue_ue.TestBaseCls.md#receivepointdamage)
- [ReceiveRadialDamage](ue_ue.TestBaseCls.md#receiveradialdamage)
- [ReceiveTick](ue_ue.TestBaseCls.md#receivetick)
- [RemoveTickPrerequisiteActor](ue_ue.TestBaseCls.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.TestBaseCls.md#removetickprerequisitecomponent)
- [SetActorEnableCollision](ue_ue.TestBaseCls.md#setactorenablecollision)
- [SetActorHiddenInGame](ue_ue.TestBaseCls.md#setactorhiddeningame)
- [SetActorLabel](ue_ue.TestBaseCls.md#setactorlabel)
- [SetActorRelativeScale3D](ue_ue.TestBaseCls.md#setactorrelativescale3d)
- [SetActorScale3D](ue_ue.TestBaseCls.md#setactorscale3d)
- [SetActorTickEnabled](ue_ue.TestBaseCls.md#setactortickenabled)
- [SetActorTickInterval](ue_ue.TestBaseCls.md#setactortickinterval)
- [SetFolderPath](ue_ue.TestBaseCls.md#setfolderpath)
- [SetIsTemporarilyHiddenInEditor](ue_ue.TestBaseCls.md#setistemporarilyhiddenineditor)
- [SetLifeSpan](ue_ue.TestBaseCls.md#setlifespan)
- [SetNetDormancy](ue_ue.TestBaseCls.md#setnetdormancy)
- [SetOwner](ue_ue.TestBaseCls.md#setowner)
- [SetReplicateMovement](ue_ue.TestBaseCls.md#setreplicatemovement)
- [SetReplicates](ue_ue.TestBaseCls.md#setreplicates)
- [SetTickGroup](ue_ue.TestBaseCls.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.TestBaseCls.md#settickablewhenpaused)
- [SnapRootComponentTo](ue_ue.TestBaseCls.md#snaprootcomponentto)
- [TearOff](ue_ue.TestBaseCls.md#tearoff)
- [UserConstructionScript](ue_ue.TestBaseCls.md#userconstructionscript)
- [WasRecentlyRendered](ue_ue.TestBaseCls.md#wasrecentlyrendered)
- [Find](ue_ue.TestBaseCls.md#find)
- [Load](ue_ue.TestBaseCls.md#load)
- [StaticClass](ue_ue.TestBaseCls.md#staticclass)

## Constructors

### constructor

• **new TestBaseCls**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:62826](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62826)
...
### \_\_tid\_TestBaseCls\_\_

• **\_\_tid\_TestBaseCls\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:62833](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62833)
...
[ue/ue.d.ts:62827](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62827)
...
[ue/ue.d.ts:62828](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62828)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TestBaseCls`](ue_ue.TestBaseCls.md)
...
[ue/ue.d.ts:62830](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62830)

___

### Load

▸ `Static` **Load**(`InName`): [`TestBaseCls`](ue_ue.TestBaseCls.md)
...
[ue/ue.d.ts:62831](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62831)
...
[ue/ue.d.ts:62829](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L62829)
