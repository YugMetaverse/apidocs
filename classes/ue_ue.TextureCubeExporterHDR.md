[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TextureCubeExporterHDR

# Class: TextureCubeExporterHDR

[ue/ue](../modules/ue_ue.md).TextureCubeExporterHDR
...
- [constructor](ue_ue.TextureCubeExporterHDR.md#constructor)

### Properties

- [ExportRootScope](ue_ue.TextureCubeExporterHDR.md#exportrootscope)
- [ExportTask](ue_ue.TextureCubeExporterHDR.md#exporttask)
- [FormatDescription](ue_ue.TextureCubeExporterHDR.md#formatdescription)
- [FormatExtension](ue_ue.TextureCubeExporterHDR.md#formatextension)
- [PreferredFormatIndex](ue_ue.TextureCubeExporterHDR.md#preferredformatindex)
- [SupportedClass](ue_ue.TextureCubeExporterHDR.md#supportedclass)
- [TextIndent](ue_ue.TextureCubeExporterHDR.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.TextureCubeExporterHDR.md#__tid_exporter__)
- [\_\_tid\_Object\_\_](ue_ue.TextureCubeExporterHDR.md#__tid_object__)
- [\_\_tid\_TextureCubeExporterHDR\_\_](ue_ue.TextureCubeExporterHDR.md#__tid_texturecubeexporterhdr__)
- [bForceFileOperations](ue_ue.TextureCubeExporterHDR.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.TextureCubeExporterHDR.md#bselectedonly)
- [bText](ue_ue.TextureCubeExporterHDR.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.TextureCubeExporterHDR.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.TextureCubeExporterHDR.md#executeubergraph)
- [GetClass](ue_ue.TextureCubeExporterHDR.md#getclass)
- [GetName](ue_ue.TextureCubeExporterHDR.md#getname)
- [GetOuter](ue_ue.TextureCubeExporterHDR.md#getouter)
- [GetWorld](ue_ue.TextureCubeExporterHDR.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.TextureCubeExporterHDR.md#scriptrunassetexporttask)
- [Find](ue_ue.TextureCubeExporterHDR.md#find)
- [Load](ue_ue.TextureCubeExporterHDR.md#load)
- [RunAssetExportTask](ue_ue.TextureCubeExporterHDR.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.TextureCubeExporterHDR.md#runassetexporttasks)
- [StaticClass](ue_ue.TextureCubeExporterHDR.md#staticclass)

## Constructors

### constructor

• **new TextureCubeExporterHDR**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:63219](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63219)
...
### \_\_tid\_TextureCubeExporterHDR\_\_

• **\_\_tid\_TextureCubeExporterHDR\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:63224](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63224)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TextureCubeExporterHDR`](ue_ue.TextureCubeExporterHDR.md)
...
[ue/ue.d.ts:63221](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63221)

___

### Load

▸ `Static` **Load**(`InName`): [`TextureCubeExporterHDR`](ue_ue.TextureCubeExporterHDR.md)
...
[ue/ue.d.ts:63222](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63222)
...
[ue/ue.d.ts:63220](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63220)
