[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TextureExporterBMP

# Class: TextureExporterBMP

[ue/ue](../modules/ue_ue.md).TextureExporterBMP
...
- [constructor](ue_ue.TextureExporterBMP.md#constructor)

### Properties

- [ExportRootScope](ue_ue.TextureExporterBMP.md#exportrootscope)
- [ExportTask](ue_ue.TextureExporterBMP.md#exporttask)
- [FormatDescription](ue_ue.TextureExporterBMP.md#formatdescription)
- [FormatExtension](ue_ue.TextureExporterBMP.md#formatextension)
- [PreferredFormatIndex](ue_ue.TextureExporterBMP.md#preferredformatindex)
- [SupportedClass](ue_ue.TextureExporterBMP.md#supportedclass)
- [TextIndent](ue_ue.TextureExporterBMP.md#textindent)
- [\_\_tid\_Exporter\_\_](ue_ue.TextureExporterBMP.md#__tid_exporter__)
- [\_\_tid\_Object\_\_](ue_ue.TextureExporterBMP.md#__tid_object__)
- [\_\_tid\_TextureExporterBMP\_\_](ue_ue.TextureExporterBMP.md#__tid_textureexporterbmp__)
- [bForceFileOperations](ue_ue.TextureExporterBMP.md#bforcefileoperations)
- [bSelectedOnly](ue_ue.TextureExporterBMP.md#bselectedonly)
- [bText](ue_ue.TextureExporterBMP.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.TextureExporterBMP.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.TextureExporterBMP.md#executeubergraph)
- [GetClass](ue_ue.TextureExporterBMP.md#getclass)
- [GetName](ue_ue.TextureExporterBMP.md#getname)
- [GetOuter](ue_ue.TextureExporterBMP.md#getouter)
- [GetWorld](ue_ue.TextureExporterBMP.md#getworld)
- [ScriptRunAssetExportTask](ue_ue.TextureExporterBMP.md#scriptrunassetexporttask)
- [Find](ue_ue.TextureExporterBMP.md#find)
- [Load](ue_ue.TextureExporterBMP.md#load)
- [RunAssetExportTask](ue_ue.TextureExporterBMP.md#runassetexporttask)
- [RunAssetExportTasks](ue_ue.TextureExporterBMP.md#runassetexporttasks)
- [StaticClass](ue_ue.TextureExporterBMP.md#staticclass)

## Constructors

### constructor

• **new TextureExporterBMP**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:63237](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L63237)
...
### \_\_tid\_TextureExporterBMP\_\_

• **\_\_tid\_TextureExporterBMP\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:63242](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L63242)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TextureExporterBMP`](ue_ue.TextureExporterBMP.md)
...
[ue/ue.d.ts:63239](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L63239)

___

### Load

▸ `Static` **Load**(`InName`): [`TextureExporterBMP`](ue_ue.TextureExporterBMP.md)
...
[ue/ue.d.ts:63240](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L63240)
...
[ue/ue.d.ts:63238](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L63238)
