[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TileMapActorFactory

# Class: TileMapActorFactory

[ue/ue](../modules/ue_ue.md).TileMapActorFactory
...
- [constructor](ue_ue.TileMapActorFactory.md#constructor)

### Properties

- [DisplayName](ue_ue.TileMapActorFactory.md#displayname)
- [MenuPriority](ue_ue.TileMapActorFactory.md#menupriority)
- [NewActorClass](ue_ue.TileMapActorFactory.md#newactorclass)
- [NewActorClassName](ue_ue.TileMapActorFactory.md#newactorclassname)
- [SpawnPositionOffset](ue_ue.TileMapActorFactory.md#spawnpositionoffset)
- [\_\_tid\_ActorFactory\_\_](ue_ue.TileMapActorFactory.md#__tid_actorfactory__)
- [\_\_tid\_Object\_\_](ue_ue.TileMapActorFactory.md#__tid_object__)
- [\_\_tid\_TileMapActorFactory\_\_](ue_ue.TileMapActorFactory.md#__tid_tilemapactorfactory__)
- [bShowInEditorQuickMenu](ue_ue.TileMapActorFactory.md#bshowineditorquickmenu)
- [bUseSurfaceOrientation](ue_ue.TileMapActorFactory.md#busesurfaceorientation)

### Methods

- [CreateDefaultSubobject](ue_ue.TileMapActorFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.TileMapActorFactory.md#executeubergraph)
- [GetClass](ue_ue.TileMapActorFactory.md#getclass)
- [GetName](ue_ue.TileMapActorFactory.md#getname)
- [GetOuter](ue_ue.TileMapActorFactory.md#getouter)
- [GetWorld](ue_ue.TileMapActorFactory.md#getworld)
- [Find](ue_ue.TileMapActorFactory.md#find)
- [Load](ue_ue.TileMapActorFactory.md#load)
- [StaticClass](ue_ue.TileMapActorFactory.md#staticclass)

## Constructors

### constructor

• **new TileMapActorFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:63434](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63434)
...
### \_\_tid\_TileMapActorFactory\_\_

• **\_\_tid\_TileMapActorFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:63439](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63439)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TileMapActorFactory`](ue_ue.TileMapActorFactory.md)
...
[ue/ue.d.ts:63436](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63436)

___

### Load

▸ `Static` **Load**(`InName`): [`TileMapActorFactory`](ue_ue.TileMapActorFactory.md)
...
[ue/ue.d.ts:63437](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63437)
...
[ue/ue.d.ts:63435](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L63435)
