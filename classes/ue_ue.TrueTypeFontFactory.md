[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TrueTypeFontFactory
...
▸ `Static` **Load**(`InName`): [`TrueTypeFontFactory`](ue_ue.TrueTypeFontFactory.md)
