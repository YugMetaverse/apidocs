[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / TypeScriptBlueprint

# Class: TypeScriptBlueprint

[ue/ue](../modules/ue_ue.md).TypeScriptBlueprint
...
- [constructor](ue_ue.TypeScriptBlueprint.md#constructor)

### Properties

- [BlueprintCategory](ue_ue.TypeScriptBlueprint.md#blueprintcategory)
- [BlueprintDescription](ue_ue.TypeScriptBlueprint.md#blueprintdescription)
- [BlueprintDisplayName](ue_ue.TypeScriptBlueprint.md#blueprintdisplayname)
- [BlueprintGuid](ue_ue.TypeScriptBlueprint.md#blueprintguid)
- [BlueprintSystemVersion](ue_ue.TypeScriptBlueprint.md#blueprintsystemversion)
- [BlueprintType](ue_ue.TypeScriptBlueprint.md#blueprinttype)
- [BookmarkNodes](ue_ue.TypeScriptBlueprint.md#bookmarknodes)
- [Bookmarks](ue_ue.TypeScriptBlueprint.md#bookmarks)
- [Breakpoints](ue_ue.TypeScriptBlueprint.md#breakpoints)
- [CategorySorting](ue_ue.TypeScriptBlueprint.md#categorysorting)
- [CompileMode](ue_ue.TypeScriptBlueprint.md#compilemode)
- [ComponentClassOverrides](ue_ue.TypeScriptBlueprint.md#componentclassoverrides)
- [ComponentTemplateNameIndex](ue_ue.TypeScriptBlueprint.md#componenttemplatenameindex)
- [ComponentTemplates](ue_ue.TypeScriptBlueprint.md#componenttemplates)
- [CrcLastCompiledCDO](ue_ue.TypeScriptBlueprint.md#crclastcompiledcdo)
- [CrcLastCompiledSignature](ue_ue.TypeScriptBlueprint.md#crclastcompiledsignature)
- [DelegateSignatureGraphs](ue_ue.TypeScriptBlueprint.md#delegatesignaturegraphs)
- [DeprecatedPinWatches](ue_ue.TypeScriptBlueprint.md#deprecatedpinwatches)
- [EventGraphs](ue_ue.TypeScriptBlueprint.md#eventgraphs)
- [Extensions](ue_ue.TypeScriptBlueprint.md#extensions)
- [FunctionGraphs](ue_ue.TypeScriptBlueprint.md#functiongraphs)
- [GeneratedClass](ue_ue.TypeScriptBlueprint.md#generatedclass)
- [HideCategories](ue_ue.TypeScriptBlueprint.md#hidecategories)
- [ImplementedInterfaces](ue_ue.TypeScriptBlueprint.md#implementedinterfaces)
- [InheritableComponentHandler](ue_ue.TypeScriptBlueprint.md#inheritablecomponenthandler)
- [IntermediateGeneratedGraphs](ue_ue.TypeScriptBlueprint.md#intermediategeneratedgraphs)
- [LastEditedDocuments](ue_ue.TypeScriptBlueprint.md#lastediteddocuments)
- [MacroGraphs](ue_ue.TypeScriptBlueprint.md#macrographs)
- [NativizationFlag](ue_ue.TypeScriptBlueprint.md#nativizationflag)
- [NewVariables](ue_ue.TypeScriptBlueprint.md#newvariables)
- [OldToNewComponentTemplateNames](ue_ue.TypeScriptBlueprint.md#oldtonewcomponenttemplatenames)
- [OriginalClass](ue_ue.TypeScriptBlueprint.md#originalclass)
- [PRIVATE\_CachedMacroInfo](ue_ue.TypeScriptBlueprint.md#private_cachedmacroinfo)
- [ParentClass](ue_ue.TypeScriptBlueprint.md#parentclass)
- [SearchGuid](ue_ue.TypeScriptBlueprint.md#searchguid)
- [SimpleConstructionScript](ue_ue.TypeScriptBlueprint.md#simpleconstructionscript)
- [SkeletonGeneratedClass](ue_ue.TypeScriptBlueprint.md#skeletongeneratedclass)
- [Status](ue_ue.TypeScriptBlueprint.md#status)
- [ThumbnailInfo](ue_ue.TypeScriptBlueprint.md#thumbnailinfo)
- [Timelines](ue_ue.TypeScriptBlueprint.md#timelines)
- [UbergraphPages](ue_ue.TypeScriptBlueprint.md#ubergraphpages)
- [WatchedPins](ue_ue.TypeScriptBlueprint.md#watchedpins)
- [\_\_tid\_BlueprintCore\_\_](ue_ue.TypeScriptBlueprint.md#__tid_blueprintcore__)
- [\_\_tid\_Blueprint\_\_](ue_ue.TypeScriptBlueprint.md#__tid_blueprint__)
- [\_\_tid\_Object\_\_](ue_ue.TypeScriptBlueprint.md#__tid_object__)
- [\_\_tid\_TypeScriptBlueprint\_\_](ue_ue.TypeScriptBlueprint.md#__tid_typescriptblueprint__)
- [bBeingCompiled](ue_ue.TypeScriptBlueprint.md#bbeingcompiled)
- [bDeprecate](ue_ue.TypeScriptBlueprint.md#bdeprecate)
- [bDisplayCompilePIEWarning](ue_ue.TypeScriptBlueprint.md#bdisplaycompilepiewarning)
- [bDuplicatingReadOnly](ue_ue.TypeScriptBlueprint.md#bduplicatingreadonly)
- [bForceFullEditor](ue_ue.TypeScriptBlueprint.md#bforcefulleditor)
- [bGenerateAbstractClass](ue_ue.TypeScriptBlueprint.md#bgenerateabstractclass)
- [bGenerateConstClass](ue_ue.TypeScriptBlueprint.md#bgenerateconstclass)
- [bHasBeenRegenerated](ue_ue.TypeScriptBlueprint.md#bhasbeenregenerated)
- [bIsNewlyCreated](ue_ue.TypeScriptBlueprint.md#bisnewlycreated)
- [bIsRegeneratingOnLoad](ue_ue.TypeScriptBlueprint.md#bisregeneratingonload)
- [bLegacyNeedToPurgeSkelRefs](ue_ue.TypeScriptBlueprint.md#blegacyneedtopurgeskelrefs)
- [bNativize](ue_ue.TypeScriptBlueprint.md#bnativize)
- [bQueuedForCompilation](ue_ue.TypeScriptBlueprint.md#bqueuedforcompilation)
- [bRecompileOnLoad](ue_ue.TypeScriptBlueprint.md#brecompileonload)
- [bRunConstructionScriptInSequencer](ue_ue.TypeScriptBlueprint.md#brunconstructionscriptinsequencer)
- [bRunConstructionScriptOnDrag](ue_ue.TypeScriptBlueprint.md#brunconstructionscriptondrag)

### Methods

- [CreateDefaultSubobject](ue_ue.TypeScriptBlueprint.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.TypeScriptBlueprint.md#executeubergraph)
- [GetClass](ue_ue.TypeScriptBlueprint.md#getclass)
- [GetName](ue_ue.TypeScriptBlueprint.md#getname)
- [GetOuter](ue_ue.TypeScriptBlueprint.md#getouter)
- [GetWorld](ue_ue.TypeScriptBlueprint.md#getworld)
- [Find](ue_ue.TypeScriptBlueprint.md#find)
- [Load](ue_ue.TypeScriptBlueprint.md#load)
- [StaticClass](ue_ue.TypeScriptBlueprint.md#staticclass)

## Constructors

### constructor

• **new TypeScriptBlueprint**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:64344](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L64344)
...
### \_\_tid\_TypeScriptBlueprint\_\_

• **\_\_tid\_TypeScriptBlueprint\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:64349](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L64349)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TypeScriptBlueprint`](ue_ue.TypeScriptBlueprint.md)
...
[ue/ue.d.ts:64346](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L64346)

___

### Load

▸ `Static` **Load**(`InName`): [`TypeScriptBlueprint`](ue_ue.TypeScriptBlueprint.md)
...
[ue/ue.d.ts:64347](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L64347)
...
[ue/ue.d.ts:64345](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L64345)
