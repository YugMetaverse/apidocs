[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / UniformScalar

# Class: UniformScalar

[ue/ue](../modules/ue_ue.md).UniformScalar
...
- [constructor](ue_ue.UniformScalar.md#constructor)

### Properties

- [AssetUserData](ue_ue.UniformScalar.md#assetuserdata)
- [ComponentTags](ue_ue.UniformScalar.md#componenttags)
- [CreationMethod](ue_ue.UniformScalar.md#creationmethod)
- [Magnitude](ue_ue.UniformScalar.md#magnitude)
- [OnComponentActivated](ue_ue.UniformScalar.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue.UniformScalar.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue.UniformScalar.md#primarycomponenttick)
- [UCSModifiedProperties](ue_ue.UniformScalar.md#ucsmodifiedproperties)
- [\_\_tid\_ActorComponent\_\_](ue_ue.UniformScalar.md#__tid_actorcomponent__)
- [\_\_tid\_FieldNodeBase\_\_](ue_ue.UniformScalar.md#__tid_fieldnodebase__)
- [\_\_tid\_FieldNodeFloat\_\_](ue_ue.UniformScalar.md#__tid_fieldnodefloat__)
- [\_\_tid\_Object\_\_](ue_ue.UniformScalar.md#__tid_object__)
- [\_\_tid\_UniformScalar\_\_](ue_ue.UniformScalar.md#__tid_uniformscalar__)
- [bAutoActivate](ue_ue.UniformScalar.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue.UniformScalar.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue.UniformScalar.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue.UniformScalar.md#beditablewheninherited)
- [bInstanceComponent](ue_ue.UniformScalar.md#binstancecomponent)
- [bIsActive](ue_ue.UniformScalar.md#bisactive)
- [bIsEditorOnly](ue_ue.UniformScalar.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue.UniformScalar.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue.UniformScalar.md#bnetaddressable)
- [bReplicates](ue_ue.UniformScalar.md#breplicates)

### Methods

- [Activate](ue_ue.UniformScalar.md#activate)
- [AddTickPrerequisiteActor](ue_ue.UniformScalar.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.UniformScalar.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue.UniformScalar.md#componenthastag)
- [CreateDefaultSubobject](ue_ue.UniformScalar.md#createdefaultsubobject)
- [Deactivate](ue_ue.UniformScalar.md#deactivate)
- [ExecuteUbergraph](ue_ue.UniformScalar.md#executeubergraph)
- [GetClass](ue_ue.UniformScalar.md#getclass)
- [GetComponentTickInterval](ue_ue.UniformScalar.md#getcomponenttickinterval)
- [GetName](ue_ue.UniformScalar.md#getname)
- [GetOuter](ue_ue.UniformScalar.md#getouter)
- [GetOwner](ue_ue.UniformScalar.md#getowner)
- [GetWorld](ue_ue.UniformScalar.md#getworld)
- [IsActive](ue_ue.UniformScalar.md#isactive)
- [IsBeingDestroyed](ue_ue.UniformScalar.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue.UniformScalar.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue.UniformScalar.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue.UniformScalar.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue.UniformScalar.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue.UniformScalar.md#receiveendplay)
- [ReceiveTick](ue_ue.UniformScalar.md#receivetick)
- [RegisterComponent](ue_ue.UniformScalar.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue.UniformScalar.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.UniformScalar.md#removetickprerequisitecomponent)
- [SetActive](ue_ue.UniformScalar.md#setactive)
- [SetAutoActivate](ue_ue.UniformScalar.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue.UniformScalar.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue.UniformScalar.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue.UniformScalar.md#setisreplicated)
- [SetTickGroup](ue_ue.UniformScalar.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.UniformScalar.md#settickablewhenpaused)
- [SetUniformScalar](ue_ue.UniformScalar.md#setuniformscalar)
- [ToggleActive](ue_ue.UniformScalar.md#toggleactive)
- [Find](ue_ue.UniformScalar.md#find)
- [Load](ue_ue.UniformScalar.md#load)
- [StaticClass](ue_ue.UniformScalar.md#staticclass)

## Constructors

### constructor

• **new UniformScalar**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:64563](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64563)
...
[ue/ue.d.ts:64564](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64564)
...
### \_\_tid\_UniformScalar\_\_

• **\_\_tid\_UniformScalar\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:64570](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64570)
...
▸ **SetUniformScalar**(`Magnitude`): [`UniformScalar`](ue_ue.UniformScalar.md)
...
[`UniformScalar`](ue_ue.UniformScalar.md)

#### Defined in

[ue/ue.d.ts:64565](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64565)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`UniformScalar`](ue_ue.UniformScalar.md)
...
[ue/ue.d.ts:64567](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64567)

___

### Load

▸ `Static` **Load**(`InName`): [`UniformScalar`](ue_ue.UniformScalar.md)
...
[ue/ue.d.ts:64568](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64568)
...
[ue/ue.d.ts:64566](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L64566)
