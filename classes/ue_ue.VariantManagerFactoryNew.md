[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / VariantManagerFactoryNew

# Class: VariantManagerFactoryNew

[ue/ue](../modules/ue_ue.md).VariantManagerFactoryNew
...
- [constructor](ue_ue.VariantManagerFactoryNew.md#constructor)

### Properties

- [AssetImportTask](ue_ue.VariantManagerFactoryNew.md#assetimporttask)
- [AutomatedImportData](ue_ue.VariantManagerFactoryNew.md#automatedimportdata)
- [ContextClass](ue_ue.VariantManagerFactoryNew.md#contextclass)
- [Formats](ue_ue.VariantManagerFactoryNew.md#formats)
- [ImportPriority](ue_ue.VariantManagerFactoryNew.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.VariantManagerFactoryNew.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.VariantManagerFactoryNew.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.VariantManagerFactoryNew.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.VariantManagerFactoryNew.md#__tid_object__)
- [\_\_tid\_VariantManagerFactoryNew\_\_](ue_ue.VariantManagerFactoryNew.md#__tid_variantmanagerfactorynew__)
- [bCreateNew](ue_ue.VariantManagerFactoryNew.md#bcreatenew)
- [bEditAfterNew](ue_ue.VariantManagerFactoryNew.md#beditafternew)
- [bEditorImport](ue_ue.VariantManagerFactoryNew.md#beditorimport)
- [bText](ue_ue.VariantManagerFactoryNew.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.VariantManagerFactoryNew.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.VariantManagerFactoryNew.md#executeubergraph)
- [GetClass](ue_ue.VariantManagerFactoryNew.md#getclass)
- [GetName](ue_ue.VariantManagerFactoryNew.md#getname)
- [GetOuter](ue_ue.VariantManagerFactoryNew.md#getouter)
- [GetWorld](ue_ue.VariantManagerFactoryNew.md#getworld)
- [ScriptFactoryCanImport](ue_ue.VariantManagerFactoryNew.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.VariantManagerFactoryNew.md#scriptfactorycreatefile)
- [Find](ue_ue.VariantManagerFactoryNew.md#find)
- [Load](ue_ue.VariantManagerFactoryNew.md#load)
- [StaticClass](ue_ue.VariantManagerFactoryNew.md#staticclass)

## Constructors

### constructor

• **new VariantManagerFactoryNew**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:65019](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65019)
...
### \_\_tid\_VariantManagerFactoryNew\_\_

• **\_\_tid\_VariantManagerFactoryNew\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:65024](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65024)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`VariantManagerFactoryNew`](ue_ue.VariantManagerFactoryNew.md)
...
[ue/ue.d.ts:65021](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65021)

___

### Load

▸ `Static` **Load**(`InName`): [`VariantManagerFactoryNew`](ue_ue.VariantManagerFactoryNew.md)
...
[ue/ue.d.ts:65022](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65022)
...
[ue/ue.d.ts:65020](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65020)
