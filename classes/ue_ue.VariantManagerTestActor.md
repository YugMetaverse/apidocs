[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / VariantManagerTestActor

# Class: VariantManagerTestActor

[ue/ue](../modules/ue_ue.md).VariantManagerTestActor
...
- [constructor](ue_ue.VariantManagerTestActor.md#constructor)

### Properties

- [ActorLabel](ue_ue.VariantManagerTestActor.md#actorlabel)
- [AttachmentReplication](ue_ue.VariantManagerTestActor.md#attachmentreplication)
- [AutoReceiveInput](ue_ue.VariantManagerTestActor.md#autoreceiveinput)
- [BlueprintCreatedComponents](ue_ue.VariantManagerTestActor.md#blueprintcreatedcomponents)
- [CapturedByteProperty](ue_ue.VariantManagerTestActor.md#capturedbyteproperty)
- [CapturedColorProperty](ue_ue.VariantManagerTestActor.md#capturedcolorproperty)
- [CapturedFloatProperty](ue_ue.VariantManagerTestActor.md#capturedfloatproperty)
- [CapturedIntPointProperty](ue_ue.VariantManagerTestActor.md#capturedintpointproperty)
- [CapturedIntProperty](ue_ue.VariantManagerTestActor.md#capturedintproperty)
- [CapturedInterfaceProperty](ue_ue.VariantManagerTestActor.md#capturedinterfaceproperty)
- [CapturedLinearColorProperty](ue_ue.VariantManagerTestActor.md#capturedlinearcolorproperty)
- [CapturedNameProperty](ue_ue.VariantManagerTestActor.md#capturednameproperty)
- [CapturedObjectProperty](ue_ue.VariantManagerTestActor.md#capturedobjectproperty)
- [CapturedQuatProperty](ue_ue.VariantManagerTestActor.md#capturedquatproperty)
- [CapturedRotatorProperty](ue_ue.VariantManagerTestActor.md#capturedrotatorproperty)
- [CapturedStrProperty](ue_ue.VariantManagerTestActor.md#capturedstrproperty)
- [CapturedTextProperty](ue_ue.VariantManagerTestActor.md#capturedtextproperty)
- [CapturedUObjectArrayProperty](ue_ue.VariantManagerTestActor.md#captureduobjectarrayproperty)
- [CapturedVector2DProperty](ue_ue.VariantManagerTestActor.md#capturedvector2dproperty)
- [CapturedVector4Property](ue_ue.VariantManagerTestActor.md#capturedvector4property)
- [CapturedVectorArrayProperty](ue_ue.VariantManagerTestActor.md#capturedvectorarrayproperty)
- [CapturedVectorProperty](ue_ue.VariantManagerTestActor.md#capturedvectorproperty)
- [Children](ue_ue.VariantManagerTestActor.md#children)
- [ControllingMatineeActors](ue_ue.VariantManagerTestActor.md#controllingmatineeactors)
- [CustomTimeDilation](ue_ue.VariantManagerTestActor.md#customtimedilation)
- [DefaultUpdateOverlapsMethodDuringLevelStreaming](ue_ue.VariantManagerTestActor.md#defaultupdateoverlapsmethodduringlevelstreaming)
- [EnumWithNoDefault](ue_ue.VariantManagerTestActor.md#enumwithnodefault)
- [EnumWithSecondDefault](ue_ue.VariantManagerTestActor.md#enumwithseconddefault)
- [FolderPath](ue_ue.VariantManagerTestActor.md#folderpath)
- [GroupActor](ue_ue.VariantManagerTestActor.md#groupactor)
- [HiddenEditorViews](ue_ue.VariantManagerTestActor.md#hiddeneditorviews)
- [InitialLifeSpan](ue_ue.VariantManagerTestActor.md#initiallifespan)
- [InputComponent](ue_ue.VariantManagerTestActor.md#inputcomponent)
- [InputPriority](ue_ue.VariantManagerTestActor.md#inputpriority)
- [InstanceComponents](ue_ue.VariantManagerTestActor.md#instancecomponents)
- [Instigator](ue_ue.VariantManagerTestActor.md#instigator)
- [Layers](ue_ue.VariantManagerTestActor.md#layers)
- [MinNetUpdateFrequency](ue_ue.VariantManagerTestActor.md#minnetupdatefrequency)
- [NetCullDistanceSquared](ue_ue.VariantManagerTestActor.md#netculldistancesquared)
- [NetDormancy](ue_ue.VariantManagerTestActor.md#netdormancy)
- [NetDriverName](ue_ue.VariantManagerTestActor.md#netdrivername)
- [NetPriority](ue_ue.VariantManagerTestActor.md#netpriority)
- [NetTag](ue_ue.VariantManagerTestActor.md#nettag)
- [NetUpdateFrequency](ue_ue.VariantManagerTestActor.md#netupdatefrequency)
- [OnActorBeginOverlap](ue_ue.VariantManagerTestActor.md#onactorbeginoverlap)
- [OnActorEndOverlap](ue_ue.VariantManagerTestActor.md#onactorendoverlap)
- [OnActorHit](ue_ue.VariantManagerTestActor.md#onactorhit)
- [OnBeginCursorOver](ue_ue.VariantManagerTestActor.md#onbegincursorover)
- [OnClicked](ue_ue.VariantManagerTestActor.md#onclicked)
- [OnDestroyed](ue_ue.VariantManagerTestActor.md#ondestroyed)
- [OnEndCursorOver](ue_ue.VariantManagerTestActor.md#onendcursorover)
- [OnEndPlay](ue_ue.VariantManagerTestActor.md#onendplay)
- [OnInputTouchBegin](ue_ue.VariantManagerTestActor.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue.VariantManagerTestActor.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue.VariantManagerTestActor.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue.VariantManagerTestActor.md#oninputtouchleave)
- [OnReleased](ue_ue.VariantManagerTestActor.md#onreleased)
- [OnTakeAnyDamage](ue_ue.VariantManagerTestActor.md#ontakeanydamage)
- [OnTakePointDamage](ue_ue.VariantManagerTestActor.md#ontakepointdamage)
- [OnTakeRadialDamage](ue_ue.VariantManagerTestActor.md#ontakeradialdamage)
- [Owner](ue_ue.VariantManagerTestActor.md#owner)
- [ParentComponent](ue_ue.VariantManagerTestActor.md#parentcomponent)
- [ParentComponentActor](ue_ue.VariantManagerTestActor.md#parentcomponentactor)
- [PivotOffset](ue_ue.VariantManagerTestActor.md#pivotoffset)
- [PrimaryActorTick](ue_ue.VariantManagerTestActor.md#primaryactortick)
- [RemoteRole](ue_ue.VariantManagerTestActor.md#remoterole)
- [ReplicatedMovement](ue_ue.VariantManagerTestActor.md#replicatedmovement)
- [Role](ue_ue.VariantManagerTestActor.md#role)
- [RootComponent](ue_ue.VariantManagerTestActor.md#rootcomponent)
- [SpawnCollisionHandlingMethod](ue_ue.VariantManagerTestActor.md#spawncollisionhandlingmethod)
- [SpriteScale](ue_ue.VariantManagerTestActor.md#spritescale)
- [Tags](ue_ue.VariantManagerTestActor.md#tags)
- [UpdateOverlapsMethodDuringLevelStreaming](ue_ue.VariantManagerTestActor.md#updateoverlapsmethodduringlevelstreaming)
- [\_\_tid\_Actor\_\_](ue_ue.VariantManagerTestActor.md#__tid_actor__)
- [\_\_tid\_Object\_\_](ue_ue.VariantManagerTestActor.md#__tid_object__)
- [\_\_tid\_VariantManagerTestActor\_\_](ue_ue.VariantManagerTestActor.md#__tid_variantmanagertestactor__)
- [bActorEnableCollision](ue_ue.VariantManagerTestActor.md#bactorenablecollision)
- [bActorIsBeingDestroyed](ue_ue.VariantManagerTestActor.md#bactorisbeingdestroyed)
- [bActorLabelEditable](ue_ue.VariantManagerTestActor.md#bactorlabeleditable)
- [bActorSeamlessTraveled](ue_ue.VariantManagerTestActor.md#bactorseamlesstraveled)
- [bAllowReceiveTickEventOnDedicatedServer](ue_ue.VariantManagerTestActor.md#ballowreceivetickeventondedicatedserver)
- [bAllowTickBeforeBeginPlay](ue_ue.VariantManagerTestActor.md#ballowtickbeforebeginplay)
- [bAlwaysRelevant](ue_ue.VariantManagerTestActor.md#balwaysrelevant)
- [bAutoDestroyWhenFinished](ue_ue.VariantManagerTestActor.md#bautodestroywhenfinished)
- [bBlockInput](ue_ue.VariantManagerTestActor.md#bblockinput)
- [bCanBeDamaged](ue_ue.VariantManagerTestActor.md#bcanbedamaged)
- [bCanBeInCluster](ue_ue.VariantManagerTestActor.md#bcanbeincluster)
- [bCapturedBoolProperty](ue_ue.VariantManagerTestActor.md#bcapturedboolproperty)
- [bCollideWhenPlacing](ue_ue.VariantManagerTestActor.md#bcollidewhenplacing)
- [bEditable](ue_ue.VariantManagerTestActor.md#beditable)
- [bEnableAutoLODGeneration](ue_ue.VariantManagerTestActor.md#benableautolodgeneration)
- [bExchangedRoles](ue_ue.VariantManagerTestActor.md#bexchangedroles)
- [bFindCameraComponentWhenViewTarget](ue_ue.VariantManagerTestActor.md#bfindcameracomponentwhenviewtarget)
- [bGenerateOverlapEventsDuringLevelStreaming](ue_ue.VariantManagerTestActor.md#bgenerateoverlapeventsduringlevelstreaming)
- [bHidden](ue_ue.VariantManagerTestActor.md#bhidden)
- [bHiddenEd](ue_ue.VariantManagerTestActor.md#bhiddened)
- [bHiddenEdLayer](ue_ue.VariantManagerTestActor.md#bhiddenedlayer)
- [bHiddenEdLevel](ue_ue.VariantManagerTestActor.md#bhiddenedlevel)
- [bHiddenEdTemporary](ue_ue.VariantManagerTestActor.md#bhiddenedtemporary)
- [bIgnoresOriginShifting](ue_ue.VariantManagerTestActor.md#bignoresoriginshifting)
- [bIsEditorOnlyActor](ue_ue.VariantManagerTestActor.md#biseditoronlyactor)
- [bIsEditorPreviewActor](ue_ue.VariantManagerTestActor.md#biseditorpreviewactor)
- [bListedInSceneOutliner](ue_ue.VariantManagerTestActor.md#blistedinsceneoutliner)
- [bLockLocation](ue_ue.VariantManagerTestActor.md#blocklocation)
- [bNetLoadOnClient](ue_ue.VariantManagerTestActor.md#bnetloadonclient)
- [bNetStartup](ue_ue.VariantManagerTestActor.md#bnetstartup)
- [bNetTemporary](ue_ue.VariantManagerTestActor.md#bnettemporary)
- [bNetUseOwnerRelevancy](ue_ue.VariantManagerTestActor.md#bnetuseownerrelevancy)
- [bOnlyRelevantToOwner](ue_ue.VariantManagerTestActor.md#bonlyrelevanttoowner)
- [bOptimizeBPComponentData](ue_ue.VariantManagerTestActor.md#boptimizebpcomponentdata)
- [bRelevantForLevelBounds](ue_ue.VariantManagerTestActor.md#brelevantforlevelbounds)
- [bRelevantForNetworkReplays](ue_ue.VariantManagerTestActor.md#brelevantfornetworkreplays)
- [bReplayRewindable](ue_ue.VariantManagerTestActor.md#breplayrewindable)
- [bReplicateMovement](ue_ue.VariantManagerTestActor.md#breplicatemovement)
- [bReplicates](ue_ue.VariantManagerTestActor.md#breplicates)
- [bTearOff](ue_ue.VariantManagerTestActor.md#btearoff)

### Methods

- [ActorHasTag](ue_ue.VariantManagerTestActor.md#actorhastag)
- [AddComponent](ue_ue.VariantManagerTestActor.md#addcomponent)
- [AddTickPrerequisiteActor](ue_ue.VariantManagerTestActor.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue.VariantManagerTestActor.md#addtickprerequisitecomponent)
- [CreateDefaultSubobject](ue_ue.VariantManagerTestActor.md#createdefaultsubobject)
- [DetachRootComponentFromParent](ue_ue.VariantManagerTestActor.md#detachrootcomponentfromparent)
- [DisableInput](ue_ue.VariantManagerTestActor.md#disableinput)
- [EnableInput](ue_ue.VariantManagerTestActor.md#enableinput)
- [ExecuteUbergraph](ue_ue.VariantManagerTestActor.md#executeubergraph)
- [FlushNetDormancy](ue_ue.VariantManagerTestActor.md#flushnetdormancy)
- [ForceNetUpdate](ue_ue.VariantManagerTestActor.md#forcenetupdate)
- [GetActorBounds](ue_ue.VariantManagerTestActor.md#getactorbounds)
- [GetActorEnableCollision](ue_ue.VariantManagerTestActor.md#getactorenablecollision)
- [GetActorEyesViewPoint](ue_ue.VariantManagerTestActor.md#getactoreyesviewpoint)
- [GetActorForwardVector](ue_ue.VariantManagerTestActor.md#getactorforwardvector)
- [GetActorLabel](ue_ue.VariantManagerTestActor.md#getactorlabel)
- [GetActorRelativeScale3D](ue_ue.VariantManagerTestActor.md#getactorrelativescale3d)
- [GetActorRightVector](ue_ue.VariantManagerTestActor.md#getactorrightvector)
- [GetActorScale3D](ue_ue.VariantManagerTestActor.md#getactorscale3d)
- [GetActorTickInterval](ue_ue.VariantManagerTestActor.md#getactortickinterval)
- [GetActorTimeDilation](ue_ue.VariantManagerTestActor.md#getactortimedilation)
- [GetActorUpVector](ue_ue.VariantManagerTestActor.md#getactorupvector)
- [GetAllChildActors](ue_ue.VariantManagerTestActor.md#getallchildactors)
- [GetAttachParentActor](ue_ue.VariantManagerTestActor.md#getattachparentactor)
- [GetAttachParentSocketName](ue_ue.VariantManagerTestActor.md#getattachparentsocketname)
- [GetAttachedActors](ue_ue.VariantManagerTestActor.md#getattachedactors)
- [GetClass](ue_ue.VariantManagerTestActor.md#getclass)
- [GetComponentByClass](ue_ue.VariantManagerTestActor.md#getcomponentbyclass)
- [GetComponentsByInterface](ue_ue.VariantManagerTestActor.md#getcomponentsbyinterface)
- [GetComponentsByTag](ue_ue.VariantManagerTestActor.md#getcomponentsbytag)
- [GetDistanceTo](ue_ue.VariantManagerTestActor.md#getdistanceto)
- [GetDotProductTo](ue_ue.VariantManagerTestActor.md#getdotproductto)
- [GetFolderPath](ue_ue.VariantManagerTestActor.md#getfolderpath)
- [GetGameTimeSinceCreation](ue_ue.VariantManagerTestActor.md#getgametimesincecreation)
- [GetHorizontalDistanceTo](ue_ue.VariantManagerTestActor.md#gethorizontaldistanceto)
- [GetHorizontalDotProductTo](ue_ue.VariantManagerTestActor.md#gethorizontaldotproductto)
- [GetInputAxisKeyValue](ue_ue.VariantManagerTestActor.md#getinputaxiskeyvalue)
- [GetInputAxisValue](ue_ue.VariantManagerTestActor.md#getinputaxisvalue)
- [GetInputVectorAxisValue](ue_ue.VariantManagerTestActor.md#getinputvectoraxisvalue)
- [GetInstigator](ue_ue.VariantManagerTestActor.md#getinstigator)
- [GetInstigatorController](ue_ue.VariantManagerTestActor.md#getinstigatorcontroller)
- [GetLifeSpan](ue_ue.VariantManagerTestActor.md#getlifespan)
- [GetLocalRole](ue_ue.VariantManagerTestActor.md#getlocalrole)
- [GetName](ue_ue.VariantManagerTestActor.md#getname)
- [GetOuter](ue_ue.VariantManagerTestActor.md#getouter)
- [GetOverlappingActors](ue_ue.VariantManagerTestActor.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue.VariantManagerTestActor.md#getoverlappingcomponents)
- [GetOwner](ue_ue.VariantManagerTestActor.md#getowner)
- [GetParentActor](ue_ue.VariantManagerTestActor.md#getparentactor)
- [GetParentComponent](ue_ue.VariantManagerTestActor.md#getparentcomponent)
- [GetRemoteRole](ue_ue.VariantManagerTestActor.md#getremoterole)
- [GetSquaredDistanceTo](ue_ue.VariantManagerTestActor.md#getsquareddistanceto)
- [GetTickableWhenPaused](ue_ue.VariantManagerTestActor.md#gettickablewhenpaused)
- [GetTransform](ue_ue.VariantManagerTestActor.md#gettransform)
- [GetVelocity](ue_ue.VariantManagerTestActor.md#getvelocity)
- [GetVerticalDistanceTo](ue_ue.VariantManagerTestActor.md#getverticaldistanceto)
- [GetWorld](ue_ue.VariantManagerTestActor.md#getworld)
- [HasAuthority](ue_ue.VariantManagerTestActor.md#hasauthority)
- [IsActorBeingDestroyed](ue_ue.VariantManagerTestActor.md#isactorbeingdestroyed)
- [IsActorTickEnabled](ue_ue.VariantManagerTestActor.md#isactortickenabled)
- [IsChildActor](ue_ue.VariantManagerTestActor.md#ischildactor)
- [IsEditable](ue_ue.VariantManagerTestActor.md#iseditable)
- [IsHiddenEd](ue_ue.VariantManagerTestActor.md#ishiddened)
- [IsHiddenEdAtStartup](ue_ue.VariantManagerTestActor.md#ishiddenedatstartup)
- [IsOverlappingActor](ue_ue.VariantManagerTestActor.md#isoverlappingactor)
- [IsSelectable](ue_ue.VariantManagerTestActor.md#isselectable)
- [IsTemporarilyHiddenInEditor](ue_ue.VariantManagerTestActor.md#istemporarilyhiddenineditor)
- [K2\_AddActorLocalOffset](ue_ue.VariantManagerTestActor.md#k2_addactorlocaloffset)
- [K2\_AddActorLocalRotation](ue_ue.VariantManagerTestActor.md#k2_addactorlocalrotation)
- [K2\_AddActorLocalTransform](ue_ue.VariantManagerTestActor.md#k2_addactorlocaltransform)
- [K2\_AddActorWorldOffset](ue_ue.VariantManagerTestActor.md#k2_addactorworldoffset)
- [K2\_AddActorWorldRotation](ue_ue.VariantManagerTestActor.md#k2_addactorworldrotation)
- [K2\_AddActorWorldTransform](ue_ue.VariantManagerTestActor.md#k2_addactorworldtransform)
- [K2\_AttachRootComponentTo](ue_ue.VariantManagerTestActor.md#k2_attachrootcomponentto)
- [K2\_AttachRootComponentToActor](ue_ue.VariantManagerTestActor.md#k2_attachrootcomponenttoactor)
- [K2\_AttachToActor](ue_ue.VariantManagerTestActor.md#k2_attachtoactor)
- [K2\_AttachToComponent](ue_ue.VariantManagerTestActor.md#k2_attachtocomponent)
- [K2\_DestroyActor](ue_ue.VariantManagerTestActor.md#k2_destroyactor)
- [K2\_DestroyComponent](ue_ue.VariantManagerTestActor.md#k2_destroycomponent)
- [K2\_DetachFromActor](ue_ue.VariantManagerTestActor.md#k2_detachfromactor)
- [K2\_GetActorLocation](ue_ue.VariantManagerTestActor.md#k2_getactorlocation)
- [K2\_GetActorRotation](ue_ue.VariantManagerTestActor.md#k2_getactorrotation)
- [K2\_GetComponentsByClass](ue_ue.VariantManagerTestActor.md#k2_getcomponentsbyclass)
- [K2\_GetRootComponent](ue_ue.VariantManagerTestActor.md#k2_getrootcomponent)
- [K2\_OnBecomeViewTarget](ue_ue.VariantManagerTestActor.md#k2_onbecomeviewtarget)
- [K2\_OnEndViewTarget](ue_ue.VariantManagerTestActor.md#k2_onendviewtarget)
- [K2\_OnReset](ue_ue.VariantManagerTestActor.md#k2_onreset)
- [K2\_SetActorLocation](ue_ue.VariantManagerTestActor.md#k2_setactorlocation)
- [K2\_SetActorLocationAndRotation](ue_ue.VariantManagerTestActor.md#k2_setactorlocationandrotation)
- [K2\_SetActorRelativeLocation](ue_ue.VariantManagerTestActor.md#k2_setactorrelativelocation)
- [K2\_SetActorRelativeRotation](ue_ue.VariantManagerTestActor.md#k2_setactorrelativerotation)
- [K2\_SetActorRelativeTransform](ue_ue.VariantManagerTestActor.md#k2_setactorrelativetransform)
- [K2\_SetActorRotation](ue_ue.VariantManagerTestActor.md#k2_setactorrotation)
- [K2\_SetActorTransform](ue_ue.VariantManagerTestActor.md#k2_setactortransform)
- [K2\_TeleportTo](ue_ue.VariantManagerTestActor.md#k2_teleportto)
- [MakeMIDForMaterial](ue_ue.VariantManagerTestActor.md#makemidformaterial)
- [MakeNoise](ue_ue.VariantManagerTestActor.md#makenoise)
- [OnRep\_AttachmentReplication](ue_ue.VariantManagerTestActor.md#onrep_attachmentreplication)
- [OnRep\_Instigator](ue_ue.VariantManagerTestActor.md#onrep_instigator)
- [OnRep\_Owner](ue_ue.VariantManagerTestActor.md#onrep_owner)
- [OnRep\_ReplicateMovement](ue_ue.VariantManagerTestActor.md#onrep_replicatemovement)
- [OnRep\_ReplicatedMovement](ue_ue.VariantManagerTestActor.md#onrep_replicatedmovement)
- [PrestreamTextures](ue_ue.VariantManagerTestActor.md#prestreamtextures)
- [ReceiveActorBeginCursorOver](ue_ue.VariantManagerTestActor.md#receiveactorbegincursorover)
- [ReceiveActorBeginOverlap](ue_ue.VariantManagerTestActor.md#receiveactorbeginoverlap)
- [ReceiveActorEndCursorOver](ue_ue.VariantManagerTestActor.md#receiveactorendcursorover)
- [ReceiveActorEndOverlap](ue_ue.VariantManagerTestActor.md#receiveactorendoverlap)
- [ReceiveActorOnClicked](ue_ue.VariantManagerTestActor.md#receiveactoronclicked)
- [ReceiveActorOnInputTouchBegin](ue_ue.VariantManagerTestActor.md#receiveactoroninputtouchbegin)
- [ReceiveActorOnInputTouchEnd](ue_ue.VariantManagerTestActor.md#receiveactoroninputtouchend)
- [ReceiveActorOnInputTouchEnter](ue_ue.VariantManagerTestActor.md#receiveactoroninputtouchenter)
- [ReceiveActorOnInputTouchLeave](ue_ue.VariantManagerTestActor.md#receiveactoroninputtouchleave)
- [ReceiveActorOnReleased](ue_ue.VariantManagerTestActor.md#receiveactoronreleased)
- [ReceiveAnyDamage](ue_ue.VariantManagerTestActor.md#receiveanydamage)
- [ReceiveBeginPlay](ue_ue.VariantManagerTestActor.md#receivebeginplay)
- [ReceiveDestroyed](ue_ue.VariantManagerTestActor.md#receivedestroyed)
- [ReceiveEndPlay](ue_ue.VariantManagerTestActor.md#receiveendplay)
- [ReceiveHit](ue_ue.VariantManagerTestActor.md#receivehit)
- [ReceivePointDamage](ue_ue.VariantManagerTestActor.md#receivepointdamage)
- [ReceiveRadialDamage](ue_ue.VariantManagerTestActor.md#receiveradialdamage)
- [ReceiveTick](ue_ue.VariantManagerTestActor.md#receivetick)
- [RemoveTickPrerequisiteActor](ue_ue.VariantManagerTestActor.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue.VariantManagerTestActor.md#removetickprerequisitecomponent)
- [SetActorEnableCollision](ue_ue.VariantManagerTestActor.md#setactorenablecollision)
- [SetActorHiddenInGame](ue_ue.VariantManagerTestActor.md#setactorhiddeningame)
- [SetActorLabel](ue_ue.VariantManagerTestActor.md#setactorlabel)
- [SetActorRelativeScale3D](ue_ue.VariantManagerTestActor.md#setactorrelativescale3d)
- [SetActorScale3D](ue_ue.VariantManagerTestActor.md#setactorscale3d)
- [SetActorTickEnabled](ue_ue.VariantManagerTestActor.md#setactortickenabled)
- [SetActorTickInterval](ue_ue.VariantManagerTestActor.md#setactortickinterval)
- [SetFolderPath](ue_ue.VariantManagerTestActor.md#setfolderpath)
- [SetIsTemporarilyHiddenInEditor](ue_ue.VariantManagerTestActor.md#setistemporarilyhiddenineditor)
- [SetLifeSpan](ue_ue.VariantManagerTestActor.md#setlifespan)
- [SetNetDormancy](ue_ue.VariantManagerTestActor.md#setnetdormancy)
- [SetOwner](ue_ue.VariantManagerTestActor.md#setowner)
- [SetReplicateMovement](ue_ue.VariantManagerTestActor.md#setreplicatemovement)
- [SetReplicates](ue_ue.VariantManagerTestActor.md#setreplicates)
- [SetTickGroup](ue_ue.VariantManagerTestActor.md#settickgroup)
- [SetTickableWhenPaused](ue_ue.VariantManagerTestActor.md#settickablewhenpaused)
- [SnapRootComponentTo](ue_ue.VariantManagerTestActor.md#snaprootcomponentto)
- [TearOff](ue_ue.VariantManagerTestActor.md#tearoff)
- [UserConstructionScript](ue_ue.VariantManagerTestActor.md#userconstructionscript)
- [WasRecentlyRendered](ue_ue.VariantManagerTestActor.md#wasrecentlyrendered)
- [Find](ue_ue.VariantManagerTestActor.md#find)
- [Load](ue_ue.VariantManagerTestActor.md#load)
- [StaticClass](ue_ue.VariantManagerTestActor.md#staticclass)

## Constructors

### constructor

• **new VariantManagerTestActor**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:65028](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65028)
...
[ue/ue.d.ts:65031](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65031)

___

### CapturedColorProperty

• **CapturedColorProperty**: [`Color`](ue_ue_s.Color.md)

#### Defined in

[ue/ue.d.ts:65041](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65041)
...
[ue/ue.d.ts:65033](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65033)

___

### CapturedIntPointProperty

• **CapturedIntPointProperty**: [`IntPoint`](ue_ue_s.IntPoint.md)

#### Defined in

[ue/ue.d.ts:65047](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65047)
...
[ue/ue.d.ts:65032](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65032)

___

### CapturedInterfaceProperty

• **CapturedInterfaceProperty**: [`Interface`](ue_ue.Interface.md)

#### Defined in

[ue/ue.d.ts:65036](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65036)

___

### CapturedLinearColorProperty

• **CapturedLinearColorProperty**: [`LinearColor`](ue_ue_s.LinearColor.md)

#### Defined in

[ue/ue.d.ts:65042](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65042)
...
[ue/ue.d.ts:65037](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65037)

___

### CapturedObjectProperty

• **CapturedObjectProperty**: [`Object`](ue_ue.Object.md)

#### Defined in

[ue/ue.d.ts:65035](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65035)

___

### CapturedQuatProperty

• **CapturedQuatProperty**: [`Quat`](ue_ue_s.Quat.md)

#### Defined in

[ue/ue.d.ts:65044](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65044)

___

### CapturedRotatorProperty

• **CapturedRotatorProperty**: [`Rotator`](ue_ue_s.Rotator.md)

#### Defined in

[ue/ue.d.ts:65040](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65040)
...
[ue/ue.d.ts:65038](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65038)
...
[ue/ue.d.ts:65039](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65039)

___

### CapturedUObjectArrayProperty

• **CapturedUObjectArrayProperty**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Object`](ue_ue.Object.md)\>

#### Defined in

[ue/ue.d.ts:65048](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65048)

___

### CapturedVector2DProperty

• **CapturedVector2DProperty**: [`Vector2D`](ue_ue_s.Vector2D.md)

#### Defined in

[ue/ue.d.ts:65046](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65046)

___

### CapturedVector4Property

• **CapturedVector4Property**: [`Vector4`](ue_ue_s.Vector4.md)

#### Defined in

[ue/ue.d.ts:65045](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65045)

___

### CapturedVectorArrayProperty

• **CapturedVectorArrayProperty**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Vector`](ue_ue_s.Vector.md)\>

#### Defined in

[ue/ue.d.ts:65049](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65049)

___

### CapturedVectorProperty

• **CapturedVectorProperty**: [`Vector`](ue_ue_s.Vector.md)

#### Defined in

[ue/ue.d.ts:65043](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65043)
...
• **EnumWithNoDefault**: [`EVariantManagerTestEnum`](../enums/ue_ue.EVariantManagerTestEnum.md)

#### Defined in

[ue/ue.d.ts:65029](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65029)

___

### EnumWithSecondDefault

• **EnumWithSecondDefault**: [`EVariantManagerTestEnum`](../enums/ue_ue.EVariantManagerTestEnum.md)

#### Defined in

[ue/ue.d.ts:65030](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65030)
...
### \_\_tid\_VariantManagerTestActor\_\_

• **\_\_tid\_VariantManagerTestActor\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:65054](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65054)
...
[ue/ue.d.ts:65034](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65034)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`VariantManagerTestActor`](ue_ue.VariantManagerTestActor.md)
...
[ue/ue.d.ts:65051](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65051)

___

### Load

▸ `Static` **Load**(`InName`): [`VariantManagerTestActor`](ue_ue.VariantManagerTestActor.md)
...
[ue/ue.d.ts:65052](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65052)
...
[ue/ue.d.ts:65050](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L65050)
