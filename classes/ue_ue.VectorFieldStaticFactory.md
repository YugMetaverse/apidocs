[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / VectorFieldStaticFactory

# Class: VectorFieldStaticFactory

[ue/ue](../modules/ue_ue.md).VectorFieldStaticFactory
...
- [constructor](ue_ue.VectorFieldStaticFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.VectorFieldStaticFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.VectorFieldStaticFactory.md#automatedimportdata)
- [ContextClass](ue_ue.VectorFieldStaticFactory.md#contextclass)
- [Formats](ue_ue.VectorFieldStaticFactory.md#formats)
- [ImportPriority](ue_ue.VectorFieldStaticFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.VectorFieldStaticFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.VectorFieldStaticFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.VectorFieldStaticFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.VectorFieldStaticFactory.md#__tid_object__)
- [\_\_tid\_VectorFieldStaticFactory\_\_](ue_ue.VectorFieldStaticFactory.md#__tid_vectorfieldstaticfactory__)
- [bCreateNew](ue_ue.VectorFieldStaticFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.VectorFieldStaticFactory.md#beditafternew)
- [bEditorImport](ue_ue.VectorFieldStaticFactory.md#beditorimport)
- [bText](ue_ue.VectorFieldStaticFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.VectorFieldStaticFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.VectorFieldStaticFactory.md#executeubergraph)
- [GetClass](ue_ue.VectorFieldStaticFactory.md#getclass)
- [GetName](ue_ue.VectorFieldStaticFactory.md#getname)
- [GetOuter](ue_ue.VectorFieldStaticFactory.md#getouter)
- [GetWorld](ue_ue.VectorFieldStaticFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.VectorFieldStaticFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.VectorFieldStaticFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.VectorFieldStaticFactory.md#find)
- [Load](ue_ue.VectorFieldStaticFactory.md#load)
- [StaticClass](ue_ue.VectorFieldStaticFactory.md#staticclass)

## Constructors

### constructor

• **new VectorFieldStaticFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:59415](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L59415)
...
[ue/ue.d.ts:59420](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L59420)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`VectorFieldStaticFactory`](ue_ue.VectorFieldStaticFactory.md)
...
[ue/ue.d.ts:59417](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L59417)

___

### Load

▸ `Static` **Load**(`InName`): [`VectorFieldStaticFactory`](ue_ue.VectorFieldStaticFactory.md)
...
[ue/ue.d.ts:59418](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L59418)
...
[ue/ue.d.ts:59416](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L59416)
