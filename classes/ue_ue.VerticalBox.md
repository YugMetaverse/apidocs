[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / VerticalBox

# Class: VerticalBox

[ue/ue](../modules/ue_ue.md).VerticalBox
...
- [constructor](ue_ue.VerticalBox.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.VerticalBox.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.VerticalBox.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.VerticalBox.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.VerticalBox.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.VerticalBox.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.VerticalBox.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.VerticalBox.md#accessiblewidgetdata)
- [CategoryName](ue_ue.VerticalBox.md#categoryname)
- [Clipping](ue_ue.VerticalBox.md#clipping)
- [Cursor](ue_ue.VerticalBox.md#cursor)
- [DesignerFlags](ue_ue.VerticalBox.md#designerflags)
- [DisplayLabel](ue_ue.VerticalBox.md#displaylabel)
- [FlowDirectionPreference](ue_ue.VerticalBox.md#flowdirectionpreference)
- [NativeBindings](ue_ue.VerticalBox.md#nativebindings)
- [Navigation](ue_ue.VerticalBox.md#navigation)
- [RenderOpacity](ue_ue.VerticalBox.md#renderopacity)
- [RenderTransform](ue_ue.VerticalBox.md#rendertransform)
- [RenderTransformPivot](ue_ue.VerticalBox.md#rendertransformpivot)
- [Slot](ue_ue.VerticalBox.md#slot)
- [Slots](ue_ue.VerticalBox.md#slots)
- [ToolTipText](ue_ue.VerticalBox.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.VerticalBox.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.VerticalBox.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.VerticalBox.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.VerticalBox.md#visibility)
- [VisibilityDelegate](ue_ue.VerticalBox.md#visibilitydelegate)
- [\_\_tid\_Object\_\_](ue_ue.VerticalBox.md#__tid_object__)
- [\_\_tid\_PanelWidget\_\_](ue_ue.VerticalBox.md#__tid_panelwidget__)
- [\_\_tid\_VerticalBox\_\_](ue_ue.VerticalBox.md#__tid_verticalbox__)
- [\_\_tid\_Visual\_\_](ue_ue.VerticalBox.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.VerticalBox.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.VerticalBox.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.VerticalBox.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.VerticalBox.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.VerticalBox.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.VerticalBox.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.VerticalBox.md#bisenableddelegate)
- [bIsVariable](ue_ue.VerticalBox.md#bisvariable)
- [bIsVolatile](ue_ue.VerticalBox.md#bisvolatile)
- [bLockedInDesigner](ue_ue.VerticalBox.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.VerticalBox.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.VerticalBox.md#boverride_cursor)

### Methods

- [AddChild](ue_ue.VerticalBox.md#addchild)
- [AddChildToVerticalBox](ue_ue.VerticalBox.md#addchildtoverticalbox)
- [ClearChildren](ue_ue.VerticalBox.md#clearchildren)
- [CreateDefaultSubobject](ue_ue.VerticalBox.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.VerticalBox.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.VerticalBox.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.VerticalBox.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.VerticalBox.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.VerticalBox.md#generatewidgetforstring__delegatesignature)
- [GetAllChildren](ue_ue.VerticalBox.md#getallchildren)
- [GetBool\_\_DelegateSignature](ue_ue.VerticalBox.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.VerticalBox.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.VerticalBox.md#getcheckboxstate__delegatesignature)
- [GetChildAt](ue_ue.VerticalBox.md#getchildat)
- [GetChildIndex](ue_ue.VerticalBox.md#getchildindex)
- [GetChildrenCount](ue_ue.VerticalBox.md#getchildrencount)
- [GetClass](ue_ue.VerticalBox.md#getclass)
- [GetClipping](ue_ue.VerticalBox.md#getclipping)
- [GetDesiredSize](ue_ue.VerticalBox.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.VerticalBox.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.VerticalBox.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.VerticalBox.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.VerticalBox.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.VerticalBox.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.VerticalBox.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.VerticalBox.md#getname)
- [GetOuter](ue_ue.VerticalBox.md#getouter)
- [GetOwningLocalPlayer](ue_ue.VerticalBox.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.VerticalBox.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.VerticalBox.md#getpaintspacegeometry)
- [GetParent](ue_ue.VerticalBox.md#getparent)
- [GetRenderOpacity](ue_ue.VerticalBox.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.VerticalBox.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.VerticalBox.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.VerticalBox.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.VerticalBox.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.VerticalBox.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.VerticalBox.md#gettickspacegeometry)
- [GetVisibility](ue_ue.VerticalBox.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.VerticalBox.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.VerticalBox.md#getworld)
- [HasAnyChildren](ue_ue.VerticalBox.md#hasanychildren)
- [HasAnyUserFocus](ue_ue.VerticalBox.md#hasanyuserfocus)
- [HasChild](ue_ue.VerticalBox.md#haschild)
- [HasFocusedDescendants](ue_ue.VerticalBox.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.VerticalBox.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.VerticalBox.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.VerticalBox.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.VerticalBox.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.VerticalBox.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.VerticalBox.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.VerticalBox.md#ishovered)
- [IsVisible](ue_ue.VerticalBox.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.VerticalBox.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.VerticalBox.md#onreply__delegatesignature)
- [RemoveChild](ue_ue.VerticalBox.md#removechild)
- [RemoveChildAt](ue_ue.VerticalBox.md#removechildat)
- [RemoveFromParent](ue_ue.VerticalBox.md#removefromparent)
- [ResetCursor](ue_ue.VerticalBox.md#resetcursor)
- [SetAllNavigationRules](ue_ue.VerticalBox.md#setallnavigationrules)
- [SetClipping](ue_ue.VerticalBox.md#setclipping)
- [SetCursor](ue_ue.VerticalBox.md#setcursor)
- [SetFocus](ue_ue.VerticalBox.md#setfocus)
- [SetIsEnabled](ue_ue.VerticalBox.md#setisenabled)
- [SetKeyboardFocus](ue_ue.VerticalBox.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.VerticalBox.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.VerticalBox.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.VerticalBox.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.VerticalBox.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.VerticalBox.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.VerticalBox.md#setrenderopacity)
- [SetRenderScale](ue_ue.VerticalBox.md#setrenderscale)
- [SetRenderShear](ue_ue.VerticalBox.md#setrendershear)
- [SetRenderTransform](ue_ue.VerticalBox.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.VerticalBox.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.VerticalBox.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.VerticalBox.md#setrendertranslation)
- [SetToolTip](ue_ue.VerticalBox.md#settooltip)
- [SetToolTipText](ue_ue.VerticalBox.md#settooltiptext)
- [SetUserFocus](ue_ue.VerticalBox.md#setuserfocus)
- [SetVisibility](ue_ue.VerticalBox.md#setvisibility)
- [Find](ue_ue.VerticalBox.md#find)
- [Load](ue_ue.VerticalBox.md#load)
- [StaticClass](ue_ue.VerticalBox.md#staticclass)

## Constructors

### constructor

• **new VerticalBox**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:65188](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65188)
...
### \_\_tid\_VerticalBox\_\_

• **\_\_tid\_VerticalBox\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:65194](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65194)
...
▸ **AddChildToVerticalBox**(`Content`): [`VerticalBoxSlot`](ue_ue.VerticalBoxSlot.md)
...
[ue/ue.d.ts:65189](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65189)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`VerticalBox`](ue_ue.VerticalBox.md)
...
[`VerticalBox`](ue_ue.VerticalBox.md)
...
[ue/ue.d.ts:65191](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65191)

___

### Load

▸ `Static` **Load**(`InName`): [`VerticalBox`](ue_ue.VerticalBox.md)
...
[ue/ue.d.ts:65192](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65192)
...
[ue/ue.d.ts:65190](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65190)
