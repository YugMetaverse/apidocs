[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / Viewport

# Class: Viewport

[ue/ue](../modules/ue_ue.md).Viewport
...
- [constructor](ue_ue.Viewport.md#constructor)

### Properties

- [AccessibleBehavior](ue_ue.Viewport.md#accessiblebehavior)
- [AccessibleSummaryBehavior](ue_ue.Viewport.md#accessiblesummarybehavior)
- [AccessibleSummaryText](ue_ue.Viewport.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](ue_ue.Viewport.md#accessiblesummarytextdelegate)
- [AccessibleText](ue_ue.Viewport.md#accessibletext)
- [AccessibleTextDelegate](ue_ue.Viewport.md#accessibletextdelegate)
- [AccessibleWidgetData](ue_ue.Viewport.md#accessiblewidgetdata)
- [BackgroundColor](ue_ue.Viewport.md#backgroundcolor)
- [CategoryName](ue_ue.Viewport.md#categoryname)
- [Clipping](ue_ue.Viewport.md#clipping)
- [Cursor](ue_ue.Viewport.md#cursor)
- [DesignerFlags](ue_ue.Viewport.md#designerflags)
- [DisplayLabel](ue_ue.Viewport.md#displaylabel)
- [FlowDirectionPreference](ue_ue.Viewport.md#flowdirectionpreference)
- [NativeBindings](ue_ue.Viewport.md#nativebindings)
- [Navigation](ue_ue.Viewport.md#navigation)
- [RenderOpacity](ue_ue.Viewport.md#renderopacity)
- [RenderTransform](ue_ue.Viewport.md#rendertransform)
- [RenderTransformPivot](ue_ue.Viewport.md#rendertransformpivot)
- [Slot](ue_ue.Viewport.md#slot)
- [Slots](ue_ue.Viewport.md#slots)
- [ToolTipText](ue_ue.Viewport.md#tooltiptext)
- [ToolTipTextDelegate](ue_ue.Viewport.md#tooltiptextdelegate)
- [ToolTipWidget](ue_ue.Viewport.md#tooltipwidget)
- [ToolTipWidgetDelegate](ue_ue.Viewport.md#tooltipwidgetdelegate)
- [Visibility](ue_ue.Viewport.md#visibility)
- [VisibilityDelegate](ue_ue.Viewport.md#visibilitydelegate)
- [\_\_tid\_ContentWidget\_\_](ue_ue.Viewport.md#__tid_contentwidget__)
- [\_\_tid\_Object\_\_](ue_ue.Viewport.md#__tid_object__)
- [\_\_tid\_PanelWidget\_\_](ue_ue.Viewport.md#__tid_panelwidget__)
- [\_\_tid\_Viewport\_\_](ue_ue.Viewport.md#__tid_viewport__)
- [\_\_tid\_Visual\_\_](ue_ue.Viewport.md#__tid_visual__)
- [\_\_tid\_Widget\_\_](ue_ue.Viewport.md#__tid_widget__)
- [bCanChildrenBeAccessible](ue_ue.Viewport.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](ue_ue.Viewport.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](ue_ue.Viewport.md#bexpandedindesigner)
- [bHiddenInDesigner](ue_ue.Viewport.md#bhiddenindesigner)
- [bIsEnabled](ue_ue.Viewport.md#bisenabled)
- [bIsEnabledDelegate](ue_ue.Viewport.md#bisenableddelegate)
- [bIsVariable](ue_ue.Viewport.md#bisvariable)
- [bIsVolatile](ue_ue.Viewport.md#bisvolatile)
- [bLockedInDesigner](ue_ue.Viewport.md#blockedindesigner)
- [bOverrideAccessibleDefaults](ue_ue.Viewport.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](ue_ue.Viewport.md#boverride_cursor)

### Methods

- [AddChild](ue_ue.Viewport.md#addchild)
- [ClearChildren](ue_ue.Viewport.md#clearchildren)
- [CreateDefaultSubobject](ue_ue.Viewport.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.Viewport.md#executeubergraph)
- [ForceLayoutPrepass](ue_ue.Viewport.md#forcelayoutprepass)
- [ForceVolatile](ue_ue.Viewport.md#forcevolatile)
- [GenerateWidgetForObject\_\_DelegateSignature](ue_ue.Viewport.md#generatewidgetforobject__delegatesignature)
- [GenerateWidgetForString\_\_DelegateSignature](ue_ue.Viewport.md#generatewidgetforstring__delegatesignature)
- [GetAllChildren](ue_ue.Viewport.md#getallchildren)
- [GetBool\_\_DelegateSignature](ue_ue.Viewport.md#getbool__delegatesignature)
- [GetCachedGeometry](ue_ue.Viewport.md#getcachedgeometry)
- [GetCheckBoxState\_\_DelegateSignature](ue_ue.Viewport.md#getcheckboxstate__delegatesignature)
- [GetChildAt](ue_ue.Viewport.md#getchildat)
- [GetChildIndex](ue_ue.Viewport.md#getchildindex)
- [GetChildrenCount](ue_ue.Viewport.md#getchildrencount)
- [GetClass](ue_ue.Viewport.md#getclass)
- [GetClipping](ue_ue.Viewport.md#getclipping)
- [GetContent](ue_ue.Viewport.md#getcontent)
- [GetContentSlot](ue_ue.Viewport.md#getcontentslot)
- [GetDesiredSize](ue_ue.Viewport.md#getdesiredsize)
- [GetFloat\_\_DelegateSignature](ue_ue.Viewport.md#getfloat__delegatesignature)
- [GetGameInstance](ue_ue.Viewport.md#getgameinstance)
- [GetInt32\_\_DelegateSignature](ue_ue.Viewport.md#getint32__delegatesignature)
- [GetIsEnabled](ue_ue.Viewport.md#getisenabled)
- [GetLinearColor\_\_DelegateSignature](ue_ue.Viewport.md#getlinearcolor__delegatesignature)
- [GetMouseCursor\_\_DelegateSignature](ue_ue.Viewport.md#getmousecursor__delegatesignature)
- [GetName](ue_ue.Viewport.md#getname)
- [GetOuter](ue_ue.Viewport.md#getouter)
- [GetOwningLocalPlayer](ue_ue.Viewport.md#getowninglocalplayer)
- [GetOwningPlayer](ue_ue.Viewport.md#getowningplayer)
- [GetPaintSpaceGeometry](ue_ue.Viewport.md#getpaintspacegeometry)
- [GetParent](ue_ue.Viewport.md#getparent)
- [GetRenderOpacity](ue_ue.Viewport.md#getrenderopacity)
- [GetRenderTransformAngle](ue_ue.Viewport.md#getrendertransformangle)
- [GetSlateBrush\_\_DelegateSignature](ue_ue.Viewport.md#getslatebrush__delegatesignature)
- [GetSlateColor\_\_DelegateSignature](ue_ue.Viewport.md#getslatecolor__delegatesignature)
- [GetSlateVisibility\_\_DelegateSignature](ue_ue.Viewport.md#getslatevisibility__delegatesignature)
- [GetText\_\_DelegateSignature](ue_ue.Viewport.md#gettext__delegatesignature)
- [GetTickSpaceGeometry](ue_ue.Viewport.md#gettickspacegeometry)
- [GetViewLocation](ue_ue.Viewport.md#getviewlocation)
- [GetViewRotation](ue_ue.Viewport.md#getviewrotation)
- [GetViewportWorld](ue_ue.Viewport.md#getviewportworld)
- [GetVisibility](ue_ue.Viewport.md#getvisibility)
- [GetWidget\_\_DelegateSignature](ue_ue.Viewport.md#getwidget__delegatesignature)
- [GetWorld](ue_ue.Viewport.md#getworld)
- [HasAnyChildren](ue_ue.Viewport.md#hasanychildren)
- [HasAnyUserFocus](ue_ue.Viewport.md#hasanyuserfocus)
- [HasChild](ue_ue.Viewport.md#haschild)
- [HasFocusedDescendants](ue_ue.Viewport.md#hasfocuseddescendants)
- [HasKeyboardFocus](ue_ue.Viewport.md#haskeyboardfocus)
- [HasMouseCapture](ue_ue.Viewport.md#hasmousecapture)
- [HasMouseCaptureByUser](ue_ue.Viewport.md#hasmousecapturebyuser)
- [HasUserFocus](ue_ue.Viewport.md#hasuserfocus)
- [HasUserFocusedDescendants](ue_ue.Viewport.md#hasuserfocuseddescendants)
- [InvalidateLayoutAndVolatility](ue_ue.Viewport.md#invalidatelayoutandvolatility)
- [IsHovered](ue_ue.Viewport.md#ishovered)
- [IsVisible](ue_ue.Viewport.md#isvisible)
- [OnPointerEvent\_\_DelegateSignature](ue_ue.Viewport.md#onpointerevent__delegatesignature)
- [OnReply\_\_DelegateSignature](ue_ue.Viewport.md#onreply__delegatesignature)
- [RemoveChild](ue_ue.Viewport.md#removechild)
- [RemoveChildAt](ue_ue.Viewport.md#removechildat)
- [RemoveFromParent](ue_ue.Viewport.md#removefromparent)
- [ResetCursor](ue_ue.Viewport.md#resetcursor)
- [SetAllNavigationRules](ue_ue.Viewport.md#setallnavigationrules)
- [SetClipping](ue_ue.Viewport.md#setclipping)
- [SetContent](ue_ue.Viewport.md#setcontent)
- [SetCursor](ue_ue.Viewport.md#setcursor)
- [SetFocus](ue_ue.Viewport.md#setfocus)
- [SetIsEnabled](ue_ue.Viewport.md#setisenabled)
- [SetKeyboardFocus](ue_ue.Viewport.md#setkeyboardfocus)
- [SetNavigationRule](ue_ue.Viewport.md#setnavigationrule)
- [SetNavigationRuleBase](ue_ue.Viewport.md#setnavigationrulebase)
- [SetNavigationRuleCustom](ue_ue.Viewport.md#setnavigationrulecustom)
- [SetNavigationRuleCustomBoundary](ue_ue.Viewport.md#setnavigationrulecustomboundary)
- [SetNavigationRuleExplicit](ue_ue.Viewport.md#setnavigationruleexplicit)
- [SetRenderOpacity](ue_ue.Viewport.md#setrenderopacity)
- [SetRenderScale](ue_ue.Viewport.md#setrenderscale)
- [SetRenderShear](ue_ue.Viewport.md#setrendershear)
- [SetRenderTransform](ue_ue.Viewport.md#setrendertransform)
- [SetRenderTransformAngle](ue_ue.Viewport.md#setrendertransformangle)
- [SetRenderTransformPivot](ue_ue.Viewport.md#setrendertransformpivot)
- [SetRenderTranslation](ue_ue.Viewport.md#setrendertranslation)
- [SetToolTip](ue_ue.Viewport.md#settooltip)
- [SetToolTipText](ue_ue.Viewport.md#settooltiptext)
- [SetUserFocus](ue_ue.Viewport.md#setuserfocus)
- [SetViewLocation](ue_ue.Viewport.md#setviewlocation)
- [SetViewRotation](ue_ue.Viewport.md#setviewrotation)
- [SetVisibility](ue_ue.Viewport.md#setvisibility)
- [Spawn](ue_ue.Viewport.md#spawn)
- [Find](ue_ue.Viewport.md#find)
- [Load](ue_ue.Viewport.md#load)
- [StaticClass](ue_ue.Viewport.md#staticclass)

## Constructors

### constructor

• **new Viewport**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:65209](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65209)
...
[ue/ue.d.ts:65210](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65210)
...
### \_\_tid\_Viewport\_\_

• **\_\_tid\_Viewport\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:65221](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65221)
...
▸ **GetViewLocation**(): [`Vector`](ue_ue_s.Vector.md)
...
[ue/ue.d.ts:65211](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65211)
...
[ue/ue.d.ts:65213](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65213)

___

### GetViewportWorld

▸ **GetViewportWorld**(): [`World`](ue_ue.World.md)
...
[ue/ue.d.ts:65212](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65212)
...
[ue/ue.d.ts:65214](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65214)

___

### SetViewRotation

▸ **SetViewRotation**(`Rotation`): `void`
...
[ue/ue.d.ts:65215](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65215)
...
▸ **Spawn**(`ActorClass`): [`Actor`](ue_ue.Actor.md)
...
[ue/ue.d.ts:65216](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65216)

___

### Find

▸ `Static` **Find**(`OrigInName`, `Outer?`): [`Viewport`](ue_ue.Viewport.md)
...
[ue/ue.d.ts:65218](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65218)

___

### Load

▸ `Static` **Load**(`InName`): [`Viewport`](ue_ue.Viewport.md)
...
[ue/ue.d.ts:65219](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65219)
...
[ue/ue.d.ts:65217](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65217)
