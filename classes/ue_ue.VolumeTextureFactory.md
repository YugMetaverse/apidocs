[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / VolumeTextureFactory

# Class: VolumeTextureFactory

[ue/ue](../modules/ue_ue.md).VolumeTextureFactory
...
- [constructor](ue_ue.VolumeTextureFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.VolumeTextureFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.VolumeTextureFactory.md#automatedimportdata)
- [ContextClass](ue_ue.VolumeTextureFactory.md#contextclass)
- [Formats](ue_ue.VolumeTextureFactory.md#formats)
- [ImportPriority](ue_ue.VolumeTextureFactory.md#importpriority)
- [InitialTexture](ue_ue.VolumeTextureFactory.md#initialtexture)
- [OverwriteYesOrNoToAllState](ue_ue.VolumeTextureFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.VolumeTextureFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.VolumeTextureFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.VolumeTextureFactory.md#__tid_object__)
- [\_\_tid\_VolumeTextureFactory\_\_](ue_ue.VolumeTextureFactory.md#__tid_volumetexturefactory__)
- [bCreateNew](ue_ue.VolumeTextureFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.VolumeTextureFactory.md#beditafternew)
- [bEditorImport](ue_ue.VolumeTextureFactory.md#beditorimport)
- [bText](ue_ue.VolumeTextureFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.VolumeTextureFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.VolumeTextureFactory.md#executeubergraph)
- [GetClass](ue_ue.VolumeTextureFactory.md#getclass)
- [GetName](ue_ue.VolumeTextureFactory.md#getname)
- [GetOuter](ue_ue.VolumeTextureFactory.md#getouter)
- [GetWorld](ue_ue.VolumeTextureFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.VolumeTextureFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.VolumeTextureFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.VolumeTextureFactory.md#find)
- [Load](ue_ue.VolumeTextureFactory.md#load)
- [StaticClass](ue_ue.VolumeTextureFactory.md#staticclass)

## Constructors

### constructor

• **new VolumeTextureFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:65489](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65489)
...
[ue/ue.d.ts:65490](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65490)
...
### \_\_tid\_VolumeTextureFactory\_\_

• **\_\_tid\_VolumeTextureFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:65495](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65495)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`VolumeTextureFactory`](ue_ue.VolumeTextureFactory.md)
...
[ue/ue.d.ts:65492](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65492)

___

### Load

▸ `Static` **Load**(`InName`): [`VolumeTextureFactory`](ue_ue.VolumeTextureFactory.md)
...
[ue/ue.d.ts:65493](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65493)
...
[ue/ue.d.ts:65491](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L65491)
