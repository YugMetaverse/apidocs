[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / WebMPlatFileMediaSourceFactory

# Class: WebMPlatFileMediaSourceFactory

[ue/ue](../modules/ue_ue.md).WebMPlatFileMediaSourceFactory
...
- [constructor](ue_ue.WebMPlatFileMediaSourceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.WebMPlatFileMediaSourceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.WebMPlatFileMediaSourceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.WebMPlatFileMediaSourceFactory.md#contextclass)
- [Formats](ue_ue.WebMPlatFileMediaSourceFactory.md#formats)
- [ImportPriority](ue_ue.WebMPlatFileMediaSourceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.WebMPlatFileMediaSourceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.WebMPlatFileMediaSourceFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.WebMPlatFileMediaSourceFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.WebMPlatFileMediaSourceFactory.md#__tid_object__)
- [\_\_tid\_WebMPlatFileMediaSourceFactory\_\_](ue_ue.WebMPlatFileMediaSourceFactory.md#__tid_webmplatfilemediasourcefactory__)
- [bCreateNew](ue_ue.WebMPlatFileMediaSourceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.WebMPlatFileMediaSourceFactory.md#beditafternew)
- [bEditorImport](ue_ue.WebMPlatFileMediaSourceFactory.md#beditorimport)
- [bText](ue_ue.WebMPlatFileMediaSourceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.WebMPlatFileMediaSourceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.WebMPlatFileMediaSourceFactory.md#executeubergraph)
- [GetClass](ue_ue.WebMPlatFileMediaSourceFactory.md#getclass)
- [GetName](ue_ue.WebMPlatFileMediaSourceFactory.md#getname)
- [GetOuter](ue_ue.WebMPlatFileMediaSourceFactory.md#getouter)
- [GetWorld](ue_ue.WebMPlatFileMediaSourceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.WebMPlatFileMediaSourceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.WebMPlatFileMediaSourceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.WebMPlatFileMediaSourceFactory.md#find)
- [Load](ue_ue.WebMPlatFileMediaSourceFactory.md#load)
- [StaticClass](ue_ue.WebMPlatFileMediaSourceFactory.md#staticclass)

## Constructors

### constructor

• **new WebMPlatFileMediaSourceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:66017](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66017)
...
### \_\_tid\_WebMPlatFileMediaSourceFactory\_\_

• **\_\_tid\_WebMPlatFileMediaSourceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:66022](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66022)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`WebMPlatFileMediaSourceFactory`](ue_ue.WebMPlatFileMediaSourceFactory.md)
...
[ue/ue.d.ts:66019](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66019)

___

### Load

▸ `Static` **Load**(`InName`): [`WebMPlatFileMediaSourceFactory`](ue_ue.WebMPlatFileMediaSourceFactory.md)
...
[ue/ue.d.ts:66020](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66020)
...
[ue/ue.d.ts:66018](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66018)
