[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / WmfFileMediaSourceFactory

# Class: WmfFileMediaSourceFactory

[ue/ue](../modules/ue_ue.md).WmfFileMediaSourceFactory
...
- [constructor](ue_ue.WmfFileMediaSourceFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.WmfFileMediaSourceFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.WmfFileMediaSourceFactory.md#automatedimportdata)
- [ContextClass](ue_ue.WmfFileMediaSourceFactory.md#contextclass)
- [Formats](ue_ue.WmfFileMediaSourceFactory.md#formats)
- [ImportPriority](ue_ue.WmfFileMediaSourceFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.WmfFileMediaSourceFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.WmfFileMediaSourceFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.WmfFileMediaSourceFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.WmfFileMediaSourceFactory.md#__tid_object__)
- [\_\_tid\_WmfFileMediaSourceFactory\_\_](ue_ue.WmfFileMediaSourceFactory.md#__tid_wmffilemediasourcefactory__)
- [bCreateNew](ue_ue.WmfFileMediaSourceFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.WmfFileMediaSourceFactory.md#beditafternew)
- [bEditorImport](ue_ue.WmfFileMediaSourceFactory.md#beditorimport)
- [bText](ue_ue.WmfFileMediaSourceFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.WmfFileMediaSourceFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.WmfFileMediaSourceFactory.md#executeubergraph)
- [GetClass](ue_ue.WmfFileMediaSourceFactory.md#getclass)
- [GetName](ue_ue.WmfFileMediaSourceFactory.md#getname)
- [GetOuter](ue_ue.WmfFileMediaSourceFactory.md#getouter)
- [GetWorld](ue_ue.WmfFileMediaSourceFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.WmfFileMediaSourceFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.WmfFileMediaSourceFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.WmfFileMediaSourceFactory.md#find)
- [Load](ue_ue.WmfFileMediaSourceFactory.md#load)
- [StaticClass](ue_ue.WmfFileMediaSourceFactory.md#staticclass)

## Constructors

### constructor

• **new WmfFileMediaSourceFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:66524](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66524)
...
### \_\_tid\_WmfFileMediaSourceFactory\_\_

• **\_\_tid\_WmfFileMediaSourceFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:66529](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66529)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`WmfFileMediaSourceFactory`](ue_ue.WmfFileMediaSourceFactory.md)
...
[ue/ue.d.ts:66526](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66526)

___

### Load

▸ `Static` **Load**(`InName`): [`WmfFileMediaSourceFactory`](ue_ue.WmfFileMediaSourceFactory.md)
...
[ue/ue.d.ts:66527](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66527)
...
[ue/ue.d.ts:66525](https://github.com/YugMetaverse/yug_typings/blob/25cad34/ue/ue.d.ts#L66525)
