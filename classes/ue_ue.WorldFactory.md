[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / WorldFactory

# Class: WorldFactory

[ue/ue](../modules/ue_ue.md).WorldFactory
...
- [constructor](ue_ue.WorldFactory.md#constructor)

### Properties

- [AssetImportTask](ue_ue.WorldFactory.md#assetimporttask)
- [AutomatedImportData](ue_ue.WorldFactory.md#automatedimportdata)
- [ContextClass](ue_ue.WorldFactory.md#contextclass)
- [Formats](ue_ue.WorldFactory.md#formats)
- [ImportPriority](ue_ue.WorldFactory.md#importpriority)
- [OverwriteYesOrNoToAllState](ue_ue.WorldFactory.md#overwriteyesornotoallstate)
- [SupportedClass](ue_ue.WorldFactory.md#supportedclass)
- [\_\_tid\_Factory\_\_](ue_ue.WorldFactory.md#__tid_factory__)
- [\_\_tid\_Object\_\_](ue_ue.WorldFactory.md#__tid_object__)
- [\_\_tid\_WorldFactory\_\_](ue_ue.WorldFactory.md#__tid_worldfactory__)
- [bCreateNew](ue_ue.WorldFactory.md#bcreatenew)
- [bEditAfterNew](ue_ue.WorldFactory.md#beditafternew)
- [bEditorImport](ue_ue.WorldFactory.md#beditorimport)
- [bText](ue_ue.WorldFactory.md#btext)

### Methods

- [CreateDefaultSubobject](ue_ue.WorldFactory.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.WorldFactory.md#executeubergraph)
- [GetClass](ue_ue.WorldFactory.md#getclass)
- [GetName](ue_ue.WorldFactory.md#getname)
- [GetOuter](ue_ue.WorldFactory.md#getouter)
- [GetWorld](ue_ue.WorldFactory.md#getworld)
- [ScriptFactoryCanImport](ue_ue.WorldFactory.md#scriptfactorycanimport)
- [ScriptFactoryCreateFile](ue_ue.WorldFactory.md#scriptfactorycreatefile)
- [Find](ue_ue.WorldFactory.md#find)
- [Load](ue_ue.WorldFactory.md#load)
- [StaticClass](ue_ue.WorldFactory.md#staticclass)

## Constructors

### constructor

• **new WorldFactory**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:66556](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66556)
...
### \_\_tid\_WorldFactory\_\_

• **\_\_tid\_WorldFactory\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:66561](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66561)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`WorldFactory`](ue_ue.WorldFactory.md)
...
[ue/ue.d.ts:66558](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66558)

___

### Load

▸ `Static` **Load**(`InName`): [`WorldFactory`](ue_ue.WorldFactory.md)
...
[ue/ue.d.ts:66559](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66559)
...
[ue/ue.d.ts:66557](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66557)
