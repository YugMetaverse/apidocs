[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue](../modules/ue_ue.md) / WrangleContentCommandlet

# Class: WrangleContentCommandlet

[ue/ue](../modules/ue_ue.md).WrangleContentCommandlet
...
- [constructor](ue_ue.WrangleContentCommandlet.md#constructor)

### Properties

- [HelpDescription](ue_ue.WrangleContentCommandlet.md#helpdescription)
- [HelpParamDescriptions](ue_ue.WrangleContentCommandlet.md#helpparamdescriptions)
- [HelpParamNames](ue_ue.WrangleContentCommandlet.md#helpparamnames)
- [HelpUsage](ue_ue.WrangleContentCommandlet.md#helpusage)
- [HelpWebLink](ue_ue.WrangleContentCommandlet.md#helpweblink)
- [IsClient](ue_ue.WrangleContentCommandlet.md#isclient)
- [IsEditor](ue_ue.WrangleContentCommandlet.md#iseditor)
- [IsServer](ue_ue.WrangleContentCommandlet.md#isserver)
- [LogToConsole](ue_ue.WrangleContentCommandlet.md#logtoconsole)
- [ShowErrorCount](ue_ue.WrangleContentCommandlet.md#showerrorcount)
- [ShowProgress](ue_ue.WrangleContentCommandlet.md#showprogress)
- [\_\_tid\_Commandlet\_\_](ue_ue.WrangleContentCommandlet.md#__tid_commandlet__)
- [\_\_tid\_Object\_\_](ue_ue.WrangleContentCommandlet.md#__tid_object__)
- [\_\_tid\_WrangleContentCommandlet\_\_](ue_ue.WrangleContentCommandlet.md#__tid_wranglecontentcommandlet__)

### Methods

- [CreateDefaultSubobject](ue_ue.WrangleContentCommandlet.md#createdefaultsubobject)
- [ExecuteUbergraph](ue_ue.WrangleContentCommandlet.md#executeubergraph)
- [GetClass](ue_ue.WrangleContentCommandlet.md#getclass)
- [GetName](ue_ue.WrangleContentCommandlet.md#getname)
- [GetOuter](ue_ue.WrangleContentCommandlet.md#getouter)
- [GetWorld](ue_ue.WrangleContentCommandlet.md#getworld)
- [Find](ue_ue.WrangleContentCommandlet.md#find)
- [Load](ue_ue.WrangleContentCommandlet.md#load)
- [StaticClass](ue_ue.WrangleContentCommandlet.md#staticclass)

## Constructors

### constructor

• **new WrangleContentCommandlet**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue.d.ts:66589](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66589)
...
### \_\_tid\_WrangleContentCommandlet\_\_

• **\_\_tid\_WrangleContentCommandlet\_\_**: `boolean`

#### Defined in

[ue/ue.d.ts:66594](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66594)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`WrangleContentCommandlet`](ue_ue.WrangleContentCommandlet.md)
...
[ue/ue.d.ts:66591](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66591)

___

### Load

▸ `Static` **Load**(`InName`): [`WrangleContentCommandlet`](ue_ue.WrangleContentCommandlet.md)
...
[ue/ue.d.ts:66592](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66592)
...
[ue/ue.d.ts:66590](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue.d.ts#L66590)
