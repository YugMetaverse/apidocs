[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue\_bp](../modules/ue_ue_bp.md) / [Game](../modules/ue_ue_bp.Game.md) / [ActorComp](../modules/ue_ue_bp.Game.ActorComp.md) / ActorComp\_C

# Class: ActorComp\_C

[Game](../modules/ue_ue_bp.Game.md).[ActorComp](../modules/ue_ue_bp.Game.ActorComp.md).ActorComp_C
...
- [constructor](ue_ue_bp.Game.ActorComp.ActorComp_C.md#constructor)

### Properties

- [AssetUserData](ue_ue_bp.Game.ActorComp.ActorComp_C.md#assetuserdata)
- [ComponentTags](ue_ue_bp.Game.ActorComp.ActorComp_C.md#componenttags)
- [CreationMethod](ue_ue_bp.Game.ActorComp.ActorComp_C.md#creationmethod)
- [OnComponentActivated](ue_ue_bp.Game.ActorComp.ActorComp_C.md#oncomponentactivated)
- [OnComponentDeactivated](ue_ue_bp.Game.ActorComp.ActorComp_C.md#oncomponentdeactivated)
- [PrimaryComponentTick](ue_ue_bp.Game.ActorComp.ActorComp_C.md#primarycomponenttick)
- [UCSModifiedProperties](ue_ue_bp.Game.ActorComp.ActorComp_C.md#ucsmodifiedproperties)
- [UberGraphFrame](ue_ue_bp.Game.ActorComp.ActorComp_C.md#ubergraphframe)
- [\_\_tid\_ActorComp\_C\_\_](ue_ue_bp.Game.ActorComp.ActorComp_C.md#__tid_actorcomp_c__)
- [\_\_tid\_ActorComponent\_\_](ue_ue_bp.Game.ActorComp.ActorComp_C.md#__tid_actorcomponent__)
- [\_\_tid\_Object\_\_](ue_ue_bp.Game.ActorComp.ActorComp_C.md#__tid_object__)
- [bAutoActivate](ue_ue_bp.Game.ActorComp.ActorComp_C.md#bautoactivate)
- [bCanEverAffectNavigation](ue_ue_bp.Game.ActorComp.ActorComp_C.md#bcaneveraffectnavigation)
- [bCreatedByConstructionScript](ue_ue_bp.Game.ActorComp.ActorComp_C.md#bcreatedbyconstructionscript)
- [bEditableWhenInherited](ue_ue_bp.Game.ActorComp.ActorComp_C.md#beditablewheninherited)
- [bInstanceComponent](ue_ue_bp.Game.ActorComp.ActorComp_C.md#binstancecomponent)
- [bIsActive](ue_ue_bp.Game.ActorComp.ActorComp_C.md#bisactive)
- [bIsEditorOnly](ue_ue_bp.Game.ActorComp.ActorComp_C.md#biseditoronly)
- [bIsVisualizationComponent](ue_ue_bp.Game.ActorComp.ActorComp_C.md#bisvisualizationcomponent)
- [bNetAddressable](ue_ue_bp.Game.ActorComp.ActorComp_C.md#bnetaddressable)
- [bReplicates](ue_ue_bp.Game.ActorComp.ActorComp_C.md#breplicates)

### Methods

- [Activate](ue_ue_bp.Game.ActorComp.ActorComp_C.md#activate)
- [AddTickPrerequisiteActor](ue_ue_bp.Game.ActorComp.ActorComp_C.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue_bp.Game.ActorComp.ActorComp_C.md#addtickprerequisitecomponent)
- [ComponentHasTag](ue_ue_bp.Game.ActorComp.ActorComp_C.md#componenthastag)
- [CreateDefaultSubobject](ue_ue_bp.Game.ActorComp.ActorComp_C.md#createdefaultsubobject)
- [Deactivate](ue_ue_bp.Game.ActorComp.ActorComp_C.md#deactivate)
- [ExecuteUbergraph](ue_ue_bp.Game.ActorComp.ActorComp_C.md#executeubergraph)
- [ExecuteUbergraph\_ActorComp](ue_ue_bp.Game.ActorComp.ActorComp_C.md#executeubergraph_actorcomp)
- [GetClass](ue_ue_bp.Game.ActorComp.ActorComp_C.md#getclass)
- [GetComponentTickInterval](ue_ue_bp.Game.ActorComp.ActorComp_C.md#getcomponenttickinterval)
- [GetName](ue_ue_bp.Game.ActorComp.ActorComp_C.md#getname)
- [GetOuter](ue_ue_bp.Game.ActorComp.ActorComp_C.md#getouter)
- [GetOwner](ue_ue_bp.Game.ActorComp.ActorComp_C.md#getowner)
- [GetWorld](ue_ue_bp.Game.ActorComp.ActorComp_C.md#getworld)
- [IsActive](ue_ue_bp.Game.ActorComp.ActorComp_C.md#isactive)
- [IsBeingDestroyed](ue_ue_bp.Game.ActorComp.ActorComp_C.md#isbeingdestroyed)
- [IsComponentTickEnabled](ue_ue_bp.Game.ActorComp.ActorComp_C.md#iscomponenttickenabled)
- [K2\_DestroyComponent](ue_ue_bp.Game.ActorComp.ActorComp_C.md#k2_destroycomponent)
- [OnRep\_IsActive](ue_ue_bp.Game.ActorComp.ActorComp_C.md#onrep_isactive)
- [ReceiveBeginPlay](ue_ue_bp.Game.ActorComp.ActorComp_C.md#receivebeginplay)
- [ReceiveEndPlay](ue_ue_bp.Game.ActorComp.ActorComp_C.md#receiveendplay)
- [ReceiveTick](ue_ue_bp.Game.ActorComp.ActorComp_C.md#receivetick)
- [RegisterComponent](ue_ue_bp.Game.ActorComp.ActorComp_C.md#registercomponent)
- [RemoveTickPrerequisiteActor](ue_ue_bp.Game.ActorComp.ActorComp_C.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue_bp.Game.ActorComp.ActorComp_C.md#removetickprerequisitecomponent)
- [SetActive](ue_ue_bp.Game.ActorComp.ActorComp_C.md#setactive)
- [SetAutoActivate](ue_ue_bp.Game.ActorComp.ActorComp_C.md#setautoactivate)
- [SetComponentTickEnabled](ue_ue_bp.Game.ActorComp.ActorComp_C.md#setcomponenttickenabled)
- [SetComponentTickInterval](ue_ue_bp.Game.ActorComp.ActorComp_C.md#setcomponenttickinterval)
- [SetIsReplicated](ue_ue_bp.Game.ActorComp.ActorComp_C.md#setisreplicated)
- [SetTickGroup](ue_ue_bp.Game.ActorComp.ActorComp_C.md#settickgroup)
- [SetTickableWhenPaused](ue_ue_bp.Game.ActorComp.ActorComp_C.md#settickablewhenpaused)
- [ToggleActive](ue_ue_bp.Game.ActorComp.ActorComp_C.md#toggleactive)
- [Find](ue_ue_bp.Game.ActorComp.ActorComp_C.md#find)
- [Load](ue_ue_bp.Game.ActorComp.ActorComp_C.md#load)
- [StaticClass](ue_ue_bp.Game.ActorComp.ActorComp_C.md#staticclass)

## Constructors

### constructor

• **new ActorComp_C**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue_bp.d.ts:12](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L12)
...
[ue/ue_bp.d.ts:13](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L13)

___

### \_\_tid\_ActorComp\_C\_\_

• **\_\_tid\_ActorComp\_C\_\_**: `boolean`

#### Defined in

[ue/ue_bp.d.ts:20](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L20)
...
### ExecuteUbergraph\_ActorComp

▸ **ExecuteUbergraph_ActorComp**(`EntryPoint`): `void`
...
[ue/ue_bp.d.ts:14](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L14)
...
[ue/ue_bp.d.ts:15](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L15)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`ActorComp_C`](ue_ue_bp.Game.ActorComp.ActorComp_C.md)
...
[ue/ue_bp.d.ts:17](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L17)

___

### Load

▸ `Static` **Load**(`InName`): [`ActorComp_C`](ue_ue_bp.Game.ActorComp.ActorComp_C.md)
...
[ue/ue_bp.d.ts:18](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L18)
...
[ue/ue_bp.d.ts:16](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L16)
