[yug_typings](../README.md) / [Modules](../modules.md) / [ue/ue\_bp](../modules/ue_ue_bp.md) / [Game](../modules/ue_ue_bp.Game.md) / [Blueprints](../modules/ue_ue_bp.Game.Blueprints.md) / [TypeScript](../modules/ue_ue_bp.Game.Blueprints.TypeScript.md) / [TsTestActor](../modules/ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.md) / TsTestActor\_C

# Class: TsTestActor\_C

[TypeScript](../modules/ue_ue_bp.Game.Blueprints.TypeScript.md).[TsTestActor](../modules/ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.md).TsTestActor_C
...
- [constructor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#constructor)

### Properties

- [ActorLabel](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#actorlabel)
- [AttachmentReplication](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#attachmentreplication)
- [AutoReceiveInput](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#autoreceiveinput)
- [BlueprintCreatedComponents](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#blueprintcreatedcomponents)
- [Children](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#children)
- [ControllingMatineeActors](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#controllingmatineeactors)
- [CustomTimeDilation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#customtimedilation)
- [DefaultSceneRoot](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#defaultsceneroot)
- [DefaultUpdateOverlapsMethodDuringLevelStreaming](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#defaultupdateoverlapsmethodduringlevelstreaming)
- [FolderPath](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#folderpath)
- [GroupActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#groupactor)
- [HiddenEditorViews](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#hiddeneditorviews)
- [InitialLifeSpan](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#initiallifespan)
- [InputComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#inputcomponent)
- [InputPriority](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#inputpriority)
- [InstanceComponents](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#instancecomponents)
- [Instigator](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#instigator)
- [Layers](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#layers)
- [MinNetUpdateFrequency](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#minnetupdatefrequency)
- [NetCullDistanceSquared](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#netculldistancesquared)
- [NetDormancy](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#netdormancy)
- [NetDriverName](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#netdrivername)
- [NetPriority](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#netpriority)
- [NetTag](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#nettag)
- [NetUpdateFrequency](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#netupdatefrequency)
- [OnActorBeginOverlap](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onactorbeginoverlap)
- [OnActorEndOverlap](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onactorendoverlap)
- [OnActorHit](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onactorhit)
- [OnBeginCursorOver](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onbegincursorover)
- [OnClicked](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onclicked)
- [OnDestroyed](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ondestroyed)
- [OnEndCursorOver](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onendcursorover)
- [OnEndPlay](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onendplay)
- [OnInputTouchBegin](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#oninputtouchbegin)
- [OnInputTouchEnd](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#oninputtouchend)
- [OnInputTouchEnter](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#oninputtouchenter)
- [OnInputTouchLeave](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#oninputtouchleave)
- [OnReleased](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onreleased)
- [OnTakeAnyDamage](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ontakeanydamage)
- [OnTakePointDamage](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ontakepointdamage)
- [OnTakeRadialDamage](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ontakeradialdamage)
- [Owner](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#owner)
- [ParentComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#parentcomponent)
- [ParentComponentActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#parentcomponentactor)
- [PivotOffset](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#pivotoffset)
- [PrimaryActorTick](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#primaryactortick)
- [RemoteRole](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#remoterole)
- [ReplicatedMovement](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#replicatedmovement)
- [Role](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#role)
- [RootComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#rootcomponent)
- [SpawnCollisionHandlingMethod](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#spawncollisionhandlingmethod)
- [SpriteScale](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#spritescale)
- [Tags](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#tags)
- [UberGraphFrame](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ubergraphframe)
- [UpdateOverlapsMethodDuringLevelStreaming](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#updateoverlapsmethodduringlevelstreaming)
- [\_\_tid\_Actor\_\_](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#__tid_actor__)
- [\_\_tid\_Object\_\_](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#__tid_object__)
- [\_\_tid\_TsTestActor\_C\_\_](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#__tid_tstestactor_c__)
- [actor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#actor)
- [arr](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#arr)
- [b](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#b)
- [bActorEnableCollision](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bactorenablecollision)
- [bActorIsBeingDestroyed](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bactorisbeingdestroyed)
- [bActorLabelEditable](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bactorlabeleditable)
- [bActorSeamlessTraveled](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bactorseamlesstraveled)
- [bAllowReceiveTickEventOnDedicatedServer](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ballowreceivetickeventondedicatedserver)
- [bAllowTickBeforeBeginPlay](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ballowtickbeforebeginplay)
- [bAlwaysRelevant](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#balwaysrelevant)
- [bAutoDestroyWhenFinished](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bautodestroywhenfinished)
- [bBlockInput](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bblockinput)
- [bCanBeDamaged](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bcanbedamaged)
- [bCanBeInCluster](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bcanbeincluster)
- [bCollideWhenPlacing](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bcollidewhenplacing)
- [bEditable](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#beditable)
- [bEnableAutoLODGeneration](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#benableautolodgeneration)
- [bExchangedRoles](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bexchangedroles)
- [bFindCameraComponentWhenViewTarget](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bfindcameracomponentwhenviewtarget)
- [bGenerateOverlapEventsDuringLevelStreaming](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bgenerateoverlapeventsduringlevelstreaming)
- [bHidden](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bhidden)
- [bHiddenEd](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bhiddened)
- [bHiddenEdLayer](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bhiddenedlayer)
- [bHiddenEdLevel](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bhiddenedlevel)
- [bHiddenEdTemporary](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bhiddenedtemporary)
- [bIgnoresOriginShifting](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bignoresoriginshifting)
- [bIsEditorOnlyActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#biseditoronlyactor)
- [bIsEditorPreviewActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#biseditorpreviewactor)
- [bListedInSceneOutliner](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#blistedinsceneoutliner)
- [bLockLocation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#blocklocation)
- [bNetLoadOnClient](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bnetloadonclient)
- [bNetStartup](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bnetstartup)
- [bNetTemporary](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bnettemporary)
- [bNetUseOwnerRelevancy](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bnetuseownerrelevancy)
- [bOnlyRelevantToOwner](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#bonlyrelevanttoowner)
- [bOptimizeBPComponentData](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#boptimizebpcomponentdata)
- [bRelevantForLevelBounds](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#brelevantforlevelbounds)
- [bRelevantForNetworkReplays](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#brelevantfornetworkreplays)
- [bReplayRewindable](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#breplayrewindable)
- [bReplicateMovement](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#breplicatemovement)
- [bReplicates](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#breplicates)
- [bTearOff](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#btearoff)
- [cls](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#cls)
- [clsOfWidget](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#clsofwidget)
- [dint](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#dint)
- [e](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#e)
- [ea](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ea)
- [fname](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#fname)
- [int64\_1](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#int64_1)
- [int64\_2](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#int64_2)
- [map](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#map)
- [namearr](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#namearr)
- [set](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#set)
- [softClass](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#softclass)
- [softObject](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#softobject)
- [str](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#str)
- [tickCount](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#tickcount)
- [v](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#v)

### Methods

- [ActorHasTag](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#actorhastag)
- [Add](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#add)
- [AddComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#addcomponent)
- [AddTickPrerequisiteActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#addtickprerequisiteactor)
- [AddTickPrerequisiteComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#addtickprerequisitecomponent)
- [CreateDefaultSubobject](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#createdefaultsubobject)
- [DetachRootComponentFromParent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#detachrootcomponentfromparent)
- [DisableInput](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#disableinput)
- [EnableInput](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#enableinput)
- [ExecuteUbergraph](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#executeubergraph)
- [ExecuteUbergraph\_TsTestActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#executeubergraph_tstestactor)
- [Fire](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#fire)
- [FireServer](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#fireserver)
- [FlushNetDormancy](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#flushnetdormancy)
- [ForceNetUpdate](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#forcenetupdate)
- [GetActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactor)
- [GetActorBounds](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorbounds)
- [GetActorEnableCollision](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorenablecollision)
- [GetActorEyesViewPoint](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactoreyesviewpoint)
- [GetActorForwardVector](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorforwardvector)
- [GetActorLabel](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorlabel)
- [GetActorRelativeScale3D](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorrelativescale3d)
- [GetActorRightVector](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorrightvector)
- [GetActorScale3D](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorscale3d)
- [GetActorTickInterval](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactortickinterval)
- [GetActorTimeDilation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactortimedilation)
- [GetActorUpVector](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getactorupvector)
- [GetAllChildActors](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getallchildactors)
- [GetArray](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getarray)
- [GetAttachParentActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getattachparentactor)
- [GetAttachParentSocketName](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getattachparentsocketname)
- [GetAttachedActors](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getattachedactors)
- [GetClass](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getclass)
- [GetComponentByClass](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getcomponentbyclass)
- [GetComponentsByInterface](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getcomponentsbyinterface)
- [GetComponentsByTag](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getcomponentsbytag)
- [GetDistanceTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getdistanceto)
- [GetDotProductTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getdotproductto)
- [GetFolderPath](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getfolderpath)
- [GetGameTimeSinceCreation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getgametimesincecreation)
- [GetHorizontalDistanceTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#gethorizontaldistanceto)
- [GetHorizontalDotProductTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#gethorizontaldotproductto)
- [GetInputAxisKeyValue](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getinputaxiskeyvalue)
- [GetInputAxisValue](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getinputaxisvalue)
- [GetInputVectorAxisValue](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getinputvectoraxisvalue)
- [GetInstigator](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getinstigator)
- [GetInstigatorController](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getinstigatorcontroller)
- [GetLifeSpan](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getlifespan)
- [GetLocalRole](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getlocalrole)
- [GetMap](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getmap)
- [GetName](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getname)
- [GetOuter](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getouter)
- [GetOverlappingActors](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getoverlappingactors)
- [GetOverlappingComponents](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getoverlappingcomponents)
- [GetOwner](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getowner)
- [GetParentActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getparentactor)
- [GetParentComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getparentcomponent)
- [GetRemoteRole](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getremoterole)
- [GetSquaredDistanceTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getsquareddistanceto)
- [GetTickableWhenPaused](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#gettickablewhenpaused)
- [GetTransform](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#gettransform)
- [GetVelocity](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getvelocity)
- [GetVerticalDistanceTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getverticaldistanceto)
- [GetWorld](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#getworld)
- [HasAuthority](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#hasauthority)
- [IsActorBeingDestroyed](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#isactorbeingdestroyed)
- [IsActorTickEnabled](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#isactortickenabled)
- [IsChildActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ischildactor)
- [IsEditable](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#iseditable)
- [IsHiddenEd](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ishiddened)
- [IsHiddenEdAtStartup](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#ishiddenedatstartup)
- [IsOverlappingActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#isoverlappingactor)
- [IsSelectable](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#isselectable)
- [IsTemporarilyHiddenInEditor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#istemporarilyhiddenineditor)
- [K2\_AddActorLocalOffset](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_addactorlocaloffset)
- [K2\_AddActorLocalRotation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_addactorlocalrotation)
- [K2\_AddActorLocalTransform](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_addactorlocaltransform)
- [K2\_AddActorWorldOffset](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_addactorworldoffset)
- [K2\_AddActorWorldRotation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_addactorworldrotation)
- [K2\_AddActorWorldTransform](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_addactorworldtransform)
- [K2\_AttachRootComponentTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_attachrootcomponentto)
- [K2\_AttachRootComponentToActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_attachrootcomponenttoactor)
- [K2\_AttachToActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_attachtoactor)
- [K2\_AttachToComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_attachtocomponent)
- [K2\_DestroyActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_destroyactor)
- [K2\_DestroyComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_destroycomponent)
- [K2\_DetachFromActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_detachfromactor)
- [K2\_GetActorLocation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_getactorlocation)
- [K2\_GetActorRotation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_getactorrotation)
- [K2\_GetComponentsByClass](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_getcomponentsbyclass)
- [K2\_GetRootComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_getrootcomponent)
- [K2\_OnBecomeViewTarget](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_onbecomeviewtarget)
- [K2\_OnEndViewTarget](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_onendviewtarget)
- [K2\_OnReset](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_onreset)
- [K2\_SetActorLocation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactorlocation)
- [K2\_SetActorLocationAndRotation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactorlocationandrotation)
- [K2\_SetActorRelativeLocation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactorrelativelocation)
- [K2\_SetActorRelativeRotation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactorrelativerotation)
- [K2\_SetActorRelativeTransform](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactorrelativetransform)
- [K2\_SetActorRotation](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactorrotation)
- [K2\_SetActorTransform](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_setactortransform)
- [K2\_TeleportTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#k2_teleportto)
- [MakeMIDForMaterial](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#makemidformaterial)
- [MakeNoise](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#makenoise)
- [OnRep\_AttachmentReplication](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onrep_attachmentreplication)
- [OnRep\_Instigator](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onrep_instigator)
- [OnRep\_Owner](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onrep_owner)
- [OnRep\_ReplicateMovement](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onrep_replicatemovement)
- [OnRep\_ReplicatedMovement](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onrep_replicatedmovement)
- [OnRep\_dint](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#onrep_dint)
- [PrestreamTextures](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#prestreamtextures)
- [ReceiveActorBeginCursorOver](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactorbegincursorover)
- [ReceiveActorBeginOverlap](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactorbeginoverlap)
- [ReceiveActorEndCursorOver](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactorendcursorover)
- [ReceiveActorEndOverlap](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactorendoverlap)
- [ReceiveActorOnClicked](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactoronclicked)
- [ReceiveActorOnInputTouchBegin](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactoroninputtouchbegin)
- [ReceiveActorOnInputTouchEnd](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactoroninputtouchend)
- [ReceiveActorOnInputTouchEnter](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactoroninputtouchenter)
- [ReceiveActorOnInputTouchLeave](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactoroninputtouchleave)
- [ReceiveActorOnReleased](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveactoronreleased)
- [ReceiveAnyDamage](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveanydamage)
- [ReceiveBeginPlay](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receivebeginplay)
- [ReceiveDestroyed](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receivedestroyed)
- [ReceiveEndPlay](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveendplay)
- [ReceiveHit](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receivehit)
- [ReceivePointDamage](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receivepointdamage)
- [ReceiveRadialDamage](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receiveradialdamage)
- [ReceiveTick](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#receivetick)
- [RemoveTickPrerequisiteActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#removetickprerequisiteactor)
- [RemoveTickPrerequisiteComponent](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#removetickprerequisitecomponent)
- [SetActor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactor)
- [SetActorEnableCollision](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactorenablecollision)
- [SetActorHiddenInGame](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactorhiddeningame)
- [SetActorLabel](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactorlabel)
- [SetActorRelativeScale3D](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactorrelativescale3d)
- [SetActorScale3D](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactorscale3d)
- [SetActorTickEnabled](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactortickenabled)
- [SetActorTickInterval](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setactortickinterval)
- [SetArray](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setarray)
- [SetFolderPath](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setfolderpath)
- [SetIsTemporarilyHiddenInEditor](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setistemporarilyhiddenineditor)
- [SetLifeSpan](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setlifespan)
- [SetNetDormancy](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setnetdormancy)
- [SetOwner](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setowner)
- [SetReplicateMovement](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setreplicatemovement)
- [SetReplicates](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#setreplicates)
- [SetTickGroup](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#settickgroup)
- [SetTickableWhenPaused](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#settickablewhenpaused)
- [SnapRootComponentTo](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#snaprootcomponentto)
- [TearOff](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#tearoff)
- [TestCppType](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#testcpptype)
- [UserConstructionScript](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#userconstructionscript)
- [WasRecentlyRendered](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#wasrecentlyrendered)
- [Find](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#find)
- [Load](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#load)
- [StaticClass](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md#staticclass)

## Constructors

### constructor

• **new TsTestActor_C**(`Outer?`, `Name?`, `ObjectFlags?`)
...
[ue/ue_bp.d.ts:118](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L118)
...
[ue/ue_bp.d.ts:120](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L120)
...
[ue/ue_bp.d.ts:119](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L119)
...
### \_\_tid\_TsTestActor\_C\_\_

• **\_\_tid\_TsTestActor\_C\_\_**: `boolean`

#### Defined in

[ue/ue_bp.d.ts:157](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L157)
...
[ue/ue_bp.d.ts:122](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L122)

___

### arr

• **arr**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Object`](ue_ue.Object.md)\>

#### Defined in

[ue/ue_bp.d.ts:130](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L130)
...
[ue/ue_bp.d.ts:124](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L124)
...
• **cls**: [`Class`](ue_ue.Class.md)

#### Defined in

[ue/ue_bp.d.ts:123](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L123)

___

### clsOfWidget

• **clsOfWidget**: [`Class`](ue_ue.Class.md)

#### Defined in

[ue/ue_bp.d.ts:137](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L137)
...
[ue/ue_bp.d.ts:134](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L134)

___

### e

• **e**: [`ETickingGroup`](../enums/ue_ue.ETickingGroup.md)

#### Defined in

[ue/ue_bp.d.ts:135](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L135)

___

### ea

• **ea**: [`TArray`](../interfaces/ue_puerts.TArray.md)<[`ETickingGroup`](../enums/ue_ue.ETickingGroup.md)\>

#### Defined in

[ue/ue_bp.d.ts:136](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L136)
...
[ue/ue_bp.d.ts:132](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L132)
...
[ue/ue_bp.d.ts:125](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L125)
...
[ue/ue_bp.d.ts:126](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L126)

___

### map

• **map**: [`TMap`](../interfaces/ue_puerts.TMap.md)<`string`, `number`\>

#### Defined in

[ue/ue_bp.d.ts:129](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L129)

___

### namearr

• **namearr**: [`TArray`](../interfaces/ue_puerts.TArray.md)<`string`\>

#### Defined in

[ue/ue_bp.d.ts:133](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L133)

___

### set

• **set**: [`TSet`](../interfaces/ue_puerts.TSet.md)<`string`\>

#### Defined in

[ue/ue_bp.d.ts:131](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L131)

___

### softClass

• **softClass**: [`TSoftClassPtr`](../modules/ue_puerts.md#tsoftclassptr)<[`Actor`](ue_ue.Actor.md)\>

#### Defined in

[ue/ue_bp.d.ts:139](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L139)

___

### softObject

• **softObject**: [`TSoftObjectPtr`](../modules/ue_puerts.md#tsoftobjectptr)<[`Actor`](ue_ue.Actor.md)\>

#### Defined in

[ue/ue_bp.d.ts:138](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L138)
...
[ue/ue_bp.d.ts:127](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L127)
...
[ue/ue_bp.d.ts:121](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L121)
...
[ue/ue_bp.d.ts:128](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L128)
...
[ue/ue_bp.d.ts:140](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L140)
...
### ExecuteUbergraph\_TsTestActor

▸ **ExecuteUbergraph_TsTestActor**(`EntryPoint`): `void`
...
[ue/ue_bp.d.ts:141](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L141)
...
[ue/ue_bp.d.ts:142](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L142)
...
[ue/ue_bp.d.ts:143](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L143)
...
[ue/ue_bp.d.ts:144](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L144)
...
▸ **GetArray**(): [`TArray`](../interfaces/ue_puerts.TArray.md)<[`Object`](ue_ue.Object.md)\>
...
[ue/ue_bp.d.ts:145](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L145)
...
▸ **GetMap**(): [`TMap`](../interfaces/ue_puerts.TMap.md)<`string`, `number`\>

#### Returns

[`TMap`](../interfaces/ue_puerts.TMap.md)<`string`, `number`\>

#### Defined in

[ue/ue_bp.d.ts:146](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L146)
...
[ue/ue_bp.d.ts:147](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L147)
...
[ue/ue_bp.d.ts:148](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L148)
...
[ue/ue_bp.d.ts:149](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L149)
...
| Name | Type |
| :------ | :------ |
| `p1` | [`$Nullable`](../modules/puerts.md#$nullable)<[`Actor`](ue_ue.Actor.md)\> |
...
[ue/ue_bp.d.ts:150](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L150)
...
| Name | Type |
| :------ | :------ |
| `p` | [`$Ref`](../interfaces/puerts._Ref.md)<[`TArray`](../interfaces/ue_puerts.TArray.md)<[`Object`](ue_ue.Object.md)\>\> |
...
[ue/ue_bp.d.ts:151](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L151)
...
[ue/ue_bp.d.ts:152](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L152)
...
▸ `Static` **Find**(`OrigInName`, `Outer?`): [`TsTestActor_C`](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md)
...
[ue/ue_bp.d.ts:154](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L154)

___

### Load

▸ `Static` **Load**(`InName`): [`TsTestActor_C`](ue_ue_bp.Game.Blueprints.TypeScript.TsTestActor.TsTestActor_C.md)
...
[ue/ue_bp.d.ts:155](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L155)
...
[ue/ue_bp.d.ts:153](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/ue/ue_bp.d.ts#L153)
