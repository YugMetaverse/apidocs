[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / BackgroundBlurProps

# Interface: BackgroundBlurProps

[react-umg](../modules/react_umg.md).BackgroundBlurProps
...
- [AccessibleBehavior](react_umg.BackgroundBlurProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.BackgroundBlurProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.BackgroundBlurProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.BackgroundBlurProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.BackgroundBlurProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.BackgroundBlurProps.md#accessibletextdelegate)
- [BlurRadius](react_umg.BackgroundBlurProps.md#blurradius)
- [BlurStrength](react_umg.BackgroundBlurProps.md#blurstrength)
- [CategoryName](react_umg.BackgroundBlurProps.md#categoryname)
- [Clipping](react_umg.BackgroundBlurProps.md#clipping)
- [Cursor](react_umg.BackgroundBlurProps.md#cursor)
- [DesignerFlags](react_umg.BackgroundBlurProps.md#designerflags)
- [DisplayLabel](react_umg.BackgroundBlurProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.BackgroundBlurProps.md#flowdirectionpreference)
- [HorizontalAlignment](react_umg.BackgroundBlurProps.md#horizontalalignment)
- [LowQualityFallbackBrush](react_umg.BackgroundBlurProps.md#lowqualityfallbackbrush)
- [Padding](react_umg.BackgroundBlurProps.md#padding)
- [RenderOpacity](react_umg.BackgroundBlurProps.md#renderopacity)
- [RenderTransform](react_umg.BackgroundBlurProps.md#rendertransform)
- [RenderTransformPivot](react_umg.BackgroundBlurProps.md#rendertransformpivot)
- [Slot](react_umg.BackgroundBlurProps.md#slot)
- [ToolTipText](react_umg.BackgroundBlurProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.BackgroundBlurProps.md#tooltiptextdelegate)
- [VerticalAlignment](react_umg.BackgroundBlurProps.md#verticalalignment)
- [Visibility](react_umg.BackgroundBlurProps.md#visibility)
- [VisibilityDelegate](react_umg.BackgroundBlurProps.md#visibilitydelegate)
- [bApplyAlphaToBlur](react_umg.BackgroundBlurProps.md#bapplyalphatoblur)
- [bCanChildrenBeAccessible](react_umg.BackgroundBlurProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.BackgroundBlurProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.BackgroundBlurProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.BackgroundBlurProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.BackgroundBlurProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.BackgroundBlurProps.md#bisenableddelegate)
- [bIsVariable](react_umg.BackgroundBlurProps.md#bisvariable)
- [bIsVolatile](react_umg.BackgroundBlurProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.BackgroundBlurProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.BackgroundBlurProps.md#boverrideaccessibledefaults)
- [bOverrideAutoRadiusCalculation](react_umg.BackgroundBlurProps.md#boverrideautoradiuscalculation)
- [bOverride\_Cursor](react_umg.BackgroundBlurProps.md#boverride_cursor)
...
[react-umg/index.d.ts:222](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L222)

___

### BlurStrength

• `Optional` **BlurStrength**: `number`

#### Defined in

[react-umg/index.d.ts:220](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L220)
...
[react-umg/index.d.ts:217](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L217)

___

### LowQualityFallbackBrush

• `Optional` **LowQualityFallbackBrush**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`SlateBrush`](../classes/ue_ue.SlateBrush.md)\>

#### Defined in

[react-umg/index.d.ts:223](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L223)
...
[react-umg/index.d.ts:216](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L216)
...
[react-umg/index.d.ts:218](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L218)
...
• `Optional` **bApplyAlphaToBlur**: `boolean`

#### Defined in

[react-umg/index.d.ts:219](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L219)
...
• `Optional` **bOverrideAutoRadiusCalculation**: `boolean`

#### Defined in

[react-umg/index.d.ts:221](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L221)
