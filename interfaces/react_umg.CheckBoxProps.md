[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / CheckBoxProps

# Interface: CheckBoxProps

[react-umg](../modules/react_umg.md).CheckBoxProps
...
- [AccessibleBehavior](react_umg.CheckBoxProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.CheckBoxProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.CheckBoxProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.CheckBoxProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.CheckBoxProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.CheckBoxProps.md#accessibletextdelegate)
- [BorderBackgroundColor](react_umg.CheckBoxProps.md#borderbackgroundcolor)
- [CategoryName](react_umg.CheckBoxProps.md#categoryname)
- [CheckedState](react_umg.CheckBoxProps.md#checkedstate)
- [CheckedStateDelegate](react_umg.CheckBoxProps.md#checkedstatedelegate)
- [Clipping](react_umg.CheckBoxProps.md#clipping)
- [Cursor](react_umg.CheckBoxProps.md#cursor)
- [DesignerFlags](react_umg.CheckBoxProps.md#designerflags)
- [DisplayLabel](react_umg.CheckBoxProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.CheckBoxProps.md#flowdirectionpreference)
- [HorizontalAlignment](react_umg.CheckBoxProps.md#horizontalalignment)
- [IsFocusable](react_umg.CheckBoxProps.md#isfocusable)
- [OnCheckStateChanged](react_umg.CheckBoxProps.md#oncheckstatechanged)
- [Padding](react_umg.CheckBoxProps.md#padding)
- [RenderOpacity](react_umg.CheckBoxProps.md#renderopacity)
- [RenderTransform](react_umg.CheckBoxProps.md#rendertransform)
- [RenderTransformPivot](react_umg.CheckBoxProps.md#rendertransformpivot)
- [Slot](react_umg.CheckBoxProps.md#slot)
- [ToolTipText](react_umg.CheckBoxProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.CheckBoxProps.md#tooltiptextdelegate)
- [Visibility](react_umg.CheckBoxProps.md#visibility)
- [VisibilityDelegate](react_umg.CheckBoxProps.md#visibilitydelegate)
- [WidgetStyle](react_umg.CheckBoxProps.md#widgetstyle)
- [bCanChildrenBeAccessible](react_umg.CheckBoxProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.CheckBoxProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.CheckBoxProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.CheckBoxProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.CheckBoxProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.CheckBoxProps.md#bisenableddelegate)
- [bIsVariable](react_umg.CheckBoxProps.md#bisvariable)
- [bIsVolatile](react_umg.CheckBoxProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.CheckBoxProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.CheckBoxProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.CheckBoxProps.md#boverride_cursor)
...
• `Optional` **BorderBackgroundColor**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`SlateColor`](../classes/ue_ue.SlateColor.md)\>

#### Defined in

[react-umg/index.d.ts:285](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L285)
...
• `Optional` **CheckedState**: [`ECheckBoxState`](../enums/ue_ue.ECheckBoxState.md)

#### Defined in

[react-umg/index.d.ts:280](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L280)

___

### CheckedStateDelegate

• `Optional` **CheckedStateDelegate**: () => [`ECheckBoxState`](../enums/ue_ue.ECheckBoxState.md)
...
[react-umg/index.d.ts:281](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L281)
...
[react-umg/index.d.ts:283](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L283)
...
[react-umg/index.d.ts:286](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L286)

___

### OnCheckStateChanged

• `Optional` **OnCheckStateChanged**: (`bIsChecked`: `boolean`) => `void`
...
[react-umg/index.d.ts:287](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L287)
...
[react-umg/index.d.ts:284](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L284)
...
• `Optional` **WidgetStyle**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`CheckBoxStyle`](../classes/ue_ue.CheckBoxStyle.md)\>

#### Defined in

[react-umg/index.d.ts:282](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L282)
