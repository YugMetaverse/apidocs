[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / CircularThrobberProps

# Interface: CircularThrobberProps

[react-umg](../modules/react_umg.md).CircularThrobberProps

## Hierarchy

- [`WidgetProps`](react_umg.WidgetProps.md)

  ↳ **`CircularThrobberProps`**

## Table of contents

### Properties

- [AccessibleBehavior](react_umg.CircularThrobberProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.CircularThrobberProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.CircularThrobberProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.CircularThrobberProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.CircularThrobberProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.CircularThrobberProps.md#accessibletextdelegate)
- [CategoryName](react_umg.CircularThrobberProps.md#categoryname)
- [Clipping](react_umg.CircularThrobberProps.md#clipping)
- [Cursor](react_umg.CircularThrobberProps.md#cursor)
- [DesignerFlags](react_umg.CircularThrobberProps.md#designerflags)
- [DisplayLabel](react_umg.CircularThrobberProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.CircularThrobberProps.md#flowdirectionpreference)
- [Image](react_umg.CircularThrobberProps.md#image)
- [NumberOfPieces](react_umg.CircularThrobberProps.md#numberofpieces)
- [Period](react_umg.CircularThrobberProps.md#period)
- [Radius](react_umg.CircularThrobberProps.md#radius)
- [RenderOpacity](react_umg.CircularThrobberProps.md#renderopacity)
- [RenderTransform](react_umg.CircularThrobberProps.md#rendertransform)
- [RenderTransformPivot](react_umg.CircularThrobberProps.md#rendertransformpivot)
- [Slot](react_umg.CircularThrobberProps.md#slot)
- [ToolTipText](react_umg.CircularThrobberProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.CircularThrobberProps.md#tooltiptextdelegate)
- [Visibility](react_umg.CircularThrobberProps.md#visibility)
- [VisibilityDelegate](react_umg.CircularThrobberProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.CircularThrobberProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.CircularThrobberProps.md#bcreatedbyconstructionscript)
- [bEnableRadius](react_umg.CircularThrobberProps.md#benableradius)
- [bExpandedInDesigner](react_umg.CircularThrobberProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.CircularThrobberProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.CircularThrobberProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.CircularThrobberProps.md#bisenableddelegate)
- [bIsVariable](react_umg.CircularThrobberProps.md#bisvariable)
- [bIsVolatile](react_umg.CircularThrobberProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.CircularThrobberProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.CircularThrobberProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.CircularThrobberProps.md#boverride_cursor)
...
• `Optional` **Image**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`SlateBrush`](../classes/ue_ue.SlateBrush.md)\>

#### Defined in

[react-umg/index.d.ts:298](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L298)

___

### NumberOfPieces

• `Optional` **NumberOfPieces**: `number`

#### Defined in

[react-umg/index.d.ts:295](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L295)
...
[react-umg/index.d.ts:296](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L296)
...
[react-umg/index.d.ts:297](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L297)
...
• `Optional` **bEnableRadius**: `boolean`

#### Defined in

[react-umg/index.d.ts:299](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L299)
