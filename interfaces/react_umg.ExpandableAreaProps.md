[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / ExpandableAreaProps

# Interface: ExpandableAreaProps

[react-umg](../modules/react_umg.md).ExpandableAreaProps
...
- [AccessibleBehavior](react_umg.ExpandableAreaProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.ExpandableAreaProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.ExpandableAreaProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.ExpandableAreaProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.ExpandableAreaProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.ExpandableAreaProps.md#accessibletextdelegate)
- [AreaPadding](react_umg.ExpandableAreaProps.md#areapadding)
- [BorderBrush](react_umg.ExpandableAreaProps.md#borderbrush)
- [BorderColor](react_umg.ExpandableAreaProps.md#bordercolor)
- [CategoryName](react_umg.ExpandableAreaProps.md#categoryname)
- [Clipping](react_umg.ExpandableAreaProps.md#clipping)
- [Cursor](react_umg.ExpandableAreaProps.md#cursor)
- [DesignerFlags](react_umg.ExpandableAreaProps.md#designerflags)
- [DisplayLabel](react_umg.ExpandableAreaProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.ExpandableAreaProps.md#flowdirectionpreference)
- [HeaderPadding](react_umg.ExpandableAreaProps.md#headerpadding)
- [MaxHeight](react_umg.ExpandableAreaProps.md#maxheight)
- [RenderOpacity](react_umg.ExpandableAreaProps.md#renderopacity)
- [RenderTransform](react_umg.ExpandableAreaProps.md#rendertransform)
- [RenderTransformPivot](react_umg.ExpandableAreaProps.md#rendertransformpivot)
- [Slot](react_umg.ExpandableAreaProps.md#slot)
- [Style](react_umg.ExpandableAreaProps.md#style)
- [ToolTipText](react_umg.ExpandableAreaProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.ExpandableAreaProps.md#tooltiptextdelegate)
- [Visibility](react_umg.ExpandableAreaProps.md#visibility)
- [VisibilityDelegate](react_umg.ExpandableAreaProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.ExpandableAreaProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.ExpandableAreaProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.ExpandableAreaProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.ExpandableAreaProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.ExpandableAreaProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.ExpandableAreaProps.md#bisenableddelegate)
- [bIsExpanded](react_umg.ExpandableAreaProps.md#bisexpanded)
- [bIsVariable](react_umg.ExpandableAreaProps.md#bisvariable)
- [bIsVolatile](react_umg.ExpandableAreaProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.ExpandableAreaProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.ExpandableAreaProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.ExpandableAreaProps.md#boverride_cursor)
...
• `Optional` **AreaPadding**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`Margin`](../classes/ue_ue.Margin.md)\>

#### Defined in

[react-umg/index.d.ts:427](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L427)

___

### BorderBrush

• `Optional` **BorderBrush**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`SlateBrush`](../classes/ue_ue.SlateBrush.md)\>

#### Defined in

[react-umg/index.d.ts:422](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L422)

___

### BorderColor

• `Optional` **BorderColor**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`SlateColor`](../classes/ue_ue.SlateColor.md)\>

#### Defined in

[react-umg/index.d.ts:423](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L423)
...
• `Optional` **HeaderPadding**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`Margin`](../classes/ue_ue.Margin.md)\>

#### Defined in

[react-umg/index.d.ts:426](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L426)
...
[react-umg/index.d.ts:425](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L425)
...
• `Optional` **Style**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`ExpandableAreaStyle`](../classes/ue_ue.ExpandableAreaStyle.md)\>

#### Defined in

[react-umg/index.d.ts:421](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L421)
...
• `Optional` **bIsExpanded**: `boolean`

#### Defined in

[react-umg/index.d.ts:424](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L424)
