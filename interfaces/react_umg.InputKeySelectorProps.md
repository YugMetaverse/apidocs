[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / InputKeySelectorProps

# Interface: InputKeySelectorProps

[react-umg](../modules/react_umg.md).InputKeySelectorProps
...
- [AccessibleBehavior](react_umg.InputKeySelectorProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.InputKeySelectorProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.InputKeySelectorProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.InputKeySelectorProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.InputKeySelectorProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.InputKeySelectorProps.md#accessibletextdelegate)
- [CategoryName](react_umg.InputKeySelectorProps.md#categoryname)
- [Clipping](react_umg.InputKeySelectorProps.md#clipping)
- [ColorAndOpacity](react_umg.InputKeySelectorProps.md#colorandopacity)
- [Cursor](react_umg.InputKeySelectorProps.md#cursor)
- [DesignerFlags](react_umg.InputKeySelectorProps.md#designerflags)
- [DisplayLabel](react_umg.InputKeySelectorProps.md#displaylabel)
- [EscapeKeys](react_umg.InputKeySelectorProps.md#escapekeys)
- [FlowDirectionPreference](react_umg.InputKeySelectorProps.md#flowdirectionpreference)
- [Font](react_umg.InputKeySelectorProps.md#font)
- [KeySelectionText](react_umg.InputKeySelectorProps.md#keyselectiontext)
- [Margin](react_umg.InputKeySelectorProps.md#margin)
- [NoKeySpecifiedText](react_umg.InputKeySelectorProps.md#nokeyspecifiedtext)
- [OnIsSelectingKeyChanged](react_umg.InputKeySelectorProps.md#onisselectingkeychanged)
- [OnKeySelected](react_umg.InputKeySelectorProps.md#onkeyselected)
- [RenderOpacity](react_umg.InputKeySelectorProps.md#renderopacity)
- [RenderTransform](react_umg.InputKeySelectorProps.md#rendertransform)
- [RenderTransformPivot](react_umg.InputKeySelectorProps.md#rendertransformpivot)
- [SelectedKey](react_umg.InputKeySelectorProps.md#selectedkey)
- [Slot](react_umg.InputKeySelectorProps.md#slot)
- [TextStyle](react_umg.InputKeySelectorProps.md#textstyle)
- [ToolTipText](react_umg.InputKeySelectorProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.InputKeySelectorProps.md#tooltiptextdelegate)
- [Visibility](react_umg.InputKeySelectorProps.md#visibility)
- [VisibilityDelegate](react_umg.InputKeySelectorProps.md#visibilitydelegate)
- [WidgetStyle](react_umg.InputKeySelectorProps.md#widgetstyle)
- [bAllowGamepadKeys](react_umg.InputKeySelectorProps.md#ballowgamepadkeys)
- [bAllowModifierKeys](react_umg.InputKeySelectorProps.md#ballowmodifierkeys)
- [bCanChildrenBeAccessible](react_umg.InputKeySelectorProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.InputKeySelectorProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.InputKeySelectorProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.InputKeySelectorProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.InputKeySelectorProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.InputKeySelectorProps.md#bisenableddelegate)
- [bIsVariable](react_umg.InputKeySelectorProps.md#bisvariable)
- [bIsVolatile](react_umg.InputKeySelectorProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.InputKeySelectorProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.InputKeySelectorProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.InputKeySelectorProps.md#boverride_cursor)
...
[react-umg/index.d.ts:469](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L469)
...
• `Optional` **EscapeKeys**: [`TArray`](../modules/react_umg.md#tarray)<[`Key`](../classes/ue_ue.Key.md)\>

#### Defined in

[react-umg/index.d.ts:474](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L474)
...
[react-umg/index.d.ts:467](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L467)

___

### KeySelectionText

• `Optional` **KeySelectionText**: `string`

#### Defined in

[react-umg/index.d.ts:470](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L470)
...
[react-umg/index.d.ts:468](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L468)

___

### NoKeySpecifiedText

• `Optional` **NoKeySpecifiedText**: `string`

#### Defined in

[react-umg/index.d.ts:471](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L471)

___

### OnIsSelectingKeyChanged

• `Optional` **OnIsSelectingKeyChanged**: () => `void`
...
[react-umg/index.d.ts:476](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L476)

___

### OnKeySelected

• `Optional` **OnKeySelected**: (`SelectedKey`: [`InputChord`](../classes/ue_ue.InputChord.md)) => `void`
...
| Name | Type |
| :------ | :------ |
| `SelectedKey` | [`InputChord`](../classes/ue_ue.InputChord.md) |
...
[react-umg/index.d.ts:475](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L475)
...
• `Optional` **SelectedKey**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`InputChord`](../classes/ue_ue.InputChord.md)\>

#### Defined in

[react-umg/index.d.ts:466](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L466)
...
[react-umg/index.d.ts:465](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L465)
...
• `Optional` **WidgetStyle**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`ButtonStyle`](../classes/ue_ue.ButtonStyle.md)\>

#### Defined in

[react-umg/index.d.ts:464](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L464)

___

### bAllowGamepadKeys

• `Optional` **bAllowGamepadKeys**: `boolean`

#### Defined in

[react-umg/index.d.ts:473](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L473)

___

### bAllowModifierKeys

• `Optional` **bAllowModifierKeys**: `boolean`

#### Defined in

[react-umg/index.d.ts:472](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L472)
