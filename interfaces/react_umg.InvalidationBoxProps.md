[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / InvalidationBoxProps

# Interface: InvalidationBoxProps

[react-umg](../modules/react_umg.md).InvalidationBoxProps

## Hierarchy

- [`ContentWidgetProps`](react_umg.ContentWidgetProps.md)

  ↳ **`InvalidationBoxProps`**

## Table of contents

### Properties

- [AccessibleBehavior](react_umg.InvalidationBoxProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.InvalidationBoxProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.InvalidationBoxProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.InvalidationBoxProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.InvalidationBoxProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.InvalidationBoxProps.md#accessibletextdelegate)
- [CacheRelativeTransforms](react_umg.InvalidationBoxProps.md#cacherelativetransforms)
- [CategoryName](react_umg.InvalidationBoxProps.md#categoryname)
- [Clipping](react_umg.InvalidationBoxProps.md#clipping)
- [Cursor](react_umg.InvalidationBoxProps.md#cursor)
- [DesignerFlags](react_umg.InvalidationBoxProps.md#designerflags)
- [DisplayLabel](react_umg.InvalidationBoxProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.InvalidationBoxProps.md#flowdirectionpreference)
- [RenderOpacity](react_umg.InvalidationBoxProps.md#renderopacity)
- [RenderTransform](react_umg.InvalidationBoxProps.md#rendertransform)
- [RenderTransformPivot](react_umg.InvalidationBoxProps.md#rendertransformpivot)
- [Slot](react_umg.InvalidationBoxProps.md#slot)
- [ToolTipText](react_umg.InvalidationBoxProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.InvalidationBoxProps.md#tooltiptextdelegate)
- [Visibility](react_umg.InvalidationBoxProps.md#visibility)
- [VisibilityDelegate](react_umg.InvalidationBoxProps.md#visibilitydelegate)
- [bCanCache](react_umg.InvalidationBoxProps.md#bcancache)
- [bCanChildrenBeAccessible](react_umg.InvalidationBoxProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.InvalidationBoxProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.InvalidationBoxProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.InvalidationBoxProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.InvalidationBoxProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.InvalidationBoxProps.md#bisenableddelegate)
- [bIsVariable](react_umg.InvalidationBoxProps.md#bisvariable)
- [bIsVolatile](react_umg.InvalidationBoxProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.InvalidationBoxProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.InvalidationBoxProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.InvalidationBoxProps.md#boverride_cursor)
...
• `Optional` **CacheRelativeTransforms**: `boolean`

#### Defined in

[react-umg/index.d.ts:485](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L485)
...
• `Optional` **bCanCache**: `boolean`

#### Defined in

[react-umg/index.d.ts:484](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L484)
