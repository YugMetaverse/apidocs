[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / MenuAnchorProps

# Interface: MenuAnchorProps

[react-umg](../modules/react_umg.md).MenuAnchorProps
...
- [AccessibleBehavior](react_umg.MenuAnchorProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.MenuAnchorProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.MenuAnchorProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.MenuAnchorProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.MenuAnchorProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.MenuAnchorProps.md#accessibletextdelegate)
- [CategoryName](react_umg.MenuAnchorProps.md#categoryname)
- [Clipping](react_umg.MenuAnchorProps.md#clipping)
- [Cursor](react_umg.MenuAnchorProps.md#cursor)
- [DesignerFlags](react_umg.MenuAnchorProps.md#designerflags)
- [DisplayLabel](react_umg.MenuAnchorProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.MenuAnchorProps.md#flowdirectionpreference)
- [OnMenuOpenChanged](react_umg.MenuAnchorProps.md#onmenuopenchanged)
- [Placement](react_umg.MenuAnchorProps.md#placement)
- [RenderOpacity](react_umg.MenuAnchorProps.md#renderopacity)
- [RenderTransform](react_umg.MenuAnchorProps.md#rendertransform)
- [RenderTransformPivot](react_umg.MenuAnchorProps.md#rendertransformpivot)
- [ShouldDeferPaintingAfterWindowContent](react_umg.MenuAnchorProps.md#shoulddeferpaintingafterwindowcontent)
- [Slot](react_umg.MenuAnchorProps.md#slot)
- [ToolTipText](react_umg.MenuAnchorProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.MenuAnchorProps.md#tooltiptextdelegate)
- [UseApplicationMenuStack](react_umg.MenuAnchorProps.md#useapplicationmenustack)
- [Visibility](react_umg.MenuAnchorProps.md#visibility)
- [VisibilityDelegate](react_umg.MenuAnchorProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.MenuAnchorProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.MenuAnchorProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.MenuAnchorProps.md#bexpandedindesigner)
- [bFitInWindow](react_umg.MenuAnchorProps.md#bfitinwindow)
- [bHiddenInDesigner](react_umg.MenuAnchorProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.MenuAnchorProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.MenuAnchorProps.md#bisenableddelegate)
- [bIsVariable](react_umg.MenuAnchorProps.md#bisvariable)
- [bIsVolatile](react_umg.MenuAnchorProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.MenuAnchorProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.MenuAnchorProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.MenuAnchorProps.md#boverride_cursor)
...
• `Optional` **OnMenuOpenChanged**: (`bIsOpen`: `boolean`) => `void`
...
[react-umg/index.d.ts:524](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L524)

___

### Placement

• `Optional` **Placement**: [`EMenuPlacement`](../enums/ue_ue.EMenuPlacement.md)

#### Defined in

[react-umg/index.d.ts:520](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L520)
...
• `Optional` **ShouldDeferPaintingAfterWindowContent**: `boolean`

#### Defined in

[react-umg/index.d.ts:522](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L522)
...
• `Optional` **UseApplicationMenuStack**: `boolean`

#### Defined in

[react-umg/index.d.ts:523](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L523)
...
• `Optional` **bFitInWindow**: `boolean`

#### Defined in

[react-umg/index.d.ts:521](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L521)
