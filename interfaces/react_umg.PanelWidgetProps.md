[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / PanelWidgetProps

# Interface: PanelWidgetProps

[react-umg](../modules/react_umg.md).PanelWidgetProps
...
- [`WidgetProps`](react_umg.WidgetProps.md)
  ...
  ↳↳ [`CanvasPanelProps`](react_umg.CanvasPanelProps.md)

  ↳↳ [`GridPanelProps`](react_umg.GridPanelProps.md)

  ↳↳ [`HorizontalBoxProps`](react_umg.HorizontalBoxProps.md)

  ↳↳ [`OverlayProps`](react_umg.OverlayProps.md)

  ↳↳ [`ScrollBoxProps`](react_umg.ScrollBoxProps.md)

  ↳↳ [`UniformGridPanelProps`](react_umg.UniformGridPanelProps.md)

  ↳↳ [`VerticalBoxProps`](react_umg.VerticalBoxProps.md)

  ↳↳ [`WidgetSwitcherProps`](react_umg.WidgetSwitcherProps.md)

  ↳↳ [`WrapBoxProps`](react_umg.WrapBoxProps.md)

## Table of contents

### Properties

- [AccessibleBehavior](react_umg.PanelWidgetProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.PanelWidgetProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.PanelWidgetProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.PanelWidgetProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.PanelWidgetProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.PanelWidgetProps.md#accessibletextdelegate)
- [CategoryName](react_umg.PanelWidgetProps.md#categoryname)
- [Clipping](react_umg.PanelWidgetProps.md#clipping)
- [Cursor](react_umg.PanelWidgetProps.md#cursor)
- [DesignerFlags](react_umg.PanelWidgetProps.md#designerflags)
- [DisplayLabel](react_umg.PanelWidgetProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.PanelWidgetProps.md#flowdirectionpreference)
- [RenderOpacity](react_umg.PanelWidgetProps.md#renderopacity)
- [RenderTransform](react_umg.PanelWidgetProps.md#rendertransform)
- [RenderTransformPivot](react_umg.PanelWidgetProps.md#rendertransformpivot)
- [Slot](react_umg.PanelWidgetProps.md#slot)
- [ToolTipText](react_umg.PanelWidgetProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.PanelWidgetProps.md#tooltiptextdelegate)
- [Visibility](react_umg.PanelWidgetProps.md#visibility)
- [VisibilityDelegate](react_umg.PanelWidgetProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.PanelWidgetProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.PanelWidgetProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.PanelWidgetProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.PanelWidgetProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.PanelWidgetProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.PanelWidgetProps.md#bisenableddelegate)
- [bIsVariable](react_umg.PanelWidgetProps.md#bisvariable)
- [bIsVolatile](react_umg.PanelWidgetProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.PanelWidgetProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.PanelWidgetProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.PanelWidgetProps.md#boverride_cursor)
