[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / ProgressBarProps

# Interface: ProgressBarProps

[react-umg](../modules/react_umg.md).ProgressBarProps
...
- [AccessibleBehavior](react_umg.ProgressBarProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.ProgressBarProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.ProgressBarProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.ProgressBarProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.ProgressBarProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.ProgressBarProps.md#accessibletextdelegate)
- [BarFillType](react_umg.ProgressBarProps.md#barfilltype)
- [BorderPadding](react_umg.ProgressBarProps.md#borderpadding)
- [CategoryName](react_umg.ProgressBarProps.md#categoryname)
- [Clipping](react_umg.ProgressBarProps.md#clipping)
- [Cursor](react_umg.ProgressBarProps.md#cursor)
- [DesignerFlags](react_umg.ProgressBarProps.md#designerflags)
- [DisplayLabel](react_umg.ProgressBarProps.md#displaylabel)
- [FillColorAndOpacity](react_umg.ProgressBarProps.md#fillcolorandopacity)
- [FillColorAndOpacityDelegate](react_umg.ProgressBarProps.md#fillcolorandopacitydelegate)
- [FlowDirectionPreference](react_umg.ProgressBarProps.md#flowdirectionpreference)
- [Percent](react_umg.ProgressBarProps.md#percent)
- [PercentDelegate](react_umg.ProgressBarProps.md#percentdelegate)
- [RenderOpacity](react_umg.ProgressBarProps.md#renderopacity)
- [RenderTransform](react_umg.ProgressBarProps.md#rendertransform)
- [RenderTransformPivot](react_umg.ProgressBarProps.md#rendertransformpivot)
- [Slot](react_umg.ProgressBarProps.md#slot)
- [ToolTipText](react_umg.ProgressBarProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.ProgressBarProps.md#tooltiptextdelegate)
- [Visibility](react_umg.ProgressBarProps.md#visibility)
- [VisibilityDelegate](react_umg.ProgressBarProps.md#visibilitydelegate)
- [WidgetStyle](react_umg.ProgressBarProps.md#widgetstyle)
- [bCanChildrenBeAccessible](react_umg.ProgressBarProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.ProgressBarProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.ProgressBarProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.ProgressBarProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.ProgressBarProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.ProgressBarProps.md#bisenableddelegate)
- [bIsMarquee](react_umg.ProgressBarProps.md#bismarquee)
- [bIsVariable](react_umg.ProgressBarProps.md#bisvariable)
- [bIsVolatile](react_umg.ProgressBarProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.ProgressBarProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.ProgressBarProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.ProgressBarProps.md#boverride_cursor)
...
• `Optional` **BarFillType**: [`EProgressBarFillType`](../enums/ue_ue.EProgressBarFillType.md)

#### Defined in

[react-umg/index.d.ts:613](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L613)

___

### BorderPadding

• `Optional` **BorderPadding**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`Vector2D`](../classes/ue_ue_s.Vector2D.md)\>

#### Defined in

[react-umg/index.d.ts:615](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L615)
...
• `Optional` **FillColorAndOpacity**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`LinearColor`](../classes/ue_ue_s.LinearColor.md)\>

#### Defined in

[react-umg/index.d.ts:617](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L617)

___

### FillColorAndOpacityDelegate

• `Optional` **FillColorAndOpacityDelegate**: () => [`LinearColor`](../classes/ue_ue_s.LinearColor.md)
...
[react-umg/index.d.ts:618](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L618)
...
[react-umg/index.d.ts:612](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L612)

___

### PercentDelegate

• `Optional` **PercentDelegate**: () => `number`
...
[react-umg/index.d.ts:616](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L616)
...
• `Optional` **WidgetStyle**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`ProgressBarStyle`](../classes/ue_ue.ProgressBarStyle.md)\>

#### Defined in

[react-umg/index.d.ts:611](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L611)
...
• `Optional` **bIsMarquee**: `boolean`

#### Defined in

[react-umg/index.d.ts:614](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L614)
