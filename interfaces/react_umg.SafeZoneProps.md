[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / SafeZoneProps

# Interface: SafeZoneProps

[react-umg](../modules/react_umg.md).SafeZoneProps
...
- [AccessibleBehavior](react_umg.SafeZoneProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.SafeZoneProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.SafeZoneProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.SafeZoneProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.SafeZoneProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.SafeZoneProps.md#accessibletextdelegate)
- [CategoryName](react_umg.SafeZoneProps.md#categoryname)
- [Clipping](react_umg.SafeZoneProps.md#clipping)
- [Cursor](react_umg.SafeZoneProps.md#cursor)
- [DesignerFlags](react_umg.SafeZoneProps.md#designerflags)
- [DisplayLabel](react_umg.SafeZoneProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.SafeZoneProps.md#flowdirectionpreference)
- [PadBottom](react_umg.SafeZoneProps.md#padbottom)
- [PadLeft](react_umg.SafeZoneProps.md#padleft)
- [PadRight](react_umg.SafeZoneProps.md#padright)
- [PadTop](react_umg.SafeZoneProps.md#padtop)
- [RenderOpacity](react_umg.SafeZoneProps.md#renderopacity)
- [RenderTransform](react_umg.SafeZoneProps.md#rendertransform)
- [RenderTransformPivot](react_umg.SafeZoneProps.md#rendertransformpivot)
- [Slot](react_umg.SafeZoneProps.md#slot)
- [ToolTipText](react_umg.SafeZoneProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.SafeZoneProps.md#tooltiptextdelegate)
- [Visibility](react_umg.SafeZoneProps.md#visibility)
- [VisibilityDelegate](react_umg.SafeZoneProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.SafeZoneProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.SafeZoneProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.SafeZoneProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.SafeZoneProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.SafeZoneProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.SafeZoneProps.md#bisenableddelegate)
- [bIsVariable](react_umg.SafeZoneProps.md#bisvariable)
- [bIsVolatile](react_umg.SafeZoneProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.SafeZoneProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.SafeZoneProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.SafeZoneProps.md#boverride_cursor)
...
• `Optional` **PadBottom**: `boolean`

#### Defined in

[react-umg/index.d.ts:652](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L652)

___

### PadLeft

• `Optional` **PadLeft**: `boolean`

#### Defined in

[react-umg/index.d.ts:649](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L649)

___

### PadRight

• `Optional` **PadRight**: `boolean`

#### Defined in

[react-umg/index.d.ts:650](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L650)

___

### PadTop

• `Optional` **PadTop**: `boolean`

#### Defined in

[react-umg/index.d.ts:651](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L651)
