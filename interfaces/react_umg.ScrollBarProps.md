[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / ScrollBarProps

# Interface: ScrollBarProps

[react-umg](../modules/react_umg.md).ScrollBarProps
...
- [AccessibleBehavior](react_umg.ScrollBarProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.ScrollBarProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.ScrollBarProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.ScrollBarProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.ScrollBarProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.ScrollBarProps.md#accessibletextdelegate)
- [CategoryName](react_umg.ScrollBarProps.md#categoryname)
- [Clipping](react_umg.ScrollBarProps.md#clipping)
- [Cursor](react_umg.ScrollBarProps.md#cursor)
- [DesignerFlags](react_umg.ScrollBarProps.md#designerflags)
- [DisplayLabel](react_umg.ScrollBarProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.ScrollBarProps.md#flowdirectionpreference)
- [Orientation](react_umg.ScrollBarProps.md#orientation)
- [Padding](react_umg.ScrollBarProps.md#padding)
- [RenderOpacity](react_umg.ScrollBarProps.md#renderopacity)
- [RenderTransform](react_umg.ScrollBarProps.md#rendertransform)
- [RenderTransformPivot](react_umg.ScrollBarProps.md#rendertransformpivot)
- [Slot](react_umg.ScrollBarProps.md#slot)
- [Thickness](react_umg.ScrollBarProps.md#thickness)
- [ToolTipText](react_umg.ScrollBarProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.ScrollBarProps.md#tooltiptextdelegate)
- [Visibility](react_umg.ScrollBarProps.md#visibility)
- [VisibilityDelegate](react_umg.ScrollBarProps.md#visibilitydelegate)
- [WidgetStyle](react_umg.ScrollBarProps.md#widgetstyle)
- [bAlwaysShowScrollbar](react_umg.ScrollBarProps.md#balwaysshowscrollbar)
- [bAlwaysShowScrollbarTrack](react_umg.ScrollBarProps.md#balwaysshowscrollbartrack)
- [bCanChildrenBeAccessible](react_umg.ScrollBarProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.ScrollBarProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.ScrollBarProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.ScrollBarProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.ScrollBarProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.ScrollBarProps.md#bisenableddelegate)
- [bIsVariable](react_umg.ScrollBarProps.md#bisvariable)
- [bIsVolatile](react_umg.ScrollBarProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.ScrollBarProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.ScrollBarProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.ScrollBarProps.md#boverride_cursor)
...
[react-umg/index.d.ts:674](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L674)
...
[react-umg/index.d.ts:676](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L676)
...
• `Optional` **Thickness**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`Vector2D`](../classes/ue_ue_s.Vector2D.md)\>

#### Defined in

[react-umg/index.d.ts:675](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L675)
...
• `Optional` **WidgetStyle**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`ScrollBarStyle`](../classes/ue_ue.ScrollBarStyle.md)\>

#### Defined in

[react-umg/index.d.ts:671](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L671)

___

### bAlwaysShowScrollbar

• `Optional` **bAlwaysShowScrollbar**: `boolean`

#### Defined in

[react-umg/index.d.ts:672](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L672)

___

### bAlwaysShowScrollbarTrack

• `Optional` **bAlwaysShowScrollbarTrack**: `boolean`

#### Defined in

[react-umg/index.d.ts:673](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L673)
