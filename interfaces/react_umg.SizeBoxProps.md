[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / SizeBoxProps

# Interface: SizeBoxProps

[react-umg](../modules/react_umg.md).SizeBoxProps
...
- [AccessibleBehavior](react_umg.SizeBoxProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.SizeBoxProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.SizeBoxProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.SizeBoxProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.SizeBoxProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.SizeBoxProps.md#accessibletextdelegate)
- [CategoryName](react_umg.SizeBoxProps.md#categoryname)
- [Clipping](react_umg.SizeBoxProps.md#clipping)
- [Cursor](react_umg.SizeBoxProps.md#cursor)
- [DesignerFlags](react_umg.SizeBoxProps.md#designerflags)
- [DisplayLabel](react_umg.SizeBoxProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.SizeBoxProps.md#flowdirectionpreference)
- [HeightOverride](react_umg.SizeBoxProps.md#heightoverride)
- [MaxAspectRatio](react_umg.SizeBoxProps.md#maxaspectratio)
- [MaxDesiredHeight](react_umg.SizeBoxProps.md#maxdesiredheight)
- [MaxDesiredWidth](react_umg.SizeBoxProps.md#maxdesiredwidth)
- [MinAspectRatio](react_umg.SizeBoxProps.md#minaspectratio)
- [MinDesiredHeight](react_umg.SizeBoxProps.md#mindesiredheight)
- [MinDesiredWidth](react_umg.SizeBoxProps.md#mindesiredwidth)
- [RenderOpacity](react_umg.SizeBoxProps.md#renderopacity)
- [RenderTransform](react_umg.SizeBoxProps.md#rendertransform)
- [RenderTransformPivot](react_umg.SizeBoxProps.md#rendertransformpivot)
- [Slot](react_umg.SizeBoxProps.md#slot)
- [ToolTipText](react_umg.SizeBoxProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.SizeBoxProps.md#tooltiptextdelegate)
- [Visibility](react_umg.SizeBoxProps.md#visibility)
- [VisibilityDelegate](react_umg.SizeBoxProps.md#visibilitydelegate)
- [WidthOverride](react_umg.SizeBoxProps.md#widthoverride)
- [bCanChildrenBeAccessible](react_umg.SizeBoxProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.SizeBoxProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.SizeBoxProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.SizeBoxProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.SizeBoxProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.SizeBoxProps.md#bisenableddelegate)
- [bIsVariable](react_umg.SizeBoxProps.md#bisvariable)
- [bIsVolatile](react_umg.SizeBoxProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.SizeBoxProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.SizeBoxProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.SizeBoxProps.md#boverride_cursor)
- [bOverride\_HeightOverride](react_umg.SizeBoxProps.md#boverride_heightoverride)
- [bOverride\_MaxAspectRatio](react_umg.SizeBoxProps.md#boverride_maxaspectratio)
- [bOverride\_MaxDesiredHeight](react_umg.SizeBoxProps.md#boverride_maxdesiredheight)
- [bOverride\_MaxDesiredWidth](react_umg.SizeBoxProps.md#boverride_maxdesiredwidth)
- [bOverride\_MinAspectRatio](react_umg.SizeBoxProps.md#boverride_minaspectratio)
- [bOverride\_MinDesiredHeight](react_umg.SizeBoxProps.md#boverride_mindesiredheight)
- [bOverride\_MinDesiredWidth](react_umg.SizeBoxProps.md#boverride_mindesiredwidth)
- [bOverride\_WidthOverride](react_umg.SizeBoxProps.md#boverride_widthoverride)
...
• `Optional` **HeightOverride**: `number`

#### Defined in

[react-umg/index.d.ts:708](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L708)
...
[react-umg/index.d.ts:714](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L714)

___

### MaxDesiredHeight

• `Optional` **MaxDesiredHeight**: `number`

#### Defined in

[react-umg/index.d.ts:712](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L712)

___

### MaxDesiredWidth

• `Optional` **MaxDesiredWidth**: `number`

#### Defined in

[react-umg/index.d.ts:711](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L711)
...
[react-umg/index.d.ts:713](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L713)

___

### MinDesiredHeight

• `Optional` **MinDesiredHeight**: `number`

#### Defined in

[react-umg/index.d.ts:710](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L710)
...
[react-umg/index.d.ts:709](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L709)
...
• `Optional` **WidthOverride**: `number`

#### Defined in

[react-umg/index.d.ts:707](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L707)
...
• `Optional` **bOverride\_HeightOverride**: `boolean`

#### Defined in

[react-umg/index.d.ts:716](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L716)

___

### bOverride\_MaxAspectRatio

• `Optional` **bOverride\_MaxAspectRatio**: `boolean`

#### Defined in

[react-umg/index.d.ts:722](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L722)

___

### bOverride\_MaxDesiredHeight

• `Optional` **bOverride\_MaxDesiredHeight**: `boolean`

#### Defined in

[react-umg/index.d.ts:720](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L720)

___

### bOverride\_MaxDesiredWidth

• `Optional` **bOverride\_MaxDesiredWidth**: `boolean`

#### Defined in

[react-umg/index.d.ts:719](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L719)

___

### bOverride\_MinAspectRatio

• `Optional` **bOverride\_MinAspectRatio**: `boolean`

#### Defined in

[react-umg/index.d.ts:721](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L721)

___

### bOverride\_MinDesiredHeight

• `Optional` **bOverride\_MinDesiredHeight**: `boolean`

#### Defined in

[react-umg/index.d.ts:718](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L718)

___

### bOverride\_MinDesiredWidth

• `Optional` **bOverride\_MinDesiredWidth**: `boolean`

#### Defined in

[react-umg/index.d.ts:717](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L717)

___

### bOverride\_WidthOverride

• `Optional` **bOverride\_WidthOverride**: `boolean`

#### Defined in

[react-umg/index.d.ts:715](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L715)
