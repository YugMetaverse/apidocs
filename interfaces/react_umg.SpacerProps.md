[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / SpacerProps

# Interface: SpacerProps

[react-umg](../modules/react_umg.md).SpacerProps
...
- [AccessibleBehavior](react_umg.SpacerProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.SpacerProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.SpacerProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.SpacerProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.SpacerProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.SpacerProps.md#accessibletextdelegate)
- [CategoryName](react_umg.SpacerProps.md#categoryname)
- [Clipping](react_umg.SpacerProps.md#clipping)
- [Cursor](react_umg.SpacerProps.md#cursor)
- [DesignerFlags](react_umg.SpacerProps.md#designerflags)
- [DisplayLabel](react_umg.SpacerProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.SpacerProps.md#flowdirectionpreference)
- [RenderOpacity](react_umg.SpacerProps.md#renderopacity)
- [RenderTransform](react_umg.SpacerProps.md#rendertransform)
- [RenderTransformPivot](react_umg.SpacerProps.md#rendertransformpivot)
- [Size](react_umg.SpacerProps.md#size)
- [Slot](react_umg.SpacerProps.md#slot)
- [ToolTipText](react_umg.SpacerProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.SpacerProps.md#tooltiptextdelegate)
- [Visibility](react_umg.SpacerProps.md#visibility)
- [VisibilityDelegate](react_umg.SpacerProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.SpacerProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.SpacerProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.SpacerProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.SpacerProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.SpacerProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.SpacerProps.md#bisenableddelegate)
- [bIsVariable](react_umg.SpacerProps.md#bisvariable)
- [bIsVolatile](react_umg.SpacerProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.SpacerProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.SpacerProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.SpacerProps.md#boverride_cursor)
...
• `Optional` **Size**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`Vector2D`](../classes/ue_ue_s.Vector2D.md)\>

#### Defined in

[react-umg/index.d.ts:756](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L756)
