[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / ThrobberProps

# Interface: ThrobberProps

[react-umg](../modules/react_umg.md).ThrobberProps
...
- [AccessibleBehavior](react_umg.ThrobberProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.ThrobberProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.ThrobberProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.ThrobberProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.ThrobberProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.ThrobberProps.md#accessibletextdelegate)
- [CategoryName](react_umg.ThrobberProps.md#categoryname)
- [Clipping](react_umg.ThrobberProps.md#clipping)
- [Cursor](react_umg.ThrobberProps.md#cursor)
- [DesignerFlags](react_umg.ThrobberProps.md#designerflags)
- [DisplayLabel](react_umg.ThrobberProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.ThrobberProps.md#flowdirectionpreference)
- [Image](react_umg.ThrobberProps.md#image)
- [NumberOfPieces](react_umg.ThrobberProps.md#numberofpieces)
- [RenderOpacity](react_umg.ThrobberProps.md#renderopacity)
- [RenderTransform](react_umg.ThrobberProps.md#rendertransform)
- [RenderTransformPivot](react_umg.ThrobberProps.md#rendertransformpivot)
- [Slot](react_umg.ThrobberProps.md#slot)
- [ToolTipText](react_umg.ThrobberProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.ThrobberProps.md#tooltiptextdelegate)
- [Visibility](react_umg.ThrobberProps.md#visibility)
- [VisibilityDelegate](react_umg.ThrobberProps.md#visibilitydelegate)
- [bAnimateHorizontally](react_umg.ThrobberProps.md#banimatehorizontally)
- [bAnimateOpacity](react_umg.ThrobberProps.md#banimateopacity)
- [bAnimateVertically](react_umg.ThrobberProps.md#banimatevertically)
- [bCanChildrenBeAccessible](react_umg.ThrobberProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.ThrobberProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.ThrobberProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.ThrobberProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.ThrobberProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.ThrobberProps.md#bisenableddelegate)
- [bIsVariable](react_umg.ThrobberProps.md#bisvariable)
- [bIsVolatile](react_umg.ThrobberProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.ThrobberProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.ThrobberProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.ThrobberProps.md#boverride_cursor)
...
[react-umg/index.d.ts:818](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L818)
...
[react-umg/index.d.ts:814](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L814)
...
• `Optional` **bAnimateHorizontally**: `boolean`

#### Defined in

[react-umg/index.d.ts:815](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L815)

___

### bAnimateOpacity

• `Optional` **bAnimateOpacity**: `boolean`

#### Defined in

[react-umg/index.d.ts:817](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L817)

___

### bAnimateVertically

• `Optional` **bAnimateVertically**: `boolean`

#### Defined in

[react-umg/index.d.ts:816](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L816)
