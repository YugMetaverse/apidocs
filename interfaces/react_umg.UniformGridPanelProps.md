[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / UniformGridPanelProps

# Interface: UniformGridPanelProps

[react-umg](../modules/react_umg.md).UniformGridPanelProps
...
- [AccessibleBehavior](react_umg.UniformGridPanelProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.UniformGridPanelProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.UniformGridPanelProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.UniformGridPanelProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.UniformGridPanelProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.UniformGridPanelProps.md#accessibletextdelegate)
- [CategoryName](react_umg.UniformGridPanelProps.md#categoryname)
- [Clipping](react_umg.UniformGridPanelProps.md#clipping)
- [Cursor](react_umg.UniformGridPanelProps.md#cursor)
- [DesignerFlags](react_umg.UniformGridPanelProps.md#designerflags)
- [DisplayLabel](react_umg.UniformGridPanelProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.UniformGridPanelProps.md#flowdirectionpreference)
- [MinDesiredSlotHeight](react_umg.UniformGridPanelProps.md#mindesiredslotheight)
- [MinDesiredSlotWidth](react_umg.UniformGridPanelProps.md#mindesiredslotwidth)
- [RenderOpacity](react_umg.UniformGridPanelProps.md#renderopacity)
- [RenderTransform](react_umg.UniformGridPanelProps.md#rendertransform)
- [RenderTransformPivot](react_umg.UniformGridPanelProps.md#rendertransformpivot)
- [Slot](react_umg.UniformGridPanelProps.md#slot)
- [SlotPadding](react_umg.UniformGridPanelProps.md#slotpadding)
- [ToolTipText](react_umg.UniformGridPanelProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.UniformGridPanelProps.md#tooltiptextdelegate)
- [Visibility](react_umg.UniformGridPanelProps.md#visibility)
- [VisibilityDelegate](react_umg.UniformGridPanelProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.UniformGridPanelProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.UniformGridPanelProps.md#bcreatedbyconstructionscript)
- [bExpandedInDesigner](react_umg.UniformGridPanelProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.UniformGridPanelProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.UniformGridPanelProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.UniformGridPanelProps.md#bisenableddelegate)
- [bIsVariable](react_umg.UniformGridPanelProps.md#bisvariable)
- [bIsVolatile](react_umg.UniformGridPanelProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.UniformGridPanelProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.UniformGridPanelProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.UniformGridPanelProps.md#boverride_cursor)
...
• `Optional` **MinDesiredSlotHeight**: `number`

#### Defined in

[react-umg/index.d.ts:846](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L846)

___

### MinDesiredSlotWidth

• `Optional` **MinDesiredSlotWidth**: `number`

#### Defined in

[react-umg/index.d.ts:845](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L845)
...
• `Optional` **SlotPadding**: [`RecursivePartial`](../modules/react_umg.md#recursivepartial)<[`Margin`](../classes/ue_ue.Margin.md)\>

#### Defined in

[react-umg/index.d.ts:844](https://github.com/YugMetaverse/yug_typings/blob/25cad34/react-umg/index.d.ts#L844)
