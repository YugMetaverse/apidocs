[yug_typings](../README.md) / [Modules](../modules.md) / [react-umg](../modules/react_umg.md) / WindowTitleBarAreaProps

# Interface: WindowTitleBarAreaProps

[react-umg](../modules/react_umg.md).WindowTitleBarAreaProps

## Hierarchy

- [`ContentWidgetProps`](react_umg.ContentWidgetProps.md)

  ↳ **`WindowTitleBarAreaProps`**

## Table of contents

### Properties

- [AccessibleBehavior](react_umg.WindowTitleBarAreaProps.md#accessiblebehavior)
- [AccessibleSummaryBehavior](react_umg.WindowTitleBarAreaProps.md#accessiblesummarybehavior)
- [AccessibleSummaryText](react_umg.WindowTitleBarAreaProps.md#accessiblesummarytext)
- [AccessibleSummaryTextDelegate](react_umg.WindowTitleBarAreaProps.md#accessiblesummarytextdelegate)
- [AccessibleText](react_umg.WindowTitleBarAreaProps.md#accessibletext)
- [AccessibleTextDelegate](react_umg.WindowTitleBarAreaProps.md#accessibletextdelegate)
- [CategoryName](react_umg.WindowTitleBarAreaProps.md#categoryname)
- [Clipping](react_umg.WindowTitleBarAreaProps.md#clipping)
- [Cursor](react_umg.WindowTitleBarAreaProps.md#cursor)
- [DesignerFlags](react_umg.WindowTitleBarAreaProps.md#designerflags)
- [DisplayLabel](react_umg.WindowTitleBarAreaProps.md#displaylabel)
- [FlowDirectionPreference](react_umg.WindowTitleBarAreaProps.md#flowdirectionpreference)
- [RenderOpacity](react_umg.WindowTitleBarAreaProps.md#renderopacity)
- [RenderTransform](react_umg.WindowTitleBarAreaProps.md#rendertransform)
- [RenderTransformPivot](react_umg.WindowTitleBarAreaProps.md#rendertransformpivot)
- [Slot](react_umg.WindowTitleBarAreaProps.md#slot)
- [ToolTipText](react_umg.WindowTitleBarAreaProps.md#tooltiptext)
- [ToolTipTextDelegate](react_umg.WindowTitleBarAreaProps.md#tooltiptextdelegate)
- [Visibility](react_umg.WindowTitleBarAreaProps.md#visibility)
- [VisibilityDelegate](react_umg.WindowTitleBarAreaProps.md#visibilitydelegate)
- [bCanChildrenBeAccessible](react_umg.WindowTitleBarAreaProps.md#bcanchildrenbeaccessible)
- [bCreatedByConstructionScript](react_umg.WindowTitleBarAreaProps.md#bcreatedbyconstructionscript)
- [bDoubleClickTogglesFullscreen](react_umg.WindowTitleBarAreaProps.md#bdoubleclicktogglesfullscreen)
- [bExpandedInDesigner](react_umg.WindowTitleBarAreaProps.md#bexpandedindesigner)
- [bHiddenInDesigner](react_umg.WindowTitleBarAreaProps.md#bhiddenindesigner)
- [bIsEnabled](react_umg.WindowTitleBarAreaProps.md#bisenabled)
- [bIsEnabledDelegate](react_umg.WindowTitleBarAreaProps.md#bisenableddelegate)
- [bIsVariable](react_umg.WindowTitleBarAreaProps.md#bisvariable)
- [bIsVolatile](react_umg.WindowTitleBarAreaProps.md#bisvolatile)
- [bLockedInDesigner](react_umg.WindowTitleBarAreaProps.md#blockedindesigner)
- [bOverrideAccessibleDefaults](react_umg.WindowTitleBarAreaProps.md#boverrideaccessibledefaults)
- [bOverride\_Cursor](react_umg.WindowTitleBarAreaProps.md#boverride_cursor)
- [bWindowButtonsEnabled](react_umg.WindowTitleBarAreaProps.md#bwindowbuttonsenabled)
...
• `Optional` **bDoubleClickTogglesFullscreen**: `boolean`

#### Defined in

[react-umg/index.d.ts:878](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L878)
...
• `Optional` **bWindowButtonsEnabled**: `boolean`

#### Defined in

[react-umg/index.d.ts:877](https://github.com/YugMetaverse/yug_typings/blob/b7d9b19/react-umg/index.d.ts#L877)
